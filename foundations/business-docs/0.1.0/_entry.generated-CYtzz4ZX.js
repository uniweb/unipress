...
import { createContext as _t, useContext as At, useMemo as _e, createElement as kt, useState as ct, useEffect as gt, useReducer as ar, Children as rr, isValidElement as nr, cloneElement as sr, Fragment as dt, useRef as ir } from "react";
import { renderToStaticMarkup as Jt } from "react-dom/server";
import { getUniweb as ea, deriveCacheKey as or } from "@uniweb/core";
const ta = /\s+/, cr = /([+\-*\/=<>!&|]+)/, du = {
  "|": 1,
  "&": 2,
  "=": 3,
...
function De(e, t, u = {}) {
  const a = Object.keys(t), n = u.minQuoteLevel || 0, s = u.splitText || !1;
  u.skipCommas;
  const i = [];
  let l = 0, f = "", m = !1, h = "", p = [], g = "", N = 0;
  const L = ["'", '"', "`", "‘", "’", "“", "”"], B = (D, $) => D === $ ? !0 : ["‘", "’"].includes(D) && ["‘", "’"].includes($) || ["“", "”"].includes(D) && ["“", "”"].includes($);
  function x(D, $) {
    if (s && D == "text") {
      const ue = $.trim().split(ta);
      for (let z of ue)
        z = dr(z), z !== "" && i.push({ type: D, value: z });
    } else
      i.push({ type: D, value: $ });
    f = "";
  }
  ...
  for (; l < e.length; ) {
    const D = e[l];
    a.includes(D) && !m ? (R(D), N = p.push(D), g = t[D]) : D === g && !m ? (f += D, p.pop(), N--, g = N > 0 ? t[p[N - 1]] : "", N === 0 && x("enclosure", f)) : !m && L.includes(D) && N > n ? (R(D), m = !0, h = D) : m && B(h, D) ? (f += D, m = !1, N === 0 && x("quote", f)) : f += D, l++;
  }
  return f !== "" && x("text", f), i;
}
function lr(e) {
  ...
  function i(f, m) {
    s.set(a, { type: f, value: m }), n = !1, u = "";
  }
  function l(f) {
    s.set(f, { type: "text", value: !0 }), n = !0, a = f, u = "";
  }
  for (; t < e.length; ) {
    const f = e[t];
    if (f.type == "text" && f.value !== ":") {
      const m = f.value.split(":");
      m.length === 1 ? u += f.value : n ? (u += m[0], i("text", u), u = m[1] ?? "") : (u += m[0], a = u, l(a), u = m[1] ?? "");
    } else
      u !== "" && (n ? i("text", u) : l(u)), n && f.value !== ":" ? i(f.type, f.value) : f.type == "quote" ? (a = f, l(a)) : f.value !== ":" && console.warn(`Unexpected key: ${f.value} type: ${f.type}`);
    u !== "" && (n ? i("text", u) : l(u)), t++;
  }
  return s;
}
function ua(e, t = []) {
  ...
  const u = De(e, { "{": "}", "(": ")" }, { minQuoteLevel: 1 }), a = {};
  function n(s, i, l) {
  ...
  for (let s = 1; s < u.length; s += 2) {
    ...
    if (i.length < 3 || !i.startsWith("[") || !i.endsWith("]"))
      ...
      const m = i.slice(1, -1).trim().split(ta), h = m.shift(), p = m[0] === "$0";
      p && m.shift(), !h || !/^[a-zA-Z_]\w*$/.test(h) ? n("name", "word", m.join(" ")) : m.every((g) => /^(\.\.\.)?[a-zA-Z_]\w*$/.test(g)) ? a[h] = { args: m, body: f, isText: l == "{", hasFlags: p } : n("arguments", "words", m.join(" "));
    }
  }
  return a;
}
...
function fr(e) {
  ...
  for (let s of e)
    if (s.type === "text")
      if (u = s.value.split(cr), u.length <= 1)
        t.push(s);
      else
        for (let i = 0; i < u.length; i++)
          a = u[i].trim(), a !== "" && (n = "+-*/=<>!&|".includes(a[0]), a === "!" && t.push({ type: "text", value: "" }), t.push({ type: "text", value: a, isOperator: n }));
    else
      t.push(s);
  return t;
}
function hr(e) {
  ...
  for (; u < e.length; ) {
    const s = e[u], i = e[u + 1];
    i && i.isOperator ? (a || (a = !0, n = []), n.push(s, i), u += 2) : (a ? (a = !1, n.push(s), t.push({ type: "chain", tokens: n })) : t.push(s), u++);
  }
  return a && t.push({ type: "chain", tokens: n }), t;
}
function Er(e) {
  const t = [], u = [];
  let a, n, s;
  for (let i of e)
    if (!i.isOperator)
      ...
      for (; u.length > 0 && du[u[u.length - 1]] >= du[i.value]; )
        a = u.pop(), n = t.pop(), s = t.pop(), t.push(`(${a} ${s} ${n})`);
      u.push(i.value);
    }
  for (; u.length > 0; )
    a = u.pop(), n = t.pop(), s = t.pop(), t.push(`(${a} ${s} ${n})`);
...
function mr(e) {
  const t = fr(e), u = hr(t);
  for (const a of u)
    a.type === "chain" && (a.type = "enclosure", a.value = Er(a.tokens), delete a.tokens);
  return u;
}
function Tr(e) {
  if (!e.length) return [];
  ...
  for (let h = 1; h < e.length; h++) {
    const p = e[h], g = p.value.toLowerCase();
    p.type == "text" ? g in t ? (s.push(a), a = { name: t[g], flags: {}, args: [] }, n = "") : l.includes(g) ? (n = g, a.flags[n] = !0) : g in f ? (n = f[g], a.flags[n] = !0) : n ? i.includes(g) || (a.flags[n] = p, n = "") : i.includes(g) || a.args.push(p) : n ? (a.flags[n] = p, n = "") : a.args.push(p);
  }
  s.push(a);
  ...
  const m = s.shift();
  for (const h of s) {
    const p = fu(h).map((g) => g.value);
    m.args.push({ type: "enclosure", value: "(" + p.join(" ") + ")" });
  }
...
}, _r = ["wrap", "aux", "label", "heading", "title"];
let wt;
const Eu = {};
function mu(e, t, u) {
  Eu[e] ??= Ar(e);
  ...
  if ((a.spread && u.length == a.minArgs && !t.l || t.s) && M(u[u.length - 1])) {
    const i = u.pop();
    u = u.concat(i);
  }
  let n = pr[e] || [];
  ...
  !t.type && typeof t.as == "string" && (t.type = t.as), t.lang ? t.locale = t.lang : (t.locale || (t.locale = Ve(t.locale)), t.lang = oa(t.locale)), t._name = e;
  const s = a.handler(a.fn, t, u);
  return t.r && M(s) && s.reverse(), s === void 0 ? null : s;
}
function Ar(e) {
  for (let t in hu) {
    const u = hu[t];
    if (u.hasOwnProperty(e)) {
      let a = u[""];
      return typeof a == "function" ? a = { handler: a, minArgs: 1, spread: !0 } : X(a) && (a = { ...a }), a.fn = u[e], a;
    }
  }
  return !1;
}
function gr(e, t, u) {
  const a = u[0], n = u.slice(1);
  ...
  if (X(a))
    if (n.length > 1 || M(n[0])) {
      ...
      return e(a, n[0]);
  else return n.length == 1 ? e(a, n[0]) : e(a, n);
}
function Nr(e, t) {
...
function Ir(e, t, u) {
  if (["~", "phone", "address", "ref", "email"].includes(t._name) && Ie(u)) {
    let a = pe(t, u);
    return t._name === "phone" && (a = a.filter((n) => n[0])), a.map((n) => e(t, n));
  }
  return e(t, u);
}
function Ft(e) {
...
function pe(e, t) {
  ...
  const n = [];
  for (const s of t)
    Array.isArray(s) ? u > s.length ? n.push([...s, ...Array(u - s.length).fill(a)]) : u < s.length ? n.push(s.slice(0, u)) : n.push(s) : n.push(Array(u).fill(s));
  return e.t ? n : Cr(n);
}
function Cr(e) {
  const t = [];
...
function ne(e, t) {
  ...
  let a = t.slice(1);
  if (a = Be(a), fe(u))
    return a.filter((s) => !Nt(s)).join(u);
  if (M(u)) {
    const n = u.length ? u : [""];
    return a.reduce((i, l, f) => {
      if (!l && l !== 0) return "";
      if (f === 0) return l;
...
aa.init = 0;
function Be(e) {
  return M(e) ? e.flat(1 / 0) : e == null ? [] : typeof e == "object" ? Object.values(e).flat(1 / 0) : [e];
}
function Gr(e, t, u) {
  if (!Ie(u))
    return e(u);
...
function zr(e, t, u) {
  const a = u[0], n = u.slice(1);
  let s;
  return /*config.stepIn[0] &&*/ Array.isArray(a) ? s = a.map((i) => bu(e, i, n)) : s = bu(e, a, n), s;
}
function Qr(e, t, u) {
  if (u.length === 1)
    return e({ ...t }, u[0]);
  const a = (s) => s.length == 1 ? e({ ...t }, s[0]) : s.map((i) => e({ ...t }, i));
  return Ie(u) ? pe({}, u).map((s) => a(s)) : a(u);
}
function qr(e, t, u) {
  const a = u[0];
  return t.l ? e({ ...t }, a) : Array.isArray(a) ? a.map((n) => e({ ...t }, n)) : e({ ...t }, a);
}
function Vr(e, t, u) {
  if (!Ie(u))
    return e(t, u);
...
function bu(e, t, u) {
  return u.length == 1 && !M(u[0]) ? e(t, u[0]) : (u.length == 1 && M(u[0]) && (u = u[0]), u.map((a) => Array.isArray(a) ? a.map((n) => e(t, n)) : e(t, a)));
}
function jr(e, t) {
  if (!e) return [];
  if (e = Array.isArray(e) ? e : e.split("|"), fe(t) && (t = t.split(",")), !hn(t))
    return e;
  const u = [];
  for (const a of t)
    u.push(e[a]);
...
function Le(e, t) {
  if (e.type ??= ht(t, e), e.row ? (t = jr(t, e.row), e.type = "list") : t = ce(t, e.type, e), t === null) return "";
  const u = e.json ? "json" : e.type, a = { ...e };
  _r.forEach((s) => {
    delete a[s];
  });
  const n = { ...a, [e.type]: e[e.type] };
  return t = Xr(u, n, t), e.title && fe(t) && (t = ia(t, e.locale)), e.aux && (M(t) && (t = t.join(e.sep || ", ")), t = Zt(e, t)), e.label && (M(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = An(e, t)), e.heading && (M(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = _n(e, t)), e.wrap && (Nt(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Xr(e, t, u) {
  switch (e) {
    case "null":
...
function ln(e, t) {
  const u = e.date ? dn : ra, a = e.desc ? -1 : 1;
  return t.sort((n, s) => a * u(e, n, s));
}
function ft(e, t) {
  if (t.by && X(e) && !M(e)) {
    const u = e[t.by];
...
function dn(e, t, u) {
  let a = ft(t, e), n = ft(u, e);
  return Ce(a) && Ce(n) ? ce(a, "date").getTime() - ce(n, "date").getTime() : ra(e, t, u);
}
function ra(e, t, u) {
  let a = ft(t, e), n = ft(u, e);
  const s = ee(a), i = ee(n);
  return s && i ? Number(a) - Number(n) : !s && !i ? (typeof a != "string" && (a = String(a)), typeof n != "string" && (n = String(n)), a.localeCompare(n, e.locale)) : s ? -1 : 1;
}
function pu(e) {
  if (M(e))
    return e[0];
...
function fn(e, t, u) {
  ...
  if (t._name === "?:")
    ...
    if (s || (s = { "??": 2, "???": 3 }[t._name] || 1), s >= u.length)
      return null;
    a = u.slice(0, s), n = u.slice(s);
  }
  if (!Ie(a) && !Ie(n))
    return e(t, a, n);
  {
    const s = Math.max(Ft(a), Ft(n)), i = { sz: s }, l = pe(i, a), f = pe(i, n), m = [];
    for (let h = 0; h < s; h++)
      m.push(e(t, l[h], f[h]));
    return m;
  }
  ...
  for (let n = 0; n < u.length; n++) {
    ...
    if (typeof a == "object")
      if (a.hasOwnProperty(s))
        ...
        return s = u.slice(n).join("."), a.hasOwnProperty(s) ? a[s] : void 0;
...
function ce(e, t, u = {}) {
  switch (t) {
    case "boolean":
      return !Se(e);
    case "date":
      return Ce(e) ? e instanceof Date || u.date === "auto" && En(e) ? e : new Date(e.replace(/-/g, "/")) : null;
    case "text":
    case "string":
      return fe(e) ? e : ne(Be(e));
    case "list":
      return M(e) ? e : X(e) ? Be(e) : null;
    case "object":
      return X(e) ? e : null;
    case "number":
      return ee(e) ? parseFloat(e) : Ce(e) ? ce(e, "date").getTime() : 0;
    case "range":
      return e instanceof Z ? e : M(e) ? new Z(u, e) : X(e) ? new Z(u, [e.start, e.end]) : new Z(u, [e]);
    case "tag":
      return e instanceof F ? e : M(e) ? new F(u, [e]) : e instanceof G ? new F(u, [[null, e, null]]) : X(e) ? new F(u, [e]) : new F(u, [[null, e, null]]);
  }
  return e;
}
function ht(e, t = {}) {
  ...
  if (e instanceof Date)
    return "date";
  const u = typeof e;
  return u == "undefined" || e === null ? "null" : u == "boolean" ? u : M(e) ? "list" : ee(e) ? "number" : Ce(e) ? "date" : X(e) ? "object" : u;
}
function mn(e, t) {
  if (!Ce(t))
    return null;
  ...
  let a = e.date;
  return fe(a) && (a = u[a]), (!a || a === !0) && (a = "medium"), fe(a) && (a = { dateStyle: a }), t instanceof Date ? t.toLocaleDateString(e.locale, a) : t;
}
function Tn(e, t) {
  if (isNaN(t)) return "";
...
function na(e, t) {
  const u = [];
  for (let a of t)
    M(a) ? a = na(e, a) : X(a) && (a = sa(e, a)), Nt(a) || u.push(a);
...
function ia(e, t) {
  ...
  return t.toLowerCase().startsWith("en") ? e.split(" ").map((n, s, i) => s === 0 || s === i.length - 1 || !u.has(n.toLowerCase()) ? a(n) : n.toLowerCase()).join(" ") : a(e);
}
function pn(e) {
...
function oa(e = null) {
  return Ve(e).split("-")[0].toLowerCase();
}
function _u(e) {
  return {
    en: "Present",
...
class G {
  ...
  getParsedArgs(t) {
    ...
    let u = {};
    const a = this.getFieldMapping(), n = Object.keys(t);
...
class Z extends G {
  ...
  format(t) {
    t = { ...t, ...this.flags };
    const u = t.separator || " – ";
    let a = this.givenStart, n = this.givenEnd;
    return t.type === "date" ? (a = a ? Le(t, a) : _u(t.locale), n = n ? Le(t, n) : _u(t.locale)) : t.type !== "range" && (a = Le(t, a || ""), n = Le(t, n || "")), a || n ? `${a}${u}${n}` : "";
  }
  isEmpty() {
...
class F extends G {
  ...
  format() {
    ...
    return this.markups.forEach((a) => {
      const { tag: n, children: s, attrs: i } = a;
      let l = s || "";
      n.forEach((f, m) => {
        let h = "", p = {};
        switch (f) {
        ...
        if (m === 0 && (p = i), p && Object.keys(p).length) {
          h = h === "_self" ? "span" : h;
          let g = Object.keys(p).reduce((N, L) => `${N} ${L}="${p[L]}"`, "");
          l = `<${h}${g}>${l}</${h}>`;
        } else
...
class Nn extends G {
  ...
  format() {
    ...
    const { link: t = !1 } = this.flags, { type: u, country: a, ext: n, start: s, end: i } = this.parsedArgs;
...
class In extends G {
  ...
  format() {
    ...
    return [
      ne({}, [
        " ",
        Le({ tag: "bold", type: "tag", bold: !0 }, re([t, ":"])),
        ne({}, [
          " ",
          n,
          re(["(", new Z({}, [p, g]), ")"])
  ...
  isEmpty() {
    const { country: t, city: u, line1: a = "", province: n } = this.parsedArgs;
    return !t && !u && !a && !n;
  }
  toString() {
    return this.format();
...
class Cn extends G {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { type: t, organization: u, country: a, province: n } = this.parsedArgs, s = ne(null, [" - ", a, n, t]);
    return new F({}, [
      [
        "u-org",
        new F({}, [
...
class Sn extends G {
  ...
  format() {
    const [t, ...u] = this.values, a = ne(null, [" - ", ...u]);
    return t ? new F({}, [
      [
        "u-ref",
        new F({}, [
...
let On = class extends G {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { amount: t, currency: u, convertedAmount: a } = this.parsedArgs, n = br[u.toLowerCase()], i = [["u-amount", n ? new Intl.NumberFormat(`${Ve()}-CA`, {
      style: "currency",
      currency: n
    }).format(t) : t]];
    return u && i.push(["u-unit", u]), a && a !== "0" && i.push([
      "u-aux",
      new Intl.NumberFormat(`${Ve()}-CA`, {
        style: "currency",
        currency: "CAD"
      }).format(a)
...
class yn extends G {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { type: t, email: u, start: a = "", end: n = "" } = this.parsedArgs;
    let s = new Z({}, [a, n]).format();
    return [
      re([t, ":"]),
      u,
...
const Au = /^[@]?[\$]?[\/]?[a-zA-Z_][a-zA-Z0-9_\/\.-]*$|^@$|^\?$/, Dn = /^-?\d+(\.\d+)?$/;
class Ln {
  /**
   ...
   */
  constructor(t = {}, u = {}) {
    this.snippets = ua(t), this.functions = u;
  }
  /**
  ...
  render(t, u = null, a = null) {
    ...
    for (const i of n)
      if (i.type === "enclosure") {
        ...
        try {
          l = this.evaluateText(l, null, a), typeof l != "string" && (l = mu("#", { l: !0, sep: ", " }, [l]), Array.isArray(l) && l.every((f) => typeof f == "string") && (l = l.join(", ")));
        } catch (f) {
          l = f;
        }
        s += l;
  ...
  evaluateFunction(t, u) {
    const { name: a, tokens: n } = this.parseFunction(t);
    if (!a) return "";
    const s = [], i = { _params: [] };
    for (let f = 0; f < n.length; f++) {
      ...
      if (m.type == "quote" && m.value[0] === "`" && (m.value = m.value.slice(1, -1).toLowerCase().split(" ").join("_"), m.type = "text"), m.type == "quote")
        ...
        if (h[1] === "" && f + 1 < n.length) {
          const p = n[++f];
          h[1] = this.evaluateExpression(p, u).value;
  ...
  applyFallback(t, u) {
    ...
    const s = a[t] ?? a[t.toLowerCase()];
    if (typeof s != "function")
      return this.getError(104, "Invalid function name", t);
    if (u.length <= 1) return s.call(a);
    if (n === "string") return s.call(a, ...u.slice(1));
  ...
  getVariableMeta(t) {
    ...
    return typeof u == "string" ? { label: u } : (u.label ??= ia(t.split("_").join(" ")), u);
  }
  /**
  ...
  evaluateExpression(t, u = null) {
    const { value: a, type: n } = t;
    if (n === "quote")
      return { value: a.slice(1, -1), type: n };
    if (t.type === "enclosure") {
    ...
    return u && u.has(a) ? { value: u.get(a), type: "aux" } : Au.test(a) ? {
      value: this.getVariable(a, u),
      label: this.getVariableMeta(a).label,
      type: "variable"
    } : Dn.test(a) ? { value: parseFloat(a), type: "number" } : { value: this.getError(103, "Invalid expression", a), type: "error" };
  }
  ...
  callSnippet(t, u = {}, a = []) {
    ...
    return typeof n != "function" && (n = this.makeSnippetFunction(n), this.snippets[t] = n), n(u, a);
  }
  makeSnippetFunction(t) {
    const u = t.args || [], a = t.isText, n = t.body, s = t.hasFlags, i = /* @__PURE__ */ new Map();
    return (f, m) => {
      s && i.set("$0", f);
      for (let h = 0; h < m.length; h++) {
        const p = u[h] || "$" + (h + 1);
        if (p.startsWith("...")) {
          i.set(p.slice(3), m.slice(h));
          break;
        } else
          i.set(p, m[h]);
      }
      return a ? this.render(n, null, i) : this.evaluateFunction(n, i);
    };
  }
  getError(t, u, a) {
...
ca.sort((e, t) => t.length - e.length);
const Rn = new Set(ca.map((e) => e.join(" ").toUpperCase())), Pn = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
  ...
  "object",
  "tag"
]), Mn = /* @__PURE__ */ new Set([">=", "<=", "!=", "==", "&&", "||"]), Bn = /* @__PURE__ */ new Set(["+", "-", "*", "/", "%", "=", "<", ">", "!"]), xn = /[a-zA-Z_@$?]/, kn = /[a-zA-Z0-9_.\/@]/, Rt = /[0-9]/;
function wn(e) {
  return Fn(e);
}
function Fn(e) {
...
` || n === "\r") {
    ...
    if (Rt.test(n) || n === "-" && Rt.test(e[a + 1] || "") && Hn(t)) {
      let i = a + (n === "-" ? 1 : 0);
      for (; i < u && (Rt.test(e[i]) || e[i] === "."); ) i++;
      t.push({ type: "number", value: parseFloat(e.slice(a, i)) }), a = i;
      continue;
    }
    const s = e.slice(a, a + 2);
    if (Mn.has(s)) {
      t.push({ type: "operator", value: s }), a += 2;
      continue;
    }
    if (Bn.has(n)) {
      t.push({ type: "operator", value: n }), a++;
      continue;
    }
    if (xn.test(n)) {
      let i = a + 1;
      for (; i < u && kn.test(e[i]); ) i++;
      const l = e.slice(a, i), f = l.toLowerCase();
      f === "and" ? t.push({ type: "operator", value: "&" }) : f === "or" ? t.push({ type: "operator", value: "|" }) : f === "not" ? t.push({ type: "operator", value: "!" }) : t.push({ type: "word", value: l }), a = i;
      continue;
    }
    t.push({ type: "unknown", value: n }), a++;
  }
  return t;
}
function Hn(e) {
  ...
  return !!(t.type === "operator" || t.type === "lparen" || t.type === "word" && Rn.has(t.value.toUpperCase()));
}
function la(e, t, u) {
...
function vn(e, t, u) {
  for (const a of u) {
    ...
    for (let s = 0; s < a.length; s++) {
      const i = e[t + s];
      if (i.type !== "word" || i.value.toLowerCase() !== a[s]) {
        n = !1;
        break;
      }
    }
...
const Yn = /* @__PURE__ */ new Set(["long", "full", "short", "medium"]), Wn = [
  ["for", "each"],
  ["total", "of"],
  ["sum", "of"],
  ["average", "of"],
  ...
  ["as"],
  ["if"]
], Gn = [["then"], ["show"]], Kn = [["otherwise"], ["else"]], $n = [["else"], ["show"]], zn = [["in"]], Qn = [["do"]], qn = [["ascending"]], Vn = [["descending"]];
function V(e, t) {
  return vn(e.tokens, e.i, t);
}
function Y(e, t) {
  e.i += t.length;
}
function jn(e) {
  ...
  if (t.i < t.tokens.length) {
    const a = t.tokens.slice(t.i).map((n) => n.value).join(" ");
    throw new le(`Unexpected trailing tokens: ${a}`);
  }
  return u;
}
function H(e, t = 0) {
...
function da(e, t, u) {
  ...
  if (!a || a.type !== t || u != null) {
    const n = a ? `${a.type}:${a.value}` : "end of input";
...
function eu(e) {
  ...
  if (t.type === "word" && Jn(e)) {
    const a = Zn(e), n = tu(e);
    return n.length > 0 ? { type: "show", value: a, modifiers: n } : a;
  }
  {
    const a = e.i;
    try {
...
function Zn(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    if (a.type === "rparen" || a.type === "operator" || a.type === "word" && V(e, Je)) break;
    const n = J(e);
    if (n == null) break;
    u.push(n);
  }
...
function gu(e) {
  ...
  const a = t[0];
  return u.length === 0 && ts(a) ? { type: "show", value: a, modifiers: [] } : { type: "show", value: a, modifiers: u };
}
function es(e) {
  const t = [];
  for (; e.i < e.tokens.length; ) {
    ...
    if (u.type === "rparen" || u.type === "operator" || u.type === "word" && V(e, Je)) break;
    const a = J(e);
    if (a == null) break;
    t.push(a);
  }
...
function tu(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    switch (u.canonical) {
      case "AS": {
        Y(e, u), t.push({ type: "as", format: us(e) });
        break;
      }
      case "WITH LABEL": {
        Y(e, u);
        let a = null;
        H(e) && H(e).type === "string" && (a = w(e).value), t.push({ type: "withLabel", label: a });
        break;
      }
      case "SORTED BY": {
        Y(e, u);
        ...
        t.push({ type: "sortedBy", value: a, order: n });
        break;
      }
      ...
      case "JOINED BY": {
        ...
        w(e), t.push({ type: "joinedBy", sep: a.value });
        break;
      }
      case "WHERE":
      case "IF": {
...
function us(e) {
  ...
  for (; u.length < 2; ) {
    const s = H(e);
    if (!s || s.type !== "word" || V(e, Je)) break;
    u.push(w(e).value.toLowerCase());
  }
  if (u.length === 0)
    throw new le("AS requires a format type");
  const a = u[0], n = u[1];
  return n === "date" && Yn.has(a) ? { type: "date", value: a } : n === "only" && (a === "year" || a === "month") ? { type: "date", value: a === "year" ? "y" : "m" } : Pn.has(a) ? { type: a, value: n ?? null } : (n != null && e.i--, { type: a, value: null });
}
function as(e) {
  const t = uu(e), u = V(e, Gn);
  u && Y(e, u);
  const a = Nu(e);
  let n = null;
  const s = V(e, Kn);
  ...
  return { type: "if", condition: t, thenBranch: a, elseBranch: n };
}
function Nu(e) {
  return J(e);
}
...
function ns(e) {
  ...
  const u = V(e, zn);
  u && Y(e, u);
  const a = J(e), n = V(e, Qn);
  n && Y(e, n);
  const s = eu(e);
  return { type: "forEach", ident: t.value, list: a, body: s };
}
function uu(e) {
  return fa(e);
}
...
function Ht(e) {
  ...
  if (t && t.type === "lparen") {
    w(e);
    const u = fa(e);
    return da(e, "rparen"), { type: "group", inner: u };
  }
  return is(e);
}
...
function is(e) {
  const t = Cu(e), u = H(e);
  if (u && u.type === "operator" && ss.has(u.value)) {
    w(e);
    const a = Cu(e);
...
function k(e) {
  switch (e.type) {
    ...
    case "forEach":
      return Es(e);
    default:
      throw new ha(`Unknown node type: ${e.type}`);
  }
}
function cs(e) {
...
function ls(e) {
  ...
  if (u && e.value.type === "var" && t) {
    ...
    l.startsWith(f) && l.length > f.length && (a = l.slice(f.length));
  }
  let n, s = -1;
  const i = e.value;
  ...
  for (let l = 0; l < e.modifiers.length; l++) {
    ...
    switch (f.type) {
      ...
      case "sortedBy": {
        const m = Ts(f.value);
        n = `(>> ${f.order === "desc" ? "-desc " : ""}-by=${m} ${n})`, a && (n = `(. ${Me(a)} ${n})`, a = null);
        break;
      }
      case "joinedBy":
        n = `(+: ${Me(f.sep)} ${n})`;
      ...
      case "as":
        ...
        break;
      case "withLabel": {
        n = `(# -label${f.label != null ? `=${Me(f.label)}` : ""} ${n})`;
        break;
      }
      default:
        throw new ha(`Unknown modifier type: ${f.type}`);
    }
  }
  return n;
}
function ds(e) {
  ...
  if (e.modifiers.some((s) => s.type === "ifPresent"))
    return `(+? ${t.join(" ")})`;
  const a = e.modifiers.find((s) => s.type === "joinedBy"), n = a ? a.sep : "";
  return `(+: ${Me(n)} ${t.join(" ")})`;
}
function fs(e) {
...
class gs {
  ...
  evaluateText(t, u = null, a = null) {
    ...
    return this.core.evaluateText(n, u, a);
  }
  /**
...
function ye(e, t, u) {
  ...
  return Array.isArray(a) ? {
    ...e,
    content: a.map((n) => Ut(n, t, u))
  } : e;
}
function Ut(e, t, u) {
  if (!e || typeof e != "object") return e;
  const { type: a, content: n, text: s } = e;
  return a === "text" && typeof s == "string" ? {
    ...e,
    text: t.render(s, u)
  } : n && Array.isArray(n) ? {
    ...e,
...
function Ou(e, t, u, a) {
  ...
  const m = (i.length >= 3 ? i.slice(1, -1) : [i[1]]).reduce((h, p, g) => (g > 0 && h.push({ type: "divider" }), h.push(...p), h), []);
  for (const h of s) {
    const p = ye(
      { type: "doc", content: m },
      t,
...
function ma(e) {
  return Array.isArray(e) ? Math.round(e.reduce((t, u) => t + ru(u), 0) * 100) / 100 : 0;
}
function Rs(e, t = {}, u = {}) {
  const a = ma(e?.items), n = e?.tax?.jurisdiction || t.tax_jurisdiction || null;
  if (!n)
    return { jurisdiction: null, rate: 0, amount: 0, label: "" };
  const s = Ls(n, u), i = e?.tax?.rate != null ? Number(e.tax.rate) : s.rate, l = e?.tax?.amount != null ? Number(e.tax.amount) : Math.round(a * i * 100) / 100;
  return { jurisdiction: n, rate: i, amount: l, label: s.label };
}
function It(e, t = {}, u = {}) {
  const a = ma(e?.items), n = Rs(e, t, u), s = Math.round((a + n.amount) * 100) / 100;
  return {
    subtotal: a,
    tax_amount: n.amount,
    tax_rate: n.rate,
...
function ks({ invoices: e = [], sows: t = [] } = {}) {
  const u = [], a = (n, s, i, l) => u.push({ severity: n, code: s, recordType: "invoice", recordSlug: i, message: l });
  for (const n of e) {
    const s = n?.slug || n?.number || "(unknown)", i = Ms(n);
    if (!n?.sow_ref) {
      a(
        i ? "warn" : "info",
    ...
    ), Array.isArray(n?.items) && l?.expires && n.items.some((h) => xs(h?.period, l.expires)) && a(
      i ? "warn" : "info",
...
function Du(e, t) {
  const u = t?.website?.config?.business_docs || {}, a = u.vendor || {}, n = u.defaults || {}, s = u.registries?.tax || {}, i = xe("invoices", e, t), l = xe("sows", e, t), f = { vendor: a, defaults: n }, m = ba({ invoice: e?.invoice, invoices: i });
  if (m) {
    const p = It(m, n, s), g = Array.isArray(m.items) ? m.items.map((N) => ({ ...N, amount: ru(N) })) : [];
    return { ...f, ...m, items: g, ...p };
  }
  const h = pa({ sow: e?.sow, sows: l });
...
function vt(e) {
  ...
  if (e instanceof Date) {
    ...
    const t = e.getUTCFullYear(), u = String(e.getUTCMonth() + 1).padStart(2, "0"), a = String(e.getUTCDate()).padStart(2, "0");
    return `${t}-${u}-${a}`;
  }
  if (Array.isArray(e)) return e.map(vt);
  if (typeof e == "object") {
    const t = {};
    for (const [u, a] of Object.entries(e)) t[u] = vt(a);
    return t;
  }
  return e;
}
function Hs({ params: e, content: t, block: u }) {
  const a = e?.kind || u?.properties?.kind;
...
function Us(e, t) {
  const u = xe("invoices", e, t), a = xe("sows", e, t);
  if (u.length === 0 || a.length === 0 || Lu.has(t)) return;
  Lu.add(t);
  const n = ks({ invoices: u, sows: a });
  n.length > 0 && ws(n);
}
const We = {
  ...
  handlers: {
    content: (e, t) => {
      Us(e, t);
      const u = vt(Du(e, t)), a = t.rawContent?.doc ?? t.rawContent, n = t.properties?.source;
      if (!n) return ye(a, at, u);
      const s = t.properties?.where;
      if (s) {
        const i = u[n];
        if (Array.isArray(i)) {
          const l = i.filter(
            (f) => at.evaluateText(s, { ...u, ...f })
          );
          return Ou(a, at, { ...u, [n]: l }, n);
        }
      }
      return Ou(a, at, u, n);
    },
     ...
     */
    props: (e, t, u) => {
      const a = u.parsedContent?.data, n = Du(a, u), s = u?.website?.config?.business_docs || {}, i = s.vendor || {}, l = s.defaults || {}, f = s.registries?.tax || {}, m = ba({
        invoice: a?.invoice,
        invoices: xe("invoices", a, u)
      }), h = pa({
        sow: a?.sow,
        sows: xe("sows", a, u)
      }), p = m ? It(m, l, f) : null, g = m && Array.isArray(m.items) ? m.items.map((L) => ({ ...L, amount: ru(L) })) : [], N = Hs({ params: t, content: e, block: u });
      return {
        content: {
          ...e,
          __bd: { kind: N, invoice: m, sow: h, items: g, totals: p, vendor: i, defaults: l, namespace: n }
        },
        params: t
      };
    }
...
function Aa() {
  const e = /* @__PURE__ */ new WeakMap(), t = [], u = (a, n) => `${a}@${n && n.role || "body"}`;
  return {
    register(a, n, s, i = {}) {
      let l = e.get(a);
      l || (l = /* @__PURE__ */ new Map(), e.set(a, l), t.push(a)), l.set(u(n, i), { fragment: s, options: i });
    },
    getOutputs(a) {
      const n = [], s = `${a}@`;
      for (const i of t) {
...
function ga({
  ...
  ), /* @__PURE__ */ E(_a.Provider, { value: n, children: /* @__PURE__ */ E(Yt.Provider, { value: s, children: /* @__PURE__ */ E(Wt.Provider, { value: i, children: e }) }) });
}
function se(e, t, u, a = {}) {
  const n = At(_a);
  if (!n) {
...
function Ca(e) {
  return e >= 64976 && e <= 65007 || Ws.has(e);
}
var b;
(function(e) {
...
class zs {
  constructor(t) {
    this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = $s, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
  ...
  getError(t, u) {
    const { line: a, col: n, offset: s } = this, i = n + u, l = s + u;
    return {
      code: t,
      startLine: a,
      endLine: a,
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (Gs(u))
        return this.pos++, this._addGap(), Ks(t, u);
  ...
  advance() {
    ...
    return t === o.CARRIAGE_RETURN ? (this.isEol = !0, this.skipNextNewLine = !0, o.LINE_FEED) : t === o.LINE_FEED && (this.isEol = !0, this.skipNextNewLine) ? (this.line--, this.skipNextNewLine = !1, this._addGap(), this.advance()) : (this.skipNextNewLine = !1, Na(t) && (t = this._processSurrogate(t)), this.handler.onParseError === null || t > 31 && t < 127 || t === o.LINE_FEED || t === o.CARRIAGE_RETURN || t > 159 && t < 64976 || this._checkForProblematicCharacters(t), t);
  }
  _checkForProblematicCharacters(t) {
    Ia(t) ? this._err(b.controlCharacterInInputStream) : Ca(t) && this._err(b.noncharacterInInputStream);
  }
  retreat(t) {
...
const Qs = /* @__PURE__ */ new Uint16Array(
  // prettier-ignore
...
function Vs(e) {
  var t;
  return e >= 55296 && e <= 57343 || e > 1114111 ? 65533 : (t = qs.get(e)) !== null && t !== void 0 ? t : e;
}
var v;
(function(e) {
...
class ei {
  constructor(t, u, a) {
    this.decodeTree = t, this.emitCodePoint = u, this.errors = a, this.state = U.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = ie.Strict;
  }
  ...
  stateNumericStart(t, u) {
    return u >= t.length ? -1 : (t.charCodeAt(u) | js) === v.LOWER_X ? (this.state = U.NumericHex, this.consumed += 1, this.stateNumericHex(t, u + 1)) : (this.state = U.NumericDecimal, this.stateNumericDecimal(t, u));
  }
  addToNumericResult(t, u, a, n) {
    if (u !== a) {
      const s = a - u;
  ...
  stateNumericHex(t, u) {
    ...
    for (; u < t.length; ) {
      ...
      if (Gt(n) || Xs(n))
        ...
        return this.addToNumericResult(t, a, u, 16), this.emitNumericEntity(n, 3);
    }
  ...
  stateNumericDecimal(t, u) {
    ...
    for (; u < t.length; ) {
      ...
      if (Gt(n))
        ...
        return this.addToNumericResult(t, a, u, 10), this.emitNumericEntity(n, 2);
    }
  ...
  emitNumericEntity(t, u) {
    ...
    if (t === v.SEMI)
      ...
      return 0;
    return this.emitCodePoint(Vs(this.result), this.consumed), this.errors && (t !== v.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(t, u) {
    ...
    let n = a[this.treeIndex], s = (n & be.VALUE_LENGTH) >> 14;
    for (; u < t.length; u++, this.excess++) {
      const i = t.charCodeAt(u);
      if (this.treeIndex = ti(a, n, this.treeIndex + Math.max(1, s), i), this.treeIndex < 0)
        ...
        Zs(i)) ? 0 : this.emitNotTerminatedNamedEntity();
      if (n = a[this.treeIndex], s = (n & be.VALUE_LENGTH) >> 14, s !== 0) {
        if (i === v.SEMI)
  ...
  emitNotTerminatedNamedEntity() {
    var t;
    const { result: u, decodeTree: a } = this, n = (a[u] & be.VALUE_LENGTH) >> 14;
  ...
  emitNamedEntityData(t, u, a) {
    ...
    return this.emitCodePoint(u === 1 ? n[t] & ~be.VALUE_LENGTH : n[t + 1], a), u === 3 && this.emitCodePoint(n[t + 2], a), a;
  }
  /**
...
function Ct(e) {
  var t;
  return (t = ui.get(e)) !== null && t !== void 0 ? t : r.UNKNOWN;
}
const A = r, ai = {
  ...
  [_.MATHML]: /* @__PURE__ */ new Set([A.MI, A.MO, A.MN, A.MS, A.MTEXT, A.ANNOTATION_XML]),
  [_.SVG]: /* @__PURE__ */ new Set([A.TITLE, A.FOREIGN_OBJECT, A.DESC]),
...
function Mu(e) {
  return Oa(e) || e === o.SOLIDUS || e === o.GREATER_THAN_SIGN;
}
function si(e) {
  return e === o.NULL ? b.nullCharacterReference : e > 1114111 ? b.characterReferenceOutsideUnicodeRange : Na(e) ? b.surrogateCharacterReference : Ca(e) ? b.noncharacterCharacterReference : Ia(e) || e === o.CARRIAGE_RETURN ? b.controlCharacterReference : null;
}
class ii {
  constructor(t, u) {
    this.options = t, this.handler = u, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = c.DATA, this.returnState = c.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new zs(u), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new ei(Qs, (a, n) => {
  ...
  _err(t, u = 0) {
    var a, n;
    (n = (a = this.handler).onParseError) === null || n === void 0 || n.call(a, this.preprocessor.getError(t, u));
  }
  ...
  _leaveAttrName() {
    ...
    if (Sa(a, this.currentAttr.name) === null) {
      if (a.attrs.push(this.currentAttr), a.location && this.currentLocation) {
        const n = (t = (u = a.location).attrs) !== null && t !== void 0 ? t : u.attrs = /* @__PURE__ */ Object.create(null);
  ...
  _emitCodePoint(t) {
    const u = Oa(t) ? y.WHITESPACE_CHARACTER : t === o.NULL ? y.NULL_CHARACTER : y.CHARACTER;
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(Q.SCRIPT, !1) && Mu(this.preprocessor.peek(Q.SCRIPT.length))) {
      this._emitCodePoint(t);
...
const ya = /* @__PURE__ */ new Set([r.DD, r.DT, r.LI, r.OPTGROUP, r.OPTION, r.P, r.RB, r.RP, r.RT, r.RTC]), Bu = /* @__PURE__ */ new Set([
  ...ya,
  r.CAPTION,
  r.COLGROUP,
  r.TBODY,
  ...
  r.TEMPLATE,
  r.TH
]), oi = /* @__PURE__ */ new Set([...mt, r.OL, r.UL]), ci = /* @__PURE__ */ new Set([...mt, r.BUTTON]), xu = /* @__PURE__ */ new Set([r.ANNOTATION_XML, r.MI, r.MN, r.MO, r.MS, r.MTEXT]), ku = /* @__PURE__ */ new Set([r.DESC, r.FOREIGN_OBJECT, r.TITLE]), li = /* @__PURE__ */ new Set([r.TR, r.TEMPLATE, r.HTML]), di = /* @__PURE__ */ new Set([r.TBODY, r.TFOOT, r.THEAD, r.TEMPLATE, r.HTML]), fi = /* @__PURE__ */ new Set([r.TABLE, r.TEMPLATE, r.HTML]), hi = /* @__PURE__ */ new Set([r.TD, r.TH]);
class Ei {
  ...
  _isInTemplate() {
    return this.currentTagId === r.TEMPLATE && this.treeAdapter.getNamespaceURI(this.current) === _.HTML;
  }
  ...
  insertAfter(t, u, a) {
    ...
    this.items.splice(n, 0, u), this.tagIDs.splice(n, 0, a), this.stackTop++, n === this.stackTop && this._updateCurrentElement(), this.current && this.currentTagId !== void 0 && this.handler.onItemPush(this.current, this.currentTagId, n === this.stackTop);
  }
  popUntilTagNamePopped(t) {
    let u = this.stackTop + 1;
    do
      u = this.tagIDs.lastIndexOf(t, u - 1);
    while (u > 0 && this.treeAdapter.getNamespaceURI(this.items[u]) !== _.HTML);
  ...
  clearBackToTableContext() {
    this.clearBackTo(fi, _.HTML);
  }
  clearBackToTableBodyContext() {
    this.clearBackTo(di, _.HTML);
  }
  clearBackToTableRowContext() {
    this.clearBackTo(li, _.HTML);
  }
  remove(t) {
    const u = this._indexOf(t);
  ...
  hasInListItemScope(t) {
    return this.hasInDynamicScope(t, oi);
  }
  hasInButtonScope(t) {
  ...
  hasInTableScope(t) {
    for (let u = this.stackTop; u >= 0; u--)
      if (this.treeAdapter.getNamespaceURI(this.items[u]) === _.HTML)
  ...
  generateImpliedEndTags() {
    for (; this.currentTagId !== void 0 && ya.has(this.currentTagId); )
      this.pop();
  }
  generateImpliedEndTagsThoroughly() {
    for (; this.currentTagId !== void 0 && Bu.has(this.currentTagId); )
      this.pop();
  }
  generateImpliedEndTagsWithExclusion(t) {
    for (; this.currentTagId !== void 0 && this.currentTagId !== t && Bu.has(this.currentTagId); )
      this.pop();
  }
}
const Bt = 3;
...
class mi {
  ...
  _getNoahArkConditionCandidates(t, u) {
    const a = [], n = u.length, s = this.treeAdapter.getTagName(t), i = this.treeAdapter.getNamespaceURI(t);
    for (let l = 0; l < this.entries.length; l++) {
      ...
      if (this.treeAdapter.getTagName(m) === s && this.treeAdapter.getNamespaceURI(m) === i) {
        ...
        h.length === n && a.push({ idx: l, attrs: h });
      }
    }
    return a;
  }
  _ensureNoahArkCondition(t) {
    if (this.entries.length < Bt)
      return;
    ...
    for (let i = 0; i < a.length; i++) {
      const l = a[i];
      l.attrs.every((f) => n.get(f.name) === f.value) && (s += 1, s >= Bt && this.entries.splice(l.idx, 1));
    }
  }
  //Mutations
  insertMarker() {
  ...
  getElementEntryInScopeWithTagName(t) {
    const u = this.entries.find((a) => a.type === ae.Marker || this.treeAdapter.getTagName(a.element) === t);
    return u && u.type === ae.Element ? u : null;
  }
  getElementEntry(t) {
    return this.entries.find((u) => u.type === ae.Element && u.element === t);
  }
}
const Te = {
  //Node construction
  ...
  setDocumentType(e, t, u, a) {
    ...
    if (n)
      n.name = t, n.publicId = u, n.systemId = a;
    else {
      const s = {
  ...
  insertTextBefore(e, t, u) {
    ...
    a && Te.isTextNode(a) ? a.value += t : Te.insertBefore(e, Te.createTextNode(t), u);
  },
  adoptAttributes(e, t) {
...
}, Da = "html", Ti = "about:legacy-compat", bi = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", La = [
  ...
  "html"
]), Ra = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], Ai = [
  ...Ra,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function gi(e) {
  return e.name === Da && e.publicId === null && (e.systemId === null || e.systemId === Ti);
}
function Ni(e) {
  if (e.name !== Da)
    return j.QUIRKS;
  const { systemId: t } = e;
  if (t && t.toLowerCase() === bi)
    return j.QUIRKS;
  let { publicId: u } = e;
  if (u !== null) {
    if (u = u.toLowerCase(), _i.has(u))
      return j.QUIRKS;
    let a = t === null ? pi : La;
    if (Fu(u, a))
      return j.QUIRKS;
    if (a = t === null ? Ra : Ai, Fu(u, a))
...
const Hu = {
...
}, Ii = "definitionurl", Ci = "definitionURL", Si = new Map([
  "attributeName",
  "attributeType",
  "baseFrequency",
  "baseProfile",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((e) => [e.toLowerCase(), e])), Oi = /* @__PURE__ */ new Map([
  ["xlink:actuate", { prefix: "xlink", name: "actuate", namespace: _.XLINK }],
  ["xlink:arcrole", { prefix: "xlink", name: "arcrole", namespace: _.XLINK }],
  ["xlink:href", { prefix: "xlink", name: "href", namespace: _.XLINK }],
  ["xlink:role", { prefix: "xlink", name: "role", namespace: _.XLINK }],
  ["xlink:show", { prefix: "xlink", name: "show", namespace: _.XLINK }],
  ["xlink:title", { prefix: "xlink", name: "title", namespace: _.XLINK }],
  ["xlink:type", { prefix: "xlink", name: "type", namespace: _.XLINK }],
  ["xml:lang", { prefix: "xml", name: "lang", namespace: _.XML }],
  ["xml:space", { prefix: "xml", name: "space", namespace: _.XML }],
  ["xmlns", { prefix: "", name: "xmlns", namespace: _.XMLNS }],
  ["xmlns:xlink", { prefix: "xmlns", name: "xlink", namespace: _.XMLNS }]
]), yi = new Map([
  "altGlyph",
  "altGlyphDef",
  "altGlyphItem",
  ...
  "radialGradient",
  "textPath"
].map((e) => [e.toLowerCase(), e])), Di = /* @__PURE__ */ new Set([
  r.B,
  r.BIG,
  r.BLOCKQUOTE,
  r.BODY,
...
function Li(e) {
  const t = e.tagID;
  return t === r.FONT && e.attrs.some(({ name: a }) => a === Ae.COLOR || a === Ae.SIZE || a === Ae.FACE) || Di.has(t);
}
function Pa(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === Ii) {
      e.attrs[t].name = Ci;
      break;
    }
}
function Ma(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    const u = Si.get(e.attrs[t].name);
    u != null && (e.attrs[t].name = u);
  }
}
function nu(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    const u = Oi.get(e.attrs[t].name);
    u && (e.attrs[t].prefix = u.prefix, e.attrs[t].name = u.name, e.attrs[t].namespace = u.namespace);
  }
}
function Ri(e) {
  const t = yi.get(e.tagName);
  t != null && (e.tagName = t, e.tagID = Ct(e.tagName));
}
function Pi(e, t) {
  return t === _.MATHML && (e === r.MI || e === r.MO || e === r.MN || e === r.MS || e === r.MTEXT);
}
function Mi(e, t, u) {
  if (t === _.MATHML && e === r.ANNOTATION_XML) {
    for (let a = 0; a < u.length; a++)
      if (u[a].name === Ae.ENCODING) {
        const n = u[a].value.toLowerCase();
        return n === Hu.TEXT_HTML || n === Hu.APPLICATION_XML;
      }
  }
  return t === _.SVG && (e === r.FOREIGN_OBJECT || e === r.DESC || e === r.TITLE);
}
function Bi(e, t, u, a) {
  return (!a || a === _.HTML) && Mi(e, t, u) || (!a || a === _.MATHML) && Pi(e, t);
}
const xi = "hidden", ki = 8, wi = 3;
var d;
(function(e) {
...
const Fi = {
  ...
  endCol: -1,
  endOffset: -1
}, Ba = /* @__PURE__ */ new Set([r.TABLE, r.TBODY, r.TFOOT, r.THEAD, r.TR]), Uu = {
  scriptingEnabled: !0,
...
class Hi {
  constructor(t, u, a = null, n = null) {
    this.fragmentContext = a, this.scriptHandler = n, this.currentToken = null, this.stopped = !1, this.insertionMode = d.INITIAL, this.originalInsertionMode = d.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...Uu,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = u ?? this.treeAdapter.createDocument(), this.tokenizer = new ii(this.options, this), this.activeFormattingElements = new mi(this.treeAdapter), this.fragmentContextID = a ? Ct(this.treeAdapter.getTagName(a)) : r.UNKNOWN, this._setContextModes(a ?? this.document, this.fragmentContextID), this.openElements = new Ei(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, u) {
    const a = new this(u);
  ...
  static getFragmentParser(t, u) {
    ...
    t ?? (t = a.treeAdapter.createElement(T.TEMPLATE, _.HTML, []));
    const n = a.treeAdapter.createElement("documentmock", _.HTML, []), s = new this(a, n, t);
    return s.fragmentContextID === r.TEMPLATE && s.tmplInsertionModeStack.unshift(d.IN_TEMPLATE), s._initTokenizerForFragmentParsing(), s._insertFakeRootElement(), s._resetInsertionMode(), s._findFormInFragmentContext(), s;
  }
  getFragment() {
  ...
  _err(t, u, a) {
    ...
    if (!this.onParseError)
      return;
    const s = (n = t.location) !== null && n !== void 0 ? n : Fi, i = {
      code: u,
  ...
  onItemPush(t, u, a) {
    var n, s;
    (s = (n = this.treeAdapter).onItemPush) === null || s === void 0 || s.call(n, t), a && this.openElements.stackTop > 0 && this._setContextModes(t, u);
  }
  /** @internal */
  onItemPop(t, u) {
    var a, n;
    if (this.options.sourceCodeLocationInfo && this._setEndLocation(t, this.currentToken), (n = (a = this.treeAdapter).onItemPop) === null || n === void 0 || n.call(a, t, this.openElements.current), u) {
      let s, i;
  ...
  _setContextModes(t, u) {
    const a = t === this.document || t && this.treeAdapter.getNamespaceURI(t) === _.HTML;
  ...
  _switchToTextParsing(t, u) {
    this._insertElement(t, _.HTML), this.tokenizer.state = u, this.originalInsertionMode = this.insertionMode, this.insertionMode = d.TEXT;
  }
  ...
  _initTokenizerForFragmentParsing() {
    if (!(!this.fragmentContext || this.treeAdapter.getNamespaceURI(this.fragmentContext) !== _.HTML))
  ...
  /** @protected */
  _setDocumentType(t) {
    const u = t.name || "", a = t.publicId || "", n = t.systemId || "";
    if (this.treeAdapter.setDocumentType(this.document, u, a, n), t.location) {
  ...
  /** @protected */
  _insertTemplate(t) {
    const u = this.treeAdapter.createElement(t.tagName, _.HTML, t.attrs), a = this.treeAdapter.createDocumentFragment();
  ...
  _insertFakeRootElement() {
    const t = this.treeAdapter.createElement(T.HTML, _.HTML, []);
  ...
  _insertCharacters(t) {
    ...
    if (this._shouldFosterParentOnInsertion() ? ({ parent: u, beforeElement: a } = this._findFosterParentingLocation(), a ? this.treeAdapter.insertTextBefore(u, t.chars, a) : this.treeAdapter.insertText(u, t.chars)) : (u = this.openElements.currentTmplContentOrNode, this.treeAdapter.insertText(u, t.chars)), !t.location)
      return;
    const n = this.treeAdapter.getChildNodes(u), s = a ? n.lastIndexOf(a) : n.length, i = n[s - 1];
  ...
  _setEndLocation(t, u) {
    if (this.treeAdapter.getNodeSourceCodeLocation(t) && u.location) {
      const a = u.location, n = this.treeAdapter.getTagName(t), s = (
  ...
  shouldProcessStartTagTokenInForeignContent(t) {
    if (!this.currentNotInHTML)
      return !1;
    let u, a;
    return this.openElements.stackTop === 0 && this.fragmentContext ? (u = this.fragmentContext, a = this.fragmentContextID) : { current: u, currentTagId: a } = this.openElements, t.tagID === r.SVG && this.treeAdapter.getTagName(u) === T.ANNOTATION_XML && this.treeAdapter.getNamespaceURI(u) === _.MATHML ? !1 : (
      // Check that `current` is not an integration point for HTML or MathML elements.
      this.tokenizer.inForeignNode || // If it _is_ an integration point, then we might have to check that it is not an HTML
      // integration point.
      (t.tagID === r.MGLYPH || t.tagID === r.MALIGNMARK) && a !== void 0 && !this._isIntegrationPoint(a, u, _.HTML)
    );
  }
  /** @protected */
  _processToken(t) {
  ...
  _reconstructActiveFormattingElements() {
    ...
    if (t) {
      const u = this.activeFormattingElements.entries.findIndex((n) => n.type === ae.Marker || this.openElements.contains(n.element)), a = u === -1 ? t - 1 : u - 1;
      for (let n = a; n >= 0; n--) {
  ...
  _findFosterParentingLocation() {
    for (let t = this.openElements.stackTop; t >= 0; t--) {
      ...
      switch (this.openElements.tagIDs[t]) {
        case r.TEMPLATE: {
          if (this.treeAdapter.getNamespaceURI(u) === _.HTML)
   ...
   */
  _processStartTag(t) {
    this.shouldProcessStartTagTokenInForeignContent(t) ? Tc(this, t) : this._startTagOutsideForeignContent(t);
  }
  /** @protected */
  ...
  /** @internal */
  onEndTag(t) {
    this.skipNextNewLine = !1, this.currentToken = t, this.currentNotInHTML ? bc(this, t) : this._endTagOutsideForeignContent(t);
  }
  /** @protected */
...
function Ui(e, t) {
  ...
  return u ? e.openElements.contains(u.element) ? e.openElements.hasInScope(t.tagID) || (u = null) : (e.activeFormattingElements.removeEntry(u), u = null) : Ha(e, t), u;
}
function vi(e, t) {
  ...
  for (; a >= 0; a--) {
    ...
    if (n === t.element)
      break;
    e._isSpecialElement(n, e.openElements.tagIDs[a]) && (u = n);
  }
...
function Yi(e, t, u) {
  ...
  for (let s = 0, i = n; i !== u; s++, i = n) {
    ...
    const l = e.activeFormattingElements.getElementEntry(i), f = l && s >= wi;
    !l || f ? (f && e.activeFormattingElements.removeEntry(l), e.openElements.remove(i)) : (i = Wi(e, l), a === t && (e.activeFormattingElements.bookmark = l), e.treeAdapter.detachNode(a), e.treeAdapter.appendChild(i, a), a = i);
  }
  return a;
}
function Wi(e, t) {
...
function Gi(e, t, u) {
  const a = e.treeAdapter.getTagName(t), n = Ct(a);
  if (e._isElementCausesFosterParenting(n))
    e._fosterParentElement(u);
  else {
    const s = e.treeAdapter.getNamespaceURI(t);
    n === r.TEMPLATE && s === _.HTML && (t = e.treeAdapter.getTemplateContent(t)), e.treeAdapter.appendChild(t, u);
  }
}
function Ki(e, t, u) {
  const a = e.treeAdapter.getNamespaceURI(u.element), { token: n } = u, s = e.treeAdapter.createElement(n.tagName, a, n.attrs);
...
function su(e, t) {
  for (let u = 0; u < ki; u++) {
    ...
    const s = Yi(e, n, a.element), i = e.openElements.getCommonAncestor(a.element);
    e.treeAdapter.detachNode(s), i && Gi(e, i, s), Ki(e, n, a);
  }
}
function $t(e, t) {
...
function Qi(e, t) {
  ...
  const u = t.forceQuirks ? j.QUIRKS : Ni(t);
  gi(t) || e._err(t, b.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, u), e.insertionMode = d.BEFORE_HTML;
}
function we(e, t) {
...
function qi(e, t) {
  t.tagID === r.HTML ? (e._insertElement(t, _.HTML), e.insertionMode = d.BEFORE_HEAD) : Ge(e, t);
}
function Vi(e, t) {
  const u = t.tagID;
  (u === r.HTML || u === r.HEAD || u === r.BODY || u === r.BR) && Ge(e, t);
}
function Ge(e, t) {
...
function ji(e, t) {
  switch (t.tagID) {
    ...
    case r.HEAD: {
      e._insertElement(t, _.HTML), e.headElement = e.openElements.current, e.insertionMode = d.IN_HEAD;
      break;
    }
    default:
      Ke(e, t);
...
function Xi(e, t) {
  const u = t.tagID;
  u === r.HEAD || u === r.BODY || u === r.HTML || u === r.BR ? Ke(e, t) : e._err(t, b.endTagWithoutMatchingOpenElement);
}
function Ke(e, t) {
  e._insertFakeElement(T.HEAD, r.HEAD), e.headElement = e.openElements.current, e.insertionMode = d.IN_HEAD, e._processToken(t);
}
function te(e, t) {
  switch (t.tagID) {
    case r.HTML: {
    ...
    case r.NOSCRIPT: {
      e.options.scriptingEnabled ? e._switchToTextParsing(t, q.RAWTEXT) : (e._insertElement(t, _.HTML), e.insertionMode = d.IN_HEAD_NO_SCRIPT);
      break;
    }
    case r.NOFRAMES:
    case r.STYLE: {
...
function Oe(e, t) {
  e.openElements.tmplCount > 0 ? (e.openElements.generateImpliedEndTagsThoroughly(), e.openElements.currentTagId !== r.TEMPLATE && e._err(t, b.closingOfElementWithOpenChildElements), e.openElements.popUntilTagNamePopped(r.TEMPLATE), e.activeFormattingElements.clearToLastMarker(), e.tmplInsertionModeStack.shift(), e._resetInsertionMode()) : e._err(t, b.endTagWithoutMatchingOpenElement);
}
function $e(e, t) {
...
function to(e, t) {
  switch (t.tagID) {
    ...
    case r.BODY: {
      e._insertElement(t, _.HTML), e.framesetOk = !1, e.insertionMode = d.IN_BODY;
      break;
    }
    case r.FRAMESET: {
      e._insertElement(t, _.HTML), e.insertionMode = d.IN_FRAMESET;
      break;
    }
    case r.BASE:
    case r.BASEFONT:
    ...
    case r.TEMPLATE:
    case r.TITLE: {
      e._err(t, b.abandonedHeadElementChild), e.openElements.push(e.headElement, r.HEAD), te(e, t), e.openElements.remove(e.headElement);
      break;
    }
    case r.HEAD: {
      e._err(t, b.misplacedStartTagForHeadElement);
...
function Qe(e, t) {
  e._insertFakeElement(T.BODY, r.BODY), e.insertionMode = d.IN_BODY, St(e, t);
}
function St(e, t) {
  switch (t.type) {
    case y.CHARACTER: {
...
function no(e, t) {
  const u = e.openElements.tryPeekProperlyNestedBodyElement();
  e.framesetOk && u && (e.treeAdapter.detachNode(u), e.openElements.popAllUpToHtmlElement(), e._insertElement(t, _.HTML), e.insertionMode = d.IN_FRAMESET);
}
function so(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, _.HTML);
}
function io(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e.openElements.currentTagId !== void 0 && Kt.has(e.openElements.currentTagId) && e.openElements.pop(), e._insertElement(t, _.HTML);
}
function oo(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, _.HTML), e.skipNextNewLine = !0, e.framesetOk = !1;
}
function co(e, t) {
  const u = e.openElements.tmplCount > 0;
  (!e.formElement || u) && (e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, _.HTML), u || (e.formElement = e.openElements.current));
}
function lo(e, t) {
  e.framesetOk = !1;
  const u = t.tagID;
  for (let a = e.openElements.stackTop; a >= 0; a--) {
    ...
    if (u === r.LI && n === r.LI || (u === r.DD || u === r.DT) && (n === r.DD || n === r.DT)) {
      e.openElements.generateImpliedEndTagsWithExclusion(n), e.openElements.popUntilTagNamePopped(n);
      break;
    }
    if (n !== r.ADDRESS && n !== r.DIV && n !== r.P && e._isSpecialElement(e.openElements.items[a], n))
      break;
  }
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, _.HTML);
}
function fo(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, _.HTML), e.tokenizer.state = q.PLAINTEXT;
}
function ho(e, t) {
  e.openElements.hasInScope(r.BUTTON) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(r.BUTTON)), e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML), e.framesetOk = !1;
}
function Eo(e, t) {
  const u = e.activeFormattingElements.getElementEntryInScopeWithTagName(T.A);
  u && (su(e, t), e.openElements.remove(u.element), e.activeFormattingElements.removeEntry(u)), e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
}
function mo(e, t) {
...
function To(e, t) {
  e._reconstructActiveFormattingElements(), e.openElements.hasInScope(r.NOBR) && (su(e, t), e._reconstructActiveFormattingElements()), e._insertElement(t, _.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
}
function bo(e, t) {
  e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML), e.activeFormattingElements.insertMarker(), e.framesetOk = !1;
}
function po(e, t) {
  e.treeAdapter.getDocumentMode(e.document) !== j.QUIRKS && e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, _.HTML), e.framesetOk = !1, e.insertionMode = d.IN_TABLE;
}
function wa(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, _.HTML), e.framesetOk = !1, t.ackSelfClosing = !0;
}
function Fa(e) {
  const t = Sa(e, Ae.TYPE);
  return t != null && t.toLowerCase() === xi;
}
function _o(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, _.HTML), Fa(t) || (e.framesetOk = !1), t.ackSelfClosing = !0;
}
function Ao(e, t) {
  e._appendElement(t, _.HTML), t.ackSelfClosing = !0;
}
function go(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._appendElement(t, _.HTML), e.framesetOk = !1, t.ackSelfClosing = !0;
}
function No(e, t) {
  t.tagName = T.IMG, t.tagID = r.IMG, wa(e, t);
}
function Io(e, t) {
  e._insertElement(t, _.HTML), e.skipNextNewLine = !0, e.tokenizer.state = q.RCDATA, e.originalInsertionMode = e.insertionMode, e.framesetOk = !1, e.insertionMode = d.TEXT;
}
function Co(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._reconstructActiveFormattingElements(), e.framesetOk = !1, e._switchToTextParsing(t, q.RAWTEXT);
}
function So(e, t) {
...
function Oo(e, t) {
  e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML), e.framesetOk = !1, e.insertionMode = e.insertionMode === d.IN_TABLE || e.insertionMode === d.IN_CAPTION || e.insertionMode === d.IN_TABLE_BODY || e.insertionMode === d.IN_ROW || e.insertionMode === d.IN_CELL ? d.IN_SELECT_IN_TABLE : d.IN_SELECT;
}
function yo(e, t) {
  e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML);
}
function Do(e, t) {
  e.openElements.hasInScope(r.RUBY) && e.openElements.generateImpliedEndTags(), e._insertElement(t, _.HTML);
}
function Lo(e, t) {
  e.openElements.hasInScope(r.RUBY) && e.openElements.generateImpliedEndTagsWithExclusion(r.RTC), e._insertElement(t, _.HTML);
}
function Ro(e, t) {
  e._reconstructActiveFormattingElements(), Pa(t), nu(t), t.selfClosing ? e._appendElement(t, _.MATHML) : e._insertElement(t, _.MATHML), t.ackSelfClosing = !0;
}
function Po(e, t) {
  e._reconstructActiveFormattingElements(), Ma(t), nu(t), t.selfClosing ? e._appendElement(t, _.SVG) : e._insertElement(t, _.SVG), t.ackSelfClosing = !0;
}
function Yu(e, t) {
...
function Mo(e, t) {
  if (e.openElements.hasInScope(r.BODY) && (e.insertionMode = d.AFTER_BODY, e.options.sourceCodeLocationInfo)) {
    const u = e.openElements.tryPeekProperlyNestedBodyElement();
    u && e._setEndLocation(u, t);
  }
}
function Bo(e, t) {
  e.openElements.hasInScope(r.BODY) && (e.insertionMode = d.AFTER_BODY, Qa(e, t));
}
function xo(e, t) {
  const u = t.tagID;
...
function Yo(e) {
  e._reconstructActiveFormattingElements(), e._insertFakeElement(T.BR, r.BR), e.openElements.pop(), e.framesetOk = !1;
}
function Ha(e, t) {
  const u = t.tagName, a = t.tagID;
  for (let n = e.openElements.stackTop; n > 0; n--) {
    const s = e.openElements.items[n], i = e.openElements.tagIDs[n];
    if (a === i && (a !== r.UNKNOWN || e.treeAdapter.getTagName(s) === u)) {
...
function Ua(e, t) {
  e.tmplInsertionModeStack.length > 0 ? za(e, t) : iu(e, t);
}
function Wo(e, t) {
  var u;
...
function xt(e, t) {
  if (e.openElements.currentTagId !== void 0 && Ba.has(e.openElements.currentTagId))
...
function Ko(e, t) {
  e.openElements.clearBackToTableContext(), e.activeFormattingElements.insertMarker(), e._insertElement(t, _.HTML), e.insertionMode = d.IN_CAPTION;
}
function $o(e, t) {
  e.openElements.clearBackToTableContext(), e._insertElement(t, _.HTML), e.insertionMode = d.IN_COLUMN_GROUP;
}
function zo(e, t) {
  e.openElements.clearBackToTableContext(), e._insertFakeElement(T.COLGROUP, r.COLGROUP), e.insertionMode = d.IN_COLUMN_GROUP, ou(e, t);
}
function Qo(e, t) {
  e.openElements.clearBackToTableContext(), e._insertElement(t, _.HTML), e.insertionMode = d.IN_TABLE_BODY;
}
function qo(e, t) {
  e.openElements.clearBackToTableContext(), e._insertFakeElement(T.TBODY, r.TBODY), e.insertionMode = d.IN_TABLE_BODY, yt(e, t);
}
function Vo(e, t) {
...
function jo(e, t) {
  Fa(t) ? e._appendElement(t, _.HTML) : et(e, t), t.ackSelfClosing = !0;
}
function Xo(e, t) {
...
function Fe(e, t) {
  ...
  if (e.hasNonWhitespacePendingCharacterToken)
    for (; u < e.pendingCharacterTokens.length; u++)
      et(e, e.pendingCharacterTokens[u]);
  else
    for (; u < e.pendingCharacterTokens.length; u++)
      e._insertCharacters(e.pendingCharacterTokens[u]);
  e.insertionMode = e.originalInsertionMode, e._processToken(t);
}
const Wa = /* @__PURE__ */ new Set([r.CAPTION, r.COL, r.COLGROUP, r.TBODY, r.TD, r.TFOOT, r.TH, r.THEAD, r.TR]);
function Jo(e, t) {
  const u = t.tagID;
  Wa.has(u) ? e.openElements.hasInTableScope(r.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(r.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, ke(e, t)) : K(e, t);
}
function Zo(e, t) {
  const u = t.tagID;
  switch (u) {
    case r.CAPTION:
    case r.TABLE: {
      e.openElements.hasInTableScope(r.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(r.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, u === r.TABLE && Xe(e, t));
      break;
    }
    case r.BODY:
    case r.COL:
...
function ec(e, t) {
  switch (t.tagID) {
    case r.COLGROUP: {
      e.openElements.currentTagId === r.COLGROUP && (e.openElements.pop(), e.insertionMode = d.IN_TABLE);
      break;
    }
    case r.TEMPLATE: {
      Oe(e, t);
...
function Tt(e, t) {
  e.openElements.currentTagId === r.COLGROUP && (e.openElements.pop(), e.insertionMode = d.IN_TABLE, e._processToken(t));
}
function yt(e, t) {
  switch (t.tagID) {
    case r.TR: {
      e.openElements.clearBackToTableBodyContext(), e._insertElement(t, _.HTML), e.insertionMode = d.IN_ROW;
      break;
    }
    case r.TH:
    case r.TD: {
      e.openElements.clearBackToTableBodyContext(), e._insertFakeElement(T.TR, r.TR), e.insertionMode = d.IN_ROW, Dt(e, t);
      break;
    }
    case r.CAPTION:
    case r.COL:
...
function zt(e, t) {
  ...
  switch (t.tagID) {
    ...
    case r.TABLE: {
      e.openElements.hasTableBodyContextInTableScope() && (e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE, Xe(e, t));
      break;
    }
    case r.BODY:
    case r.CAPTION:
...
function Dt(e, t) {
  switch (t.tagID) {
    case r.TH:
    case r.TD: {
      e.openElements.clearBackToTableRowContext(), e._insertElement(t, _.HTML), e.insertionMode = d.IN_CELL, e.activeFormattingElements.insertMarker();
      break;
    }
    case r.CAPTION:
    case r.COL:
    ...
    case r.THEAD:
    case r.TR: {
      e.openElements.hasInTableScope(r.TR) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE_BODY, yt(e, t));
      break;
    }
    default:
      ke(e, t);
...
function Ga(e, t) {
  switch (t.tagID) {
    case r.TR: {
      e.openElements.hasInTableScope(r.TR) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE_BODY);
      break;
    }
    case r.TABLE: {
      e.openElements.hasInTableScope(r.TR) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE_BODY, zt(e, t));
      break;
    }
    case r.TBODY:
    case r.TFOOT:
    case r.THEAD: {
      (e.openElements.hasInTableScope(t.tagID) || e.openElements.hasInTableScope(r.TR)) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE_BODY, zt(e, t));
      break;
    }
    case r.BODY:
    case r.CAPTION:
...
function tc(e, t) {
  const u = t.tagID;
  Wa.has(u) ? (e.openElements.hasInTableScope(r.TD) || e.openElements.hasInTableScope(r.TH)) && (e._closeTableCell(), Dt(e, t)) : K(e, t);
}
function uc(e, t) {
  const u = t.tagID;
  switch (u) {
    ...
    case r.THEAD:
    case r.TR: {
      e.openElements.hasInTableScope(u) && (e._closeTableCell(), Ga(e, t));
      break;
    }
    case r.BODY:
    case r.CAPTION:
...
function Ka(e, t) {
  switch (t.tagID) {
    ...
    case r.OPTION: {
      e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e._insertElement(t, _.HTML);
      break;
    }
    case r.OPTGROUP: {
      e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e.openElements.currentTagId === r.OPTGROUP && e.openElements.pop(), e._insertElement(t, _.HTML);
      break;
    }
    case r.HR: {
      e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e.openElements.currentTagId === r.OPTGROUP && e.openElements.pop(), e._appendElement(t, _.HTML), t.ackSelfClosing = !0;
      break;
    }
    case r.INPUT:
    case r.KEYGEN:
...
function ac(e, t) {
  const u = t.tagID;
  u === r.CAPTION || u === r.TABLE || u === r.TBODY || u === r.TFOOT || u === r.THEAD || u === r.TR || u === r.TD || u === r.TH ? (e.openElements.popUntilTagNamePopped(r.SELECT), e._resetInsertionMode(), e._processStartTag(t)) : Ka(e, t);
}
function rc(e, t) {
  const u = t.tagID;
  u === r.CAPTION || u === r.TABLE || u === r.TBODY || u === r.TFOOT || u === r.THEAD || u === r.TR || u === r.TD || u === r.TH ? e.openElements.hasInTableScope(u) && (e.openElements.popUntilTagNamePopped(r.SELECT), e._resetInsertionMode(), e.onEndTag(t)) : $a(e, t);
}
function nc(e, t) {
  switch (t.tagID) {
...
function sc(e, t) {
  t.tagID === r.TEMPLATE && Oe(e, t);
}
function za(e, t) {
  e.openElements.tmplCount > 0 ? (e.openElements.popUntilTagNamePopped(r.TEMPLATE), e.activeFormattingElements.clearToLastMarker(), e.tmplInsertionModeStack.shift(), e._resetInsertionMode(), e.onEof(t)) : iu(e, t);
}
function ic(e, t) {
  t.tagID === r.HTML ? K(e, t) : bt(e, t);
}
function Qa(e, t) {
  var u;
  if (t.tagID === r.HTML) {
    if (e.fragmentContext || (e.insertionMode = d.AFTER_AFTER_BODY), e.options.sourceCodeLocationInfo && e.openElements.tagIDs[0] === r.HTML) {
...
function cc(e, t) {
  t.tagID === r.FRAMESET && !e.openElements.isRootHtmlElementCurrent() && (e.openElements.pop(), !e.fragmentContext && e.openElements.currentTagId !== r.FRAMESET && (e.insertionMode = d.AFTER_FRAMESET));
}
function lc(e, t) {
  switch (t.tagID) {
    case r.HTML: {
...
function dc(e, t) {
  t.tagID === r.HTML && (e.insertionMode = d.AFTER_AFTER_FRAMESET);
}
function fc(e, t) {
  t.tagID === r.HTML ? K(e, t) : lt(e, t);
}
function lt(e, t) {
  e.insertionMode = d.IN_BODY, St(e, t);
}
...
function qa(e) {
  for (; e.treeAdapter.getNamespaceURI(e.openElements.current) !== _.HTML && e.openElements.currentTagId !== void 0 && !e._isIntegrationPoint(e.openElements.currentTagId, e.openElements.current); )
    e.openElements.pop();
}
function Tc(e, t) {
  if (Li(t))
    qa(e), e._startTagOutsideForeignContent(t);
  else {
    const u = e._getAdjustedCurrentElement(), a = e.treeAdapter.getNamespaceURI(u);
    a === _.MATHML ? Pa(t) : a === _.SVG && (Ri(t), Ma(t)), nu(t), t.selfClosing ? e._appendElement(t, a) : e._insertElement(t, a), t.ackSelfClosing = !0;
  }
}
function bc(e, t) {
...
function pc(e, t, u) {
  ...
  const a = Hi.getFragmentParser(e, u);
  return a.tokenizer.write(t, !0), a.getFragment();
}
const _c = () => ({}), He = () => !0, Ee = (e) => {
  const t = parseInt(e, 10);
  return Number.isFinite(t) ? t : e;
}, Ac = (e) => typeof e != "string" ? e : e.split(",").map((t) => t.trim()).filter(Boolean).map((t) => parseInt(t, 10)).filter((t) => Number.isFinite(t)), gc = {
  "data-underline": { path: ["underline"], transform: _c },
...
function Nc(e, t, u) {
  ...
  for (let n = 0; n < t.length - 1; n++) {
    const s = t[n];
    (!a[s] || typeof a[s] != "object") && (a[s] = {}), a = a[s];
  }
  a[t[t.length - 1]] = u;
}
function Ic(e) {
  ...
  for (const { name: u, value: a } of e) {
    ...
    const n = gc[u];
    if (n) {
      const s = n.transform ? n.transform(a) : a;
      Nc(t, n.path, s);
    } else {
      const s = u.slice(5);
      t[s] = a;
...
function Oc(e) {
  ...
  const a = Wu(e, "data-type") || t;
  if (a === "emptyLine") return null;
  if (a === "contentWrapper")
    return Qt(e);
  const n = Ic(e.attrs || []), s = Qt(e);
  if (a === "a" && n.href === void 0) {
    const l = Wu(e, "href");
    l && (n.href = l);
  }
  const i = { type: a, ...n };
  return a === "text" ? i.content = s.map((l) => l.content || "").join("") : s.length > 0 && (i.children = s), i;
}
function Qt(e) {
...
const yc = {
  docx: { load: () => import("./docx-C-HDMeDL.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-ByoeiX6E.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-BMf04yM1.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-C7tawh8j.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-QOiQsQN7.js"), consumes: "html", ir: !1 }
};
function cu(e) {
  const t = yc[e];
  return t ? {
...
async function Dc(e, t, u = {}) {
  const a = cu(e);
  if (!a)
    throw new Error(`Unsupported document format: "${e}"`);
  const n = await a.load(), s = n.compileDocx || n.compileXlsx || n.compileTypst || n.compileLatex || n.compilePagedjs || n.compileEpub || n.compilePdf;
  if (!s)
    throw new Error(
...
function Lc(e, t) {
  ...
  return u.ir ? Rc(a, e) : u.consumes === "html" ? Pc(a, e) : Mc(a);
}
function Rc(e, t) {
  let u = null, a = null, n = null, s = !1, i = !1;
  ...
  for (const { fragment: m, options: h } of e) {
    ...
    const g = Jt(f(m)), N = Cc(g);
    switch (p) {
      case "header":
        a = N, h.applyTo === "first" && (s = !0);
        break;
      case "footer":
...
function xc(e, t, u = {}) {
  const { basePath: a, theme: n } = u, s = Aa();
  return Jt(
    kt(
      ga,
      { store: s, basePath: a, theme: n },
      e
    )
  ), kc(s, t), Lc(s, t);
}
...
function kc(e, t) {
  ...
  if (!u) return;
  const a = u.consumes;
  if (!(Gu.has(a) || (e.getOutputs && e.getOutputs(a) || []).length > 0) && (Gu.add(a), typeof console < "u" && console.warn)) {
    const s = a === t ? `compileSubtree('${t}') found 0 registered sections. Did any section component call useDocumentOutput(block, '${t}', ...)?` : `compileSubtree('${t}') found 0 sections registered under input key '${a}'. Sections should call useDocumentOutput(block, '${a}', ...) (the output format '${t}' reads fragments registered under '${a}').`;
    console.warn(
      `@uniweb/press: ${s} Sections registered for a different input key do not cross-register.`
    );
  }
}
async function Ku(e, t, u = {}) {
  const { basePath: a, theme: n, adapterOptions: s = {} } = u, i = xc(e, t, { basePath: a, theme: n });
  return Dc(t, i, s);
}
async function wc(e, t = {}) {
  ...
  const L = N.via ?? n, B = N.getOptions ? await N.getOptions(a, { format: n, rootPath: i, loadAsset: p, ...h }) : {}, x = {
    ...
    ...B.adapterOptions,
    ...l
  }, R = Uc(a, i), D = globalThis.uniweb?.childBlockRenderer;
...
function Hc(e) {
  return async function(u) {
    ...
    if (!/^https?:\/\//i.test(a) && !a.startsWith("data:")) {
      const s = (e?.basePath || "") + (a.startsWith("/") ? a : "/" + a);
      a = typeof window < "u" && window.location?.origin ? window.location.origin + s : s;
    }
    const n = await fetch(a);
    if (!n.ok)
      throw new Error(
        "loadAsset: fetch failed for " + a + " (" + n.status + ")"
      );
...
function ja(e) {
  const t = ea()?.activeWebsite ?? null, u = e && t ? or(e) : null, a = u ? t.dataStore.get(u) : null, [n, s] = ct(
    () => a ? nt(a.data) : u ? zu() : $u()
  );
  return gt(() => {
    if (!u || !t) {
    ...
    return t.fetcher.dispatch(e, { website: t, signal: f.signal }).then((m) => {
      if (!f.signal.aborted) {
        if (m?.error) {
          s(Qu(m.error, m.data ?? null));
          return;
        }
        m && "data" in m && s(nt(m.data));
      }
    }).catch((m) => {
      f.signal.aborted || s(Qu(String(m?.message || m)));
    }), () => {
      f.abort(), l();
    };
  }, [u, t]), n;
...
function Lt(e, t) {
  const { website: u } = lu(), [, a] = ar(Yc, 0), s = u.activePage?.state;
  gt(() => {
    if (s)
      return s.subscribe(e, a);
  }, [s, e]);
...
const Xa = "business-docs/report-options", he = {
  source: "invoices",
...
function Wc() {
  ...
  try {
    const e = window.localStorage.getItem(Xa);
    if (!e) return null;
    const t = JSON.parse(e);
    return {
...
function Gc(e) {
  ...
  try {
    window.localStorage.setItem(Xa, JSON.stringify(t));
  } catch {
  }
}
...
function Kc(e) {
  ...
  const u = () => Gc(e), a = qt.map((n) => e.state.subscribe(n, u));
...
const Vc = /* @__PURE__ */ new Set(["paid", "void"]);
function jc({ source: e, dateRange: t, client: u, status: a }) {
  const n = [e === "sows" ? "SOWs" : "Invoices"];
  return (t?.from || t?.to) && n.push(`${t.from || ""}–${t.to || ""}`), u && n.push(u), a && n.push(a), n.length > 1 ? n.join(" · ") : null;
}
function Xc(e) {
...
function e0(e, t, u, a) {
  ...
  if (t === "invoices")
    for (const l of e) {
      const f = It(l, u, a);
      n += f.subtotal, s += f.total, Vc.has(String(l?.status)) || (i += f.total);
    }
  else
    for (const l of e) {
...
function t0(e, t) {
  const [u] = Ja(), [a] = $c(), [n] = zc(), [s] = Qc(), i = t?.website?.config?.business_docs || {}, l = i.defaults || {}, f = i.registries?.tax || {}, m = _e(
    () => qc({ dateRange: a, client: n, status: s }),
    [a, n, s]
  ), h = _e(
    () => Zc(u, e),
    [u, e?.data?.invoices, e?.data?.sows]
  ), { data: p, loading: g } = ja(
    m ? { path: Xc(u), schema: Jc(u), where: m } : null
  ), N = m ? p || [] : h, { sumSubtotals: L, sumTotals: B, sumOutstanding: x } = _e(
    () => e0(N, u, l, f),
    [N, u, l, f]
  );
  return {
    ...
    sumOutstanding: x,
    activeWhere: m,
    activeLabel: jc({ source: u, dateRange: a, client: n, status: s }),
    totalCount: h.length,
    loading: m ? g : !1
  };
}
function u0(e, { currency: t = "CAD", locale: u = "en-CA" } = {}) {
  const a = Number(e);
...
function Vu(e, t) {
  if (!e) return "";
  const u = Vt(e.from, t), a = Vt(e.to, t);
  return u && a ? `${u} – ${a}` : u || a;
}
function Y0({ content: e, block: t }) {
  const u = t?.website?.config?.business_docs || {}, a = u.defaults || {}, n = u.registries?.tax || {}, s = a.currency || "CAD", i = a.locale || "en-CA", l = (I) => u0(I, { currency: s, locale: i }), f = (I) => Vt(I, { locale: i }), [m] = Ja(), h = m !== "sows", {
    records: p,
    count: g,
    sumSubtotals: N,
    sumTotals: L,
  ...
  const tt = e?.title || (h ? "Invoice report" : "SOW report"), ut = x || e?.subtitle || (h ? "All invoices" : "All SOWs");
  return /* @__PURE__ */ C("section", { className: "engagement-report", children: [
    /* @__PURE__ */ C("header", { children: [
      /* @__PURE__ */ E("h1", { children: tt }),
      /* @__PURE__ */ E("p", { className: "engagement-report-subtitle", children: ut }),
    ...
    /* @__PURE__ */ C("div", { className: "engagement-report-cards", role: "list", children: [
      /* @__PURE__ */ E(st, { label: "Records", value: g }),
      /* @__PURE__ */ E(st, { label: "Subtotal", value: l(N) }),
      /* @__PURE__ */ E(st, { label: "Total", value: l(L) }),
      h && /* @__PURE__ */ E(st, { label: "Outstanding", value: l(B) })
    ] }),
    ...
    /* @__PURE__ */ C("table", { className: "engagement-report-table", children: [
      ...
      /* @__PURE__ */ E("tbody", { children: z.map(
        (I) => h ? /* @__PURE__ */ C("tr", { children: [
          ...
          /* @__PURE__ */ E("td", { children: I.period ? Vu(I.period, { locale: i }) : "" }),
...
function r0(e, t, u, a) {
  const n = It(e, u, a), s = e?.sow_ref ? t.get(String(e.sow_ref)) : null, i = Number(s?.budget?.total) || 0, l = i > 0 ? n.total / i * 100 : null;
  return { ...e, _totals: n, _percentBilled: l };
}
function n0(e, t) {
  const u = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map(), n = (i, l, f) => {
  ...
  for (const i of e) {
    ...
    n(u, i.client?.organization || "(no client)", l), n(a, i.status || "(no status)", l);
  }
  const s = [];
  for (const [i, l] of u) s.push(["Client", i, l.count, l.subtotal, l.total, l.outstanding]);
  for (const [i, l] of a) s.push(["Status", i, l.count, l.subtotal, l.total, l.outstanding]);
  return s;
}
function s0(e) {
...
function jt(e, { locale: t = "en-CA", format: u = "medium" } = {}) {
  const a = s0(e);
  if (!a) return "";
  if (u === "iso") return Xu(a);
  const n = ju[u] || ju.medium;
  try {
    return new Intl.DateTimeFormat(t, { ...n, timeZone: "UTC" }).format(a);
  } catch {
    return Xu(a);
  }
}
function i0(e, t, u) {
  const a = jt(e, u), n = jt(t, u);
  return a && n ? `${a} – ${n}` : a || n || "";
}
function o0(e, { locale: t = "en-CA", code: u = "CAD" } = {}) {
  if (e == null || e === "") return "";
  ...
  try {
    ...
    return `${a.toFixed(2)} ${u}`;
  }
}
function Ju({ value: e, format: t = "medium", locale: u }) {
  const a = Ze(), n = jt(e, {
    locale: u ?? a.locale,
    format: t
  });
...
function Za({
  ...
  const s = Ze(), i = u?.from ?? e, l = u?.to ?? t, f = i0(i, l, {
    locale: n ?? s.locale,
    format: a
  });
...
function Ue(e, t) {
  const u = new RegExp(`${t}="([^"]*)"`), a = e.match(u);
  return a ? c0(a[1]) : null;
}
function er(e) {
  const t = (a, n) => ({
    type: "text",
    ...
    let i = [], l = 0;
    if (!a) return [t("", n)];
    a.replace(s, (m, h, p, g, N) => {
      const L = a.slice(l, N);
      if (L && i.push(t(L, n)), h === "a" && p) {
        const x = Ue(p, "href");
        if (x) {
          i.push({
            type: "link",
      ...
      if (h === "span" && p && Ue(p, "data-type") === "math") {
        const R = Ue(p, "data-latex") || "", D = Ue(p, "data-display") === "true", $ = Ue(p, "data-id");
        i.push({
          type: "math",
          latex: R,
          display: D,
      ...
      const B = { ...n };
      (h === "strong" || h === "b") && (B.bold = !0), (h === "em" || h === "i") && (B.italics = !0), h === "u" && (B.underline = {}), i = i.concat(u(g, B)), l = N + m.length;
    });
    const f = a.slice(l);
...
function l0(e) {
  return e == null ? e : Array.isArray(e) ? e.map(Zu) : Zu(e);
}
function O({
  children: e,
  bold: t,
  ...
  const N = Ze(), L = je(n, N), B = vs(i, N), x = h ?? p, R = { "data-type": "text" };
  return t && (R["data-bold"] = "true"), u && (R["data-italics"] = "true"), a && (R["data-underline"] = "true"), L && (R["data-color"] = L), s != null && (R["data-size"] = s), B && (R["data-font"] = B), l && (R["data-smallcaps"] = "true"), f && (R["data-allcaps"] = "true"), m && (R["data-strike"] = "true"), x && (R["data-style"] = x), /* @__PURE__ */ E("span", { ...R, ...g, children: l0(e) });
}
function d0({ latex: e, display: t = !1, id: u, ...a }) {
  const n = { "data-type": "math" };
  return n["data-latex"] = e || "", n["data-display"] = t ? "true" : "false", u && (n["data-id"] = u), /* @__PURE__ */ E("span", { ...n, ...a });
}
function f0({ tabStops: e, indent: t, role: u }) {
  const a = {};
  return Array.isArray(e) && e.length && (a["data-tab-stops"] = JSON.stringify(e)), t && typeof t == "object" && (t.left != null && (a["data-indent-left"] = t.left), t.right != null && (a["data-indent-right"] = t.right), t.firstLine != null && (a["data-indent-firstline"] = t.firstLine), t.hanging != null && (a["data-indent-hanging"] = t.hanging)), typeof u == "string" && u.length && (a["data-paragraph-style"] = u), a;
}
function S({
  as: e = "p",
  data: t,
  ...
  const l = f0({ tabStops: u, indent: a, role: n });
  if (t) {
    const f = er(t);
...
function tr({ level: e, data: t, children: u, ...a }) {
  const n = `h${e}`;
  if (t) {
    const s = er(t);
    return /* @__PURE__ */ E(n, { "data-type": "paragraph", "data-heading": `HEADING_${e}`, ...a, children: s.map(
  ...
  return /* @__PURE__ */ E(n, { "data-type": "paragraph", "data-heading": `HEADING_${e}`, ...a, children: u });
}
function h0(e) {
  return /* @__PURE__ */ E(tr, { level: 1, ...e });
}
function E0(e) {
  return /* @__PURE__ */ E(tr, { level: 2, ...e });
}
function m0(e, t) {
...
function A0(e, t) {
  ...
  for (const [a, n] of Object.entries(e))
    n && (u[a] = {
      ...n,
      ...n.color ? { color: je(n.color, t) } : {}
    });
  return u;
}
const ur = _t({ widths: null, borderColor: "cccccc" });
function pt({
  widths: e,
  columnWidths: t,
  layout: u,
  ...
  const m = Ze(), h = {};
  t && t.length ? (h["data-table-column-widths"] = t.join(","), h["data-table-layout"] = u || "fixed") : u && (h["data-table-layout"] = u), a && (a.size != null && (h["data-table-width-size"] = a.size), h["data-table-width-type"] = a.type ?? "pct");
  const p = A0(n, m);
  if (p)
    for (const [N, L] of Object.entries(p)) {
      if (!L) continue;
      const B = N === "insideHorizontal" ? "insideh" : N === "insideVertical" ? "insidev" : N;
      L.style && (h[`data-table-borders-${B}-style`] = L.style), L.size != null && (h[`data-table-borders-${B}-size`] = L.size), L.color && (h[`data-table-borders-${B}-color`] = L.color);
    }
  const g = je(s, m) ?? s;
  return /* @__PURE__ */ E(
    ur.Provider,
...
function ge({ header: e = !1, className: t, children: u, ...a }) {
  let n = 0;
  const s = rr.toArray(u).map((l) => {
    if (!nr(l)) return l;
  ...
  return /* @__PURE__ */ E("div", { "data-type": "tableRow", className: t, ...e ? { "data-row-header": "" } : {}, ...a, children: s });
}
const it = { top: 80, bottom: 80, left: 120, right: 120 };
function W({
  _col: e = 0,
  _header: t = !1,
  width: u,
  ...
  const { widths: N, borderColor: L, theme: B } = At(ur), x = u ?? N?.[e], R = {
    "data-type": "tableCell",
    "data-margins-top": it.top,
    "data-margins-bottom": it.bottom,
    "data-margins-left": it.left,
    "data-margins-right": it.right,
  ...
  if (x != null && (R["data-width-size"] = x, R["data-width-type"] = "pct"), s) {
    const z = typeof s == "string" ? { fill: s } : s, tt = je(z.fill, B), ut = je(z.color, B);
    tt && (R["data-shading-fill"] = tt), z.type && (R["data-shading-type"] = z.type), ut && (R["data-shading-color"] = ut);
  }
  ...
  return /* @__PURE__ */ E("div", { className: m, style: D, ...R, ...g, children: typeof p == "string" || typeof p == "number" ? /* @__PURE__ */ E(S, { children: a || t ? /* @__PURE__ */ E(O, { bold: !0, children: p }) : p }) : p });
}
function g0({ children: e }) {
...
function O0({ bd: e }) {
  const { invoice: t, vendor: u } = e, a = t?.client || {};
  return /* @__PURE__ */ C(Ne, { children: [
    ...
    /* @__PURE__ */ E(pt, { widths: [50, 50], borders: Xt(), children: /* @__PURE__ */ C(ge, { children: [
      ...
      /* @__PURE__ */ C(W, { borderBottom: "none", children: [
        ...
        a.organization && /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { role: "BodyStrong", children: a.organization }) }),
        a.contact && /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { children: a.contact }) }),
        a.email && /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { role: "Caption", children: a.email }) })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ E(pt, { widths: [33, 33, 34], borders: Xt(), children: /* @__PURE__ */ C(ge, { children: [
      ...
      t?.issued && /* @__PURE__ */ C(W, { borderBottom: "none", children: [
        ...
        /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(Ju, { value: t.issued, format: "long" }) }) })
      ] }),
      t?.due && /* @__PURE__ */ C(W, { borderBottom: "none", children: [
        /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { role: "Label", children: "Due" }) }),
        /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(Ju, { value: t.due, format: "long" }) }) })
      ] })
    ] }) }),
    t?.period && /* @__PURE__ */ C(Ne, { children: [
      /* @__PURE__ */ E(S, { "data-spacing-before": 120, children: /* @__PURE__ */ E(O, { role: "Label", children: "Period" }) }),
      /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(Za, { period: t.period, format: "long" }) }) })
    ] })
  ] });
}
function y0({ bd: e }) {
      ...
      children: [
        ...
        t.map((n, s) => /* @__PURE__ */ C(ge, { children: [
          /* @__PURE__ */ C(W, { valign: "center", children: [
            ...
            n.period && /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { role: "Caption", children: /* @__PURE__ */ E(Za, { period: n.period, format: "medium" }) }) })
          ] }),
          /* @__PURE__ */ E(W, { valign: "center", children: /* @__PURE__ */ E(S, { "data-alignment": "right", children: /* @__PURE__ */ E(O, { children: String(n.qty ?? "") }) }) }),
          /* @__PURE__ */ E(W, { valign: "center", children: /* @__PURE__ */ E(S, { "data-alignment": "right", children: /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(qe, { value: n.unit_price, code: a }) }) }) }),
          /* @__PURE__ */ E(W, { valign: "center", children: /* @__PURE__ */ E(S, { "data-alignment": "right", children: /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(qe, { value: n.amount, code: a }) }) }) })
        ] }, s))
      ]
    }
  );
    ...
    pt,
    {
      ...
      children: [
        /* @__PURE__ */ C(ge, { children: [
          ...
          /* @__PURE__ */ E(W, { borderBottom: "none", children: /* @__PURE__ */ E(S, { "data-alignment": "right", children: /* @__PURE__ */ E(O, { role: "BodyStrong", children: /* @__PURE__ */ E(qe, { value: t.subtotal, code: a }) }) }) })
        ] }),
        t.tax_amount > 0 && /* @__PURE__ */ C(ge, { children: [
          ...
          /* @__PURE__ */ E(W, { borderBottom: "none", children: /* @__PURE__ */ E(S, { "data-alignment": "right", children: /* @__PURE__ */ E(O, { role: "BodyStrong", children: /* @__PURE__ */ E(qe, { value: t.tax_amount, code: a }) }) }) })
        ] }),
        /* @__PURE__ */ C(ge, { children: [
          ...
          /* @__PURE__ */ E(W, { shading: "accent", borderBottom: "none", valign: "center", children: /* @__PURE__ */ E(S, { "data-alignment": "right", children: /* @__PURE__ */ E(O, { role: "TotalLine", children: /* @__PURE__ */ E(qe, { value: t.total, code: a }) }) }) })
        ] })
      ]
    }
  );
}
function L0({ content: e, block: t }) {
  const { title: u, items: a, sequence: n } = e, s = (() => {
    try {
      return Va();
    } catch {
      return null;
    }
  })(), i = C0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ C(Ne, { children: [
    u && /* @__PURE__ */ E(S, { role: "Heading1", "data-spacing-after": 240, children: /* @__PURE__ */ E(O, { children: u }) }),
    l.map((h, p) => /* @__PURE__ */ E(S, { data: h, "data-spacing-after": 120 }, `p${p}`)),
    a.map((h, p) => /* @__PURE__ */ C(dt, { children: [
      h.title && /* @__PURE__ */ E(
        S,
        {
          role: "Heading2",
      ...
      h.paragraphs.map((g, N) => /* @__PURE__ */ E(S, { data: g, "data-spacing-after": 100 }, `${p}-${N}`))
    ] }, p))
  ] }), m = /* @__PURE__ */ C("section", { className: "invoice-section", children: [
    u && /* @__PURE__ */ E("h1", { className: "invoice-title", children: u }),
    i.map((h, p) => {
      if (h.type === "paragraph")
        return /* @__PURE__ */ E("p", { dangerouslySetInnerHTML: { __html: h.text } }, `p${p}`);
      if (h.type === "inset") {
        if (!s) return null;
        const g = t.getInset(h.refId);
        return g ? /* @__PURE__ */ E(s, { blocks: [g] }, `i${p}`) : null;
      }
      return null;
    }),
    a.length > 0 && /* @__PURE__ */ E("div", { className: "invoice-items", children: a.map((h, p) => /* @__PURE__ */ C(dt, { children: [
...
function W0({ content: e, block: t }) {
  const u = e?.__bd, a = u?.kind || "body";
  let n = null;
  if (u && (a === "cover" ? n = /* @__PURE__ */ E(O0, { bd: u }) : a === "line-items" ? n = /* @__PURE__ */ E(y0, { bd: u }) : a === "totals" && (n = /* @__PURE__ */ E(D0, { bd: u }))), a === "cover" && u?.vendor?.logo) {
    const l = /* @__PURE__ */ E(g0, { children: /* @__PURE__ */ E(_0, { url: u.vendor.logo, width: oe(4), align: "right" }) });
    se(t, "docx", l, { role: "header" });
  }
  if (n)
    return se(t, "docx", n), se(t, "html", n), /* @__PURE__ */ E("section", { className: `invoice-section invoice-${a}`, children: n });
  const { docxBody: s, previewJsx: i } = L0({ content: e, block: t });
...
function G0({ content: e, block: t }) {
  const { title: u, items: a, sequence: n } = e, s = Va(), i = R0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ C(Ne, { children: [
    u && /* @__PURE__ */ E(h0, { data: u, "data-spacing-after": 240 }),
    l.map((h, p) => /* @__PURE__ */ E(S, { data: h, "data-spacing-after": 120 }, `p${p}`)),
    a.map((h, p) => /* @__PURE__ */ C(dt, { children: [
      h.title && /* @__PURE__ */ E(E0, { data: h.title, "data-spacing-before": 200, "data-spacing-after": 120 }),
      h.paragraphs.map((g, N) => /* @__PURE__ */ E(S, { data: g, "data-spacing-after": 100 }, `${p}-${N}`))
    ] }, p))
    ...
    a.length > 0 && /* @__PURE__ */ E("div", { className: "sow-items", children: a.map((h, p) => /* @__PURE__ */ C(dt, { children: [
      h.title && /* @__PURE__ */ E("h2", { className: "sow-item-title", children: h.title }),
      h.paragraphs.map((g, N) => /* @__PURE__ */ E("p", { className: "sow-item-detail", dangerouslySetInnerHTML: { __html: g } }, `${p}-${N}`)),
...
function P0({ title: e = "Document", filename: t = "document" }) {
  const { website: u } = lu(), [a, n] = ct(null), [s, i] = ct(null), [l, f] = ct(!1), m = ir(null);
  gt(() => {
    if (!l) return;
    const g = (N) => {
  ...
  const h = Object.keys(We.outputs || {}).filter((g) => ot[g]), p = async (g) => {
    i(null), n(g), f(!1);
    try {
      const N = await wc(u, { format: g, foundation: We, title: e }), L = We.outputs?.[g]?.extension || ot[g]?.ext || g;
      Bc(N, `${t}.${L}`);
    } catch (N) {
  ...
  return /* @__PURE__ */ C("div", { ref: m, className: "business-docs-download", children: [
    ...
    l && /* @__PURE__ */ E("div", { role: "menu", className: "business-docs-download-menu", children: h.map((g) => /* @__PURE__ */ C(
      "button",
      {
        ...
        onClick: () => p(g),
        children: [
          /* @__PURE__ */ E("span", { children: ot[g].label }),
...
function M0({ body: e, page: t }) {
  const { website: u } = lu(), a = t?.title || "Business document", n = (t?.title || "document").toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
  return gt(() => Kc(t), [t]), /* @__PURE__ */ C(ga, { basePath: u.basePath, children: [
    /* @__PURE__ */ E("main", { className: "business-docs-body", children: /* @__PURE__ */ E("div", { className: "business-docs-document", children: e }) }),
    /* @__PURE__ */ E(P0, { title: a, filename: n })
  ] });
}
const B0 = { ...We, vars: Fs || We?.vars, layouts: { BusinessDocLayout: M0 } }, x0 = {}, k0 = {}, K0 = { meta: x0, capabilities: B0, layoutMeta: k0 };
export {
  de as D,
  Y0 as E,
  W0 as I,
...
//# sourceMappingURL=_entry.generated-CYtzz4ZX.js.map
