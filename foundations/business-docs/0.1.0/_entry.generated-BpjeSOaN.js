...
function De(e, t, u = {}) {
  ...
  for (; l < e.length; ) {
    const D = e[l];
    a.includes(D) && !m ? (R(D), N = _.push(D), g = t[D]) : D === g && !m ? (f += D, _.pop(), N--, g = N > 0 ? t[_[N - 1]] : "", N === 0 && x("enclosure", f)) : !m && L.includes(D) && N > n ? (R(D), m = !0, h = D) : m && M(h, D) ? (f += D, m = !1, N === 0 && x("quote", f)) : f += D, l++;
  }
  return f !== "" && x("text", f), i;
}
function cr(e) {
...
function ta(e, t = []) {
  ...
  for (let s = 1; s < u.length; s += 2) {
    ...
    if (i.length < 3 || !i.startsWith("[") || !i.endsWith("]"))
      ...
      const m = i.slice(1, -1).trim().split(ea), h = m.shift(), _ = m[0] === "$0";
      _ && m.shift(), !h || !/^[a-zA-Z_]\w*$/.test(h) ? n("name", "word", m.join(" ")) : m.every((g) => /^(\.\.\.)?[a-zA-Z_]\w*$/.test(g)) ? a[h] = { args: m, body: f, isText: l == "{", hasFlags: _ } : n("arguments", "words", m.join(" "));
    }
  }
  return a;
}
...
function mr(e) {
  ...
  for (let h = 1; h < e.length; h++) {
    ...
    _.type == "text" ? g in t ? (s.push(a), a = { name: t[g], flags: {}, args: [] }, n = "") : l.includes(g) ? (n = g, a.flags[n] = !0) : g in f ? (n = f[g], a.flags[n] = !0) : n ? i.includes(g) || (a.flags[n] = _, n = "") : i.includes(g) || a.args.push(_) : n ? (a.flags[n] = _, n = "") : a.args.push(_);
  }
  s.push(a);
...
function Du(e, t) {
  ...
  if (m) {
    const _ = It(m, n, s), g = Array.isArray(m.items) ? m.items.map((N) => ({ ...N, amount: ru(N) })) : [];
  ...
  handlers: {
    ...
    props: (e, t, u) => {
      const a = u.parsedContent?.data, n = Du(a, u), s = u?.website?.config?.business_docs || {}, i = s.vendor || {}, l = s.defaults || {}, f = s.registries?.tax || {}, m = Ta({
        ...
        sow: a?.sow,
        sows: xe("sows", a, u)
      }), _ = m ? It(m, l, f) : null, g = m && Array.isArray(m.items) ? m.items.map((L) => ({ ...L, amount: ru(L) })) : [], N = ws({ params: t, content: e, block: u });
      return {
        content: {
          ...e,
...
class fi {
  ...
  _isInTemplate() {
    return this.currentTagId === r.TEMPLATE && this.treeAdapter.getNamespaceURI(this.current) === p.HTML;
  }
...
function Li(e, t) {
  return t === p.MATHML && (e === r.MI || e === r.MO || e === r.MN || e === r.MS || e === r.MTEXT);
}
function Ri(e, t, u) {
  if (t === p.MATHML && e === r.ANNOTATION_XML) {
  ...
  return t === p.SVG && (e === r.FOREIGN_OBJECT || e === r.DESC || e === r.TITLE);
}
function Pi(e, t, u, a) {
  return (!a || a === p.HTML) && Ri(e, t, u) || (!a || a === p.MATHML) && Li(e, t);
}
...
class wi {
  ...
  static getFragmentParser(t, u) {
    ...
    t ?? (t = a.treeAdapter.createElement(T.TEMPLATE, p.HTML, []));
    const n = a.treeAdapter.createElement("documentmock", p.HTML, []), s = new this(a, n, t);
  ...
  _setContextModes(t, u) {
    const a = t === this.document || t && this.treeAdapter.getNamespaceURI(t) === p.HTML;
  ...
  _insertFakeElement(t, u) {
    const a = this.treeAdapter.createElement(t, p.HTML, []);
    this._attachElementToTree(a, null), this.openElements.push(a, u);
  }
  /** @protected */
  _insertTemplate(t) {
    const u = this.treeAdapter.createElement(t.tagName, p.HTML, t.attrs), a = this.treeAdapter.createDocumentFragment();
  ...
  shouldProcessStartTagTokenInForeignContent(t) {
    if (!this.currentNotInHTML)
      return !1;
    let u, a;
    return this.openElements.stackTop === 0 && this.fragmentContext ? (u = this.fragmentContext, a = this.fragmentContextID) : { current: u, currentTagId: a } = this.openElements, t.tagID === r.SVG && this.treeAdapter.getTagName(u) === T.ANNOTATION_XML && this.treeAdapter.getNamespaceURI(u) === p.MATHML ? !1 : (
      // Check that `current` is not an integration point for HTML or MathML elements.
      this.tokenizer.inForeignNode || // If it _is_ an integration point, then we might have to check that it is not an HTML
      // integration point.
      (t.tagID === r.MGLYPH || t.tagID === r.MALIGNMARK) && a !== void 0 && !this._isIntegrationPoint(a, u, p.HTML)
    );
  }
  /** @protected */
  _processToken(t) {
...
function Yi(e, t, u) {
  ...
  if (e._isElementCausesFosterParenting(n))
    ...
    n === r.TEMPLATE && s === p.HTML && (t = e.treeAdapter.getTemplateContent(t)), e.treeAdapter.appendChild(t, u);
  }
}
function Wi(e, t, u) {
...
function zi(e, t) {
  t.tagID === r.HTML ? (e._insertElement(t, p.HTML), e.insertionMode = d.BEFORE_HEAD) : We(e, t);
}
function Qi(e, t) {
  const u = t.tagID;
...
function ro(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, p.HTML);
}
function no(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e.openElements.currentTagId !== void 0 && Kt.has(e.openElements.currentTagId) && e.openElements.pop(), e._insertElement(t, p.HTML);
}
function so(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, p.HTML), e.skipNextNewLine = !0, e.framesetOk = !1;
}
function io(e, t) {
  const u = e.openElements.tmplCount > 0;
  (!e.formElement || u) && (e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, p.HTML), u || (e.formElement = e.openElements.current));
}
function oo(e, t) {
  e.framesetOk = !1;
  const u = t.tagID;
...
function co(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, p.HTML), e.tokenizer.state = q.PLAINTEXT;
}
function lo(e, t) {
  e.openElements.hasInScope(r.BUTTON) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(r.BUTTON)), e._reconstructActiveFormattingElements(), e._insertElement(t, p.HTML), e.framesetOk = !1;
}
function fo(e, t) {
...
function Eo(e, t) {
  e._reconstructActiveFormattingElements(), e.openElements.hasInScope(r.NOBR) && (su(e, t), e._reconstructActiveFormattingElements()), e._insertElement(t, p.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
}
function mo(e, t) {
  e._reconstructActiveFormattingElements(), e._insertElement(t, p.HTML), e.activeFormattingElements.insertMarker(), e.framesetOk = !1;
}
function To(e, t) {
  e.treeAdapter.getDocumentMode(e.document) !== j.QUIRKS && e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._insertElement(t, p.HTML), e.framesetOk = !1, e.insertionMode = d.IN_TABLE;
}
function ka(e, t) {
...
function bo(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, p.HTML), wa(t) || (e.framesetOk = !1), t.ackSelfClosing = !0;
}
function po(e, t) {
  e._appendElement(t, p.HTML), t.ackSelfClosing = !0;
}
function _o(e, t) {
  e.openElements.hasInButtonScope(r.P) && e._closePElement(), e._appendElement(t, p.HTML), e.framesetOk = !1, t.ackSelfClosing = !0;
}
function Ao(e, t) {
...
function So(e, t) {
  e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e._reconstructActiveFormattingElements(), e._insertElement(t, p.HTML);
}
function Oo(e, t) {
  e.openElements.hasInScope(r.RUBY) && e.openElements.generateImpliedEndTags(), e._insertElement(t, p.HTML);
}
function yo(e, t) {
  e.openElements.hasInScope(r.RUBY) && e.openElements.generateImpliedEndTagsWithExclusion(r.RTC), e._insertElement(t, p.HTML);
}
function Do(e, t) {
  e._reconstructActiveFormattingElements(), Ra(t), nu(t), t.selfClosing ? e._appendElement(t, p.MATHML) : e._insertElement(t, p.MATHML), t.ackSelfClosing = !0;
}
function Lo(e, t) {
  e._reconstructActiveFormattingElements(), Pa(t), nu(t), t.selfClosing ? e._appendElement(t, p.SVG) : e._insertElement(t, p.SVG), t.ackSelfClosing = !0;
}
function Yu(e, t) {
...
function qo(e, t) {
  wa(t) ? e._appendElement(t, p.HTML) : Ze(e, t), t.ackSelfClosing = !0;
}
function Vo(e, t) {
...
function Ga(e, t) {
  switch (t.tagID) {
    ...
    case r.OPTION: {
      e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e._insertElement(t, p.HTML);
      break;
    }
    case r.OPTGROUP: {
      e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e.openElements.currentTagId === r.OPTGROUP && e.openElements.pop(), e._insertElement(t, p.HTML);
      break;
    }
    case r.HR: {
      e.openElements.currentTagId === r.OPTION && e.openElements.pop(), e.openElements.currentTagId === r.OPTGROUP && e.openElements.pop(), e._appendElement(t, p.HTML), t.ackSelfClosing = !0;
      break;
    }
    case r.INPUT:
    case r.KEYGEN:
...
function Ec(e, t) {
  if (yi(t))
    ...
    a === p.MATHML ? Ra(t) : a === p.SVG && (Di(t), Pa(t)), nu(t), t.selfClosing ? e._appendElement(t, a) : e._insertElement(t, a), t.ackSelfClosing = !0;
  }
}
function mc(e, t) {
  ...
  for (let u = e.openElements.stackTop; u > 0; u--) {
    ...
    if (e.treeAdapter.getNamespaceURI(a) === p.HTML) {
...
const Oc = {
  docx: { load: () => import("./docx-KDNh-B16.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-BoTSVKSs.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-BDUICwyr.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-CyMH_axY.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-BkklBPmr.js"), consumes: "html", ir: !1 }
};
function cu(e) {
  const t = Oc[e];
  return t ? {
...
async function kc(e, t = {}) {
  ...
  const L = N.via ?? n, M = N.getOptions ? await N.getOptions(a, { format: n, rootPath: i, loadAsset: _, ...h }) : {}, x = {
    ...M.adapterOptions,
    ...l
...
function W({
  ...
  return /* @__PURE__ */ E("div", { className: m, style: D, ...R, ...g, children: typeof _ == "string" || typeof _ == "number" ? /* @__PURE__ */ E(S, { children: a || t ? /* @__PURE__ */ E(O, { bold: !0, children: _ }) : _ }) : _ });
}
...
function D0({ content: e, block: t }) {
  const { title: u, items: a, sequence: n } = e, s = (() => {
    ...
    a.map((h, _) => /* @__PURE__ */ C(dt, { children: [
      h.title && /* @__PURE__ */ E(
        S,
        {
          role: "Heading2",
    ...
    a.length > 0 && /* @__PURE__ */ E("div", { className: "invoice-items", children: a.map((h, _) => /* @__PURE__ */ C(dt, { children: [
...
function W0({ content: e, block: t }) {
  const { title: u, items: a, sequence: n } = e, s = qa(), i = L0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ C(Ne, { children: [
    ...
    a.length > 0 && /* @__PURE__ */ E("div", { className: "sow-items", children: a.map((h, _) => /* @__PURE__ */ C(dt, { children: [
...
//# sourceMappingURL=_entry.generated-BpjeSOaN.js.map
