...
import { createContext as _t, useContext as At, useMemo as Ae, createElement as kt, useState as ct, useEffect as gt, useReducer as aa, Children as na, isValidElement as sa, cloneElement as ia, Fragment as dt, useRef as oa } from "react";
...
function Le(e, t, u = {}) {
  ...
  function k(C, R) {
    if (s && C == "text") {
      const ue = R.trim().split(tr);
      for (let z of ue)
        z = fa(z), z !== "" && i.push({ type: C, value: z });
    } else
  ...
  for (; l < e.length; ) {
    const C = e[l];
    r.includes(C) && !m ? (M(C), N = p.push(C), g = t[C]) : C === g && !m ? (f += C, p.pop(), N--, g = N > 0 ? t[p[N - 1]] : "", N === 0 && k("enclosure", f)) : !m && L.includes(C) && N > n ? (M(C), m = !0, h = C) : m && P(h, C) ? (f += C, m = !1, N === 0 && k("quote", f)) : f += C, l++;
  }
  return f !== "" && k("text", f), i;
}
function da(e) {
...
function ur(e, t = []) {
  ...
  for (let s = 1; s < u.length; s += 2) {
    ...
    if (i.length < 3 || !i.startsWith("[") || !i.endsWith("]"))
      ...
      const m = i.slice(1, -1).trim().split(tr), h = m.shift(), p = m[0] === "$0";
...
function ha(e) {
  ...
  for (let s of e)
    if (s.type === "text")
      if (u = s.value.split(la), u.length <= 1)
        t.push(s);
      else
...
function Ta(e) {
  const t = ha(e), u = Ea(t);
  for (const r of u)
    r.type === "chain" && (r.type = "enclosure", r.value = ma(r.tokens), delete r.tokens);
  return u;
}
function ba(e) {
  if (!e.length) return [];
...
}, Aa = ["wrap", "aux", "label", "heading", "title"];
let wt;
const Eu = {};
function mu(e, t, u) {
  Eu[e] ??= ga(e);
  ...
  !t.type && typeof t.as == "string" && (t.type = t.as), t.lang ? t.locale = t.lang : (t.locale || (t.locale = Ve(t.locale)), t.lang = or(t.locale)), t._name = e;
...
function Xa(e, t) {
  if (!e) return [];
  if (e = Array.isArray(e) ? e : e.split("|"), fe(t) && (t = t.split(",")), !En(t))
    return e;
  const u = [];
  for (const r of t)
    u.push(e[r]);
...
function Re(e, t) {
  if (e.type ??= ht(t, e), e.row ? (t = Xa(t, e.row), e.type = "list") : t = ce(t, e.type, e), t === null) return "";
  const u = e.json ? "json" : e.type, r = { ...e };
  Aa.forEach((s) => {
    delete r[s];
  });
  const n = { ...r, [e.type]: e[e.type] };
  return t = Ja(u, n, t), e.title && fe(t) && (t = ir(t, e.locale)), e.aux && (x(t) && (t = t.join(e.sep || ", ")), t = Zt(e, t)), e.label && (x(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = gn(e, t)), e.heading && (x(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = An(e, t)), e.wrap && (Nt(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Ja(e, t, u) {
  switch (e) {
    case "null":
...
function dn(e, t) {
  const u = e.date ? fn : ar, r = e.desc ? -1 : 1;
...
function fn(e, t, u) {
  ...
  return Se(r) && Se(n) ? ce(r, "date").getTime() - ce(n, "date").getTime() : ar(e, t, u);
}
function ar(e, t, u) {
  let r = ft(t, e), n = ft(u, e);
  const s = ee(r), i = ee(n);
...
function Me(e, t) {
  ...
  for (let n = 0; n < u.length; n++) {
    ...
    if (x(r) && !ee(s)) {
      const i = [];
      for (let l of r)
        s = u.slice(n).join("."), i.push(Me(s, l));
      return i;
    }
    if (r === null)
      return;
...
function ce(e, t, u = {}) {
  switch (t) {
    case "boolean":
      return !Oe(e);
    case "date":
      return Se(e) ? e instanceof Date || u.date === "auto" && mn(e) ? e : new Date(e.replace(/-/g, "/")) : null;
    case "text":
    case "string":
      return fe(e) ? e : ne(xe(e));
    case "list":
      return x(e) ? e : X(e) ? xe(e) : null;
    case "object":
      return X(e) ? e : null;
    case "number":
      return ee(e) ? parseFloat(e) : Se(e) ? ce(e, "date").getTime() : 0;
    case "range":
...
function nr(e, t) {
  const u = [];
  for (let r of t)
    x(r) ? r = nr(e, r) : X(r) && (r = sr(e, r)), Nt(r) || u.push(r);
...
class Z extends K {
  ...
  format(t) {
    ...
    return t.type === "date" ? (r = r ? Re(t, r) : _u(t.locale), n = n ? Re(t, n) : _u(t.locale)) : t.type !== "range" && (r = Re(t, r || ""), n = Re(t, n || "")), r || n ? `${r}${u}${n}` : "";
  }
  isEmpty() {
...
let yn = class extends K {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { amount: t, currency: u, convertedAmount: r } = this.parsedArgs, n = pa[u.toLowerCase()], i = [["u-amount", n ? new Intl.NumberFormat(`${Ve()}-CA`, {
      style: "currency",
      currency: n
    }).format(t) : t]];
...
const Au = /^[@]?[\$]?[\/]?[a-zA-Z_][a-zA-Z0-9_\/\.-]*$|^@$|^\?$/, Ln = /^-?\d+(\.\d+)?$/;
class Rn {
  /**
   ...
   */
  constructor(t = {}, u = {}) {
    this.snippets = ur(t), this.functions = u;
  }
  /**
   ...
   */
  setVariables(t) {
    this.variables = typeof t == "function" ? t : (u) => Me(u, t);
  }
  /**
  ...
  getVariableMeta(t) {
    ...
    return typeof u == "string" ? { label: u } : (u.label ??= ir(t.split("_").join(" ")), u);
  }
  /**
  ...
  evaluateExpression(t, u = null) {
    ...
    return u && u.has(r) ? { value: u.get(r), type: "aux" } : Au.test(r) ? {
      ...
      type: "variable"
    } : Ln.test(r) ? { value: parseFloat(r), type: "number" } : { value: this.getError(103, "Invalid expression", r), type: "error" };
  }
...
cr.sort((e, t) => t.length - e.length);
const Pn = new Set(cr.map((e) => e.join(" ").toUpperCase())), Mn = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
  ...
  "object",
  "tag"
]), Bn = /* @__PURE__ */ new Set([">=", "<=", "!=", "==", "&&", "||"]), xn = /* @__PURE__ */ new Set(["+", "-", "*", "/", "%", "=", "<", ">", "!"]), kn = /[a-zA-Z_@$?]/, wn = /[a-zA-Z0-9_.\/@]/, Rt = /[0-9]/;
function Fn(e) {
  return Hn(e);
}
function Hn(e) {
...
` || n === "\r") {
    ...
    if (Rt.test(n) || n === "-" && Rt.test(e[r + 1] || "") && Un(t)) {
      let i = r + (n === "-" ? 1 : 0);
...
function Un(e) {
  ...
  return !!(t.type === "operator" || t.type === "lparen" || t.type === "word" && Pn.has(t.value.toUpperCase()));
}
function lr(e, t, u) {
...
const Wn = /* @__PURE__ */ new Set(["long", "full", "short", "medium"]), Gn = [
  ["for", "each"],
  ["total", "of"],
  ["sum", "of"],
  ["average", "of"],
  ...
  ["as"],
  ["if"]
], Kn = [["then"], ["show"]], $n = [["otherwise"], ["else"]], zn = [["else"], ["show"]], Qn = [["in"]], qn = [["do"]], Vn = [["ascending"]], jn = [["descending"]];
function V(e, t) {
  return Yn(e.tokens, e.i, t);
}
function W(e, t) {
  e.i += t.length;
}
...
function es(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    if (r.type === "rparen" || r.type === "operator" || r.type === "word" && V(e, Je)) break;
    const n = J(e);
    if (n == null) break;
    u.push(n);
  }
...
function gu(e) {
  ...
  const r = t[0];
  return u.length === 0 && us(r) ? { type: "show", value: r, modifiers: [] } : { type: "show", value: r, modifiers: u };
}
function ts(e) {
  const t = [];
  for (; e.i < e.tokens.length; ) {
...
function tu(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    switch (u.canonical) {
      case "AS": {
        W(e, u), t.push({ type: "as", format: rs(e) });
        break;
      }
      case "WITH LABEL": {
        W(e, u);
      ...
      case "WHERE":
      case "IF": {
        W(e, u), t.push({ type: "where", condition: uu(e) });
        break;
      }
      case "IF PRESENT": {
...
function rs(e) {
  ...
  const r = u[0], n = u[1];
  return n === "date" && Wn.has(r) ? { type: "date", value: r } : n === "only" && (r === "year" || r === "month") ? { type: "date", value: r === "year" ? "y" : "m" } : Mn.has(r) ? { type: r, value: n ?? null } : (n != null && e.i--, { type: r, value: null });
}
function as(e) {
  const t = uu(e), u = V(e, Kn);
  u && W(e, u);
  const r = Nu(e);
  let n = null;
  const s = V(e, $n);
...
function Ht(e) {
  ...
  if (t && t.type === "operator" && t.value === "!")
    return F(e), { type: "unop", op: "!", arg: Ht(e) };
  if (t && t.type === "lparen") {
    F(e);
    const u = fr(e);
    return dr(e, "rparen"), { type: "group", inner: u };
  }
  return os(e);
}
...
function os(e) {
  const t = Cu(e), u = U(e);
  if (u && u.type === "operator" && is.has(u.value)) {
    F(e);
    const r = Cu(e);
...
function w(e) {
  switch (e.type) {
    ...
    case "forEach":
      return ms(e);
    default:
      throw new hr(`Unknown node type: ${e.type}`);
  }
}
function ls(e) {
...
function ds(e) {
  ...
  if (i && (i.type === "count" || i.type === "sum" || i.type === "average")) {
    ...
    if (l >= 0) {
      const f = e.modifiers[l], m = Et(i.value), h = w(Pe(f.condition, m));
      if (i.type === "count")
        n = `(++!! ${h})`;
      else if (i.type === "sum")
        n = `(++ (? ${h} ${w(i.value)}))`;
  ...
  for (let l = 0; l < e.modifiers.length; l++) {
    ...
    switch (f.type) {
      ...
      default:
        throw new hr(`Unknown modifier type: ${f.type}`);
    }
  }
  return n;
}
...
function Ps(e, t = {}, u = {}) {
  ...
  const s = Rs(n, u), i = e?.tax?.rate != null ? Number(e.tax.rate) : s.rate, l = e?.tax?.amount != null ? Number(e.tax.amount) : Math.round(r * i * 100) / 100;
  return { jurisdiction: n, rate: i, amount: l, label: s.label };
}
function It(e, t = {}, u = {}) {
  const r = mr(e?.items), n = Ps(e, t, u), s = Math.round((r + n.amount) * 100) / 100;
  return {
    subtotal: r,
    tax_amount: n.amount,
    tax_rate: n.rate,
...
function ws({ invoices: e = [], sows: t = [] } = {}) {
  ...
  for (const n of e) {
    ...
    ), Array.isArray(n?.items) && l?.expires && n.items.some((h) => ks(h?.period, l.expires)) && r(
      i ? "warn" : "info",
...
function Du(e, t) {
  const u = t?.website?.config?.business_docs || {}, r = u.vendor || {}, n = u.defaults || {}, s = u.registries?.tax || {}, i = ke("invoices", e, t), l = ke("sows", e, t), f = { vendor: r, defaults: n }, m = br({ invoice: e?.invoice, invoices: i });
  if (m) {
    const p = It(m, n, s), g = Array.isArray(m.items) ? m.items.map((N) => ({ ...N, amount: au(N) })) : [];
    return { ...f, ...m, items: g, ...p };
  }
  const h = pr({ sow: e?.sow, sows: l });
...
function Us({ params: e, content: t, block: u }) {
...
function vs(e, t) {
  const u = ke("invoices", e, t), r = ke("sows", e, t);
  if (u.length === 0 || r.length === 0 || Lu.has(t)) return;
  Lu.add(t);
  const n = ws({ invoices: u, sows: r });
  n.length > 0 && Fs(n);
}
const We = {
  ...
  handlers: {
    content: (e, t) => {
      ...
      if (!n) return De(r, rt, u);
      const s = t.properties?.where;
      if (s) {
        const i = u[n];
        if (Array.isArray(i)) {
          const l = i.filter(
            (f) => rt.evaluateText(s, { ...u, ...f })
          );
          return Ou(r, rt, { ...u, [n]: l }, n);
        }
      }
      return Ou(r, rt, u, n);
    },
     ...
     */
    props: (e, t, u) => {
      const r = u.parsedContent?.data, n = Du(r, u), s = u?.website?.config?.business_docs || {}, i = s.vendor || {}, l = s.defaults || {}, f = s.registries?.tax || {}, m = br({
        invoice: r?.invoice,
        invoices: ke("invoices", r, u)
      }), h = pr({
        sow: r?.sow,
        sows: ke("sows", r, u)
      }), p = m ? It(m, l, f) : null, g = m && Array.isArray(m.items) ? m.items.map((L) => ({ ...L, amount: au(L) })) : [], N = Us({ params: t, content: e, block: u });
      return {
        content: {
          ...e,
...
function gr({
  ...
  ), /* @__PURE__ */ E(_r.Provider, { value: n, children: /* @__PURE__ */ E(Yt.Provider, { value: s, children: /* @__PURE__ */ E(Wt.Provider, { value: i, children: e }) }) });
}
function se(e, t, u, r = {}) {
  const n = At(_r);
  if (!n) {
...
function Cr(e) {
  return e >= 64976 && e <= 65007 || Gs.has(e);
}
var b;
(function(e) {
...
class Qs {
  constructor(t) {
    this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = zs, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (Ks(u))
        return this.pos++, this._addGap(), $s(t, u);
  ...
  advance() {
    ...
    return t === o.CARRIAGE_RETURN ? (this.isEol = !0, this.skipNextNewLine = !0, o.LINE_FEED) : t === o.LINE_FEED && (this.isEol = !0, this.skipNextNewLine) ? (this.line--, this.skipNextNewLine = !1, this._addGap(), this.advance()) : (this.skipNextNewLine = !1, Nr(t) && (t = this._processSurrogate(t)), this.handler.onParseError === null || t > 31 && t < 127 || t === o.LINE_FEED || t === o.CARRIAGE_RETURN || t > 159 && t < 64976 || this._checkForProblematicCharacters(t), t);
  }
  _checkForProblematicCharacters(t) {
    Ir(t) ? this._err(b.controlCharacterInInputStream) : Cr(t) && this._err(b.noncharacterInInputStream);
  }
  retreat(t) {
...
function Zs(e) {
  return e >= Y.UPPER_A && e <= Y.UPPER_Z || e >= Y.LOWER_A && e <= Y.LOWER_Z || Gt(e);
}
function ei(e) {
  return e === Y.EQUALS || Zs(e);
}
var v;
(function(e) {
...
class ti {
  ...
  stateNumericStart(t, u) {
    return u >= t.length ? -1 : (t.charCodeAt(u) | Xs) === Y.LOWER_X ? (this.state = v.NumericHex, this.consumed += 1, this.stateNumericHex(t, u + 1)) : (this.state = v.NumericDecimal, this.stateNumericDecimal(t, u));
  }
  ...
  emitNumericEntity(t, u) {
    ...
    if (t === Y.SEMI)
      ...
      return 0;
    return this.emitCodePoint(js(this.result), this.consumed), this.errors && (t !== Y.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(t, u) {
    ...
    for (; u < t.length; u++, this.excess++) {
      ...
      if (this.treeIndex = ui(r, n, this.treeIndex + Math.max(1, s), i), this.treeIndex < 0)
        ...
        ei(i)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function Ct(e) {
  var t;
  return (t = ri.get(e)) !== null && t !== void 0 ? t : a.UNKNOWN;
}
const A = a, ai = {
...
function ii(e) {
  return e === o.NULL ? b.nullCharacterReference : e > 1114111 ? b.characterReferenceOutsideUnicodeRange : Nr(e) ? b.surrogateCharacterReference : Cr(e) ? b.noncharacterCharacterReference : Ir(e) || e === o.CARRIAGE_RETURN ? b.controlCharacterReference : null;
}
class oi {
  constructor(t, u) {
    this.options = t, this.handler = u, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = c.DATA, this.returnState = c.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new Qs(u), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new ti(qs, (r, n) => {
  ...
  _leaveAttrName() {
    ...
    if (Sr(r, this.currentAttr.name) === null) {
  ...
  emitCurrentTagToken() {
    ...
    this.prepareToken(t), t.tagID = Ct(t.tagName), t.type === D.START_TAG ? (this.lastStartTagName = t.tagName, this.handler.onStartTag(t)) : (t.attrs.length > 0 && this._err(b.endTagWithAttributes), t.selfClosing && this._err(b.endTagWithTrailingSolidus), this.handler.onEndTag(t)), this.preprocessor.dropParsedChunk();
  }
  ...
  _stateRcdata(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this._emitChars(B);
        break;
      }
      case o.EOF: {
        this._emitEOFToken();
  ...
  _stateTagName(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.tagName += B;
        break;
      }
      case o.EOF: {
  ...
  _stateScriptDataEscapedDash(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.state = c.SCRIPT_DATA_ESCAPED, this._emitChars(B);
        break;
      }
      case o.EOF: {
        this._err(b.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
  ...
  _stateScriptDataDoubleEscapedDash(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.state = c.SCRIPT_DATA_DOUBLE_ESCAPED, this._emitChars(B);
        break;
      }
      case o.EOF: {
        this._err(b.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
  ...
  _stateAttributeName(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.currentAttr.name += B;
        break;
      }
      default:
  ...
  _stateAttributeValueDoubleQuoted(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.currentAttr.value += B;
        break;
      }
      case o.EOF: {
        this._err(b.eofInTag), this._emitEOFToken();
  ...
  _stateBogusComment(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.data += B;
        break;
      }
      default:
    ...
    if (Ye(t))
      ...
      switch (t) {
        ...
        case o.FORM_FEED:
          break;
        case o.NULL: {
          this._err(b.unexpectedNullCharacter), this._createDoctypeToken(B), this.state = c.DOCTYPE_NAME;
          break;
        }
        case o.GREATER_THAN_SIGN: {
  ...
  _stateDoctypeName(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.name += B;
        break;
      }
      case o.EOF: {
  ...
  _stateDoctypePublicIdentifierDoubleQuoted(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.publicId += B;
        break;
      }
      case o.GREATER_THAN_SIGN: {
  ...
  _stateDoctypeSystemIdentifierDoubleQuoted(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.systemId += B;
        break;
      }
      case o.GREATER_THAN_SIGN: {
...
const yr = /* @__PURE__ */ new Set([a.DD, a.DT, a.LI, a.OPTGROUP, a.OPTION, a.P, a.RB, a.RP, a.RT, a.RTC]), Bu = /* @__PURE__ */ new Set([
  ...yr,
  a.CAPTION,
  a.COLGROUP,
  a.TBODY,
  ...
  a.TEMPLATE,
  a.TH
]), ci = /* @__PURE__ */ new Set([...mt, a.OL, a.UL]), li = /* @__PURE__ */ new Set([...mt, a.BUTTON]), xu = /* @__PURE__ */ new Set([a.ANNOTATION_XML, a.MI, a.MN, a.MO, a.MS, a.MTEXT]), ku = /* @__PURE__ */ new Set([a.DESC, a.FOREIGN_OBJECT, a.TITLE]), di = /* @__PURE__ */ new Set([a.TR, a.TEMPLATE, a.HTML]), fi = /* @__PURE__ */ new Set([a.TBODY, a.TFOOT, a.THEAD, a.TEMPLATE, a.HTML]), hi = /* @__PURE__ */ new Set([a.TABLE, a.TEMPLATE, a.HTML]), Ei = /* @__PURE__ */ new Set([a.TD, a.TH]);
class mi {
  ...
  hasInButtonScope(t) {
    return this.hasInDynamicScope(t, li);
  }
  ...
  generateImpliedEndTags() {
    for (; this.currentTagId !== void 0 && yr.has(this.currentTagId); )
      this.pop();
  }
...
const Te = {
...
}, Dr = "html", bi = "about:legacy-compat", pi = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", Lr = [
  ...
  "html"
]), Rr = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], gi = [
  ...Rr,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function Ni(e) {
  return e.name === Dr && e.publicId === null && (e.systemId === null || e.systemId === bi);
}
function Ii(e) {
  if (e.name !== Dr)
    return j.QUIRKS;
  const { systemId: t } = e;
  if (t && t.toLowerCase() === pi)
    return j.QUIRKS;
  let { publicId: u } = e;
  if (u !== null) {
    if (u = u.toLowerCase(), Ai.has(u))
      return j.QUIRKS;
    let r = t === null ? _i : Lr;
    if (Fu(u, r))
      return j.QUIRKS;
    if (r = t === null ? Rr : gi, Fu(u, r))
...
const Hu = {
...
}, Ci = "definitionurl", Si = "definitionURL", Oi = new Map([
  "attributeName",
  "attributeType",
  "baseFrequency",
  "baseProfile",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((e) => [e.toLowerCase(), e])), yi = /* @__PURE__ */ new Map([
  ...
  "radialGradient",
  "textPath"
].map((e) => [e.toLowerCase(), e])), Li = /* @__PURE__ */ new Set([
  a.B,
  a.BIG,
  a.BLOCKQUOTE,
  a.BODY,
...
function Ri(e) {
  const t = e.tagID;
  return t === a.FONT && e.attrs.some(({ name: r }) => r === ge.COLOR || r === ge.SIZE || r === ge.FACE) || Li.has(t);
}
function Pr(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === Ci) {
      e.attrs[t].name = Si;
      break;
    }
}
...
function xi(e, t, u, r) {
  return (!r || r === _.HTML) && Bi(e, t, u) || (!r || r === _.MATHML) && Mi(e, t);
}
const ki = "hidden", wi = 8, Fi = 3;
var d;
(function(e) {
...
class Ui {
  constructor(t, u, r = null, n = null) {
    this.fragmentContext = r, this.scriptHandler = n, this.currentToken = null, this.stopped = !1, this.insertionMode = d.INITIAL, this.originalInsertionMode = d.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...Uu,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = u ?? this.treeAdapter.createDocument(), this.tokenizer = new oi(this.options, this), this.activeFormattingElements = new Ti(this.treeAdapter), this.fragmentContextID = r ? Ct(this.treeAdapter.getTagName(r)) : a.UNKNOWN, this._setContextModes(r ?? this.document, this.fragmentContextID), this.openElements = new mi(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, u) {
    const r = new this(u);
  ...
  _err(t, u, r) {
    ...
    if (!this.onParseError)
      return;
    const s = (n = t.location) !== null && n !== void 0 ? n : Hi, i = {
      code: u,
   ...
   */
  _processStartTag(t) {
    this.shouldProcessStartTagTokenInForeignContent(t) ? bc(this, t) : this._startTagOutsideForeignContent(t);
  }
  /** @protected */
  ...
  /** @internal */
  onEndTag(t) {
    this.skipNextNewLine = !1, this.currentToken = t, this.currentNotInHTML ? pc(this, t) : this._endTagOutsideForeignContent(t);
  }
  /** @protected */
...
function vi(e, t) {
  ...
  return u ? e.openElements.contains(u.element) ? e.openElements.hasInScope(t.tagID) || (u = null) : (e.activeFormattingElements.removeEntry(u), u = null) : Hr(e, t), u;
}
function Yi(e, t) {
...
function Wi(e, t, u) {
  ...
  for (let s = 0, i = n; i !== u; s++, i = n) {
    ...
    const l = e.activeFormattingElements.getElementEntry(i), f = l && s >= Fi;
    !l || f ? (f && e.activeFormattingElements.removeEntry(l), e.openElements.remove(i)) : (i = Gi(e, l), r === t && (e.activeFormattingElements.bookmark = l), e.treeAdapter.detachNode(r), e.treeAdapter.appendChild(i, r), r = i);
  }
  return r;
}
function Gi(e, t) {
...
function su(e, t) {
  for (let u = 0; u < wi; u++) {
    ...
    const s = Wi(e, n, r.element), i = e.openElements.getCommonAncestor(r.element);
    e.treeAdapter.detachNode(s), i && Ki(e, i, s), $i(e, n, r);
  }
}
function $t(e, t) {
...
function qi(e, t) {
  ...
  const u = t.forceQuirks ? j.QUIRKS : Ii(t);
  Ni(t) || e._err(t, b.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, u), e.insertionMode = d.BEFORE_HTML;
}
function Fe(e, t) {
...
function Vi(e, t) {
  t.tagID === a.HTML ? (e._insertElement(t, _.HTML), e.insertionMode = d.BEFORE_HEAD) : Ge(e, t);
}
function ji(e, t) {
  const u = t.tagID;
  (u === a.HTML || u === a.HEAD || u === a.BODY || u === a.BR) && Ge(e, t);
}
function Ge(e, t) {
...
function Ji(e, t) {
  const u = t.tagID;
  u === a.HEAD || u === a.BODY || u === a.HTML || u === a.BR ? Ke(e, t) : e._err(t, b.endTagWithoutMatchingOpenElement);
}
function Ke(e, t) {
...
function oo(e, t) {
  e.openElements.hasInButtonScope(a.P) && e._closePElement(), e.openElements.currentTagId !== void 0 && Kt.has(e.openElements.currentTagId) && e.openElements.pop(), e._insertElement(t, _.HTML);
}
function co(e, t) {
...
function bo(e, t) {
  e._reconstructActiveFormattingElements(), e.openElements.hasInScope(a.NOBR) && (su(e, t), e._reconstructActiveFormattingElements()), e._insertElement(t, _.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
}
function po(e, t) {
...
function Fr(e) {
  const t = Sr(e, ge.TYPE);
  return t != null && t.toLowerCase() === ki;
}
function Ao(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, _.HTML), Fr(t) || (e.framesetOk = !1), t.ackSelfClosing = !0;
}
function go(e, t) {
  e._appendElement(t, _.HTML), t.ackSelfClosing = !0;
}
...
function Io(e, t) {
  t.tagName = T.IMG, t.tagID = a.IMG, wr(e, t);
}
function Co(e, t) {
...
function Po(e, t) {
  e._reconstructActiveFormattingElements(), Pr(t), nu(t), t.selfClosing ? e._appendElement(t, _.MATHML) : e._insertElement(t, _.MATHML), t.ackSelfClosing = !0;
}
function Mo(e, t) {
  e._reconstructActiveFormattingElements(), Mr(t), nu(t), t.selfClosing ? e._appendElement(t, _.SVG) : e._insertElement(t, _.SVG), t.ackSelfClosing = !0;
}
function Yu(e, t) {
...
function xo(e, t) {
  e.openElements.hasInScope(a.BODY) && (e.insertionMode = d.AFTER_BODY, Qr(e, t));
}
function ko(e, t) {
  const u = t.tagID;
...
function Ur(e, t) {
  e.tmplInsertionModeStack.length > 0 ? zr(e, t) : iu(e, t);
}
function Go(e, t) {
  var u;
...
function Xo(e, t) {
  Fr(t) ? e._appendElement(t, _.HTML) : et(e, t), t.ackSelfClosing = !0;
}
function Jo(e, t) {
...
const Wr = /* @__PURE__ */ new Set([a.CAPTION, a.COL, a.COLGROUP, a.TBODY, a.TD, a.TFOOT, a.TH, a.THEAD, a.TR]);
function Zo(e, t) {
  const u = t.tagID;
  Wr.has(u) ? e.openElements.hasInTableScope(a.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(a.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, we(e, t)) : $(e, t);
}
function ec(e, t) {
  const u = t.tagID;
  switch (u) {
    case a.CAPTION:
    case a.TABLE: {
      e.openElements.hasInTableScope(a.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(a.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, u === a.TABLE && Xe(e, t));
      break;
    }
    case a.BODY:
    case a.COL:
...
function yt(e, t) {
  switch (t.tagID) {
    ...
    case a.TFOOT:
    case a.THEAD: {
      e.openElements.hasTableBodyContextInTableScope() && (e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE, we(e, t));
      break;
    }
    default:
      we(e, t);
...
function uc(e, t) {
  const u = t.tagID;
  Wr.has(u) ? (e.openElements.hasInTableScope(a.TD) || e.openElements.hasInTableScope(a.TH)) && (e._closeTableCell(), Dt(e, t)) : $(e, t);
}
function rc(e, t) {
  const u = t.tagID;
  switch (u) {
    ...
    case a.THEAD:
    case a.TR: {
      e.openElements.hasInTableScope(u) && (e._closeTableCell(), Gr(e, t));
      break;
    }
    case a.BODY:
    case a.CAPTION:
...
function ac(e, t) {
  const u = t.tagID;
  u === a.CAPTION || u === a.TABLE || u === a.TBODY || u === a.TFOOT || u === a.THEAD || u === a.TR || u === a.TD || u === a.TH ? (e.openElements.popUntilTagNamePopped(a.SELECT), e._resetInsertionMode(), e._processStartTag(t)) : Kr(e, t);
}
function nc(e, t) {
  const u = t.tagID;
  u === a.CAPTION || u === a.TABLE || u === a.TBODY || u === a.TFOOT || u === a.THEAD || u === a.TR || u === a.TD || u === a.TH ? e.openElements.hasInTableScope(u) && (e.openElements.popUntilTagNamePopped(a.SELECT), e._resetInsertionMode(), e.onEndTag(t)) : $r(e, t);
}
function sc(e, t) {
  switch (t.tagID) {
    ...
    case a.TFOOT:
    case a.THEAD: {
      e.tmplInsertionModeStack[0] = d.IN_TABLE, e.insertionMode = d.IN_TABLE, we(e, t);
      break;
    }
    case a.COL: {
...
function bc(e, t) {
  if (Ri(t))
    ...
    r === _.MATHML ? Pr(t) : r === _.SVG && (Pi(t), Mr(t)), nu(t), t.selfClosing ? e._appendElement(t, r) : e._insertElement(t, r), t.ackSelfClosing = !0;
  }
}
function pc(e, t) {
...
function _c(e, t, u) {
  ...
  const r = Ui.getFragmentParser(e, u);
  return r.tokenizer.write(t, !0), r.getFragment();
}
const Ac = () => ({}), _e = () => !0, Ee = (e) => {
  const t = parseInt(e, 10);
  return Number.isFinite(t) ? t : e;
}, gc = (e) => typeof e != "string" ? e : e.split(",").map((t) => t.trim()).filter(Boolean).map((t) => parseInt(t, 10)).filter((t) => Number.isFinite(t)), Nc = {
  "data-underline": { path: ["underline"], transform: Ac },
...
function yc(e) {
  ...
  if (Oc.has(t)) return null;
  const r = Wu(e, "data-type") || t;
  if (r === "emptyLine") return null;
  if (r === "contentWrapper")
    return Qt(e);
  const n = Cc(e.attrs || []), s = Qt(e);
...
const Dc = {
  docx: { load: () => import("./docx-Di3c45b9.js"), consumes: "docx", ir: !0 },
  ...
  epub: { load: () => import("./epub-DAWlH49m.js"), consumes: "html", ir: !1 }
};
function cu(e) {
  const t = Dc[e];
  return t ? {
...
function Rc(e, t) {
  ...
  return u.ir ? Pc(r, e) : u.consumes === "html" ? Mc(r, e) : Bc(r);
}
function Pc(e, t) {
...
function kc(e, t, u = {}) {
  const { basePath: r, theme: n } = u, s = Ar();
  return Jt(
    kt(
      gr,
...
function wc(e, t) {
  ...
  if (!u) return;
  const r = u.consumes;
  if (!(Gu.has(r) || (e.getOutputs && e.getOutputs(r) || []).length > 0) && (Gu.add(r), typeof console < "u" && console.warn)) {
...
async function Ku(e, t, u = {}) {
  const { basePath: r, theme: n, adapterOptions: s = {} } = u, i = kc(e, t, { basePath: r, theme: n });
  return Lc(t, i, s);
}
async function Fc(e, t = {}) {
  ...
  const L = N.via ?? n, P = N.getOptions ? await N.getOptions(r, { format: n, rootPath: i, loadAsset: p, ...h }) : {}, k = {
    ...
    ...P.adapterOptions,
    ...l
  }, M = vc(r, i), C = globalThis.uniweb?.childBlockRenderer;
...
function jr(e) {
  const t = er()?.activeWebsite ?? null, u = e && t ? ca(e) : null, r = u ? t.dataStore.get(u) : null, [n, s] = ct(
    () => r ? nt(r.data) : u ? zu() : $u()
  );
  return gt(() => {
    if (!u || !t) {
...
function Lt(e, t) {
  const { website: u } = lu(), [, r] = aa(Wc, 0), s = u.activePage?.state;
  gt(() => {
    if (s)
...
const Xr = "business-docs/report-options", he = {
  source: "invoices",
...
function $c(e) {
  ...
  const u = () => Kc(e), r = qt.map((n) => e.state.subscribe(n, u));
...
function Vc({ dateRange: e, client: t, status: u }) {
  const r = [];
...
const jc = /* @__PURE__ */ new Set(["paid", "void"]);
function Xc({ source: e, dateRange: t, client: u, status: r }) {
...
function t0(e, t, u, r) {
  ...
  if (t === "invoices")
    for (const l of e) {
      const f = It(l, u, r);
      n += f.subtotal, s += f.total, jc.has(String(l?.status)) || (i += f.total);
    }
  else
    for (const l of e) {
...
function u0(e, t) {
  const [u] = Jr(), [r] = zc(), [n] = Qc(), [s] = qc(), i = t?.website?.config?.business_docs || {}, l = i.defaults || {}, f = i.registries?.tax || {}, m = Ae(
    () => Vc({ dateRange: r, client: n, status: s }),
    [r, n, s]
  ), h = Ae(
    () => e0(u, e),
    [u, e?.data?.invoices, e?.data?.sows]
  ), { data: p, loading: g } = jr(
    m ? { path: Jc(u), schema: Zc(u), where: m } : null
  ...
  return {
    ...
    sumOutstanding: k,
    activeWhere: m,
    activeLabel: Xc({ source: u, dateRange: r, client: n, status: s }),
    totalCount: h.length,
    loading: m ? g : !1
  };
}
function r0(e, { currency: t = "CAD", locale: u = "en-CA" } = {}) {
  const r = Number(e);
...
function G0({ content: e, block: t }) {
  const u = t?.website?.config?.business_docs || {}, r = u.defaults || {}, n = u.registries?.tax || {}, s = r.currency || "CAD", i = r.locale || "en-CA", l = (I) => r0(I, { currency: s, locale: i }), f = (I) => Vt(I, { locale: i }), [m] = Jr(), h = m !== "sows", {
    records: p,
    count: g,
    sumSubtotals: N,
    sumTotals: L,
  ...
  const tt = e?.title || (h ? "Invoice report" : "SOW report"), ut = k || e?.subtitle || (h ? "All invoices" : "All SOWs");
  return /* @__PURE__ */ S("section", { className: "engagement-report", children: [
    ...
    /* @__PURE__ */ S("div", { className: "engagement-report-cards", role: "list", children: [
      ...
      h && /* @__PURE__ */ E(st, { label: "Outstanding", value: l(P) })
    ] }),
...
function c0(e, { locale: t = "en-CA", code: u = "CAD" } = {}) {
  if (e == null || e === "") return "";
...
function Zr({
  ...
  const s = Ze(), i = u?.from ?? e, l = u?.to ?? t, f = o0(i, l, {
    locale: n ?? s.locale,
    format: r
  });
  ...
  const t = (r, n) => ({
    ...
    r.replace(s, (m, h, p, g, N) => {
      ...
      if (L && i.push(t(L, n)), h === "a" && p) {
        const k = Ue(p, "href");
        if (k) {
          const M = u(g, n).filter(
            (C) => C.type === "text"
          );
          i.push({
            type: "link",
            content: M.map((C) => C.content).join(""),
            href: k,
            parts: M
          }), l = N + m.length;
          return;
      ...
      if (h === "span" && p && Ue(p, "data-type") === "math") {
        const M = Ue(p, "data-latex") || "", C = Ue(p, "data-display") === "true", R = Ue(p, "data-id");
        i.push({
          type: "math",
          latex: M,
          display: C,
...
function y({
  ...
  const P = Ze(), k = je(n, P), M = Ys(i, P), C = g ?? N, R = { "data-type": "text" };
  return t && (R["data-bold"] = "true"), u && (R["data-italics"] = "true"), r && (R["data-underline"] = "true"), k && (R["data-color"] = k), s != null && (R["data-size"] = s), M && (R["data-font"] = M), l && (R["data-smallcaps"] = "true"), f && (R["data-allcaps"] = "true"), m && (R["data-strike"] = "true"), h && (R["data-subscript"] = "true"), p && (R["data-superscript"] = "true"), C && (R["data-style"] = C), /* @__PURE__ */ E("span", { ...R, ...L, children: d0(e) });
}
function f0(e) {
  return e.parts?.length ? e.parts : [{ content: e.content }];
}
function ta({ part: e }) {
  const t = e.href || "", u = t.startsWith("#") ? t.slice(1) : null;
  return /* @__PURE__ */ E("a", { ...u ? { "data-type": "internalHyperlink", "data-anchor": u } : { "data-type": "externalHyperlink", "data-link": t }, href: t, children: f0(e).map((n, s) => /* @__PURE__ */ E(
    y,
    {
      style: "Hyperlink",
      bold: n.bold,
...
function O({
  ...
  const l = E0({ tabStops: u, indent: r, role: n });
  if (t) {
    const f = ea(t);
    return /* @__PURE__ */ E(e, { "data-type": "paragraph", ...l, ...i, children: f.map((m, h) => m.type === "link" ? /* @__PURE__ */ E(ta, { part: m }, h) : m.type === "math" ? /* @__PURE__ */ E(
      h0,
      {
        latex: m.latex,
        display: m.display,
...
function ua({ level: e, data: t, children: u, ...r }) {
  const n = `h${e}`;
  if (t) {
    const s = ea(t);
    return /* @__PURE__ */ E(n, { "data-type": "paragraph", "data-heading": `HEADING_${e}`, ...r, children: s.map(
      (i, l) => i.type === "link" ? /* @__PURE__ */ E(ta, { part: i }, l) : /* @__PURE__ */ E(
        y,
        {
          bold: i.bold,
          italics: i.italics,
...
function m0(e) {
  return /* @__PURE__ */ E(ua, { level: 1, ...e });
}
function T0(e) {
  return /* @__PURE__ */ E(ua, { level: 2, ...e });
}
function b0(e, t) {
...
const ra = _t({ widths: null, borderColor: "cccccc" });
function pt({
  widths: e,
  columnWidths: t,
  layout: u,
...
function G({
  ...
  const { widths: N, borderColor: L, theme: P } = At(ra), k = u ?? N?.[e], M = {
    "data-type": "tableCell",
  ...
  if (k != null && (M["data-width-size"] = k, M["data-width-type"] = "pct"), s) {
    const z = typeof s == "string" ? { fill: s } : s, tt = je(z.fill, P), ut = je(z.color, P);
    tt && (M["data-shading-fill"] = tt), z.type && (M["data-shading-type"] = z.type), ut && (M["data-shading-color"] = ut);
  }
  i && (M["data-valign"] = i), typeof l == "number" && l > 1 && (M["data-grid-span"] = l), typeof f == "number" && f > 1 && (M["data-row-span"] = f);
  const C = k != null ? { flex: `${k} ${k} 0%`, minWidth: 0, ...h } : h;
  return /* @__PURE__ */ E("div", { className: m, style: C, ...M, ...g, children: typeof p == "string" || typeof p == "number" ? /* @__PURE__ */ E(O, { children: r || t ? /* @__PURE__ */ E(y, { bold: !0, children: p }) : p }) : p });
}
...
function D0({ bd: e }) {
  ...
  return /* @__PURE__ */ S(Ie, { children: [
    ...
    /* @__PURE__ */ E(pt, { widths: [50, 50], borders: Xt(), children: /* @__PURE__ */ S(Ne, { children: [
    ...
    /* @__PURE__ */ E(pt, { widths: [33, 33, 34], borders: Xt(), children: /* @__PURE__ */ S(Ne, { children: [
      ...
      t?.issued && /* @__PURE__ */ S(G, { borderBottom: "none", children: [
        ...
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(Ju, { value: t.issued, format: "long" }) }) })
      ] }),
      t?.due && /* @__PURE__ */ S(G, { borderBottom: "none", children: [
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Label", children: "Due" }) }),
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(Ju, { value: t.due, format: "long" }) }) })
      ] })
    ] }) }),
    t?.period && /* @__PURE__ */ S(Ie, { children: [
      /* @__PURE__ */ E(O, { "data-spacing-before": 120, children: /* @__PURE__ */ E(y, { role: "Label", children: "Period" }) }),
      /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(Zr, { period: t.period, format: "long" }) }) })
    ] })
  ] });
}
function L0({ bd: e }) {
      ...
      children: [
        ...
        t.map((n, s) => /* @__PURE__ */ S(Ne, { children: [
          /* @__PURE__ */ S(G, { valign: "center", children: [
            ...
            n.period && /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Caption", children: /* @__PURE__ */ E(Zr, { period: n.period, format: "medium" }) }) })
          ] }),
...
function P0({ content: e, block: t }) {
  const { title: u, items: r, sequence: n } = e, s = (() => {
  ...
  })(), i = O0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ S(Ie, { children: [
    ...
    r.map((h, p) => /* @__PURE__ */ S(dt, { children: [
      h.title && /* @__PURE__ */ E(
        O,
        {
          role: "Heading2",
    ...
    r.length > 0 && /* @__PURE__ */ E("div", { className: "invoice-items", children: r.map((h, p) => /* @__PURE__ */ S(dt, { children: [
...
function K0({ content: e, block: t }) {
  ...
  let n = null;
  if (u && (r === "cover" ? n = /* @__PURE__ */ E(D0, { bd: u }) : r === "line-items" ? n = /* @__PURE__ */ E(L0, { bd: u }) : r === "totals" && (n = /* @__PURE__ */ E(R0, { bd: u }))), r === "cover" && u?.vendor?.logo) {
    const l = /* @__PURE__ */ E(I0, { children: /* @__PURE__ */ E(g0, { url: u.vendor.logo, width: oe(4), align: "right" }) });
    se(t, "docx", l, { role: "header" });
  }
  if (n)
    return se(t, "docx", n), se(t, "html", n), /* @__PURE__ */ E("section", { className: `invoice-section invoice-${r}`, children: n });
  const { docxBody: s, previewJsx: i } = P0({ content: e, block: t });
...
function $0({ content: e, block: t }) {
  const { title: u, items: r, sequence: n } = e, s = Vr(), i = M0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ S(Ie, { children: [
    u && /* @__PURE__ */ E(m0, { data: u, "data-spacing-after": 240 }),
    l.map((h, p) => /* @__PURE__ */ E(O, { data: h, "data-spacing-after": 120 }, `p${p}`)),
    r.map((h, p) => /* @__PURE__ */ S(dt, { children: [
      h.title && /* @__PURE__ */ E(T0, { data: h.title, "data-spacing-before": 200, "data-spacing-after": 120 }),
      h.paragraphs.map((g, N) => /* @__PURE__ */ E(O, { data: g, "data-spacing-after": 100 }, `${p}-${N}`))
    ] }, p))
    ...
    r.length > 0 && /* @__PURE__ */ E("div", { className: "sow-items", children: r.map((h, p) => /* @__PURE__ */ S(dt, { children: [
...
function B0({ title: e = "Document", filename: t = "document" }) {
  const { website: u } = lu(), [r, n] = ct(null), [s, i] = ct(null), [l, f] = ct(!1), m = oa(null);
  gt(() => {
    if (!l) return;
    const g = (N) => {
  ...
  const h = Object.keys(We.outputs || {}).filter((g) => ot[g]), p = async (g) => {
    i(null), n(g), f(!1);
    try {
      const N = await Fc(u, { format: g, foundation: We, title: e }), L = We.outputs?.[g]?.extension || ot[g]?.ext || g;
      xc(N, `${t}.${L}`);
    } catch (N) {
...
function x0({ body: e, page: t }) {
  ...
  return gt(() => $c(t), [t]), /* @__PURE__ */ S(gr, { basePath: u.basePath, children: [
    /* @__PURE__ */ E("main", { className: "business-docs-body", children: /* @__PURE__ */ E("div", { className: "business-docs-document", children: e }) }),
    /* @__PURE__ */ E(B0, { title: r, filename: n })
  ] });
}
const k0 = { ...We, vars: Hs || We?.vars, layouts: { BusinessDocLayout: x0 } }, w0 = {}, F0 = {}, z0 = { meta: w0, capabilities: k0, layoutMeta: F0 };
export {
  de as D,
  G0 as E,
  K0 as I,
...
//# sourceMappingURL=_entry.generated-B1pXVjqi.js.map
