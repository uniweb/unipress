...
import { createContext as _t, useContext as At, useMemo as _e, createElement as kt, useState as ot, useEffect as gt, useReducer as ur, Children as ar, isValidElement as rr, cloneElement as nr, Fragment as dt, useRef as sr } from "react";
import { renderToStaticMarkup as Jt } from "react-dom/server";
import { getUniweb as Zu, deriveCacheKey as ir } from "@uniweb/core";
const ea = /\s+/, or = /([+\-*\/=<>!&|]+)/, du = {
  "|": 1,
  "&": 2,
  "=": 3,
...
function De(e, t, u = {}) {
  ...
  function x(D, $) {
    if (s && D == "text") {
      const ue = $.trim().split(ea);
      for (let z of ue)
        z = lr(z), z !== "" && i.push({ type: D, value: z });
    } else
      i.push({ type: D, value: $ });
    f = "";
  }
...
function ta(e, t = []) {
  ...
  for (let s = 1; s < u.length; s += 2) {
    ...
    if (i.length < 3 || !i.startsWith("[") || !i.endsWith("]"))
      ...
      const m = i.slice(1, -1).trim().split(ea), h = m.shift(), p = m[0] === "$0";
...
function dr(e) {
  ...
  for (let s of e)
    if (s.type === "text")
      if (u = s.value.split(or), u.length <= 1)
        t.push(s);
      else
...
function Er(e) {
  const t = dr(e), u = fr(t);
  for (const a of u)
    a.type === "chain" && (a.type = "enclosure", a.value = hr(a.tokens), delete a.tokens);
  return u;
}
function mr(e) {
  if (!e.length) return [];
...
}, pr = ["wrap", "aux", "label", "heading", "title"];
let wt;
const Eu = {};
function mu(e, t, u) {
  Eu[e] ??= _r(e);
  ...
  !t.type && typeof t.as == "string" && (t.type = t.as), t.lang ? t.locale = t.lang : (t.locale || (t.locale = qe(t.locale)), t.lang = ia(t.locale)), t._name = e;
...
function Le(e, t) {
  if (e.type ??= ht(t, e), e.row ? (t = Vr(t, e.row), e.type = "list") : t = ce(t, e.type, e), t === null) return "";
  const u = e.json ? "json" : e.type, a = { ...e };
  pr.forEach((s) => {
    delete a[s];
  });
  const n = { ...a, [e.type]: e[e.type] };
  return t = jr(u, n, t), e.title && fe(t) && (t = sa(t, e.locale)), e.aux && (B(t) && (t = t.join(e.sep || ", ")), t = Zt(e, t)), e.label && (B(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = _n(e, t)), e.heading && (B(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = pn(e, t)), e.wrap && (Nt(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function jr(e, t, u) {
  switch (e) {
    case "null":
...
function cn(e, t) {
  const u = e.date ? ln : aa, a = e.desc ? -1 : 1;
...
function ln(e, t, u) {
  ...
  return Ce(a) && Ce(n) ? ce(a, "date").getTime() - ce(n, "date").getTime() : aa(e, t, u);
}
function aa(e, t, u) {
  let a = ft(t, e), n = ft(u, e);
  const s = ee(a), i = ee(n);
...
function ra(e, t) {
  const u = [];
  for (let a of t)
    B(a) ? a = ra(e, a) : X(a) && (a = na(e, a)), Nt(a) || u.push(a);
...
let Sn = class extends G {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { amount: t, currency: u, convertedAmount: a } = this.parsedArgs, n = Tr[u.toLowerCase()], i = [["u-amount", n ? new Intl.NumberFormat(`${qe()}-CA`, {
      style: "currency",
      currency: n
    }).format(t) : t]];
...
class Dn {
   ...
   */
  constructor(t = {}, u = {}) {
    this.snippets = ta(t), this.functions = u;
  }
  /**
  ...
  getVariableMeta(t) {
    ...
    return typeof u == "string" ? { label: u } : (u.label ??= sa(t.split("_").join(" ")), u);
  }
  /**
  ...
  evaluateExpression(t, u = null) {
    ...
    return u && u.has(a) ? { value: u.get(a), type: "aux" } : Au.test(a) ? {
      ...
      type: "variable"
    } : yn.test(a) ? { value: parseFloat(a), type: "number" } : { value: this.getError(103, "Invalid expression", a), type: "error" };
  }
...
oa.sort((e, t) => t.length - e.length);
const Ln = new Set(oa.map((e) => e.join(" ").toUpperCase())), Rn = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
...
` || n === "\r") {
    ...
    if (Rt.test(n) || n === "-" && Rt.test(e[a + 1] || "") && Fn(t)) {
      let i = a + (n === "-" ? 1 : 0);
...
function gu(e) {
  ...
  const a = t[0];
  return u.length === 0 && es(a) ? { type: "show", value: a, modifiers: [] } : { type: "show", value: a, modifiers: u };
}
function Zn(e) {
  const t = [];
  for (; e.i < e.tokens.length; ) {
...
function ts(e) {
  ...
  const a = u[0], n = u[1];
  return n === "date" && vn.has(a) ? { type: "date", value: a } : n === "only" && (a === "year" || a === "month") ? { type: "date", value: a === "year" ? "y" : "m" } : Rn.has(a) ? { type: a, value: n ?? null } : (n != null && e.i--, { type: a, value: null });
}
function us(e) {
...
function Ht(e) {
  ...
  if (t && t.type === "lparen") {
    w(e);
    const u = da(e);
    return la(e, "rparen"), { type: "group", inner: u };
  }
  return ss(e);
}
...
function k(e) {
  switch (e.type) {
    ...
    case "forEach":
      return hs(e);
    default:
      throw new fa(`Unknown node type: ${e.type}`);
  }
}
function os(e) {
...
function cs(e) {
  ...
  for (let l = 0; l < e.modifiers.length; l++) {
    ...
    switch (f.type) {
      ...
      default:
        throw new fa(`Unknown modifier type: ${f.type}`);
    }
  }
  return n;
}
...
function Ls(e, t = {}, u = {}) {
  const a = Ea(e?.items), n = e?.tax?.jurisdiction || t.tax_jurisdiction || null;
  if (!n)
    return { jurisdiction: null, rate: 0, amount: 0, label: "" };
  const s = Ds(n, u), i = e?.tax?.rate != null ? Number(e.tax.rate) : s.rate, l = e?.tax?.amount != null ? Number(e.tax.amount) : Math.round(a * i * 100) / 100;
  return { jurisdiction: n, rate: i, amount: l, label: s.label };
}
function It(e, t = {}, u = {}) {
  const a = Ea(e?.items), n = Ls(e, t, u), s = Math.round((a + n.amount) * 100) / 100;
  return {
    subtotal: a,
    tax_amount: n.amount,
    tax_rate: n.rate,
...
function xs({ invoices: e = [], sows: t = [] } = {}) {
  ...
  for (const n of e) {
    ...
    ), Array.isArray(n?.items) && l?.expires && n.items.some((h) => Ms(h?.period, l.expires)) && a(
      i ? "warn" : "info",
...
function Du(e, t) {
  const u = t?.website?.config?.business_docs || {}, a = u.vendor || {}, n = u.defaults || {}, s = u.registries?.tax || {}, i = xe("invoices", e, t), l = xe("sows", e, t), f = { vendor: a, defaults: n }, m = Ta({ invoice: e?.invoice, invoices: i });
  if (m) {
    const p = It(m, n, s), g = Array.isArray(m.items) ? m.items.map((N) => ({ ...N, amount: ru(N) })) : [];
    return { ...f, ...m, items: g, ...p };
  }
  const h = ba({ sow: e?.sow, sows: l });
...
const ct = {
  ...
  handlers: {
     ...
     */
    props: (e, t, u) => {
      const a = u.parsedContent?.data, n = Du(a, u), s = u?.website?.config?.business_docs || {}, i = s.vendor || {}, l = s.defaults || {}, f = s.registries?.tax || {}, m = Ta({
        invoice: a?.invoice,
        invoices: xe("invoices", a, u)
      }), h = ba({
        sow: a?.sow,
        sows: xe("sows", a, u)
      }), p = m ? It(m, l, f) : null, g = m && Array.isArray(m.items) ? m.items.map((L) => ({ ...L, amount: ru(L) })) : [], N = ws({ params: t, content: e, block: u });
      return {
        content: {
          ...e,
...
function Aa({
  ...
  ), /* @__PURE__ */ E(pa.Provider, { value: n, children: /* @__PURE__ */ E(Yt.Provider, { value: s, children: /* @__PURE__ */ E(Wt.Provider, { value: i, children: e }) }) });
}
function se(e, t, u, a = {}) {
  const n = At(pa);
  if (!n) {
...
class Ks {
  ...
  advance() {
    ...
    return t === o.CARRIAGE_RETURN ? (this.isEol = !0, this.skipNextNewLine = !0, o.LINE_FEED) : t === o.LINE_FEED && (this.isEol = !0, this.skipNextNewLine) ? (this.line--, this.skipNextNewLine = !1, this._addGap(), this.advance()) : (this.skipNextNewLine = !1, ga(t) && (t = this._processSurrogate(t)), this.handler.onParseError === null || t > 31 && t < 127 || t === o.LINE_FEED || t === o.CARRIAGE_RETURN || t > 159 && t < 64976 || this._checkForProblematicCharacters(t), t);
  }
  _checkForProblematicCharacters(t) {
    Na(t) ? this._err(b.controlCharacterInInputStream) : Ia(t) && this._err(b.noncharacterInInputStream);
  }
  retreat(t) {
...
class Js {
  ...
  stateNamedEntity(t, u) {
    ...
    for (; u < t.length; u++, this.excess++) {
      ...
      if (this.treeIndex = Zs(a, n, this.treeIndex + Math.max(1, s), i), this.treeIndex < 0)
...
function Ct(e) {
  var t;
  return (t = ei.get(e)) !== null && t !== void 0 ? t : r.UNKNOWN;
}
const A = r, ti = {
...
function Bu(e) {
  return Sa(e) || e === o.SOLIDUS || e === o.GREATER_THAN_SIGN;
}
function ri(e) {
  return e === o.NULL ? b.nullCharacterReference : e > 1114111 ? b.characterReferenceOutsideUnicodeRange : ga(e) ? b.surrogateCharacterReference : Ia(e) ? b.noncharacterCharacterReference : Na(e) || e === o.CARRIAGE_RETURN ? b.controlCharacterReference : null;
}
class ni {
  constructor(t, u) {
    this.options = t, this.handler = u, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = c.DATA, this.returnState = c.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new Ks(u), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new Js($s, (a, n) => {
  ...
  _leaveAttrName() {
    ...
    if (Ca(a, this.currentAttr.name) === null) {
  ...
  _emitCodePoint(t) {
    const u = Sa(t) ? y.WHITESPACE_CHARACTER : t === o.NULL ? y.NULL_CHARACTER : y.CHARACTER;
...
const Oa = /* @__PURE__ */ new Set([r.DD, r.DT, r.LI, r.OPTGROUP, r.OPTION, r.P, r.RB, r.RP, r.RT, r.RTC]), Mu = /* @__PURE__ */ new Set([
  ...Oa,
  r.CAPTION,
  r.COLGROUP,
  r.TBODY,
  ...
  r.TEMPLATE,
  r.TH
]), si = /* @__PURE__ */ new Set([...mt, r.OL, r.UL]), ii = /* @__PURE__ */ new Set([...mt, r.BUTTON]), xu = /* @__PURE__ */ new Set([r.ANNOTATION_XML, r.MI, r.MN, r.MO, r.MS, r.MTEXT]), ku = /* @__PURE__ */ new Set([r.DESC, r.FOREIGN_OBJECT, r.TITLE]), oi = /* @__PURE__ */ new Set([r.TR, r.TEMPLATE, r.HTML]), ci = /* @__PURE__ */ new Set([r.TBODY, r.TFOOT, r.THEAD, r.TEMPLATE, r.HTML]), li = /* @__PURE__ */ new Set([r.TABLE, r.TEMPLATE, r.HTML]), di = /* @__PURE__ */ new Set([r.TD, r.TH]);
class fi {
  ...
  generateImpliedEndTags() {
    for (; this.currentTagId !== void 0 && Oa.has(this.currentTagId); )
      this.pop();
  }
...
const Te = {
...
}, ya = "html", Ei = "about:legacy-compat", mi = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", Da = [
  ...
  "html"
]), La = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], pi = [
  ...La,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function _i(e) {
  return e.name === ya && e.publicId === null && (e.systemId === null || e.systemId === Ei);
}
function Ai(e) {
  if (e.name !== ya)
    return j.QUIRKS;
...
function yi(e) {
  const t = e.tagID;
  return t === r.FONT && e.attrs.some(({ name: a }) => a === Ae.COLOR || a === Ae.SIZE || a === Ae.FACE) || Oi.has(t);
}
function Ra(e) {
...
function Pi(e, t, u, a) {
  return (!a || a === _.HTML) && Ri(e, t, u) || (!a || a === _.MATHML) && Li(e, t);
}
...
class wi {
  constructor(t, u, a = null, n = null) {
    this.fragmentContext = a, this.scriptHandler = n, this.currentToken = null, this.stopped = !1, this.insertionMode = d.INITIAL, this.originalInsertionMode = d.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...Uu,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = u ?? this.treeAdapter.createDocument(), this.tokenizer = new ni(this.options, this), this.activeFormattingElements = new hi(this.treeAdapter), this.fragmentContextID = a ? Ct(this.treeAdapter.getTagName(a)) : r.UNKNOWN, this._setContextModes(a ?? this.document, this.fragmentContextID), this.openElements = new fi(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, u) {
    const a = new this(u);
...
function Fi(e, t) {
  ...
  return u ? e.openElements.contains(u.element) ? e.openElements.hasInScope(t.tagID) || (u = null) : (e.activeFormattingElements.removeEntry(u), u = null) : Fa(e, t), u;
}
function Hi(e, t) {
...
function Ui(e, t, u) {
  ...
  for (let s = 0, i = n; i !== u; s++, i = n) {
    ...
    !l || f ? (f && e.activeFormattingElements.removeEntry(l), e.openElements.remove(i)) : (i = vi(e, l), a === t && (e.activeFormattingElements.bookmark = l), e.treeAdapter.detachNode(a), e.treeAdapter.appendChild(i, a), a = i);
  }
  return a;
}
function vi(e, t) {
...
function su(e, t) {
  for (let u = 0; u < Mi; u++) {
    ...
    const s = Ui(e, n, a.element), i = e.openElements.getCommonAncestor(a.element);
    e.treeAdapter.detachNode(s), i && Yi(e, i, s), Wi(e, n, a);
  }
}
function $t(e, t) {
...
function wa(e) {
  const t = Ca(e, Ae.TYPE);
  return t != null && t.toLowerCase() === Bi;
}
function bo(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, _.HTML), wa(t) || (e.framesetOk = !1), t.ackSelfClosing = !0;
}
function po(e, t) {
  e._appendElement(t, _.HTML), t.ackSelfClosing = !0;
}
...
function Ao(e, t) {
  t.tagName = T.IMG, t.tagID = r.IMG, ka(e, t);
}
function go(e, t) {
...
function Do(e, t) {
  e._reconstructActiveFormattingElements(), Ra(t), nu(t), t.selfClosing ? e._appendElement(t, _.MATHML) : e._insertElement(t, _.MATHML), t.ackSelfClosing = !0;
}
function Lo(e, t) {
  e._reconstructActiveFormattingElements(), Pa(t), nu(t), t.selfClosing ? e._appendElement(t, _.SVG) : e._insertElement(t, _.SVG), t.ackSelfClosing = !0;
}
function Yu(e, t) {
...
function Po(e, t) {
  e.openElements.hasInScope(r.BODY) && (e.insertionMode = d.AFTER_BODY, za(e, t));
}
function Bo(e, t) {
  const u = t.tagID;
...
function Ha(e, t) {
  e.tmplInsertionModeStack.length > 0 ? $a(e, t) : iu(e, t);
}
function vo(e, t) {
  var u;
...
function qo(e, t) {
  wa(t) ? e._appendElement(t, _.HTML) : Ze(e, t), t.ackSelfClosing = !0;
}
function Vo(e, t) {
...
const Ya = /* @__PURE__ */ new Set([r.CAPTION, r.COL, r.COLGROUP, r.TBODY, r.TD, r.TFOOT, r.TH, r.THEAD, r.TR]);
function jo(e, t) {
  const u = t.tagID;
  Ya.has(u) ? e.openElements.hasInTableScope(r.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(r.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, ke(e, t)) : K(e, t);
}
function Xo(e, t) {
  const u = t.tagID;
  switch (u) {
...
function Zo(e, t) {
  const u = t.tagID;
  Ya.has(u) ? (e.openElements.hasInTableScope(r.TD) || e.openElements.hasInTableScope(r.TH)) && (e._closeTableCell(), Dt(e, t)) : K(e, t);
}
function ec(e, t) {
  const u = t.tagID;
  switch (u) {
    ...
    case r.THEAD:
    case r.TR: {
      e.openElements.hasInTableScope(u) && (e._closeTableCell(), Wa(e, t));
      break;
    }
    case r.BODY:
    case r.CAPTION:
...
function tc(e, t) {
  const u = t.tagID;
  u === r.CAPTION || u === r.TABLE || u === r.TBODY || u === r.TFOOT || u === r.THEAD || u === r.TR || u === r.TD || u === r.TH ? (e.openElements.popUntilTagNamePopped(r.SELECT), e._resetInsertionMode(), e._processStartTag(t)) : Ga(e, t);
}
function uc(e, t) {
  const u = t.tagID;
  u === r.CAPTION || u === r.TABLE || u === r.TBODY || u === r.TFOOT || u === r.THEAD || u === r.TR || u === r.TD || u === r.TH ? e.openElements.hasInTableScope(u) && (e.openElements.popUntilTagNamePopped(r.SELECT), e._resetInsertionMode(), e.onEndTag(t)) : Ka(e, t);
}
function ac(e, t) {
  switch (t.tagID) {
...
function Ec(e, t) {
  if (yi(t))
    ...
    a === _.MATHML ? Ra(t) : a === _.SVG && (Di(t), Pa(t)), nu(t), t.selfClosing ? e._appendElement(t, a) : e._insertElement(t, a), t.ackSelfClosing = !0;
  }
}
function mc(e, t) {
...
function Tc(e, t, u) {
  ...
  const a = wi.getFragmentParser(e, u);
...
function Cc(e) {
  ...
  const a = Sc(e, "data-type") || t;
  if (a === "emptyLine") return null;
  if (a === "contentWrapper")
    return Qt(e);
  const n = gc(e.attrs || []), s = Qt(e), i = { type: a, ...n };
...
const Oc = {
  docx: { load: () => import("./docx-BtJoFP9Y.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-ByoeiX6E.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-CzGm8MET.js"), consumes: "typst", ir: !0 },
  ...
  epub: { load: () => import("./epub-CRXWYUmC.js"), consumes: "html", ir: !1 }
};
function cu(e) {
  const t = Oc[e];
  return t ? {
...
function Mc(e, t, u = {}) {
  const { basePath: a, theme: n } = u, s = _a();
  return Jt(
    kt(
      Aa,
...
function xc(e, t) {
  ...
  if (!u) return;
  const a = u.consumes;
  if (!(Wu.has(a) || (e.getOutputs && e.getOutputs(a) || []).length > 0) && (Wu.add(a), typeof console < "u" && console.warn)) {
...
function Va(e) {
  const t = Zu()?.activeWebsite ?? null, u = e && t ? ir(e) : null, a = u ? t.dataStore.get(u) : null, [n, s] = ot(
    () => a ? rt(a.data) : u ? $u() : Ku()
  );
  return gt(() => {
    if (!u || !t) {
...
function Lt(e, t) {
  const { website: u } = lu(), [, a] = ur(vc, 0), s = u.activePage?.state;
  gt(() => {
    if (s)
...
const ja = "business-docs/report-options", he = {
  source: "invoices",
...
function Yc() {
  ...
  try {
    const e = window.localStorage.getItem(ja);
    if (!e) return null;
    const t = JSON.parse(e);
    return {
...
function e0(e, t) {
  const [u] = Xa(), [a] = Kc(), [n] = $c(), [s] = zc(), i = t?.website?.config?.business_docs || {}, l = i.defaults || {}, f = i.registries?.tax || {}, m = _e(
...
function v0({ content: e, block: t }) {
  const u = t?.website?.config?.business_docs || {}, a = u.defaults || {}, n = u.registries?.tax || {}, s = a.currency || "CAD", i = a.locale || "en-CA", l = (I) => t0(I, { currency: s, locale: i }), f = (I) => Vt(I, { locale: i }), [m] = Xa(), h = m !== "sows", {
    records: p,
    count: g,
    sumSubtotals: N,
    sumTotals: L,
...
function O({
  ...
  const N = Je(), L = Ve(n, N), M = Hs(i, N), x = h ?? p, R = { "data-type": "text" };
...
function er({ level: e, data: t, children: u, ...a }) {
  const n = `h${e}`;
  if (t) {
    const s = Za(t);
...
function f0(e) {
  return /* @__PURE__ */ E(er, { level: 1, ...e });
}
function h0(e) {
  return /* @__PURE__ */ E(er, { level: 2, ...e });
}
function E0(e, t) {
...
const tr = _t({ widths: null, borderColor: "cccccc" });
function pt({
  widths: e,
  columnWidths: t,
  layout: u,
...
function W({
  ...
  const { widths: N, borderColor: L, theme: M } = At(tr), x = u ?? N?.[e], R = {
    "data-type": "tableCell",
...
function S0({ bd: e }) {
  ...
  return /* @__PURE__ */ C(Ne, { children: [
    ...
    t?.period && /* @__PURE__ */ C(Ne, { children: [
      ...
      /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(Ja, { period: t.period, format: "long" }) }) })
    ] })
  ] });
}
function O0({ bd: e }) {
      ...
      children: [
        ...
        t.map((n, s) => /* @__PURE__ */ C(ge, { children: [
          /* @__PURE__ */ C(W, { valign: "center", children: [
            ...
            n.period && /* @__PURE__ */ E(S, { children: /* @__PURE__ */ E(O, { role: "Caption", children: /* @__PURE__ */ E(Ja, { period: n.period, format: "medium" }) }) })
          ] }),
...
function W0({ content: e, block: t }) {
  const { title: u, items: a, sequence: n } = e, s = qa(), i = L0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ C(Ne, { children: [
...
function R0({ title: e = "Document", filename: t = "document" }) {
  const { website: u } = lu(), [a, n] = ot(null), [s, i] = ot(null), [l, f] = ot(!1), m = sr(null);
  gt(() => {
    if (!l) return;
    const g = (N) => {
...
function P0({ body: e, page: t }) {
  ...
  return gt(() => Gc(t), [t]), /* @__PURE__ */ C(Aa, { basePath: u.basePath, children: [
...
//# sourceMappingURL=_entry.generated-CzXBEDd_.js.map
