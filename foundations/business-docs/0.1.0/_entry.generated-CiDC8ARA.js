...
import { createContext as pt, useContext as _t, useMemo as Ae, createElement as kt, useState as ot, useEffect as At, useReducer as aa, Children as na, isValidElement as sa, cloneElement as ia, Fragment as lt, useRef as oa } from "react";
import { renderToStaticMarkup as Jt } from "react-dom/server";
import { getUniweb as er, deriveCacheKey as ca } from "@uniweb/core";
const tr = pt(null), wt = pt(""), ce = {
  colors: {
...
function qe(e, t = ce) {
  ...
  const u = t && t.colors ? t.colors : ce.colors;
  return Object.prototype.hasOwnProperty.call(u, e) ? du(u[e]) : du(e);
}
function la(e, t = ce) {
  if (!e) return;
  if (typeof e != "string") return e;
  const u = t && t.fonts ? t.fonts : ce.fonts;
...
function da(e) {
  return e ? {
    colors: { ...ce.colors, ...e.colors || {} },
    fonts: { ...ce.fonts, ...e.fonts || {} },
    ...Object.fromEntries(
...
function rr({
  ...
  ), /* @__PURE__ */ E(tr.Provider, { value: n, children: /* @__PURE__ */ E(wt.Provider, { value: s, children: /* @__PURE__ */ E(Ft.Provider, { value: i, children: e }) }) });
}
function se(e, t, u, r = {}) {
  const n = _t(tr);
  if (!n) {
...
function sr(e) {
  return e >= 64976 && e <= 65007 || fa.has(e);
}
var b;
(function(e) {
...
class Ta {
  constructor(t) {
    this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = ma, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (ha(u))
        return this.pos++, this._addGap(), Ea(t, u);
  ...
  advance() {
    ...
    return t === o.CARRIAGE_RETURN ? (this.isEol = !0, this.skipNextNewLine = !0, o.LINE_FEED) : t === o.LINE_FEED && (this.isEol = !0, this.skipNextNewLine) ? (this.line--, this.skipNextNewLine = !1, this._addGap(), this.advance()) : (this.skipNextNewLine = !1, ar(t) && (t = this._processSurrogate(t)), this.handler.onParseError === null || t > 31 && t < 127 || t === o.LINE_FEED || t === o.CARRIAGE_RETURN || t > 159 && t < 64976 || this._checkForProblematicCharacters(t), t);
  }
  _checkForProblematicCharacters(t) {
    nr(t) ? this._err(b.controlCharacterInInputStream) : sr(t) && this._err(b.noncharacterInInputStream);
  }
  retreat(t) {
...
const ba = /* @__PURE__ */ new Uint16Array(
  // prettier-ignore
...
function Na(e) {
  return e >= Y.UPPER_A && e <= Y.UPPER_Z || e >= Y.LOWER_A && e <= Y.LOWER_Z || Ht(e);
}
function Ia(e) {
  return e === Y.EQUALS || Na(e);
}
var v;
(function(e) {
...
class Ca {
  constructor(t, u, r) {
    this.decodeTree = t, this.emitCodePoint = u, this.errors = r, this.state = v.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = ie.Strict;
  }
  ...
  write(t, u) {
    switch (this.state) {
      case v.EntityStart:
        return t.charCodeAt(u) === Y.NUM ? (this.state = v.NumericStart, this.consumed += 1, this.stateNumericStart(t, u + 1)) : (this.state = v.NamedEntity, this.stateNamedEntity(t, u));
      case v.NumericStart:
  ...
  stateNumericStart(t, u) {
    return u >= t.length ? -1 : (t.charCodeAt(u) | Aa) === Y.LOWER_X ? (this.state = v.NumericHex, this.consumed += 1, this.stateNumericHex(t, u + 1)) : (this.state = v.NumericDecimal, this.stateNumericDecimal(t, u));
  }
  ...
  emitNumericEntity(t, u) {
    ...
    if (t === Y.SEMI)
      ...
      return 0;
    return this.emitCodePoint(_a(this.result), this.consumed), this.errors && (t !== Y.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(t, u) {
    ...
    for (; u < t.length; u++, this.excess++) {
      ...
      if (this.treeIndex = Sa(r, n, this.treeIndex + Math.max(1, s), i), this.treeIndex < 0)
        ...
        Ia(i)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function gt(e) {
  var t;
  return (t = Oa.get(e)) !== null && t !== void 0 ? t : a.UNKNOWN;
}
const A = a, ya = {
...
}, Ut = /* @__PURE__ */ new Set([A.H1, A.H2, A.H3, A.H4, A.H5, A.H6]);
...
function hu(e) {
  return or(e) || e === o.SOLIDUS || e === o.GREATER_THAN_SIGN;
}
function Ra(e) {
  return e === o.NULL ? b.nullCharacterReference : e > 1114111 ? b.characterReferenceOutsideUnicodeRange : ar(e) ? b.surrogateCharacterReference : sr(e) ? b.noncharacterCharacterReference : nr(e) || e === o.CARRIAGE_RETURN ? b.controlCharacterReference : null;
}
class Pa {
  constructor(t, u) {
    this.options = t, this.handler = u, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = c.DATA, this.returnState = c.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new Ta(u), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new Ca(ba, (r, n) => {
  ...
  _leaveAttrName() {
    ...
    if (ir(r, this.currentAttr.name) === null) {
  ...
  emitCurrentTagToken() {
    ...
    this.prepareToken(t), t.tagID = gt(t.tagName), t.type === D.START_TAG ? (this.lastStartTagName = t.tagName, this.handler.onStartTag(t)) : (t.attrs.length > 0 && this._err(b.endTagWithAttributes), t.selfClosing && this._err(b.endTagWithTrailingSolidus), this.handler.onEndTag(t)), this.preprocessor.dropParsedChunk();
  }
  ...
  _emitCodePoint(t) {
    const u = or(t) ? D.WHITESPACE_CHARACTER : t === o.NULL ? D.NULL_CHARACTER : D.CHARACTER;
  ...
  _stateRcdata(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this._emitChars(M);
        break;
      }
      case o.EOF: {
        this._emitEOFToken();
  ...
  _stateTagName(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.tagName += M;
        break;
      }
      case o.EOF: {
      ...
      default:
        u.tagName += String.fromCodePoint(ve(t) ? ut(t) : t);
    }
  }
  ...
  _stateScriptDataEscapedDash(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.state = c.SCRIPT_DATA_ESCAPED, this._emitChars(M);
        break;
      }
      case o.EOF: {
        this._err(b.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
  ...
  _stateScriptDataDoubleEscapeStart(t) {
    if (this.preprocessor.startsWith(Q.SCRIPT, !1) && hu(this.preprocessor.peek(Q.SCRIPT.length))) {
      this._emitCodePoint(t);
  ...
  _stateScriptDataDoubleEscapedDash(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.state = c.SCRIPT_DATA_DOUBLE_ESCAPED, this._emitChars(M);
        break;
      }
      case o.EOF: {
        this._err(b.eofInScriptHtmlCommentLikeText), this._emitEOFToken();
  ...
  _stateAttributeName(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.currentAttr.name += M;
        break;
      }
      default:
        this.currentAttr.name += String.fromCodePoint(ve(t) ? ut(t) : t);
    }
  }
  ...
  _stateAttributeValueDoubleQuoted(t) {
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), this.currentAttr.value += M;
        break;
      }
      case o.EOF: {
        this._err(b.eofInTag), this._emitEOFToken();
  ...
  _stateBogusComment(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.data += M;
        break;
      }
      default:
  ...
  _stateBeforeDoctypeName(t) {
    if (ve(t))
      this._createDoctypeToken(String.fromCharCode(ut(t))), this.state = c.DOCTYPE_NAME;
    else
      switch (t) {
        case o.SPACE:
        case o.LINE_FEED:
        ...
        case o.FORM_FEED:
          break;
        case o.NULL: {
          this._err(b.unexpectedNullCharacter), this._createDoctypeToken(M), this.state = c.DOCTYPE_NAME;
          break;
        }
        case o.GREATER_THAN_SIGN: {
  ...
  _stateDoctypeName(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.name += M;
        break;
      }
      case o.EOF: {
      ...
      default:
        u.name += String.fromCodePoint(ve(t) ? ut(t) : t);
    }
  }
  ...
  _stateDoctypePublicIdentifierDoubleQuoted(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.publicId += M;
        break;
      }
      case o.GREATER_THAN_SIGN: {
  ...
  _stateDoctypeSystemIdentifierDoubleQuoted(t) {
    ...
    switch (t) {
      ...
      case o.NULL: {
        this._err(b.unexpectedNullCharacter), u.systemId += M;
        break;
      }
      case o.GREATER_THAN_SIGN: {
  ...
  _stateCharacterReference() {
    ...
    t === 0 ? (this.preprocessor.pos = this.entityStartPos, this._flushCodePointConsumedAsCharacterReference(o.AMPERSAND), this.state = !this._isCharacterReferenceInAttribute() && fu(this.preprocessor.peek(1)) ? c.AMBIGUOUS_AMPERSAND : this.returnState) : this.state = this.returnState;
  }
  // Ambiguos ampersand state
  //------------------------------------------------------------------
  _stateAmbiguousAmpersand(t) {
    fu(t) ? this._flushCodePointConsumedAsCharacterReference(t) : (t === o.SEMICOLON && this._err(b.unknownNamedCharacterReference), this.state = this.returnState, this._callState(t));
  }
}
const cr = /* @__PURE__ */ new Set([a.DD, a.DT, a.LI, a.OPTGROUP, a.OPTION, a.P, a.RB, a.RP, a.RT, a.RTC]), Eu = /* @__PURE__ */ new Set([
  ...cr,
  a.CAPTION,
  a.COLGROUP,
  a.TBODY,
  ...
  a.TEMPLATE,
  a.TH
]), Ba = /* @__PURE__ */ new Set([...dt, a.OL, a.UL]), Ma = /* @__PURE__ */ new Set([...dt, a.BUTTON]), mu = /* @__PURE__ */ new Set([a.ANNOTATION_XML, a.MI, a.MN, a.MO, a.MS, a.MTEXT]), Tu = /* @__PURE__ */ new Set([a.DESC, a.FOREIGN_OBJECT, a.TITLE]), xa = /* @__PURE__ */ new Set([a.TR, a.TEMPLATE, a.HTML]), ka = /* @__PURE__ */ new Set([a.TBODY, a.TFOOT, a.THEAD, a.TEMPLATE, a.HTML]), wa = /* @__PURE__ */ new Set([a.TABLE, a.TEMPLATE, a.HTML]), Fa = /* @__PURE__ */ new Set([a.TD, a.TH]);
class Ha {
  ...
  _isInTemplate() {
    return this.currentTagId === a.TEMPLATE && this.treeAdapter.getNamespaceURI(this.current) === _.HTML;
  }
  ...
  popUntilNumberedHeaderPopped() {
    this.popUntilPopped(Ut, _.HTML);
  }
  popUntilTableCellPopped() {
    this.popUntilPopped(Fa, _.HTML);
  }
  ...
  clearBackToTableContext() {
    this.clearBackTo(wa, _.HTML);
  }
  clearBackToTableBodyContext() {
    this.clearBackTo(ka, _.HTML);
  }
  clearBackToTableRowContext() {
    this.clearBackTo(xa, _.HTML);
  }
  remove(t) {
    const u = this._indexOf(t);
  ...
  hasInScope(t) {
    return this.hasInDynamicScope(t, dt);
  }
  hasInListItemScope(t) {
    return this.hasInDynamicScope(t, Ba);
  }
  hasInButtonScope(t) {
    return this.hasInDynamicScope(t, Ma);
  }
  ...
  generateImpliedEndTags() {
    for (; this.currentTagId !== void 0 && cr.has(this.currentTagId); )
      this.pop();
  }
  ...
  generateImpliedEndTagsWithExclusion(t) {
    for (; this.currentTagId !== void 0 && this.currentTagId !== t && Eu.has(this.currentTagId); )
      this.pop();
  }
}
const Lt = 3;
...
class Ua {
  ...
  _ensureNoahArkCondition(t) {
    ...
    for (let i = 0; i < r.length; i++) {
      const l = r[i];
      l.attrs.every((f) => n.get(f.name) === f.value) && (s += 1, s >= Lt && this.entries.splice(l.idx, 1));
    }
  }
  //Mutations
  insertMarker() {
    this.entries.unshift(bu);
  }
  pushElement(t, u) {
   ...
   */
  clearToLastMarker() {
    const t = this.entries.indexOf(bu);
...
const Te = {
...
}, lr = "html", va = "about:legacy-compat", Ya = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", dr = [
  ...
  "html"
]), fr = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], Ka = [
  ...fr,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function $a(e) {
  return e.name === lr && e.publicId === null && (e.systemId === null || e.systemId === va);
}
function za(e) {
  if (e.name !== lr)
    return j.QUIRKS;
  const { systemId: t } = e;
  if (t && t.toLowerCase() === Ya)
    return j.QUIRKS;
  let { publicId: u } = e;
  if (u !== null) {
    if (u = u.toLowerCase(), Ga.has(u))
      return j.QUIRKS;
    let r = t === null ? Wa : dr;
    if (pu(u, r))
      return j.QUIRKS;
    if (r = t === null ? fr : Ka, pu(u, r))
...
const _u = {
...
}, Qa = "definitionurl", qa = "definitionURL", Va = new Map([
  "attributeName",
  "attributeType",
  "baseFrequency",
  "baseProfile",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((e) => [e.toLowerCase(), e])), ja = /* @__PURE__ */ new Map([
  ...
  "radialGradient",
  "textPath"
].map((e) => [e.toLowerCase(), e])), Ja = /* @__PURE__ */ new Set([
  a.B,
  a.BIG,
  a.BLOCKQUOTE,
  a.BODY,
...
function Za(e) {
  const t = e.tagID;
  return t === a.FONT && e.attrs.some(({ name: r }) => r === ge.COLOR || r === ge.SIZE || r === ge.FACE) || Ja.has(t);
}
function hr(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === Qa) {
      e.attrs[t].name = qa;
      break;
    }
}
function Er(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    const u = Va.get(e.attrs[t].name);
    u != null && (e.attrs[t].name = u);
  }
}
function Zt(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    const u = ja.get(e.attrs[t].name);
    u && (e.attrs[t].prefix = u.prefix, e.attrs[t].name = u.name, e.attrs[t].namespace = u.namespace);
  }
}
function en(e) {
  const t = Xa.get(e.tagName);
  t != null && (e.tagName = t, e.tagID = gt(e.tagName));
}
function tn(e, t) {
  return t === _.MATHML && (e === a.MI || e === a.MO || e === a.MN || e === a.MS || e === a.MTEXT);
}
function un(e, t, u) {
  if (t === _.MATHML && e === a.ANNOTATION_XML) {
    for (let r = 0; r < u.length; r++)
      if (u[r].name === ge.ENCODING) {
        const n = u[r].value.toLowerCase();
        return n === _u.TEXT_HTML || n === _u.APPLICATION_XML;
      }
  }
  return t === _.SVG && (e === a.FOREIGN_OBJECT || e === a.DESC || e === a.TITLE);
}
function rn(e, t, u, r) {
  return (!r || r === _.HTML) && un(e, t, u) || (!r || r === _.MATHML) && tn(e, t);
}
const an = "hidden", nn = 8, sn = 3;
var d;
(function(e) {
...
const on = {
  ...
  endCol: -1,
  endOffset: -1
}, mr = /* @__PURE__ */ new Set([a.TABLE, a.TBODY, a.TFOOT, a.THEAD, a.TR]), Au = {
  scriptingEnabled: !0,
...
class cn {
  constructor(t, u, r = null, n = null) {
    this.fragmentContext = r, this.scriptHandler = n, this.currentToken = null, this.stopped = !1, this.insertionMode = d.INITIAL, this.originalInsertionMode = d.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...Au,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = u ?? this.treeAdapter.createDocument(), this.tokenizer = new Pa(this.options, this), this.activeFormattingElements = new Ua(this.treeAdapter), this.fragmentContextID = r ? gt(this.treeAdapter.getTagName(r)) : a.UNKNOWN, this._setContextModes(r ?? this.document, this.fragmentContextID), this.openElements = new Ha(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, u) {
    const r = new this(u);
  ...
  static getFragmentParser(t, u) {
    ...
    t ?? (t = r.treeAdapter.createElement(T.TEMPLATE, _.HTML, []));
    const n = r.treeAdapter.createElement("documentmock", _.HTML, []), s = new this(r, n, t);
  ...
  _err(t, u, r) {
    ...
    if (!this.onParseError)
      return;
    const s = (n = t.location) !== null && n !== void 0 ? n : on, i = {
      code: u,
  ...
  _setContextModes(t, u) {
    const r = t === this.document || t && this.treeAdapter.getNamespaceURI(t) === _.HTML;
  ...
  _insertFakeElement(t, u) {
    const r = this.treeAdapter.createElement(t, _.HTML, []);
    this._attachElementToTree(r, null), this.openElements.push(r, u);
  }
  /** @protected */
  _insertTemplate(t) {
    const u = this.treeAdapter.createElement(t.tagName, _.HTML, t.attrs), r = this.treeAdapter.createDocumentFragment();
  ...
  shouldProcessStartTagTokenInForeignContent(t) {
    if (!this.currentNotInHTML)
      return !1;
    let u, r;
    return this.openElements.stackTop === 0 && this.fragmentContext ? (u = this.fragmentContext, r = this.fragmentContextID) : { current: u, currentTagId: r } = this.openElements, t.tagID === a.SVG && this.treeAdapter.getTagName(u) === T.ANNOTATION_XML && this.treeAdapter.getNamespaceURI(u) === _.MATHML ? !1 : (
      // Check that `current` is not an integration point for HTML or MathML elements.
      this.tokenizer.inForeignNode || // If it _is_ an integration point, then we might have to check that it is not an HTML
      // integration point.
      (t.tagID === a.MGLYPH || t.tagID === a.MALIGNMARK) && r !== void 0 && !this._isIntegrationPoint(r, u, _.HTML)
    );
  }
  /** @protected */
  _processToken(t) {
   ...
   */
  _processStartTag(t) {
    this.shouldProcessStartTagTokenInForeignContent(t) ? vs(this, t) : this._startTagOutsideForeignContent(t);
  }
  /** @protected */
  ...
  /** @internal */
  onEndTag(t) {
    this.skipNextNewLine = !1, this.currentToken = t, this.currentNotInHTML ? Ys(this, t) : this._endTagOutsideForeignContent(t);
  }
  /** @protected */
...
function ln(e, t) {
  ...
  return u ? e.openElements.contains(u.element) ? e.openElements.hasInScope(t.tagID) || (u = null) : (e.activeFormattingElements.removeEntry(u), u = null) : Ar(e, t), u;
}
function dn(e, t) {
...
function fn(e, t, u) {
  ...
  for (let s = 0, i = n; i !== u; s++, i = n) {
    ...
    const l = e.activeFormattingElements.getElementEntry(i), f = l && s >= sn;
    !l || f ? (f && e.activeFormattingElements.removeEntry(l), e.openElements.remove(i)) : (i = hn(e, l), r === t && (e.activeFormattingElements.bookmark = l), e.treeAdapter.detachNode(r), e.treeAdapter.appendChild(i, r), r = i);
  }
  return r;
}
function hn(e, t) {
...
function En(e, t, u) {
  const r = e.treeAdapter.getTagName(t), n = gt(r);
  if (e._isElementCausesFosterParenting(n))
    e._fosterParentElement(u);
  else {
    const s = e.treeAdapter.getNamespaceURI(t);
    n === a.TEMPLATE && s === _.HTML && (t = e.treeAdapter.getTemplateContent(t)), e.treeAdapter.appendChild(t, u);
  }
}
function mn(e, t, u) {
...
function eu(e, t) {
  for (let u = 0; u < nn; u++) {
    ...
    const s = fn(e, n, r.element), i = e.openElements.getCommonAncestor(r.element);
    e.treeAdapter.detachNode(s), i && En(e, i, s), mn(e, n, r);
  }
}
function vt(e, t) {
...
function pn(e, t) {
  ...
  const u = t.forceQuirks ? j.QUIRKS : za(t);
  $a(t) || e._err(t, b.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, u), e.insertionMode = d.BEFORE_HTML;
}
function Fe(e, t) {
...
function _n(e, t) {
  t.tagID === a.HTML ? (e._insertElement(t, _.HTML), e.insertionMode = d.BEFORE_HEAD) : We(e, t);
}
function An(e, t) {
  const u = t.tagID;
...
function $e(e, t) {
  const u = t.type === D.EOF ? b.openElementsLeftAfterEof : b.disallowedContentInNoscriptInHead;
...
function ze(e, t) {
  e._insertFakeElement(T.BODY, a.BODY), e.insertionMode = d.IN_BODY, Nt(e, t);
}
function Nt(e, t) {
  switch (t.type) {
    case D.CHARACTER: {
...
function Pn(e, t) {
  e.openElements.hasInButtonScope(a.P) && e._closePElement(), e._insertElement(t, _.HTML);
}
function Bn(e, t) {
  e.openElements.hasInButtonScope(a.P) && e._closePElement(), e.openElements.currentTagId !== void 0 && Ut.has(e.openElements.currentTagId) && e.openElements.pop(), e._insertElement(t, _.HTML);
}
function Mn(e, t) {
  e.openElements.hasInButtonScope(a.P) && e._closePElement(), e._insertElement(t, _.HTML), e.skipNextNewLine = !0, e.framesetOk = !1;
}
function xn(e, t) {
  const u = e.openElements.tmplCount > 0;
  (!e.formElement || u) && (e.openElements.hasInButtonScope(a.P) && e._closePElement(), e._insertElement(t, _.HTML), u || (e.formElement = e.openElements.current));
}
function kn(e, t) {
  e.framesetOk = !1;
  const u = t.tagID;
...
function wn(e, t) {
  e.openElements.hasInButtonScope(a.P) && e._closePElement(), e._insertElement(t, _.HTML), e.tokenizer.state = q.PLAINTEXT;
}
function Fn(e, t) {
  e.openElements.hasInScope(a.BUTTON) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(a.BUTTON)), e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML), e.framesetOk = !1;
}
function Hn(e, t) {
  const u = e.activeFormattingElements.getElementEntryInScopeWithTagName(T.A);
  u && (eu(e, t), e.openElements.remove(u.element), e.activeFormattingElements.removeEntry(u)), e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
}
function Un(e, t) {
...
function vn(e, t) {
  e._reconstructActiveFormattingElements(), e.openElements.hasInScope(a.NOBR) && (eu(e, t), e._reconstructActiveFormattingElements()), e._insertElement(t, _.HTML), e.activeFormattingElements.pushElement(e.openElements.current, t);
}
function Yn(e, t) {
  e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML), e.activeFormattingElements.insertMarker(), e.framesetOk = !1;
}
function Wn(e, t) {
  e.treeAdapter.getDocumentMode(e.document) !== j.QUIRKS && e.openElements.hasInButtonScope(a.P) && e._closePElement(), e._insertElement(t, _.HTML), e.framesetOk = !1, e.insertionMode = d.IN_TABLE;
}
function pr(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, _.HTML), e.framesetOk = !1, t.ackSelfClosing = !0;
}
function _r(e) {
  const t = ir(e, ge.TYPE);
  return t != null && t.toLowerCase() === an;
}
function Gn(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, _.HTML), _r(t) || (e.framesetOk = !1), t.ackSelfClosing = !0;
}
function Kn(e, t) {
  e._appendElement(t, _.HTML), t.ackSelfClosing = !0;
}
function $n(e, t) {
  e.openElements.hasInButtonScope(a.P) && e._closePElement(), e._appendElement(t, _.HTML), e.framesetOk = !1, t.ackSelfClosing = !0;
}
function zn(e, t) {
  t.tagName = T.IMG, t.tagID = a.IMG, pr(e, t);
}
function Qn(e, t) {
...
function Xn(e, t) {
  e.openElements.currentTagId === a.OPTION && e.openElements.pop(), e._reconstructActiveFormattingElements(), e._insertElement(t, _.HTML);
}
function Jn(e, t) {
  e.openElements.hasInScope(a.RUBY) && e.openElements.generateImpliedEndTags(), e._insertElement(t, _.HTML);
}
function Zn(e, t) {
  e.openElements.hasInScope(a.RUBY) && e.openElements.generateImpliedEndTagsWithExclusion(a.RTC), e._insertElement(t, _.HTML);
}
function es(e, t) {
  e._reconstructActiveFormattingElements(), hr(t), Zt(t), t.selfClosing ? e._appendElement(t, _.MATHML) : e._insertElement(t, _.MATHML), t.ackSelfClosing = !0;
}
function ts(e, t) {
  e._reconstructActiveFormattingElements(), Er(t), Zt(t), t.selfClosing ? e._appendElement(t, _.SVG) : e._insertElement(t, _.SVG), t.ackSelfClosing = !0;
}
function Nu(e, t) {
...
function $(e, t) {
  switch (t.tagID) {
    ...
    case a.NOSCRIPT: {
      e.options.scriptingEnabled ? gu(e, t) : Nu(e, t);
      break;
    }
    case a.PLAINTEXT: {
      wn(e, t);
...
function rs(e, t) {
  e.openElements.hasInScope(a.BODY) && (e.insertionMode = d.AFTER_BODY, Lr(e, t));
}
function as(e, t) {
  const u = t.tagID;
...
function gr(e, t) {
  e.tmplInsertionModeStack.length > 0 ? Dr(e, t) : tu(e, t);
}
function fs(e, t) {
  var u;
...
function Rt(e, t) {
  if (e.openElements.currentTagId !== void 0 && mr.has(e.openElements.currentTagId))
...
function Ts(e, t) {
  e.openElements.clearBackToTableContext(), e._insertFakeElement(T.COLGROUP, a.COLGROUP), e.insertionMode = d.IN_COLUMN_GROUP, uu(e, t);
}
function bs(e, t) {
  e.openElements.clearBackToTableContext(), e._insertElement(t, _.HTML), e.insertionMode = d.IN_TABLE_BODY;
}
function ps(e, t) {
  e.openElements.clearBackToTableContext(), e._insertFakeElement(T.TBODY, a.TBODY), e.insertionMode = d.IN_TABLE_BODY, Ct(e, t);
}
function _s(e, t) {
...
function As(e, t) {
  _r(t) ? e._appendElement(t, _.HTML) : Je(e, t), t.ackSelfClosing = !0;
}
function gs(e, t) {
...
function Je(e, t) {
  ...
  e.fosterParentingEnabled = !0, Nt(e, t), e.fosterParentingEnabled = u;
}
function Nr(e, t) {
...
const Cr = /* @__PURE__ */ new Set([a.CAPTION, a.COL, a.COLGROUP, a.TBODY, a.TD, a.TFOOT, a.TH, a.THEAD, a.TR]);
function Ns(e, t) {
  const u = t.tagID;
  Cr.has(u) ? e.openElements.hasInTableScope(a.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(a.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, xe(e, t)) : $(e, t);
}
function Is(e, t) {
  const u = t.tagID;
  switch (u) {
    case a.CAPTION:
    case a.TABLE: {
      e.openElements.hasInTableScope(a.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(a.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, u === a.TABLE && Ve(e, t));
      break;
    }
    case a.BODY:
    case a.COL:
...
function Ct(e, t) {
  switch (t.tagID) {
    ...
    case a.TH:
    case a.TD: {
      e.openElements.clearBackToTableBodyContext(), e._insertFakeElement(T.TR, a.TR), e.insertionMode = d.IN_ROW, St(e, t);
      break;
    }
    case a.CAPTION:
    case a.COL:
...
function Yt(e, t) {
  ...
  switch (t.tagID) {
    ...
    case a.TABLE: {
      e.openElements.hasTableBodyContextInTableScope() && (e.openElements.clearBackToTableBodyContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE, Ve(e, t));
      break;
    }
    case a.BODY:
    case a.CAPTION:
...
function St(e, t) {
  switch (t.tagID) {
    ...
    case a.THEAD:
    case a.TR: {
      e.openElements.hasInTableScope(a.TR) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE_BODY, Ct(e, t));
      break;
    }
    default:
      xe(e, t);
...
function Sr(e, t) {
  switch (t.tagID) {
    ...
    case a.TFOOT:
    case a.THEAD: {
      (e.openElements.hasInTableScope(t.tagID) || e.openElements.hasInTableScope(a.TR)) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = d.IN_TABLE_BODY, Yt(e, t));
      break;
    }
    case a.BODY:
    case a.CAPTION:
...
function Ss(e, t) {
  const u = t.tagID;
  Cr.has(u) ? (e.openElements.hasInTableScope(a.TD) || e.openElements.hasInTableScope(a.TH)) && (e._closeTableCell(), St(e, t)) : $(e, t);
}
function Os(e, t) {
  const u = t.tagID;
  switch (u) {
    ...
    case a.THEAD:
    case a.TR: {
      e.openElements.hasInTableScope(u) && (e._closeTableCell(), Sr(e, t));
      break;
    }
    case a.BODY:
    case a.CAPTION:
...
function Or(e, t) {
  switch (t.tagID) {
    ...
    case a.OPTION: {
      e.openElements.currentTagId === a.OPTION && e.openElements.pop(), e._insertElement(t, _.HTML);
      break;
    }
    case a.OPTGROUP: {
      e.openElements.currentTagId === a.OPTION && e.openElements.pop(), e.openElements.currentTagId === a.OPTGROUP && e.openElements.pop(), e._insertElement(t, _.HTML);
      break;
    }
    case a.HR: {
      e.openElements.currentTagId === a.OPTION && e.openElements.pop(), e.openElements.currentTagId === a.OPTGROUP && e.openElements.pop(), e._appendElement(t, _.HTML), t.ackSelfClosing = !0;
      break;
    }
    case a.INPUT:
    case a.KEYGEN:
...
function ys(e, t) {
  const u = t.tagID;
  u === a.CAPTION || u === a.TABLE || u === a.TBODY || u === a.TFOOT || u === a.THEAD || u === a.TR || u === a.TD || u === a.TH ? (e.openElements.popUntilTagNamePopped(a.SELECT), e._resetInsertionMode(), e._processStartTag(t)) : Or(e, t);
}
function Ds(e, t) {
  const u = t.tagID;
  u === a.CAPTION || u === a.TABLE || u === a.TBODY || u === a.TFOOT || u === a.THEAD || u === a.TR || u === a.TD || u === a.TH ? e.openElements.hasInTableScope(u) && (e.openElements.popUntilTagNamePopped(a.SELECT), e._resetInsertionMode(), e.onEndTag(t)) : yr(e, t);
}
function Ls(e, t) {
  switch (t.tagID) {
    ...
    case a.TFOOT:
    case a.THEAD: {
      e.tmplInsertionModeStack[0] = d.IN_TABLE, e.insertionMode = d.IN_TABLE, xe(e, t);
      break;
    }
    case a.COL: {
      e.tmplInsertionModeStack[0] = d.IN_COLUMN_GROUP, e.insertionMode = d.IN_COLUMN_GROUP, uu(e, t);
      break;
    }
    case a.TR: {
      e.tmplInsertionModeStack[0] = d.IN_TABLE_BODY, e.insertionMode = d.IN_TABLE_BODY, Ct(e, t);
      break;
    }
    case a.TD:
    case a.TH: {
      e.tmplInsertionModeStack[0] = d.IN_ROW, e.insertionMode = d.IN_ROW, St(e, t);
      break;
    }
    default:
      e.tmplInsertionModeStack[0] = d.IN_BODY, e.insertionMode = d.IN_BODY, $(e, t);
  }
}
function Rs(e, t) {
...
function ht(e, t) {
  e.insertionMode = d.IN_BODY, Nt(e, t);
}
function Bs(e, t) {
  switch (t.tagID) {
    case a.HTML: {
...
function vs(e, t) {
  if (Za(t))
    Rr(e), e._startTagOutsideForeignContent(t);
  else {
    const u = e._getAdjustedCurrentElement(), r = e.treeAdapter.getNamespaceURI(u);
    r === _.MATHML ? hr(t) : r === _.SVG && (en(t), Er(t)), Zt(t), t.selfClosing ? e._appendElement(t, r) : e._insertElement(t, r), t.ackSelfClosing = !0;
  }
}
function Ys(e, t) {
  if (t.tagID === a.P || t.tagID === a.BR) {
    Rr(e), e._endTagOutsideForeignContent(t);
    return;
  }
  for (let u = e.openElements.stackTop; u > 0; u--) {
    const r = e.openElements.items[u];
    if (e.treeAdapter.getNamespaceURI(r) === _.HTML) {
...
function Ws(e, t, u) {
  ...
  const r = cn.getFragmentParser(e, u);
  return r.tokenizer.write(t, !0), r.getFragment();
}
const Gs = () => ({}), _e = () => !0, Ee = (e) => {
  const t = parseInt(e, 10);
  return Number.isFinite(t) ? t : e;
}, Ks = (e) => typeof e != "string" ? e : e.split(",").map((t) => t.trim()).filter(Boolean).map((t) => parseInt(t, 10)).filter((t) => Number.isFinite(t)), $s = {
  "data-underline": { path: ["underline"], transform: Gs },
  ...
  "data-smallcaps": { path: ["smallCaps"], transform: _e },
  "data-allcaps": { path: ["allCaps"], transform: _e },
  "data-strike": { path: ["strike"], transform: _e },
  "data-subscript": { path: ["subScript"], transform: _e },
  "data-superscript": { path: ["superScript"], transform: _e },
  ...
  "data-row-header": { path: ["tableHeader"], transform: _e },
  // ------------------------------------------------------------------
  ...
  "data-page-break-before": { path: ["pageBreakBefore"], transform: _e },
...
function js(e) {
  ...
  const r = Iu(e, "data-type") || t;
  if (r === "emptyLine") return null;
  if (r === "contentWrapper")
    return Wt(e);
  const n = Qs(e.attrs || []), s = Wt(e);
  if (r === "a" && n.href === void 0) {
    const l = Iu(e, "href");
    l && (n.href = l);
  }
  const i = { type: r, ...n };
...
const Xs = {
  docx: { load: () => import("./docx-JFZzSufc.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-ByoeiX6E.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-BEDK6vtY.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-C-GPi414.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-Cai0FmUY.js"), consumes: "html", ir: !1 }
};
function ru(e) {
  const t = Xs[e];
  return t ? {
...
function Zs(e, t) {
  ...
  return u.ir ? ei(r, e) : u.consumes === "html" ? ti(r, e) : ui(r);
}
function ei(e, t) {
...
function ai(e, t, u = {}) {
  const { basePath: r, theme: n } = u, s = ur();
  return Jt(
    kt(
      rr,
...
function ni(e, t) {
  ...
  if (!u) return;
  const r = u.consumes;
  if (!(Cu.has(r) || (e.getOutputs && e.getOutputs(r) || []).length > 0) && (Cu.add(r), typeof console < "u" && console.warn)) {
...
async function Su(e, t, u = {}) {
  const { basePath: r, theme: n, adapterOptions: s = {} } = u, i = ai(e, t, { basePath: r, theme: n });
  return Js(t, i, s);
}
async function si(e, t = {}) {
  ...
  const L = N.via ?? n, P = N.getOptions ? await N.getOptions(r, { format: n, rootPath: i, loadAsset: p, ...h }) : {}, k = {
    ...
    ...P.adapterOptions,
    ...l
  }, B = ci(r, i), C = globalThis.uniweb?.childBlockRenderer;
...
function Br(e) {
  const t = er()?.activeWebsite ?? null, u = e && t ? ca(e) : null, r = u ? t.dataStore.get(u) : null, [n, s] = ot(
    () => r ? rt(r.data) : u ? yu() : Ou()
  );
  return At(() => {
    if (!u || !t) {
    ...
    return t.fetcher.dispatch(e, { website: t, signal: f.signal }).then((m) => {
      if (!f.signal.aborted) {
        if (m?.error) {
          s(Du(m.error, m.data ?? null));
          return;
        }
        m && "data" in m && s(rt(m.data));
      }
    }).catch((m) => {
      f.signal.aborted || s(Du(String(m?.message || m)));
    }), () => {
      f.abort(), l();
    };
  }, [u, t]), n;
...
function Ot(e, t) {
  const { website: u } = au(), [, r] = aa(di, 0), s = u.activePage?.state;
  At(() => {
    if (s)
...
function nu(e) {
  return Lu(e?.qty) * Lu(e?.unit_price);
}
function Mr(e) {
  return Array.isArray(e) ? Math.round(e.reduce((t, u) => t + nu(u), 0) * 100) / 100 : 0;
}
function Ei(e, t = {}, u = {}) {
  const r = Mr(e?.items), n = e?.tax?.jurisdiction || t.tax_jurisdiction || null;
  if (!n)
    return { jurisdiction: null, rate: 0, amount: 0, label: "" };
  const s = hi(n, u), i = e?.tax?.rate != null ? Number(e.tax.rate) : s.rate, l = e?.tax?.amount != null ? Number(e.tax.amount) : Math.round(r * i * 100) / 100;
  return { jurisdiction: n, rate: i, amount: l, label: s.label };
}
function yt(e, t = {}, u = {}) {
  const r = Mr(e?.items), n = Ei(e, t, u), s = Math.round((r + n.amount) * 100) / 100;
  return {
    subtotal: r,
    tax_amount: n.amount,
    tax_rate: n.rate,
...
const xr = "business-docs/report-options", fe = {
  source: "invoices",
...
function mi() {
  ...
  try {
    ...
    const t = JSON.parse(e);
    return {
      source: t.source || fe.source,
      dateRange: t.dateRange && typeof t.dateRange == "object" ? { from: t.dateRange.from || null, to: t.dateRange.to || null } : fe.dateRange,
...
function Ti(e) {
  ...
  const t = {};
  for (const u of Gt)
    t[u] = e.state.get(u) ?? fe[u];
  try {
    window.localStorage.setItem(xr, JSON.stringify(t));
  } catch {
  }
}
...
function bi(e) {
  ...
  const u = () => Ti(e), r = Gt.map((n) => e.state.subscribe(n, u));
  return () => r.forEach((n) => n());
}
function kr() {
  return Ot("source", fe.source);
}
function pi() {
  return Ot("dateRange", fe.dateRange);
}
function _i() {
  return Ot("client", fe.client);
}
function Ai() {
  return Ot("status", fe.status);
}
function gi({ dateRange: e, client: t, status: u }) {
  const r = [];
...
const Ni = /* @__PURE__ */ new Set(["paid", "void"]);
function Ii({ source: e, dateRange: t, client: u, status: r }) {
...
function yi(e, t, u, r) {
  ...
  if (t === "invoices")
    for (const l of e) {
      const f = yt(l, u, r);
      n += f.subtotal, s += f.total, Ni.has(String(l?.status)) || (i += f.total);
    }
  else
    for (const l of e) {
...
function Di(e, t) {
  const [u] = kr(), [r] = pi(), [n] = _i(), [s] = Ai(), i = t?.website?.config?.business_docs || {}, l = i.defaults || {}, f = i.registries?.tax || {}, m = Ae(
    () => gi({ dateRange: r, client: n, status: s }),
    [r, n, s]
  ), h = Ae(
    () => Oi(u, e),
    [u, e?.data?.invoices, e?.data?.sows]
  ), { data: p, loading: g } = Br(
    m ? { path: Ci(u), schema: Si(u), where: m } : null
  ), N = m ? p || [] : h, { sumSubtotals: L, sumTotals: P, sumOutstanding: k } = Ae(
    () => yi(N, u, l, f),
    [N, u, l, f]
  );
  return {
    ...
    sumOutstanding: k,
    activeWhere: m,
    activeLabel: Ii({ source: u, dateRange: r, client: n, status: s }),
    totalCount: h.length,
    loading: m ? g : !1
  };
}
function Li(e, { currency: t = "CAD", locale: u = "en-CA" } = {}) {
  const r = Number(e);
...
function Pu(e, t) {
  if (!e) return "";
  const u = Kt(e.from, t), r = Kt(e.to, t);
  return u && r ? `${u} – ${r}` : u || r;
}
function W0({ content: e, block: t }) {
  const u = t?.website?.config?.business_docs || {}, r = u.defaults || {}, n = u.registries?.tax || {}, s = r.currency || "CAD", i = r.locale || "en-CA", l = (I) => Li(I, { currency: s, locale: i }), f = (I) => Kt(I, { locale: i }), [m] = kr(), h = m !== "sows", {
    records: p,
    count: g,
    sumSubtotals: N,
    sumTotals: L,
  ...
  const et = e?.title || (h ? "Invoice report" : "SOW report"), tt = k || e?.subtitle || (h ? "All invoices" : "All SOWs");
  return /* @__PURE__ */ S("section", { className: "engagement-report", children: [
    /* @__PURE__ */ S("header", { children: [
      /* @__PURE__ */ E("h1", { children: et }),
      /* @__PURE__ */ E("p", { className: "engagement-report-subtitle", children: tt }),
      /* @__PURE__ */ S("p", { className: "engagement-report-population", children: [
        g,
        " of ",
        B,
        " ",
    ...
    /* @__PURE__ */ S("div", { className: "engagement-report-cards", role: "list", children: [
      /* @__PURE__ */ E(at, { label: "Records", value: g }),
      /* @__PURE__ */ E(at, { label: "Subtotal", value: l(N) }),
      /* @__PURE__ */ E(at, { label: "Total", value: l(L) }),
      h && /* @__PURE__ */ E(at, { label: "Outstanding", value: l(P) })
    ] }),
    C && /* @__PURE__ */ E("p", { className: "engagement-report-loading", children: "Loading…" }),
    /* @__PURE__ */ S("table", { className: "engagement-report-table", children: [
      /* @__PURE__ */ E("thead", { children: /* @__PURE__ */ E("tr", { children: h ? /* @__PURE__ */ S(Ie, { children: [
      ...
      /* @__PURE__ */ E("tbody", { children: z.map(
        ...
        ] }, I.slug || I.number) : /* @__PURE__ */ S("tr", { children: [
          /* @__PURE__ */ E("td", { children: I.number }),
          /* @__PURE__ */ E("td", { children: f(I.issued) }),
          /* @__PURE__ */ E("td", { children: I.client?.organization || "" }),
...
function at({ label: e, value: t }) {
  return /* @__PURE__ */ S("div", { role: "listitem", className: "engagement-report-card", children: [
...
function Pi(e, t, u, r) {
  const n = yt(e, u, r), s = e?.sow_ref ? t.get(String(e.sow_ref)) : null, i = Number(s?.budget?.total) || 0, l = i > 0 ? n.total / i * 100 : null;
...
function $t(e, { locale: t = "en-CA", format: u = "medium" } = {}) {
  const r = Mi(e);
  if (!r) return "";
  if (u === "iso") return Mu(r);
  const n = Bu[u] || Bu.medium;
  try {
...
function xi(e, t, u) {
  const r = $t(e, u), n = $t(t, u);
  return r && n ? `${r} – ${n}` : r || n || "";
}
function ki(e, { locale: t = "en-CA", code: u = "CAD" } = {}) {
  if (e == null || e === "") return "";
...
function wr({
  ...
  const s = Xe(), i = u?.from ?? e, l = u?.to ?? t, f = xi(i, l, {
    locale: n ?? s.locale,
    format: r
  });
...
function Fr(e) {
  const t = (r, n) => ({
    ...
    let i = [], l = 0;
    if (!r) return [t("", n)];
    r.replace(s, (m, h, p, g, N) => {
      const L = r.slice(l, N);
      if (L && i.push(t(L, n)), h === "a" && p) {
        const k = Ue(p, "href");
        if (k) {
          const B = u(g, n).filter(
            (C) => C.type === "text"
          );
          i.push({
            type: "link",
            content: B.map((C) => C.content).join(""),
            href: k,
            parts: B
          }), l = N + m.length;
          return;
      ...
      if (h === "span" && p && Ue(p, "data-type") === "math") {
        const B = Ue(p, "data-latex") || "", C = Ue(p, "data-display") === "true", R = Ue(p, "data-id");
        i.push({
          type: "math",
          latex: B,
          display: C,
      ...
      const P = { ...n };
      (h === "strong" || h === "b") && (P.bold = !0), (h === "em" || h === "i") && (P.italics = !0), h === "u" && (P.underline = {}), h === "sub" && (P.subscript = !0), h === "sup" && (P.superscript = !0), i = i.concat(u(g, P)), l = N + m.length;
    });
    const f = r.slice(l);
...
function Fi(e) {
  return e == null ? e : Array.isArray(e) ? e.map(ku) : ku(e);
}
function y({
  children: e,
  bold: t,
  ...
  const P = Xe(), k = qe(n, P), B = la(i, P), C = g ?? N, R = { "data-type": "text" };
  return t && (R["data-bold"] = "true"), u && (R["data-italics"] = "true"), r && (R["data-underline"] = "true"), k && (R["data-color"] = k), s != null && (R["data-size"] = s), B && (R["data-font"] = B), l && (R["data-smallcaps"] = "true"), f && (R["data-allcaps"] = "true"), m && (R["data-strike"] = "true"), h && (R["data-subscript"] = "true"), p && (R["data-superscript"] = "true"), C && (R["data-style"] = C), /* @__PURE__ */ E("span", { ...R, ...L, children: Fi(e) });
}
function Hi(e) {
...
function Hr({ part: e }) {
  const t = e.href || "", { anchor: u } = Hi(t);
  return /* @__PURE__ */ E("a", { ...u !== null ? { "data-type": "internalHyperlink", "data-anchor": u } : { "data-type": "externalHyperlink", "data-link": t }, href: t, children: Ui(e).map((n, s) => /* @__PURE__ */ E(
    y,
    {
      style: "Hyperlink",
      bold: n.bold,
...
function O({
  ...
  const l = Yi({ tabStops: u, indent: r, role: n });
  if (t) {
    const f = Fr(t);
    return /* @__PURE__ */ E(e, { "data-type": "paragraph", ...l, ...i, children: f.map((m, h) => m.type === "link" ? /* @__PURE__ */ E(Hr, { part: m }, h) : m.type === "math" ? /* @__PURE__ */ E(
      vi,
      {
        latex: m.latex,
        display: m.display,
...
function Ur({ level: e, data: t, children: u, ...r }) {
  const n = `h${e}`;
  if (t) {
    const s = Fr(t);
    return /* @__PURE__ */ E(n, { "data-type": "paragraph", "data-heading": `HEADING_${e}`, ...r, children: s.map(
      (i, l) => i.type === "link" ? /* @__PURE__ */ E(Hr, { part: i }, l) : /* @__PURE__ */ E(
        y,
        {
          bold: i.bold,
          italics: i.italics,
...
function Wi(e) {
  return /* @__PURE__ */ E(Ur, { level: 1, ...e });
}
function Gi(e) {
  return /* @__PURE__ */ E(Ur, { level: 2, ...e });
}
function Ki(e, t) {
...
function Vi(e, t) {
  ...
  for (const [r, n] of Object.entries(e))
    n && (u[r] = {
      ...n,
      ...n.color ? { color: qe(n.color, t) } : {}
    });
  return u;
}
const vr = pt({ widths: null, borderColor: "cccccc" });
function Et({
  widths: e,
  columnWidths: t,
  layout: u,
  ...
  if (p)
    for (const [N, L] of Object.entries(p)) {
      if (!L) continue;
      const P = N === "insideHorizontal" ? "insideh" : N === "insideVertical" ? "insidev" : N;
      L.style && (h[`data-table-borders-${P}-style`] = L.style), L.size != null && (h[`data-table-borders-${P}-size`] = L.size), L.color && (h[`data-table-borders-${P}-color`] = L.color);
    }
  const g = qe(s, m) ?? s;
  return /* @__PURE__ */ E(
    vr.Provider,
...
function Ne({ header: e = !1, className: t, children: u, ...r }) {
  let n = 0;
  const s = na.toArray(u).map((l) => {
    if (!sa(l)) return l;
...
const nt = { top: 80, bottom: 80, left: 120, right: 120 };
function G({
  _col: e = 0,
  _header: t = !1,
  width: u,
  ...
  const { widths: N, borderColor: L, theme: P } = _t(vr), k = u ?? N?.[e], B = {
    "data-type": "tableCell",
    "data-margins-top": nt.top,
    "data-margins-bottom": nt.bottom,
    "data-margins-left": nt.left,
    "data-margins-right": nt.right,
  ...
  if (k != null && (B["data-width-size"] = k, B["data-width-type"] = "pct"), s) {
    const z = typeof s == "string" ? { fill: s } : s, et = qe(z.fill, P), tt = qe(z.color, P);
    et && (B["data-shading-fill"] = et), z.type && (B["data-shading-type"] = z.type), tt && (B["data-shading-color"] = tt);
  }
  i && (B["data-valign"] = i), typeof l == "number" && l > 1 && (B["data-grid-span"] = l), typeof f == "number" && f > 1 && (B["data-row-span"] = f);
  const C = k != null ? { flex: `${k} ${k} 0%`, minWidth: 0, ...h } : h;
  return /* @__PURE__ */ E("div", { className: m, style: C, ...B, ...g, children: typeof p == "string" || typeof p == "number" ? /* @__PURE__ */ E(O, { children: r || t ? /* @__PURE__ */ E(y, { bold: !0, children: p }) : p }) : p });
}
function ji({ children: e }) {
  return /* @__PURE__ */ E(Ie, { children: e });
}
function Xi(e) {
...
function to({ bd: e }) {
  ...
  return /* @__PURE__ */ S(Ie, { children: [
    /* @__PURE__ */ E(O, { role: "Title", children: /* @__PURE__ */ E(y, { children: "INVOICE" }) }),
    /* @__PURE__ */ E(Et, { widths: [50, 50], borders: zt(), children: /* @__PURE__ */ S(Ne, { children: [
      /* @__PURE__ */ S(G, { borderBottom: "none", children: [
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Label", children: "From" }) }),
        u?.organization && /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "BodyStrong", children: u.organization }) }),
        u?.address && /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: u.address }) })
      ] }),
      /* @__PURE__ */ S(G, { borderBottom: "none", children: [
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Label", children: "Bill to" }) }),
        r.organization && /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "BodyStrong", children: r.organization }) }),
        r.contact && /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: r.contact }) }),
        r.email && /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Caption", children: r.email }) })
      ] })
    ] }) }),
    /* @__PURE__ */ E(O, { "data-spacing-before": 200 }),
    /* @__PURE__ */ E(Et, { widths: [33, 33, 34], borders: zt(), children: /* @__PURE__ */ S(Ne, { children: [
      t?.number && /* @__PURE__ */ S(G, { borderBottom: "none", children: [
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Label", children: "Invoice number" }) }),
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Display", children: t.number }) })
      ] }),
      t?.issued && /* @__PURE__ */ S(G, { borderBottom: "none", children: [
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Label", children: "Issued" }) }),
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(xu, { value: t.issued, format: "long" }) }) })
      ] }),
      t?.due && /* @__PURE__ */ S(G, { borderBottom: "none", children: [
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Label", children: "Due" }) }),
        /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(xu, { value: t.due, format: "long" }) }) })
      ] })
    ] }) }),
    t?.period && /* @__PURE__ */ S(Ie, { children: [
      /* @__PURE__ */ E(O, { "data-spacing-before": 120, children: /* @__PURE__ */ E(y, { role: "Label", children: "Period" }) }),
      /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(wr, { period: t.period, format: "long" }) }) })
    ] })
  ] });
}
function uo({ bd: e }) {
  ...
  return /* @__PURE__ */ S(
    Et,
    {
      ...
      borders: eo(),
      children: [
        /* @__PURE__ */ E(Ne, { header: !0, children: ["Description", "Qty", "Unit price", "Amount"].map((n, s) => /* @__PURE__ */ E(G, { shading: "accent", valign: "center", children: /* @__PURE__ */ E(O, { "data-alignment": s === 0 ? "left" : "right", children: /* @__PURE__ */ E(y, { role: "TableHeader", children: n }) }) }, s)) }),
        t.map((n, s) => /* @__PURE__ */ S(Ne, { children: [
          /* @__PURE__ */ S(G, { valign: "center", children: [
            /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { children: n.description }) }),
            n.period && /* @__PURE__ */ E(O, { children: /* @__PURE__ */ E(y, { role: "Caption", children: /* @__PURE__ */ E(wr, { period: n.period, format: "medium" }) }) })
          ] }),
          /* @__PURE__ */ E(G, { valign: "center", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { children: String(n.qty ?? "") }) }) }),
          /* @__PURE__ */ E(G, { valign: "center", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(Qe, { value: n.unit_price, code: r }) }) }) }),
          /* @__PURE__ */ E(G, { valign: "center", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { children: /* @__PURE__ */ E(Qe, { value: n.amount, code: r }) }) }) })
        ] }, s))
      ]
    }
  );
    ...
    Et,
    {
      ...
      children: [
        /* @__PURE__ */ S(Ne, { children: [
          /* @__PURE__ */ E(G, { colSpan: 3, borderBottom: "none", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { role: "Label", children: "Subtotal" }) }) }),
          /* @__PURE__ */ E(G, { borderBottom: "none", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { role: "BodyStrong", children: /* @__PURE__ */ E(Qe, { value: t.subtotal, code: r }) }) }) })
        ] }),
        t.tax_amount > 0 && /* @__PURE__ */ S(Ne, { children: [
          /* @__PURE__ */ E(G, { colSpan: 3, borderBottom: "none", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { role: "Label", children: t.tax_label }) }) }),
          /* @__PURE__ */ E(G, { borderBottom: "none", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { role: "BodyStrong", children: /* @__PURE__ */ E(Qe, { value: t.tax_amount, code: r }) }) }) })
        ] }),
        /* @__PURE__ */ S(Ne, { children: [
          /* @__PURE__ */ E(G, { colSpan: 3, shading: "accent", borderBottom: "none", valign: "center", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { role: "TotalLine", children: "Total" }) }) }),
          /* @__PURE__ */ E(G, { shading: "accent", borderBottom: "none", valign: "center", children: /* @__PURE__ */ E(O, { "data-alignment": "right", children: /* @__PURE__ */ E(y, { role: "TotalLine", children: /* @__PURE__ */ E(Qe, { value: t.total, code: r }) }) }) })
        ] })
      ]
    }
  );
}
function ao({ content: e, block: t }) {
  const { title: u, items: r, sequence: n } = e, s = (() => {
  ...
  })(), i = Zi(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ S(Ie, { children: [
    u && /* @__PURE__ */ E(O, { role: "Heading1", "data-spacing-after": 240, children: /* @__PURE__ */ E(y, { children: u }) }),
    l.map((h, p) => /* @__PURE__ */ E(O, { data: h, "data-spacing-after": 120 }, `p${p}`)),
    r.map((h, p) => /* @__PURE__ */ S(lt, { children: [
      h.title && /* @__PURE__ */ E(
        O,
        {
          role: "Heading2",
          ...
          children: /* @__PURE__ */ E(y, { children: h.title })
        }
      ),
      h.paragraphs.map((g, N) => /* @__PURE__ */ E(O, { data: g, "data-spacing-after": 100 }, `${p}-${N}`))
    ] }, p))
  ] }), m = /* @__PURE__ */ S("section", { className: "invoice-section", children: [
    ...
    r.length > 0 && /* @__PURE__ */ E("div", { className: "invoice-items", children: r.map((h, p) => /* @__PURE__ */ S(lt, { children: [
...
function G0({ content: e, block: t }) {
  ...
  let n = null;
  if (u && (r === "cover" ? n = /* @__PURE__ */ E(to, { bd: u }) : r === "line-items" ? n = /* @__PURE__ */ E(uo, { bd: u }) : r === "totals" && (n = /* @__PURE__ */ E(ro, { bd: u }))), r === "cover" && u?.vendor?.logo) {
    const l = /* @__PURE__ */ E(ji, { children: /* @__PURE__ */ E(qi, { url: u.vendor.logo, width: oe(4), align: "right" }) });
    se(t, "docx", l, { role: "header" });
  }
  if (n)
    return se(t, "docx", n), se(t, "html", n), /* @__PURE__ */ E("section", { className: `invoice-section invoice-${r}`, children: n });
  const { docxBody: s, previewJsx: i } = ao({ content: e, block: t });
...
function K0({ content: e, block: t }) {
  const { title: u, items: r, sequence: n } = e, s = Pr(), i = no(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ S(Ie, { children: [
    u && /* @__PURE__ */ E(Wi, { data: u, "data-spacing-after": 240 }),
    l.map((h, p) => /* @__PURE__ */ E(O, { data: h, "data-spacing-after": 120 }, `p${p}`)),
    r.map((h, p) => /* @__PURE__ */ S(lt, { children: [
      h.title && /* @__PURE__ */ E(Gi, { data: h.title, "data-spacing-before": 200, "data-spacing-after": 120 }),
      h.paragraphs.map((g, N) => /* @__PURE__ */ E(O, { data: g, "data-spacing-after": 100 }, `${p}-${N}`))
    ] }, p))
  ] }), m = /* @__PURE__ */ S("section", { className: "sow-section", children: [
    ...
    r.length > 0 && /* @__PURE__ */ E("div", { className: "sow-items", children: r.map((h, p) => /* @__PURE__ */ S(lt, { children: [
...
function Le(e, t, u = {}) {
  ...
  const L = ["'", '"', "`", "‘", "’", "“", "”"], P = (C, R) => C === R ? !0 : ["‘", "’"].includes(C) && ["‘", "’"].includes(R) || ["“", "”"].includes(C) && ["“", "”"].includes(R);
  function k(C, R) {
    if (s && C == "text") {
      const ue = R.trim().split(Yr);
      for (let z of ue)
        z = oo(z), z !== "" && i.push({ type: C, value: z });
    } else
      i.push({ type: C, value: R });
    f = "";
  }
  function B(C) {
    N === 0 ? (f !== "" && k("text", f), f = C) : f += C;
  }
  for (; l < e.length; ) {
    const C = e[l];
    r.includes(C) && !m ? (B(C), N = p.push(C), g = t[C]) : C === g && !m ? (f += C, p.pop(), N--, g = N > 0 ? t[p[N - 1]] : "", N === 0 && k("enclosure", f)) : !m && L.includes(C) && N > n ? (B(C), m = !0, h = C) : m && P(h, C) ? (f += C, m = !1, N === 0 && k("quote", f)) : f += C, l++;
  }
  return f !== "" && k("text", f), i;
}
function io(e) {
...
function Wr(e, t = []) {
  ...
  const u = Le(e, { "{": "}", "(": ")" }, { minQuoteLevel: 1 }), r = {};
  function n(s, i, l) {
  ...
  for (let s = 1; s < u.length; s += 2) {
    ...
    if (i.length < 3 || !i.startsWith("[") || !i.endsWith("]"))
      ...
      const m = i.slice(1, -1).trim().split(Yr), h = m.shift(), p = m[0] === "$0";
      p && m.shift(), !h || !/^[a-zA-Z_]\w*$/.test(h) ? n("name", "word", m.join(" ")) : m.every((g) => /^(\.\.\.)?[a-zA-Z_]\w*$/.test(g)) ? r[h] = { args: m, body: f, isText: l == "{", hasFlags: p } : n("arguments", "words", m.join(" "));
    }
  }
  return r;
}
...
function co(e) {
  ...
  for (let s of e)
    if (s.type === "text")
      if (u = s.value.split(so), u.length <= 1)
        t.push(s);
      else
...
function fo(e) {
  ...
  for (let i of e)
    if (!i.isOperator)
      ...
      for (; u.length > 0 && wu[u[u.length - 1]] >= wu[i.value]; )
...
function ho(e) {
  const t = co(e), u = lo(t);
  for (const r of u)
    r.type === "chain" && (r.type = "enclosure", r.value = fo(r.tokens), delete r.tokens);
  return u;
}
function Eo(e) {
  if (!e.length) return [];
  ...
  for (let h = 1; h < e.length; h++) {
    ...
    p.type == "text" ? g in t ? (s.push(r), r = { name: t[g], flags: {}, args: [] }, n = "") : l.includes(g) ? (n = g, r.flags[n] = !0) : g in f ? (n = f[g], r.flags[n] = !0) : n ? i.includes(g) || (r.flags[n] = p, n = "") : i.includes(g) || r.args.push(p) : n ? (r.flags[n] = p, n = "") : r.args.push(p);
  }
  s.push(r);
...
const mo = {
  ...
  formatter: {
    "": { handler: $o, minArgs: 1, spread: !1 },
    // handler
    "#": Re
  },
  unary: {
    "": { handler: zo, minArgs: 1, spread: !1 },
    // handler
    "!": ac,
...
}, bo = ["wrap", "aux", "label", "heading", "title"];
let Qt;
const Uu = {};
function vu(e, t, u) {
  Uu[e] ??= po(e);
  ...
  if ((r.spread && u.length == r.minArgs && !t.l || t.s) && x(u[u.length - 1])) {
    const i = u.pop();
    u = u.concat(i);
  }
  let n = To[e] || [];
  ...
  !t.type && typeof t.as == "string" && (t.type = t.as), t.lang ? t.locale = t.lang : (t.locale || (t.locale = je(t.locale)), t.lang = qr(t.locale)), t._name = e;
  const s = r.handler(r.fn, t, u);
  return t.r && x(s) && s.reverse(), s === void 0 ? null : s;
}
function po(e) {
  for (let t in Hu) {
    const u = Hu[t];
...
function go(e, t, u) {
  if (["~", "phone", "address", "ref", "email"].includes(t._name) && Ce(u)) {
    let r = pe(t, u);
...
Gr.init = 0;
function ke(e) {
  return x(e) ? e.flat(1 / 0) : e == null ? [] : typeof e == "object" ? Object.values(e).flat(1 / 0) : [e];
}
function Yo(e, t, u) {
  if (!Ce(u))
    return e(u);
...
function Ko(e, t, u) {
  const r = u[0], n = u.slice(1);
  let s;
  return /*config.stepIn[0] &&*/ Array.isArray(r) ? s = r.map((i) => Wu(e, i, n)) : s = Wu(e, r, n), s;
}
function $o(e, t, u) {
  if (u.length === 1)
    return e({ ...t }, u[0]);
  const r = (s) => s.length == 1 ? e({ ...t }, s[0]) : s.map((i) => e({ ...t }, i));
  return Ce(u) ? pe({}, u).map((s) => r(s)) : r(u);
}
function zo(e, t, u) {
  const r = u[0];
...
function Wu(e, t, u) {
  return u.length == 1 && !x(u[0]) ? e(t, u[0]) : (u.length == 1 && x(u[0]) && (u = u[0]), u.map((r) => Array.isArray(r) ? r.map((n) => e(t, n)) : e(t, r)));
}
function qo(e, t) {
  if (!e) return [];
  if (e = Array.isArray(e) ? e : e.split("|"), he(t) && (t = t.split(",")), !lc(t))
    return e;
  const u = [];
  for (const r of t)
    u.push(e[r]);
...
function Re(e, t) {
  if (e.type ??= Tt(t, e), e.row ? (t = qo(t, e.row), e.type = "list") : t = le(t, e.type, e), t === null) return "";
  const u = e.json ? "json" : e.type, r = { ...e };
  bo.forEach((s) => {
    delete r[s];
  });
  const n = { ...r, [e.type]: e[e.type] };
  return t = Vo(u, n, t), e.title && he(t) && (t = Qr(t, e.locale)), e.aux && (x(t) && (t = t.join(e.sep || ", ")), t = su(e, t)), e.label && (x(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = bc(e, t)), e.heading && (x(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = Tc(e, t)), e.wrap && (Dt(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Vo(e, t, u) {
  switch (e) {
    case "null":
...
function ic(e, t) {
  const u = e.date ? oc : Kr, r = e.desc ? -1 : 1;
  return t.sort((n, s) => r * u(e, n, s));
}
function mt(e, t) {
  if (t.by && X(e) && !x(e)) {
    const u = e[t.by];
    return u !== void 0 ? u : Gu(e);
  }
  return Gu(e);
}
function oc(e, t, u) {
  let r = mt(t, e), n = mt(u, e);
  return Se(r) && Se(n) ? le(r, "date").getTime() - le(n, "date").getTime() : Kr(e, t, u);
}
function Kr(e, t, u) {
  let r = mt(t, e), n = mt(u, e);
  const s = ee(r), i = ee(n);
...
function cc(e, t, u) {
  ...
  if (!Ce(r) && !Ce(n))
    return e(t, r, n);
  {
    const s = Math.max(qt(r), qt(n)), i = { sz: s }, l = pe(i, r), f = pe(i, n), m = [];
    for (let h = 0; h < s; h++)
      m.push(e(t, l[h], f[h]));
    return m;
  }
...
function Dt(e) {
  return e == null || e === "" || Number.isNaN(e) ? !0 : Array.isArray(e) ? e.length === 0 : e instanceof K && typeof e.isEmpty == "function" && e.isEmpty() ? !0 : typeof e == "object" && e.constructor === Object ? Object.keys(e).length === 0 : !1;
}
function ye(e) {
  return !e || e === "0" ? !0 : Array.isArray(e) ? e.length === 0 : e instanceof K && typeof e.isEmpty == "function" && e.isEmpty() ? !0 : typeof e == "object" && e.constructor === Object ? Object.keys(e).length === 0 : !1;
}
function Be(e, t) {
  const u = e.split(".");
  let r = t;
  for (let n = 0; n < u.length; n++) {
    ...
    if (x(r) && !ee(s)) {
      const i = [];
      for (let l of r)
        s = u.slice(n).join("."), i.push(Be(s, l));
      return i;
    }
    if (r === null)
      return;
...
function dc(e) {
  return Se(e) ? !/^\d{4}\/\d{1,2}\/\d{1,2}$/.test(e) : !1;
}
function le(e, t, u = {}) {
  switch (t) {
    case "boolean":
      return !ye(e);
    case "date":
      return Se(e) ? e instanceof Date || u.date === "auto" && dc(e) ? e : new Date(e.replace(/-/g, "/")) : null;
    case "text":
    case "string":
      return he(e) ? e : ne(ke(e));
    case "list":
      return x(e) ? e : X(e) ? ke(e) : null;
    case "object":
      return X(e) ? e : null;
    case "number":
      return ee(e) ? parseFloat(e) : Se(e) ? le(e, "date").getTime() : 0;
    case "range":
      return e instanceof Z ? e : x(e) ? new Z(u, e) : X(e) ? new Z(u, [e.start, e.end]) : new Z(u, [e]);
    case "tag":
      return e instanceof H ? e : x(e) ? new H(u, [e]) : e instanceof K ? new H(u, [[null, e, null]]) : X(e) ? new H(u, [e]) : new H(u, [[null, e, null]]);
  }
  return e;
}
function Tt(e, t = {}) {
  ...
  if (e instanceof Date)
    return "date";
  const u = typeof e;
  return u == "undefined" || e === null ? "null" : u == "boolean" ? u : x(e) ? "list" : ee(e) ? "number" : Se(e) ? "date" : X(e) ? "object" : u;
}
function fc(e, t) {
  if (!Se(t))
    return null;
  ...
  let r = e.date;
  return he(r) && (r = u[r]), (!r || r === !0) && (r = "medium"), he(r) && (r = { dateStyle: r }), t instanceof Date ? t.toLocaleDateString(e.locale, r) : t;
}
function hc(e, t) {
  if (isNaN(t)) return "";
...
function $r(e, t) {
  const u = [];
  for (let r of t)
    x(r) ? r = $r(e, r) : X(r) && (r = zr(e, r)), Dt(r) || u.push(r);
...
function mc(e) {
  Qt = typeof document < "u" && document.documentElement?.getAttribute("lang") || "en";
}
function je(e = null) {
  return Qt || mc(), e || Qt;
}
function qr(e = null) {
  return je(e).split("-")[0].toLowerCase();
}
function Ku(e) {
  return {
    en: "Present",
...
function su(e, t) {
  return t ? new H(e, [["u-aux", t]]).format() : "";
}
function Tc(e, t) {
  if (!t && !e.force) return "";
  let u = e.level || 3;
...
class K {
  constructor(t, u) {
    if (this.flags = { ...t }, this.values = Array.isArray(u) ? [...u] : typeof u == "object" ? { ...u } : u, this.parsedArgs = null, new.target === K)
...
class Z extends K {
  constructor(t, u) {
    super(t, u);
    const r = ke(u), n = r[0], s = r[1];
    this.givenStart = n, this.givenEnd = s, this.includeStart = !t.open, this.includeEnd = !t.open, this.flags.type || (this.flags.type = Tt(n || s)), this.start = le(n, "number"), this.end = le(s, "number");
  }
  /**
  ...
  format(t) {
    ...
    return t.type === "date" ? (r = r ? Re(t, r) : Ku(t.locale), n = n ? Re(t, n) : Ku(t.locale)) : t.type !== "range" && (r = Re(t, r || ""), n = Re(t, n || "")), r || n ? `${r}${u}${n}` : "";
  }
  isEmpty() {
  ...
  format() {
    ...
    return this.markups.forEach((r) => {
      ...
      n.forEach((f, m) => {
        ...
        if (u.includes(h))
          if (l) {
            if (l instanceof K && l.isEmpty()) return "";
          } else return "";
...
class Ac extends K {
  ...
  format() {
    ...
    return [
      ne({}, [
        " ",
        Re({ tag: "bold", type: "tag", bold: !0 }, ae([t, ":"])),
        ne({}, [
          " ",
          n,
          ae(["(", new Z({}, [p, g]), ")"])
...
class Ic extends K {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { amount: t, currency: u, convertedAmount: r } = this.parsedArgs, n = mo[u.toLowerCase()], i = [["u-amount", n ? new Intl.NumberFormat(`${je()}-CA`, {
      style: "currency",
      currency: n
    }).format(t) : t]];
    return u && i.push(["u-unit", u]), r && r !== "0" && i.push([
      "u-aux",
      new Intl.NumberFormat(`${je()}-CA`, {
        style: "currency",
        currency: "CAD"
      }).format(r)
    ]), new H({}, [["u-currency", new H({}, i)]]).format();
  }
  isEmpty() {
...
const $u = /^[@]?[\$]?[\/]?[a-zA-Z_][a-zA-Z0-9_\/\.-]*$|^@$|^\?$/, Sc = /^-?\d+(\.\d+)?$/;
class Oc {
  /**
   ...
   */
  constructor(t = {}, u = {}) {
    this.snippets = Wr(t), this.functions = u;
  }
  /**
   ...
   */
  setVariables(t) {
    this.variables = typeof t == "function" ? t : (u) => Be(u, t);
  }
  /**
  ...
  render(t, u = null, r = null) {
    ...
    for (const i of n)
      if (i.type === "enclosure") {
        ...
        try {
          l = this.evaluateText(l, null, r), typeof l != "string" && (l = vu("#", { l: !0, sep: ", " }, [l]), Array.isArray(l) && l.every((f) => typeof f == "string") && (l = l.join(", ")));
        } catch (f) {
          l = f;
        }
        s += l;
  ...
  evaluateText(t, u = null, r = null) {
    if (t = t.trim(), u && this.setVariables(u), $u.test(t))
  ...
  getVariableMeta(t) {
    ...
    return typeof u == "string" ? { label: u } : (u.label ??= Qr(t.split("_").join(" ")), u);
  }
  /**
  ...
  evaluateExpression(t, u = null) {
    ...
    return u && u.has(r) ? { value: u.get(r), type: "aux" } : $u.test(r) ? {
      value: this.getVariable(r, u),
      label: this.getVariableMeta(r).label,
      type: "variable"
    } : Sc.test(r) ? { value: parseFloat(r), type: "number" } : { value: this.getError(103, "Invalid expression", r), type: "error" };
  }
...
Vr.sort((e, t) => t.length - e.length);
const yc = new Set(Vr.map((e) => e.join(" ").toUpperCase())), Dc = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
  ...
  "object",
  "tag"
]), Lc = /* @__PURE__ */ new Set([">=", "<=", "!=", "==", "&&", "||"]), Rc = /* @__PURE__ */ new Set(["+", "-", "*", "/", "%", "=", "<", ">", "!"]), Pc = /[a-zA-Z_@$?]/, Bc = /[a-zA-Z0-9_.\/@]/, Pt = /[0-9]/;
function Mc(e) {
  return xc(e);
}
function xc(e) {
...
` || n === "\r") {
    ...
    if (Pt.test(n) || n === "-" && Pt.test(e[r + 1] || "") && kc(t)) {
      let i = r + (n === "-" ? 1 : 0);
      for (; i < u && (Pt.test(e[i]) || e[i] === "."); ) i++;
...
function kc(e) {
  ...
  return !!(t.type === "operator" || t.type === "lparen" || t.type === "word" && yc.has(t.value.toUpperCase()));
}
function jr(e, t, u) {
...
const Hc = /* @__PURE__ */ new Set(["long", "full", "short", "medium"]), Uc = [
  ["for", "each"],
  ["total", "of"],
  ["sum", "of"],
  ["average", "of"],
  ...
  ["as"],
  ["if"]
], vc = [["then"], ["show"]], Yc = [["otherwise"], ["else"]], Wc = [["else"], ["show"]], Gc = [["in"]], Kc = [["do"]], $c = [["ascending"]], zc = [["descending"]];
function V(e, t) {
  return Fc(e.tokens, e.i, t);
}
function W(e, t) {
  e.i += t.length;
}
function Qc(e) {
  const t = { tokens: e, i: 0 }, u = iu(t);
  if (u == null)
    throw new de("Empty Plain expression");
  if (t.i < t.tokens.length) {
    const r = t.tokens.slice(t.i).map((n) => n.value).join(" ");
    throw new de(`Unexpected trailing tokens: ${r}`);
  }
  return u;
}
function U(e, t = 0) {
...
function iu(e) {
  ...
  if (u && !qc(e, u))
    switch (W(e, u), u.canonical) {
      ...
      case "TOTAL OF":
      case "SUM OF":
        return Bt(e, { type: "sum", value: J(e) });
      case "AVERAGE OF":
        return Bt(e, { type: "average", value: J(e) });
      case "COUNT OF":
        return Bt(e, t0(e));
      case "FOR EACH":
        return u0(e);
...
function jc(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    if (r.type === "rparen" || r.type === "operator" || r.type === "word" && V(e, Ze)) break;
    const n = J(e);
    if (n == null) break;
    u.push(n);
  }
...
function zu(e) {
  const t = Xc(e);
  if (t.length === 0) {
    const n = U(e), s = n ? `${n.type}:${n.value}` : "end of input";
    throw new de(`Expected a value, got ${s}`);
  }
  const u = ou(e);
  if (t.length > 1) {
    for (const i of u)
  ...
  const r = t[0];
  return u.length === 0 && Jc(r) ? { type: "show", value: r, modifiers: [] } : { type: "show", value: r, modifiers: u };
}
function Xc(e) {
  const t = [];
  for (; e.i < e.tokens.length; ) {
    ...
    if (u.type === "rparen" || u.type === "operator" || u.type === "word" && V(e, Ze)) break;
    const r = J(e);
    if (r == null) break;
    t.push(r);
  }
...
function ou(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    switch (u.canonical) {
      case "AS": {
        W(e, u), t.push({ type: "as", format: Zc(e) });
        break;
      }
      case "WITH LABEL": {
        W(e, u);
        let r = null;
        U(e) && U(e).type === "string" && (r = F(e).value), t.push({ type: "withLabel", label: r });
        break;
      }
      case "SORTED BY": {
        W(e, u);
      ...
      case "FROM LOWEST TO HIGHEST": {
        W(e, u), t.push({ type: "sortedBy", value: J(e), order: "asc" });
        break;
      }
      case "FROM HIGHEST TO LOWEST": {
        W(e, u), t.push({ type: "sortedBy", value: J(e), order: "desc" });
        break;
      }
      case "JOINED BY": {
        W(e, u);
        const r = U(e);
        if (!r || r.type !== "string")
          throw new de("JOINED BY expects a quoted string");
        F(e), t.push({ type: "joinedBy", sep: r.value });
        break;
      }
      case "WHERE":
      case "IF": {
        W(e, u), t.push({ type: "where", condition: cu(e) });
        break;
      }
      case "IF PRESENT": {
        W(e, u), t.push({ type: "ifPresent" });
        break;
      }
      default:
        return t;
...
function Zc(e) {
  const t = U(e);
  if (t && t.type === "string")
    return F(e), { raw: t.value };
  const u = [];
  for (; u.length < 2; ) {
    const s = U(e);
    if (!s || s.type !== "word" || V(e, Ze)) break;
    u.push(F(e).value.toLowerCase());
  }
  if (u.length === 0)
    throw new de("AS requires a format type");
  const r = u[0], n = u[1];
  return n === "date" && Hc.has(r) ? { type: "date", value: r } : n === "only" && (r === "year" || r === "month") ? { type: "date", value: r === "year" ? "y" : "m" } : Dc.has(r) ? { type: r, value: n ?? null } : (n != null && e.i--, { type: r, value: null });
}
function e0(e) {
  const t = cu(e), u = V(e, vc);
  u && W(e, u);
  const r = Qu(e);
  let n = null;
  const s = V(e, Yc);
...
function u0(e) {
  const t = U(e);
  if (!t || t.type !== "word")
    throw new de("FOR EACH expects an identifier");
  F(e);
  const u = V(e, Gc);
  u && W(e, u);
  const r = J(e), n = V(e, Kc);
  n && W(e, n);
  const s = iu(e);
...
function Vt(e) {
  ...
  if (t && t.type === "operator" && t.value === "!")
    return F(e), { type: "unop", op: "!", arg: Vt(e) };
  if (t && t.type === "lparen") {
    F(e);
    const u = Jr(e);
    return Xr(e, "rparen"), { type: "group", inner: u };
  }
  return a0(e);
}
...
function a0(e) {
  const t = Vu(e), u = U(e);
  if (u && u.type === "operator" && r0.has(u.value)) {
    F(e);
    const r = Vu(e);
...
function J(e) {
  ...
  return t.type === "loom" ? (F(e), { type: "loom", value: t.value }) : t.type === "string" ? (F(e), { type: "string", value: t.value }) : t.type === "number" ? (F(e), { type: "number", value: t.value }) : t.type === "word" ? (F(e), { type: "var", path: t.value }) : null;
}
...
function w(e) {
  switch (e.type) {
    ...
    case "group":
      return w(e.inner);
    case "binop":
      return `(${e.op} ${w(e.left)} ${w(e.right)})`;
    case "unop":
      return `(${e.op} ${w(e.arg)})`;
    case "show":
      return i0(e);
    ...
    case "forEach":
      return d0(e);
    default:
      throw new Zr(`Unknown node type: ${e.type}`);
  }
}
function s0(e) {
  if (e.args.length === 0) return e.name;
  const t = e.args.map(w).join(" ");
  return `(${e.name} ${t})`;
}
function i0(e) {
  if (e.values)
    return o0(e);
  const t = bt(e.value), u = e.modifiers.some((l) => l.type === "sortedBy");
  let r = null;
  ...
  if (i && (i.type === "count" || i.type === "sum" || i.type === "average")) {
    ...
    if (l >= 0) {
      const f = e.modifiers[l], m = bt(i.value), h = w(Pe(f.condition, m));
      if (i.type === "count")
        n = `(++!! ${h})`;
      else if (i.type === "sum")
        n = `(++ (? ${h} ${w(i.value)}))`;
  ...
  n == null && (n = r ? t : w(e.value));
  for (let l = 0; l < e.modifiers.length; l++) {
    if (l === s) continue;
    const f = e.modifiers[l];
    switch (f.type) {
      case "where": {
        n = `(? ${w(Pe(f.condition, t))} ${n})`;
        break;
      }
      case "sortedBy": {
        const m = h0(f.value);
        n = `(>> ${f.order === "desc" ? "-desc " : ""}-by=${m} ${n})`, r && (n = `(. ${Me(r)} ${n})`, r = null);
        break;
      }
      case "joinedBy":
        n = `(+: ${Me(f.sep)} ${n})`;
      ...
      default:
        throw new Zr(`Unknown modifier type: ${f.type}`);
    }
  }
  return n;
}
function o0(e) {
  const t = e.values.map(w);
...
function c0(e) {
  const t = w(e.condition), u = w(e.thenBranch);
  return e.elseBranch != null ? `(? ${t} ${u} ${w(e.elseBranch)})` : `(? ${t} ${u})`;
}
function l0(e) {
  return `(++!! ${w(e.value)})`;
}
function bt(e) {
  ...
  return e.type === "group" ? bt(e.inner) : e.type === "count" || e.type === "sum" || e.type === "average" ? bt(e.value) : null;
}
function Pe(e, t) {
  ...
  switch (e.type) {
    ...
    case "unop":
      return { ...e, arg: Pe(e.arg, t) };
    case "group":
      return { ...e, inner: Pe(e.inner, t) };
    default:
      return e;
  }
}
function d0(e) {
  const t = w(e.list), u = w(e.body).replace(
    new RegExp(`\\b${f0(e.ident)}\\b`, "g"),
    "$1"
  );
  return `(map ${t} ${Me(u)})`;
}
...
function h0(e) {
  ...
  return e.type === "string" ? e.value : w(e);
}
function E0(e) {
  if (e.raw != null) {
    const t = e.raw;
...
function De(e, t, u) {
  if (Array.isArray(e))
    return e.map((n) => jt(n, t, u));
  if (!e || typeof e != "object") return e;
  const r = e.content;
  return Array.isArray(r) ? {
    ...e,
    content: r.map((n) => jt(n, t, u))
  } : e;
}
function jt(e, t, u) {
  if (!e || typeof e != "object") return e;
  ...
  return r === "text" && typeof s == "string" ? {
    ...
    ...e,
    content: n.map((i) => jt(i, t, u))
  } : e;
}
function Xu(e, t, u, r) {
  const n = e?.doc ?? e;
  if (!n?.content) return De(n, t, u);
  const s = Be(r, u), i = _0(n.content);
...
function L0({ invoices: e = [], sows: t = [] } = {}) {
  ...
  for (const n of e) {
    ...
    ), Array.isArray(n?.items) && l?.expires && n.items.some((h) => D0(h?.period, l.expires)) && r(
      i ? "warn" : "info",
...
function we(e, t, u) {
  ...
  const r = u?.website?.config?.recordsByQuery?.[e];
  return Array.isArray(r) ? r : [];
}
function Ju(e, t) {
  const u = t?.website?.config?.business_docs || {}, r = u.vendor || {}, n = u.defaults || {}, s = u.registries?.tax || {}, i = we("invoices", e, t), l = we("sows", e, t), f = { vendor: r, defaults: n }, m = ua({ invoice: e?.invoice, invoices: i });
  if (m) {
    const p = yt(m, n, s), g = Array.isArray(m.items) ? m.items.map((N) => ({ ...N, amount: nu(N) })) : [];
    return { ...f, ...m, items: g, ...p };
  }
  const h = ra({ sow: e?.sow, sows: l });
...
function Xt(e) {
  ...
  if (typeof e == "object") {
    const t = {};
    for (const [u, r] of Object.entries(e)) t[u] = Xt(r);
    return t;
  }
  return e;
}
function P0({ params: e, content: t, block: u }) {
...
let Zu = /* @__PURE__ */ new WeakSet();
function B0(e, t) {
  const u = we("invoices", e, t), r = we("sows", e, t);
  if (u.length === 0 || r.length === 0 || Zu.has(t)) return;
  Zu.add(t);
  const n = L0({ invoices: u, sows: r });
  n.length > 0 && R0(n);
}
const xt = {
  ...
  handlers: {
    content: (e, t) => {
      B0(e, t);
      const u = Xt(Ju(e, t)), r = t.rawContent?.doc ?? t.rawContent, n = t.properties?.source;
      if (!n) return De(r, st, u);
      const s = t.properties?.where;
      if (s) {
        const i = u[n];
        if (Array.isArray(i)) {
          const l = i.filter(
            (f) => st.evaluateText(s, { ...u, ...f })
          );
          return Xu(r, st, { ...u, [n]: l }, n);
        }
      }
      return Xu(r, st, u, n);
    },
     ...
     */
    props: (e, t, u) => {
      const r = u.parsedContent?.data, n = Ju(r, u), s = u?.website?.config?.business_docs || {}, i = s.vendor || {}, l = s.defaults || {}, f = s.registries?.tax || {}, m = ua({
        invoice: r?.invoice,
        invoices: we("invoices", r, u)
      }), h = ra({
        sow: r?.sow,
        sows: we("sows", r, u)
      }), p = m ? yt(m, l, f) : null, g = m && Array.isArray(m.items) ? m.items.map((L) => ({ ...L, amount: nu(L) })) : [], N = P0({ params: t, content: e, block: u });
      return {
        content: {
          ...e,
...
function M0({ title: e = "Document", filename: t = "document" }) {
  const { website: u } = au(), [r, n] = ot(null), [s, i] = ot(null), [l, f] = ot(!1), m = oa(null);
  At(() => {
    if (!l) return;
    const g = (N) => {
  ...
  const h = Object.keys(xt.outputs || {}).filter((g) => it[g]), p = async (g) => {
    i(null), n(g), f(!1);
    try {
      const N = await si(u, { format: g, foundation: xt, title: e }), L = xt.outputs?.[g]?.extension || it[g]?.ext || g;
      ri(N, `${t}.${L}`);
    } catch (N) {
  ...
  return /* @__PURE__ */ S("div", { ref: m, className: "business-docs-download", children: [
    /* @__PURE__ */ E(
      "button",
      {
        type: "button",
    ...
    l && /* @__PURE__ */ E("div", { role: "menu", className: "business-docs-download-menu", children: h.map((g) => /* @__PURE__ */ S(
      "button",
      {
        type: "button",
        role: "menuitem",
        ...
        children: [
          ...
          /* @__PURE__ */ S("span", { className: "business-docs-download-ext", children: [
            ".",
            it[g].ext
          ] })
        ]
...
function x0({ body: e, page: t }) {
  const { website: u } = au(), r = t?.title || "Business document", n = (t?.title || "document").toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
  return At(() => bi(t), [t]), /* @__PURE__ */ S(rr, { basePath: u.basePath, children: [
    /* @__PURE__ */ E("main", { className: "business-docs-body", children: /* @__PURE__ */ E("div", { className: "business-docs-document", children: e }) }),
    /* @__PURE__ */ E(M0, { title: r, filename: n })
  ] });
}
const k0 = { layouts: { BusinessDocLayout: x0 } }, w0 = {}, F0 = {}, $0 = { meta: w0, capabilities: k0, layoutMeta: F0 };
export {
  ce as D,
  W0 as E,
  G0 as I,
...
//# sourceMappingURL=_entry.generated-CiDC8ARA.js.map
