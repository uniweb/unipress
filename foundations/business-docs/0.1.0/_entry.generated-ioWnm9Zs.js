...
import { createContext as _t, useContext as At, useMemo as _e, createElement as kt, useState as ot, useEffect as gt, useReducer as ar, Children as rr, isValidElement as nr, cloneElement as sr, Fragment as dt, useRef as ir } from "react";
...
function De(e, t, u = {}) {
  ...
  for (; l < e.length; ) {
    const D = e[l];
    a.includes(D) && !m ? (R(D), N = p.push(D), g = t[D]) : D === g && !m ? (f += D, p.pop(), N--, g = N > 0 ? t[p[N - 1]] : "", N === 0 && x("enclosure", f)) : !m && L.includes(D) && N > n ? (R(D), m = !0, h = D) : m && M(h, D) ? (f += D, m = !1, N === 0 && x("quote", f)) : f += D, l++;
  }
  return f !== "" && x("text", f), i;
}
function lr(e) {
...
function mu(e, t, u) {
  ...
  if ((a.spread && u.length == a.minArgs && !t.l || t.s) && B(u[u.length - 1])) {
    const i = u.pop();
    u = u.concat(i);
  }
  let n = pr[e] || [];
  ...
  !t.type && typeof t.as == "string" && (t.type = t.as), t.lang ? t.locale = t.lang : (t.locale || (t.locale = qe(t.locale)), t.lang = oa(t.locale)), t._name = e;
...
function bu(e, t, u) {
  return u.length == 1 && !B(u[0]) ? e(t, u[0]) : (u.length == 1 && B(u[0]) && (u = u[0]), u.map((a) => Array.isArray(a) ? a.map((n) => e(t, n)) : e(t, a)));
}
function jr(e, t) {
  if (!e) return [];
...
function Le(e, t) {
  ...
  return t = Xr(u, n, t), e.title && fe(t) && (t = ia(t, e.locale)), e.aux && (B(t) && (t = t.join(e.sep || ", ")), t = Zt(e, t)), e.label && (B(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = An(e, t)), e.heading && (B(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = _n(e, t)), e.wrap && (Nt(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Xr(e, t, u) {
  switch (e) {
    case "null":
...
function na(e, t) {
  const u = [];
  for (let a of t)
    B(a) ? a = na(e, a) : X(a) && (a = sa(e, a)), Nt(a) || u.push(a);
...
let On = class extends G {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { amount: t, currency: u, convertedAmount: a } = this.parsedArgs, n = br[u.toLowerCase()], i = [["u-amount", n ? new Intl.NumberFormat(`${qe()}-CA`, {
      style: "currency",
      currency: n
    }).format(t) : t]];
...
const Rn = new Set(ca.map((e) => e.join(" ").toUpperCase())), Pn = /* @__PURE__ */ new Set([
  ...
  "object",
  "tag"
]), Bn = /* @__PURE__ */ new Set([">=", "<=", "!=", "==", "&&", "||"]), Mn = /* @__PURE__ */ new Set(["+", "-", "*", "/", "%", "=", "<", ">", "!"]), xn = /[a-zA-Z_@$?]/, kn = /[a-zA-Z0-9_.\/@]/, Rt = /[0-9]/;
function wn(e) {
  return Fn(e);
}
function Fn(e) {
...
function Zn(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    if (a.type === "rparen" || a.type === "operator" || a.type === "word" && V(e, Xe)) break;
    const n = J(e);
    if (n == null) break;
    u.push(n);
  }
...
function ls(e) {
  ...
  for (let l = 0; l < e.modifiers.length; l++) {
    ...
    switch (f.type) {
      ...
      case "sortedBy": {
        const m = Ts(f.value);
        n = `(>> ${f.order === "desc" ? "-desc " : ""}-by=${m} ${n})`, a && (n = `(. ${Be(a)} ${n})`, a = null);
        break;
      }
      case "joinedBy":
        n = `(+: ${Be(f.sep)} ${n})`;
...
function ks({ invoices: e = [], sows: t = [] } = {}) {
  ...
  for (const n of e) {
    const s = n?.slug || n?.number || "(unknown)", i = Bs(n);
    if (!n?.sow_ref) {
      a(
        i ? "warn" : "info",
...
function Fs({ params: e, content: t, block: u }) {
  ...
  handlers: {
    ...
    props: (e, t, u) => {
      const a = u.parsedContent?.data, n = Du(a, u), s = u?.website?.config?.business_docs || {}, i = s.vendor || {}, l = s.defaults || {}, f = s.registries?.tax || {}, m = ba({
        ...
        sow: a?.sow,
        sows: xe("sows", a, u)
      }), p = m ? It(m, l, f) : null, g = m && Array.isArray(m.items) ? m.items.map((L) => ({ ...L, amount: ru(L) })) : [], N = Fs({ params: t, content: e, block: u });
      return {
        content: {
          ...e,
...
function Ca(e) {
  return e >= 64976 && e <= 65007 || Ys.has(e);
}
var b;
(function(e) {
...
class $s {
  constructor(t) {
    this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = Ks, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (Ws(u))
        return this.pos++, this._addGap(), Gs(t, u);
...
const zs = /* @__PURE__ */ new Uint16Array(
  // prettier-ignore
...
class Zs {
  ...
  stateNumericStart(t, u) {
    return u >= t.length ? -1 : (t.charCodeAt(u) | Vs) === v.LOWER_X ? (this.state = U.NumericHex, this.consumed += 1, this.stateNumericHex(t, u + 1)) : (this.state = U.NumericDecimal, this.stateNumericDecimal(t, u));
  }
  ...
  stateNamedEntity(t, u) {
    ...
    for (; u < t.length; u++, this.excess++) {
      ...
      if (this.treeIndex = ei(a, n, this.treeIndex + Math.max(1, s), i), this.treeIndex < 0)
        ...
        Js(i)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function Ct(e) {
  var t;
  return (t = ti.get(e)) !== null && t !== void 0 ? t : r.UNKNOWN;
}
const A = r, ui = {
...
class si {
  constructor(t, u) {
    this.options = t, this.handler = u, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = c.DATA, this.returnState = c.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new $s(u), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new Zs(zs, (a, n) => {
  ...
  _stateTagName(t) {
    ...
    switch (t) {
      ...
      default:
        u.tagName += String.fromCodePoint(Ye(t) ? at(t) : t);
    }
  }
  ...
  _stateAttributeName(t) {
    switch (t) {
      ...
      default:
        this.currentAttr.name += String.fromCodePoint(Ye(t) ? at(t) : t);
    }
  }
  ...
  _stateBeforeDoctypeName(t) {
    if (Ye(t))
      this._createDoctypeToken(String.fromCharCode(at(t))), this.state = c.DOCTYPE_NAME;
    else
      switch (t) {
        case o.SPACE:
        case o.LINE_FEED:
  ...
  _stateDoctypeName(t) {
    ...
    switch (t) {
      ...
      default:
        u.name += String.fromCodePoint(Ye(t) ? at(t) : t);
    }
  }
...
const ya = /* @__PURE__ */ new Set([r.DD, r.DT, r.LI, r.OPTGROUP, r.OPTION, r.P, r.RB, r.RP, r.RT, r.RTC]), Mu = /* @__PURE__ */ new Set([
  ...ya,
  r.CAPTION,
  r.COLGROUP,
  r.TBODY,
  ...
  r.TEMPLATE,
  r.TH
]), ii = /* @__PURE__ */ new Set([...mt, r.OL, r.UL]), oi = /* @__PURE__ */ new Set([...mt, r.BUTTON]), xu = /* @__PURE__ */ new Set([r.ANNOTATION_XML, r.MI, r.MN, r.MO, r.MS, r.MTEXT]), ku = /* @__PURE__ */ new Set([r.DESC, r.FOREIGN_OBJECT, r.TITLE]), ci = /* @__PURE__ */ new Set([r.TR, r.TEMPLATE, r.HTML]), li = /* @__PURE__ */ new Set([r.TBODY, r.TFOOT, r.THEAD, r.TEMPLATE, r.HTML]), di = /* @__PURE__ */ new Set([r.TABLE, r.TEMPLATE, r.HTML]), fi = /* @__PURE__ */ new Set([r.TD, r.TH]);
class hi {
...
const Te = {
...
}, Da = "html", mi = "about:legacy-compat", Ti = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", La = [
  ...
  "html"
]), Ra = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], _i = [
  ...Ra,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function Ai(e) {
  return e.name === Da && e.publicId === null && (e.systemId === null || e.systemId === mi);
}
function gi(e) {
  if (e.name !== Da)
    return j.QUIRKS;
  ...
  let { publicId: u } = e;
  if (u !== null) {
    if (u = u.toLowerCase(), pi.has(u))
      return j.QUIRKS;
    let a = t === null ? bi : La;
    if (Fu(u, a))
      return j.QUIRKS;
    if (a = t === null ? Ra : _i, Fu(u, a))
...
const Hu = {
...
}, Ni = "definitionurl", Ii = "definitionURL", Ci = new Map([
  "attributeName",
  "attributeType",
  "baseFrequency",
  "baseProfile",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((e) => [e.toLowerCase(), e])), Si = /* @__PURE__ */ new Map([
...
function Di(e) {
  const t = e.tagID;
  return t === r.FONT && e.attrs.some(({ name: a }) => a === Ae.COLOR || a === Ae.SIZE || a === Ae.FACE) || yi.has(t);
}
function Pa(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === Ni) {
      e.attrs[t].name = Ii;
      break;
    }
}
...
function Bi(e, t, u, a) {
  return (!a || a === _.HTML) && Pi(e, t, u) || (!a || a === _.MATHML) && Ri(e, t);
}
const Mi = "hidden", xi = 8, ki = 3;
var d;
(function(e) {
...
const wi = {
  ...
  endCol: -1,
  endOffset: -1
}, Ma = /* @__PURE__ */ new Set([r.TABLE, r.TBODY, r.TFOOT, r.THEAD, r.TR]), Uu = {
  scriptingEnabled: !0,
...
class Fi {
  constructor(t, u, a = null, n = null) {
    this.fragmentContext = a, this.scriptHandler = n, this.currentToken = null, this.stopped = !1, this.insertionMode = d.INITIAL, this.originalInsertionMode = d.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...Uu,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = u ?? this.treeAdapter.createDocument(), this.tokenizer = new si(this.options, this), this.activeFormattingElements = new Ei(this.treeAdapter), this.fragmentContextID = a ? Ct(this.treeAdapter.getTagName(a)) : r.UNKNOWN, this._setContextModes(a ?? this.document, this.fragmentContextID), this.openElements = new hi(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, u) {
    const a = new this(u);
  ...
  _err(t, u, a) {
    ...
    if (!this.onParseError)
      return;
    const s = (n = t.location) !== null && n !== void 0 ? n : wi, i = {
      code: u,
   ...
   */
  _processStartTag(t) {
    this.shouldProcessStartTagTokenInForeignContent(t) ? mc(this, t) : this._startTagOutsideForeignContent(t);
  }
  /** @protected */
  ...
  /** @internal */
  onEndTag(t) {
    this.skipNextNewLine = !1, this.currentToken = t, this.currentNotInHTML ? Tc(this, t) : this._endTagOutsideForeignContent(t);
  }
  /** @protected */
...
function vi(e, t, u) {
  ...
  for (let s = 0, i = n; i !== u; s++, i = n) {
    ...
    const l = e.activeFormattingElements.getElementEntry(i), f = l && s >= ki;
    !l || f ? (f && e.activeFormattingElements.removeEntry(l), e.openElements.remove(i)) : (i = Yi(e, l), a === t && (e.activeFormattingElements.bookmark = l), e.treeAdapter.detachNode(a), e.treeAdapter.appendChild(i, a), a = i);
  }
  return a;
}
function Yi(e, t) {
...
function su(e, t) {
  for (let u = 0; u < xi; u++) {
    ...
    const s = vi(e, n, a.element), i = e.openElements.getCommonAncestor(a.element);
    e.treeAdapter.detachNode(s), i && Wi(e, i, s), Gi(e, n, a);
  }
}
function $t(e, t) {
...
function zi(e, t) {
  ...
  const u = t.forceQuirks ? j.QUIRKS : gi(t);
  Ai(t) || e._err(t, b.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, u), e.insertionMode = d.BEFORE_HTML;
}
function we(e, t) {
...
function Qi(e, t) {
  t.tagID === r.HTML ? (e._insertElement(t, _.HTML), e.insertionMode = d.BEFORE_HEAD) : We(e, t);
}
function qi(e, t) {
  const u = t.tagID;
  (u === r.HTML || u === r.HEAD || u === r.BODY || u === r.BR) && We(e, t);
}
function We(e, t) {
...
function ji(e, t) {
  const u = t.tagID;
  u === r.HEAD || u === r.BODY || u === r.HTML || u === r.BR ? Ge(e, t) : e._err(t, b.endTagWithoutMatchingOpenElement);
}
function Ge(e, t) {
...
function Ro(e, t) {
  e._reconstructActiveFormattingElements(), Ba(t), nu(t), t.selfClosing ? e._appendElement(t, _.SVG) : e._insertElement(t, _.SVG), t.ackSelfClosing = !0;
}
function Yu(e, t) {
...
function Vo(e, t) {
  Fa(t) ? e._appendElement(t, _.HTML) : Ze(e, t), t.ackSelfClosing = !0;
}
function jo(e, t) {
...
function Jo(e, t) {
  ...
  switch (u) {
    case r.CAPTION:
    case r.TABLE: {
      e.openElements.hasInTableScope(r.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(r.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = d.IN_TABLE, u === r.TABLE && je(e, t));
      break;
    }
    case r.BODY:
    case r.COL:
...
function mc(e, t) {
  if (Di(t))
    ...
    a === _.MATHML ? Pa(t) : a === _.SVG && (Li(t), Ba(t)), nu(t), t.selfClosing ? e._appendElement(t, a) : e._insertElement(t, a), t.ackSelfClosing = !0;
  }
}
function Tc(e, t) {
...
function bc(e, t, u) {
  ...
  const a = Fi.getFragmentParser(e, u);
  return a.tokenizer.write(t, !0), a.getFragment();
}
const pc = () => ({}), He = () => !0, Ee = (e) => {
  const t = parseInt(e, 10);
  return Number.isFinite(t) ? t : e;
}, _c = (e) => typeof e != "string" ? e : e.split(",").map((t) => t.trim()).filter(Boolean).map((t) => parseInt(t, 10)).filter((t) => Number.isFinite(t)), Ac = {
  "data-underline": { path: ["underline"], transform: pc },
...
const Oc = {
  docx: { load: () => import("./docx-BL9dQEpt.js"), consumes: "docx", ir: !0 },
  ...
  epub: { load: () => import("./epub-D3M6ddXA.js"), consumes: "html", ir: !1 }
};
function cu(e) {
  const t = Oc[e];
  return t ? {
...
function Dc(e, t) {
  ...
  return u.ir ? Lc(a, e) : u.consumes === "html" ? Rc(a, e) : Pc(a);
}
function Lc(e, t) {
...
async function Ku(e, t, u = {}) {
  const { basePath: a, theme: n, adapterOptions: s = {} } = u, i = Mc(e, t, { basePath: a, theme: n });
  return yc(t, i, s);
}
async function kc(e, t = {}) {
  ...
  const L = N.via ?? n, M = N.getOptions ? await N.getOptions(a, { format: n, rootPath: i, loadAsset: p, ...h }) : {}, x = {
    ...
    ...M.adapterOptions,
    ...l
  }, R = Hc(a, i), D = globalThis.uniweb?.childBlockRenderer;
...
function ja(e) {
  const t = ea()?.activeWebsite ?? null, u = e && t ? or(e) : null, a = u ? t.dataStore.get(u) : null, [n, s] = ot(
    () => a ? rt(a.data) : u ? zu() : $u()
  );
  return gt(() => {
    if (!u || !t) {
...
function Lt(e, t) {
  const { website: u } = lu(), [, a] = ar(vc, 0), s = u.activePage?.state;
  gt(() => {
    if (s)
...
function Gc(e) {
  ...
  const u = () => Wc(e), a = qt.map((n) => e.state.subscribe(n, u));
...
function Vc({ source: e, dateRange: t, client: u, status: a }) {
...
function e0(e, t) {
  const [u] = Ja(), [a] = Kc(), [n] = $c(), [s] = zc(), i = t?.website?.config?.business_docs || {}, l = i.defaults || {}, f = i.registries?.tax || {}, m = _e(
  ...
  ), N = m ? p || [] : h, { sumSubtotals: L, sumTotals: M, sumOutstanding: x } = _e(
    () => Zc(N, u, l, f),
    [N, u, l, f]
  );
  return {
    ...
    sumOutstanding: x,
    activeWhere: m,
    activeLabel: Vc({ source: u, dateRange: a, client: n, status: s }),
    totalCount: h.length,
    loading: m ? g : !1
  };
}
...
function v0({ content: e, block: t }) {
  const u = t?.website?.config?.business_docs || {}, a = u.defaults || {}, n = u.registries?.tax || {}, s = a.currency || "CAD", i = a.locale || "en-CA", l = (I) => t0(I, { currency: s, locale: i }), f = (I) => Vt(I, { locale: i }), [m] = Ja(), h = m !== "sows", {
    records: p,
    count: g,
    sumSubtotals: N,
    sumTotals: L,
...
function O({
  ...
  const N = Je(), L = Ve(n, N), M = Us(i, N), x = h ?? p, R = { "data-type": "text" };
  return t && (R["data-bold"] = "true"), u && (R["data-italics"] = "true"), a && (R["data-underline"] = "true"), L && (R["data-color"] = L), s != null && (R["data-size"] = s), M && (R["data-font"] = M), l && (R["data-smallcaps"] = "true"), f && (R["data-allcaps"] = "true"), m && (R["data-strike"] = "true"), x && (R["data-style"] = x), /* @__PURE__ */ E("span", { ...R, ...g, children: c0(e) });
}
function l0({ latex: e, display: t = !1, id: u, ...a }) {
...
function S({
  ...
  const l = d0({ tabStops: u, indent: a, role: n });
  if (t) {
    const f = er(t);
...
function W({
  ...
  const { widths: N, borderColor: L, theme: M } = At(ur), x = u ?? N?.[e], R = {
    "data-type": "tableCell",
...
function Y0({ content: e, block: t }) {
  ...
  let n = null;
  if (u && (a === "cover" ? n = /* @__PURE__ */ E(S0, { bd: u }) : a === "line-items" ? n = /* @__PURE__ */ E(O0, { bd: u }) : a === "totals" && (n = /* @__PURE__ */ E(y0, { bd: u }))), a === "cover" && u?.vendor?.logo) {
...
function W0({ content: e, block: t }) {
  const { title: u, items: a, sequence: n } = e, s = Va(), i = L0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ C(Ne, { children: [
...
function R0({ title: e = "Document", filename: t = "document" }) {
  const { website: u } = lu(), [a, n] = ot(null), [s, i] = ot(null), [l, f] = ot(!1), m = ir(null);
  gt(() => {
    if (!l) return;
    const g = (N) => {
  ...
  const h = Object.keys(ct.outputs || {}).filter((g) => it[g]), p = async (g) => {
    i(null), n(g), f(!1);
    try {
...
//# sourceMappingURL=_entry.generated-ioWnm9Zs.js.map
