...
const Dc = {
  docx: { load: () => import("./docx-BfDTkjw4.js"), consumes: "docx", ir: !0 },
  ...
  epub: { load: () => import("./epub-BXLpFBuJ.js"), consumes: "html", ir: !1 }
};
function cu(e) {
  const t = Dc[e];
  return t ? {
...
function ta({ part: e }) {
  const t = e.href || "", { anchor: u } = f0(t);
  return /* @__PURE__ */ E("a", { ...u !== null ? { "data-type": "internalHyperlink", "data-anchor": u } : { "data-type": "externalHyperlink", "data-link": t }, href: t, children: h0(e).map((n, s) => /* @__PURE__ */ E(
    y,
    {
      style: "Hyperlink",
      bold: n.bold,
...
function O({
  ...
  const l = m0({ tabStops: u, indent: r, role: n });
  if (t) {
    const f = ea(t);
...
function M0({ content: e, block: t }) {
  ...
  })(), i = y0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ S(Ie, { children: [
...
function $0({ content: e, block: t }) {
  ...
  let n = null;
  if (u && (r === "cover" ? n = /* @__PURE__ */ E(L0, { bd: u }) : r === "line-items" ? n = /* @__PURE__ */ E(R0, { bd: u }) : r === "totals" && (n = /* @__PURE__ */ E(P0, { bd: u }))), r === "cover" && u?.vendor?.logo) {
    const l = /* @__PURE__ */ E(C0, { children: /* @__PURE__ */ E(N0, { url: u.vendor.logo, width: oe(4), align: "right" }) });
    se(t, "docx", l, { role: "header" });
  }
  if (n)
    return se(t, "docx", n), se(t, "html", n), /* @__PURE__ */ E("section", { className: `invoice-section invoice-${r}`, children: n });
  const { docxBody: s, previewJsx: i } = M0({ content: e, block: t });
...
function z0({ content: e, block: t }) {
  const { title: u, items: r, sequence: n } = e, s = Vr(), i = B0(n), l = i.filter((h) => h.type === "paragraph").map((h) => h.text), f = /* @__PURE__ */ S(Ie, { children: [
    u && /* @__PURE__ */ E(T0, { data: u, "data-spacing-after": 240 }),
    l.map((h, p) => /* @__PURE__ */ E(O, { data: h, "data-spacing-after": 120 }, `p${p}`)),
    r.map((h, p) => /* @__PURE__ */ S(dt, { children: [
      h.title && /* @__PURE__ */ E(b0, { data: h.title, "data-spacing-before": 200, "data-spacing-after": 120 }),
      h.paragraphs.map((g, N) => /* @__PURE__ */ E(O, { data: g, "data-spacing-after": 100 }, `${p}-${N}`))
    ] }, p))
...
function x0({ title: e = "Document", filename: t = "document" }) {
...
function k0({ body: e, page: t }) {
  ...
  return gt(() => $c(t), [t]), /* @__PURE__ */ S(gr, { basePath: u.basePath, children: [
    ...
    /* @__PURE__ */ E(x0, { title: r, filename: n })
  ] });
}
const w0 = { ...We, vars: Hs || We?.vars, layouts: { BusinessDocLayout: k0 } }, F0 = {}, H0 = {}, Q0 = { meta: F0, capabilities: w0, layoutMeta: H0 };
export {
  de as D,
  K0 as E,
  $0 as I,
...
//# sourceMappingURL=_entry.generated-Ds4uoo9f.js.map
