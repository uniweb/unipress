...
const Pn = new Set(cr.map((e) => e.join(" ").toUpperCase())), Bn = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
  ...
  "object",
  "tag"
]), Mn = /* @__PURE__ */ new Set([">=", "<=", "!=", "==", "&&", "||"]), xn = /* @__PURE__ */ new Set(["+", "-", "*", "/", "%", "=", "<", ">", "!"]), kn = /[a-zA-Z_@$?]/, wn = /[a-zA-Z0-9_.\/@]/, Rt = /[0-9]/;
function Fn(e) {
  return Hn(e);
}
function Hn(e) {
...
function rs(e) {
  ...
  const r = u[0], n = u[1];
  return n === "date" && Wn.has(r) ? { type: "date", value: r } : n === "only" && (r === "year" || r === "month") ? { type: "date", value: r === "year" ? "y" : "m" } : Bn.has(r) ? { type: r, value: n ?? null } : (n != null && e.i--, { type: r, value: null });
}
function as(e) {
...
const yr = /* @__PURE__ */ new Set([a.DD, a.DT, a.LI, a.OPTGROUP, a.OPTION, a.P, a.RB, a.RP, a.RT, a.RTC]), Mu = /* @__PURE__ */ new Set([
  ...yr,
  a.CAPTION,
  a.COLGROUP,
  a.TBODY,
...
function xi(e, t, u, r) {
  return (!r || r === _.HTML) && Mi(e, t, u) || (!r || r === _.MATHML) && Bi(e, t);
}
...
const Hi = {
  ...
  endCol: -1,
  endOffset: -1
}, Mr = /* @__PURE__ */ new Set([a.TABLE, a.TBODY, a.TFOOT, a.THEAD, a.TR]), Uu = {
  scriptingEnabled: !0,
...
function Bo(e, t) {
  e._reconstructActiveFormattingElements(), Br(t), nu(t), t.selfClosing ? e._appendElement(t, _.SVG) : e._insertElement(t, _.SVG), t.ackSelfClosing = !0;
}
function Yu(e, t) {
...
function bc(e, t) {
  if (Ri(t))
    ...
    r === _.MATHML ? Pr(t) : r === _.SVG && (Pi(t), Br(t)), nu(t), t.selfClosing ? e._appendElement(t, r) : e._insertElement(t, r), t.ackSelfClosing = !0;
  }
}
function pc(e, t) {
...
const Dc = {
  docx: { load: () => import("./docx-7OfHGLgh.js"), consumes: "docx", ir: !0 },
  ...
  epub: { load: () => import("./epub-Bvk_B2ph.js"), consumes: "html", ir: !1 }
};
function cu(e) {
  const t = Dc[e];
  return t ? {
...
function Rc(e, t) {
  ...
  return u.ir ? Pc(r, e) : u.consumes === "html" ? Bc(r, e) : Mc(r);
}
function Pc(e, t) {
...
async function Fc(e, t = {}) {
  ...
  const L = N.via ?? n, P = N.getOptions ? await N.getOptions(r, { format: n, rootPath: i, loadAsset: p, ...h }) : {}, k = {
    ...
    ...P.adapterOptions,
    ...l
  }, B = vc(r, i), C = globalThis.uniweb?.childBlockRenderer;
...
function y({
  ...
  const P = Ze(), k = je(n, P), B = Ys(i, P), C = g ?? N, R = { "data-type": "text" };
  return t && (R["data-bold"] = "true"), u && (R["data-italics"] = "true"), r && (R["data-underline"] = "true"), k && (R["data-color"] = k), s != null && (R["data-size"] = s), B && (R["data-font"] = B), l && (R["data-smallcaps"] = "true"), f && (R["data-allcaps"] = "true"), m && (R["data-strike"] = "true"), h && (R["data-subscript"] = "true"), p && (R["data-superscript"] = "true"), C && (R["data-style"] = C), /* @__PURE__ */ E("span", { ...R, ...L, children: d0(e) });
}
function f0(e) {
...
function G({
  ...
  const { widths: N, borderColor: L, theme: P } = At(ra), k = u ?? N?.[e], B = {
    "data-type": "tableCell",
  ...
  if (k != null && (B["data-width-size"] = k, B["data-width-type"] = "pct"), s) {
    ...
    tt && (B["data-shading-fill"] = tt), z.type && (B["data-shading-type"] = z.type), ut && (B["data-shading-color"] = ut);
  }
...
function $0({ content: e, block: t }) {
  ...
  const { docxBody: s, previewJsx: i } = B0({ content: e, block: t });
...
//# sourceMappingURL=_entry.generated-Dhn_Fiay.js.map
