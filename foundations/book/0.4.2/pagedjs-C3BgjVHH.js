import { M as m } from "./math-css-BVI-Y5gH.js";
...
function h({ body: e = "", meta: t = {}, stylesheet: r, polyfillUrl: o } = {}) {
  const n = t.language ?? "en", i = t.title ?? "Book", a = r || $, p = o || b;
  return `<!doctype html>
<html lang="${s(n)}">
  <head>
    <meta charset="utf-8" />
...
const b = "https://unpkg.com/pagedjs@0.4.3/dist/paged.polyfill.js", $ = `
...
`;
export {
  b as DEFAULT_POLYFILL_URL,
  $ as DEFAULT_STYLESHEET,
  w as compilePagedjs,
  h as emitDocument
};
//# sourceMappingURL=pagedjs-C3BgjVHH.js.map
