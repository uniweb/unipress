...
// The QUERY whose `queryable:` surface drives this panel. `queryable:` is
// declared on a query, not on a set of files — which is why kit's hook is
// `useQueryable` and this constant is no longer named for a collection.
const QUERY = 'members'
