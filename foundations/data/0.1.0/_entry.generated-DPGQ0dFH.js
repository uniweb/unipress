...
import C, { createContext as Vt, useContext as $t, useMemo as Fr, createElement as ai, Children as $r, isValidElement as Lt, cloneElement as Ue, useState as ft, useEffect as Et, useReducer as ZS, PureComponent as ir, forwardRef as RT, useRef as ii, useImperativeHandle as JS, useCallback as ex, Component as DT } from "react";
...
function Ln(e, t, r = {}) {
  ...
  function m(v, T) {
    if (i && v == "text") {
      const A = T.trim().split(MT);
      for (let b of A)
        b = ax(b), b !== "" && o.push({ type: v, value: b });
    } else
...
function LT(e, t = []) {
  ...
  const r = Ln(e, { "{": "}", "(": ")" }, { minQuoteLevel: 1 }), n = {};
  function a(i, o, u) {
  ...
  for (let i = 1; i < r.length; i += 2) {
    ...
    if (o.length < 3 || !o.startsWith("[") || !o.endsWith("]"))
      ...
      const c = o.slice(1, -1).trim().split(MT), l = c.shift(), f = c[0] === "$0";
...
function G0(e, t, r) {
  ...
  !t.type && typeof t.as == "string" && (t.type = t.as), t.lang ? t.locale = t.lang : (t.locale || (t.locale = oi(t.locale)), t.lang = UT(t.locale)), t._name = e;
...
function kn(e, t) {
  ...
  return t = Wx(r, a, t), e.title && Tr(t) && (t = $T(t, e.locale)), e.aux && (ke(t) && (t = t.join(e.sep || ", ")), t = Ap(e, t)), e.label && (ke(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = d2(e, t)), e.heading && (ke(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = f2(e, t)), e.wrap && (Mu(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Wx(e, t, r) {
  switch (e) {
    case "null":
...
function r2(e, t) {
  const r = e.date ? n2 : BT, n = e.desc ? -1 : 1;
...
function n2(e, t, r) {
  ...
  return mn(n) && mn(a) ? yr(n, "date").getTime() - yr(a, "date").getTime() : BT(e, t, r);
}
function BT(e, t, r) {
  let n = Po(t, e), a = Po(r, e);
  const i = Kt(n), o = Kt(a);
...
function yr(e, t, r = {}) {
  switch (t) {
    case "boolean":
      return !Tn(e);
    case "date":
      return mn(e) ? e instanceof Date || r.date === "auto" && o2(e) ? e : new Date(e.replace(/-/g, "/")) : null;
    case "text":
    case "string":
      return Tr(e) ? e : er(Kn(e));
    case "list":
      return ke(e) ? e : Dt(e) ? Kn(e) : null;
    case "object":
      return Dt(e) ? e : null;
    case "number":
...
function jT(e, t) {
  const r = [];
  for (let n of t)
    ke(n) ? n = jT(e, n) : Dt(n) && (n = FT(e, n)), Mu(n) || r.push(n);
...
class Yt extends st {
  ...
  format(t) {
    ...
    return t.type === "date" ? (n = n ? kn(t, n) : Q0(t.locale), a = a ? kn(t, a) : Q0(t.locale)) : t.type !== "range" && (n = kn(t, n || ""), a = kn(t, a || "")), n || a ? `${n}${r}${a}` : "";
  }
  isEmpty() {
...
class m2 extends st {
  ...
  format() {
    ...
    return [
      er({}, [
        " ",
        kn({ tag: "bold", type: "tag", bold: !0 }, Jt([t, ":"])),
        er({}, [
          " ",
          a,
          Jt(["(", new Yt({}, [f, h]), ")"])
...
const Z0 = /^[@]?[\$]?[\/]?[a-zA-Z_][a-zA-Z0-9_\/\.-]*$|^@$|^\?$/, E2 = /^-?\d+(\.\d+)?$/;
class T2 {
  /**
   ...
   */
  constructor(t = {}, r = {}) {
    this.snippets = LT(t), this.functions = r;
  }
  /**
  ...
  getVariableMeta(t) {
    ...
    return typeof r == "string" ? { label: r } : (r.label ??= $T(t.split("_").join(" ")), r);
  }
  /**
...
HT.sort((e, t) => t.length - e.length);
const _2 = new Set(HT.map((e) => e.join(" ").toUpperCase())), A2 = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
...
function Wd(e) {
  ...
  if (t && t.type === "lparen") {
    Fe(e);
    const r = YT(e);
    return WT(e, "rparen"), { type: "group", inner: r };
  }
  return J2(e);
}
...
function je(e) {
  switch (e.type) {
    ...
    case "forEach":
      return ow(e);
    default:
      throw new zT(`Unknown node type: ${e.type}`);
  }
}
function tw(e) {
...
function rw(e) {
  ...
  if (o && (o.type === "count" || o.type === "sum" || o.type === "average")) {
    ...
    if (u >= 0) {
      const s = e.modifiers[u], c = Co(o.value), l = je(Bn(s.condition, c));
      if (o.type === "count")
        a = `(++!! ${l})`;
      else if (o.type === "sum")
        a = `(++ (? ${l} ${je(o.value)}))`;
  ...
  for (let u = 0; u < e.modifiers.length; u++) {
    ...
    switch (s.type) {
      case "where": {
        a = `(? ${je(Bn(s.condition, t))} ${a})`;
        break;
      }
      case "sortedBy": {
        const c = sw(s.value);
        a = `(>> ${s.order === "desc" ? "-desc " : ""}-by=${c} ${a})`, n && (a = `(. ${qn(n)} ${a})`, n = null);
        break;
      }
      case "joinedBy":
        a = `(+: ${qn(s.sep)} ${a})`;
      ...
      case "as":
        ...
        break;
      case "withLabel": {
        a = `(# -label${s.label != null ? `=${qn(s.label)}` : ""} ${a})`;
        break;
      }
      default:
        throw new zT(`Unknown modifier type: ${s.type}`);
    }
  }
  return a;
}
...
function Bn(e, t) {
  ...
  switch (e.type) {
    ...
    case "unop":
      return { ...e, arg: Bn(e.arg, t) };
    case "group":
      return { ...e, inner: Bn(e.inner, t) };
    default:
      return e;
  }
}
...
function yw(e) {
  if (e == null) return null;
  if (typeof e == "number")
    return Number.isFinite(e) ? { tier: zd, value: e * KT } : null;
  if (typeof e == "string") {
    const t = e.trim();
    if (t === "") return null;
    const r = bw(t);
...
function bw(e) {
  ...
  return t ? parseInt(t[1], 10) * KT + parseInt(t[2] ?? "0", 10) * 100 + parseInt(t[3] ?? "0", 10) : null;
}
const gw = [
  {
    id: "bibliography",
...
function JT({
  ...
  ), /* @__PURE__ */ P(XT.Provider, { value: a, children: /* @__PURE__ */ P(om.Provider, { value: i, children: /* @__PURE__ */ P(Gd.Provider, { value: o, children: e }) }) });
}
function ct(e, t, r, n = {}) {
  const a = $t(XT);
  if (!a) {
...
class Cw {
  ...
  advance() {
    ...
    return t === S.CARRIAGE_RETURN ? (this.isEol = !0, this.skipNextNewLine = !0, S.LINE_FEED) : t === S.LINE_FEED && (this.isEol = !0, this.skipNextNewLine) ? (this.line--, this.skipNextNewLine = !1, this._addGap(), this.advance()) : (this.skipNextNewLine = !1, e_(t) && (t = this._processSurrogate(t)), this.handler.onParseError === null || t > 31 && t < 127 || t === S.LINE_FEED || t === S.CARRIAGE_RETURN || t > 159 && t < 64976 || this._checkForProblematicCharacters(t), t);
  }
  _checkForProblematicCharacters(t) {
    t_(t) ? this._err(U.controlCharacterInInputStream) : r_(t) && this._err(U.noncharacterInInputStream);
  }
  retreat(t) {
...
function cm(e) {
  return a_(e) || e === S.SOLIDUS || e === S.GREATER_THAN_SIGN;
}
function Ww(e) {
  return e === S.NULL ? U.nullCharacterReference : e > 1114111 ? U.characterReferenceOutsideUnicodeRange : e_(e) ? U.surrogateCharacterReference : r_(e) ? U.noncharacterCharacterReference : t_(e) || e === S.CARRIAGE_RETURN ? U.controlCharacterReference : null;
}
class Yw {
  constructor(t, r) {
  ...
  _leaveAttrName() {
    ...
    if (n_(n, this.currentAttr.name) === null) {
  ...
  _emitCodePoint(t) {
    const r = a_(t) ? be.WHITESPACE_CHARACTER : t === S.NULL ? be.NULL_CHARACTER : be.CHARACTER;
...
const i_ = /* @__PURE__ */ new Set([d.DD, d.DT, d.LI, d.OPTGROUP, d.OPTION, d.P, d.RB, d.RP, d.RT, d.RTC]), lm = /* @__PURE__ */ new Set([
  ...i_,
  d.CAPTION,
  d.COLGROUP,
  d.TBODY,
  ...
  d.TEMPLATE,
  d.TH
]), zw = /* @__PURE__ */ new Set([...Ro, d.OL, d.UL]), Gw = /* @__PURE__ */ new Set([...Ro, d.BUTTON]), fm = /* @__PURE__ */ new Set([d.ANNOTATION_XML, d.MI, d.MN, d.MO, d.MS, d.MTEXT]), dm = /* @__PURE__ */ new Set([d.DESC, d.FOREIGN_OBJECT, d.TITLE]), Kw = /* @__PURE__ */ new Set([d.TR, d.TEMPLATE, d.HTML]), Vw = /* @__PURE__ */ new Set([d.TBODY, d.TFOOT, d.THEAD, d.TEMPLATE, d.HTML]), Xw = /* @__PURE__ */ new Set([d.TABLE, d.TEMPLATE, d.HTML]), Qw = /* @__PURE__ */ new Set([d.TD, d.TH]);
class Zw {
  ...
  generateImpliedEndTags() {
    for (; this.currentTagId !== void 0 && i_.has(this.currentTagId); )
      this.pop();
  }
...
const Dr = {
...
}, o_ = "html", eP = "about:legacy-compat", tP = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", u_ = [
  ...
  "html"
]), s_ = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], aP = [
  ...s_,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function iP(e) {
  return e.name === o_ && e.publicId === null && (e.systemId === null || e.systemId === eP);
}
function oP(e) {
  if (e.name !== o_)
    return Nt.QUIRKS;
...
function hP(e) {
  const t = e.tagID;
  return t === d.FONT && e.attrs.some(({ name: n }) => n === ln.COLOR || n === ln.SIZE || n === ln.FACE) || dP.has(t);
}
function c_(e) {
...
const TP = {
  ...
  endCol: -1,
  endOffset: -1
}, f_ = /* @__PURE__ */ new Set([d.TABLE, d.TBODY, d.TFOOT, d.THEAD, d.TR]), ym = {
  scriptingEnabled: !0,
...
function AP(e, t) {
  ...
  return r ? e.openElements.contains(r.element) ? e.openElements.hasInScope(t.tagID) || (r = null) : (e.activeFormattingElements.removeEntry(r), r = null) : y_(e, t), r;
}
function OP(e, t) {
...
function m_(e) {
  const t = n_(e, ln.TYPE);
  return t != null && t.toLowerCase() === gP;
}
function rI(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, K.HTML), m_(t) || (e.framesetOk = !1), t.ackSelfClosing = !0;
}
function nI(e, t) {
  e._appendElement(t, K.HTML), t.ackSelfClosing = !0;
}
...
function iI(e, t) {
  t.tagName = L.IMG, t.tagID = d.IMG, p_(e, t);
}
function oI(e, t) {
...
function hI(e, t) {
  e._reconstructActiveFormattingElements(), c_(t), wp(t), t.selfClosing ? e._appendElement(t, K.MATHML) : e._insertElement(t, K.MATHML), t.ackSelfClosing = !0;
}
function pI(e, t) {
  e._reconstructActiveFormattingElements(), l_(t), wp(t), t.selfClosing ? e._appendElement(t, K.SVG) : e._insertElement(t, K.SVG), t.ackSelfClosing = !0;
}
function gm(e, t) {
...
function yI(e, t) {
  e.openElements.hasInScope(d.BODY) && (e.insertionMode = w.AFTER_BODY, S_(e, t));
}
function bI(e, t) {
  const r = t.tagID;
...
function b_(e, t) {
  e.tmplInsertionModeStack.length > 0 ? O_(e, t) : Ip(e, t);
}
function SI(e, t) {
  var r;
...
function Ds(e, t) {
  if (e.openElements.currentTagId !== void 0 && f_.has(e.openElements.currentTagId))
...
function DI(e, t) {
  m_(t) ? e._appendElement(t, K.HTML) : Wi(e, t), t.ackSelfClosing = !0;
}
function MI(e, t) {
...
const E_ = /* @__PURE__ */ new Set([d.CAPTION, d.COL, d.COLGROUP, d.TBODY, d.TD, d.TFOOT, d.TH, d.THEAD, d.TR]);
function LI(e, t) {
  const r = t.tagID;
  E_.has(r) ? e.openElements.hasInTableScope(d.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(d.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = w.IN_TABLE, Vn(e, t)) : lt(e, t);
}
function kI(e, t) {
  const r = t.tagID;
  switch (r) {
...
function jI(e, t) {
  const r = t.tagID;
  E_.has(r) ? (e.openElements.hasInTableScope(d.TD) || e.openElements.hasInTableScope(d.TH)) && (e._closeTableCell(), Fu(e, t)) : lt(e, t);
}
function FI(e, t) {
  const r = t.tagID;
  switch (r) {
    ...
    case d.THEAD:
    case d.TR: {
      e.openElements.hasInTableScope(r) && (e._closeTableCell(), T_(e, t));
      break;
    }
    case d.BODY:
    case d.CAPTION:
...
function $I(e, t) {
  const r = t.tagID;
  r === d.CAPTION || r === d.TABLE || r === d.TBODY || r === d.TFOOT || r === d.THEAD || r === d.TR || r === d.TD || r === d.TH ? (e.openElements.popUntilTagNamePopped(d.SELECT), e._resetInsertionMode(), e._processStartTag(t)) : __(e, t);
}
function UI(e, t) {
  const r = t.tagID;
  r === d.CAPTION || r === d.TABLE || r === d.TBODY || r === d.TFOOT || r === d.THEAD || r === d.TR || r === d.TD || r === d.TH ? e.openElements.hasInTableScope(r) && (e.openElements.popUntilTagNamePopped(d.SELECT), e._resetInsertionMode(), e.onEndTag(t)) : A_(e, t);
}
function HI(e, t) {
  switch (t.tagID) {
...
function JI(e, t) {
  if (hP(t))
    x_(e), e._startTagOutsideForeignContent(t);
  else {
    const r = e._getAdjustedCurrentElement(), n = e.treeAdapter.getNamespaceURI(r);
    n === K.MATHML ? c_(t) : n === K.SVG && (pP(t), l_(t)), wp(t), t.selfClosing ? e._appendElement(t, n) : e._insertElement(t, n), t.ackSelfClosing = !0;
  }
}
function eC(e, t) {
  if (t.tagID === d.P || t.tagID === d.BR) {
    x_(e), e._endTagOutsideForeignContent(t);
    return;
  }
...
const lC = {
  docx: { load: () => import("./docx-CU-D0Ner.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-hXHqL117.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-C0u92AlS.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-LK4PynqI.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-Ba3mduKx.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = lC[e];
  return t ? {
...
function bC(e, t, r = {}) {
  const { basePath: n, theme: a } = r, i = ZT();
  return Tp(
    ai(
      JT,
...
async function vC(e, t = {}) {
  ...
  const g = p.via ?? a, y = p.getOptions ? await p.getOptions(n, { format: a, rootPath: o, loadAsset: f, ...l }) : {}, m = {
    ...
    ...y.adapterOptions,
    ...u
  }, E = _C(n, o), v = globalThis.uniweb?.childBlockRenderer;
  ...
  const t = (n, a) => ({
    ...
    n.replace(i, (c, l, f, h, p) => {
      ...
      if (l === "span" && f && Ra(f, "data-type") === "math") {
        const E = Ra(f, "data-latex") || "", v = Ra(f, "data-display") === "true", T = Ra(f, "data-id");
        o.push({
          type: "math",
          latex: E,
          display: v,
...
function Rp({
  ...
  const y = QT(), m = ui(a, y), E = Ow(o, y), v = h ?? p, T = { "data-type": "text" };
  return t && (T["data-bold"] = "true"), r && (T["data-italics"] = "true"), n && (T["data-underline"] = "true"), m && (T["data-color"] = m), i != null && (T["data-size"] = i), E && (T["data-font"] = E), u && (T["data-smallcaps"] = "true"), s && (T["data-allcaps"] = "true"), c && (T["data-strike"] = "true"), l && (T["data-subscript"] = "true"), f && (T["data-superscript"] = "true"), v && (T["data-style"] = v), /* @__PURE__ */ P("span", { ...T, ...g, children: SC(e) });
}
function xC(e) {
  return e.parts?.length ? e.parts : [{ content: e.content }];
}
function wC({ part: e }) {
  const t = e.href || "", r = t.startsWith("#") ? t.slice(1) : null;
  return /* @__PURE__ */ P("a", { ...r ? { "data-type": "internalHyperlink", "data-anchor": r } : { "data-type": "externalHyperlink", "data-link": t }, href: t, children: xC(e).map((a, i) => /* @__PURE__ */ P(
    Rp,
    {
      style: "Hyperlink",
      bold: a.bold,
...
function Bt({
  ...
  const u = IC({ tabStops: r, indent: n, role: a });
  if (t) {
    const s = OC(t);
    return /* @__PURE__ */ P(e, { "data-type": "paragraph", ...u, ...o, children: s.map((c, l) => c.type === "link" ? /* @__PURE__ */ P(wC, { part: c }, l) : c.type === "math" ? /* @__PURE__ */ P(
      PC,
      {
        latex: c.latex,
        display: c.display,
...
function he({
  ...
  const { widths: p, borderColor: g, theme: y } = $t(w_), m = r ?? p?.[e], E = {
    "data-type": "tableCell",
  ...
  if (m != null && (E["data-width-size"] = m, E["data-width-type"] = "pct"), i) {
    const b = typeof i == "string" ? { fill: i } : i, _ = ui(b.fill, y), O = ui(b.color, y);
...
function RC(e) {
  ...
  return NC.some((r) => t.includes(r));
}
const DC = /(<a\b[^>]*?\shref=)(["'])([^"']*)\2/gi, MC = /^(?:[a-z][a-z0-9+.-]*:|\/\/|#)/i;
function LC(e, t) {
...
function BC(e, t, { locale: r = !0 } = {}) {
  if (!e || typeof e != "string" || !t) return e;
  let n = e;
  return (e.startsWith("page:") || e.startsWith("topic:")) && (n = t.makeHref ? t.makeHref(e) : e), MC.test(n) || r && n.startsWith("/") && !RC(n) && (n = kC(n, t)), n;
}
function jC(e, t) {
  return !e || typeof e != "string" || !t ? e : LC(BC(e, t), t.basePath || "");
}
function FC(e, t) {
  ...
  return !r && !t.basePath && !n ? e : e.replace(DC, (a, i, o, u) => {
    const s = jC(u, t);
    return s === u ? a : `${i}${o}${s}${o}`;
  });
}
function $C({ value: e, className: t, as: r = "div", ...n }) {
...
function fn(e, t) {
  const { website: r } = $u(), [, n] = ZS(HC, 0), i = r.activePage?.state;
  Et(() => {
    if (i)
...
const C_ = "academic-metrics/options", Dp = "all-members", N_ = Dp, qC = [
  "members",
...
function VC(e) {
  ...
  const r = () => KC(e), n = wm.map((a) => e.state.subscribe(a, r));
...
function RH({ content: e, block: t }) {
  ...
  return ct(t, "xlsx", {
    ...
    /* @__PURE__ */ ee("div", { className: "cover-meta", role: "list", children: [
      ...
      /* @__PURE__ */ P(oo, { label: "Funding", value: ZC(s) }),
...
function xr() {
  if (Mm) return $s;
  Mm = 1;
  var e = zi(), t = JC(), r = eN(), n = "[object Null]", a = "[object Undefined]", i = e ? e.toStringTag : void 0;
  function o(u) {
...
function nN() {
  if (qm) return Vs;
  qm = 1;
  var e = Bp(), t = rN(), r = Gr(), n = D_(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, u = Object.prototype, s = o.toString, c = u.hasOwnProperty, l = RegExp(
...
function AN() {
  if (gy) return Oc;
  gy = 1;
  var e = _N(), t = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, n = e(function(a) {
    var i = [];
...
function ON() {
  if (Ey) return xc;
  Ey = 1;
  var e = zi(), t = Up(), r = Tt(), n = _a(), a = e ? e.prototype : void 0, i = a ? a.toString : void 0;
  function o(u) {
    if (typeof u == "string")
      return u;
    if (r(u))
...
var IN = PN();
const yn = /* @__PURE__ */ xe(IN);
var CN = Bp();
const de = /* @__PURE__ */ xe(CN);
var NN = Gr();
const Aa = /* @__PURE__ */ xe(NN);
var so = { exports: {} }, ve = {};
var Py;
function RN() {
  if (Py) return ve;
...
var Cy;
function MN() {
  return Cy || (Cy = 1, process.env.NODE_ENV === "production" ? so.exports = RN() : so.exports = DN()), so.exports;
}
var LN = MN(), Mc, Ny;
function j_() {
  if (Ny) return Mc;
...
var BN = kN();
const Gi = /* @__PURE__ */ xe(BN);
var jN = j_();
const FN = /* @__PURE__ */ xe(jN);
var dt = function(t) {
...
var WN = ["viewBox", "children"], YN = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    qp.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = zN(o, r, n));
  }), a;
}, GN = ["children"], KN = ["children"];
function My(e, t) {
  if (e == null) return {};
  var r = VN(e, t), n, a;
...
}, ky = null, Bc = null, Wp = function e(t) {
  if (t === ky && Array.isArray(Bc))
    return Bc;
  var r = [];
  return $r.forEach(t, function(n) {
    me(n) || (LN.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), Bc = r, ky = t, r;
};
function jt(e, t) {
  var r = [], n = [];
...
var By = function(t) {
...
}, XN = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], QN = function(t) {
  return t && t.type && yn(t.type) && XN.indexOf(t.type) >= 0;
}, ZN = function(t, r, n, a) {
  var i, o = (i = kc?.[a]) !== null && i !== void 0 ? i : [];
  return r.startsWith("data-") || !de(t) && (a && o.includes(r) || YN.includes(r)) || n && qp.includes(r);
}, le = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  return Object.keys(a).forEach(function(o) {
    var u;
    ZN((u = a) === null || u === void 0 ? void 0 : u[o], o, r, n) && (i[o] = a[o]);
  }), i;
}, th = function e(t, r) {
  if (t === r)
    return !0;
  ...
  if (me(t) && me(r))
    return !0;
  if (!me(t) && !me(r)) {
    var n = t.props || {}, a = n.children, i = My(n, GN), o = r.props || {}, u = o.children, s = My(o, KN);
    return a && u ? Wn(i, s) && th(a, u) : !a && !u ? Wn(i, s) : !1;
  }
  return !1;
}, Fy = function(t, r) {
  var n = [], a = {};
...
}, t3 = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function rh() {
...
function nh(e) {
  var t = e.children, r = e.width, n = e.height, a = e.viewBox, i = e.className, o = e.style, u = e.title, s = e.desc, c = r3(e, t3), l = a || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
var Oe = /* @__PURE__ */ C.forwardRef(function(e, t) {
  var r = e.children, n = e.className, a = i3(e, a3), i = pe("recharts-layer", n);
  return /* @__PURE__ */ C.createElement("g", ah({
    className: i
  }, le(a, !0), {
    ref: t
  }), r);
}), u3 = process.env.NODE_ENV !== "production", zt = function(t, r) {
  for (var n = arguments.length, a = new Array(n > 2 ? n - 2 : 0), i = 2; i < n; i++)
    a[i - 2] = arguments[i];
  if (u3 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
...
function p3() {
  if (Gy) return Yc;
  Gy = 1;
  var e = h3(), t = e("toUpperCase");
  return Yc = t, Yc;
}
var m3 = p3();
const zu = /* @__PURE__ */ xe(m3);
function Ce(e) {
  return function() {
    return e;
  };
}
const $_ = Math.cos, ko = Math.sin, Qt = Math.sqrt, Bo = Math.PI, Gu = 2 * Bo, ih = Math.PI, oh = 2 * ih, rn = 1e-6, y3 = oh - rn;
function U_(e) {
  this._ += e[0];
...
class g3 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? U_ : b3(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${l}` : (Math.abs(this._x1 - c) > rn || Math.abs(this._y1 - l) > rn) && this._append`L${c},${l}`, n && (h < 0 && (h = h % oh + oh), h > y3 ? this._append`A${n},${n},0,1,${f},${t - u},${r - s}A${n},${n},0,1,${f},${this._x1 = c},${this._y1 = l}` : h > rn && this._append`A${n},${n},0,${+(h >= ih)},${f},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
function Y_(e, t) {
  var r = Ce(!0), n = null, a = Ku, i = null, o = Yp(u);
...
function co(e, t, r) {
  var n = null, a = Ce(!0), i = null, o = Ku, u = null, s = Yp(c);
...
}, G_ = Qt(1 / 3), _3 = G_ * 2, A3 = {
  draw(e, t) {
    const r = Qt(t / _3), n = r * G_;
...
}, S3 = 0.8908130915292852, K_ = ko(Bo / 10) / ko(7 * Bo / 10), x3 = ko(Gu / 10) * K_, w3 = -$_(Gu / 10) * K_, P3 = {
  draw(e, t) {
    const r = Qt(t * S3), n = x3 * r, a = w3 * r;
...
}, Pt = -0.5, It = Qt(3) / 2, uh = 1 / Qt(12), C3 = (uh / 2 + 1) * 3, N3 = {
  draw(e, t) {
    const r = Qt(t / C3), n = r / 2, a = r * uh, i = n, o = r * uh + r, u = -i, s = o;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Gc(this, this._t0, Xy(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, Gc(this, Xy(this, r = Vy(this, e, t)), r);
          break;
        default:
          Gc(this, this._t0, r = Vy(this, e, t));
          break;
      }
...
function Y3() {
  var e = Ce([]), t = sh, r = Xn, n = q3;
  function a(i) {
    var o = Array.from(e.apply(this, arguments), W3), u, s = o.length, c = -1, l;
    for (const f of i)
      for (u = 0, ++c; u < s; ++u)
...
var rA = {
  ...
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, u = o === void 0 ? "area" : o, s = J3(t, V3), c = Jy(Jy({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), l = function() {
    var m = rR(n), E = R3().type(m).size(nR(i, u, n));
    return E();
...
function cR(e, t, r) {
  return t = Uo(t), lR(e, nA() ? Reflect.construct(t, r || [], Uo(e).constructor) : t.apply(e, r));
}
function lR(e, t) {
...
var Ct = 32, Vp = /* @__PURE__ */ (function(e) {
  function t() {
    return oR(this, t), cR(this, t, arguments);
  }
  return dR(t, e), sR(t, [{
    key: "renderIcon",
    value: (
...
function iA() {
  if (ob) return Jc;
  ob = 1;
  var e = qu(), t = pR(), r = mR(), n = yR(), a = bR(), i = gR();
  function o(u) {
...
function AR() {
  if (yb) return cl;
  yb = 1;
  var e = zi(), t = TR(), r = jp(), n = cA(), a = _R(), i = Xp(), o = 1, u = 2, s = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", h = "[object Number]", p = "[object RegExp]", g = "[object Set]", y = "[object String]", m = "[object Symbol]", E = "[object ArrayBuffer]", v = "[object DataView]", T = e ? e.prototype : void 0, A = T ? T.valueOf : void 0;
...
function wR() {
  if (Tb) return pl;
  Tb = 1;
  var e = SR(), t = xR(), r = Object.prototype, n = r.propertyIsEnumerable, a = Object.getOwnPropertySymbols, i = a ? function(o) {
...
function Qp() {
  if (Ob) return bl;
  Ob = 1;
  var e = IR(), t = wr(), r = Object.prototype, n = r.hasOwnProperty, a = r.propertyIsEnumerable, i = e(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? e : function(o) {
...
function fA() {
  return xb || (xb = 1, (function(e, t) {
    var r = or(), n = CR(), a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, o = i && i.exports === a, u = o ? r.Buffer : void 0, s = u ? u.isBuffer : void 0, c = s || n;
    e.exports = c;
...
function hA() {
  if (Rb) return Al;
  Rb = 1;
  var e = NR(), t = dA(), r = RR(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return Al = a, Al;
}
var Ol, Db;
function DR() {
  if (Db) return Ol;
  Db = 1;
  var e = PR(), t = Qp(), r = Tt(), n = fA(), a = Zp(), i = hA(), o = Object.prototype, u = o.hasOwnProperty;
  function s(c, l) {
...
function kR() {
  if (Bb) return Pl;
  Bb = 1;
  var e = MR(), t = LR(), r = Object.prototype, n = r.hasOwnProperty;
  function a(i) {
    if (!e(i))
      return t(i);
    var o = [];
...
function jR() {
  if (Ub) return Rl;
  Ub = 1;
  var e = BR(), t = 1, r = Object.prototype, n = r.hasOwnProperty;
...
function HR() {
  if (zb) return Bl;
  zb = 1;
  var e = FR(), t = Fp(), r = $R(), n = mA(), a = UR(), i = xr(), o = D_(), u = "[object Map]", s = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", h = "[object DataView]", p = o(e), g = o(t), y = o(r), m = o(n), E = o(a), v = i;
...
function qR() {
  if (Gb) return jl;
  Gb = 1;
  var e = iA(), t = cA(), r = AR(), n = jR(), a = HR(), i = Tt(), o = fA(), u = hA(), s = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", h = Object.prototype, p = h.hasOwnProperty;
...
function KR() {
  if (tg) return zl;
  tg = 1;
  var e = k_(), t = Qp(), r = Tt(), n = Zp(), a = Jp(), i = Yu();
  function o(u, s, c) {
    s = e(s, u);
...
function XR() {
  if (ng) return Kl;
  ng = 1;
  var e = e0(), t = B_(), r = VR(), n = kp(), a = yA(), i = bA(), o = Yu(), u = 1, s = 2;
  function c(l, f) {
...
function oD() {
  if (yg) return sf;
  yg = 1;
  var e = mA(), t = iD(), r = Xp(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return sf = a, sf;
}
...
function uD() {
  if (bg) return cf;
  bg = 1;
  var e = oA(), t = nD(), r = aD(), n = sA(), a = oD(), i = Xp(), o = 200;
  function u(s, c, l) {
...
function hD(e, t, r) {
  return t = Ho(t), pD(e, EA() ? Reflect.construct(t, r || [], Ho(e).constructor) : t.apply(e, r));
}
function pD(e, t) {
...
var _g = 1, Hr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = hD(this, t, [].concat(a)), Qu(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
...
function _D() {
  if (Ag) return ff;
  Ag = 1;
  var e = zi(), t = Qp(), r = Tt(), n = e ? e.isConcatSpreadable : void 0;
  function a(i) {
...
function ID() {
  if (Mg) return _f;
  Mg = 1;
  var e = Up(), t = Hp(), r = ur(), n = OA(), a = xD(), i = dA(), o = PD(), u = Oa(), s = Tt();
  function c(l, f, h) {
...
function DD() {
  if (Fg) return wf;
  Fg = 1;
  var e = RD(), t = SA(), r = Oa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function BD() {
  if (Wg) return Rf;
  Wg = 1;
  var e = _A(), t = ID(), r = kD(), n = Zu(), a = r(function(i, o) {
    if (i == null)
      return [];
    var u = o.length;
    ...
    if (l && l.length) {
      var R = {
        ...
        var q = Df({
          ...
          paddingBottom: 4,
          color: F.color || "#000"
        }, u), Y = F.formatter || f || GD, Q = F.value, te = F.name, k = Q, W = te;
        if (Y && k != null && W != null) {
          var z = Y(Q, te, F, $, l);
          if (Array.isArray(z)) {
            var Z = FD(z, 2);
...
var Da = "recharts-tooltip-wrapper", QD = {
  visibility: "hidden"
};
function ZD(e) {
...
function a6(e, t, r) {
  return t = qo(t), i6(e, xA() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function i6(e, t) {
...
var Xg = 1, c6 = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    t6(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = a6(this, t, [].concat(a)), mh(r, "state", {
      dismissed: !1,
  ...
  return u6(t, e), n6(t, [{
    ...
    key: "render",
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, u = a.animationDuration, s = a.animationEasing, c = a.children, l = a.coordinate, f = a.hasPayload, h = a.isAnimationActive, p = a.offset, g = a.position, y = a.reverseDirection, m = a.useTranslate3d, E = a.viewBox, v = a.wrapperStyle, T = e6({
...
function h6(e, t, r) {
  return t && d6(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function p6(e, t, r) {
  return t = Wo(t), m6(e, PA() ? Reflect.construct(t, r || [], Wo(e).constructor) : t.apply(e, r));
}
function m6(e, t) {
...
function E6(e, t) {
  return /* @__PURE__ */ C.isValidElement(e) ? /* @__PURE__ */ C.cloneElement(e, t) : typeof e == "function" ? /* @__PURE__ */ C.createElement(e, t) : /* @__PURE__ */ C.createElement(KD, t);
}
var yt = /* @__PURE__ */ (function(e) {
  function t() {
    return f6(this, t), p6(this, t, arguments);
  }
  return b6(t, e), h6(t, [{
    key: "render",
    value: function() {
...
function CA() {
  if (rv) return Bf;
  rv = 1;
  var e = A6(), t = Gr(), r = _a(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, u = parseInt;
  function s(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function O6() {
  if (nv) return jf;
  nv = 1;
  var e = Gr(), t = T6(), r = CA(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(u, s, c) {
...
function S6() {
  if (av) return Ff;
  av = 1;
  var e = O6(), t = Gr(), r = "Expected a function";
  function n(a, i, o) {
    var u = !0, s = !0;
...
var Xi = /* @__PURE__ */ RT(function(e, t) {
  var r = e.aspect, n = e.initialDimension, a = n === void 0 ? {
    width: -1,
    height: -1
  } : n, i = e.width, o = i === void 0 ? "100%" : i, u = e.height, s = u === void 0 ? "100%" : u, c = e.minWidth, l = c === void 0 ? 0 : c, f = e.minHeight, h = e.maxHeight, p = e.children, g = e.debounce, y = g === void 0 ? 0 : g, m = e.id, E = e.className, v = e.onResize, T = e.style, A = T === void 0 ? {} : T, b = ii(null), _ = ii();
  _.current = v, JS(t, function() {
  ...
  }), I = C6(O, 2), N = I[0], j = I[1], D = ex(function(B, F) {
    j(function($) {
...
var Za = function(t) {
  ...
  try {
    ...
    return Nn.widthCache[a] = s, ++Nn.cacheCount > j6 && (Nn.cacheCount = 0, Nn.widthCache = {}), s;
  } catch {
    return {
      width: 0,
      height: 0
...
function lv(e, t) {
  for (var r = 0; r < t.length; r++) {
    var n = t[r];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, K6(n.key), n);
  }
}
function G6(e, t, r) {
...
var fv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, dv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, X6 = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, Q6 = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, RA = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, Z6 = Object.keys(RA), jn = "NaN";
function J6(e, t) {
  return e * RA[t];
}
var ho = /* @__PURE__ */ (function() {
  function e(t, r) {
    z6(this, e), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !X6.test(r) && (this.num = NaN, this.unit = ""), Z6.includes(r) && (this.num = J6(t, r), this.unit = "px");
  }
  return G6(e, [{
    key: "add",
    value: function(r) {
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = Q6.exec(r)) !== null && n !== void 0 ? n : [], i = Yo(a, 3), o = i[1], u = i[2];
...
function DA(e) {
  ...
  for (var t = e; t.includes("*") || t.includes("/"); ) {
    var r, n = (r = fv.exec(t)) !== null && r !== void 0 ? r : [], a = Yo(n, 4), i = a[1], o = a[2], u = a[3], s = ho.parse(i ?? ""), c = ho.parse(u ?? ""), l = o === "*" ? s.multiply(c) : s.divide(c);
    if (l.isNaN())
      return jn;
    t = t.replace(fv, l.toString());
  }
  for (; t.includes("+") || /.-\d+(?:\.\d+)?/.test(t); ) {
    var f, h = (f = dv.exec(t)) !== null && f !== void 0 ? f : [], p = Yo(h, 4), g = p[1], y = p[2], m = p[3], E = ho.parse(g ?? ""), v = ho.parse(m ?? ""), T = y === "+" ? E.add(v) : E.subtract(v);
    if (T.isNaN())
      return jn;
...
function eM(e) {
  for (var t = e; t.includes("("); ) {
    var r = hv.exec(t), n = Yo(r, 2), a = n[1];
    t = t.replace(hv, DA(a));
  }
  return t;
}
...
function $f(e) {
  var t = rM(e.slice(5, -1));
  return t === jn ? "" : t;
}
var nM = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], aM = ["dx", "dy", "angle", "className", "breakAll"];
function gh() {
...
var MA = /[ \f\n\r\t\v\u2028\u2029]+/, LA = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, l = t.scaleToFit, f = l === void 0 ? !1 : l, h = t.textAnchor, p = h === void 0 ? "start" : h, g = t.verticalAnchor, y = g === void 0 ? "end" : g, m = t.fill, E = m === void 0 ? gv : m, v = pv(t, nM), T = Fr(function() {
    return fM({
      breakAll: v.breakAll,
      children: v.children,
      maxLines: v.maxLines,
  ...
  }, [v.breakAll, v.children, v.maxLines, f, v.style, v.width]), A = v.dx, b = v.dy, _ = v.angle, O = v.className, I = v.breakAll, N = pv(v, aM);
  if (!ze(n) || !ze(i))
    return null;
  ...
  switch (y) {
    case "start":
      ...
      break;
    case "middle":
      R = $f("calc(".concat((T.length - 1) / 2, " * -").concat(u, " + (").concat(c, " / 2))"));
      break;
    default:
      R = $f("calc(".concat(T.length - 1, " * -").concat(u, ")"));
      break;
  }
  var B = [];
  if (f) {
...
function a0(e) {
  let t, r, n;
  e.length !== 2 ? (t = qr, r = (u, s) => qr(e(u), s), n = (u, s) => e(u) - s) : (t = e === qr || e === dM ? e : hM, r = e, n = e);
...
class vv extends Map {
  ...
  set(t, r) {
    return super.set(yM(this, t), r);
  }
  delete(t) {
    return super.delete(bM(this, t));
  }
}
...
function yM({ _intern: e, _key: t }, r) {
  const n = t(r);
  return e.has(n) ? e.get(n) : (e.set(n, r), r);
}
function bM({ _intern: e, _key: t }, r) {
  const n = t(r);
...
const EM = Math.sqrt(50), TM = Math.sqrt(10), _M = Math.sqrt(2);
function zo(e, t, r) {
  const n = (t - e) / Math.max(0, r), a = Math.floor(Math.log10(n)), i = n / Math.pow(10, a), o = i >= EM ? 10 : i >= TM ? 5 : i >= _M ? 2 : 1;
  let u, s, c;
...
function AM(e, t, r) {
  if (e = Float64Array.from(pM(e)), !(!(n = e.length) || isNaN(t = +t))) {
    if (t <= 0 || n < 2) return _v(e);
    if (t >= 1) return Tv(e);
    var n, a = (n - 1) * t, i = Math.floor(a), o = Tv(jA(e, i).subarray(0, i + 1)), u = _v(e.subarray(i + 1));
    return o + (u - o) * (a - i);
  }
}
function OM(e, t, r = kA) {
...
var bi = 0.7, Go = 1 / bi, Yn = "\\s*([+-]?\\d+)\\s*", gi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", xM = /^#([0-9a-f]{3,8})$/, wM = new RegExp(`^rgb\\(${Yn},${Yn},${Yn}\\)$`), PM = new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`), IM = new RegExp(`^rgba\\(${Yn},${Yn},${Yn},${gi}\\)$`), CM = new RegExp(`^rgba\\(${rr},${rr},${rr},${gi}\\)$`), NM = new RegExp(`^hsl\\(${gi},${rr},${rr}\\)$`), RM = new RegExp(`^hsla\\(${gi},${rr},${rr},${gi}\\)$`), Av = {
  aliceblue: 15792383,
...
function vi(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = xM.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? xv(t) : r === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? po(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? po(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = wM.exec(e)) ? new gt(t[1], t[2], t[3], 1) : (t = PM.exec(e)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = IM.exec(e)) ? po(t[1], t[2], t[3], t[4]) : (t = CM.exec(e)) ? po(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = NM.exec(e)) ? Iv(t[1], t[2] / 100, t[3] / 100, 1) : (t = RM.exec(e)) ? Iv(t[1], t[2] / 100, t[3] / 100, t[4]) : Av.hasOwnProperty(e) ? xv(Av[e]) : e === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function xv(e) {
...
function Ah(e, t, r, n) {
  return arguments.length === 1 ? LM(e) : new gt(e, t, r, n ?? 1);
}
function gt(e, t, r, n) {
...
o0(gt, Ah, $A(Zi, {
  ...
  clamp() {
    return new gt(dn(this.r), dn(this.g), dn(this.b), Ko(this.opacity));
  },
  displayable() {
...
o0(Wt, BM, $A(Zi, {
  ...
  clamp() {
    return new Wt(Cv(this.h), mo(this.s), mo(this.l), Ko(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Ko(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${Cv(this.h)}, ${mo(this.s) * 100}%, ${mo(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function Cv(e) {
...
function $M(e) {
  return (e = +e) == 1 ? HA : function(t, r) {
    return r - t ? FM(t, r, e) : u0(isNaN(t) ? r : t);
  };
}
function HA(e, t) {
  var r = t - e;
  return r ? jM(e, r) : u0(isNaN(e) ? t : e);
}
...
function KM(e, t) {
  ...
  return r < t.length && (i = t.slice(r), u[o] ? u[o] += i : u[++o] = i), u.length < 2 ? s[0] ? GM(s[0].x) : zM(t) : (t = s.length, function(c) {
...
function xa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? u0(t) : (r === "number" ? Vo : r === "string" ? (n = vi(t)) ? (t = n, Nv) : KM : t instanceof vi ? Nv : t instanceof Date ? WM : HM(t) ? UM : Array.isArray(t) ? qM : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? YM : Vo)(e, t);
}
function s0(e, t) {
  return e = +e, t = +t, function(r) {
...
function es() {
  var e = Rv, t = Rv, r = xa, n, a, i, o = pt, u, s, c;
  function l() {
    var h = Math.min(e.length, t.length);
    return o !== pt && (o = QM(e[0], e[h - 1])), u = h > 2 ? JM : ZM, s = c = null, f;
  }
  function f(h) {
...
var nL = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function Ei(e) {
  if (!(t = nL.exec(e))) throw new Error("invalid format: " + e);
  var t;
  return new l0({
    fill: t[1],
    align: t[2],
...
function oL(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? Lv : tL(kv.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? Lv : rL(kv.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", u = e.minus === void 0 ? "−" : e.minus + "", s = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f, h) {
    f = Ei(f);
    ...
    function D(R) {
      ...
      if (_ === "c")
        ...
        R = +R;
        var Q = R < 0 || 1 / R < 0;
        if (R = isNaN(R) ? s : N(Math.abs(R), A), b && (R = aL(R)), Q && +R == 0 && y !== "+" && (Q = !1), B = (Q ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + B, F = (_ === "s" && !isNaN(R) && Zo !== void 0 ? Bv[8 + Zo / 3] : "") + F + (Q && y === "(" ? ")" : ""), j) {
          for ($ = -1, q = R.length; ++$ < q; )
  ...
  function l(f, h) {
    var p = Math.max(-8, Math.min(8, Math.floor(ta(h) / 3))) * 3, g = Math.pow(10, -p), y = c((f = Ei(f), f.type = "f", f), { suffix: Bv[8 + p / 3] });
    return function(m) {
      return y(g * m);
    };
  }
...
function uL(e) {
  return yo = oL(e), f0 = yo.format, qA = yo.formatPrefix, yo;
}
function sL(e) {
...
function WA(e, t, r, n) {
  ...
  switch (n = Ei(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = cL(a, o)) && (n.precision = i), qA(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(i = lL(a, Math.max(Math.abs(e), Math.abs(t)))) && (n.precision = i - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
      n.precision == null && !isNaN(i = sL(a)) && (n.precision = i - (n.type === "%") * 2);
      break;
    }
  }
  return f0(n);
...
function pL(e) {
  return e === 10 ? hL : e === Math.E ? Math.exp : (t) => Math.pow(e, t);
}
function mL(e) {
...
function d0(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = mL(n), i = pL(n), r()[0] < 0 ? (a = $v(a), i = $v(i), e(fL, dL)) : e(jv, Fv), t;
  }
  return t.base = function(u) {
    ...
    if (u == null && (u = 10), s == null && (s = n === 10 ? "s" : ","), typeof s != "function" && (!(n % 1) && (s = Ei(s)).precision == null && (s.trim = !0), s = f0(s)), u === 1 / 0) return s;
...
function p0(e) {
  var t = e(pt, pt), r = 1;
  function n() {
    return r === 1 ? e(pt, pt) : r === 0.5 ? e(yL, bL) : e(qv(r), qv(1 / r));
  }
...
function m0() {
  var e = p0(es());
  return e.copy = function() {
    return Ji(e, m0()).exponent(e.exponent());
...
function VA() {
  ...
  return a.invert = function(i) {
    ...
    return arguments.length ? (e.range((t = Array.from(i, Xo)).map(Wv)), a) : t.slice();
...
function XA() {
  ...
  function a() {
    ...
    for (r = new Array(u - 1); ++o < u; ) r[o - 1] = OM(e, o / u);
    return i;
  }
  function i(o) {
...
eu.range;
const hr = 1e3, Mt = hr * 60, pr = Mt * 60, _r = pr * 24, y0 = _r * 7, Yv = _r * 30, Yf = _r * 365, sn = Ke((e) => {
...
const rs = Sn(0), tu = Sn(1), EL = Sn(2), TL = Sn(3), ra = Sn(4), _L = Sn(5), AL = Sn(6);
rs.range;
tu.range;
EL.range;
TL.range;
...
const ns = xn(0), ru = xn(1), OL = xn(2), SL = xn(3), na = xn(4), xL = xn(5), wL = xn(6);
ns.range;
ru.range;
OL.range;
SL.range;
...
const [PL, IL] = eO(Or, _0, ns, JA, E0, g0), [CL, NL] = eO(Ar, T0, rs, eo, v0, b0);
function zf(e) {
  if (0 <= e.y && e.y < 100) {
...
function RL(e) {
  var t = e.dateTime, r = e.date, n = e.time, a = e.periods, i = e.days, o = e.shortDays, u = e.months, s = e.shortMonths, c = ka(a), l = Ba(a), f = ka(i), h = Ba(i), p = ka(o), g = Ba(o), y = ka(u), m = Ba(u), E = ka(s), v = Ba(s), T = {
    a: Y,
    A: Q,
    b: te,
    B: k,
...
function ka(e) {
  return new RegExp("^(?:" + e.map(LL).join("|") + ")", "i");
}
function Ba(e) {
...
function uk(e, t) {
  return e = rO(e), ge(ra.count(Ar(e), e) + (Ar(e).getDay() === 4), t, 2);
}
function sk(e) {
  return e.getDay();
}
...
function Ok(e, t) {
  return e = aO(e), ge(na.count(Or(e), e) + (Or(e).getUTCDay() === 4), t, 2);
}
function Sk(e) {
  return e.getUTCDay();
}
...
function Rk(e) {
  return Rn = RL(e), iO = Rn.format, Rn.parse, oO = Rn.utcFormat, Rn.utcParse, Rn;
}
function Dk(e) {
  return new Date(e);
}
...
function A0(e, t, r, n, a, i, o, u, s, c) {
  ...
  return l.invert = function(_) {
    ...
    return arguments.length ? h(Array.from(_, Mk)) : h().map(Dk);
  }, l.ticks = function(_) {
    var O = h();
    ...
    var O = h();
    return (!_ || typeof _.range != "function") && (_ = t(O[0], O[O.length - 1], _ ?? 10)), _ ? h(zA(O, _)) : l;
  }, l.copy = function() {
    return Ji(l, A0(e, t, r, n, a, i, o, u, s, c));
  }, l;
}
function Lk() {
  return Ut.apply(A0(CL, NL, Ar, T0, rs, eo, v0, b0, sn, iO).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function kk() {
  return Ut.apply(A0(PL, IL, Or, _0, ns, ts, E0, g0, sn, oO).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function as() {
  ...
  return c.range = l(xa), c.rangeRound = l(s0), c.unknown = function(f) {
...
function lO() {
  ...
  return r.domain = function(n) {
    ...
    return Array.from({ length: n + 1 }, (a, i) => AM(e, i / n));
  }, r.copy = function() {
...
function is() {
  ...
  function g(y) {
    return function(m) {
      var E, v, T;
      return arguments.length ? ([E, v, T] = m, c = VM(y, [E, v, T]), p) : [c(0), c(0.5), c(1)];
    };
  }
  return p.range = g(xa), p.rangeRound = g(s0), p.unknown = function(y) {
...
var Hk = Uk();
const ss = /* @__PURE__ */ xe(Hk);
var Jf, s1;
function qk() {
  if (s1) return Jf;
  s1 = 1;
  var e = Up(), t = ur(), r = OA(), n = Tt();
  function a(i, o) {
    var u = n(i) ? e : r;
    return u(i, t(o, 3));
  }
...
}, w0, Le = !0, Ft = "[DecimalError] ", hn = Ft + "Invalid argument: ", x0 = Ft + "Exponent out of range: ", Pa = Math.floor, nn = Math.pow, Xk = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ot, Xe = 1e7, Re = 7, yO = 9007199254740991, nu = Pa(yO / Re), ae = {};
...
ae.squareRoot = ae.sqrt = function() {
  ...
  for (e = He(u), Le = !1, a = Math.sqrt(+u), a == 0 || a == 1 / 0 ? (t = tr(u.d), (t.length + e) % 2 == 0 && (t += "0"), a = Math.sqrt(t), e = Pa((e + 1) / 2) - (e < 0 || e % 2), a == 1 / 0 ? t = "5e" + e : (t = a.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + e), n = new s(t)) : n = new s(a.toString()), r = s.precision, a = o = r + 3; ; )
...
ae.toDecimalPlaces = ae.todp = function(e, t) {
  ...
  return r = new n(r), e === void 0 ? r : (ar(e, 0, wa), t === void 0 ? t = n.rounding : ar(t, 0, 8), we(r, e + He(r) + 1, t));
};
ae.toExponential = function(e, t) {
  var r, n = this, a = n.constructor;
  return e === void 0 ? r = vn(n, !0) : (ar(e, 0, wa), t === void 0 ? t = a.rounding : ar(t, 0, 8), n = we(new a(n), e + 1, t), r = vn(n, !0, e + 1)), r;
};
ae.toFixed = function(e, t) {
  var r, n, a = this, i = a.constructor;
  return e === void 0 ? vn(a) : (ar(e, 0, wa), t === void 0 ? t = i.rounding : ar(t, 0, 8), n = we(new i(a), e + He(a) + 1, t), r = vn(n.abs(), !1, e + He(n) + 1), a.isneg() && !a.isZero() ? "-" + r : r);
};
...
ae.toPower = ae.pow = function(e) {
  ...
  if (t = e.e, r = e.d.length - 1, o = t >= r, i = u.s, o) {
    if ((r = l < 0 ? -l : l) <= yO) {
      for (a = new s(Ot), t = Math.ceil(n / Re + 4), Le = !1; r % 2 && (a = a.times(u), d1(a.d, t)), r = Pa(r / 2), r !== 0; )
...
ae.toPrecision = function(e, t) {
  var r, n, a = this, i = a.constructor;
  return e === void 0 ? (r = He(a), n = vn(a, r <= i.toExpNeg || r >= i.toExpPos)) : (ar(e, 1, wa), t === void 0 ? t = i.rounding : ar(t, 0, 8), a = we(new i(a), e, t), r = He(a), n = vn(a, e <= r || r <= i.toExpNeg, e)), n;
};
ae.toSignificantDigits = ae.tosd = function(e, t) {
  var r = this, n = r.constructor;
  return e === void 0 ? (e = n.precision, t = n.rounding) : (ar(e, 1, wa), t === void 0 ? t = n.rounding : ar(t, 0, 8)), we(new n(r), e, t);
};
...
function f1(e, t) {
  ...
  if (t = t.slice(n, a), t) {
    if (a -= n, r = r - n - 1, e.e = Pa(r / Re), e.d = [], n = (r + 1) % Re, r < 0 && (n += Re), n < a) {
      for (n && e.d.push(+t.slice(0, n)), a -= Re; n < a; ) e.d.push(+t.slice(n, n += Re));
      t = t.slice(n), n = Re - t.length;
    } else
      n -= a;
    for (; n--; ) t += "0";
    if (e.d.push(+t), Le && (e.e > nu || e.e < -nu)) throw Error(x0 + r);
  } else
    e.s = 0, e.e = 0, e.d = [0];
  return e;
}
function we(e, t, r) {
  ...
  (n > 0 ? a > 0 ? c / nn(10, o - a) : 0 : f[l - 1]) % 10 & 1 || r == (e.s < 0 ? 8 : 7))), t < 1 || !f[0])
    return s ? (i = He(e), f.length = 1, t = t - i - 1, f[0] = nn(10, (Re - t % Re) % Re), e.e = Pa(-t / Re) || 0) : (f.length = 1, f[0] = e.e = e.s = 0), e;
...
function EO(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(hn + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, Xk.test(i)) f1(o, i);
    else throw Error(hn + i);
  }
  if (a.prototype = ae, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = EO, a.config = a.set = Qk, e === void 0 && (e = {}), e)
...
function Qk(e) {
  ...
  for (t = 0; t < a.length; t += 3)
    if ((n = e[r = a[t]]) !== void 0)
      if (Pa(n) === n && n >= a[t + 1] && n <= a[t + 2]) this[r] = n;
...
var n4 = function(t) {
  ...
  return t === 1 ? r : h1(function() {
    ...
    return o >= t ? r.apply(void 0, a) : e(t - o, h1(function() {
      ...
      return r.apply(void 0, Zk(l).concat(s));
    }));
  });
}, ls = function(t) {
  return a4(t.length, t);
}, wh = function(t, r) {
  for (var n = [], a = t; a < r; ++a)
    n[a - t] = a;
  return n;
...
var c4 = ls(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), l4 = ls(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), f4 = ls(function(e, t, r) {
  var n = t - +e;
...
const fs = {
  rangeStep: s4,
  getDigitCount: u4,
  interpolateNumber: c4,
  uninterpolateNumber: l4,
  uninterpolateTruncation: f4
};
function Ih(e) {
  return p4(e) || h4(e) || OO(e) || d4();
}
function d4() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function g4(e, t, r) {
  ...
  var o = Math.floor((t - 1) / 2), u = o4(i4(function(s) {
...
var T4 = AO(v4), _4 = AO(E4), A4 = process.env.NODE_ENV === "production", nd = "Invariant failed";
function vt(e, t) {
  if (A4)
    throw new Error(nd);
...
function M4(e, t, r) {
  return t && D4(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function L4(e, t, r) {
  return t = iu(t), k4(e, PO() ? Reflect.construct(t, r || [], iu(e).constructor) : t.apply(e, r));
}
function k4(e, t) {
...
var ds = /* @__PURE__ */ (function(e) {
  function t() {
    return R4(this, t), L4(this, t, arguments);
  }
  return j4(t, e), M4(t, [{
    key: "render",
    value: function() {
      var n = this.props, a = n.offset, i = n.layout, o = n.width, u = n.dataKey, s = n.data, c = n.dataPointFormatter, l = n.xAxis, f = n.yAxis, h = C4(n, O4), p = le(h, !1);
...
function $4(e, t, r) {
  return t = U4(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function U4(e) {
  var t = H4(e, "string");
...
function zn(e, t, r) {
  return t = G4(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function G4(e) {
  var t = K4(e, "string");
...
var V4 = function(t) {
  ...
  var o = r.props.children, u = jt(o, ds).filter(function(c) {
    return J4(a, i, c.props.direction);
  });
  if (u && u.length) {
  ...
  }), i = i8[n], o = Y3().keys(a).value(function(u, s) {
    return +ut(u, s, 0);
  }).order(sh).offset(i);
  return o(t);
}, u8 = function(t, r, n, a, i, o) {
  if (!t)
    return null;
...
var uu = Math.PI / 180, g8 = function(t) {
  ...
  return y.reduce(function(m, E) {
    ...
    var I = kO(v, i), N = I.realScaleType, j = I.scale;
    j.domain(T).range(b), BO(j);
    var D = jO(j, fr(fr({}, v), {}, {
      realScaleType: N
    })), R = fr(fr(fr({}, v), D), {}, {
      range: b,
  ...
  if (o === 0)
    return !0;
  var l = _8(r), f = l.startAngle, h = l.endAngle, p = u, g;
  if (f <= h) {
    for (; p > h; )
      p -= 360;
    for (; p < f; )
...
function R8(e, t, r) {
  return t = D8(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function D8(e) {
  var t = M8(e, "string");
...
var L8 = function(t) {
  ...
  var a = t.position, i = t.viewBox, o = t.offset, u = t.className, s = i, c = s.cx, l = s.cy, f = s.innerRadius, h = s.outerRadius, p = s.startAngle, g = s.endAngle, y = s.clockWise, m = (f + h) / 2, E = k8(p, g), v = E >= 0 ? 1 : -1, T, A;
  ...
  var b = Ne(c, l, m, T), _ = Ne(c, l, m, T + (A ? 1 : -1) * 359), O = "M".concat(b.x, ",").concat(b.y, `
    ...
    `).concat(_.x, ",").concat(_.y), I = me(t.id) ? Ki("recharts-radial-line-") : t.id;
  ...
  return i === "insideLeft" ? We({
    ...
    textAnchor: E,
    verticalAnchor: p
  }, O) : Aa(i) && (J(i.x) || on(i.x)) && (J(i.y) || on(i.y)) ? We({
    x: u + ht(i.x, c),
    y: s + ht(i.y, l),
    textAnchor: "end",
    verticalAnchor: "end"
...
function Qe(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = C8(e, O8), a = We({
    offset: r
  ...
  if (g && (o === "insideStart" || o === "insideEnd" || o === "end"))
    return B8(a, p, y);
  var m = g ? j8(a) : F8(a);
  return /* @__PURE__ */ C.createElement(gn, wi({
...
var WO = function(t) {
  ...
  return t ? t === !0 ? /* @__PURE__ */ C.createElement(Qe, {
    ...
    content: t,
    viewBox: r
  }) : Aa(t) ? /* @__PURE__ */ C.createElement(Qe, wi({
    viewBox: r
  }, t, {
    key: "label-implicit"
  })) : null : null;
  ...
  if (!n)
    return o;
  var u = U8(t.label, r || i);
  return [u].concat(S8(o));
};
Qe.parseViewBox = WO;
Qe.renderCallByParent = H8;
var id, w1;
function q8() {
  if (w1) return id;
  w1 = 1;
...
var z8 = ["valueAccessor"], G8 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function K8(e) {
  return Z8(e) || Q8(e) || X8(e) || V8();
}
function V8() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var nB = function(t) {
  return Array.isArray(t.value) ? Y8(t.value) : t.value;
};
function Gt(e) {
  var t = e.valueAccessor, r = t === void 0 ? nB : t, n = C1(e, z8), a = n.data, i = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = C1(n, G8);
...
function aB(e, t) {
  return e ? e === !0 ? /* @__PURE__ */ C.createElement(Gt, {
    ...
    data: t,
    content: e
  }) : Aa(e) ? /* @__PURE__ */ C.createElement(Gt, su({
    data: t
  }, e, {
    key: "labelList-implicit"
  })) : null : null;
...
function iB(e, t) {
  ...
  if (!r)
    return a;
  var i = aB(e.label, t);
  return [i].concat(K8(a));
}
Gt.renderCallByParent = iB;
function Ii(e) {
  "@babel/helpers - typeof";
...
var cB = function(t, r) {
  ...
  var r = t.cx, n = t.cy, a = t.innerRadius, i = t.outerRadius, o = t.startAngle, u = t.endAngle, s = cB(o, u), c = o + s, l = Ne(r, n, i, o), f = Ne(r, n, i, c), h = "M ".concat(l.x, ",").concat(l.y, `
  ...
  if (a > 0) {
    var _ = go({
      ...
      cornerRadius: o,
      cornerIsExternal: s
    }), O = _.circleTangency, I = _.lineTangency, N = _.theta, j = go({
      cx: r,
      cy: n,
      radius: a,
      angle: l,
  ...
  var r = R1(R1({}, fB), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < i || l === f)
    return null;
  var p = pe("recharts-sector", h), g = o - i, y = ht(u, g, 0, !0), m;
  return y > 0 && Math.abs(l - f) < 360 ? m = lB({
    cx: n,
    cy: a,
    innerRadius: i,
    outerRadius: o,
...
var L1 = {
  ...
  return (n === "curveMonotone" || n === "curveBump") && r ? L1["".concat(n).concat(r === "vertical" ? "Y" : "X")] : L1[n] || Ku;
}, yB = function(t) {
  var r = t.type, n = r === void 0 ? "linear" : r, a = t.points, i = a === void 0 ? [] : a, o = t.baseLine, u = t.layout, s = t.connectNulls, c = s === void 0 ? !1 : s, l = mB(n, u), f = c ? i.filter(function(y) {
    return vo(y);
  }) : i, h;
  if (Array.isArray(o)) {
...
var j1;
function GO() {
  return j1 || (j1 = 1, process.env.NODE_ENV === "production" ? To.exports = bB() : To.exports = gB()), To.exports;
}
var od, F1;
function vB() {
  if (F1) return od;
...
var sd, U1;
function KO() {
  return U1 || (U1 = 1, sd = Function.call.bind(Object.prototype.hasOwnProperty)), sd;
}
var cd, H1;
function EB() {
  if (H1) return cd;
  ...
  if (process.env.NODE_ENV !== "production") {
    var t = /* @__PURE__ */ I0(), r = {}, n = /* @__PURE__ */ KO();
    e = function(i) {
      var o = "Warning: " + i;
...
function TB() {
  if (q1) return ld;
  q1 = 1;
  var e = GO(), t = vB(), r = /* @__PURE__ */ I0(), n = /* @__PURE__ */ KO(), a = /* @__PURE__ */ EB(), i = function() {
  };
...
var Y1;
function AB() {
  if (Y1) return Eo.exports;
  if (Y1 = 1, process.env.NODE_ENV !== "production") {
    var e = GO(), t = !0;
    Eo.exports = /* @__PURE__ */ TB()(e.isElement, t);
  } else
    Eo.exports = /* @__PURE__ */ _B()();
  return Eo.exports;
}
var OB = /* @__PURE__ */ AB();
const Ae = /* @__PURE__ */ xe(OB), { getOwnPropertyNames: SB, getOwnPropertySymbols: xB } = Object, { hasOwnProperty: wB } = Object.prototype;
function dd(e, t) {
...
function z1(e) {
  return SB(e).concat(xB(e));
}
const IB = (
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  Object.hasOwn || ((e, t) => wB.call(e, t))
);
function wn(e, t) {
  return e === t || !e && !t && e !== e && t !== t;
}
const CB = "__v", NB = "__o", RB = "_owner", { getOwnPropertyDescriptor: G1, keys: K1 } = Object;
function DB(e, t) {
...
function $a(e, t, r) {
  ...
  let i, o, u;
  for (; a-- > 0; )
    if (i = n[a], !VO(e, t, r, i) || (o = G1(e, i), u = G1(t, i), (o || u) && (!o || !u || o.configurable !== u.configurable || o.enumerable !== u.enumerable || o.writable !== u.writable)))
      return !1;
  return !0;
}
function UB(e, t) {
...
function VO(e, t, r, n) {
  return (n === RB || n === NB || n === CB) && (e.$$typeof || t.$$typeof) ? !0 : IB(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
const WB = "[object ArrayBuffer]", YB = "[object Arguments]", zB = "[object Boolean]", GB = "[object DataView]", KB = "[object Date]", VB = "[object Error]", XB = "[object Map]", QB = "[object Number]", ZB = "[object Object]", JB = "[object RegExp]", e5 = "[object Set]", t5 = "[object String]", r5 = {
  "[object Int8Array]": !0,
  "[object Uint8Array]": !0,
...
}, n5 = "[object URL]", a5 = Object.prototype.toString;
function i5({ areArrayBuffersEqual: e, areArraysEqual: t, areDataViewsEqual: r, areDatesEqual: n, areErrorsEqual: a, areFunctionsEqual: i, areMapsEqual: o, areNumbersEqual: u, areObjectsEqual: s, arePrimitiveWrappersEqual: c, areRegExpsEqual: l, areSetsEqual: f, areTypedArraysEqual: h, areUrlsEqual: p, unknownTagComparators: g }) {
...
function o5({ circular: e, createCustomConfig: t, strict: r }) {
  let n = {
    areArrayBuffersEqual: DB,
    areArraysEqual: r ? $a : MB,
    areDataViewsEqual: LB,
    areDatesEqual: kB,
    areErrorsEqual: BB,
    areFunctionsEqual: jB,
    areMapsEqual: r ? dd(V1, $a) : V1,
    areNumbersEqual: FB,
    areObjectsEqual: r ? $a : $B,
    arePrimitiveWrappersEqual: UB,
    areRegExpsEqual: HB,
    areSetsEqual: r ? dd(X1, $a) : X1,
...
function s5({ circular: e, comparator: t, createState: r, equals: n, strict: a }) {
  if (r)
    return function(u, s) {
...
function Xr(e = {}) {
  const { circular: t = !1, createInternalComparator: r, createState: n, strict: a = !1 } = e, i = o5(e), o = i5(i), u = r ? r(o) : u5(o);
  return s5({ circular: t, comparator: o, createState: n, equals: u, strict: a });
}
function l5(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(i)) {
        if (!i.length)
          return;
        var o = i, u = f5(o), s = u[0], c = u.slice(1);
        if (typeof s == "number") {
          Q1(a.bind(null, c), s);
          return;
        }
        a(s), Q1(a.bind(null, c));
        return;
      }
...
var v5 = function(t, r) {
  ...
  return Object.keys(r).reduce(function(n, a) {
    return eE(eE({}, n), {}, XO({}, a, t(a, r[a])));
  }, {});
}, tE = function(t, r, n) {
  return t.map(function(a) {
    return "".concat(T5(a), " ").concat(r, "ms ").concat(n);
  }).join(",");
}, _5 = process.env.NODE_ENV !== "production", lu = function(t, r, n, a, i, o, u, s) {
  if (_5 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
      console.warn("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
    else {
...
var fu = 1e-4, ZO = function(t, r) {
  ...
  return function(n) {
    var a = ZO(t, r), i = [].concat(w5(a.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return JO(i, n);
  };
  ...
  var f = rE(a, o), h = rE(i, u), p = N5(a, o), g = function(E) {
    return E > 1 ? 1 : E < 0 ? 0 : E;
  }, y = function(E) {
    for (var v = E > 1 ? 1 : E, T = v, A = 0; A < 8; ++A) {
      var b = f(T) - v, _ = p(T);
      if (Math.abs(b - v) < fu || _ < fu)
        return h(T);
      T = g(T - b / _);
    }
    return h(T);
...
var du = function(t, r, n) {
  ...
  var a = ti(function(i, o) {
    if (qh(o)) {
      var u = t(o.from, o.to, o.velocity), s = F5(u, 2), c = s[0], l = s[1];
      return tt(tt({}, o), {}, {
        from: c,
        velocity: l
      });
...
const W5 = (function(e, t, r, n, a) {
  var i = v5(e, t), o = i.reduce(function(m, E) {
    ...
    c || (c = E);
    var v = E - c, T = v / r.dt;
    u = q5(r, u, T), a(tt(tt(tt({}, e), t), h())), c = E, p() || (s = requestAnimationFrame(f));
  }, y = function(E) {
    l || (l = E);
    var v = (E - l) / n, T = ti(function(b, _) {
      return du.apply(void 0, aE(_).concat([r(v)]));
    }, o);
    if (a(tt(tt(tt({}, e), t), T)), v < 1)
      s = requestAnimationFrame(f);
    else {
      var A = ti(function(b, _) {
        return du.apply(void 0, aE(_).concat([r(1)]));
      }, o);
      a(tt(tt(tt({}, e), t), A));
    }
  };
...
var Y5 = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function z5(e, t) {
  if (e == null) return {};
  var r = G5(e, t), n, a;
  if (Object.getOwnPropertySymbols) {
...
function ej(e, t, r) {
  return t && J5(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function tS(e) {
  var t = tj(e, "string");
  ...
  return ej(r, [{
    ...
    value: function(a) {
      ...
      if (u) {
        ...
        if (!(c5(a.to, l) && a.canBegin && a.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(a) {
      var i = this, o = a.from, u = a.to, s = a.duration, c = a.easing, l = a.begin, f = a.onAnimationEnd, h = a.onAnimationStart, p = W5(o, u, D5(c), s, this.changeStyle), g = function() {
        i.stopJSAnimation = p();
      };
    ...
    value: function(a) {
      var i = this, o = a.steps, u = a.begin, s = a.onAnimationStart, c = o[0], l = c.style, f = c.duration, h = f === void 0 ? 0 : f, p = function(y, m, E) {
        ...
        var j = tE(N, v, A), D = Ht(Ht(Ht({}, I.style), b), {}, {
          transition: j
        });
        return [].concat(hd(y), [D, v, O]).filter(E5);
      };
    ...
    value: function(a) {
      ...
      var y = u ? za({}, u, s) : s, m = tE(Object.keys(y), o, c);
      g.start([l, i, Ht(Ht({}, y), {}, {
        transition: m
      }), o, f]);
    }
    ...
    value: function() {
      ...
      var s = z5(a, Y5), c = $r.count(i), l = this.state.style;
      if (typeof i == "function")
        return i(l);
      if (!u || c === 0 || o <= 0)
        return i;
...
var lE = function(t, r, n, a, i) {
  ...
  var r = cE(cE({}, pj), t), n = ii(), a = ft(-1), i = ij(a, 2), o = i[0], u = i[1];
  Et(function() {
...
}, mj = ["points", "className", "baseLinePoints", "connectNulls"];
function Fn() {
...
var dE = function(t) {
  ...
  return t.forEach(function(n) {
    dE(n) ? r[r.length - 1].push(n) : r[r.length - 1].length > 0 && r.push([]);
  }), dE(t[0]) && r[r.length - 1].push(t[0]), r[r.length - 1].length <= 0 && (r = r.slice(0, -1)), r;
}, ri = function(t, r) {
  var n = _j(t);
  r && (n = [n.reduce(function(i, o) {
    return [].concat(fE(i), fE(o));
  }, [])]);
  ...
  var r = t.points, n = t.className, a = t.baseLinePoints, i = t.connectNulls, o = yj(t, mj);
  if (!r || !r.length)
    return null;
  var u = pe("recharts-polygon", n);
  if (a && a.length) {
    var s = o.stroke && o.stroke !== "none", c = Aj(r, a, i);
    return /* @__PURE__ */ C.createElement("g", {
      className: u
    }, /* @__PURE__ */ C.createElement("path", Fn({}, le(o, !0), {
      fill: c.slice(-1) === "Z" ? o.fill : "none",
      stroke: "none",
      d: c
    })), s ? /* @__PURE__ */ C.createElement("path", Fn({}, le(o, !0), {
      fill: "none",
      d: ri(r, i)
    })) : null, s ? /* @__PURE__ */ C.createElement("path", Fn({}, le(o, !0), {
      fill: "none",
      d: ri(a, i)
    })) : null);
  }
  var l = ri(r, i);
  return /* @__PURE__ */ C.createElement("path", Fn({}, le(o, !0), {
...
var Sj = ["x", "y", "top", "left", "width", "height", "className"];
function Xh() {
...
function wj(e, t, r) {
  return t = Pj(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function Pj(e) {
  var t = Ij(e, "string");
  return Mi(t) == "symbol" ? t : t + "";
...
var Rj = function(t, r, n, a, i, o) {
  return "M".concat(t, ",").concat(i, "v").concat(a, "M").concat(o, ",").concat(r, "h").concat(n);
}, Dj = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.top, u = o === void 0 ? 0 : o, s = t.left, c = s === void 0 ? 0 : s, l = t.width, f = l === void 0 ? 0 : l, h = t.height, p = h === void 0 ? 0 : h, g = t.className, y = Cj(t, Sj), m = xj({
    x: n,
    y: i,
    top: u,
    left: c,
...
var jj = Bj();
const Fj = /* @__PURE__ */ xe(jj);
var $j = ["cx", "cy", "angle", "ticks", "axisLine"], Uj = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function oa(e) {
  "@babel/helpers - typeof";
...
function Yj(e, t, r) {
  return t = mu(t), zj(e, rS() ? Reflect.construct(t, r || [], mu(e).constructor) : t.apply(e, r));
}
function zj(e, t) {
...
var ps = /* @__PURE__ */ (function(e) {
  function t() {
    return qj(this, t), Yj(this, t, arguments);
  }
  return Kj(t, e), Wj(t, [{
    ...
    key: "getViewBox",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = kj(u, function(l) {
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = n.axisLine, c = bE(n, $j), l = u.reduce(function(g, y) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.angle, s = a.tickFormatter, c = a.stroke, l = bE(a, Uj), f = this.getTickTextAnchor(), h = le(l, !1), p = le(o, !1), g = i.map(function(y, m) {
    ...
    value: function(n, a, i) {
      var o;
      return /* @__PURE__ */ C.isValidElement(n) ? o = /* @__PURE__ */ C.cloneElement(n, a) : de(n) ? o = n(a) : o = /* @__PURE__ */ C.createElement(gn, ni({}, a, {
...
function Zj(e, t, r) {
  return t = yu(t), Jj(e, aS() ? Reflect.construct(t, r || [], yu(e).constructor) : t.apply(e, r));
}
function Jj(e, t) {
...
var nF = Math.PI / 180, TE = 1e-5, ys = /* @__PURE__ */ (function(e) {
  function t() {
    return Xj(this, t), Zj(this, t, arguments);
  }
  return tF(t, e), Qj(t, [{
    ...
    key: "getTickTextAnchor",
    value: function(n) {
      var a = this.props.orientation, i = Math.cos(-n.coordinate * nF), o;
      return i > TE ? o = a === "outer" ? "start" : "end" : i < -TE ? o = a === "outer" ? "end" : "start" : o = "middle", o;
    }
  }, {
    key: "renderAxisLine",
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Oj, an({
        className: "recharts-polar-angle-axis-line"
      }, c, {
        points: f
      }));
...
function iF() {
  if (AE) return bd;
  AE = 1;
  var e = xr(), t = aF(), r = wr(), n = "[object Object]", a = Function.prototype, i = Object.prototype, o = a.toString, u = i.hasOwnProperty, s = o.call(Object);
  function c(l) {
    if (!r(l) || e(l) != n)
      return !1;
    var f = t(l);
...
var PE = function(t, r, n, a, i) {
  ...
  var r = wE(wE({}, vF), t), n = ii(), a = ft(-1), i = fF(a, 2), o = i[0], u = i[1];
  Et(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
}, TF = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function ki(e) {
  "@babel/helpers - typeof";
...
function CE(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ C.createElement(EF, r);
    case "sector":
...
function oS(e) {
  var t = e.option, r = e.shapeType, n = e.propTransformer, a = n === void 0 ? wF : n, i = e.activeClassName, o = i === void 0 ? "recharts-active-shape" : i, u = e.isActive, s = _F(e, TF), c;
  if (/* @__PURE__ */ Lt(t))
    c = /* @__PURE__ */ Ue(t, gu(gu({}, s), IF(t)));
  else if (de(t))
    c = t(s);
  else if (uF(t) && !lF(t)) {
    var l = a(t, s);
    c = /* @__PURE__ */ C.createElement(CE, {
      shapeType: r,
      elementProps: l
    });
  } else {
...
function DF(e, t) {
  var r;
  return bs(e, t) ? r = CF : gs(e, t) ? r = NF : Bi(e, t) && (r = RF), r;
}
function MF(e, t) {
  var r;
...
function kF(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, a = MF(r, t), i = LF(r, t), o = n.filter(function(s, c) {
...
function FF(e, t, r) {
  return t = vu(t), $F(e, uS() ? Reflect.construct(t, r || [], vu(e).constructor) : t.apply(e, r));
}
function $F(e, t) {
...
var Ir = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return BF(this, t), n = FF(this, t, [r]), Rt(n, "pieRef", null), Rt(n, "sectorRefs", []), Rt(n, "id", Ki("recharts-pie-")), Rt(n, "handleAnimationEnd", function() {
  ...
  return HF(t, e), jF(t, [{
    ...
    value: function(n, a, i) {
      ...
      return /* @__PURE__ */ C.createElement(jh, $n({}, a, {
        key: i,
        type: "linear",
        className: o
      }));
    ...
    value: function(n, a, i) {
      ...
      return /* @__PURE__ */ C.createElement(gn, $n({}, a, {
...
Rt(Ir, "getComposedData", function(e) {
  ...
  if (!a || !a.length)
    return null;
  var i = n.cornerRadius, o = n.startAngle, u = n.endAngle, s = n.paddingAngle, c = n.dataKey, l = n.nameKey, f = n.valueKey, h = n.tooltipType, p = Math.abs(n.minAngle), g = wo.parseCoordinateOfPie(n, r), y = wo.parseDeltaAngle(o, u), m = Math.abs(y), E = c;
...
var XF = ["Webkit", "Moz", "O", "ms"], QF = function(t, r) {
  var n = t.replace(/(\w)/, function(i) {
    return i.toUpperCase();
  }), a = XF.reduce(function(i, o) {
    return jE(jE({}, i), {}, lS({}, o + n, r));
  }, {});
  return a[t] = r, a;
};
function ca(e) {
...
function JF(e, t, r) {
  return t && $E(e.prototype, t), r && $E(e, r), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function e9(e, t, r) {
  return t = _u(t), t9(e, fS() ? Reflect.construct(t, r || [], _u(e).constructor) : t.apply(e, r));
}
function t9(e, t) {
...
var i9 = function(t) {
  ...
  function t(r) {
    var n;
    return ZF(this, t), n = e9(this, t, [r]), _t(n, "handleDrag", function(a) {
      ...
      var i = UE(a) ? a.changedTouches[0] : a;
      n.setState({
        isTravellerMoving: !1,
        isSlideMoving: !0,
  ...
  return n9(t, e), JF(t, [{
    ...
    value: function() {
      ...
      }, /* @__PURE__ */ C.createElement(gn, Tu({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(f, h) - p,
        y: o + u / 2
      }, g), this.getTextOfTick(a)), /* @__PURE__ */ C.createElement(gn, Tu({
        textAnchor: "start",
        verticalAnchor: "middle",
        x: Math.max(f, h) + s + p,
        y: o + u / 2
    ...
    value: function() {
      ...
      if (!a || !a.length || !J(u) || !J(s) || !J(c) || !J(l) || c <= 0 || l <= 0)
        return null;
      var T = pe("recharts-brush", i), A = C.Children.count(o) === 1, b = QF("userSelect", "none");
      return /* @__PURE__ */ C.createElement(Oe, {
        className: T,
...
function O9(e, t) {
  var r = e.x, n = e.y, a = _9(e, g9), i = "".concat(r), o = parseInt(i, 10), u = "".concat(n), s = parseInt(u, 10), c = "".concat(t.height || a.height), l = parseInt(c, 10), f = "".concat(t.width || a.width), h = parseInt(f, 10);
...
function N9(e, t, r) {
  return t = Ou(t), R9(e, mS() ? Reflect.construct(t, r || [], Ou(e).constructor) : t.apply(e, r));
}
function R9(e, t) {
...
var sr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = N9(this, t, [].concat(a)), jr(r, "state", {
      isAnimationFinished: !1
  ...
  return M9(t, e), C9(t, [{
    ...
    value: function() {
      ...
      return i.map(function(c, l) {
        ...
        return /* @__PURE__ */ C.createElement(XE, Au({
...
jr(sr, "getComposedData", function(e) {
  var t = e.props, r = e.item, n = e.barPosition, a = e.bandSize, i = e.xAxis, o = e.yAxis, u = e.xAxisTicks, s = e.yAxisTicks, c = e.stackedData, l = e.dataStartIndex, f = e.displayedData, h = e.offset, p = t8(n, r);
  if (!p)
    return null;
  var g = t.layout, y = r.type.defaultProps, m = y !== void 0 ? $e($e({}, y), r.props) : r.props, E = m.dataKey, v = m.children, T = m.minPointSize, A = g === "horizontal" ? o : i, b = c ? A.scale.domain() : null, _ = s8({
    numericAxis: A
  }), O = jt(v, Ju), I = f.map(function(N, j) {
    var D, R, B, F, $, q;
    c ? D = r8(c[l + j], b) : (D = ut(N, E), Array.isArray(D) || (D = [_, D]));
    var Y = S9(T, pS.defaultProps.minPointSize)(D[1], j);
    if (g === "horizontal") {
...
var F9 = function(t, r, n, a, i) {
  ...
  return l.reduce(function(p, g) {
    ...
    if (y.type === "number" && (y.padding === "gap" || y.padding === "no-gap")) {
      var R = E[1] - E[0], B = 1 / 0, F = y.categoricalDomain.sort(qN);
    ...
    return Z.bandSize = ou(Z, z), !y.hide && a === "xAxis" ? f[_] += (D ? -1 : 1) * Z.height : y.hide || (f[_] += (D ? -1 : 1) * Z.width), qt(qt({}, p), {}, vs({}, g, Z));
  }, {});
}, gS = function(t, r) {
  var n = t.x, a = t.y, i = r.x, o = r.y;
  return {
...
var H9 = function(t) {
  var r = t.width, n = t.height, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i = U9(a), o = i * Math.PI / 180, u = Math.atan(n / r), s = o > u && o < Math.PI - u ? n / Math.sin(o) : r / Math.cos(o);
  return Math.abs(s);
}, Nd, tT;
function q9() {
  if (tT) return Nd;
...
var V9 = M_();
const X9 = /* @__PURE__ */ xe(V9);
var Q9 = X9(function(e) {
  return {
    x: e.left,
    y: e.top,
    width: e.width,
...
var D0 = /* @__PURE__ */ Vt(void 0), M0 = /* @__PURE__ */ Vt(void 0), ES = /* @__PURE__ */ Vt(void 0), TS = /* @__PURE__ */ Vt({}), _S = /* @__PURE__ */ Vt(void 0), AS = /* @__PURE__ */ Vt(0), OS = /* @__PURE__ */ Vt(0), iT = function(t) {
  var r = t.state, n = r.xAxisMap, a = r.yAxisMap, i = r.offset, o = t.clipPathId, u = t.children, s = t.width, c = t.height, l = Q9(i);
...
function o$(e, t, r) {
  return t = xu(t), u$(e, PS() ? Reflect.construct(t, r || [], xu(e).constructor) : t.apply(e, r));
}
function u$(e, t) {
...
var y$ = function(t, r) {
  ...
  if (a) {
    ...
    return nr(c, "discard") && c9(b, function(_) {
...
function g$(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = Z9(), l = xS(a), f = wS(i), h = t$();
  if (!c || !h)
    return null;
  ...
  var p = R0({
    x: l.scale,
    y: f.scale
  }), g = ze(t), y = ze(r), m = n && n.length === 2, E = b$(p, g, y, m, h, e.position, l.orientation, f.orientation, e);
  if (!E)
    return null;
  var v = f$(E, 2), T = v[0], A = T.x, b = T.y, _ = v[1], O = _.x, I = _.y, N = nr(e, "hidden") ? "url(#".concat(c, ")") : void 0, j = uT(uT({
    clipPath: N
  }, le(e, !0)), {}, {
    x1: A,
    y1: b,
  ...
  }, y$(o, j), Qe.renderCallByParent(e, $9({
    x1: A,
    y1: b,
    x2: O,
    y2: I
...
var j0 = /* @__PURE__ */ (function(e) {
  ...
  return c$(t, e), i$(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(g$, this.props);
    }
  }]);
})(C.Component);
...
function _$(e, t, r) {
  return t = wu(t), A$(e, CS() ? Reflect.construct(t, r || [], wu(e).constructor) : t.apply(e, r));
}
function A$(e, t) {
...
var w$ = function(t) {
  ...
  function t() {
    return v$(this, t), _$(this, t, arguments);
  }
  return S$(t, e), T$(t, [{
    key: "render",
    value: function() {
      ...
      if (!f)
        return null;
      var h = f.x, p = f.y, g = this.props, y = g.shape, m = g.className, E = nr(this.props, "hidden") ? "url(#".concat(s, ")") : void 0, v = lT(lT({
        clipPath: E
      }, le(this.props, !0)), {}, {
        cx: h,
        cy: p
...
function N$(e, t, r) {
  return t = Pu(t), R$(e, RS() ? Reflect.construct(t, r || [], Pu(e).constructor) : t.apply(e, r));
}
function R$(e, t) {
...
var k$ = function(t, r, n, a, i) {
  ...
  function t() {
    return P$(this, t), N$(this, t, arguments);
  }
  return M$(t, e), C$(t, [{
    key: "render",
    value: function() {
...
function $$(e, t, r, n, a) {
  for (var i = (n || []).slice(), o = t.start, u = t.end, s = 0, c = 1, l = o, f = function() {
    ...
    }, v = g.coordinate, T = s === 0 || Iu(e, v, E, l, u);
...
function F0(e, t, r) {
  ...
  if (!a || !a.length || !n)
    return [];
  if (J(s) || Sa.isSsr)
    return F$(a, typeof s == "number" && J(s) ? s : 0);
  ...
  }, m = a.length >= 2 ? dt(a[1].coordinate - a[0].coordinate) : 1, E = j$(i, m, p);
  return s === "equidistantPreserveStart" ? $$(m, E, y, a, o) : (s === "preserveStart" || s === "preserveStartEnd" ? h = Y$(m, E, y, a, o, s === "preserveStartEnd") : h = W$(m, E, y, a, o), h.filter(function(v) {
    return v.isShow;
  }));
}
var z$ = ["viewBox"], G$ = ["viewBox"], K$ = ["ticks"];
function ya(e) {
  "@babel/helpers - typeof";
...
function Q$(e, t, r) {
  return t && mT(e.prototype, t), r && mT(e, r), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function Z$(e, t, r) {
  return t = Cu(t), J$(e, LS() ? Reflect.construct(t, r || [], Cu(e).constructor) : t.apply(e, r));
}
function J$(e, t) {
...
var Ia = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return X$(this, t), n = Z$(this, t, [r]), n.state = {
      fontSize: "",
      letterSpacing: ""
    }, n;
  }
  return tU(t, e), Q$(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = Ld(n, z$), u = this.props, s = u.viewBox, c = Ld(u, G$);
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement("line", Un({}, f, {
    ...
    value: (
      ...
      function(n, a, i) {
        var o = this, u = this.props, s = u.tickLine, c = u.stroke, l = u.tick, f = u.tickFormatter, h = u.unit, p = F0(qe(qe({}, this.props), {}, {
          ...
          }, bn(o.props, A, b)), s && /* @__PURE__ */ C.createElement("line", Un({}, v, O, {
    ...
    value: function() {
      ...
      if (l)
        return null;
      var f = this.props, h = f.ticks, p = Ld(f, K$), g = h;
    ...
    value: function(n, a, i) {
      ...
      return /* @__PURE__ */ C.isValidElement(n) ? o = /* @__PURE__ */ C.cloneElement(n, qe(qe({}, a), {}, {
        ...
        className: u
      })) : o = /* @__PURE__ */ C.createElement(gn, Un({}, a, {
        className: "recharts-cartesian-axis-tick-value"
      }), i), o;
    }
  }]);
})(DT);
$0(Ia, "displayName", "CartesianAxis");
$0(Ia, "defaultProps", {
  x: 0,
  y: 0,
  width: 0,
...
var nU = ["x1", "y1", "x2", "y2", "key"], aU = ["offset"];
function En(e) {
  "@babel/helpers - typeof";
...
function iU(e, t, r) {
  return t = oU(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function oU(e) {
  var t = uU(e, "string");
...
function BS(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, u = t.key, s = bT(t, nU), c = le(s, !1);
    c.offset;
    var l = bT(c, aU);
...
var pU = function(t, r) {
  ...
  return LO(F0(ot(ot(ot({}, Ia.defaultProps), n), {}, {
    ticks: mr(n, !0),
    viewBox: {
      x: 0,
      y: 0,
...
function to(e) {
  var t, r, n, a, i, o, u = L0(), s = k0(), c = r$(), l = ot(ot({}, e), {}, {
    stroke: (t = e.stroke) !== null && t !== void 0 ? t : Dn.stroke,
    fill: (r = e.fill) !== null && r !== void 0 ? r : Dn.fill,
    horizontal: (n = e.horizontal) !== null && n !== void 0 ? n : Dn.horizontal,
    horizontalFill: (a = e.horizontalFill) !== null && a !== void 0 ? a : Dn.horizontalFill,
    vertical: (i = e.vertical) !== null && i !== void 0 ? i : Dn.vertical,
    verticalFill: (o = e.verticalFill) !== null && o !== void 0 ? o : Dn.verticalFill,
    x: J(e.x) ? e.x : c.left,
    y: J(e.y) ? e.y : c.top,
    width: J(e.width) ? e.width : c.width,
    height: J(e.height) ? e.height : c.height
  }), f = l.x, h = l.y, p = l.width, g = l.height, y = l.syncWithTicks, m = l.horizontalValues, E = l.verticalValues, v = J9(), T = e$();
  if (!J(p) || p <= 0 || !J(g) || g <= 0 || !J(f) || f !== +f || !J(h) || h !== +h)
    return null;
  var A = l.verticalCoordinatesGenerator || pU, b = l.horizontalCoordinatesGenerator || mU, _ = l.horizontalPoints, O = l.verticalPoints;
  if ((!_ || !_.length) && de(b)) {
  ...
  return /* @__PURE__ */ C.createElement("g", {
    ...
    height: l.height,
    ry: l.ry
  }), /* @__PURE__ */ C.createElement(lU, cn({}, l, {
    offset: c,
    horizontalPoints: _,
    xAxis: v,
    yAxis: T
  })), /* @__PURE__ */ C.createElement(fU, cn({}, l, {
    offset: c,
    verticalPoints: O,
    xAxis: v,
    yAxis: T
  })), /* @__PURE__ */ C.createElement(dU, cn({}, l, {
    horizontalPoints: _
  })), /* @__PURE__ */ C.createElement(hU, cn({}, l, {
    verticalPoints: O
  })));
}
...
function vU(e, t, r) {
  return t = Nu(t), EU(e, jS() ? Reflect.construct(t, r || [], Nu(e).constructor) : t.apply(e, r));
}
function EU(e, t) {
...
function OU(e) {
  var t = e.xAxisId, r = L0(), n = k0(), a = xS(t);
  return a == null ? null : (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ Wr.createElement(Ia, fp({}, a, {
...
var Pn = /* @__PURE__ */ (function(e) {
  function t() {
    return yU(this, t), vU(this, t, arguments);
  }
  return _U(t, e), gU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(OU, this.props);
    }
  }]);
})(Wr.Component);
FS(Pn, "displayName", "XAxis");
FS(Pn, "defaultProps", {
  allowDecimals: !0,
  hide: !1,
  orientation: "bottom",
...
function PU(e, t, r) {
  return t = Ru(t), IU(e, US() ? Reflect.construct(t, r || [], Ru(e).constructor) : t.apply(e, r));
}
function IU(e, t) {
...
var DU = function(t) {
  var r = t.yAxisId, n = L0(), a = k0(), i = wS(r);
  return i == null ? null : (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ Wr.createElement(Ia, hp({}, i, {
  ...
  function t() {
    return SU(this, t), PU(this, t, arguments);
  }
  return NU(t, e), wU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(DU, this.props);
    }
  }]);
})(Wr.Component);
HS(In, "displayName", "YAxis");
HS(In, "defaultProps", {
  allowDuplicatedCategory: !0,
  allowDecimals: !0,
  hide: !1,
...
var mp = function(t, r, n, a, i) {
  var o = jt(t, j0), u = jt(t, Ts), s = [].concat(gT(o), gT(u)), c = jt(t, As), l = "".concat(a, "Id"), f = a[0], h = r;
...
var FU = jU();
const $U = /* @__PURE__ */ xe(FU);
var Bd = new $U(), jd = "recharts.syncMouseEvents";
function Ui(e) {
  "@babel/helpers - typeof";
...
var YU = /* @__PURE__ */ (function() {
  function e() {
    UU(this, e), Fd(this, "activeIndex", 0), Fd(this, "coordinateList", []), Fd(this, "layout", "horizontal");
  }
  return qU(e, [{
    key: "setDetails",
    value: function(r) {
...
function VU(e, t, r) {
  return t = XU(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function XU(e) {
  var t = QU(e, "string");
  return Hi(t) == "symbol" ? t : t + "";
...
function ZU(e) {
  ...
  if (h === "ScatterChart")
    ...
    var m = YS(o), E = m.cx, v = m.cy, T = m.radius, A = m.startAngle, b = m.endAngle;
    g = {
      cx: E,
      cy: v,
      startAngle: A,
  ...
  return /* @__PURE__ */ Lt(p) ? /* @__PURE__ */ Ue(p, _) : /* @__PURE__ */ ai(y, _);
}
var JU = ["item"], e7 = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function va(e) {
  "@babel/helpers - typeof";
...
function u7(e, t, r) {
  return t && o7(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function s7(e, t, r) {
  return t = Du(t), c7(e, zS() ? Reflect.construct(t, r || [], Du(e).constructor) : t.apply(e, r));
}
function c7(e, t) {
...
var gp = function(t, r, n, a) {
  ...
  return n < 0 || !i || !i.length || n >= u.length ? null : i.reduce(function(s, c) {
    ...
    if (o.dataKey && !o.allowDuplicatedCategory) {
      ...
      h = f && f[n] || u[n];
    return h ? [].concat(Ea(s), [$O(c, h)]) : s;
  }, []);
}, OT = function(t, r, n, a) {
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = g7(i, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, l = V4(o, u, c, s);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, h = gp(t, r, l, f), p = v7(n, u, l, i);
    return {
  ...
  return n.reduce(function(g, y) {
    ...
    zU(E.domain, A, v) && (R = Dh(E.domain, null, A), p && (v === "number" || _ !== "auto") && (F = ei(j, T, "category")));
    var $ = XS(v);
    if (!R || R.length === 0) {
      var q, Y = (q = E.domain) !== null && q !== void 0 ? q : $;
      if (T) {
        if (R = ei(j, T, v), v === "category" && p) {
          var Q = HN(R);
          b && Q ? (B = R, R = Eu(0, D)) : b || (R = _1(Y, R, y).reduce(function(z, Z) {
          ...
          var te = e8(j, a.filter(function(z) {
        ...
        p && (v === "number" || _ !== "auto") && (F = ei(j, T, "category"));
      } else p ? R = Eu(0, D) : u && u[N] && u[N].hasStack && v === "number" ? R = h === "expand" ? [0, 1] : FO(u[N].stackGroups, s, c) : R = DO(j, a.filter(function(z) {
  ...
  return n.reduce(function(m, E) {
    var v = E.type.defaultProps !== void 0 ? H(H({}, E.type.defaultProps), E.props) : E.props, T = v[o], A = XS("number");
    if (!m[T]) {
      y++;
      var b;
      return g ? b = Eu(0, p) : u && u[T] && u[T].hasStack ? (b = FO(u[T].stackGroups, s, c), b = mp(f, b, T, i)) : (b = Dh(A, DO(h, n.filter(function(_) {
        ...
        hide: !0,
        orientation: xt(y7, "".concat(i, ".").concat(y % 2), null),
        domain: b,
        originalDomain: A,
        isCategorical: g,
        layout: l
  ...
  var n = t.props, a = t.graphicalItems, i = t.xAxisMap, o = i === void 0 ? {} : i, u = t.yAxisMap, s = u === void 0 ? {} : u, c = n.width, l = n.height, f = n.children, h = n.margin || {}, p = At(f, la), g = At(f, Hr), y = Object.keys(s).reduce(function(b, _) {
  ...
  p && (E.bottom += p.props.height || la.defaultProps.height), g && r && (E = Z4(E, a, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(E, v) {
    var T = v.graphicalItems, A = v.stackGroups, b = v.offset, _ = v.updateId, O = v.dataStartIndex, I = v.dataEndIndex, N = E.barSize, j = E.layout, D = E.barGap, R = E.barCategoryGap, B = E.maxBarSize, F = xT(j), $ = F.numericAxisName, q = F.cateAxisName, Y = O7(T), Q = [];
    return T.forEach(function(te, k) {
      var W = Os(E.data, {
        ...
        var ws, Ps, Is = v["".concat(cr.axisType, "Map")], U0 = z["".concat(cr.axisType, "Id")];
        Is && Is[U0] || cr.axisType === "zAxis" || (process.env.NODE_ENV !== "production" ? vt(!1, "Specifying a(n) ".concat(cr.axisType, "Id requires a corresponding ").concat(
          cr.axisType,
      ...
      }, fe), G = ce[q], re = ce["".concat(q, "Ticks")], ie = A && A[oe] && A[oe].hasStack && c8(te, A[oe].stackGroups), M = vr(te.type).indexOf("Bar") >= 0, ye = ou(G, re), X = [], Pe = Y && X4({
        barSize: N,
        stackGroups: A,
        totalSize: x7(ce, q)
      });
      if (M) {
        var De, et, Cr = me(ne) ? B : ne, Cn = (De = (et = ou(G, re, !0)) !== null && et !== void 0 ? et : Cr) !== null && De !== void 0 ? De : 0;
        X = Q4({
          barGap: D,
          barCategoryGap: R,
    ...
    if (!By({
      ...
      return null;
    var O = T.children, I = T.layout, N = T.stackOffset, j = T.data, D = T.reverseStackOrder, R = xT(I), B = R.numericAxisName, F = R.cateAxisName, $ = jt(O, n), q = u8(j, $, "".concat(B, "Id"), "".concat(F, "Id"), N, D), Y = s.reduce(function(z, Z) {
      var ne = "".concat(Z.axisType, "Map");
      return H(H({}, z), {}, se({}, ne, _7(T, H(H({}, Z), {}, {
        graphicalItems: $,
    ...
    var te = Y["".concat(F, "Map")], k = A7(te), W = h(T, H(H({}, Y), {}, {
      dataStartIndex: A,
      dataEndIndex: b,
      updateId: _,
      graphicalItems: $,
    ...
    function E(v) {
      var T, A, b;
      return i7(this, E), b = s7(this, E, [v]), se(b, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(b, "accessibilityManager", new YU()), se(b, "handleLegendBBoxUpdate", function(_) {
        if (_) {
        ...
        var O = JN(_), I = xt(b.props, "".concat(O));
        if (O && de(I)) {
          var N, j;
        ...
        return /* @__PURE__ */ C.createElement(ZU, {
          key: Q,
          activeCoordinate: j,
          activePayload: D,
        ...
        var _ = b.state.formattedGraphicalItems, O = b.props, I = O.children, N = O.width, j = O.height, D = b.props.margin || {}, R = N - (D.left || 0) - (D.right || 0), B = NO({
          children: I,
        ...
        return /* @__PURE__ */ Ue(_, {
          ...
          onChange: bo(b.handleBrushChange, _.props.onChange),
          data: N,
        ...
        j !== "axis" && Y && Y.props.trigger === "click" ? ce = {
          onClick: bo(b.handleItemMouseEnter, _.props.onClick)
        } : j !== "axis" && (ce = {
          onMouseLeave: bo(b.handleItemMouseLeave, _.props.onMouseLeave),
          onMouseEnter: bo(b.handleItemMouseEnter, _.props.onMouseEnter)
        });
        ...
        if (fe)
          if (F >= 0) {
            ...
            var Pe, De = (Pe = b.getItemByXY(b.state.activeCoordinate)) !== null && Pe !== void 0 ? Pe : {
              graphicalItem: G
            }, et = De.graphicalItem, Cr = et.item, Cn = Cr === void 0 ? _ : Cr, ro = et.childIndex, Qr = H(H(H({}, N.props), ce), {}, {
              activeIndex: ro
            });
      ...
      }), b.clipPathId = "".concat((T = v.id) !== null && T !== void 0 ? T : Ki("recharts"), "-clip"), b.throttleTriggeredAfterMouseMove = NA(b.triggeredAfterMouseMove, (A = v.throttleDelay) !== null && A !== void 0 ? A : 1e3 / 60), b.state = {}, b;
    }
    return f7(E, m), u7(E, [{
      key: "componentDidMount",
      value: function() {
      ...
      value: function(T) {
        if (!this.container)
          return null;
        var A = this.container, b = A.getBoundingClientRect(), _ = U6(b), O = {
        ...
        if (!N)
          return null;
        var j = this.state, D = j.xAxisMap, R = j.yAxisMap, B = this.getTooltipEventType(), F = OT(this.state, this.props.data, this.props.layout, N);
        if (B !== "axis" && D && R) {
          ...
          for (var O = 0, I = b.length; O < I; O++) {
            ...
            if (B === "Bar") {
              ...
              return {
                ...
                payload: Bi(N, _) ? R.data[q] : N.props.data[q]
              };
            }
          }
        return null;
      ...
      value: function() {
        ...
        if (!By(this))
          return null;
        var A = this.props, b = A.children, _ = A.className, O = A.width, I = A.height, N = A.style, j = A.compact, D = A.title, R = A.desc, B = _T(A, e7), F = le(B, !1);
        if (j)
          return /* @__PURE__ */ C.createElement(iT, {
            state: this.state,
            width: this.props.width,
            height: this.props.height,
            clipPathId: this.clipPathId
          }, /* @__PURE__ */ C.createElement(nh, Hn({}, F, {
            width: O,
            height: I,
            title: D,
            desc: R
        ...
        return /* @__PURE__ */ C.createElement(iT, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, /* @__PURE__ */ C.createElement("div", Hn({
  ...
  var y = /* @__PURE__ */ RT(function(E, v) {
    return /* @__PURE__ */ C.createElement(g, Hn({}, E, {
      ref: v
    }));
  });
...
const P7 = "funding", I7 = ["Source", "Grants", "Total (GBP)"], C7 = [32, 10, 18], N7 = ["text", "number", "currency"], Gn = new Intl.NumberFormat("en-GB", {
  style: "currency",
  currency: "GBP",
  maximumFractionDigits: 0
});
function DH({ content: e, block: t }) {
  const r = An(P7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Funding received", o = D7(n), u = o.reduce((c, l) => c + l.total, 0);
  ct(
    t,
    "xlsx",
    r && o.length > 0 ? {
  ...
  return ct(
    ...
    r && o.length > 0 ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ta, { widths: [55, 15, 30], borderColor: "cbd5e1", children: [
...
const M7 = "members", $d = ["Name", "Rank", "Department", "Tenured", "Start year"], L7 = [28, 14, 18, 10, 12], k7 = ["text", "text", "text", "text", "number"];
function MH({ content: e, block: t }) {
  const r = An(M7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Members", o = [...n].sort((s, c) => {
  ...
  return ct(
    ...
    r ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ta, { widths: [32, 16, 22, 12, 18], borderColor: "cbd5e1", children: [
...
const j7 = "publications-by-journal", F7 = 10, $7 = ["Venue", "Count"], U7 = [48, 10], H7 = ["text", "number"];
function LH({ content: e, block: t }) {
  const r = An(j7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by journal", u = W7(n, F7, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    r && u.length > 0 ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ta, { widths: [82, 18], borderColor: "cbd5e1", children: [
        /* @__PURE__ */ ee(rt, { header: !0, children: [
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(q7, { counts: u })
  ] }) : null;
}
function q7({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
...
const Y7 = "publications-by-type", wT = [
  "#1e40af",
  // primary
  "#be123c",
  // accent
  ...
  "#64748b"
  // slate (fallback)
], z7 = ["Publication type", "Count"], G7 = [24, 10], K7 = ["text", "number"];
function kH({ content: e, block: t }) {
  const r = An(Y7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by type", u = X7(n, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    r && u.length > 0 ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ta, { widths: [70, 30], borderColor: "cbd5e1", children: [
        /* @__PURE__ */ ee(rt, { header: !0, children: [
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications for the selected population." }) : /* @__PURE__ */ P(V7, { counts: u })
  ] }) : null;
}
function V7({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ P("div", { className: "chart-container", children: /* @__PURE__ */ P(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(w7, { children: [
    /* @__PURE__ */ P(
      Ir,
      {
        data: n,
        ...
        children: n.map((a, i) => /* @__PURE__ */ P(Ju, { fill: wT[i % wT.length] }, i))
      }
    ),
    /* @__PURE__ */ P(
      yt,
...
const Q7 = "publications-by-year", Z7 = ["Year", "Count", "Cumulative"], J7 = [10, 10, 12], eH = ["number", "number", "number"];
function BH({ content: e, block: t }) {
  const r = An(Q7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by year", { series: u, total: s } = rH(n, i);
  return ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
    ...
    r && u.length > 0 ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ta, { widths: [30, 35, 35], borderColor: "cbd5e1", children: [
        /* @__PURE__ */ ee(rt, { header: !0, children: [
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(tH, { series: u })
  ] }) : null;
}
function tH({ series: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ P("div", { className: "chart-container", children: /* @__PURE__ */ P(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(Ss, { data: n, margin: { top: 16, right: 16, bottom: 16, left: 0 }, children: [
    /* @__PURE__ */ P(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
...
function iH(e) {
  return Array.isArray(e) ? e.map((t) => {
    const r = t._author ? nH(t._author) : void 0;
    return aH(t, { defaultAuthor: r });
  }).filter(Boolean) : [];
}
const oH = "publications-list", PT = {
...
async function uH(e) {
  ...
  const t = PT[e] || PT.apa, [{ formatAll: r }, n] = await Promise.all([
    import("./index-CxzhyvpC.js"),
    t()
  ]), a = { formatAll: r, style: n };
  return Ud.set(e, a), a;
}
function jH({ content: e, block: t }) {
  const r = An(oH), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications", u = [...B7(n, i)].sort((y, m) => {
    const E = Number(y.year) || 0;
    return (Number(m.year) || 0) - E;
  }), s = iH(u), c = s.map((y) => y.id).join("|"), [l, f] = ft({ loading: !0, entries: [] });
  Et(() => {
    let y = !1;
    if (!r || s.length === 0) {
      f({ loading: !1, entries: [] });
    ...
    return uH(i.citationStyle).then(({ formatAll: m, style: E }) => {
      if (!y)
        try {
...
const sH = "supervisions", IT = ["#1e40af", "#0f766e", "#ea580c", "#9333ea", "#be123c", "#0ea5e9"];
function FH({ content: e, block: t }) {
  const r = An(sH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Supervisions", { levels: o, rows: u, grandTotal: s } = lH(n), c = ["Member", ...o.map(Ep), "Total"], l = u.map((v) => [
    v.member,
  ...
  return ct(
    ...
    r && u.length > 0 ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ta, { widths: y, borderColor: "cbd5e1", children: [
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No supervisions recorded for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ P(cH, { rows: u, levels: o })
    ] })
  ] }) : null;
}
function cH({ rows: e, levels: t }) {
  const [r, n] = ft(!1);
  if (Et(() => {
    n(!0);
  }, []), !r)
    return /* @__PURE__ */ P("div", { className: "chart-container chart-container-placeholder" });
  const a = e.map((i) => {
    const o = { name: fH(i.member) };
    for (const u of t) o[Ep(u)] = i.counts[u] || 0;
    return o;
  });
  return /* @__PURE__ */ P("div", { className: "chart-container", children: /* @__PURE__ */ P(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(Ss, { data: a, margin: { top: 16, right: 24, bottom: 16, left: 0 }, children: [
    /* @__PURE__ */ P(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
  ...
  return /* @__PURE__ */ ee("div", { className: "query-selector", children: [
    ...
    /* @__PURE__ */ ee(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ P("option", { value: N_, children: "All members" }),
...
const hH = "members";
function pH() {
  const e = UC(hH), [, t] = Mp(), [r, n] = Lp(), [a, i] = ft(() => NT(r, e));
  if (Et(() => {
    i(NT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
function mH({ field: e, def: t, value: r, onChange: n }) {
  const a = t?.label || e;
  switch (t?.type) {
    case "enum":
      ...
      /* @__PURE__ */ ee("label", { className: "report-options-field", children: [
        ...
        /* @__PURE__ */ P(
          "select",
          {
            ...
            onChange: s,
            className: "report-options-input",
            children: zC.map((c) => /* @__PURE__ */ P("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] })
    ] }),
...
function gH() {
  ...
  return /* @__PURE__ */ ee("fieldset", { className: "section-toggles", children: [
    ...
    /* @__PURE__ */ P("div", { className: "section-toggles-list", children: qC.map((n) => /* @__PURE__ */ ee("label", { className: "section-toggles-item", children: [
      /* @__PURE__ */ P(
        "input",
        {
          type: "checkbox",
...
function OH({ body: e, page: t }) {
  ...
  return Et(() => VC(t), [t]), /* @__PURE__ */ ee(JT, { basePath: r.basePath, children: [
    ...
    /* @__PURE__ */ P(AH, { title: n, filename: a })
  ] });
}
const SH = { ...No, vars: Tw || No?.vars, layouts: { MetricsLayout: OH } }, xH = {}, wH = {}, $H = { meta: xH, capabilities: SH, layoutMeta: wH };
export {
  RH as C,
  gr as D,
  DH as F,
...
//# sourceMappingURL=_entry.generated-DPGQ0dFH.js.map
