...
const lC = {
  docx: { load: () => import("./docx-j8YSfbAV.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-C4VYgsGt.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-BJMt0yfL.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-CtBODh08.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-9gct8wdt.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = lC[e];
  return t ? {
...
const IC = /(<a\b[^>]*?\shref=)(["'])((?:page|topic):[^"']*)\2/gi;
function CC(e, t) {
  return !e || typeof e != "string" || !e.includes("page:") && !e.includes("topic:") ? e : e.replace(
    IC,
    (r, n, a, i) => `${n}${a}${t.makeHref(i)}${a}`
  );
}
function NC({ value: e, className: t, as: r = "div", ...n }) {
...
function ln(e, t) {
  const { website: r } = Fu(), [, n] = ZS(DC, 0), i = r.activePage?.state;
  Et(() => {
    if (i)
...
const I_ = "academic-metrics/options", Rp = "all-members", C_ = Rp, MC = [
  "members",
...
function $C(e) {
  ...
  const r = () => FC(e), n = Sm.map((a) => e.state.subscribe(a, r));
...
function AH({ content: e, block: t }) {
  ...
  return ct(t, "xlsx", {
    ...
    /* @__PURE__ */ ee("div", { className: "cover-meta", role: "list", children: [
      ...
      /* @__PURE__ */ P(oo, { label: "Funding", value: qC(s) }),
...
function xr() {
  if (Rm) return Fs;
  Rm = 1;
  var e = zi(), t = WC(), r = YC(), n = "[object Null]", a = "[object Undefined]", i = e ? e.toStringTag : void 0;
  function o(u) {
...
function KC() {
  if (Um) return Ks;
  Um = 1;
  var e = kp(), t = GC(), r = Gr(), n = R_(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, u = Object.prototype, s = o.toString, c = u.hasOwnProperty, l = RegExp(
...
function pN() {
  if (yy) return Ac;
  yy = 1;
  var e = hN(), t = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, n = e(function(a) {
    var i = [];
...
var EN = vN();
const mn = /* @__PURE__ */ xe(EN);
var TN = kp();
const de = /* @__PURE__ */ xe(TN);
var _N = Gr();
const _a = /* @__PURE__ */ xe(_N);
var so = { exports: {} }, ve = {};
var xy;
function AN() {
  if (xy) return ve;
...
var Py;
function SN() {
  return Py || (Py = 1, process.env.NODE_ENV === "production" ? so.exports = AN() : so.exports = ON()), so.exports;
}
var xN = SN(), Dc, Iy;
function B_() {
  if (Iy) return Dc;
...
var PN = wN();
const Gi = /* @__PURE__ */ xe(PN);
var IN = B_();
const CN = /* @__PURE__ */ xe(IN);
var dt = function(t) {
...
var LN = ["viewBox", "children"], kN = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    Hp.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = BN(o, r, n));
  }), a;
}, jN = ["children"], FN = ["children"];
function Ry(e, t) {
  if (e == null) return {};
  var r = $N(e, t), n, a;
...
var Dy = {
  ...
  return $r.forEach(t, function(n) {
    me(n) || (xN.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), kc = r, My = t, r;
};
function jt(e, t) {
  var r = [], n = [];
...
var Ly = function(t) {
...
}, UN = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], HN = function(t) {
  return t && t.type && mn(t.type) && UN.indexOf(t.type) >= 0;
}, qN = function(t, r, n, a) {
  var i, o = (i = Lc?.[a]) !== null && i !== void 0 ? i : [];
  return r.startsWith("data-") || !de(t) && (a && o.includes(r) || kN.includes(r)) || n && Hp.includes(r);
}, le = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  return Object.keys(a).forEach(function(o) {
    var u;
    qN((u = a) === null || u === void 0 ? void 0 : u[o], o, r, n) && (i[o] = a[o]);
  }), i;
}, th = function e(t, r) {
  if (t === r)
    return !0;
  ...
  if (me(t) && me(r))
    return !0;
  if (!me(t) && !me(r)) {
    var n = t.props || {}, a = n.children, i = Ry(n, jN), o = r.props || {}, u = o.children, s = Ry(o, FN);
...
function nh(e) {
  var t = e.children, r = e.width, n = e.height, a = e.viewBox, i = e.className, o = e.style, u = e.title, s = e.desc, c = GN(e, zN), l = a || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
var Oe = /* @__PURE__ */ C.forwardRef(function(e, t) {
  var r = e.children, n = e.className, a = XN(e, VN), i = pe("recharts-layer", n);
  return /* @__PURE__ */ C.createElement("g", ah({
    className: i
  }, le(a, !0), {
    ref: t
  }), r);
}), ZN = process.env.NODE_ENV !== "production", zt = function(t, r) {
  for (var n = arguments.length, a = new Array(n > 2 ? n - 2 : 0), i = 2; i < n; i++)
    a[i - 2] = arguments[i];
  if (ZN && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
...
function i3() {
  if (Yy) return Wc;
  Yy = 1;
  var e = a3(), t = e("toUpperCase");
  return Wc = t, Wc;
}
var o3 = i3();
const Yu = /* @__PURE__ */ xe(o3);
function Ce(e) {
  return function() {
    return e;
  };
}
const F_ = Math.cos, Lo = Math.sin, Qt = Math.sqrt, ko = Math.PI, zu = 2 * ko, ih = Math.PI, oh = 2 * ih, tn = 1e-6, u3 = oh - tn;
function $_(e) {
  this._ += e[0];
...
class c3 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? $_ : s3(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${l}` : (Math.abs(this._x1 - c) > tn || Math.abs(this._y1 - l) > tn) && this._append`L${c},${l}`, n && (h < 0 && (h = h % oh + oh), h > u3 ? this._append`A${n},${n},0,1,${f},${t - u},${r - s}A${n},${n},0,1,${f},${this._x1 = c},${this._y1 = l}` : h > tn && this._append`A${n},${n},0,${+(h >= ih)},${f},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
}, z_ = Qt(1 / 3), h3 = z_ * 2, p3 = {
  draw(e, t) {
    const r = Qt(t / h3), n = r * z_;
...
}, y3 = 0.8908130915292852, G_ = Lo(ko / 10) / Lo(7 * ko / 10), b3 = Lo(zu / 10) * G_, g3 = -F_(zu / 10) * G_, v3 = {
  draw(e, t) {
    const r = Qt(t * y3), n = b3 * r, a = g3 * r;
...
}, Pt = -0.5, It = Qt(3) / 2, uh = 1 / Qt(12), T3 = (uh / 2 + 1) * 3, _3 = {
  draw(e, t) {
    const r = Qt(t / T3), n = r / 2, a = r * uh, i = n, o = r * uh + r, u = -i, s = o;
...
function k3() {
  var e = Ce([]), t = sh, r = Vn, n = M3;
  function a(i) {
    var o = Array.from(e.apply(this, arguments), L3), u, s = o.length, c = -1, l;
    for (const f of i)
      for (u = 0, ++c; u < s; ++u)
...
var tA = {
  ...
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, u = o === void 0 ? "area" : o, s = W3(t, $3), c = Qy(Qy({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), l = function() {
    var m = G3(n), v = A3().type(m).size(K3(i, u, n));
    return v();
...
function J3(e, t, r) {
  return t && Z3(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function eR(e, t, r) {
  return t = $o(t), tR(e, rA() ? Reflect.construct(t, r || [], $o(e).constructor) : t.apply(e, r));
}
function tR(e, t) {
...
var Ct = 32, Kp = /* @__PURE__ */ (function(e) {
  function t() {
    return Q3(this, t), eR(this, t, arguments);
  }
  return nR(t, e), J3(t, [{
    key: "renderIcon",
    value: (
...
function aA() {
  if (ab) return Zc;
  ab = 1;
  var e = Hu(), t = iR(), r = oR(), n = uR(), a = sR(), i = cR();
  function o(u) {
...
function pR() {
  if (pb) return sl;
  pb = 1;
  var e = zi(), t = dR(), r = Bp(), n = sA(), a = hR(), i = Vp(), o = 1, u = 2, s = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", h = "[object Number]", p = "[object RegExp]", g = "[object Set]", y = "[object String]", m = "[object Symbol]", v = "[object ArrayBuffer]", E = "[object DataView]", _ = e ? e.prototype : void 0, A = _ ? _.valueOf : void 0;
...
function gR() {
  if (vb) return hl;
  vb = 1;
  var e = yR(), t = bR(), r = Object.prototype, n = r.propertyIsEnumerable, a = Object.getOwnPropertySymbols, i = a ? function(o) {
...
function Xp() {
  if (_b) return yl;
  _b = 1;
  var e = ER(), t = wr(), r = Object.prototype, n = r.hasOwnProperty, a = r.propertyIsEnumerable, i = e(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? e : function(o) {
...
function lA() {
  return Ob || (Ob = 1, (function(e, t) {
    var r = or(), n = TR(), a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, o = i && i.exports === a, u = o ? r.Buffer : void 0, s = u ? u.isBuffer : void 0, c = s || n;
    e.exports = c;
...
function dA() {
  if (Cb) return _l;
  Cb = 1;
  var e = _R(), t = fA(), r = AR(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return _l = a, _l;
}
var Al, Nb;
function OR() {
  if (Nb) return Al;
  Nb = 1;
  var e = vR(), t = Xp(), r = Tt(), n = lA(), a = Qp(), i = dA(), o = Object.prototype, u = o.hasOwnProperty;
  function s(c, l) {
...
function wR() {
  if (Lb) return wl;
  Lb = 1;
  var e = SR(), t = xR(), r = Object.prototype, n = r.hasOwnProperty;
  function a(i) {
    if (!e(i))
      return t(i);
    var o = [];
...
function IR() {
  if (Fb) return Nl;
  Fb = 1;
  var e = PR(), t = 1, r = Object.prototype, n = r.hasOwnProperty;
...
function DR() {
  if (Wb) return kl;
  Wb = 1;
  var e = CR(), t = jp(), r = NR(), n = pA(), a = RR(), i = xr(), o = R_(), u = "[object Map]", s = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", h = "[object DataView]", p = o(e), g = o(t), y = o(r), m = o(n), v = o(a), E = i;
...
function MR() {
  if (Yb) return Bl;
  Yb = 1;
  var e = aA(), t = sA(), r = pR(), n = IR(), a = DR(), i = Tt(), o = lA(), u = dA(), s = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", h = Object.prototype, p = h.hasOwnProperty;
...
function UR() {
  if (tg) return Gl;
  tg = 1;
  var e = Jp(), t = k_(), r = $R(), n = Lp(), a = mA(), i = yA(), o = Wu(), u = 1, s = 2;
  function c(l, f) {
...
function QR() {
  if (pg) return uf;
  pg = 1;
  var e = pA(), t = XR(), r = Vp(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return uf = a, uf;
}
...
function ZR() {
  if (mg) return sf;
  mg = 1;
  var e = iA(), t = KR(), r = VR(), n = uA(), a = QR(), i = Vp(), o = 200;
  function u(s, c, l) {
...
function aD(e, t, r) {
  return t = Uo(t), iD(e, vA() ? Reflect.construct(t, r || [], Uo(e).constructor) : t.apply(e, r));
}
function iD(e, t) {
...
var Eg = 1, Hr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = aD(this, t, [].concat(a)), Xu(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
...
function ED() {
  if (Rg) return Tf;
  Rg = 1;
  var e = $p(), t = Up(), r = ur(), n = AA(), a = bD(), i = fA(), o = vD(), u = Aa(), s = Tt();
  function c(l, f, h) {
...
function OD() {
  if (Bg) return xf;
  Bg = 1;
  var e = AD(), t = OA(), r = Aa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function PD() {
  if (Hg) return Nf;
  Hg = 1;
  var e = TA(), t = ED(), r = wD(), n = Qu(), a = r(function(i, o) {
    if (i == null)
      return [];
    var u = o.length;
    ...
    if (l && l.length) {
      var R = {
        ...
        var q = Rf({
          ...
          paddingBottom: 4,
          color: F.color || "#000"
        }, u), Y = F.formatter || f || jD, Q = F.value, te = F.name, k = Q, W = te;
        if (Y && k != null && W != null) {
          var z = Y(Q, te, F, $, l);
          if (Array.isArray(z)) {
            var Z = CD(z, 2);
...
var Da = "recharts-tooltip-wrapper", HD = {
  visibility: "hidden"
};
function qD(e) {
...
function VD(e, t, r) {
  return t = Ho(t), XD(e, SA() ? Reflect.construct(t, r || [], Ho(e).constructor) : t.apply(e, r));
}
function XD(e, t) {
...
var Kg = 1, e6 = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    zD(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = VD(this, t, [].concat(a)), mh(r, "state", {
      dismissed: !1,
  ...
  return ZD(t, e), KD(t, [{
    ...
    key: "render",
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, u = a.animationDuration, s = a.animationEasing, c = a.children, l = a.coordinate, f = a.hasPayload, h = a.isAnimationActive, p = a.offset, g = a.position, y = a.reverseDirection, m = a.useTranslate3d, v = a.viewBox, E = a.wrapperStyle, _ = YD({
...
function i6(e, t, r) {
  return t = qo(t), o6(e, wA() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function o6(e, t) {
...
function f6(e, t) {
  return /* @__PURE__ */ C.isValidElement(e) ? /* @__PURE__ */ C.cloneElement(e, t) : typeof e == "function" ? /* @__PURE__ */ C.createElement(e, t) : /* @__PURE__ */ C.createElement(FD, t);
}
var yt = /* @__PURE__ */ (function(e) {
  function t() {
    return r6(this, t), i6(this, t, arguments);
  }
  return s6(t, e), a6(t, [{
    key: "render",
    value: function() {
      ...
      var T = b.length > 0;
      return /* @__PURE__ */ C.createElement(e6, {
        allowEscapeViewBox: o,
        animationDuration: u,
        animationEasing: s,
        isAnimationActive: h,
...
function IA() {
  if (ev) return kf;
  ev = 1;
  var e = p6(), t = Gr(), r = Ta(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, u = parseInt;
  function s(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function m6() {
  if (tv) return Bf;
  tv = 1;
  var e = Gr(), t = d6(), r = IA(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(u, s, c) {
...
function y6() {
  if (rv) return jf;
  rv = 1;
  var e = m6(), t = Gr(), r = "Expected a function";
  function n(a, i, o) {
    var u = !0, s = !0;
...
var Xi = /* @__PURE__ */ CT(function(e, t) {
  ...
  }), I = T6(O, 2), N = I[0], j = I[1], D = ex(function(B, F) {
    j(function($) {
...
function x6(e, t, r) {
  return t = w6(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function w6(e) {
  var t = P6(e, "string");
...
var Za = function(t) {
  ...
  try {
    ...
    return Cn.widthCache[a] = s, ++Cn.cacheCount > I6 && (Cn.cacheCount = 0, Cn.widthCache = {}), s;
  } catch {
    return {
      width: 0,
      height: 0
...
function sv(e, t) {
  for (var r = 0; r < t.length; r++) {
    var n = t[r];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, F6(n.key), n);
  }
}
function j6(e, t, r) {
...
var cv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, lv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, U6 = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, H6 = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, NA = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, q6 = Object.keys(NA), Bn = "NaN";
function W6(e, t) {
  return e * NA[t];
}
var ho = /* @__PURE__ */ (function() {
  function e(t, r) {
    B6(this, e), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !U6.test(r) && (this.num = NaN, this.unit = ""), q6.includes(r) && (this.num = W6(t, r), this.unit = "px");
  }
  return j6(e, [{
    key: "add",
    value: function(r) {
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = H6.exec(r)) !== null && n !== void 0 ? n : [], i = Wo(a, 3), o = i[1], u = i[2];
...
var K6 = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], V6 = ["dx", "dy", "angle", "className", "breakAll"];
function gh() {
...
var DA = /[ \f\n\r\t\v\u2028\u2029]+/, MA = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, l = t.scaleToFit, f = l === void 0 ? !1 : l, h = t.textAnchor, p = h === void 0 ? "start" : h, g = t.verticalAnchor, y = g === void 0 ? "end" : g, m = t.fill, v = m === void 0 ? yv : m, E = dv(t, K6), _ = Fr(function() {
    return rM({
      breakAll: E.breakAll,
      children: E.children,
      maxLines: E.maxLines,
  ...
  }, [E.breakAll, E.children, E.maxLines, f, E.style, E.width]), A = E.dx, b = E.dy, T = E.angle, O = E.className, I = E.breakAll, N = dv(E, V6);
  if (!ze(n) || !ze(i))
    return null;
...
function n0(e) {
  let t, r, n;
  e.length !== 2 ? (t = qr, r = (u, s) => qr(e(u), s), n = (u, s) => e(u) - s) : (t = e === qr || e === nM ? e : aM, r = e, n = e);
...
const fM = Math.sqrt(50), dM = Math.sqrt(10), hM = Math.sqrt(2);
function Yo(e, t, r) {
  const n = (t - e) / Math.max(0, r), a = Math.floor(Math.log10(n)), i = n / Math.pow(10, a), o = i >= fM ? 10 : i >= dM ? 5 : i >= hM ? 2 : 1;
  let u, s, c;
...
function pM(e, t, r) {
  if (e = Float64Array.from(iM(e)), !(!(n = e.length) || isNaN(t = +t))) {
...
var bi = 0.7, zo = 1 / bi, Wn = "\\s*([+-]?\\d+)\\s*", gi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", bM = /^#([0-9a-f]{3,8})$/, gM = new RegExp(`^rgb\\(${Wn},${Wn},${Wn}\\)$`), vM = new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`), EM = new RegExp(`^rgba\\(${Wn},${Wn},${Wn},${gi}\\)$`), TM = new RegExp(`^rgba\\(${rr},${rr},${rr},${gi}\\)$`), _M = new RegExp(`^hsl\\(${gi},${rr},${rr}\\)$`), AM = new RegExp(`^hsla\\(${gi},${rr},${rr},${gi}\\)$`), Tv = {
  aliceblue: 15792383,
...
function vi(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = bM.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? Ov(t) : r === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? po(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? po(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = gM.exec(e)) ? new gt(t[1], t[2], t[3], 1) : (t = vM.exec(e)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = EM.exec(e)) ? po(t[1], t[2], t[3], t[4]) : (t = TM.exec(e)) ? po(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = _M.exec(e)) ? wv(t[1], t[2] / 100, t[3] / 100, 1) : (t = AM.exec(e)) ? wv(t[1], t[2] / 100, t[3] / 100, t[4]) : Tv.hasOwnProperty(e) ? Ov(Tv[e]) : e === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function Ov(e) {
...
function Ah(e, t, r, n) {
  return arguments.length === 1 ? xM(e) : new gt(e, t, r, n ?? 1);
}
function gt(e, t, r, n) {
...
function NM(e) {
  return (e = +e) == 1 ? UA : function(t, r) {
    return r - t ? CM(t, r, e) : o0(isNaN(t) ? r : t);
  };
}
function UA(e, t) {
  var r = t - e;
  return r ? IM(e, r) : o0(isNaN(e) ? t : e);
}
...
function FM(e, t) {
  ...
  return r < t.length && (i = t.slice(r), u[o] ? u[o] += i : u[++o] = i), u.length < 2 ? s[0] ? jM(s[0].x) : BM(t) : (t = s.length, function(c) {
...
function Sa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? o0(t) : (r === "number" ? Ko : r === "string" ? (n = vi(t)) ? (t = n, Iv) : FM : t instanceof vi ? Iv : t instanceof Date ? LM : DM(t) ? RM : Array.isArray(t) ? MM : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? kM : Ko)(e, t);
}
function u0(e, t) {
  return e = +e, t = +t, function(r) {
...
function Ju() {
  ...
  function l() {
    ...
    return o !== pt && (o = HM(e[0], e[h - 1])), u = h > 2 ? WM : qM, s = c = null, f;
  }
  function f(h) {
...
function QM(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? Dv : zM(Mv.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? Dv : GM(Mv.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", u = e.minus === void 0 ? "−" : e.minus + "", s = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f, h) {
    f = Ei(f);
    ...
    function D(R) {
      ...
      if (T === "c")
        ...
        R = +R;
        var Q = R < 0 || 1 / R < 0;
        if (R = isNaN(R) ? s : N(Math.abs(R), A), b && (R = VM(R)), Q && +R == 0 && y !== "+" && (Q = !1), B = (Q ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + B, F = (T === "s" && !isNaN(R) && Qo !== void 0 ? Lv[8 + Qo / 3] : "") + F + (Q && y === "(" ? ")" : ""), j) {
          for ($ = -1, q = R.length; ++$ < q; )
...
function ZM(e) {
  return yo = QM(e), l0 = yo.format, HA = yo.formatPrefix, yo;
}
function JM(e) {
...
function qA(e, t, r, n) {
  ...
  switch (n = Ei(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = eL(a, o)) && (n.precision = i), HA(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(i = tL(a, Math.max(Math.abs(e), Math.abs(t)))) && (n.precision = i - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
      n.precision == null && !isNaN(i = JM(a)) && (n.precision = i - (n.type === "%") * 2);
      break;
    }
  }
  return l0(n);
...
function f0(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = oL(n), i = iL(n), r()[0] < 0 ? (a = jv(a), i = jv(i), e(rL, nL)) : e(kv, Bv), t;
  }
...
function h0(e) {
  var t = e(pt, pt), r = 1;
  function n() {
    return r === 1 ? e(pt, pt) : r === 0.5 ? e(uL, sL) : e(Uv(r), Uv(1 / r));
  }
...
function VA() {
  ...
  function a() {
    ...
    for (r = new Array(u - 1); ++o < u; ) r[o - 1] = mM(e, o / u);
    return i;
  }
  function i(o) {
...
const ts = On(0), eu = On(1), fL = On(2), dL = On(3), ta = On(4), hL = On(5), pL = On(6);
ts.range;
eu.range;
fL.range;
dL.range;
...
const rs = Sn(0), tu = Sn(1), mL = Sn(2), yL = Sn(3), ra = Sn(4), bL = Sn(5), gL = Sn(6);
rs.range;
tu.range;
mL.range;
yL.range;
...
const [vL, EL] = JA(Or, T0, rs, ZA, v0, b0), [TL, _L] = JA(Ar, E0, ts, eo, g0, y0);
function Yf(e) {
  if (0 <= e.y && e.y < 100) {
...
function Ak(e) {
  return Nn = AL(e), aO = Nn.format, Nn.parse, iO = Nn.utcFormat, Nn.utcParse, Nn;
}
function Ok(e) {
  return new Date(e);
}
...
function _0(e, t, r, n, a, i, o, u, s, c) {
  ...
  return l.invert = function(T) {
    ...
    return arguments.length ? h(Array.from(T, Sk)) : h().map(Ok);
  }, l.ticks = function(T) {
    var O = h();
...
function xk() {
  return Ut.apply(_0(TL, _L, Ar, E0, ts, eo, g0, y0, un, aO).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function wk() {
  return Ut.apply(_0(vL, EL, Or, T0, rs, es, v0, b0, un, iO).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function ns() {
...
function as() {
  ...
  function g(y) {
    return function(m) {
      var v, E, _;
      return arguments.length ? ([v, E, _] = m, c = $M(y, [v, E, _]), p) : [c(0), c(0.5), c(1)];
    };
  }
...
}, x0, Le = !0, Ft = "[DecimalError] ", dn = Ft + "Invalid argument: ", S0 = Ft + "Exponent out of range: ", wa = Math.floor, rn = Math.pow, Uk = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ot, Xe = 1e7, Re = 7, mO = 9007199254740991, ru = wa(mO / Re), ae = {};
...
function vO(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(dn + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, Uk.test(i)) c1(o, i);
    else throw Error(dn + i);
  }
  if (a.prototype = ae, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = vO, a.config = a.set = Hk, e === void 0 && (e = {}), e)
...
var Kk = function(t) {
  ...
  return t === 1 ? r : f1(function() {
    ...
    return o >= t ? r.apply(void 0, a) : e(t - o, f1(function() {
      ...
      return r.apply(void 0, qk(l).concat(s));
    }));
  });
}, cs = function(t) {
  return Vk(t.length, t);
}, wh = function(t, r) {
  for (var n = [], a = t; a < r; ++a)
    n[a - t] = a;
  return n;
...
var e4 = cs(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), t4 = cs(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), r4 = cs(function(e, t, r) {
  var n = t - +e;
...
const ls = {
  rangeStep: Jk,
  getDigitCount: Zk,
  interpolateNumber: e4,
  uninterpolateNumber: t4,
  uninterpolateTruncation: r4
};
function Ih(e) {
  return i4(e) || a4(e) || AO(e) || n4();
}
function n4() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function c4(e, t, r) {
  ...
  var o = Math.floor((t - 1) / 2), u = Qk(Xk(function(s) {
...
var d4 = _O(l4), h4 = _O(f4), p4 = process.env.NODE_ENV === "production", rd = "Invariant failed";
function vt(e, t) {
  if (p4)
    throw new Error(rd);
...
var m4 = ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"];
function na(e) {
  "@babel/helpers - typeof";
...
function x4(e, t, r) {
  return t = au(t), w4(e, wO() ? Reflect.construct(t, r || [], au(e).constructor) : t.apply(e, r));
}
function w4(e, t) {
...
var fs = /* @__PURE__ */ (function(e) {
  function t() {
    return A4(this, t), x4(this, t, arguments);
  }
  return I4(t, e), S4(t, [{
    key: "render",
    value: function() {
      var n = this.props, a = n.offset, i = n.layout, o = n.width, u = n.dataKey, s = n.data, c = n.dataPointFormatter, l = n.xAxis, f = n.yAxis, h = T4(n, m4), p = le(h, !1);
...
var $4 = function(t) {
  ...
  }), i = X4[n], o = k3().keys(a).value(function(u, s) {
    return +ut(u, s, 0);
  }).order(sh).offset(i);
  return o(t);
}, Z4 = function(t, r, n, a, i, o) {
  if (!t)
    return null;
...
var ou = Math.PI / 180, c8 = function(t) {
  ...
  var n = t.x, a = t.y, i = r.cx, o = r.cy, u = f8({
    x: n,
    y: a
  }, {
    x: i,
  ...
  if (o === 0)
    return !0;
  var l = h8(r), f = l.startAngle, h = l.endAngle, p = u, g;
  if (f <= h) {
    for (; p > h; )
      p -= 360;
    for (; p < f; )
...
var x8 = function(t) {
  ...
  var a = t.position, i = t.viewBox, o = t.offset, u = t.className, s = i, c = s.cx, l = s.cy, f = s.innerRadius, h = s.outerRadius, p = s.startAngle, g = s.endAngle, y = s.clockWise, m = (f + h) / 2, v = w8(p, g), E = v >= 0 ? 1 : -1, _, A;
...
function Qe(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = T8(e, m8), a = We({
    offset: r
...
var qO = function(t) {
  ...
  if (!n)
    return o;
  var u = R8(t.label, r || i);
  return [u].concat(y8(o));
};
Qe.parseViewBox = qO;
Qe.renderCallByParent = D8;
var ad, S1;
function M8() {
  if (S1) return ad;
  S1 = 1;
...
var B8 = ["valueAccessor"], j8 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function F8(e) {
  return q8(e) || H8(e) || U8(e) || $8();
}
function $8() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var K8 = function(t) {
  return Array.isArray(t.value) ? k8(t.value) : t.value;
};
function Gt(e) {
  var t = e.valueAccessor, r = t === void 0 ? K8 : t, n = P1(e, B8), a = n.data, i = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = P1(n, j8);
...
function X8(e, t) {
  ...
  if (!r)
    return a;
  var i = V8(e.label, t);
  return [i].concat(F8(a));
}
Gt.renderCallByParent = X8;
function Ii(e) {
  "@babel/helpers - typeof";
...
var eB = function(t, r) {
  ...
  var r = t.cx, n = t.cy, a = t.innerRadius, i = t.outerRadius, o = t.startAngle, u = t.endAngle, s = eB(o, u), c = o + s, l = Ne(r, n, i, o), f = Ne(r, n, i, c), h = "M ".concat(l.x, ",").concat(l.y, `
  ...
  var r = C1(C1({}, rB), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < i || l === f)
    return null;
  var p = pe("recharts-sector", h), g = o - i, y = ht(u, g, 0, !0), m;
  return y > 0 && Math.abs(l - f) < 360 ? m = tB({
    cx: n,
    cy: a,
    innerRadius: i,
    outerRadius: o,
...
var D1 = {
  ...
  var r = t.type, n = r === void 0 ? "linear" : r, a = t.points, i = a === void 0 ? [] : a, o = t.baseLine, u = t.layout, s = t.connectNulls, c = s === void 0 ? !1 : s, l = oB(n, u), f = c ? i.filter(function(y) {
    return vo(y);
  }) : i, h;
  if (Array.isArray(o)) {
...
var k1;
function zO() {
  return k1 || (k1 = 1, process.env.NODE_ENV === "production" ? To.exports = sB() : To.exports = cB()), To.exports;
}
var id, B1;
function lB() {
  if (B1) return id;
...
function dB() {
  if (U1) return cd;
  U1 = 1;
  var e = zO(), t = lB(), r = /* @__PURE__ */ P0(), n = /* @__PURE__ */ GO(), a = /* @__PURE__ */ fB(), i = function() {
  };
...
function pB() {
  ...
  if (q1 = 1, process.env.NODE_ENV !== "production") {
    var e = zO(), t = !0;
    Eo.exports = /* @__PURE__ */ dB()(e.isElement, t);
  } else
    Eo.exports = /* @__PURE__ */ hB()();
  return Eo.exports;
}
var mB = /* @__PURE__ */ pB();
const Ae = /* @__PURE__ */ xe(mB), { getOwnPropertyNames: yB, getOwnPropertySymbols: bB } = Object, { hasOwnProperty: gB } = Object.prototype;
function fd(e, t) {
...
function W1(e) {
  return yB(e).concat(bB(e));
}
const EB = (
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  Object.hasOwn || ((e, t) => gB.call(e, t))
);
function xn(e, t) {
  return e === t || !e && !t && e !== e && t !== t;
}
const TB = "__v", _B = "__o", AB = "_owner", { getOwnPropertyDescriptor: Y1, keys: z1 } = Object;
function OB(e, t) {
...
function KO(e, t, r, n) {
  return (n === AB || n === _B || n === TB) && (e.$$typeof || t.$$typeof) ? !0 : EB(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
const LB = "[object ArrayBuffer]", kB = "[object Arguments]", BB = "[object Boolean]", jB = "[object DataView]", FB = "[object Date]", $B = "[object Error]", UB = "[object Map]", HB = "[object Number]", qB = "[object Object]", WB = "[object RegExp]", YB = "[object Set]", zB = "[object String]", GB = {
  "[object Int8Array]": !0,
  "[object Uint8Array]": !0,
...
}, KB = "[object URL]", VB = Object.prototype.toString;
function XB({ areArrayBuffersEqual: e, areArraysEqual: t, areDataViewsEqual: r, areDatesEqual: n, areErrorsEqual: a, areFunctionsEqual: i, areMapsEqual: o, areNumbersEqual: u, areObjectsEqual: s, arePrimitiveWrappersEqual: c, areRegExpsEqual: l, areSetsEqual: f, areTypedArraysEqual: h, areUrlsEqual: p, unknownTagComparators: g }) {
...
function QB({ circular: e, createCustomConfig: t, strict: r }) {
  let n = {
    areArrayBuffersEqual: OB,
    areArraysEqual: r ? $a : SB,
    areDataViewsEqual: xB,
    areDatesEqual: wB,
    areErrorsEqual: PB,
    areFunctionsEqual: IB,
    areMapsEqual: r ? fd(G1, $a) : G1,
    areNumbersEqual: CB,
    areObjectsEqual: r ? $a : NB,
    arePrimitiveWrappersEqual: RB,
    areRegExpsEqual: DB,
...
function JB({ circular: e, comparator: t, createState: r, equals: n, strict: a }) {
  if (r)
    return function(u, s) {
...
function Xr(e = {}) {
  const { circular: t = !1, createInternalComparator: r, createState: n, strict: a = !1 } = e, i = QB(e), o = XB(i), u = r ? r(o) : ZB(o);
  return JB({ circular: t, comparator: o, createState: n, equals: u, strict: a });
}
function t5(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(i)) {
        if (!i.length)
          return;
        var o = i, u = r5(o), s = u[0], c = u.slice(1);
        if (typeof s == "number") {
          V1(a.bind(null, c), s);
          return;
        }
...
var l5 = function(t, r) {
  ...
  return t.map(function(a) {
    return "".concat(d5(a), " ").concat(r, "ms ").concat(n);
  }).join(",");
}, h5 = process.env.NODE_ENV !== "production", cu = function(t, r, n, a, i, o, u, s) {
  if (h5 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
      console.warn("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
    else {
...
var lu = 1e-4, QO = function(t, r) {
  ...
  return function(n) {
    var a = QO(t, r), i = [].concat(g5(a.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return ZO(i, n);
  };
  ...
  var f = eE(a, o), h = eE(i, u), p = _5(a, o), g = function(v) {
...
var fu = function(t, r, n) {
  ...
  var a = ti(function(i, o) {
    if (qh(o)) {
      var u = t(o.from, o.to, o.velocity), s = C5(u, 2), c = s[0], l = s[1];
      return tt(tt({}, o), {}, {
        from: c,
        velocity: l
      });
...
const L5 = (function(e, t, r, n, a) {
  var i = l5(e, t), o = i.reduce(function(m, v) {
    ...
    c || (c = v);
    var E = v - c, _ = E / r.dt;
    u = M5(r, u, _), a(tt(tt(tt({}, e), t), h())), c = v, p() || (s = requestAnimationFrame(f));
  }, y = function(v) {
    l || (l = v);
...
var k5 = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function B5(e, t) {
  if (e == null) return {};
  var r = j5(e, t), n, a;
  if (Object.getOwnPropertySymbols) {
  ...
  return Y5(r, [{
    ...
    value: function(a) {
      ...
      if (u) {
        ...
        if (!(e5(a.to, l) && a.canBegin && a.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(a) {
      var i = this, o = a.from, u = a.to, s = a.duration, c = a.easing, l = a.begin, f = a.onAnimationEnd, h = a.onAnimationStart, p = L5(o, u, O5(c), s, this.changeStyle), g = function() {
        i.stopJSAnimation = p();
      };
    ...
    value: function(a) {
      var i = this, o = a.steps, u = a.begin, s = a.onAnimationStart, c = o[0], l = c.style, f = c.duration, h = f === void 0 ? 0 : f, p = function(y, m, v) {
        ...
        return [].concat(dd(y), [D, E, O]).filter(f5);
      };
    ...
    value: function() {
      ...
      var s = B5(a, k5), c = $r.count(i), l = this.state.style;
      if (typeof i == "function")
        return i(l);
      if (!u || c === 0 || o <= 0)
        return i;
...
var sE = function(t, r, n, a, i) {
  ...
  var r = uE(uE({}, ij), t), n = ii(), a = ft(-1), i = X5(a, 2), o = i[0], u = i[1];
  Et(function() {
...
}, oj = ["points", "className", "baseLinePoints", "connectNulls"];
function jn() {
...
var lE = function(t) {
  ...
  var r = t.points, n = t.className, a = t.baseLinePoints, i = t.connectNulls, o = uj(t, oj);
  if (!r || !r.length)
    return null;
...
var yj = ["x", "y", "top", "left", "width", "height", "className"];
function Xh() {
...
var Aj = function(t, r, n, a, i, o) {
  return "M".concat(t, ",").concat(i, "v").concat(a, "M").concat(o, ",").concat(r, "h").concat(n);
}, Oj = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.top, u = o === void 0 ? 0 : o, s = t.left, c = s === void 0 ? 0 : s, l = t.width, f = l === void 0 ? 0 : l, h = t.height, p = h === void 0 ? 0 : h, g = t.className, y = Tj(t, yj), m = bj({
    x: n,
    y: i,
    top: u,
    left: c,
...
var Nj = ["cx", "cy", "angle", "ticks", "axisLine"], Rj = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function ia(e) {
  "@babel/helpers - typeof";
...
function kj(e, t, r) {
  return t = pu(t), Bj(e, tS() ? Reflect.construct(t, r || [], pu(e).constructor) : t.apply(e, r));
}
function Bj(e, t) {
...
var hs = /* @__PURE__ */ (function(e) {
  ...
  return Fj(t, e), Lj(t, [{
    ...
    key: "getViewBox",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = wj(u, function(l) {
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = n.axisLine, c = mE(n, Nj), l = u.reduce(function(g, y) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.angle, s = a.tickFormatter, c = a.stroke, l = mE(a, Rj), f = this.getTickTextAnchor(), h = le(l, !1), p = le(o, !1), g = i.map(function(y, m) {
...
function qj(e, t, r) {
  return t = mu(t), Wj(e, nS() ? Reflect.construct(t, r || [], mu(e).constructor) : t.apply(e, r));
}
function Wj(e, t) {
...
var Kj = Math.PI / 180, vE = 1e-5, ms = /* @__PURE__ */ (function(e) {
  function t() {
  ...
  return zj(t, e), Hj(t, [{
    ...
    key: "getTickTextAnchor",
    value: function(n) {
      var a = this.props.orientation, i = Math.cos(-n.coordinate * Kj), o;
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(mj, nn({
        className: "recharts-polar-angle-axis-line"
      }, c, {
        points: f
      }));
...
function Xj() {
  if (TE) return yd;
  TE = 1;
  var e = xr(), t = Vj(), r = wr(), n = "[object Object]", a = Function.prototype, i = Object.prototype, o = a.toString, u = i.hasOwnProperty, s = o.call(Object);
  function c(l) {
    if (!r(l) || e(l) != n)
      return !1;
    var f = t(l);
...
var xE = function(t, r, n, a, i) {
  ...
  var r = SE(SE({}, lF), t), n = ii(), a = ft(-1), i = rF(a, 2), o = i[0], u = i[1];
  Et(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
}, dF = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function ki(e) {
  "@babel/helpers - typeof";
...
function PE(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ C.createElement(fF, r);
    case "sector":
...
function iS(e) {
  var t = e.option, r = e.shapeType, n = e.propTransformer, a = n === void 0 ? gF : n, i = e.activeClassName, o = i === void 0 ? "recharts-active-shape" : i, u = e.isActive, s = hF(e, dF), c;
  if (/* @__PURE__ */ Lt(t))
    c = /* @__PURE__ */ Ue(t, bu(bu({}, s), EF(t)));
  else if (de(t))
    c = t(s);
  else if (Zj(t) && !tF(t)) {
    var l = a(t, s);
...
function OF(e, t) {
  var r;
  return ys(e, t) ? r = TF : bs(e, t) ? r = _F : Bi(e, t) && (r = AF), r;
}
function SF(e, t) {
  var r;
...
function wF(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, a = SF(r, t), i = xF(r, t), o = n.filter(function(s, c) {
...
function CF(e, t, r) {
  return t = gu(t), NF(e, oS() ? Reflect.construct(t, r || [], gu(e).constructor) : t.apply(e, r));
}
function NF(e, t) {
...
var Ir = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return PF(this, t), n = CF(this, t, [r]), Rt(n, "pieRef", null), Rt(n, "sectorRefs", []), Rt(n, "id", Ki("recharts-pie-")), Rt(n, "handleAnimationEnd", function() {
...
var UF = ["Webkit", "Moz", "O", "ms"], HF = function(t, r) {
  var n = t.replace(/(\w)/, function(i) {
    return i.toUpperCase();
  }), a = UF.reduce(function(i, o) {
...
function YF(e, t, r) {
  return t = Tu(t), zF(e, lS() ? Reflect.construct(t, r || [], Tu(e).constructor) : t.apply(e, r));
}
function zF(e, t) {
...
var XF = function(t) {
  ...
  function t(r) {
    var n;
    return qF(this, t), n = YF(this, t, [r]), _t(n, "handleDrag", function(a) {
  ...
  return KF(t, e), WF(t, [{
    ...
    value: function() {
      ...
      if (!a || !a.length || !J(u) || !J(s) || !J(c) || !J(l) || c <= 0 || l <= 0)
        return null;
      var _ = pe("recharts-brush", i), A = C.Children.count(o) === 1, b = HF("userSelect", "none");
      return /* @__PURE__ */ C.createElement(Oe, {
        className: _,
...
function l9(e, t, r) {
  return t = f9(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function f9(e) {
  var t = d9(e, "string");
...
function m9(e, t) {
  var r = e.x, n = e.y, a = h9(e, c9), i = "".concat(r), o = parseInt(i, 10), u = "".concat(n), s = parseInt(u, 10), c = "".concat(t.height || a.height), l = parseInt(c, 10), f = "".concat(t.width || a.width), h = parseInt(f, 10);
...
function _9(e, t, r) {
  return t = Au(t), A9(e, pS() ? Reflect.construct(t, r || [], Au(e).constructor) : t.apply(e, r));
}
function A9(e, t) {
...
var sr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = _9(this, t, [].concat(a)), jr(r, "state", {
      isAnimationFinished: !1
...
jr(sr, "getComposedData", function(e) {
  ...
  if (!p)
    return null;
  var g = t.layout, y = r.type.defaultProps, m = y !== void 0 ? $e($e({}, y), r.props) : r.props, v = m.dataKey, E = m.children, _ = m.minPointSize, A = g === "horizontal" ? o : i, b = c ? A.scale.domain() : null, T = J4({
    numericAxis: A
  }), O = jt(E, Zu), I = f.map(function(N, j) {
    var D, R, B, F, $, q;
    c ? D = G4(c[l + j], b) : (D = ut(N, v), Array.isArray(D) || (D = [T, D]));
    var Y = y9(_, hS.defaultProps.minPointSize)(D[1], j);
    if (g === "horizontal") {
...
var C9 = function(t, r, n, a, i) {
  ...
  return l.reduce(function(p, g) {
    ...
    if (y.type === "number" && (y.padding === "gap" || y.padding === "no-gap")) {
      var R = v[1] - v[0], B = 1 / 0, F = y.categoricalDomain.sort(MN);
...
var D9 = function(t) {
  var r = t.width, n = t.height, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i = R9(a), o = i * Math.PI / 180, u = Math.atan(n / r), s = o > u && o < Math.PI - u ? n / Math.sin(o) : r / Math.cos(o);
  return Math.abs(s);
}, Cd, JE;
function M9() {
  if (JE) return Cd;
...
var j9 = B9();
const F9 = /* @__PURE__ */ xe(j9);
var $9 = D_();
const U9 = /* @__PURE__ */ xe($9);
var H9 = U9(function(e) {
  return {
    x: e.left,
    y: e.top,
    width: e.width,
...
var R0 = /* @__PURE__ */ Vt(void 0), D0 = /* @__PURE__ */ Vt(void 0), vS = /* @__PURE__ */ Vt(void 0), ES = /* @__PURE__ */ Vt({}), TS = /* @__PURE__ */ Vt(void 0), _S = /* @__PURE__ */ Vt(0), AS = /* @__PURE__ */ Vt(0), nT = function(t) {
  var r = t.state, n = r.xAxisMap, a = r.yAxisMap, i = r.offset, o = t.clipPathId, u = t.children, s = t.width, c = t.height, l = H9(i);
...
function X9(e, t, r) {
  return t && V9(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function Q9(e, t, r) {
  return t = Su(t), Z9(e, wS() ? Reflect.construct(t, r || [], Su(e).constructor) : t.apply(e, r));
}
function Z9(e, t) {
...
var u$ = function(t, r) {
  ...
  if (a) {
    ...
    return nr(c, "discard") && e9(b, function(T) {
...
function c$(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = q9(), l = SS(a), f = xS(i), h = z9();
  if (!c || !h)
    return null;
  ...
  var p = N0({
    x: l.scale,
    y: f.scale
  }), g = ze(t), y = ze(r), m = n && n.length === 2, v = s$(p, g, y, m, h, e.position, l.orientation, f.orientation, e);
  if (!v)
    return null;
  var E = r$(v, 2), _ = E[0], A = _.x, b = _.y, T = E[1], O = T.x, I = T.y, N = nr(e, "hidden") ? "url(#".concat(c, ")") : void 0, j = iT(iT({
    clipPath: N
  }, le(e, !0)), {}, {
    x1: A,
    y1: b,
  ...
  }, u$(o, j), Qe.renderCallByParent(e, N9({
    x1: A,
    y1: b,
    x2: O,
    y2: I
...
var B0 = /* @__PURE__ */ (function(e) {
  function t() {
    return K9(this, t), Q9(this, t, arguments);
  }
  return e$(t, e), X9(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(c$, this.props);
    }
  }]);
})(C.Component);
...
function h$(e, t, r) {
  return t = xu(t), p$(e, IS() ? Reflect.construct(t, r || [], xu(e).constructor) : t.apply(e, r));
}
function p$(e, t) {
...
var g$ = function(t) {
  ...
  function t() {
    return l$(this, t), h$(this, t, arguments);
  }
  return y$(t, e), d$(t, [{
    key: "render",
    value: function() {
...
function _$(e, t, r) {
  return t = wu(t), A$(e, NS() ? Reflect.construct(t, r || [], wu(e).constructor) : t.apply(e, r));
}
function A$(e, t) {
...
function j0(e, t, r) {
  ...
  if (!a || !a.length || !n)
    return [];
  if (J(s) || Oa.isSsr)
    return C$(a, typeof s == "number" && J(s) ? s : 0);
  ...
  }, m = a.length >= 2 ? dt(a[1].coordinate - a[0].coordinate) : 1, v = I$(i, m, p);
  return s === "equidistantPreserveStart" ? N$(m, v, y, a, o) : (s === "preserveStart" || s === "preserveStartEnd" ? h = k$(m, v, y, a, o, s === "preserveStartEnd") : h = L$(m, v, y, a, o), h.filter(function(E) {
    return E.isShow;
  }));
}
var B$ = ["viewBox"], j$ = ["viewBox"], F$ = ["ticks"];
function ma(e) {
  "@babel/helpers - typeof";
...
function q$(e, t, r) {
  return t = Iu(t), W$(e, MS() ? Reflect.construct(t, r || [], Iu(e).constructor) : t.apply(e, r));
}
function W$(e, t) {
...
var Pa = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return U$(this, t), n = q$(this, t, [r]), n.state = {
      fontSize: "",
      letterSpacing: ""
    }, n;
  }
  return z$(t, e), H$(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = Md(n, B$), u = this.props, s = u.viewBox, c = Md(u, j$);
    ...
    value: function() {
      ...
      if (l)
        return null;
      var f = this.props, h = f.ticks, p = Md(f, F$), g = h;
...
var K$ = ["x1", "y1", "x2", "y2", "key"], V$ = ["offset"];
function vn(e) {
  "@babel/helpers - typeof";
...
function kS(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, u = t.key, s = mT(t, K$), c = le(s, !1);
    c.offset;
    var l = mT(c, V$);
...
function to(e) {
  var t, r, n, a, i, o, u = M0(), s = L0(), c = G9(), l = ot(ot({}, e), {}, {
  ...
  }), f = l.x, h = l.y, p = l.width, g = l.height, y = l.syncWithTicks, m = l.horizontalValues, v = l.verticalValues, E = W9(), _ = Y9();
  if (!J(p) || p <= 0 || !J(g) || g <= 0 || !J(f) || f !== +f || !J(h) || h !== +h)
    return null;
  var A = l.verticalCoordinatesGenerator || iU, b = l.horizontalCoordinatesGenerator || oU, T = l.horizontalPoints, O = l.verticalPoints;
  if ((!T || !T.length) && de(b)) {
  ...
  return /* @__PURE__ */ C.createElement("g", {
    ...
    horizontalPoints: T
  })), /* @__PURE__ */ C.createElement(aU, sn({}, l, {
    verticalPoints: O
  })));
}
...
function cU(e, t, r) {
  return t && sU(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function lU(e, t, r) {
  return t = Cu(t), fU(e, BS() ? Reflect.construct(t, r || [], Cu(e).constructor) : t.apply(e, r));
}
function fU(e, t) {
...
var wn = /* @__PURE__ */ (function(e) {
  function t() {
    return uU(this, t), lU(this, t, arguments);
  }
  return hU(t, e), cU(t, [{
    key: "render",
    value: function() {
...
function vU(e, t, r) {
  return t = Nu(t), EU(e, $S() ? Reflect.construct(t, r || [], Nu(e).constructor) : t.apply(e, r));
}
function EU(e, t) {
...
var CU = IU();
const NU = /* @__PURE__ */ xe(CU);
var kd = new NU(), Bd = "recharts.syncMouseEvents";
function Ui(e) {
  "@babel/helpers - typeof";
...
function MU(e, t, r) {
  return t && DU(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function jd(e, t, r) {
...
var kU = /* @__PURE__ */ (function() {
  function e() {
    RU(this, e), jd(this, "activeIndex", 0), jd(this, "coordinateList", []), jd(this, "layout", "horizontal");
  }
  return MU(e, [{
    key: "setDetails",
    value: function(r) {
...
var WU = ["item"], YU = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function ga(e) {
  "@babel/helpers - typeof";
...
function JU(e, t, r) {
  return t = Ru(t), e7(e, YS() ? Reflect.construct(t, r || [], Ru(e).constructor) : t.apply(e, r));
}
function e7(e, t) {
...
var gp = function(t, r, n, a) {
  ...
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = c7(i, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, l = $4(o, u, c, s);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, h = gp(t, r, l, f), p = l7(n, u, l, i);
    return {
  ...
  return n.reduce(function(g, y) {
    ...
    BU(v.domain, A, E) && (R = Dh(v.domain, null, A), p && (E === "number" || T !== "auto") && (F = ei(j, _, "category")));
    var $ = VS(E);
    if (!R || R.length === 0) {
      ...
      if (_) {
        if (R = ei(j, _, E), E === "category" && p) {
          ...
          var te = Y4(j, a.filter(function(z) {
  ...
  return n.reduce(function(m, v) {
    ...
    if (!m[_]) {
      ...
      return g ? b = vu(0, p) : u && u[_] && u[_].hasStack ? (b = jO(u[_].stackGroups, s, c), b = mp(f, b, _, i)) : (b = Dh(A, RO(h, n.filter(function(T) {
        ...
        hide: !0,
        orientation: xt(u7, "".concat(i, ".").concat(y % 2), null),
        domain: b,
        originalDomain: A,
        isCategorical: g,
        layout: l
  ...
  p && (v.bottom += p.props.height || ca.defaultProps.height), g && r && (v = q4(v, a, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(v, E) {
    var _ = E.graphicalItems, A = E.stackGroups, b = E.offset, T = E.updateId, O = E.dataStartIndex, I = E.dataEndIndex, N = v.barSize, j = v.layout, D = v.barGap, R = v.barCategoryGap, B = v.maxBarSize, F = OT(j), $ = F.numericAxisName, q = F.cateAxisName, Y = m7(_), Q = [];
    return _.forEach(function(te, k) {
      ...
      }, fe), G = ce[q], re = ce["".concat(q, "Ticks")], ie = A && A[oe] && A[oe].hasStack && e8(te, A[oe].stackGroups), M = vr(te.type).indexOf("Bar") >= 0, ye = iu(G, re), X = [], Pe = Y && U4({
        barSize: N,
        stackGroups: A,
        totalSize: b7(ce, q)
      });
    ...
    if (!Ly({
      ...
      return null;
    var O = _.children, I = _.layout, N = _.stackOffset, j = _.data, D = _.reverseStackOrder, R = OT(I), B = R.numericAxisName, F = R.cateAxisName, $ = jt(O, n), q = Z4(j, $, "".concat(B, "Id"), "".concat(F, "Id"), N, D), Y = s.reduce(function(z, Z) {
      var ne = "".concat(Z.axisType, "Map");
      return H(H({}, z), {}, se({}, ne, h7(_, H(H({}, Z), {}, {
        graphicalItems: $,
    ...
    var te = Y["".concat(F, "Map")], k = p7(te), W = h(_, H(H({}, Y), {}, {
      dataStartIndex: A,
      dataEndIndex: b,
      updateId: T,
      graphicalItems: $,
    ...
    function v(E) {
      var _, A, b;
      return XU(this, v), b = JU(this, v, [E]), se(b, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(b, "accessibilityManager", new kU()), se(b, "handleLegendBBoxUpdate", function(T) {
        if (T) {
        ...
        var O = WN(T), I = xt(b.props, "".concat(O));
        if (O && de(I)) {
          var N, j;
        ...
        return /* @__PURE__ */ C.createElement(qU, {
          key: Q,
          activeCoordinate: j,
          activePayload: D,
    ...
    return r7(v, m), ZU(v, [{
      ...
      value: function(_) {
        if (!this.container)
          return null;
        var A = this.container, b = A.getBoundingClientRect(), T = R6(b), O = {
      ...
      value: function() {
        ...
        if (!Ly(this))
          return null;
        var A = this.props, b = A.children, T = A.className, O = A.width, I = A.height, N = A.style, j = A.compact, D = A.title, R = A.desc, B = ET(A, YU), F = le(B, !1);
        if (j)
...
const v7 = "funding", E7 = ["Source", "Grants", "Total (GBP)"], T7 = [32, 10, 18], _7 = ["text", "number", "currency"], zn = new Intl.NumberFormat("en-GB", {
  style: "currency",
  currency: "GBP",
  maximumFractionDigits: 0
});
function OH({ content: e, block: t }) {
  const r = _n(v7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Funding received", o = O7(n), u = o.reduce((c, l) => c + l.total, 0);
  ct(
    t,
    "xlsx",
    r && o.length > 0 ? {
...
const S7 = "members", Fd = ["Name", "Rank", "Department", "Tenured", "Start year"], x7 = [28, 14, 18, 10, 12], w7 = ["text", "text", "text", "text", "number"];
function SH({ content: e, block: t }) {
  const r = _n(S7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Members", o = [...n].sort((s, c) => {
...
const I7 = "publications-by-journal", C7 = 10, N7 = ["Venue", "Count"], R7 = [48, 10], D7 = ["text", "number"];
function xH({ content: e, block: t }) {
  const r = _n(I7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by journal", u = L7(n, C7, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(M7, { counts: u })
  ] }) : null;
}
function M7({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
...
const k7 = "publications-by-type", ST = [
  "#1e40af",
  // primary
  "#be123c",
  // accent
  ...
  "#64748b"
  // slate (fallback)
], B7 = ["Publication type", "Count"], j7 = [24, 10], F7 = ["text", "number"];
function wH({ content: e, block: t }) {
  const r = _n(k7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by type", u = U7(n, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications for the selected population." }) : /* @__PURE__ */ P($7, { counts: u })
  ] }) : null;
}
function $7({ counts: e }) {
  const [t, r] = ft(!1);
  ...
  return /* @__PURE__ */ P("div", { className: "chart-container", children: /* @__PURE__ */ P(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(g7, { children: [
    /* @__PURE__ */ P(
      Ir,
      {
        data: n,
...
const H7 = "publications-by-year", q7 = ["Year", "Count", "Cumulative"], W7 = [10, 10, 12], Y7 = ["number", "number", "number"];
function PH({ content: e, block: t }) {
  const r = _n(H7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by year", { series: u, total: s } = G7(n, i);
  return ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(z7, { series: u })
  ] }) : null;
}
...
function X7(e) {
  return Array.isArray(e) ? e.map((t) => {
    const r = t._author ? K7(t._author) : void 0;
    return V7(t, { defaultAuthor: r });
  }).filter(Boolean) : [];
}
const Q7 = "publications-list", xT = {
...
function IH({ content: e, block: t }) {
  const r = _n(Q7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications", u = [...P7(n, i)].sort((y, m) => {
    const v = Number(y.year) || 0;
    return (Number(m.year) || 0) - v;
  }), s = X7(u), c = s.map((y) => y.id).join("|"), [l, f] = ft({ loading: !0, entries: [] });
  Et(() => {
    let y = !1;
    if (!r || s.length === 0) {
      f({ loading: !1, entries: [] });
    ...
    return Z7(i.citationStyle).then(({ formatAll: m, style: v }) => {
      if (!y)
        try {
...
const J7 = "supervisions", wT = ["#1e40af", "#0f766e", "#ea580c", "#9333ea", "#be123c", "#0ea5e9"];
function CH({ content: e, block: t }) {
  const r = _n(J7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Supervisions", { levels: o, rows: u, grandTotal: s } = tH(n), c = ["Member", ...o.map(Ep), "Total"], l = u.map((E) => [
    E.member,
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No supervisions recorded for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ P(eH, { rows: u, levels: o })
    ] })
  ] }) : null;
}
function eH({ rows: e, levels: t }) {
  const [r, n] = ft(!1);
  if (Et(() => {
    n(!0);
  }, []), !r)
...
const aH = "members";
function iH() {
  const e = RC(aH), [, t] = Dp(), [r, n] = Mp(), [a, i] = ft(() => IT(r, e));
  if (Et(() => {
    i(IT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
function oH({ field: e, def: t, value: r, onChange: n }) {
  const a = t?.label || e;
  switch (t?.type) {
    case "enum":
      ...
      /* @__PURE__ */ ee("label", { className: "report-options-field", children: [
        ...
        /* @__PURE__ */ P(
          "select",
          {
            ...
            onChange: s,
            className: "report-options-input",
            children: BC.map((c) => /* @__PURE__ */ P("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] })
    ] }),
...
function cH() {
  ...
  return /* @__PURE__ */ ee("fieldset", { className: "section-toggles", children: [
    ...
    /* @__PURE__ */ P("div", { className: "section-toggles-list", children: MC.map((n) => /* @__PURE__ */ ee("label", { className: "section-toggles-item", children: [
      /* @__PURE__ */ P(
        "input",
        {
          type: "checkbox",
...
function mH({ body: e, page: t }) {
  ...
  return Et(() => $C(t), [t]), /* @__PURE__ */ ee(QT, { basePath: r.basePath, children: [
    ...
    /* @__PURE__ */ P(pH, { title: n, filename: a })
  ] });
}
const yH = { ...zd, layouts: { MetricsLayout: mH } }, bH = {}, gH = {}, NH = { meta: bH, capabilities: yH, layoutMeta: gH };
export {
  AH as C,
  gr as D,
  OH as F,
...
//# sourceMappingURL=_entry.generated-D4Ec6hwg.js.map
