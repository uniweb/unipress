...
import C, { createContext as Vt, useContext as $t, useMemo as Fr, createElement as ai, Children as $r, isValidElement as Lt, cloneElement as Ue, useState as ft, useEffect as Et, useReducer as ZS, PureComponent as ir, forwardRef as NT, useRef as ii, useImperativeHandle as JS, useCallback as ex, Component as RT } from "react";
...
function MT(e, t = []) {
  ...
  for (let i = 1; i < r.length; i += 2) {
    ...
    if (o.length < 3 || !o.startsWith("[") || !o.endsWith("]"))
      ...
      const c = o.slice(1, -1).trim().split(DT), l = c.shift(), f = c[0] === "$0";
...
function z0(e, t, r) {
  ...
  !t.type && typeof t.as == "string" && (t.type = t.as), t.lang ? t.locale = t.lang : (t.locale || (t.locale = oi(t.locale)), t.lang = $T(t.locale)), t._name = e;
...
function Ln(e, t) {
  ...
  return t = Wx(r, a, t), e.title && Tr(t) && (t = FT(t, e.locale)), e.aux && (ke(t) && (t = t.join(e.sep || ", ")), t = Ap(e, t)), e.label && (ke(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = d2(e, t)), e.heading && (ke(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = f2(e, t)), e.wrap && (Mu(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Wx(e, t, r) {
  switch (e) {
    case "null":
...
function r2(e, t) {
  const r = e.date ? n2 : kT, n = e.desc ? -1 : 1;
...
function n2(e, t, r) {
  ...
  return pn(n) && pn(a) ? yr(n, "date").getTime() - yr(a, "date").getTime() : kT(e, t, r);
}
function kT(e, t, r) {
  let n = Po(t, e), a = Po(r, e);
  const i = Kt(n), o = Kt(a);
...
function BT(e, t) {
  const r = [];
  for (let n of t)
    ke(n) ? n = BT(e, n) : Dt(n) && (n = jT(e, n)), Mu(n) || r.push(n);
...
class T2 {
   ...
   */
  constructor(t = {}, r = {}) {
    this.snippets = MT(t), this.functions = r;
  }
  /**
  ...
  getVariableMeta(t) {
    ...
    return typeof r == "string" ? { label: r } : (r.label ??= FT(t.split("_").join(" ")), r);
  }
  /**
...
UT.sort((e, t) => t.length - e.length);
const _2 = new Set(UT.map((e) => e.join(" ").toUpperCase())), A2 = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
  ...
  "object",
  "tag"
]), O2 = /* @__PURE__ */ new Set([">=", "<=", "!=", "==", "&&", "||"]), S2 = /* @__PURE__ */ new Set(["+", "-", "*", "/", "%", "=", "<", ">", "!"]), x2 = /[a-zA-Z_@$?]/, w2 = /[a-zA-Z0-9_.\/@]/, Cs = /[0-9]/;
function P2(e) {
  return I2(e);
}
function I2(e) {
...
` || a === "\r") {
    ...
    if (Cs.test(a) || a === "-" && Cs.test(e[n + 1] || "") && C2(t)) {
      let o = n + (a === "-" ? 1 : 0);
      for (; o < r && (Cs.test(e[o]) || e[o] === "."); ) o++;
...
function Op(e) {
  ...
  if (r && !q2(e, r))
    switch (nt(e, r), r.canonical) {
      ...
      case "TOTAL OF":
      case "SUM OF":
        return Ns(e, { type: "sum", value: kt(e) });
      case "AVERAGE OF":
        return Ns(e, { type: "average", value: kt(e) });
      case "COUNT OF":
        return Ns(e, X2(e));
      case "FOR EACH":
        return Q2(e);
...
function Wd(e) {
  ...
  if (t && t.type === "lparen") {
    Fe(e);
    const r = WT(e);
    return qT(e, "rparen"), { type: "group", inner: r };
  }
  return J2(e);
}
...
function je(e) {
  switch (e.type) {
    ...
    case "forEach":
      return ow(e);
    default:
      throw new YT(`Unknown node type: ${e.type}`);
  }
}
function tw(e) {
...
function rw(e) {
  ...
  for (let u = 0; u < e.modifiers.length; u++) {
    ...
    switch (s.type) {
      ...
      default:
        throw new YT(`Unknown modifier type: ${s.type}`);
    }
  }
  return a;
}
...
function yw(e) {
  if (e == null) return null;
  if (typeof e == "number")
    return Number.isFinite(e) ? { tier: zd, value: e * GT } : null;
  if (typeof e == "string") {
    const t = e.trim();
    if (t === "") return null;
    const r = bw(t);
    return r !== null ? { tier: zd, value: r } : { tier: am, value: t };
  }
  return { tier: am, value: String(e) };
}
function bw(e) {
  const t = /^(\d{4})(?:[/-](\d{1,2}))?(?:[/-](\d{1,2}))?/.exec(e);
  return t ? parseInt(t[1], 10) * GT + parseInt(t[2] ?? "0", 10) * 100 + parseInt(t[3] ?? "0", 10) : null;
}
const gw = [
  {
    id: "bibliography",
...
function ZT({
  ...
  ), /* @__PURE__ */ I(VT.Provider, { value: a, children: /* @__PURE__ */ I(im.Provider, { value: i, children: /* @__PURE__ */ I(Gd.Provider, { value: o, children: e }) }) });
}
function ct(e, t, r, n = {}) {
  const a = $t(VT);
  if (!a) {
...
function t_(e) {
  return e >= 64976 && e <= 65007 || xw.has(e);
}
var U;
(function(e) {
...
class Cw {
  constructor(t) {
    this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = Iw, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (ww(r))
        return this.pos++, this._addGap(), Pw(t, r);
  ...
  advance() {
    ...
    return t === S.CARRIAGE_RETURN ? (this.isEol = !0, this.skipNextNewLine = !0, S.LINE_FEED) : t === S.LINE_FEED && (this.isEol = !0, this.skipNextNewLine) ? (this.line--, this.skipNextNewLine = !1, this._addGap(), this.advance()) : (this.skipNextNewLine = !1, JT(t) && (t = this._processSurrogate(t)), this.handler.onParseError === null || t > 31 && t < 127 || t === S.LINE_FEED || t === S.CARRIAGE_RETURN || t > 159 && t < 64976 || this._checkForProblematicCharacters(t), t);
  }
  _checkForProblematicCharacters(t) {
    e_(t) ? this._err(U.controlCharacterInInputStream) : t_(t) && this._err(U.noncharacterInInputStream);
  }
  retreat(t) {
...
const Nw = /* @__PURE__ */ new Uint16Array(
  // prettier-ignore
...
function Dw(e) {
  var t;
  return e >= 55296 && e <= 57343 || e > 1114111 ? 65533 : (t = Rw.get(e)) !== null && t !== void 0 ? t : e;
}
var Ze;
(function(e) {
...
class jw {
  ...
  stateNumericStart(t, r) {
    return r >= t.length ? -1 : (t.charCodeAt(r) | Mw) === Ze.LOWER_X ? (this.state = Ve.NumericHex, this.consumed += 1, this.stateNumericHex(t, r + 1)) : (this.state = Ve.NumericDecimal, this.stateNumericDecimal(t, r));
  }
  ...
  emitNumericEntity(t, r) {
    ...
    if (t === Ze.SEMI)
      ...
      return 0;
    return this.emitCodePoint(Dw(this.result), this.consumed), this.errors && (t !== Ze.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(t, r) {
    ...
    for (; r < t.length; r++, this.excess++) {
      ...
      if (this.treeIndex = Fw(n, a, this.treeIndex + Math.max(1, i), o), this.treeIndex < 0)
        return this.result === 0 || // If we are parsing an attribute
        this.decodeMode === dr.Attribute && // We shouldn't have consumed any characters after the entity,
        (i === 0 || // And there should be no invalid characters.
        Bw(o)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function Lu(e) {
  var t;
  return (t = $w.get(e)) !== null && t !== void 0 ? t : d.UNKNOWN;
}
const V = d, Uw = {
...
function sm(e) {
  return n_(e) || e === S.SOLIDUS || e === S.GREATER_THAN_SIGN;
}
function Ww(e) {
  return e === S.NULL ? U.nullCharacterReference : e > 1114111 ? U.characterReferenceOutsideUnicodeRange : JT(e) ? U.surrogateCharacterReference : t_(e) ? U.noncharacterCharacterReference : e_(e) || e === S.CARRIAGE_RETURN ? U.controlCharacterReference : null;
}
class Yw {
  constructor(t, r) {
    this.options = t, this.handler = r, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = x.DATA, this.returnState = x.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new Cw(r), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new jw(Nw, (n, a) => {
  ...
  _leaveAttrName() {
    ...
    if (r_(n, this.currentAttr.name) === null) {
  ...
  emitCurrentTagToken() {
    ...
    this.prepareToken(t), t.tagID = Lu(t.tagName), t.type === be.START_TAG ? (this.lastStartTagName = t.tagName, this.handler.onStartTag(t)) : (t.attrs.length > 0 && this._err(U.endTagWithAttributes), t.selfClosing && this._err(U.endTagWithTrailingSolidus), this.handler.onEndTag(t)), this.preprocessor.dropParsedChunk();
  }
  ...
  _emitCodePoint(t) {
    const r = n_(t) ? be.WHITESPACE_CHARACTER : t === S.NULL ? be.NULL_CHARACTER : be.CHARACTER;
...
const a_ = /* @__PURE__ */ new Set([d.DD, d.DT, d.LI, d.OPTGROUP, d.OPTION, d.P, d.RB, d.RP, d.RT, d.RTC]), cm = /* @__PURE__ */ new Set([
  ...a_,
  d.CAPTION,
  d.COLGROUP,
  d.TBODY,
  ...
  d.TEMPLATE,
  d.TH
]), zw = /* @__PURE__ */ new Set([...Ro, d.OL, d.UL]), Gw = /* @__PURE__ */ new Set([...Ro, d.BUTTON]), lm = /* @__PURE__ */ new Set([d.ANNOTATION_XML, d.MI, d.MN, d.MO, d.MS, d.MTEXT]), fm = /* @__PURE__ */ new Set([d.DESC, d.FOREIGN_OBJECT, d.TITLE]), Kw = /* @__PURE__ */ new Set([d.TR, d.TEMPLATE, d.HTML]), Vw = /* @__PURE__ */ new Set([d.TBODY, d.TFOOT, d.THEAD, d.TEMPLATE, d.HTML]), Xw = /* @__PURE__ */ new Set([d.TABLE, d.TEMPLATE, d.HTML]), Qw = /* @__PURE__ */ new Set([d.TD, d.TH]);
class Zw {
  ...
  hasInScope(t) {
    return this.hasInDynamicScope(t, Ro);
  }
  hasInListItemScope(t) {
    return this.hasInDynamicScope(t, zw);
  }
  hasInButtonScope(t) {
    return this.hasInDynamicScope(t, Gw);
  }
  ...
  generateImpliedEndTags() {
    for (; this.currentTagId !== void 0 && a_.has(this.currentTagId); )
      this.pop();
  }
...
class Jw {
  ...
  _ensureNoahArkCondition(t) {
    ...
    for (let o = 0; o < n.length; o++) {
      const u = n[o];
      u.attrs.every((s) => a.get(s.name) === s.value) && (i += 1, i >= Rs && this.entries.splice(u.idx, 1));
    }
  }
  //Mutations
  insertMarker() {
...
const Dr = {
...
}, i_ = "html", eP = "about:legacy-compat", tP = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", o_ = [
  ...
  "html"
]), u_ = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], aP = [
  ...u_,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function iP(e) {
  return e.name === i_ && e.publicId === null && (e.systemId === null || e.systemId === eP);
}
function oP(e) {
  if (e.name !== i_)
    return Nt.QUIRKS;
  const { systemId: t } = e;
  if (t && t.toLowerCase() === tP)
    return Nt.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (r = r.toLowerCase(), nP.has(r))
      return Nt.QUIRKS;
    let n = t === null ? rP : o_;
    if (hm(r, n))
      return Nt.QUIRKS;
    if (n = t === null ? u_ : aP, hm(r, n))
...
const pm = {
...
}, uP = "definitionurl", sP = "definitionURL", cP = new Map([
  "attributeName",
  "attributeType",
  "baseFrequency",
  "baseProfile",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((e) => [e.toLowerCase(), e])), lP = /* @__PURE__ */ new Map([
  ...
  "radialGradient",
  "textPath"
].map((e) => [e.toLowerCase(), e])), dP = /* @__PURE__ */ new Set([
  d.B,
  d.BIG,
  d.BLOCKQUOTE,
  d.BODY,
...
function hP(e) {
  const t = e.tagID;
  return t === d.FONT && e.attrs.some(({ name: n }) => n === cn.COLOR || n === cn.SIZE || n === cn.FACE) || dP.has(t);
}
function s_(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === uP) {
      e.attrs[t].name = sP;
      break;
    }
}
...
function wp(e) {
  for (let t = 0; t < e.attrs.length; t++) {
    const r = lP.get(e.attrs[t].name);
    r && (e.attrs[t].prefix = r.prefix, e.attrs[t].name = r.name, e.attrs[t].namespace = r.namespace);
  }
}
function pP(e) {
  const t = fP.get(e.tagName);
  t != null && (e.tagName = t, e.tagID = Lu(e.tagName));
}
function mP(e, t) {
...
function bP(e, t, r, n) {
  return (!n || n === K.HTML) && yP(e, t, r) || (!n || n === K.MATHML) && mP(e, t);
}
const gP = "hidden", vP = 8, EP = 3;
var w;
(function(e) {
...
const TP = {
  ...
  endCol: -1,
  endOffset: -1
}, l_ = /* @__PURE__ */ new Set([d.TABLE, d.TBODY, d.TFOOT, d.THEAD, d.TR]), mm = {
  scriptingEnabled: !0,
...
class _P {
  constructor(t, r, n = null, a = null) {
    this.fragmentContext = n, this.scriptHandler = a, this.currentToken = null, this.stopped = !1, this.insertionMode = w.INITIAL, this.originalInsertionMode = w.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...mm,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = r ?? this.treeAdapter.createDocument(), this.tokenizer = new Yw(this.options, this), this.activeFormattingElements = new Jw(this.treeAdapter), this.fragmentContextID = n ? Lu(this.treeAdapter.getTagName(n)) : d.UNKNOWN, this._setContextModes(n ?? this.document, this.fragmentContextID), this.openElements = new Zw(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, r) {
    const n = new this(r);
  ...
  _err(t, r, n) {
    ...
    if (!this.onParseError)
      return;
    const i = (a = t.location) !== null && a !== void 0 ? a : TP, o = {
      code: r,
   ...
   */
  _processStartTag(t) {
    this.shouldProcessStartTagTokenInForeignContent(t) ? JI(this, t) : this._startTagOutsideForeignContent(t);
  }
  /** @protected */
  ...
  /** @internal */
  onEndTag(t) {
    this.skipNextNewLine = !1, this.currentToken = t, this.currentNotInHTML ? eC(this, t) : this._endTagOutsideForeignContent(t);
  }
  /** @protected */
...
function AP(e, t) {
  ...
  return r ? e.openElements.contains(r.element) ? e.openElements.hasInScope(t.tagID) || (r = null) : (e.activeFormattingElements.removeEntry(r), r = null) : m_(e, t), r;
}
function OP(e, t) {
...
function SP(e, t, r) {
  ...
  for (let i = 0, o = a; o !== r; i++, o = a) {
    ...
    const u = e.activeFormattingElements.getElementEntry(o), s = u && i >= EP;
    !u || s ? (s && e.activeFormattingElements.removeEntry(u), e.openElements.remove(o)) : (o = xP(e, u), n === t && (e.activeFormattingElements.bookmark = u), e.treeAdapter.detachNode(n), e.treeAdapter.appendChild(o, n), n = o);
  }
  return n;
}
function xP(e, t) {
...
function wP(e, t, r) {
  const n = e.treeAdapter.getTagName(t), a = Lu(n);
...
function Pp(e, t) {
  for (let r = 0; r < vP; r++) {
    ...
    const i = SP(e, a, n.element), o = e.openElements.getCommonAncestor(n.element);
    e.treeAdapter.detachNode(i), o && wP(e, o, i), PP(e, a, n);
  }
}
function Xd(e, t) {
...
function NP(e, t) {
  ...
  const r = t.forceQuirks ? Nt.QUIRKS : oP(t);
  iP(t) || e._err(t, U.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, r), e.insertionMode = w.BEFORE_HTML;
}
function Ia(e, t) {
...
function Qa(e, t) {
  e._insertFakeElement(L.BODY, d.BODY), e.insertionMode = w.IN_BODY, ku(e, t);
}
function ku(e, t) {
  switch (t.type) {
    case be.CHARACTER: {
...
function p_(e) {
  const t = r_(e, cn.TYPE);
  return t != null && t.toLowerCase() === gP;
}
function rI(e, t) {
  e._reconstructActiveFormattingElements(), e._appendElement(t, K.HTML), p_(t) || (e.framesetOk = !1), t.ackSelfClosing = !0;
}
function nI(e, t) {
  e._appendElement(t, K.HTML), t.ackSelfClosing = !0;
}
...
function iI(e, t) {
  t.tagName = L.IMG, t.tagID = d.IMG, h_(e, t);
}
function oI(e, t) {
...
function hI(e, t) {
  e._reconstructActiveFormattingElements(), s_(t), wp(t), t.selfClosing ? e._appendElement(t, K.MATHML) : e._insertElement(t, K.MATHML), t.ackSelfClosing = !0;
}
function pI(e, t) {
  e._reconstructActiveFormattingElements(), c_(t), wp(t), t.selfClosing ? e._appendElement(t, K.SVG) : e._insertElement(t, K.SVG), t.ackSelfClosing = !0;
}
function bm(e, t) {
...
function yI(e, t) {
  e.openElements.hasInScope(d.BODY) && (e.insertionMode = w.AFTER_BODY, O_(e, t));
}
function bI(e, t) {
  const r = t.tagID;
...
function y_(e, t) {
  e.tmplInsertionModeStack.length > 0 ? A_(e, t) : Ip(e, t);
}
function SI(e, t) {
  var r;
...
function Ds(e, t) {
  if (e.openElements.currentTagId !== void 0 && l_.has(e.openElements.currentTagId))
...
function NI(e, t) {
  e.openElements.clearBackToTableContext(), e._insertFakeElement(L.TBODY, d.TBODY), e.insertionMode = w.IN_TABLE_BODY, ju(e, t);
}
function RI(e, t) {
...
function DI(e, t) {
  p_(t) ? e._appendElement(t, K.HTML) : Wi(e, t), t.ackSelfClosing = !0;
}
function MI(e, t) {
...
function Wi(e, t) {
  ...
  e.fosterParentingEnabled = !0, ku(e, t), e.fosterParentingEnabled = r;
}
function b_(e, t) {
...
const v_ = /* @__PURE__ */ new Set([d.CAPTION, d.COL, d.COLGROUP, d.TBODY, d.TD, d.TFOOT, d.TH, d.THEAD, d.TR]);
function LI(e, t) {
  const r = t.tagID;
  v_.has(r) ? e.openElements.hasInTableScope(d.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(d.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = w.IN_TABLE, Kn(e, t)) : lt(e, t);
}
function kI(e, t) {
  const r = t.tagID;
  switch (r) {
...
function ju(e, t) {
  switch (t.tagID) {
    ...
    case d.TH:
    case d.TD: {
      e.openElements.clearBackToTableBodyContext(), e._insertFakeElement(L.TR, d.TR), e.insertionMode = w.IN_ROW, Fu(e, t);
      break;
    }
    case d.CAPTION:
    case d.COL:
...
function Fu(e, t) {
  switch (t.tagID) {
    ...
    case d.THEAD:
    case d.TR: {
      e.openElements.hasInTableScope(d.TR) && (e.openElements.clearBackToTableRowContext(), e.openElements.pop(), e.insertionMode = w.IN_TABLE_BODY, ju(e, t));
      break;
    }
    default:
      Kn(e, t);
...
function jI(e, t) {
  const r = t.tagID;
  v_.has(r) ? (e.openElements.hasInTableScope(d.TD) || e.openElements.hasInTableScope(d.TH)) && (e._closeTableCell(), Fu(e, t)) : lt(e, t);
}
function FI(e, t) {
  const r = t.tagID;
  switch (r) {
    ...
    case d.THEAD:
    case d.TR: {
      e.openElements.hasInTableScope(r) && (e._closeTableCell(), E_(e, t));
      break;
    }
    case d.BODY:
    case d.CAPTION:
...
function $I(e, t) {
  const r = t.tagID;
  r === d.CAPTION || r === d.TABLE || r === d.TBODY || r === d.TFOOT || r === d.THEAD || r === d.TR || r === d.TD || r === d.TH ? (e.openElements.popUntilTagNamePopped(d.SELECT), e._resetInsertionMode(), e._processStartTag(t)) : T_(e, t);
}
function UI(e, t) {
  const r = t.tagID;
  r === d.CAPTION || r === d.TABLE || r === d.TBODY || r === d.TFOOT || r === d.THEAD || r === d.TR || r === d.TD || r === d.TH ? e.openElements.hasInTableScope(r) && (e.openElements.popUntilTagNamePopped(d.SELECT), e._resetInsertionMode(), e.onEndTag(t)) : __(e, t);
}
function HI(e, t) {
  switch (t.tagID) {
    ...
    case d.TR: {
      e.tmplInsertionModeStack[0] = w.IN_TABLE_BODY, e.insertionMode = w.IN_TABLE_BODY, ju(e, t);
      break;
    }
    case d.TD:
    case d.TH: {
      e.tmplInsertionModeStack[0] = w.IN_ROW, e.insertionMode = w.IN_ROW, Fu(e, t);
      break;
    }
    default:
...
function Mo(e, t) {
  e.insertionMode = w.IN_BODY, ku(e, t);
}
function YI(e, t) {
  switch (t.tagID) {
    case d.HTML: {
...
function JI(e, t) {
  if (hP(t))
    S_(e), e._startTagOutsideForeignContent(t);
  else {
    const r = e._getAdjustedCurrentElement(), n = e.treeAdapter.getNamespaceURI(r);
    n === K.MATHML ? s_(t) : n === K.SVG && (pP(t), c_(t)), wp(t), t.selfClosing ? e._appendElement(t, n) : e._insertElement(t, n), t.ackSelfClosing = !0;
  }
}
function eC(e, t) {
  if (t.tagID === d.P || t.tagID === d.BR) {
    S_(e), e._endTagOutsideForeignContent(t);
    return;
  }
...
function tC(e, t, r) {
  ...
  const n = _P.getFragmentParser(e, r);
  return n.tokenizer.write(t, !0), n.getFragment();
}
const rC = () => ({}), Na = () => !0, Nr = (e) => {
  const t = parseInt(e, 10);
  return Number.isFinite(t) ? t : e;
}, nC = (e) => typeof e != "string" ? e : e.split(",").map((t) => t.trim()).filter(Boolean).map((t) => parseInt(t, 10)).filter((t) => Number.isFinite(t)), aC = {
  "data-underline": { path: ["underline"], transform: rC },
...
function cC(e) {
  ...
  const n = gm(e, "data-type") || t;
  if (n === "emptyLine") return null;
  if (n === "contentWrapper")
    return Zd(e);
  const a = oC(e.attrs || []), i = Zd(e);
...
const lC = {
  docx: { load: () => import("./docx-Cd9WTKBh.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-BUZmKXqv.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-BtPLGUKG.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-Cb8WlH_Q.js"), consumes: "latex", ir: !0 },
  ...
  pagedjs: { load: () => import("./pagedjs-D4yUMBVt.js"), consumes: "html", ir: !1 },
  epub: { load: () => import("./epub-n_br8Plv.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = lC[e];
  return t ? {
...
function bC(e, t, r = {}) {
  const { basePath: n, theme: a } = r, i = QT();
  return Tp(
    ai(
      ZT,
...
function gC(e, t) {
  ...
  if (!r) return;
  const n = r.consumes;
  if (!(vm.has(n) || (e.getOutputs && e.getOutputs(n) || []).length > 0) && (vm.add(n), typeof console < "u" && console.warn)) {
...
function SC(e) {
  return e == null ? e : Array.isArray(e) ? e.map(Tm) : Tm(e);
}
function x_({
  children: e,
  bold: t,
  ...
  const p = XT(), g = ui(a, p), y = Ow(o, p), m = l ?? f, v = { "data-type": "text" };
  return t && (v["data-bold"] = "true"), r && (v["data-italics"] = "true"), n && (v["data-underline"] = "true"), g && (v["data-color"] = g), i != null && (v["data-size"] = i), y && (v["data-font"] = y), u && (v["data-smallcaps"] = "true"), s && (v["data-allcaps"] = "true"), c && (v["data-strike"] = "true"), m && (v["data-style"] = m), /* @__PURE__ */ I("span", { ...v, ...h, children: SC(e) });
}
function xC({ latex: e, display: t = !1, id: r, ...n }) {
  const a = { "data-type": "math" };
  return a["data-latex"] = e || "", a["data-display"] = t ? "true" : "false", r && (a["data-id"] = r), /* @__PURE__ */ I("span", { ...a, ...n });
}
...
function Bt({
  ...
  if (t) {
    const s = OC(t);
    return /* @__PURE__ */ I(e, { "data-type": "paragraph", ...u, ...o, children: s.map((c, l) => c.type === "link" ? /* @__PURE__ */ I(
      "a",
      {
        "data-type": "externalHyperlink",
        "data-link": c.href,
        href: c.href,
        children: /* @__PURE__ */ I("span", { "data-type": "text", "data-style": "Hyperlink", children: c.content })
      },
      l
    ) : c.type === "math" ? /* @__PURE__ */ I(
      xC,
      {
        latex: c.latex,
        display: c.display,
  ...
  return /* @__PURE__ */ I(e, { "data-type": "paragraph", ...u, ...o, children: i });
}
function PC(e, t) {
  if (!e) return e;
  const r = {};
...
const w_ = Vt({ widths: null, borderColor: "cccccc" });
function Ea({
  widths: e,
  columnWidths: t,
  layout: r,
  ...
  return /* @__PURE__ */ I(
    w_.Provider,
    {
      ...
      children: /* @__PURE__ */ I("div", { "data-type": "table", className: o, ...l, ...s, children: u })
    }
  );
}
function rt({ header: e = !1, className: t, children: r, ...n }) {
  ...
  return /* @__PURE__ */ I("div", { "data-type": "tableRow", className: t, ...e ? { "data-row-header": "" } : {}, ...n, children: i });
}
...
function he({
  ...
  const { widths: p, borderColor: g, theme: y } = $t(w_), m = r ?? p?.[e], v = {
    "data-type": "tableCell",
  ...
  return /* @__PURE__ */ I("div", { className: c, style: E, ...v, ...h, children: typeof f == "string" || typeof f == "number" ? /* @__PURE__ */ I(Bt, { children: n || t ? /* @__PURE__ */ I(x_, { bold: !0, children: f }) : f }) : f });
}
function $u() {
...
function P_(e) {
  ...
  if (typeof e == "string" || typeof e == "number") n += e;
    ...
    var a = e.length;
    for (t = 0; t < a; t++) e[t] && (r = P_(e[t])) && (n && (n += " "), n += r);
  } else for (r in e) e[r] && (n && (n += " "), n += r);
  return n;
}
function pe() {
  for (var e, t, r = 0, n = "", a = arguments.length; r < a; r++) (e = arguments[r]) && (t = P_(e)) && (n && (n += " "), n += t);
  return n;
}
const IC = [
  ".pdf",
...
function CC(e) {
  ...
  return IC.some((r) => t.includes(r));
}
const NC = /(<a\b[^>]*?\shref=)(["'])([^"']*)\2/gi, RC = /^(?:[a-z][a-z0-9+.-]*:|\/\/|#)/i;
function DC(e, t) {
...
function LC(e, t, { locale: r = !0 } = {}) {
  if (!e || typeof e != "string" || !t) return e;
  let n = e;
  return (e.startsWith("page:") || e.startsWith("topic:")) && (n = t.makeHref ? t.makeHref(e) : e), RC.test(n) || r && n.startsWith("/") && !CC(n) && (n = MC(n, t)), n;
}
function kC(e, t) {
  return !e || typeof e != "string" || !t ? e : DC(LC(e, t), t.basePath || "");
}
function BC(e, t) {
  ...
  return !r && !t.basePath && !n ? e : e.replace(NC, (a, i, o, u) => {
    const s = kC(u, t);
    return s === u ? a : `${i}${o}${s}${o}`;
  });
}
function jC({ value: e, className: t, as: r = "div", ...n }) {
  const { website: a } = $u(), i = Fr(() => {
    if (!e) return "";
...
function I_(e) {
  ...
  return Et(() => {
    ...
    return t.fetcher.dispatch(e, { website: t, signal: s.signal }).then((c) => {
      if (!s.signal.aborted) {
        if (c?.error) {
          i(Om(c.error, c.data ?? null));
          return;
        }
        c && "data" in c && i(io(c.data));
      }
    }).catch((c) => {
      s.signal.aborted || i(Om(String(c?.message || c)));
    }), () => {
      s.abort(), u();
    };
  }, [r, t]), a;
...
function ln(e, t) {
  const { website: r } = $u(), [, n] = ZS($C, 0), i = r.activePage?.state;
  Et(() => {
    if (i)
...
const C_ = "academic-metrics/options", Rp = "all-members", N_ = Rp, UC = [
  "members",
...
function YC() {
  ...
  try {
    const e = window.localStorage.getItem(C_);
    if (!e) return null;
    const t = JSON.parse(e);
    return {
      slug: t.slug || it.slug,
...
function zC(e) {
  ...
  try {
    window.localStorage.setItem(C_, JSON.stringify(t));
  } catch {
  }
}
const Sm = /* @__PURE__ */ new WeakSet(), xm = ["slug", "panelWhere", "excludedSections", "dateRange", "refereedOnly", "citationStyle"];
function GC(e) {
  if (!e || !e.state) return () => {
  };
  if (Sm.has(e)) return () => {
  ...
  const r = () => zC(e), n = xm.map((a) => e.state.subscribe(a, r));
...
function CH({ content: e, block: t }) {
  ...
  return ct(t, "xlsx", {
    ...
    /* @__PURE__ */ ee(wt, { children: [
      ...
      o.map((h, p) => /* @__PURE__ */ I(Bt, { data: h, "data-spacing-after": 160 }, p))
    ] })
    ...
    o.length > 0 && /* @__PURE__ */ I("div", { className: "cover-narrative", children: o.map((h, p) => /* @__PURE__ */ I("p", { dangerouslySetInnerHTML: { __html: h } }, p)) }),
    ...
    /* @__PURE__ */ ee("div", { className: "cover-meta", role: "list", children: [
      /* @__PURE__ */ I(oo, { label: "Members", value: r.length }),
      /* @__PURE__ */ I(oo, { label: "Publications", value: u }),
      /* @__PURE__ */ I(oo, { label: "Funding", value: XC(s) }),
      /* @__PURE__ */ I(oo, { label: "Supervisions", value: c })
    ] })
  ] });
}
...
function or() {
  if (Im) return ks;
  Im = 1;
  var e = R_(), t = typeof self == "object" && self && self.Object === Object && self, r = e || t || Function("return this")();
  return ks = r, ks;
}
var Bs, Cm;
function zi() {
...
function xr() {
  if (Dm) return $s;
  Dm = 1;
  var e = zi(), t = QC(), r = ZC(), n = "[object Null]", a = "[object Undefined]", i = e ? e.toStringTag : void 0;
  function o(u) {
...
function tN() {
  if (Hm) return Vs;
  Hm = 1;
  var e = kp(), t = eN(), r = Gr(), n = D_(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, u = Object.prototype, s = o.toString, c = u.hasOwnProperty, l = RegExp(
...
function iN() {
  if (Km) return tc;
  Km = 1;
  var e = Uu(), t = "__lodash_hash_undefined__", r = Object.prototype, n = r.hasOwnProperty;
  function a(i) {
    var o = this.__data__;
    if (e) {
      var u = o[i];
...
function oN() {
  if (Vm) return rc;
  Vm = 1;
  var e = Uu(), t = Object.prototype, r = t.hasOwnProperty;
  function n(a) {
    var i = this.__data__;
...
function uN() {
  if (Xm) return nc;
  Xm = 1;
  var e = Uu(), t = "__lodash_hash_undefined__";
  function r(n, a) {
    var i = this.__data__;
...
function sN() {
  ...
  return i.prototype.clear = e, i.prototype.delete = t, i.prototype.get = r, i.prototype.has = n, i.prototype.set = a, ac = i, ac;
}
var ic, Zm;
function cN() {
  if (Zm) return ic;
...
function lN() {
  if (ty) return sc;
  ty = 1;
  var e = Hu(), t = Array.prototype, r = t.splice;
  function n(a) {
...
function qu() {
  ...
  return i.prototype.clear = e, i.prototype.delete = t, i.prototype.get = r, i.prototype.has = n, i.prototype.set = a, dc = i, dc;
}
var hc, oy;
function jp() {
  if (oy) return hc;
...
function TN() {
  if (by) return Oc;
  by = 1;
  var e = EN(), t = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, n = e(function(a) {
    var i = [];
...
var wN = xN();
const mn = /* @__PURE__ */ xe(wN);
var PN = kp();
const de = /* @__PURE__ */ xe(PN);
var IN = Gr();
const _a = /* @__PURE__ */ xe(IN);
var so = { exports: {} }, ve = {};
var wy;
function CN() {
  if (wy) return ve;
...
function NN() {
  return Py || (Py = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    var T = o, O = i, P = e, N = s, j = r, D = h, R = f, B = t, F = a, $ = n, q = c, Y = l, Q = !1, te = !1;
    function k(X) {
...
var Iy;
function RN() {
  return Iy || (Iy = 1, process.env.NODE_ENV === "production" ? so.exports = CN() : so.exports = NN()), so.exports;
}
var DN = RN(), Mc, Cy;
function j_() {
  if (Cy) return Mc;
...
var LN = MN();
const Gi = /* @__PURE__ */ xe(LN);
var kN = j_();
const BN = /* @__PURE__ */ xe(kN);
var dt = function(t) {
...
var HN = ["viewBox", "children"], qN = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    Hp.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = WN(o, r, n));
  }), a;
...
}, Ly = null, Bc = null, qp = function e(t) {
  if (t === Ly && Array.isArray(Bc))
    return Bc;
  var r = [];
  return $r.forEach(t, function(n) {
    me(n) || (DN.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), Bc = r, Ly = t, r;
};
function jt(e, t) {
  var r = [], n = [];
...
var ky = function(t) {
...
}, KN = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], VN = function(t) {
  return t && t.type && mn(t.type) && KN.indexOf(t.type) >= 0;
}, XN = function(t, r, n, a) {
  var i, o = (i = kc?.[a]) !== null && i !== void 0 ? i : [];
  return r.startsWith("data-") || !de(t) && (a && o.includes(r) || qN.includes(r)) || n && Hp.includes(r);
}, le = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  return Object.keys(a).forEach(function(o) {
    var u;
    XN((u = a) === null || u === void 0 ? void 0 : u[o], o, r, n) && (i[o] = a[o]);
  }), i;
}, th = function e(t, r) {
  if (t === r)
    return !0;
  ...
  if (n === 0)
    return !0;
  if (n === 1)
    return By(Array.isArray(t) ? t[0] : t, Array.isArray(r) ? r[0] : r);
  for (var a = 0; a < n; a++) {
    var i = t[a], o = r[a];
  ...
  if (me(t) && me(r))
    return !0;
  if (!me(t) && !me(r)) {
    var n = t.props || {}, a = n.children, i = Dy(n, YN), o = r.props || {}, u = o.children, s = Dy(o, zN);
...
}, JN = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function rh() {
...
function nh(e) {
  var t = e.children, r = e.width, n = e.height, a = e.viewBox, i = e.className, o = e.style, u = e.title, s = e.desc, c = e3(e, JN), l = a || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
var Oe = /* @__PURE__ */ C.forwardRef(function(e, t) {
  var r = e.children, n = e.className, a = n3(e, r3), i = pe("recharts-layer", n);
  return /* @__PURE__ */ C.createElement("g", ah({
    className: i
  }, le(a, !0), {
    ref: t
  }), r);
}), i3 = process.env.NODE_ENV !== "production", zt = function(t, r) {
...
function d3() {
  if (zy) return Yc;
  zy = 1;
  var e = f3(), t = e("toUpperCase");
  return Yc = t, Yc;
}
var h3 = d3();
const zu = /* @__PURE__ */ xe(h3);
function Ce(e) {
  return function() {
    return e;
  };
}
const $_ = Math.cos, ko = Math.sin, Qt = Math.sqrt, Bo = Math.PI, Gu = 2 * Bo, ih = Math.PI, oh = 2 * ih, tn = 1e-6, p3 = oh - tn;
function U_(e) {
  this._ += e[0];
...
class y3 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? U_ : m3(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${l}` : (Math.abs(this._x1 - c) > tn || Math.abs(this._y1 - l) > tn) && this._append`L${c},${l}`, n && (h < 0 && (h = h % oh + oh), h > p3 ? this._append`A${n},${n},0,1,${f},${t - u},${r - s}A${n},${n},0,1,${f},${this._x1 = c},${this._y1 = l}` : h > tn && this._append`A${n},${n},0,${+(h >= ih)},${f},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
function Y_(e, t) {
  var r = Ce(!0), n = null, a = Ku, i = null, o = Wp(u);
  e = typeof e == "function" ? e : e === void 0 ? q_ : Ce(e), t = typeof t == "function" ? t : t === void 0 ? W_ : Ce(t);
  function u(s) {
...
function co(e, t, r) {
  var n = null, a = Ce(!0), i = null, o = Ku, u = null, s = Wp(c);
  e = typeof e == "function" ? e : e === void 0 ? q_ : Ce(+e), t = typeof t == "function" ? t : Ce(t === void 0 ? 0 : +t), r = typeof r == "function" ? r : r === void 0 ? W_ : Ce(+r);
  function c(f) {
  ...
  function l() {
    return Y_().defined(a).curve(o).context(i);
  }
...
const zp = {
...
}, G_ = Qt(1 / 3), E3 = G_ * 2, T3 = {
  draw(e, t) {
    const r = Qt(t / E3), n = r * G_;
...
}, A3 = 0.8908130915292852, K_ = ko(Bo / 10) / ko(7 * Bo / 10), O3 = ko(Gu / 10) * K_, S3 = -$_(Gu / 10) * K_, x3 = {
  draw(e, t) {
    const r = Qt(t * A3), n = O3 * r, a = S3 * r;
    e.moveTo(0, -r), e.lineTo(n, a);
    for (let i = 1; i < 5; ++i) {
      const o = Gu * i / 5, u = $_(o), s = ko(o);
  ...
  draw(e, t) {
    const r = -Qt(t / (zc * 3));
    e.moveTo(0, r * 2), e.lineTo(-zc * r, -r), e.lineTo(zc * r, -r), e.closePath();
  }
}, Pt = -0.5, It = Qt(3) / 2, uh = 1 / Qt(12), P3 = (uh / 2 + 1) * 3, I3 = {
  draw(e, t) {
    const r = Qt(t / P3), n = r / 2, a = r * uh, i = n, o = r * uh + r, u = -i, s = o;
...
function Ky(e, t, r) {
  ...
  return (Gy(i) + Gy(o)) * Math.min(Math.abs(i), Math.abs(o), 0.5 * Math.abs(u)) || 0;
}
function Vy(e, t) {
  var r = e._x1 - e._x0;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Gc(this, this._t0, Vy(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, Gc(this, Vy(this, r = Ky(this, e, t)), r);
          break;
        default:
          Gc(this, this._t0, r = Ky(this, e, t));
          break;
      }
...
function J_(e) {
  this._context = new eA(e);
}
(J_.prototype = Object.create($o.prototype)).point = function(e, t) {
  ...
  lineEnd: function() {
    ...
    if (r)
      if (this._line ? this._context.lineTo(e[0], t[0]) : this._context.moveTo(e[0], t[0]), r === 2)
        ...
        for (var n = Xy(e), a = Xy(t), i = 0, o = 1; o < r; ++i, ++o)
...
function q3() {
  var e = Ce([]), t = sh, r = Vn, n = U3;
  function a(i) {
    var o = Array.from(e.apply(this, arguments), H3), u, s = o.length, c = -1, l;
    for (const f of i)
      for (u = 0, ++c; u < s; ++u)
...
var rA = {
  ...
  rA["symbol".concat(zu(t))] = r;
}, Gp = function(t) {
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, u = o === void 0 ? "area" : o, s = Q3(t, G3), c = Zy(Zy({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), l = function() {
    var m = eR(n), v = C3().type(m).size(tR(i, u, n));
    return v();
...
function uR(e, t, r) {
  return t = Uo(t), sR(e, nA() ? Reflect.construct(t, r || [], Uo(e).constructor) : t.apply(e, r));
}
function sR(e, t) {
...
var Ct = 32, Kp = /* @__PURE__ */ (function(e) {
  function t() {
    return aR(this, t), uR(this, t, arguments);
  }
  return lR(t, e), oR(t, [{
    key: "renderIcon",
    value: (
...
function iA() {
  if (ib) return Jc;
  ib = 1;
  var e = qu(), t = dR(), r = hR(), n = pR(), a = mR(), i = yR();
  function o(u) {
    var s = this.__data__ = new e(u);
    this.size = s.size;
  }
  return o.prototype.clear = t, o.prototype.delete = r, o.prototype.get = n, o.prototype.has = a, o.prototype.set = i, Jc = o, Jc;
}
var el, ob;
function bR() {
  if (ob) return el;
...
function oA() {
  ...
  return n.prototype.add = n.prototype.push = t, n.prototype.has = r, rl = n, rl;
}
var nl, cb;
function uA() {
  if (cb) return nl;
...
function TR() {
  if (mb) return cl;
  mb = 1;
  var e = zi(), t = vR(), r = Bp(), n = cA(), a = ER(), i = Vp(), o = 1, u = 2, s = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", h = "[object Number]", p = "[object RegExp]", g = "[object Set]", y = "[object String]", m = "[object Symbol]", v = "[object ArrayBuffer]", E = "[object DataView]", _ = e ? e.prototype : void 0, A = _ ? _.valueOf : void 0;
...
function SR() {
  if (Eb) return pl;
  Eb = 1;
  var e = AR(), t = OR(), r = Object.prototype, n = r.propertyIsEnumerable, a = Object.getOwnPropertySymbols, i = a ? function(o) {
...
function Xp() {
  if (Ab) return bl;
  Ab = 1;
  var e = wR(), t = wr(), r = Object.prototype, n = r.hasOwnProperty, a = r.propertyIsEnumerable, i = e(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? e : function(o) {
...
function IR() {
  ...
  D[E] = D[_] = D[A] = D[b] = D[T] = D[O] = D[P] = D[N] = D[j] = !0, D[n] = D[a] = D[m] = D[i] = D[v] = D[o] = D[u] = D[s] = D[c] = D[l] = D[f] = D[h] = D[p] = D[g] = D[y] = !1;
  function R(B) {
...
function CR() {
  return Cb || (Cb = 1, (function(e, t) {
    var r = R_(), n = t && !t.nodeType && t, a = n && !0 && e && !e.nodeType && e, i = a && a.exports === n, o = i && r.process, u = (function() {
      try {
...
function hA() {
  if (Nb) return Al;
  Nb = 1;
  var e = IR(), t = dA(), r = CR(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return Al = a, Al;
}
var Ol, Rb;
function NR() {
  if (Rb) return Ol;
  Rb = 1;
  var e = xR(), t = Xp(), r = Tt(), n = fA(), a = Qp(), i = hA(), o = Object.prototype, u = o.hasOwnProperty;
  function s(c, l) {
...
function DR() {
  if (Lb) return wl;
  Lb = 1;
  var e = pA(), t = e(Object.keys, Object);
  return wl = t, wl;
}
var Pl, kb;
function MR() {
  if (kb) return Pl;
  kb = 1;
  var e = RR(), t = DR(), r = Object.prototype, n = r.hasOwnProperty;
  function a(i) {
    if (!e(i))
      return t(i);
    var o = [];
...
function kR() {
  if ($b) return Rl;
  $b = 1;
  var e = LR(), t = 1, r = Object.prototype, n = r.hasOwnProperty;
  function a(i, o, u, s, c, l) {
    ...
    for (var b = f; ++m < p; ) {
      ...
      var T = i[v], O = o[v];
      if (s)
        var P = f ? s(O, T, v, o, i, l) : s(T, O, v, i, o, l);
      if (!(P === void 0 ? T === O || c(T, O, u, s, l) : P)) {
        A = !1;
        break;
      }
      b || (b = v == "constructor");
...
function $R() {
  if (Yb) return Bl;
  Yb = 1;
  var e = BR(), t = jp(), r = jR(), n = mA(), a = FR(), i = xr(), o = D_(), u = "[object Map]", s = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", h = "[object DataView]", p = o(e), g = o(t), y = o(r), m = o(n), v = o(a), E = i;
...
function UR() {
  if (zb) return jl;
  zb = 1;
  var e = iA(), t = cA(), r = TR(), n = kR(), a = $R(), i = Tt(), o = fA(), u = hA(), s = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", h = Object.prototype, p = h.hasOwnProperty;
...
function zR() {
  if (eg) return zl;
  eg = 1;
  var e = k_(), t = Xp(), r = Tt(), n = Qp(), a = Zp(), i = Yu();
  function o(u, s, c) {
    s = e(s, u);
...
function KR() {
  if (rg) return Kl;
  rg = 1;
  var e = Jp(), t = B_(), r = GR(), n = Lp(), a = yA(), i = bA(), o = Yu(), u = 1, s = 2;
  function c(l, f) {
...
function aD() {
  if (mg) return sf;
  mg = 1;
  var e = mA(), t = nD(), r = Vp(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return sf = a, sf;
}
...
function iD() {
  if (yg) return cf;
  yg = 1;
  var e = oA(), t = tD(), r = rD(), n = sA(), a = aD(), i = Vp(), o = 200;
  function u(s, c, l) {
...
var uD = oD();
const gg = /* @__PURE__ */ xe(uD);
function vA(e, t, r) {
  return t === !0 ? gg(e, r) : de(t) ? gg(e, t) : e;
}
function Qn(e) {
  "@babel/helpers - typeof";
...
function fD(e, t, r) {
  return t = Ho(t), dD(e, EA() ? Reflect.construct(t, r || [], Ho(e).constructor) : t.apply(e, r));
}
function dD(e, t) {
...
var Tg = 1, Hr = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    cD(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = fD(this, t, [].concat(a)), Qu(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
  return pD(t, e), lD(t, [{
    ...
    value: function() {
      ...
      a ? (Math.abs(a.width - this.lastBoundingBox.width) > Tg || Math.abs(a.height - this.lastBoundingBox.height) > Tg) && (this.lastBoundingBox.width = a.width, this.lastBoundingBox.height = a.height, n && n(a)) : (this.lastBoundingBox.width !== -1 || this.lastBoundingBox.height !== -1) && (this.lastBoundingBox.width = -1, this.lastBoundingBox.height = -1, n && n(null));
    }
  }, {
    key: "getBBoxSnapshot",
    value: function() {
...
function wD() {
  if (Dg) return _f;
  Dg = 1;
  var e = $p(), t = Up(), r = ur(), n = OA(), a = OD(), i = dA(), o = xD(), u = Aa(), s = Tt();
  function c(l, f, h) {
...
function ND() {
  if (jg) return wf;
  jg = 1;
  var e = CD(), t = SA(), r = Aa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function LD() {
  if (qg) return Rf;
  qg = 1;
  var e = _A(), t = wD(), r = MD(), n = Zu(), a = r(function(i, o) {
    if (i == null)
      return [];
    var u = o.length;
    ...
    if (l && l.length) {
      var R = {
        ...
        var q = Df({
          ...
          paddingBottom: 4,
          color: F.color || "#000"
        }, u), Y = F.formatter || f || YD, Q = F.value, te = F.name, k = Q, W = te;
        if (Y && k != null && W != null) {
          var z = Y(Q, te, F, $, l);
          if (Array.isArray(z)) {
            var Z = BD(z, 2);
...
var Da = "recharts-tooltip-wrapper", VD = {
  visibility: "hidden"
};
function XD(e) {
...
function ZD(e) {
  ...
  return o.height > 0 && o.width > 0 && r ? (l = zg({
...
function r6(e, t, r) {
  return t = qo(t), n6(e, xA() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function n6(e, t) {
...
var Vg = 1, u6 = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    JD(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = r6(this, t, [].concat(a)), mh(r, "state", {
      dismissed: !1,
  ...
  return i6(t, e), t6(t, [{
    ...
    value: function() {
      if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
        var n = this.wrapperNode.getBoundingClientRect();
        (Math.abs(n.width - this.state.lastBoundingBox.width) > Vg || Math.abs(n.height - this.state.lastBoundingBox.height) > Vg) && this.setState({
          lastBoundingBox: {
            width: n.width,
            height: n.height
          }
    ...
    key: "render",
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, u = a.animationDuration, s = a.animationEasing, c = a.children, l = a.coordinate, f = a.hasPayload, h = a.isAnimationActive, p = a.offset, g = a.position, y = a.reverseDirection, m = a.useTranslate3d, v = a.viewBox, E = a.wrapperStyle, _ = ZD({
        ...
        useTranslate3d: m,
        viewBox: v
      }), A = _.cssClasses, b = _.cssProperties, T = Kg(Kg({
...
function d6(e, t, r) {
  return t = Wo(t), h6(e, PA() ? Reflect.construct(t, r || [], Wo(e).constructor) : t.apply(e, r));
}
function h6(e, t) {
...
var yt = /* @__PURE__ */ (function(e) {
  function t() {
    return c6(this, t), d6(this, t, arguments);
  }
  return m6(t, e), f6(t, [{
    key: "render",
    value: function() {
      ...
      f && b.length && (b = vA(g.filter(function(O) {
        return O.value != null && (O.hide !== !0 || n.props.includeHidden);
      }), y, b6));
      var T = b.length > 0;
      return /* @__PURE__ */ C.createElement(u6, {
        allowEscapeViewBox: o,
        animationDuration: u,
        animationEasing: s,
        isAnimationActive: h,
...
function CA() {
  if (tv) return Bf;
  tv = 1;
  var e = T6(), t = Gr(), r = Ta(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, u = parseInt;
  function s(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function _6() {
  if (rv) return jf;
  rv = 1;
  var e = Gr(), t = v6(), r = CA(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(u, s, c) {
    ...
    function b(B) {
      return m = B, g = setTimeout(P, s), v ? A(B) : p;
    }
    function T(B) {
      var F = B - y, $ = B - m, q = s - F;
      return E ? i(q, h - $) : q;
...
function A6() {
  if (nv) return Ff;
  nv = 1;
  var e = _6(), t = Gr(), r = "Expected a function";
  function n(a, i, o) {
    var u = !0, s = !0;
...
var Xi = /* @__PURE__ */ NT(function(e, t) {
  ...
  }), P = P6(O, 2), N = P[0], j = P[1], D = ex(function(B, F) {
    j(function($) {
...
var Za = function(t) {
  ...
  try {
    var i = document.getElementById(uv);
    i || (i = document.createElement("span"), i.setAttribute("id", uv), i.setAttribute("aria-hidden", "true"), document.body.appendChild(i));
    var o = bh(bh({}, B6), n);
    ...
    return Cn.widthCache[a] = s, ++Cn.cacheCount > k6 && (Cn.cacheCount = 0, Cn.widthCache = {}), s;
  } catch {
    return {
      width: 0,
      height: 0
...
function Y6(e, t, r) {
  return t && cv(e.prototype, t), r && cv(e, r), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function z6(e) {
  var t = G6(e, "string");
...
var lv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, fv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, K6 = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, V6 = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, RA = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, X6 = Object.keys(RA), Bn = "NaN";
function Q6(e, t) {
  return e * RA[t];
}
var ho = /* @__PURE__ */ (function() {
  function e(t, r) {
    W6(this, e), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !K6.test(r) && (this.num = NaN, this.unit = ""), X6.includes(r) && (this.num = Q6(t, r), this.unit = "px");
  }
  return Y6(e, [{
    key: "add",
    value: function(r) {
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = V6.exec(r)) !== null && n !== void 0 ? n : [], i = Yo(a, 3), o = i[1], u = i[2];
...
function DA(e) {
  ...
  for (var t = e; t.includes("*") || t.includes("/"); ) {
    var r, n = (r = lv.exec(t)) !== null && r !== void 0 ? r : [], a = Yo(n, 4), i = a[1], o = a[2], u = a[3], s = ho.parse(i ?? ""), c = ho.parse(u ?? ""), l = o === "*" ? s.multiply(c) : s.divide(c);
    if (l.isNaN())
      return Bn;
    t = t.replace(lv, l.toString());
  }
  for (; t.includes("+") || /.-\d+(?:\.\d+)?/.test(t); ) {
    var f, h = (f = fv.exec(t)) !== null && f !== void 0 ? f : [], p = Yo(h, 4), g = p[1], y = p[2], m = p[3], v = ho.parse(g ?? ""), E = ho.parse(m ?? ""), _ = y === "+" ? v.add(E) : v.subtract(E);
    if (_.isNaN())
      return Bn;
    t = t.replace(fv, _.toString());
  }
  return t;
}
var dv = /\(([^()]*)\)/;
function Z6(e) {
  for (var t = e; t.includes("("); ) {
    var r = dv.exec(t), n = Yo(r, 2), a = n[1];
    t = t.replace(dv, DA(a));
  }
  return t;
}
...
function $f(e) {
  var t = eM(e.slice(5, -1));
  return t === Bn ? "" : t;
}
var tM = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], rM = ["dx", "dy", "angle", "className", "breakAll"];
function gh() {
...
var MA = /[ \f\n\r\t\v\u2028\u2029]+/, LA = function(t) {
  ...
  try {
    var i = [];
    me(r) || (n ? i = r.toString().split("") : i = r.toString().split(MA));
  ...
  for (var y = "…", m = function($) {
    ...
    var b = Math.floor((v + E) / 2), T = b - 1, O = m(T), P = pv(O, 2), N = P[0], j = P[1], D = m(b), R = pv(D, 1), B = R[0];
  ...
  var r = me(t) ? [] : t.toString().split(MA);
  return [{
    words: r
  }];
}, cM = function(t) {
  ...
  return yv(a);
}, bv = "#808080", bn = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, l = t.scaleToFit, f = l === void 0 ? !1 : l, h = t.textAnchor, p = h === void 0 ? "start" : h, g = t.verticalAnchor, y = g === void 0 ? "end" : g, m = t.fill, v = m === void 0 ? bv : m, E = hv(t, tM), _ = Fr(function() {
    return cM({
      breakAll: E.breakAll,
      children: E.children,
      maxLines: E.maxLines,
  ...
  }, [E.breakAll, E.children, E.maxLines, f, E.style, E.width]), A = E.dx, b = E.dy, T = E.angle, O = E.className, P = E.breakAll, N = hv(E, rM);
  if (!ze(n) || !ze(i))
    return null;
  ...
  switch (y) {
    case "start":
      ...
      break;
    case "middle":
      R = $f("calc(".concat((_.length - 1) / 2, " * -").concat(u, " + (").concat(c, " / 2))"));
      break;
    default:
      R = $f("calc(".concat(_.length - 1, " * -").concat(u, ")"));
      break;
  }
  var B = [];
  if (f) {
...
function n0(e) {
  let t, r, n;
  e.length !== 2 ? (t = qr, r = (u, s) => qr(e(u), s), n = (u, s) => e(u) - s) : (t = e === qr || e === lM ? e : fM, r = e, n = e);
...
class gv extends Map {
  ...
  set(t, r) {
    return super.set(pM(this, t), r);
  }
  delete(t) {
    return super.delete(mM(this, t));
  }
}
...
function pM({ _intern: e, _key: t }, r) {
  const n = t(r);
...
const gM = Math.sqrt(50), vM = Math.sqrt(10), EM = Math.sqrt(2);
function zo(e, t, r) {
  const n = (t - e) / Math.max(0, r), a = Math.floor(Math.log10(n)), i = n / Math.pow(10, a), o = i >= gM ? 10 : i >= vM ? 5 : i >= EM ? 2 : 1;
  let u, s, c;
  return a < 0 ? (c = Math.pow(10, -a) / o, u = Math.round(e * c), s = Math.round(t * c), u / c < e && ++u, s / c > t && --s, c = -c) : (c = Math.pow(10, a) * o, u = Math.round(e / c), s = Math.round(t / c), u * c < e && ++u, s * c > t && --s), s < u && 0.5 <= r && r < 2 ? zo(e, t, r * 2) : [u, s, c];
}
function vh(e, t, r) {
  if (t = +t, e = +e, r = +r, !(r > 0)) return [];
  if (e === t) return [e];
  const n = t < e, [a, i, o] = n ? zo(t, e, r) : zo(e, t, r);
  if (!(i >= a)) return [];
...
function jA(e, t, r = 0, n = 1 / 0, a) {
  if (t = Math.floor(t), r = Math.floor(Math.max(0, r)), n = Math.floor(Math.min(e.length - 1, n)), !(r <= t && t <= n)) return e;
  for (a = a === void 0 ? BA : bM(a); n > r; ) {
    if (n - r > 600) {
...
function TM(e, t, r) {
  if (e = Float64Array.from(dM(e)), !(!(n = e.length) || isNaN(t = +t))) {
    if (t <= 0 || n < 2) return Tv(e);
    if (t >= 1) return Ev(e);
    var n, a = (n - 1) * t, i = Math.floor(a), o = Ev(jA(e, i).subarray(0, i + 1)), u = Tv(e.subarray(i + 1));
    return o + (u - o) * (a - i);
  }
}
function _M(e, t, r = kA) {
...
function Ja() {
  return FA(yi.apply(null, arguments).paddingInner(1));
}
function i0(e, t, r) {
...
var bi = 0.7, Go = 1 / bi, Wn = "\\s*([+-]?\\d+)\\s*", gi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", OM = /^#([0-9a-f]{3,8})$/, SM = new RegExp(`^rgb\\(${Wn},${Wn},${Wn}\\)$`), xM = new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`), wM = new RegExp(`^rgba\\(${Wn},${Wn},${Wn},${gi}\\)$`), PM = new RegExp(`^rgba\\(${rr},${rr},${rr},${gi}\\)$`), IM = new RegExp(`^hsl\\(${gi},${rr},${rr}\\)$`), CM = new RegExp(`^hsla\\(${gi},${rr},${rr},${gi}\\)$`), _v = {
  aliceblue: 15792383,
...
function vi(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = OM.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? Sv(t) : r === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? po(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? po(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = SM.exec(e)) ? new gt(t[1], t[2], t[3], 1) : (t = xM.exec(e)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = wM.exec(e)) ? po(t[1], t[2], t[3], t[4]) : (t = PM.exec(e)) ? po(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = IM.exec(e)) ? Pv(t[1], t[2] / 100, t[3] / 100, 1) : (t = CM.exec(e)) ? Pv(t[1], t[2] / 100, t[3] / 100, t[4]) : _v.hasOwnProperty(e) ? Sv(_v[e]) : e === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function Sv(e) {
...
function Ah(e, t, r, n) {
  return arguments.length === 1 ? DM(e) : new gt(e, t, r, n ?? 1);
}
function gt(e, t, r, n) {
...
i0(gt, Ah, $A(Zi, {
  brighter(e) {
    return e = e == null ? Go : Math.pow(Go, e), new gt(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  darker(e) {
  ...
  clamp() {
    return new gt(fn(this.r), fn(this.g), fn(this.b), Ko(this.opacity));
  },
  displayable() {
...
function LM(e, t, r, n) {
  return arguments.length === 1 ? UA(e) : new Wt(e, t, r, n ?? 1);
}
function Wt(e, t, r, n) {
...
i0(Wt, LM, $A(Zi, {
  brighter(e) {
    return e = e == null ? Go : Math.pow(Go, e), new Wt(this.h, this.s, this.l * e, this.opacity);
  },
  darker(e) {
  ...
  rgb() {
    ...
    return new gt(
      Uf(e >= 240 ? e - 240 : e + 120, a, n),
      Uf(e, a, n),
      Uf(e < 120 ? e + 240 : e - 120, a, n),
      this.opacity
    );
  },
  clamp() {
    return new Wt(Iv(this.h), mo(this.s), mo(this.l), Ko(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Ko(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${Iv(this.h)}, ${mo(this.s) * 100}%, ${mo(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function Iv(e) {
...
function jM(e) {
  return (e = +e) == 1 ? HA : function(t, r) {
    return r - t ? BM(t, r, e) : o0(isNaN(t) ? r : t);
  };
}
function HA(e, t) {
  var r = t - e;
  return r ? kM(e, r) : o0(isNaN(e) ? t : e);
}
const Cv = (function e(t) {
  var r = jM(t);
  function n(a, i) {
    var o = r((a = Ah(a)).r, (i = Ah(i)).r), u = r(a.g, i.g), s = r(a.b, i.b), c = HA(a.opacity, i.opacity);
    return function(l) {
...
var Oh = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Hf = new RegExp(Oh.source, "g");
function WM(e) {
  return function() {
    return e;
  };
...
function zM(e, t) {
  var r = Oh.lastIndex = Hf.lastIndex = 0, n, a, i, o = -1, u = [], s = [];
  for (e = e + "", t = t + ""; (n = Oh.exec(e)) && (a = Hf.exec(t)); )
    (i = a.index) > r && (i = t.slice(r, i), u[o] ? u[o] += i : u[++o] = i), (n = n[0]) === (a = a[0]) ? u[o] ? u[o] += a : u[++o] = a : (u[++o] = null, s.push({ i: o, x: Vo(n, a) })), r = Hf.lastIndex;
  return r < t.length && (i = t.slice(r), u[o] ? u[o] += i : u[++o] = i), u.length < 2 ? s[0] ? YM(s[0].x) : WM(t) : (t = s.length, function(c) {
...
function Sa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? o0(t) : (r === "number" ? Vo : r === "string" ? (n = vi(t)) ? (t = n, Cv) : zM : t instanceof vi ? Cv : t instanceof Date ? HM : $M(t) ? FM : Array.isArray(t) ? UM : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? qM : Vo)(e, t);
}
function u0(e, t) {
  return e = +e, t = +t, function(r) {
...
function es() {
  var e = Nv, t = Nv, r = Sa, n, a, i, o = pt, u, s, c;
  function l() {
    var h = Math.min(e.length, t.length);
    return o !== pt && (o = VM(e[0], e[h - 1])), u = h > 2 ? QM : XM, s = c = null, f;
  }
  function f(h) {
    return h == null || isNaN(h = +h) ? i : (s || (s = u(e.map(n), t, r)))(n(o(h)));
  }
  return f.invert = function(h) {
    return o(a((c || (c = u(t, e.map(n), Vo)))(h)));
  }, f.domain = function(h) {
    return arguments.length ? (e = Array.from(h, Xo), l()) : e.slice();
  }, f.range = function(h) {
...
var tL = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function Ei(e) {
  if (!(t = tL.exec(e))) throw new Error("invalid format: " + e);
  var t;
  return new c0({
    fill: t[1],
    align: t[2],
...
function nL(e, t) {
  var r = Qo(e, t);
  if (!r) return Zo = void 0, e.toPrecision(t);
  var n = r[0], a = r[1], i = a - (Zo = Math.max(-8, Math.min(8, Math.floor(a / 3))) * 3) + 1, o = n.length;
...
var Lv = Array.prototype.map, kv = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
function aL(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? Mv : JM(Lv.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? Mv : eL(Lv.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", u = e.minus === void 0 ? "−" : e.minus + "", s = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f, h) {
    f = Ei(f);
    var p = f.fill, g = f.align, y = f.sign, m = f.symbol, v = f.zero, E = f.width, _ = f.comma, A = f.precision, b = f.trim, T = f.type;
    T === "n" ? (_ = !0, T = "g") : Dv[T] || (A === void 0 && (A = 12), b = !0, T = "g"), (v || p === "0" && g === "=") && (v = !0, p = "0", g = "=");
    var O = (h && h.prefix !== void 0 ? h.prefix : "") + (m === "$" ? r : m === "#" && /[boxX]/.test(T) ? "0" + T.toLowerCase() : ""), P = (m === "$" ? n : /[%p]/.test(T) ? o : "") + (h && h.suffix !== void 0 ? h.suffix : ""), N = Dv[T], j = /[defgprs%]/.test(T);
    ...
    function D(R) {
      ...
      if (T === "c")
        ...
        R = +R;
        var Q = R < 0 || 1 / R < 0;
        if (R = isNaN(R) ? s : N(Math.abs(R), A), b && (R = rL(R)), Q && +R == 0 && y !== "+" && (Q = !1), B = (Q ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + B, F = (T === "s" && !isNaN(R) && Zo !== void 0 ? kv[8 + Zo / 3] : "") + F + (Q && y === "(" ? ")" : ""), j) {
          for ($ = -1, q = R.length; ++$ < q; )
  ...
  function l(f, h) {
    var p = Math.max(-8, Math.min(8, Math.floor(ea(h) / 3))) * 3, g = Math.pow(10, -p), y = c((f = Ei(f), f.type = "f", f), { suffix: kv[8 + p / 3] });
    return function(m) {
      return y(g * m);
    };
  }
...
function iL(e) {
  return yo = aL(e), l0 = yo.format, qA = yo.formatPrefix, yo;
}
function oL(e) {
...
function WA(e, t, r, n) {
  ...
  switch (n = Ei(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = uL(a, o)) && (n.precision = i), qA(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(i = sL(a, Math.max(Math.abs(e), Math.abs(t)))) && (n.precision = i - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
...
function Kr(e) {
  ...
  return e.ticks = function(r) {
    ...
    var a = t();
    return WA(a[0], a[a.length - 1], r ?? 10, n);
  }, e.nice = function(r) {
    r == null && (r = 10);
...
function YA(e) {
  ...
  }, e = arguments.length ? Array.from(e, Xo) : [0, 1], Kr(r);
}
function zA(e, t) {
  e = e.slice();
...
function dL(e) {
  return e === 10 ? fL : e === Math.E ? Math.exp : (t) => Math.pow(e, t);
}
function hL(e) {
...
function f0(e) {
  const t = e(Bv, jv), r = t.domain;
  let n = 10, a, i;
  function o() {
    return a = hL(n), i = dL(n), r()[0] < 0 ? (a = Fv(a), i = Fv(i), e(cL, lL)) : e(Bv, jv), t;
  }
...
function GA() {
  const e = f0(es()).domain([1, 10]);
  return e.copy = () => Ji(e, GA()).base(e.base()), Ut.apply(e, arguments), e;
}
function $v(e) {
  return function(t) {
...
function d0(e) {
  var t = 1, r = e($v(t), Uv(t));
  return r.constant = function(n) {
    return arguments.length ? e($v(t = +n), Uv(t)) : t;
  }, Kr(r);
}
function KA() {
  var e = d0(es());
  return e.copy = function() {
    return Ji(e, KA()).constant(e.constant());
...
function h0(e) {
  var t = e(pt, pt), r = 1;
  function n() {
    return r === 1 ? e(pt, pt) : r === 0.5 ? e(pL, mL) : e(Hv(r), Hv(1 / r));
  }
...
function VA() {
  ...
  return a.invert = function(i) {
    return e.invert(qv(i));
  }, a.domain = function(i) {
    return arguments.length ? (e.domain(i), a) : e.domain();
  }, a.range = function(i) {
    return arguments.length ? (e.range((t = Array.from(i, Xo)).map(qv)), a) : t.slice();
    ...
    return VA(e.domain(), t).round(r).clamp(e.clamp()).unknown(n);
...
function XA() {
  ...
  function a() {
    ...
    for (r = new Array(u - 1); ++o < u; ) r[o - 1] = _M(e, o / u);
    return i;
  }
  function i(o) {
  ...
  return i.invertExtent = function(o) {
    ...
    return XA().domain(e).range(t).unknown(n);
...
function QA() {
  ...
  return o.domain = function(s) {
    ...
    return QA().domain([e, t]).range(a).unknown(i);
...
function ZA() {
  ...
  return a.domain = function(i) {
    ...
    return ZA().domain(e).range(t).unknown(r);
  }, Ut.apply(a, arguments);
}
const qf = /* @__PURE__ */ new Date(), Wf = /* @__PURE__ */ new Date();
function Ke(e, t, r, n) {
  function a(i) {
  ...
  return a.floor = (i) => (e(i = /* @__PURE__ */ new Date(+i)), i), a.ceil = (i) => (e(i = new Date(i - 1)), t(i, 1), e(i), i), a.round = (i) => {
    ...
    if (o >= o)
      if (u < 0) for (; ++u <= 0; )
        ...
        for (; t(o, 1), !i(o); )
          ;
  }), r && (a.count = (i, o) => (qf.setTime(+i), Wf.setTime(+o), e(qf), e(Wf), Math.floor(r(qf, Wf))), a.every = (i) => (i = Math.floor(i), !isFinite(i) || !(i > 0) ? null : i > 1 ? a.filter(n ? (o) => n(o) % i === 0 : (o) => a.count(0, o) % i === 0) : a)), a;
}
const eu = Ke(() => {
}, (e, t) => {
  e.setTime(+e + t);
}, (e, t) => t - e);
eu.every = (e) => (e = Math.floor(e), !isFinite(e) || !(e > 0) ? null : e > 1 ? Ke((t) => {
  t.setTime(Math.floor(t / e) * e);
}, (t, r) => {
  t.setTime(+t + r * e);
}, (t, r) => (r - t) / e) : eu);
eu.range;
const hr = 1e3, Mt = hr * 60, pr = Mt * 60, _r = pr * 24, m0 = _r * 7, Wv = _r * 30, Yf = _r * 365, un = Ke((e) => {
...
const rs = On(0), tu = On(1), gL = On(2), vL = On(3), ta = On(4), EL = On(5), TL = On(6);
rs.range;
tu.range;
gL.range;
vL.range;
...
const ns = Sn(0), ru = Sn(1), _L = Sn(2), AL = Sn(3), ra = Sn(4), OL = Sn(5), SL = Sn(6);
ns.range;
ru.range;
_L.range;
AL.range;
...
function eO(e, t, r, n, a, i) {
  ...
  function s(c, l, f) {
    ...
    if (p === o.length) return e.every(Th(c / Yf, l / Yf, f));
    if (p === 0) return eu.every(Math.max(Th(c, l, f), 1));
    const [g, y] = o[h / o[p - 1][2] < o[p][2] / h ? p - 1 : p];
    return g.every(y);
  }
  return [u, s];
}
const [xL, wL] = eO(Or, T0, ns, JA, v0, b0), [PL, IL] = eO(Ar, E0, rs, eo, g0, y0);
function zf(e) {
  if (0 <= e.y && e.y < 100) {
  ...
  function T(G, re) {
    return function(ie) {
      ...
      for (ie instanceof Date || (ie = /* @__PURE__ */ new Date(+ie)); ++ye < Pe; )
        G.charCodeAt(ye) === 37 && (M.push(G.slice(X, ye)), (et = Yv[De = G.charAt(++ye)]) != null ? De = G.charAt(++ye) : et = De === "e" ? " " : "0", (Cr = re[De]) && (De = Cr(ie, et)), M.push(De), X = ye + 1);
      return M.push(G.slice(X, ye)), M.join("");
    };
  }
  function O(G, re) {
    return function(ie) {
      var M = La(1900, void 0, 1), ye = P(M, G, ie += "", 0), X, Pe;
      ...
      if (re && !("Z" in M) && (M.Z = 0), "p" in M && (M.H = M.H % 12 + M.p * 12), M.m === void 0 && (M.m = "q" in M ? M.q : 0), "V" in M) {
        ...
        "w" in M || (M.w = 1), "Z" in M ? (X = Gf(La(M.y, 0, 1)), Pe = X.getUTCDay(), X = Pe > 4 || Pe === 0 ? ru.ceil(X) : ru(X), X = ts.offset(X, (M.V - 1) * 7), M.y = X.getUTCFullYear(), M.m = X.getUTCMonth(), M.d = X.getUTCDate() + (M.w + 6) % 7) : (X = zf(La(M.y, 0, 1)), Pe = X.getDay(), X = Pe > 4 || Pe === 0 ? tu.ceil(X) : tu(X), X = eo.offset(X, (M.V - 1) * 7), M.y = X.getFullYear(), M.m = X.getMonth(), M.d = X.getDate() + (M.w + 6) % 7);
      } else ("W" in M || "U" in M) && ("w" in M || (M.w = "u" in M ? M.u % 7 : "W" in M ? 1 : 0), Pe = "Z" in M ? Gf(La(M.y, 0, 1)).getUTCDay() : zf(La(M.y, 0, 1)).getDay(), M.m = 0, M.d = "W" in M ? (M.w + 6) % 7 + M.W * 7 - (Pe + 5) % 7 : M.w + M.U * 7 - (Pe + 6) % 7);
      return "Z" in M ? (M.H += M.Z / 100 | 0, M.M += M.Z % 100, Gf(M)) : zf(M);
    };
  }
  function P(G, re, ie, M) {
    for (var ye = 0, X = re.length, Pe = ie.length, De, et; ye < X; ) {
      if (M >= Pe) return -1;
      if (De = re.charCodeAt(ye++), De === 37) {
        if (De = re.charAt(ye++), et = b[De in Yv ? re.charAt(ye++) : De], !et || (M = et(G, ie, M)) < 0) return -1;
...
function ka(e) {
  return new RegExp("^(?:" + e.map(DL).join("|") + ")", "i");
}
function Ba(e) {
...
function ik(e, t) {
  return e = rO(e), ge(ta.count(Ar(e), e) + (Ar(e).getDay() === 4), t, 2);
}
function ok(e) {
  return e.getDay();
}
function uk(e, t) {
  return ge(tu.count(Ar(e) - 1, e), t, 2);
}
function sk(e, t) {
  return ge(e.getFullYear() % 100, t, 2);
}
function ck(e, t) {
  return e = rO(e), ge(e.getFullYear() % 100, t, 2);
}
function lk(e, t) {
...
function mk(e, t) {
  return ge(1 + ts.count(Or(e), e), t, 3);
}
function nO(e, t) {
...
function Tk(e, t) {
  return ge(ns.count(Or(e) - 1, e), t, 2);
}
function aO(e) {
  var t = e.getUTCDay();
...
function _k(e, t) {
  return e = aO(e), ge(ra.count(Or(e), e) + (Or(e).getUTCDay() === 4), t, 2);
}
function Ak(e) {
  return e.getUTCDay();
}
function Ok(e, t) {
  return ge(ru.count(Or(e) - 1, e), t, 2);
}
function Sk(e, t) {
  return ge(e.getUTCFullYear() % 100, t, 2);
}
function xk(e, t) {
  return e = aO(e), ge(e.getUTCFullYear() % 100, t, 2);
}
function wk(e, t) {
...
function Ck(e) {
  return Nn = CL(e), iO = Nn.format, Nn.parse, oO = Nn.utcFormat, Nn.utcParse, Nn;
}
function Nk(e) {
  return new Date(e);
}
...
function _0(e, t, r, n, a, i, o, u, s, c) {
  ...
  return l.invert = function(T) {
    ...
    return arguments.length ? h(Array.from(T, Rk)) : h().map(Nk);
  }, l.ticks = function(T) {
    var O = h();
    ...
    var O = h();
    return (!T || typeof T.range != "function") && (T = t(O[0], O[O.length - 1], T ?? 10)), T ? h(zA(O, T)) : l;
  }, l.copy = function() {
    return Ji(l, _0(e, t, r, n, a, i, o, u, s, c));
  }, l;
}
function Dk() {
  return Ut.apply(_0(PL, IL, Ar, E0, rs, eo, g0, y0, un, iO).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function Mk() {
  return Ut.apply(_0(xL, wL, Or, T0, ns, ts, v0, b0, un, oO).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function as() {
...
function sO() {
  var e = f0(as()).domain([1, 10]);
  return e.copy = function() {
    return Vr(e, sO()).base(e.base());
  }, Pr.apply(e, arguments);
}
function cO() {
  var e = d0(as());
  return e.copy = function() {
    return Vr(e, cO()).constant(e.constant());
  }, Pr.apply(e, arguments);
}
function A0() {
  var e = h0(as());
...
function lO() {
  ...
  return r.domain = function(n) {
    ...
    return Array.from({ length: n + 1 }, (a, i) => TM(e, i / n));
  }, r.copy = function() {
    return lO(t).domain(e);
...
function is() {
  ...
  function g(y) {
    return function(m) {
      var v, E, _;
      return arguments.length ? ([v, E, _] = m, c = GM(y, [v, E, _]), p) : [c(0), c(0.5), c(1)];
    };
  }
...
function dO() {
  var e = f0(is()).domain([0.1, 1, 10]);
  return e.copy = function() {
    return Vr(e, dO()).base(e.base());
  }, Pr.apply(e, arguments);
}
function hO() {
  var e = d0(is());
  return e.copy = function() {
    return Vr(e, hO()).constant(e.constant());
  }, Pr.apply(e, arguments);
}
function O0() {
  var e = h0(is());
...
const t1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  scaleBand: yi,
  scaleDiverging: fO,
  scaleDivergingLog: dO,
  scaleDivergingPow: O0,
  scaleDivergingSqrt: kk,
  ...
  scaleSequentialQuantile: lO,
  scaleSequentialSqrt: Lk,
  scaleSequentialSymlog: cO,
  scaleSqrt: yL,
  scaleSymlog: KA,
  scaleThreshold: ZA,
  scaleTime: Dk,
...
var $k = Fk();
const ss = /* @__PURE__ */ xe($k);
var Jf, u1;
function Uk() {
  if (u1) return Jf;
  u1 = 1;
  var e = $p(), t = ur(), r = OA(), n = Tt();
  function a(i, o) {
    var u = n(i) ? e : r;
    return u(i, t(o, 3));
  }
...
}, x0, Le = !0, Ft = "[DecimalError] ", dn = Ft + "Invalid argument: ", S0 = Ft + "Exponent out of range: ", wa = Math.floor, rn = Math.pow, Kk = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ot, Xe = 1e7, Re = 7, yO = 9007199254740991, nu = wa(yO / Re), ae = {};
...
ae.toPower = ae.pow = function(e) {
  ...
  if (t = e.e, r = e.d.length - 1, o = t >= r, i = u.s, o) {
    if ((r = l < 0 ? -l : l) <= yO) {
      for (a = new s(Ot), t = Math.ceil(n / Re + 4), Le = !1; r % 2 && (a = a.times(u), f1(a.d, t)), r = wa(r / 2), r !== 0; )
        u = u.times(u), f1(u.d, t);
      return Le = !0, e.s < 0 ? new s(Ot).div(a) : we(a, n);
    }
  } else if (i < 0) throw Error(Ft + "NaN");
  return i = i < 0 && e.d[Math.max(t, r)] & 1 ? -1 : 1, u.s = 1, Le = !1, a = e.times(Ti(u, n + c)), Le = !0, a = gO(a), a.s = i, a;
};
...
var Er = /* @__PURE__ */ (function() {
  ...
  return function(n, a, i, o) {
    var u, s, c, l, f, h, p, g, y, m, v, E, _, A, b, T, O, P, N = n.constructor, j = n.s == a.s ? 1 : -1, D = n.d, R = a.d;
    ...
    if (E = E / Re + 2 | 0, c = 0, O == 1)
      ...
      do
        l = 0, u = t(R, y, O, m), u < 0 ? (v = y[0], O != m && (v = v * Xe + (y[1] || 0)), l = v / T | 0, l > 1 ? (l >= Xe && (l = Xe - 1), f = e(R, l), h = f.length, m = y.length, u = t(f, y, h, m), u == 1 && (l--, r(f, O < h ? P : R, h))) : (l == 0 && (u = l = 1), f = R.slice()), h = f.length, h < m && f.unshift(0), r(y, f, m), u == -1 && (m = y.length, u = t(R, y, O, m), u < 1 && (l++, r(y, O < m ? P : R, m))), m = y.length) : u === 0 && (l++, y = [0]), g[c++] = l, u && y[0] ? y[m++] = D[A] || 0 : (y = [D[A]], m = 1);
...
function Ti(e, t) {
  ...
  if (c += h, y.precision = c, r = tr(g), n = r.charAt(0), i = He(p), Math.abs(i) < 15e14) {
    ...
    return s = rd(y, c + 2, m).times(i + ""), p = Ti(new y(n + "." + r.slice(1)), c - h).plus(s), y.precision = m, t == null ? (Le = !0, we(p, m)) : p;
  for (u = o = p = Er(p.minus(Ot), p.plus(Ot), c), l = we(p.times(p), c), a = 3; ; ) {
    if (o = we(o.times(l), c), s = u.plus(Er(o, new y(a), c)), tr(s.d).slice(0, c) === tr(u.d).slice(0, c))
      return u = u.times(2), i !== 0 && (u = u.plus(rd(y, c + 2, m).times(i + ""))), u = Er(u, new y(f), c), y.precision = m, t == null ? (Le = !0, we(u, m)) : u;
    u = s, a += 2;
  }
}
function l1(e, t) {
  ...
  if (t = t.slice(n, a), t) {
    if (a -= n, r = r - n - 1, e.e = wa(r / Re), e.d = [], n = (r + 1) % Re, r < 0 && (n += Re), n < a) {
      ...
      n -= a;
    for (; n--; ) t += "0";
    if (e.d.push(+t), Le && (e.e > nu || e.e < -nu)) throw Error(S0 + r);
  } else
    e.s = 0, e.e = 0, e.d = [0];
  return e;
}
...
function EO(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      return l1(o, i.toString());
    } else if (typeof i != "string")
      throw Error(dn + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, Kk.test(i)) l1(o, i);
    else throw Error(dn + i);
  }
  if (a.prototype = ae, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = EO, a.config = a.set = Vk, e === void 0 && (e = {}), e)
...
var t4 = function(t) {
  ...
  return function r() {
    return arguments.length === 0 || arguments.length === 1 && _O(arguments.length <= 0 ? void 0 : arguments[0]) ? r : t.apply(void 0, arguments);
  };
}, r4 = function e(t, r) {
  return t === 1 ? r : d1(function() {
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    var o = a.filter(function(u) {
      return u !== TO;
    }).length;
    return o >= t ? r.apply(void 0, a) : e(t - o, d1(function() {
      for (var u = arguments.length, s = new Array(u), c = 0; c < u; c++)
        s[c] = arguments[c];
      var l = a.map(function(f) {
        return _O(f) ? s.shift() : f;
      });
      return r.apply(void 0, Xk(l).concat(s));
    }));
  });
}, ls = function(t) {
  return r4(t.length, t);
}, wh = function(t, r) {
  for (var n = [], a = t; a < r; ++a)
    n[a - t] = a;
  return n;
...
var u4 = ls(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), s4 = ls(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), c4 = ls(function(e, t, r) {
  var n = t - +e;
...
const fs = {
  rangeStep: o4,
  getDigitCount: i4,
  interpolateNumber: u4,
  uninterpolateNumber: s4,
  uninterpolateTruncation: c4
};
function Ih(e) {
  return d4(e) || f4(e) || OO(e) || l4();
}
function l4() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function xO(e, t, r) {
  if (e.lte(0))
    return new Se(0);
  var n = fs.getDigitCount(e.toNumber()), a = new Se(10).pow(n), i = e.div(a), o = n !== 1 ? 0.05 : 0.1, u = new Se(Math.ceil(i.div(o).toNumber())).add(r).mul(o), s = u.mul(a);
...
function y4(e, t, r) {
  ...
  if (!a.isint() && r) {
    var i = Math.abs(e);
    i < 1 ? (n = new Se(10).pow(fs.getDigitCount(e) - 1), a = new Se(Math.floor(a.div(n).toNumber())).mul(n)) : i > 1 && (a = new Se(Math.floor(e)));
  } else e === 0 ? a = new Se(Math.floor((t - 1) / 2)) : r || (a = new Se(Math.floor(e)));
  var o = Math.floor((t - 1) / 2), u = a4(n4(function(s) {
...
function wO(e, t, r, n) {
  ...
  var i = xO(new Se(t).sub(e).div(r - 1), n, a), o;
  ...
  return c > r ? wO(e, t, r, n, a + 1) : (c < r && (s = t > 0 ? s + (r - c) : s, u = t > 0 ? u : u + (r - c)), {
    step: i,
...
function b4(e) {
  var t = _i(e, 2), r = t[0], n = t[1], a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6, i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, o = Math.max(a, 2), u = SO([r, n]), s = _i(u, 2), c = s[0], l = s[1];
  if (c === -1 / 0 || l === 1 / 0) {
  ...
  if (c === l)
    return y4(c, a, i);
  var h = wO(c, l, o, i), p = h.step, g = h.tickMin, y = h.tickMax, m = fs.rangeStep(g, y.add(new Se(0.1).mul(p)), p);
  return r > n ? Ph(m) : m;
}
function g4(e, t) {
  var r = _i(e, 2), n = r[0], a = r[1], i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0, o = SO([n, a]), u = _i(o, 2), s = u[0], c = u[1];
  if (s === -1 / 0 || c === 1 / 0)
    return [n, a];
  if (s === c)
    return [s];
  var l = Math.max(t, 2), f = xO(new Se(c).sub(s).div(l - 1), i, 0), h = [].concat(Ih(fs.rangeStep(new Se(s), new Se(c).sub(new Se(0.99).mul(f)), f)), [c]);
  return n > a ? Ph(h) : h;
}
var v4 = AO(b4), E4 = AO(g4), T4 = process.env.NODE_ENV === "production", nd = "Invariant failed";
function vt(e, t) {
  if (T4)
    throw new Error(nd);
  var r = typeof t == "function" ? t() : t, n = r ? "".concat(nd, ": ").concat(r) : nd;
  throw new Error(n);
}
var _4 = ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"];
function na(e) {
  "@babel/helpers - typeof";
...
function D4(e, t, r) {
  return t = iu(t), M4(e, PO() ? Reflect.construct(t, r || [], iu(e).constructor) : t.apply(e, r));
}
function M4(e, t) {
...
var ds = /* @__PURE__ */ (function(e) {
  ...
  return k4(t, e), R4(t, [{
    key: "render",
    value: function() {
      var n = this.props, a = n.offset, i = n.layout, o = n.width, u = n.dataKey, s = n.data, c = n.dataPointFormatter, l = n.xAxis, f = n.yAxis, h = P4(n, _4), p = le(h, !1);
...
function ei(e, t, r, n) {
  ...
  if (r === "number") {
    ...
    return i.length ? [ss(i), us(i)] : [1 / 0, -1 / 0];
  }
...
var G4 = function(t) {
  ...
  var i = n.children, o = n.width, u = n.margin, s = o - (u.left || 0) - (u.right || 0), c = NO({
    children: i,
    legendWidth: s
  });
  if (c) {
  ...
  var o = r.props.children, u = jt(o, ds).filter(function(c) {
  ...
  if (u && u.length) {
    ...
    return t.reduce(function(c, l) {
      var f = ut(l, n);
      if (me(f)) return c;
      var h = Array.isArray(f) ? [ss(f), us(f)] : [f, f], p = s.reduce(function(g, y) {
...
}, DO = function(t, r, n, a, i) {
  var o = r.map(function(s) {
    var c = s.props.dataKey;
    return n === "number" && c && RO(t, s, c, a) || ei(t, c, n, i);
  });
  if (n === "number")
    return o.reduce(
...
}, ad = /* @__PURE__ */ new WeakMap(), bo = function(t, r) {
  if (typeof r != "function")
    return t;
  ad.has(t) || ad.set(t, /* @__PURE__ */ new WeakMap());
  var n = ad.get(t);
  if (n.has(r))
    return n.get(r);
  var a = function() {
  ...
  if (mn(a)) {
    var s = "scale".concat(zu(a));
    return {
      scale: (t1[s] || Ja)(),
      realScaleType: t1[s] ? s : "point"
    };
  }
  return de(a) ? {
    scale: a
...
}, b1 = 1e-4, BO = function(t) {
  var r = t.domain();
  if (!(!r || r.length <= 2)) {
    var n = r.length, a = t.range(), i = Math.min(a[0], a[1]) - b1, o = Math.max(a[0], a[1]) + b1, u = t(r[0]), s = t(r[n - 1]);
  ...
  }), i = n8[n], o = q3().keys(a).value(function(u, s) {
    return +ut(u, s, 0);
  }).order(sh).offset(i);
  return o(t);
}, i8 = function(t, r, n, a, i, o) {
  if (!t)
    return null;
  ...
  if (i && a === "number" && o && (o[0] === "auto" || o[1] === "auto")) {
    ...
    if (!c.length)
      return null;
    var l = v4(c, i, u);
    return t.domain([ss(l), us(l)]), {
      niceTicks: l
    };
  }
  if (i && a === "number") {
    var f = t.domain(), h = E4(f, i, u);
    return {
      niceTicks: h
    };
  }
...
}, v1 = /^dataMin[\s]*-[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/, E1 = /^dataMax[\s]*\+[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/, Dh = function(t, r, n) {
  if (de(t))
    return t(r, n);
  if (!Array.isArray(t))
    return r;
  ...
  return !t || !t.length || cs(t, xt(n, "type.defaultProps.domain")) ? r : t;
}, $O = function(t, r) {
...
var uu = Math.PI / 180, y8 = function(t) {
...
}, b8 = function(t, r, n, a, i) {
  var o = t.width, u = t.height, s = t.startAngle, c = t.endAngle, l = ht(t.cx, o, o / 2), f = ht(t.cy, u, u / 2), h = HO(o, u, n), p = ht(t.innerRadius, h, 0), g = ht(t.outerRadius, h, h * 0.8), y = Object.keys(r);
  return y.reduce(function(m, v) {
    ...
    var P = kO(E, i), N = P.realScaleType, j = P.scale;
    j.domain(_).range(b), BO(j);
    var D = jO(j, fr(fr({}, E), {}, {
      realScaleType: N
    })), R = fr(fr(fr({}, E), D), {}, {
      range: b,
  ...
  if (o === 0)
    return !0;
  var l = E8(r), f = l.startAngle, h = l.endAngle, p = u, g;
  if (f <= h) {
    for (; p > h; )
      p -= 360;
    for (; p < f; )
...
var D8 = function(t) {
  ...
  var a = t.position, i = t.viewBox, o = t.offset, u = t.className, s = i, c = s.cx, l = s.cy, f = s.innerRadius, h = s.outerRadius, p = s.startAngle, g = s.endAngle, y = s.clockWise, m = (f + h) / 2, v = M8(p, g), E = v >= 0 ? 1 : -1, _, A;
  ...
  var b = Ne(c, l, m, _), T = Ne(c, l, m, _ + (A ? 1 : -1) * 359), O = "M".concat(b.x, ",").concat(b.y, `
    ...
    `).concat(T.x, ",").concat(T.y), P = me(t.id) ? Ki("recharts-radial-line-") : t.id;
...
function Qe(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = P8(e, _8), a = We({
    offset: r
...
var WO = function(t) {
  ...
  if (!t || !t.children && n && !t.label)
    return null;
  var a = t.children, i = WO(t), o = jt(a, Qe).map(function(s, c) {
  ...
  if (!n)
    return o;
  var u = F8(t.label, r || i);
  return [u].concat(A8(o));
};
Qe.parseViewBox = WO;
Qe.renderCallByParent = $8;
var id, x1;
function U8() {
  if (x1) return id;
  x1 = 1;
...
var W8 = ["valueAccessor"], Y8 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function z8(e) {
  return X8(e) || V8(e) || K8(e) || G8();
}
function G8() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var tB = function(t) {
  return Array.isArray(t.value) ? q8(t.value) : t.value;
};
function Gt(e) {
  var t = e.valueAccessor, r = t === void 0 ? tB : t, n = I1(e, W8), a = n.data, i = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = I1(n, Y8);
  return !a || !a.length ? null : /* @__PURE__ */ C.createElement(Oe, {
    ...
    return /* @__PURE__ */ C.createElement(Qe, su({}, le(l, !0), c, p, {
      parentViewBox: l.parentViewBox,
      value: h,
      textBreakAll: s,
      viewBox: Qe.parseViewBox(me(o) ? l : P1(P1({}, l), {}, {
        clockWise: o
      })),
      key: "label-".concat(f),
      index: f
...
function rB(e, t) {
  return e ? e === !0 ? /* @__PURE__ */ C.createElement(Gt, {
    ...
    data: t,
    content: e
  }) : _a(e) ? /* @__PURE__ */ C.createElement(Gt, su({
    data: t
  }, e, {
    key: "labelList-implicit"
  })) : null : null;
...
var uB = function(t, r) {
  ...
  var r = t.cx, n = t.cy, a = t.radius, i = t.angle, o = t.sign, u = t.isExternal, s = t.cornerRadius, c = t.cornerIsExternal, l = s * (u ? 1 : -1) + a, f = Math.asin(s / l) / uu, h = c ? i : i + o * f, p = Ne(r, n, l, h), g = Ne(r, n, a, h), y = c ? i - o * f : i, m = Ne(r, n, l * Math.cos(f * uu), y);
  return {
    center: p,
    circleTangency: g,
    lineTangency: m,
  ...
  var r = t.cx, n = t.cy, a = t.innerRadius, i = t.outerRadius, o = t.startAngle, u = t.endAngle, s = uB(o, u), c = o + s, l = Ne(r, n, i, o), f = Ne(r, n, i, c), h = "M ".concat(l.x, ",").concat(l.y, `
  ...
  if (a > 0) {
    var T = go({
      ...
      cornerRadius: o,
      cornerIsExternal: s
    }), O = T.circleTangency, P = T.lineTangency, N = T.theta, j = go({
      cx: r,
      cy: n,
      radius: a,
      angle: l,
  ...
  var r = N1(N1({}, cB), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < i || l === f)
    return null;
  var p = pe("recharts-sector", h), g = o - i, y = ht(u, g, 0, !0), m;
  return y > 0 && Math.abs(l - f) < 360 ? m = sB({
    cx: n,
    cy: a,
    innerRadius: i,
    outerRadius: o,
...
var M1 = {
  ...
  return (n === "curveMonotone" || n === "curveBump") && r ? M1["".concat(n).concat(r === "vertical" ? "Y" : "X")] : M1[n] || Ku;
}, pB = function(t) {
  var r = t.type, n = r === void 0 ? "linear" : r, a = t.points, i = a === void 0 ? [] : a, o = t.baseLine, u = t.layout, s = t.connectNulls, c = s === void 0 ? !1 : s, l = hB(n, u), f = c ? i.filter(function(y) {
    return vo(y);
  }) : i, h;
  if (Array.isArray(o)) {
  ...
  return u === "vertical" && J(o) ? h = co().y(Fa).x1(ja).x0(o) : J(o) ? h = co().x(ja).y1(Fa).y0(o) : h = Y_().x(ja).y(Fa), h.defined(vo).curve(l), h(f);
}, jh = function(t) {
  var r = t.className, n = t.points, a = t.path, i = t.pathRef;
  if ((!n || !n.length) && !a)
    return null;
  var o = n && n.length ? pB(t) : a;
  return /* @__PURE__ */ Wr.createElement("path", Bh({}, le(t, !1), Lo(t), {
...
function yB() {
  return k1 || (k1 = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    var b = s, T = c, O = u, P = o, N = t, j = l, D = n, R = g, B = p, F = r, $ = i, q = a, Y = f, Q = !1;
    function te(M) {
...
var B1;
function GO() {
  return B1 || (B1 = 1, process.env.NODE_ENV === "production" ? To.exports = mB() : To.exports = yB()), To.exports;
}
var od, j1;
function bB() {
  if (j1) return od;
  ...
  return od = a() ? Object.assign : function(i, o) {
...
var sd, $1;
function KO() {
  return $1 || ($1 = 1, sd = Function.call.bind(Object.prototype.hasOwnProperty)), sd;
}
var cd, U1;
function gB() {
  if (U1) return cd;
  ...
  if (process.env.NODE_ENV !== "production") {
    var t = /* @__PURE__ */ P0(), r = {}, n = /* @__PURE__ */ KO();
    e = function(i) {
      var o = "Warning: " + i;
...
function vB() {
  if (H1) return ld;
  H1 = 1;
  var e = GO(), t = bB(), r = /* @__PURE__ */ P0(), n = /* @__PURE__ */ KO(), a = /* @__PURE__ */ gB(), i = function() {
  };
...
function EB() {
  ...
  return r.resetWarningCache = t, fd = function() {
...
var W1;
function TB() {
  if (W1) return Eo.exports;
  if (W1 = 1, process.env.NODE_ENV !== "production") {
    var e = GO(), t = !0;
    Eo.exports = /* @__PURE__ */ vB()(e.isElement, t);
  } else
    Eo.exports = /* @__PURE__ */ EB()();
  return Eo.exports;
}
var _B = /* @__PURE__ */ TB();
const Ae = /* @__PURE__ */ xe(_B), { getOwnPropertyNames: AB, getOwnPropertySymbols: OB } = Object, { hasOwnProperty: SB } = Object.prototype;
function dd(e, t) {
...
function Y1(e) {
  return AB(e).concat(OB(e));
}
const wB = (
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  Object.hasOwn || ((e, t) => SB.call(e, t))
);
function xn(e, t) {
  return e === t || !e && !t && e !== e && t !== t;
}
const PB = "__v", IB = "__o", CB = "_owner", { getOwnPropertyDescriptor: z1, keys: G1 } = Object;
function NB(e, t) {
  return e.byteLength === t.byteLength && cu(new Uint8Array(e), new Uint8Array(t));
}
function RB(e, t, r) {
  let n = e.length;
  if (t.length !== n)
...
function DB(e, t) {
  return e.byteLength === t.byteLength && cu(new Uint8Array(e.buffer, e.byteOffset, e.byteLength), new Uint8Array(t.buffer, t.byteOffset, t.byteLength));
}
function MB(e, t) {
...
function $a(e, t, r) {
  ...
  let i, o, u;
  for (; a-- > 0; )
    if (i = n[a], !VO(e, t, r, i) || (o = z1(e, i), u = z1(t, i), (o || u) && (!o || !u || o.configurable !== u.configurable || o.enumerable !== u.enumerable || o.writable !== u.writable)))
      return !1;
  return !0;
}
function FB(e, t) {
...
function VO(e, t, r, n) {
  return (n === CB || n === IB || n === PB) && (e.$$typeof || t.$$typeof) ? !0 : wB(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
const HB = "[object ArrayBuffer]", qB = "[object Arguments]", WB = "[object Boolean]", YB = "[object DataView]", zB = "[object Date]", GB = "[object Error]", KB = "[object Map]", VB = "[object Number]", XB = "[object Object]", QB = "[object RegExp]", ZB = "[object Set]", JB = "[object String]", e5 = {
  "[object Int8Array]": !0,
  "[object Uint8Array]": !0,
...
}, t5 = "[object URL]", r5 = Object.prototype.toString;
function n5({ areArrayBuffersEqual: e, areArraysEqual: t, areDataViewsEqual: r, areDatesEqual: n, areErrorsEqual: a, areFunctionsEqual: i, areMapsEqual: o, areNumbersEqual: u, areObjectsEqual: s, arePrimitiveWrappersEqual: c, areRegExpsEqual: l, areSetsEqual: f, areTypedArraysEqual: h, areUrlsEqual: p, unknownTagComparators: g }) {
...
function a5({ circular: e, createCustomConfig: t, strict: r }) {
  let n = {
    areArrayBuffersEqual: NB,
    areArraysEqual: r ? $a : RB,
    areDataViewsEqual: DB,
    areDatesEqual: MB,
    areErrorsEqual: LB,
    areFunctionsEqual: kB,
    areMapsEqual: r ? dd(K1, $a) : K1,
    areNumbersEqual: BB,
    areObjectsEqual: r ? $a : jB,
    arePrimitiveWrappersEqual: FB,
    areRegExpsEqual: $B,
    areSetsEqual: r ? dd(V1, $a) : V1,
    areTypedArraysEqual: r ? dd(cu, $a) : cu,
    areUrlsEqual: UB,
...
function o5({ circular: e, comparator: t, createState: r, equals: n, strict: a }) {
  if (r)
    return function(u, s) {
...
function Xr(e = {}) {
  const { circular: t = !1, createInternalComparator: r, createState: n, strict: a = !1 } = e, i = a5(e), o = n5(i), u = r ? r(o) : i5(o);
  return o5({ circular: t, comparator: o, createState: n, equals: u, strict: a });
}
function s5(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(i)) {
        if (!i.length)
          return;
        var o = i, u = c5(o), s = u[0], c = u.slice(1);
        if (typeof s == "number") {
          X1(a.bind(null, c), s);
          return;
        }
        a(s), X1(a.bind(null, c));
        return;
      }
...
var b5 = function(t, r) {
  ...
  return Object.keys(r).reduce(function(n, a) {
    return J1(J1({}, n), {}, XO({}, a, t(a, r[a])));
  }, {});
}, eE = function(t, r, n) {
  return t.map(function(a) {
    return "".concat(v5(a), " ").concat(r, "ms ").concat(n);
  }).join(",");
}, E5 = process.env.NODE_ENV !== "production", lu = function(t, r, n, a, i, o, u, s) {
  if (E5 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
      console.warn("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
    else {
...
var fu = 1e-4, ZO = function(t, r) {
  ...
  return function(n) {
    var a = ZO(t, r), i = [].concat(S5(a.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return JO(i, n);
  };
    ...
    switch (r[0]) {
      ...
      default: {
        ...
        if (s[0] === "cubic-bezier" && s[1].split(")")[0].split(",").length === 4) {
          ...
          lu(!1, "[configBezier]: arguments should be one of oneOf 'linear', 'ease', 'ease-in', 'ease-out', 'ease-in-out','cubic-bezier(x1,y1,x2,y2)', instead received %s", r);
      }
    }
  lu([a, o, i, u].every(function(m) {
    return typeof m == "number" && m >= 0 && m <= 1;
  }), "[configBezier]: arguments should be x1, y1, x2, y2 of [0, 1] instead received %s", r);
  var f = tE(a, o), h = tE(i, u), p = I5(a, o), g = function(v) {
    return v > 1 ? 1 : v < 0 ? 0 : v;
  }, y = function(v) {
    for (var E = v > 1 ? 1 : v, _ = E, A = 0; A < 8; ++A) {
      var b = f(_) - E, T = p(_);
      if (Math.abs(b - E) < fu || T < fu)
        return h(_);
      _ = g(_ - b / T);
    }
    return h(_);
  ...
  var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, r = t.stiff, n = r === void 0 ? 100 : r, a = t.damping, i = a === void 0 ? 8 : a, o = t.dt, u = o === void 0 ? 17 : o, s = function(l, f, h) {
    ...
    return Math.abs(m - f) < fu && Math.abs(y) < fu ? [f, 0] : [m, y];
  };
    ...
    switch (a) {
      ...
      default:
        if (a.split("(")[0] === "cubic-bezier")
          return rE(a);
        lu(!1, "[configEasing]: first argument should be one of 'ease', 'ease-in', 'ease-out', 'ease-in-out','cubic-bezier(x1,y1,x2,y2)', 'linear' and 'spring', instead  received %s", r);
    }
  return typeof a == "function" ? a : (lu(!1, "[configEasing]: first argument type should be function or string, instead received %s", r), null);
};
function Ri(e) {
  "@babel/helpers - typeof";
...
var du = function(t, r, n) {
  ...
  var a = ti(function(i, o) {
    if (qh(o)) {
      var u = t(o.from, o.to, o.velocity), s = B5(u, 2), c = s[0], l = s[1];
      return tt(tt({}, o), {}, {
        from: c,
        velocity: l
      });
  ...
  return n < 1 ? ti(function(i, o) {
    return qh(o) ? tt(tt({}, o), {}, {
      velocity: du(o.velocity, a[i].velocity, n),
      from: du(o.from, a[i].from, n)
    }) : o;
  }, r) : e(t, a, n - 1);
};
const H5 = (function(e, t, r, n, a) {
  var i = b5(e, t), o = i.reduce(function(m, v) {
    ...
    c || (c = v);
    var E = v - c, _ = E / r.dt;
    u = U5(r, u, _), a(tt(tt(tt({}, e), t), h())), c = v, p() || (s = requestAnimationFrame(f));
  }, y = function(v) {
    l || (l = v);
    var E = (v - l) / n, _ = ti(function(b, T) {
      return du.apply(void 0, nE(T).concat([r(E)]));
    }, o);
    if (a(tt(tt(tt({}, e), t), _)), E < 1)
      s = requestAnimationFrame(f);
    else {
      var A = ti(function(b, T) {
        return du.apply(void 0, nE(T).concat([r(1)]));
      }, o);
      a(tt(tt(tt({}, e), t), A));
    }
  };
...
var q5 = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function W5(e, t) {
  if (e == null) return {};
  var r = Y5(e, t), n, a;
  if (Object.getOwnPropertySymbols) {
  ...
  return Z5(r, [{
    ...
    value: function(a) {
      ...
      if (u) {
        ...
        if (!(u5(a.to, l) && a.canBegin && a.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(a) {
      var i = this, o = a.from, u = a.to, s = a.duration, c = a.easing, l = a.begin, f = a.onAnimationEnd, h = a.onAnimationStart, p = H5(o, u, N5(c), s, this.changeStyle), g = function() {
        i.stopJSAnimation = p();
      };
    ...
    value: function(a) {
      var i = this, o = a.steps, u = a.begin, s = a.onAnimationStart, c = o[0], l = c.style, f = c.duration, h = f === void 0 ? 0 : f, p = function(y, m, v) {
        if (v === 0)
          return y;
        var E = m.duration, _ = m.easing, A = _ === void 0 ? "ease" : _, b = m.style, T = m.properties, O = m.onAnimationEnd, P = v > 0 ? o[v - 1] : m, N = T || Object.keys(b);
        ...
        var j = eE(N, E, A), D = Ht(Ht(Ht({}, P.style), b), {}, {
          transition: j
        });
        return [].concat(hd(y), [D, E, O]).filter(g5);
      };
    ...
    value: function(a) {
      ...
      var y = u ? za({}, u, s) : s, m = eE(Object.keys(y), o, c);
      g.start([l, i, Ht(Ht({}, y), {}, {
        transition: m
      }), o, f]);
    }
    ...
    value: function() {
      ...
      var s = W5(a, q5), c = $r.count(i), l = this.state.style;
      if (typeof i == "function")
        return i(l);
      if (!u || c === 0 || o <= 0)
        return i;
...
var cE = function(t, r, n, a, i) {
  ...
  var r = sE(sE({}, dj), t), n = ii(), a = ft(-1), i = nj(a, 2), o = i[0], u = i[1];
  Et(function() {
...
}, hj = ["points", "className", "baseLinePoints", "connectNulls"];
function jn() {
...
var fE = function(t) {
  ...
  return t.forEach(function(n) {
    fE(n) ? r[r.length - 1].push(n) : r[r.length - 1].length > 0 && r.push([]);
  }), fE(t[0]) && r[r.length - 1].push(t[0]), r[r.length - 1].length <= 0 && (r = r.slice(0, -1)), r;
}, ri = function(t, r) {
  var n = Ej(t);
  r && (n = [n.reduce(function(i, o) {
    return [].concat(lE(i), lE(o));
  }, [])]);
  ...
  var r = t.points, n = t.className, a = t.baseLinePoints, i = t.connectNulls, o = pj(t, hj);
  if (!r || !r.length)
    return null;
  var u = pe("recharts-polygon", n);
  if (a && a.length) {
    var s = o.stroke && o.stroke !== "none", c = Tj(r, a, i);
...
var C0 = function(t) {
  ...
  return r === +r && n === +n && a === +a ? /* @__PURE__ */ Wr.createElement("circle", Vh({}, le(t, !1), Lo(t), {
    className: o,
    cx: r,
    cy: n,
    r: a
...
var Aj = ["x", "y", "top", "left", "width", "height", "className"];
function Xh() {
...
var Cj = function(t, r, n, a, i, o) {
  return "M".concat(t, ",").concat(i, "v").concat(a, "M").concat(o, ",").concat(r, "h").concat(n);
}, Nj = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.top, u = o === void 0 ? 0 : o, s = t.left, c = s === void 0 ? 0 : s, l = t.width, f = l === void 0 ? 0 : l, h = t.height, p = h === void 0 ? 0 : h, g = t.className, y = Pj(t, Aj), m = Oj({
    x: n,
    y: i,
    top: u,
    left: c,
...
var kj = Lj();
const Bj = /* @__PURE__ */ xe(kj);
var jj = ["cx", "cy", "angle", "ticks", "axisLine"], Fj = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function ia(e) {
  "@babel/helpers - typeof";
...
function qj(e, t, r) {
  return t = mu(t), Wj(e, rS() ? Reflect.construct(t, r || [], mu(e).constructor) : t.apply(e, r));
}
function Wj(e, t) {
...
var ps = /* @__PURE__ */ (function(e) {
  function t() {
    return Uj(this, t), qj(this, t, arguments);
  }
  return zj(t, e), Hj(t, [{
    ...
    key: "getViewBox",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = Mj(u, function(l) {
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = n.axisLine, c = yE(n, jj), l = u.reduce(function(g, y) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.angle, s = a.tickFormatter, c = a.stroke, l = yE(a, Fj), f = this.getTickTextAnchor(), h = le(l, !1), p = le(o, !1), g = i.map(function(y, m) {
        ...
        return /* @__PURE__ */ C.createElement(Oe, ni({
          className: pe("recharts-polar-radius-axis-tick", qO(o)),
...
hs(ps, "displayName", "PolarRadiusAxis");
hs(ps, "axisType", "radiusAxis");
hs(ps, "defaultProps", {
  type: "number",
  radiusAxisId: 0,
  cx: 0,
...
function Xj(e, t, r) {
  return t = yu(t), Qj(e, aS() ? Reflect.construct(t, r || [], yu(e).constructor) : t.apply(e, r));
}
function Qj(e, t) {
...
var tF = Math.PI / 180, EE = 1e-5, ys = /* @__PURE__ */ (function(e) {
  function t() {
    return Kj(this, t), Xj(this, t, arguments);
  }
  return Jj(t, e), Vj(t, [{
    ...
    key: "getTickTextAnchor",
    value: function(n) {
      var a = this.props.orientation, i = Math.cos(-n.coordinate * tF), o;
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(_j, nn({
        className: "recharts-polar-angle-axis-line"
      }, c, {
        points: f
      }));
    ...
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.tickLine, s = a.tickFormatter, c = a.stroke, l = le(this.props, !1), f = le(o, !1), h = en(en({}, l), {}, {
        ...
        return /* @__PURE__ */ C.createElement(Oe, nn({
          className: pe("recharts-polar-angle-axis-tick", qO(o)),
...
ms(ys, "displayName", "PolarAngleAxis");
ms(ys, "axisType", "angleAxis");
ms(ys, "defaultProps", {
  type: "category",
  angleAxisId: 0,
  scale: "auto",
...
function rF() {
  if (TE) return yd;
  TE = 1;
  var e = pA(), t = e(Object.getPrototypeOf, Object);
  return yd = t, yd;
}
var bd, _E;
function nF() {
  if (_E) return bd;
  _E = 1;
  var e = xr(), t = rF(), r = wr(), n = "[object Object]", a = Function.prototype, i = Object.prototype, o = a.toString, u = i.hasOwnProperty, s = o.call(Object);
  function c(l) {
    if (!r(l) || e(l) != n)
      return !1;
    var f = t(l);
...
var wE = function(t, r, n, a, i) {
  ...
  var r = xE(xE({}, bF), t), n = ii(), a = ft(-1), i = cF(a, 2), o = i[0], u = i[1];
  Et(function() {
    if (n.current && n.current.getTotalLength)
      try {
  ...
  return v ? /* @__PURE__ */ C.createElement(Sr, {
    ...
    return /* @__PURE__ */ C.createElement(Sr, {
      ...
      duration: y,
      easing: g
    }, /* @__PURE__ */ C.createElement("path", bu({}, le(r, !0), {
      className: E,
      d: wE(O, P, A, b, T),
      ref: n
    })));
  }) : /* @__PURE__ */ C.createElement("g", null, /* @__PURE__ */ C.createElement("path", bu({}, le(r, !0), {
    className: E,
    d: wE(s, c, l, f, h)
  })));
}, vF = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function ki(e) {
  "@babel/helpers - typeof";
...
function IE(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ C.createElement(gF, r);
    case "sector":
      return /* @__PURE__ */ C.createElement(zO, r);
    case "symbols":
      if (xF(t))
...
function oS(e) {
  var t = e.option, r = e.shapeType, n = e.propTransformer, a = n === void 0 ? SF : n, i = e.activeClassName, o = i === void 0 ? "recharts-active-shape" : i, u = e.isActive, s = EF(e, vF), c;
  if (/* @__PURE__ */ Lt(t))
    c = /* @__PURE__ */ Ue(t, gu(gu({}, s), wF(t)));
  else if (de(t))
    c = t(s);
  else if (iF(t) && !sF(t)) {
    var l = a(t, s);
    c = /* @__PURE__ */ C.createElement(IE, {
      shapeType: r,
      elementProps: l
    });
  } else {
...
function NF(e, t) {
  var r;
  return bs(e, t) ? r = PF : gs(e, t) ? r = IF : Bi(e, t) && (r = CF), r;
}
function RF(e, t) {
  var r;
  return bs(e, t) ? r = "trapezoids" : gs(e, t) ? r = "sectors" : Bi(e, t) && (r = "points"), r;
}
function DF(e, t) {
  if (bs(e, t)) {
    var r;
...
function MF(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, a = RF(r, t), i = DF(r, t), o = n.filter(function(s, c) {
    var l = cs(i, s), f = r.props[a].filter(function(g) {
      var y = NF(r, t);
      return y(g, t);
...
function BF(e, t, r) {
  return t = vu(t), jF(e, uS() ? Reflect.construct(t, r || [], vu(e).constructor) : t.apply(e, r));
}
function jF(e, t) {
...
var Ir = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return LF(this, t), n = BF(this, t, [r]), Rt(n, "pieRef", null), Rt(n, "sectorRefs", []), Rt(n, "id", Ki("recharts-pie-")), Rt(n, "handleAnimationEnd", function() {
  ...
  return $F(t, e), kF(t, [{
    ...
    value: function(n) {
      ...
      return n.map(function(c, l) {
        ...
        }), /* @__PURE__ */ C.createElement(oS, Fn({
          option: p,
          isActive: f,
          shapeType: "sector"
        }, g)));
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Sr, {
        ...
        return i.forEach(function(_, A) {
          ...
          if (b) {
            var O = Mr(b.endAngle - b.startAngle, _.endAngle - _.startAngle), P = Ie(Ie({}, _), {}, {
              startAngle: E + T,
              endAngle: E + O(y) + T
            });
            m.push(P), E = P.endAngle;
          } else {
    ...
    value: function() {
      ...
      return i && a && a.length && (!o || !cs(o, a)) ? this.renderSectorsWithAnimation() : this.renderSectorsStatically(a);
    }
  }, {
    key: "componentDidMount",
    value: function() {
...
Rt(Ir, "getRealPieData", function(e) {
  var t = e.data, r = e.children, n = le(e, !1), a = jt(r, Ju);
...
Rt(Ir, "parseCoordinateOfPie", function(e, t) {
  var r = t.top, n = t.left, a = t.width, i = t.height, o = HO(a, i), u = n + ht(e.cx, a, a / 2), s = r + ht(e.cy, i, i / 2), c = ht(e.innerRadius, o, 0), l = ht(e.outerRadius, o, o * 0.8), f = e.maxRadius || Math.sqrt(a * a + i * i) / 2;
  return {
    cx: u,
    cy: s,
    innerRadius: c,
...
Rt(Ir, "getComposedData", function(e) {
  ...
  var E = a.filter(function(P) {
    return ut(P, v, 0) !== 0;
  }).length, _ = (m >= 360 ? E : E - 1) * s, A = m - E * p - _, b = a.reduce(function(P, N) {
    var j = ut(N, v, 0);
    return P + (J(j) ? j : 0);
  }, 0), T;
  if (b > 0) {
    ...
    T = a.map(function(P, N) {
      var j = ut(P, v, 0), D = ut(P, l, N), R = (J(j) ? j : 0) / b, B;
...
function cS() {
  if (DE) return Ed;
  DE = 1;
  var e = CA(), t = 1 / 0, r = 17976931348623157e292;
  function n(a) {
    if (!a)
      return a === 0 ? a : 0;
    if (a = e(a), a === t || a === -t) {
...
var KF = ["Webkit", "Moz", "O", "ms"], VF = function(t, r) {
  var n = t.replace(/(\w)/, function(i) {
    return i.toUpperCase();
  }), a = KF.reduce(function(i, o) {
    return BE(BE({}, i), {}, lS({}, o + n, r));
  }, {});
  return a[t] = r, a;
};
function sa(e) {
...
function QF(e, t, r) {
  return t && FE(e.prototype, t), r && FE(e, r), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function ZF(e, t, r) {
  return t = _u(t), JF(e, fS() ? Reflect.construct(t, r || [], _u(e).constructor) : t.apply(e, r));
}
function JF(e, t) {
...
var n9 = function(t) {
  ...
  if (!r || !r.length)
    return {};
  var s = r.length, c = Ja().domain(Eu(0, s)).range([i, i + o - u]), l = c.domain().map(function(f) {
    return c(f);
  });
  return {
    isTextActive: !1,
  ...
  function t(r) {
    var n;
    return XF(this, t), n = ZF(this, t, [r]), _t(n, "handleDrag", function(a) {
      ...
      var i = $E(a) ? a.changedTouches[0] : a;
      n.setState({
        isTravellerMoving: !1,
        isSlideMoving: !0,
  ...
  return t9(t, e), QF(t, [{
    ...
    value: function(n) {
      ...
      var _ = this.getIndex(v), A = _.startIndex, b = _.endIndex, T = function() {
        var P = m.length - 1;
        return o === "startX" && (u > s ? A % y === 0 : b % y === 0) || u < s && b === P || o === "endX" && (u > s ? b % y === 0 : A % y === 0) || u > s && b === P;
      };
    ...
    value: function(n, a) {
      var i, o, u = this, s = this.props, c = s.y, l = s.travellerWidth, f = s.height, h = s.traveller, p = s.ariaLabel, g = s.data, y = s.startIndex, m = s.endIndex, v = Math.max(n, this.props.x), E = Ad(Ad({}, le(this.props, !1)), {}, {
        x: v,
        y: c,
        width: l,
        height: f
    ...
    value: function() {
      ...
      }, /* @__PURE__ */ C.createElement(bn, Tu({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(f, h) - p,
        y: o + u / 2
      }, g), this.getTextOfTick(a)), /* @__PURE__ */ C.createElement(bn, Tu({
        textAnchor: "start",
        verticalAnchor: "middle",
        x: Math.max(f, h) + s + p,
        y: o + u / 2
    ...
    value: function() {
      ...
      if (!a || !a.length || !J(u) || !J(s) || !J(c) || !J(l) || c <= 0 || l <= 0)
        return null;
      var _ = pe("recharts-brush", i), A = C.Children.count(o) === 1, b = VF("userSelect", "none");
      return /* @__PURE__ */ C.createElement(Oe, {
        className: _,
...
function b9(e, t, r) {
  return t = g9(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function g9(e) {
  var t = v9(e, "string");
...
function _9(e, t) {
  var r = e.x, n = e.y, a = E9(e, y9), i = "".concat(r), o = parseInt(i, 10), u = "".concat(n), s = parseInt(u, 10), c = "".concat(t.height || a.height), l = parseInt(c, 10), f = "".concat(t.width || a.width), h = parseInt(f, 10);
...
function VE(e) {
  return /* @__PURE__ */ C.createElement(oS, tp({
    shapeType: "rectangle",
    propTransformer: _9,
...
function I9(e, t, r) {
  return t = Ou(t), C9(e, mS() ? Reflect.construct(t, r || [], Ou(e).constructor) : t.apply(e, r));
}
function C9(e, t) {
...
var sr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = I9(this, t, [].concat(a)), jr(r, "state", {
      isAnimationFinished: !1
  ...
  return R9(t, e), P9(t, [{
    ...
    value: function() {
      ...
      return i && a && a.length && (!o || !cs(o, a)) ? this.renderRectanglesWithAnimation() : this.renderRectanglesStatically(a);
    }
  }, {
    key: "renderBackground",
    value: function() {
      ...
      return i.map(function(c, l) {
        ...
        return /* @__PURE__ */ C.createElement(VE, Au({
    ...
    value: function(n, a) {
      if (this.props.isAnimationActive && !this.state.isAnimationFinished)
        return null;
      var i = this.props, o = i.data, u = i.xAxis, s = i.yAxis, c = i.layout, l = i.children, f = jt(l, ds);
      if (!f)
        return null;
...
jr(sr, "getComposedData", function(e) {
  var t = e.props, r = e.item, n = e.barPosition, a = e.bandSize, i = e.xAxis, o = e.yAxis, u = e.xAxisTicks, s = e.yAxisTicks, c = e.stackedData, l = e.dataStartIndex, f = e.displayedData, h = e.offset, p = J4(n, r);
  if (!p)
    return null;
  var g = t.layout, y = r.type.defaultProps, m = y !== void 0 ? $e($e({}, y), r.props) : r.props, v = m.dataKey, E = m.children, _ = m.minPointSize, A = g === "horizontal" ? o : i, b = c ? A.scale.domain() : null, T = o8({
    numericAxis: A
  }), O = jt(E, Ju), P = f.map(function(N, j) {
    var D, R, B, F, $, q;
    c ? D = e8(c[l + j], b) : (D = ut(N, v), Array.isArray(D) || (D = [T, D]));
    var Y = A9(_, pS.defaultProps.minPointSize)(D[1], j);
    if (g === "horizontal") {
...
function L9(e, t, r) {
  return t && ZE(e.prototype, t), r && ZE(e, r), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function JE(e, t) {
  var r = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
...
var B9 = function(t, r, n, a, i) {
  ...
  return l.reduce(function(p, g) {
    var y = r[g], m = y.orientation, v = y.domain, E = y.padding, _ = E === void 0 ? {} : E, A = y.mirror, b = y.reversed, T = "".concat(m).concat(A ? "Mirror" : ""), O, P, N, j, D;
    if (y.type === "number" && (y.padding === "gap" || y.padding === "no-gap")) {
      var R = v[1] - v[0], B = 1 / 0, F = y.categoricalDomain.sort(UN);
    ...
    var te = kO(y, i, h), k = te.scale, W = te.realScaleType;
    k.domain(v).range(P), BO(k);
    var z = jO(k, qt(qt({}, y), {}, {
      realScaleType: W
    }));
    ...
    return Z.bandSize = ou(Z, z), !y.hide && a === "xAxis" ? f[T] += (D ? -1 : 1) * Z.height : y.hide || (f[T] += (D ? -1 : 1) * Z.width), qt(qt({}, p), {}, vs({}, g, Z));
  }, {});
}, gS = function(t, r) {
  var n = t.x, a = t.y, i = r.x, o = r.y;
  return {
...
var $9 = function(t) {
  var r = t.width, n = t.height, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i = F9(a), o = i * Math.PI / 180, u = Math.atan(n / r), s = o > u && o < Math.PI - u ? n / Math.sin(o) : r / Math.cos(o);
  return Math.abs(s);
}, Nd, eT;
function U9() {
  if (eT) return Nd;
...
var Y9 = W9();
const z9 = /* @__PURE__ */ xe(Y9);
var G9 = M_();
const K9 = /* @__PURE__ */ xe(G9);
var V9 = K9(function(e) {
  return {
    x: e.left,
    y: e.top,
    width: e.width,
...
var R0 = /* @__PURE__ */ Vt(void 0), D0 = /* @__PURE__ */ Vt(void 0), ES = /* @__PURE__ */ Vt(void 0), TS = /* @__PURE__ */ Vt({}), _S = /* @__PURE__ */ Vt(void 0), AS = /* @__PURE__ */ Vt(0), OS = /* @__PURE__ */ Vt(0), aT = function(t) {
  var r = t.state, n = r.xAxisMap, a = r.yAxisMap, i = r.offset, o = t.clipPathId, u = t.children, s = t.width, c = t.height, l = V9(i);
...
var xS = function(t) {
  ...
  var n = r[t];
  return n == null && (process.env.NODE_ENV !== "production" ? vt(!1, 'Could not find xAxis by id "'.concat(t, '" [').concat(Su(t), "]. ").concat(SS(r))) : vt()), n;
}, Q9 = function() {
  var t = $t(R0);
  return kr(t);
}, Z9 = function() {
  var t = $t(D0), r = z9(t, function(n) {
    return hS(n.domain, Number.isFinite);
  });
  return r || kr(t);
}, wS = function(t) {
  var r = $t(D0);
  r == null && (process.env.NODE_ENV !== "production" ? vt(!1, "Could not find Recharts context; are you sure this is rendered inside a Recharts wrapper component?") : vt());
  var n = r[t];
  return n == null && (process.env.NODE_ENV !== "production" ? vt(!1, 'Could not find yAxis by id "'.concat(t, '" [').concat(Su(t), "]. ").concat(SS(r))) : vt()), n;
}, J9 = function() {
  var t = $t(ES);
  return t;
}, e$ = function() {
...
function a$(e, t, r) {
  return t = xu(t), i$(e, PS() ? Reflect.construct(t, r || [], xu(e).constructor) : t.apply(e, r));
}
function i$(e, t) {
...
var p$ = function(t, r) {
  ...
  if (a) {
    ...
    return nr(c, "discard") && u9(b, function(T) {
...
function y$(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = X9(), l = xS(a), f = wS(i), h = J9();
  if (!c || !h)
    return null;
  ...
  var p = N0({
    x: l.scale,
    y: f.scale
  }), g = ze(t), y = ze(r), m = n && n.length === 2, v = m$(p, g, y, m, h, e.position, l.orientation, f.orientation, e);
  if (!v)
    return null;
  var E = c$(v, 2), _ = E[0], A = _.x, b = _.y, T = E[1], O = T.x, P = T.y, N = nr(e, "hidden") ? "url(#".concat(c, ")") : void 0, j = oT(oT({
    clipPath: N
  }, le(e, !0)), {}, {
    x1: A,
    y1: b,
  ...
  }, p$(o, j), Qe.renderCallByParent(e, j9({
    x1: A,
    y1: b,
    x2: O,
    y2: P
...
var B0 = /* @__PURE__ */ (function(e) {
  function t() {
    return t$(this, t), a$(this, t, arguments);
  }
  return u$(t, e), n$(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(y$, this.props);
    }
  }]);
})(C.Component);
...
function E$(e, t, r) {
  return t = wu(t), T$(e, CS() ? Reflect.construct(t, r || [], wu(e).constructor) : t.apply(e, r));
}
function T$(e, t) {
...
var S$ = function(t) {
  ...
  function t() {
    return b$(this, t), E$(this, t, arguments);
  }
  return A$(t, e), v$(t, [{
    key: "render",
    value: function() {
      ...
      if (!f)
        return null;
      var h = f.x, p = f.y, g = this.props, y = g.shape, m = g.className, v = nr(this.props, "hidden") ? "url(#".concat(s, ")") : void 0, E = cT(cT({
        clipPath: v
      }, le(this.props, !0)), {}, {
        cx: h,
        cy: p
...
Es(Ts, "displayName", "ReferenceDot");
Es(Ts, "defaultProps", {
  isFront: !1,
  ifOverflow: "discard",
  xAxisId: 0,
...
function I$(e, t, r) {
  return t = Pu(t), C$(e, RS() ? Reflect.construct(t, r || [], Pu(e).constructor) : t.apply(e, r));
}
function C$(e, t) {
...
var M$ = function(t, r, n, a, i) {
  ...
  return nr(i, "discard") && (!h.isInRange(p) || !h.isInRange(g)) ? null : gS(p, g);
}, As = /* @__PURE__ */ (function(e) {
  function t() {
    return x$(this, t), I$(this, t, arguments);
  }
  return R$(t, e), P$(t, [{
    key: "render",
    value: function() {
...
function j$(e, t, r, n, a) {
  for (var i = (n || []).slice(), o = t.start, u = t.end, s = 0, c = 1, l = o, f = function() {
    ...
    }, E = g.coordinate, _ = s === 0 || Iu(e, E, v, l, u);
...
function q$(e, t, r, n, a, i) {
  ...
  if (i) {
    ...
    var p = Iu(e, l.tickCoord, function() {
      return f;
    }, s, c);
...
function j0(e, t, r) {
  ...
  if (!a || !a.length || !n)
    return [];
  if (J(s) || Oa.isSsr)
    return B$(a, typeof s == "number" && J(s) ? s : 0);
  ...
  }, m = a.length >= 2 ? dt(a[1].coordinate - a[0].coordinate) : 1, v = k$(i, m, p);
  return s === "equidistantPreserveStart" ? j$(m, v, y, a, o) : (s === "preserveStart" || s === "preserveStartEnd" ? h = q$(m, v, y, a, o, s === "preserveStartEnd") : h = H$(m, v, y, a, o), h.filter(function(E) {
    return E.isShow;
  }));
}
var W$ = ["viewBox"], Y$ = ["viewBox"], z$ = ["ticks"];
function ma(e) {
  "@babel/helpers - typeof";
...
function X$(e, t, r) {
  return t = Cu(t), Q$(e, LS() ? Reflect.construct(t, r || [], Cu(e).constructor) : t.apply(e, r));
}
function Q$(e, t) {
...
var Pa = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return K$(this, t), n = X$(this, t, [r]), n.state = {
      fontSize: "",
      letterSpacing: ""
    }, n;
  }
  return J$(t, e), V$(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = Ld(n, W$), u = this.props, s = u.viewBox, c = Ld(u, Y$);
    ...
    value: (
      ...
      function(n, a, i) {
        var o = this, u = this.props, s = u.tickLine, c = u.stroke, l = u.tick, f = u.tickFormatter, h = u.unit, p = j0(qe(qe({}, this.props), {}, {
          ...
          var T = o.getTickLineCoord(A), O = T.line, P = T.tick, N = qe(qe(qe(qe({
            textAnchor: g,
            verticalAnchor: y
          }, m), {}, {
            stroke: "none",
...
var tU = ["x1", "y1", "x2", "y2", "key"], rU = ["offset"];
function vn(e) {
  "@babel/helpers - typeof";
...
function BS(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, u = t.key, s = yT(t, tU), c = le(s, !1);
    c.offset;
    var l = yT(c, rU);
...
var dU = function(t, r) {
  ...
  return LO(j0(ot(ot(ot({}, Pa.defaultProps), n), {}, {
    ticks: mr(n, !0),
    viewBox: {
      x: 0,
      y: 0,
...
function to(e) {
  var t, r, n, a, i, o, u = M0(), s = L0(), c = e$(), l = ot(ot({}, e), {}, {
  ...
  }), f = l.x, h = l.y, p = l.width, g = l.height, y = l.syncWithTicks, m = l.horizontalValues, v = l.verticalValues, E = Q9(), _ = Z9();
  if (!J(p) || p <= 0 || !J(g) || g <= 0 || !J(f) || f !== +f || !J(h) || h !== +h)
    return null;
  var A = l.verticalCoordinatesGenerator || dU, b = l.horizontalCoordinatesGenerator || hU, T = l.horizontalPoints, O = l.verticalPoints;
  if ((!T || !T.length) && de(b)) {
  ...
  return /* @__PURE__ */ C.createElement("g", {
    ...
    height: l.height,
    ry: l.ry
  }), /* @__PURE__ */ C.createElement(sU, sn({}, l, {
    offset: c,
    horizontalPoints: T,
    xAxis: E,
    yAxis: _
  })), /* @__PURE__ */ C.createElement(cU, sn({}, l, {
    offset: c,
    verticalPoints: O,
    xAxis: E,
    yAxis: _
  })), /* @__PURE__ */ C.createElement(lU, sn({}, l, {
    horizontalPoints: T
  })), /* @__PURE__ */ C.createElement(fU, sn({}, l, {
    verticalPoints: O
  })));
}
...
function yU(e, t, r) {
  return t && mU(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function bU(e, t, r) {
  return t = Nu(t), gU(e, jS() ? Reflect.construct(t, r || [], Nu(e).constructor) : t.apply(e, r));
}
function gU(e, t) {
...
function _U(e) {
  var t = e.xAxisId, r = M0(), n = L0(), a = xS(t);
  return a == null ? null : (
...
var wn = /* @__PURE__ */ (function(e) {
  function t() {
    return pU(this, t), bU(this, t, arguments);
  }
  return EU(t, e), yU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(_U, this.props);
    }
  }]);
})(Wr.Component);
FS(wn, "displayName", "XAxis");
FS(wn, "defaultProps", {
  allowDecimals: !0,
  hide: !1,
  orientation: "bottom",
...
function xU(e, t, r) {
  return t = Ru(t), wU(e, US() ? Reflect.construct(t, r || [], Ru(e).constructor) : t.apply(e, r));
}
function wU(e, t) {
...
var NU = function(t) {
  var r = t.yAxisId, n = M0(), a = L0(), i = wS(r);
  return i == null ? null : (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
  ...
  function t() {
    return AU(this, t), xU(this, t, arguments);
  }
  return IU(t, e), SU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(NU, this.props);
    }
  }]);
})(Wr.Component);
HS(Pn, "displayName", "YAxis");
HS(Pn, "defaultProps", {
  allowDuplicatedCategory: !0,
  allowDecimals: !0,
  hide: !1,
...
var mp = function(t, r, n, a, i) {
  var o = jt(t, B0), u = jt(t, Ts), s = [].concat(bT(o), bT(u)), c = jt(t, As), l = "".concat(a, "Id"), f = a[0], h = r;
...
var BU = kU();
const jU = /* @__PURE__ */ xe(BU);
var Bd = new jU(), jd = "recharts.syncMouseEvents";
function Ui(e) {
  "@babel/helpers - typeof";
...
var qU = /* @__PURE__ */ (function() {
  function e() {
    FU(this, e), Fd(this, "activeIndex", 0), Fd(this, "coordinateList", []), Fd(this, "layout", "horizontal");
  }
  return UU(e, [{
    key: "setDetails",
    value: function(r) {
...
function GU(e, t, r) {
  return t = KU(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function KU(e) {
  var t = VU(e, "string");
  return Hi(t) == "symbol" ? t : t + "";
...
function XU(e) {
  ...
  if (h === "ScatterChart")
    ...
    var m = YS(o), v = m.cx, E = m.cy, _ = m.radius, A = m.startAngle, b = m.endAngle;
    g = {
      cx: v,
      cy: E,
      startAngle: A,
...
var QU = ["item"], ZU = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function ga(e) {
  "@babel/helpers - typeof";
...
function i7(e, t, r) {
  return t && a7(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function o7(e, t, r) {
  return t = Du(t), u7(e, zS() ? Reflect.construct(t, r || [], Du(e).constructor) : t.apply(e, r));
}
function u7(e, t) {
...
var gp = function(t, r, n, a) {
  var i = t.graphicalItems, o = t.tooltipAxis, u = Os(r, t);
  return n < 0 || !i || !i.length || n >= u.length ? null : i.reduce(function(s, c) {
    ...
    if (o.dataKey && !o.allowDuplicatedCategory) {
      ...
      h = f && f[n] || u[n];
    return h ? [].concat(va(s), [$O(c, h)]) : s;
  }, []);
}, AT = function(t, r, n, a) {
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = y7(i, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, l = G4(o, u, c, s);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, h = gp(t, r, l, f), p = b7(n, u, l, i);
    return {
  ...
  var n = r.axes, a = r.graphicalItems, i = r.axisType, o = r.axisIdKey, u = r.stackGroups, s = r.dataStartIndex, c = r.dataEndIndex, l = t.layout, f = t.children, h = t.stackOffset, p = MO(l, i);
  return n.reduce(function(g, y) {
    var m, v = y.type.defaultProps !== void 0 ? H(H({}, y.type.defaultProps), y.props) : y.props, E = v.type, _ = v.dataKey, A = v.allowDataOverflow, b = v.allowDuplicatedCategory, T = v.scale, O = v.ticks, P = v.includeHidden, N = v[o];
    if (g[N])
      return g;
    var j = Os(t.data, {
    ...
    WU(v.domain, A, E) && (R = Dh(v.domain, null, A), p && (E === "number" || T !== "auto") && (F = ei(j, _, "category")));
    var $ = XS(E);
    if (!R || R.length === 0) {
      ...
      if (_) {
        if (R = ei(j, _, E), E === "category" && p) {
          var Q = $N(R);
          b && Q ? (B = R, R = Eu(0, D)) : b || (R = T1(Y, R, y).reduce(function(z, Z) {
            return z.indexOf(Z) >= 0 ? z : [].concat(va(z), [Z]);
          }, []));
        } else if (E === "category")
          b ? R = R.filter(function(z) {
            return z !== "" && !me(z);
          }) : R = T1(Y, R, y).reduce(function(z, Z) {
            return z.indexOf(Z) >= 0 || Z === "" || me(Z) ? z : [].concat(va(z), [Z]);
          }, []);
        else if (E === "number") {
          var te = Z4(j, a.filter(function(z) {
      ...
      } else p ? R = Eu(0, D) : u && u[N] && u[N].hasStack && E === "number" ? R = h === "expand" ? [0, 1] : FO(u[N].stackGroups, s, c) : R = DO(j, a.filter(function(z) {
  ...
  var n = r.graphicalItems, a = r.Axis, i = r.axisType, o = r.axisIdKey, u = r.stackGroups, s = r.dataStartIndex, c = r.dataEndIndex, l = t.layout, f = t.children, h = Os(t.data, {
    graphicalItems: n,
    dataStartIndex: s,
    dataEndIndex: c
  }), p = h.length, g = MO(l, i), y = -1;
  return n.reduce(function(m, v) {
    var E = v.type.defaultProps !== void 0 ? H(H({}, v.type.defaultProps), v.props) : v.props, _ = E[o], A = XS("number");
    if (!m[_]) {
      y++;
      var b;
      return g ? b = Eu(0, p) : u && u[_] && u[_].hasStack ? (b = FO(u[_].stackGroups, s, c), b = mp(f, b, _, i)) : (b = Dh(A, DO(h, n.filter(function(T) {
        var O, P, N = o in T.props ? T.props[o] : (O = T.type.defaultProps) === null || O === void 0 ? void 0 : O[o], j = "hide" in T.props ? T.props.hide : (P = T.type.defaultProps) === null || P === void 0 ? void 0 : P.hide;
        return N === _ && !j;
      }), "number", l), a.defaultProps.allowDataOverflow), b = mp(f, b, _, i)), H(H({}, m), {}, se({}, _, H(H({
        axisType: i
      }, a.defaultProps), {}, {
        hide: !0,
        orientation: xt(p7, "".concat(i, ".").concat(y % 2), null),
        domain: b,
        originalDomain: A,
        isCategorical: g,
        layout: l
  ...
  var n = t.props, a = t.graphicalItems, i = t.xAxisMap, o = i === void 0 ? {} : i, u = t.yAxisMap, s = u === void 0 ? {} : u, c = n.width, l = n.height, f = n.children, h = n.margin || {}, p = At(f, ca), g = At(f, Hr), y = Object.keys(s).reduce(function(b, T) {
    ...
    var O = o[T], P = O.orientation;
    return !O.mirror && !O.hide ? H(H({}, b), {}, se({}, P, xt(b, "".concat(P)) + O.height)) : b;
  }, {
    top: h.top || 0,
    bottom: h.bottom || 0
  }), v = H(H({}, m), y), E = v.bottom;
  p && (v.bottom += p.props.height || ca.defaultProps.height), g && r && (v = X4(v, a, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(v, E) {
    var _ = E.graphicalItems, A = E.stackGroups, b = E.offset, T = E.updateId, O = E.dataStartIndex, P = E.dataEndIndex, N = v.barSize, j = v.layout, D = v.barGap, R = v.barCategoryGap, B = v.maxBarSize, F = ST(j), $ = F.numericAxisName, q = F.cateAxisName, Y = _7(_), Q = [];
    return _.forEach(function(te, k) {
      var W = Os(v.data, {
        ...
        var ws, Ps, Is = E["".concat(cr.axisType, "Map")], $0 = z["".concat(cr.axisType, "Id")];
      ...
      }, fe), G = ce[q], re = ce["".concat(q, "Ticks")], ie = A && A[oe] && A[oe].hasStack && u8(te, A[oe].stackGroups), M = vr(te.type).indexOf("Bar") >= 0, ye = ou(G, re), X = [], Pe = Y && K4({
        barSize: N,
        stackGroups: A,
        totalSize: O7(ce, q)
      });
      if (M) {
        var De, et, Cr = me(ne) ? B : ne, In = (De = (et = ou(G, re, !0)) !== null && et !== void 0 ? et : Cr) !== null && De !== void 0 ? De : 0;
        X = V4({
          barGap: D,
          barCategoryGap: R,
    ...
    if (!ky({
      ...
      return null;
    var O = _.children, P = _.layout, N = _.stackOffset, j = _.data, D = _.reverseStackOrder, R = ST(P), B = R.numericAxisName, F = R.cateAxisName, $ = jt(O, n), q = i8(j, $, "".concat(B, "Id"), "".concat(F, "Id"), N, D), Y = s.reduce(function(z, Z) {
      var ne = "".concat(Z.axisType, "Map");
      return H(H({}, z), {}, se({}, ne, E7(_, H(H({}, Z), {}, {
        graphicalItems: $,
    ...
    var te = Y["".concat(F, "Map")], k = T7(te), W = h(_, H(H({}, Y), {}, {
      dataStartIndex: A,
      dataEndIndex: b,
      updateId: T,
      graphicalItems: $,
    ...
    function v(E) {
      var _, A, b;
      return n7(this, v), b = o7(this, v, [E]), se(b, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(b, "accessibilityManager", new qU()), se(b, "handleLegendBBoxUpdate", function(T) {
        if (T) {
        ...
        var O = QN(T), P = xt(b.props, "".concat(O));
        if (O && de(P)) {
          var N, j;
        ...
        b.props.syncId !== void 0 && Bd.emit(jd, b.props.syncId, T, b.eventEmitterSymbol);
        ...
        var O = T.props, P = O.radialLines, N = O.polarAngles, j = O.polarRadius, D = b.state, R = D.radiusAxisMap, B = D.angleAxisMap, F = kr(R), $ = kr(B), q = $.cx, Y = $.cy, Q = $.innerRadius, te = $.outerRadius;
        ...
        var T = b.state.formattedGraphicalItems, O = b.props, P = O.children, N = O.width, j = O.height, D = b.props.margin || {}, R = N - (D.left || 0) - (D.right || 0), B = NO({
          children: P,
      ...
      }), b.clipPathId = "".concat((_ = E.id) !== null && _ !== void 0 ? _ : Ki("recharts"), "-clip"), b.throttleTriggeredAfterMouseMove = NA(b.triggeredAfterMouseMove, (A = E.throttleDelay) !== null && A !== void 0 ? A : 1e3 / 60), b.state = {}, b;
    }
    return c7(v, m), i7(v, [{
      key: "componentDidMount",
      value: function() {
      ...
      value: function(_) {
        if (!this.container)
          return null;
        var A = this.container, b = A.getBoundingClientRect(), T = F6(b), O = {
        ...
        if (!N)
          return null;
        var j = this.state, D = j.xAxisMap, R = j.yAxisMap, B = this.getTooltipEventType(), F = AT(this.state, this.props.data, this.props.layout, N);
        if (B !== "axis" && D && R) {
      ...
      value: function() {
        ...
        var O = Lo(this.props, this.handleOuterEvent);
        return H(H({}, O), T);
      }
    }, {
      key: "addListener",
      ...
      value: function() {
        ...
        if (!ky(this))
          return null;
        var A = this.props, b = A.children, T = A.className, O = A.width, P = A.height, N = A.style, j = A.compact, D = A.title, R = A.desc, B = TT(A, ZU), F = le(B, !1);
        if (j)
          return /* @__PURE__ */ C.createElement(aT, {
            state: this.state,
            ...
            title: D,
            desc: R
          }), this.renderClipPath(), jy(b, this.renderMap)));
        if (this.props.accessibilityLayer) {
          var $, q;
        ...
        return /* @__PURE__ */ C.createElement(aT, {
          ...
          desc: R,
          style: m7
        }), this.renderClipPath(), jy(b, this.renderMap)), this.renderLegend(), this.renderTooltip()));
      }
    }]);
  })(RT);
  se(g, "displayName", r), se(g, "defaultProps", H({
    ...
    var E = m.dataKey, _ = m.data, A = m.children, b = m.width, T = m.height, O = m.layout, P = m.stackOffset, N = m.margin, j = v.dataStartIndex, D = v.dataEndIndex;
    ...
    if (E !== v.prevDataKey || _ !== v.prevData || b !== v.prevWidth || T !== v.prevHeight || O !== v.prevLayout || P !== v.prevStackOffset || !qn(N, v.prevMargin)) {
      var B = OT(m), F = {
  ...
  var y = /* @__PURE__ */ NT(function(v, E) {
...
const x7 = "funding", w7 = ["Source", "Grants", "Total (GBP)"], P7 = [32, 10, 18], I7 = ["text", "number", "currency"], zn = new Intl.NumberFormat("en-GB", {
  style: "currency",
  currency: "GBP",
  maximumFractionDigits: 0
});
function NH({ content: e, block: t }) {
  const r = _n(x7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Funding received", o = N7(n), u = o.reduce((c, l) => c + l.total, 0);
  ct(
    t,
    "xlsx",
    r && o.length > 0 ? {
  ...
  return ct(
    ...
    o.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No funding records for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      /* @__PURE__ */ ee("p", { className: "chart-query-note", children: [
        "Grand total: ",
        /* @__PURE__ */ I("strong", { children: zn.format(u) }),
        " across",
        " ",
...
function C7({ rows: e }) {
  ...
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: a, children: /* @__PURE__ */ ee(
    Ss,
    {
      data: n,
      layout: "vertical",
      ...
      children: [
        /* @__PURE__ */ I(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
        /* @__PURE__ */ I(
          wn,
          {
            type: "number",
...
const R7 = "members", $d = ["Name", "Rank", "Department", "Tenured", "Start year"], D7 = [28, 14, 18, 10, 12], M7 = ["text", "text", "text", "text", "number"];
function RH({ content: e, block: t }) {
  const r = _n(R7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Members", o = [...n].sort((s, c) => {
  ...
  return ct(
    ...
    r ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ea, { widths: [32, 16, 22, 12, 18], borderColor: "cbd5e1", children: [
        /* @__PURE__ */ I(rt, { header: !0, children: $d.map((s) => /* @__PURE__ */ I(he, { children: s }, s)) }),
        u.map((s, c) => /* @__PURE__ */ I(rt, { children: s.map((l, f) => /* @__PURE__ */ I(he, { children: l == null ? "" : String(l) }, f)) }, c))
      ] })
    ] }) : null
    ...
    n.length === 0 ? /* @__PURE__ */ I("p", { className: "members-empty", children: "No members match the selected population." }) : /* @__PURE__ */ ee("table", { className: "members-table", children: [
      /* @__PURE__ */ I("thead", { children: /* @__PURE__ */ I("tr", { children: $d.map((s) => /* @__PURE__ */ I("th", { children: s }, s)) }) }),
      /* @__PURE__ */ I("tbody", { children: o.map((s) => /* @__PURE__ */ ee("tr", { children: [
...
function L7(e, t = {}) {
  ...
  const r = [];
  for (const n of e) {
    const a = xs(n?.publications, t);
    for (const i of a)
      r.push({ ...i, _author: n?.name || n?.slug || "Unknown" });
  }
  return r;
}
const k7 = "publications-by-journal", B7 = 10, j7 = ["Venue", "Count"], F7 = [48, 10], $7 = ["text", "number"];
function DH({ content: e, block: t }) {
  const r = _n(k7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by journal", u = H7(n, B7, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    /* @__PURE__ */ I("h2", { className: "chart-title", children: o }),
    a && /* @__PURE__ */ ee("p", { className: "chart-query-note", children: [
      "Across ",
      /* @__PURE__ */ I("em", { children: a }),
      " (",
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ I(U7, { counts: u })
  ] }) : null;
}
function U7({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: a, children: /* @__PURE__ */ ee(
    Ss,
    {
      ...
      children: [
        /* @__PURE__ */ I(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
        /* @__PURE__ */ I(wn, { type: "number", allowDecimals: !1 }),
        /* @__PURE__ */ I(
          Pn,
          {
            type: "category",
...
const q7 = "publications-by-type", xT = [
  "#1e40af",
  // primary
  "#be123c",
  // accent
  ...
  "#64748b"
  // slate (fallback)
], W7 = ["Publication type", "Count"], Y7 = [24, 10], z7 = ["text", "number"];
function MH({ content: e, block: t }) {
  const r = _n(q7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by type", u = K7(n, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No publications for the selected population." }) : /* @__PURE__ */ I(G7, { counts: u })
  ] }) : null;
}
function G7({ counts: e }) {
  ...
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(S7, { children: [
    /* @__PURE__ */ I(
      Ir,
      {
        data: n,
        ...
        children: n.map((a, i) => /* @__PURE__ */ I(Ju, { fill: xT[i % xT.length] }, i))
      }
    ),
    /* @__PURE__ */ I(
      yt,
...
const V7 = "publications-by-year", X7 = ["Year", "Count", "Cumulative"], Q7 = [10, 10, 12], Z7 = ["number", "number", "number"];
function LH({ content: e, block: t }) {
  const r = _n(V7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by year", { series: u, total: s } = eH(n, i);
  return ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ I(J7, { series: u })
  ] }) : null;
}
function J7({ series: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(Ss, { data: n, margin: { top: 16, right: 16, bottom: 16, left: 0 }, children: [
    /* @__PURE__ */ I(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
    /* @__PURE__ */ I(wn, { dataKey: "year", tick: { fontSize: 12 } }),
    /* @__PURE__ */ I(Pn, { allowDecimals: !1 }),
    /* @__PURE__ */ I(
      yt,
      {
        contentStyle: {
...
function nH(e) {
  return Array.isArray(e) ? e.map((t) => {
    const r = t._author ? tH(t._author) : void 0;
    return rH(t, { defaultAuthor: r });
  }).filter(Boolean) : [];
}
const aH = "publications-list", wT = {
...
async function iH(e) {
  ...
  const t = wT[e] || wT.apa, [{ formatAll: r }, n] = await Promise.all([
    import("./index-CxzhyvpC.js"),
    t()
  ]), a = { formatAll: r, style: n };
  return Ud.set(e, a), a;
}
function kH({ content: e, block: t }) {
  const r = _n(aH), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications", u = [...L7(n, i)].sort((y, m) => {
    const v = Number(y.year) || 0;
    return (Number(m.year) || 0) - v;
  }), s = nH(u), c = s.map((y) => y.id).join("|"), [l, f] = ft({ loading: !0, entries: [] });
  Et(() => {
    let y = !1;
    if (!r || s.length === 0) {
      f({ loading: !1, entries: [] });
    ...
    return iH(i.citationStyle).then(({ formatAll: m, style: v }) => {
      if (!y)
        try {
...
const oH = "supervisions", PT = ["#1e40af", "#0f766e", "#ea580c", "#9333ea", "#be123c", "#0ea5e9"];
function BH({ content: e, block: t }) {
  const r = _n(oH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Supervisions", { levels: o, rows: u, grandTotal: s } = sH(n), c = ["Member", ...o.map(Ep), "Total"], l = u.map((E) => [
    E.member,
  ...
  return ct(
    ...
    r && u.length > 0 ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ea, { widths: y, borderColor: "cbd5e1", children: [
        /* @__PURE__ */ I(rt, { header: !0, children: c.map((E) => /* @__PURE__ */ I(he, { children: E }, E)) }),
        u.map((E, _) => /* @__PURE__ */ ee(rt, { children: [
          /* @__PURE__ */ I(he, { children: E.member }),
          o.map((A) => /* @__PURE__ */ I(he, { children: String(E.counts[A] || 0) }, A)),
          /* @__PURE__ */ I(he, { children: String(E.total) })
        ] }, _)),
        /* @__PURE__ */ ee(rt, { children: [
          /* @__PURE__ */ I(he, { emphasis: !0, children: "Total" }),
          m.map((E, _) => /* @__PURE__ */ I(he, { emphasis: !0, children: String(E) }, _)),
          /* @__PURE__ */ I(he, { emphasis: !0, children: String(v) })
        ] })
      ] })
    ] }) : null
  ), r ? /* @__PURE__ */ ee("section", { className: "chart-section", children: [
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No supervisions recorded for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      /* @__PURE__ */ ee("p", { className: "chart-query-note", children: [
        "Grand total: ",
      ...
      /* @__PURE__ */ I(uH, { rows: u, levels: o })
    ] })
  ] }) : null;
}
function uH({ rows: e, levels: t }) {
  const [r, n] = ft(!1);
  if (Et(() => {
    n(!0);
  }, []), !r)
    return /* @__PURE__ */ I("div", { className: "chart-container chart-container-placeholder" });
  const a = e.map((i) => {
    const o = { name: cH(i.member) };
    for (const u of t) o[Ep(u)] = i.counts[u] || 0;
    return o;
  });
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(Ss, { data: a, margin: { top: 16, right: 24, bottom: 16, left: 0 }, children: [
    /* @__PURE__ */ I(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
    /* @__PURE__ */ I(wn, { dataKey: "name", tick: { fontSize: 12 } }),
    /* @__PURE__ */ I(Pn, { allowDecimals: !1 }),
    /* @__PURE__ */ I(
      yt,
      {
    ...
    /* @__PURE__ */ I(Hr, { wrapperStyle: { fontSize: "0.875rem" } }),
    t.map((i, o) => /* @__PURE__ */ I(
      sr,
      {
        dataKey: Ep(i),
        stackId: "supervision",
  ...
  return /* @__PURE__ */ ee("div", { className: "query-selector", children: [
    ...
    /* @__PURE__ */ ee(
      "select",
      {
        ...
        children: [
          /* @__PURE__ */ I("option", { value: N_, children: "All members" }),
...
const fH = "members";
function dH() {
  const e = FC(fH), [, t] = Dp(), [r, n] = Mp(), [a, i] = ft(() => CT(r, e));
  if (Et(() => {
    i(CT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
function hH({ field: e, def: t, value: r, onChange: n }) {
  const a = t?.label || e;
  switch (t?.type) {
    case "enum":
      return /* @__PURE__ */ I(So, { label: a, field: e, children: /* @__PURE__ */ ee(
        "select",
        {
          id: `filter-${e}`,
          value: r ?? "",
    ...
    case "range":
      return /* @__PURE__ */ I(So, { label: a, field: e, children: /* @__PURE__ */ ee("div", { className: "filter-range", children: [
        /* @__PURE__ */ I(
          "input",
          {
            type: "number",
    ...
    case "text":
      return /* @__PURE__ */ I(So, { label: a, field: e, children: /* @__PURE__ */ I(
        "input",
        {
          type: "text",
          id: `filter-${e}`,
      ...
      /* @__PURE__ */ ee("label", { className: "report-options-field", children: [
        ...
        /* @__PURE__ */ I(
          "select",
          {
            ...
            onChange: s,
            className: "report-options-input",
            children: WC.map((c) => /* @__PURE__ */ I("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] })
    ] }),
...
function yH() {
  ...
  return /* @__PURE__ */ ee("fieldset", { className: "section-toggles", children: [
    ...
    /* @__PURE__ */ I("div", { className: "section-toggles-list", children: UC.map((n) => /* @__PURE__ */ ee("label", { className: "section-toggles-item", children: [
      /* @__PURE__ */ I(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ I("span", { children: qC(n) })
    ] }, n)) })
  ] });
}
function bH() {
  const { data: e } = I_({ path: "/data/queries.json", schema: "queries" }), t = Array.isArray(e) ? e : [];
...
function TH({
  ...
  const { website: r } = $u(), [n, a] = ft(null), [i, o] = ft(null), [u, s] = ft(!1), [c, l] = ft(!1), f = ii(null);
  Et(() => {
    if (!u && !c) return;
    const g = (y) => {
...
function _H({ body: e, page: t }) {
  const { website: r } = $u(), n = t?.title || "Academic Metrics", a = (t?.title || "academic-metrics").toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
  return Et(() => GC(t), [t]), /* @__PURE__ */ ee(ZT, { basePath: r.basePath, children: [
    ...
    /* @__PURE__ */ I(TH, { title: n, filename: a })
  ] });
}
const AH = { ...No, vars: Tw || No?.vars, layouts: { MetricsLayout: _H } }, OH = {}, SH = {}, jH = { meta: OH, capabilities: AH, layoutMeta: SH };
export {
  CH as C,
  gr as D,
  NH as F,
...
//# sourceMappingURL=_entry.generated-BTJfhZgP.js.map
