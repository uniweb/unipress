...
const lC = {
  docx: { load: () => import("./docx-DyCK540a.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-kfiIej-m.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-CfOGLKkW.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-BHawaLr3.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-BjqKPkCl.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = lC[e];
  return t ? {
...
const LC = /(<a\b[^>]*?\shref=)(["'])([^"']*)\2/gi, kC = /^(?:[a-z][a-z0-9+.-]*:|\/\/|#)/i;
function BC(e, t) {
...
function jC(e, t, { locale: r = !0 } = {}) {
  ...
  let n = e;
  return (e.startsWith("page:") || e.startsWith("topic:")) && (n = t.makeHref ? t.makeHref(e) : e), kC.test(n) || r && n.startsWith("/") && !DC(n) && (n = BC(n, t)), n;
}
function FC(e, t) {
  return !e || typeof e != "string" || !t ? e : MC(jC(e, t), t.basePath || "");
}
function $C(e, t) {
  ...
  return !r && !t.basePath && !n ? e : e.replace(LC, (a, i, o, u) => {
    const s = FC(u, t);
...
//# sourceMappingURL=_entry.generated-DP09IgPb.js.map
