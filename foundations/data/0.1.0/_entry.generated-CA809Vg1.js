...
const lC = {
  docx: { load: () => import("./docx-9UK54_I5.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-DHIvwgpp.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-DB6vX01I.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-TykvFfd5.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-CIdmEWc0.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = lC[e];
  return t ? {
...
function PC({ part: e }) {
  const t = e.href || "", { anchor: r } = xC(t);
  return /* @__PURE__ */ P("a", { ...r !== null ? { "data-type": "internalHyperlink", "data-anchor": r } : { "data-type": "externalHyperlink", "data-link": t }, href: t, children: wC(e).map((a, i) => /* @__PURE__ */ P(
    Rp,
    {
      style: "Hyperlink",
      bold: a.bold,
...
function Bt({
  ...
  const u = CC({ tabStops: r, indent: n, role: a });
  if (t) {
    const s = OC(t);
    return /* @__PURE__ */ P(e, { "data-type": "paragraph", ...u, ...o, children: s.map((c, l) => c.type === "link" ? /* @__PURE__ */ P(PC, { part: c }, l) : c.type === "math" ? /* @__PURE__ */ P(
      IC,
      {
        latex: c.latex,
        display: c.display,
...
function DC(e) {
  ...
  return RC.some((r) => t.includes(r));
}
const MC = /(<a\b[^>]*?\shref=)(["'])([^"']*)\2/gi, LC = /^(?:[a-z][a-z0-9+.-]*:|\/\/|#)/i;
function kC(e, t) {
...
function jC(e, t, { locale: r = !0 } = {}) {
  if (!e || typeof e != "string" || !t) return e;
  let n = e;
  return (e.startsWith("page:") || e.startsWith("topic:")) && (n = t.makeHref ? t.makeHref(e) : e), LC.test(n) || r && n.startsWith("/") && !DC(n) && (n = BC(n, t)), n;
}
function FC(e, t) {
  return !e || typeof e != "string" || !t ? e : kC(jC(e, t), t.basePath || "");
}
function $C(e, t) {
  ...
  return !r && !t.basePath && !n ? e : e.replace(MC, (a, i, o, u) => {
    const s = FC(u, t);
    return s === u ? a : `${i}${o}${s}${o}`;
  });
}
function UC({ value: e, className: t, as: r = "div", ...n }) {
...
function fn(e, t) {
  const { website: r } = $u(), [, n] = ZS(qC, 0), i = r.activePage?.state;
  Et(() => {
    if (i)
...
const C_ = "academic-metrics/options", Dp = "all-members", N_ = Dp, WC = [
  "members",
...
function XC(e) {
  ...
  const r = () => VC(e), n = wm.map((a) => e.state.subscribe(a, r));
...
function DH({ content: e, block: t }) {
  ...
  return ct(t, "xlsx", {
    ...
    /* @__PURE__ */ ee("div", { className: "cover-meta", role: "list", children: [
      ...
      /* @__PURE__ */ P(oo, { label: "Funding", value: JC(s) }),
...
function xr() {
  if (Mm) return $s;
  Mm = 1;
  var e = zi(), t = eN(), r = tN(), n = "[object Null]", a = "[object Undefined]", i = e ? e.toStringTag : void 0;
  function o(u) {
...
function aN() {
  if (qm) return Vs;
  qm = 1;
  var e = Bp(), t = nN(), r = Gr(), n = D_(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, u = Object.prototype, s = o.toString, c = u.hasOwnProperty, l = RegExp(
...
function ON() {
  if (gy) return Oc;
  gy = 1;
  var e = AN(), t = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, n = e(function(a) {
    var i = [];
...
var CN = IN();
const yn = /* @__PURE__ */ xe(CN);
var NN = Bp();
const de = /* @__PURE__ */ xe(NN);
var RN = Gr();
const Aa = /* @__PURE__ */ xe(RN);
var so = { exports: {} }, ve = {};
var Py;
function DN() {
  if (Py) return ve;
...
var Cy;
function LN() {
  return Cy || (Cy = 1, process.env.NODE_ENV === "production" ? so.exports = DN() : so.exports = MN()), so.exports;
}
var kN = LN(), Mc, Ny;
function j_() {
  if (Ny) return Mc;
...
var jN = BN();
const Gi = /* @__PURE__ */ xe(jN);
var FN = j_();
const $N = /* @__PURE__ */ xe(FN);
var dt = function(t) {
...
var YN = ["viewBox", "children"], zN = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    qp.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = GN(o, r, n));
  }), a;
}, KN = ["children"], VN = ["children"];
function My(e, t) {
  if (e == null) return {};
  var r = XN(e, t), n, a;
...
var Ly = {
  ...
  return $r.forEach(t, function(n) {
    me(n) || (kN.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), Bc = r, ky = t, r;
};
function jt(e, t) {
  var r = [], n = [];
...
var By = function(t) {
...
}, QN = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], ZN = function(t) {
  return t && t.type && yn(t.type) && QN.indexOf(t.type) >= 0;
}, JN = function(t, r, n, a) {
  var i, o = (i = kc?.[a]) !== null && i !== void 0 ? i : [];
  return r.startsWith("data-") || !de(t) && (a && o.includes(r) || zN.includes(r)) || n && qp.includes(r);
}, le = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  return Object.keys(a).forEach(function(o) {
    var u;
    JN((u = a) === null || u === void 0 ? void 0 : u[o], o, r, n) && (i[o] = a[o]);
  }), i;
}, th = function e(t, r) {
  if (t === r)
    return !0;
  ...
  if (me(t) && me(r))
    return !0;
  if (!me(t) && !me(r)) {
    var n = t.props || {}, a = n.children, i = My(n, KN), o = r.props || {}, u = o.children, s = My(o, VN);
...
}, r3 = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function rh() {
...
function nh(e) {
  var t = e.children, r = e.width, n = e.height, a = e.viewBox, i = e.className, o = e.style, u = e.title, s = e.desc, c = n3(e, r3), l = a || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
var Oe = /* @__PURE__ */ C.forwardRef(function(e, t) {
  var r = e.children, n = e.className, a = o3(e, i3), i = pe("recharts-layer", n);
  return /* @__PURE__ */ C.createElement("g", ah({
    className: i
  }, le(a, !0), {
    ref: t
  }), r);
}), s3 = process.env.NODE_ENV !== "production", zt = function(t, r) {
...
function m3() {
  if (Gy) return Yc;
  Gy = 1;
  var e = p3(), t = e("toUpperCase");
  return Yc = t, Yc;
}
var y3 = m3();
const zu = /* @__PURE__ */ xe(y3);
function Ce(e) {
  return function() {
    return e;
  };
}
const $_ = Math.cos, ko = Math.sin, Qt = Math.sqrt, Bo = Math.PI, Gu = 2 * Bo, ih = Math.PI, oh = 2 * ih, rn = 1e-6, b3 = oh - rn;
function U_(e) {
  this._ += e[0];
...
class v3 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? U_ : g3(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${l}` : (Math.abs(this._x1 - c) > rn || Math.abs(this._y1 - l) > rn) && this._append`L${c},${l}`, n && (h < 0 && (h = h % oh + oh), h > b3 ? this._append`A${n},${n},0,1,${f},${t - u},${r - s}A${n},${n},0,1,${f},${this._x1 = c},${this._y1 = l}` : h > rn && this._append`A${n},${n},0,${+(h >= ih)},${f},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
}, G_ = Qt(1 / 3), A3 = G_ * 2, O3 = {
  draw(e, t) {
    const r = Qt(t / A3), n = r * G_;
...
}, x3 = 0.8908130915292852, K_ = ko(Bo / 10) / ko(7 * Bo / 10), w3 = ko(Gu / 10) * K_, P3 = -$_(Gu / 10) * K_, I3 = {
  draw(e, t) {
    const r = Qt(t * x3), n = w3 * r, a = P3 * r;
...
}, Pt = -0.5, It = Qt(3) / 2, uh = 1 / Qt(12), N3 = (uh / 2 + 1) * 3, R3 = {
  draw(e, t) {
    const r = Qt(t / N3), n = r / 2, a = r * uh, i = n, o = r * uh + r, u = -i, s = o;
...
function z3() {
  var e = Ce([]), t = sh, r = Xn, n = W3;
  function a(i) {
    var o = Array.from(e.apply(this, arguments), Y3), u, s = o.length, c = -1, l;
    for (const f of i)
      for (u = 0, ++c; u < s; ++u)
...
var rA = {
  ...
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, u = o === void 0 ? "area" : o, s = eR(t, X3), c = Jy(Jy({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), l = function() {
    var m = nR(n), E = D3().type(m).size(aR(i, u, n));
    return E();
...
function lR(e, t, r) {
  return t = Uo(t), fR(e, nA() ? Reflect.construct(t, r || [], Uo(e).constructor) : t.apply(e, r));
}
function fR(e, t) {
...
var Ct = 32, Vp = /* @__PURE__ */ (function(e) {
  function t() {
    return uR(this, t), lR(this, t, arguments);
  }
  return hR(t, e), cR(t, [{
    key: "renderIcon",
    value: (
...
function iA() {
  if (ob) return Jc;
  ob = 1;
  var e = qu(), t = mR(), r = yR(), n = bR(), a = gR(), i = vR();
  function o(u) {
...
function OR() {
  if (yb) return cl;
  yb = 1;
  var e = zi(), t = _R(), r = jp(), n = cA(), a = AR(), i = Xp(), o = 1, u = 2, s = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", h = "[object Number]", p = "[object RegExp]", g = "[object Set]", y = "[object String]", m = "[object Symbol]", E = "[object ArrayBuffer]", v = "[object DataView]", T = e ? e.prototype : void 0, A = T ? T.valueOf : void 0;
...
function PR() {
  if (Tb) return pl;
  Tb = 1;
  var e = xR(), t = wR(), r = Object.prototype, n = r.propertyIsEnumerable, a = Object.getOwnPropertySymbols, i = a ? function(o) {
...
function Qp() {
  if (Ob) return bl;
  Ob = 1;
  var e = CR(), t = wr(), r = Object.prototype, n = r.hasOwnProperty, a = r.propertyIsEnumerable, i = e(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? e : function(o) {
...
function fA() {
  return xb || (xb = 1, (function(e, t) {
    var r = or(), n = NR(), a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, o = i && i.exports === a, u = o ? r.Buffer : void 0, s = u ? u.isBuffer : void 0, c = s || n;
    e.exports = c;
...
function hA() {
  if (Rb) return Al;
  Rb = 1;
  var e = RR(), t = dA(), r = DR(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return Al = a, Al;
}
var Ol, Db;
function MR() {
  if (Db) return Ol;
  Db = 1;
  var e = IR(), t = Qp(), r = Tt(), n = fA(), a = Zp(), i = hA(), o = Object.prototype, u = o.hasOwnProperty;
  function s(c, l) {
...
function BR() {
  if (Bb) return Pl;
  Bb = 1;
  var e = LR(), t = kR(), r = Object.prototype, n = r.hasOwnProperty;
  function a(i) {
    if (!e(i))
      return t(i);
    var o = [];
...
function FR() {
  if (Ub) return Rl;
  Ub = 1;
  var e = jR(), t = 1, r = Object.prototype, n = r.hasOwnProperty;
...
function qR() {
  if (zb) return Bl;
  zb = 1;
  var e = $R(), t = Fp(), r = UR(), n = mA(), a = HR(), i = xr(), o = D_(), u = "[object Map]", s = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", h = "[object DataView]", p = o(e), g = o(t), y = o(r), m = o(n), E = o(a), v = i;
...
function WR() {
  if (Gb) return jl;
  Gb = 1;
  var e = iA(), t = cA(), r = OR(), n = FR(), a = qR(), i = Tt(), o = fA(), u = hA(), s = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", h = Object.prototype, p = h.hasOwnProperty;
...
function QR() {
  if (ng) return Kl;
  ng = 1;
  var e = e0(), t = B_(), r = XR(), n = kp(), a = yA(), i = bA(), o = Yu(), u = 1, s = 2;
  function c(l, f) {
...
function uD() {
  if (yg) return sf;
  yg = 1;
  var e = mA(), t = oD(), r = Xp(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return sf = a, sf;
}
...
function sD() {
  if (bg) return cf;
  bg = 1;
  var e = oA(), t = aD(), r = iD(), n = sA(), a = uD(), i = Xp(), o = 200;
  function u(s, c, l) {
...
function pD(e, t, r) {
  return t = Ho(t), mD(e, EA() ? Reflect.construct(t, r || [], Ho(e).constructor) : t.apply(e, r));
}
function mD(e, t) {
...
var _g = 1, Hr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = pD(this, t, [].concat(a)), Qu(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
...
function CD() {
  if (Mg) return _f;
  Mg = 1;
  var e = Up(), t = Hp(), r = ur(), n = OA(), a = wD(), i = dA(), o = ID(), u = Oa(), s = Tt();
  function c(l, f, h) {
...
function MD() {
  if (Fg) return wf;
  Fg = 1;
  var e = DD(), t = SA(), r = Oa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function jD() {
  if (Wg) return Rf;
  Wg = 1;
  var e = _A(), t = CD(), r = BD(), n = Zu(), a = r(function(i, o) {
    if (i == null)
      return [];
    var u = o.length;
    ...
    if (l && l.length) {
      var R = {
        ...
        var q = Df({
          ...
          paddingBottom: 4,
          color: F.color || "#000"
        }, u), Y = F.formatter || f || KD, Q = F.value, te = F.name, k = Q, W = te;
        if (Y && k != null && W != null) {
          var z = Y(Q, te, F, $, l);
          if (Array.isArray(z)) {
            var Z = $D(z, 2);
...
var Da = "recharts-tooltip-wrapper", ZD = {
  visibility: "hidden"
};
function JD(e) {
...
function i6(e, t, r) {
  return t = qo(t), o6(e, xA() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function o6(e, t) {
...
var Xg = 1, l6 = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    r6(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = i6(this, t, [].concat(a)), mh(r, "state", {
      dismissed: !1,
  ...
  return s6(t, e), a6(t, [{
    ...
    key: "render",
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, u = a.animationDuration, s = a.animationEasing, c = a.children, l = a.coordinate, f = a.hasPayload, h = a.isAnimationActive, p = a.offset, g = a.position, y = a.reverseDirection, m = a.useTranslate3d, E = a.viewBox, v = a.wrapperStyle, T = t6({
...
function m6(e, t, r) {
  return t = Wo(t), y6(e, PA() ? Reflect.construct(t, r || [], Wo(e).constructor) : t.apply(e, r));
}
function y6(e, t) {
...
function T6(e, t) {
  return /* @__PURE__ */ C.isValidElement(e) ? /* @__PURE__ */ C.cloneElement(e, t) : typeof e == "function" ? /* @__PURE__ */ C.createElement(e, t) : /* @__PURE__ */ C.createElement(VD, t);
}
var yt = /* @__PURE__ */ (function(e) {
  function t() {
    return d6(this, t), m6(this, t, arguments);
  }
  return g6(t, e), p6(t, [{
    key: "render",
    value: function() {
      ...
      var _ = b.length > 0;
      return /* @__PURE__ */ C.createElement(l6, {
        allowEscapeViewBox: o,
        animationDuration: u,
        animationEasing: s,
        isAnimationActive: h,
...
function CA() {
  if (rv) return Bf;
  rv = 1;
  var e = O6(), t = Gr(), r = _a(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, u = parseInt;
  function s(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function S6() {
  if (nv) return jf;
  nv = 1;
  var e = Gr(), t = _6(), r = CA(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(u, s, c) {
...
function x6() {
  if (av) return Ff;
  av = 1;
  var e = S6(), t = Gr(), r = "Expected a function";
  function n(a, i, o) {
    var u = !0, s = !0;
...
var Xi = /* @__PURE__ */ RT(function(e, t) {
  ...
  }), I = N6(O, 2), N = I[0], j = I[1], D = ex(function(B, F) {
    j(function($) {
...
var Za = function(t) {
  ...
  try {
    ...
    return Nn.widthCache[a] = s, ++Nn.cacheCount > F6 && (Nn.cacheCount = 0, Nn.widthCache = {}), s;
  } catch {
    return {
      width: 0,
      height: 0
...
function lv(e, t) {
  for (var r = 0; r < t.length; r++) {
    var n = t[r];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, V6(n.key), n);
  }
}
function K6(e, t, r) {
...
var fv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, dv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, Q6 = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, Z6 = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, RA = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, J6 = Object.keys(RA), jn = "NaN";
function eM(e, t) {
  return e * RA[t];
}
var ho = /* @__PURE__ */ (function() {
  function e(t, r) {
    G6(this, e), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !Q6.test(r) && (this.num = NaN, this.unit = ""), J6.includes(r) && (this.num = eM(t, r), this.unit = "px");
  }
  return K6(e, [{
    key: "add",
    value: function(r) {
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = Z6.exec(r)) !== null && n !== void 0 ? n : [], i = Yo(a, 3), o = i[1], u = i[2];
...
function $f(e) {
  var t = nM(e.slice(5, -1));
  return t === jn ? "" : t;
}
var aM = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], iM = ["dx", "dy", "angle", "className", "breakAll"];
function gh() {
...
var MA = /[ \f\n\r\t\v\u2028\u2029]+/, LA = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, l = t.scaleToFit, f = l === void 0 ? !1 : l, h = t.textAnchor, p = h === void 0 ? "start" : h, g = t.verticalAnchor, y = g === void 0 ? "end" : g, m = t.fill, E = m === void 0 ? gv : m, v = pv(t, aM), T = Fr(function() {
    return dM({
      breakAll: v.breakAll,
      children: v.children,
      maxLines: v.maxLines,
  ...
  }, [v.breakAll, v.children, v.maxLines, f, v.style, v.width]), A = v.dx, b = v.dy, _ = v.angle, O = v.className, I = v.breakAll, N = pv(v, iM);
  if (!ze(n) || !ze(i))
    return null;
...
function a0(e) {
  let t, r, n;
  e.length !== 2 ? (t = qr, r = (u, s) => qr(e(u), s), n = (u, s) => e(u) - s) : (t = e === qr || e === hM ? e : pM, r = e, n = e);
...
class vv extends Map {
  ...
  set(t, r) {
    return super.set(bM(this, t), r);
  }
  delete(t) {
    return super.delete(gM(this, t));
  }
}
...
function gM({ _intern: e, _key: t }, r) {
  const n = t(r);
...
const TM = Math.sqrt(50), _M = Math.sqrt(10), AM = Math.sqrt(2);
function zo(e, t, r) {
  const n = (t - e) / Math.max(0, r), a = Math.floor(Math.log10(n)), i = n / Math.pow(10, a), o = i >= TM ? 10 : i >= _M ? 5 : i >= AM ? 2 : 1;
  let u, s, c;
...
function OM(e, t, r) {
  if (e = Float64Array.from(mM(e)), !(!(n = e.length) || isNaN(t = +t))) {
...
var bi = 0.7, Go = 1 / bi, Yn = "\\s*([+-]?\\d+)\\s*", gi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", wM = /^#([0-9a-f]{3,8})$/, PM = new RegExp(`^rgb\\(${Yn},${Yn},${Yn}\\)$`), IM = new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`), CM = new RegExp(`^rgba\\(${Yn},${Yn},${Yn},${gi}\\)$`), NM = new RegExp(`^rgba\\(${rr},${rr},${rr},${gi}\\)$`), RM = new RegExp(`^hsl\\(${gi},${rr},${rr}\\)$`), DM = new RegExp(`^hsla\\(${gi},${rr},${rr},${gi}\\)$`), Av = {
  aliceblue: 15792383,
...
function vi(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = wM.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? xv(t) : r === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? po(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? po(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = PM.exec(e)) ? new gt(t[1], t[2], t[3], 1) : (t = IM.exec(e)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = CM.exec(e)) ? po(t[1], t[2], t[3], t[4]) : (t = NM.exec(e)) ? po(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = RM.exec(e)) ? Iv(t[1], t[2] / 100, t[3] / 100, 1) : (t = DM.exec(e)) ? Iv(t[1], t[2] / 100, t[3] / 100, t[4]) : Av.hasOwnProperty(e) ? xv(Av[e]) : e === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function xv(e) {
...
function Ah(e, t, r, n) {
  return arguments.length === 1 ? kM(e) : new gt(e, t, r, n ?? 1);
}
function gt(e, t, r, n) {
...
function UM(e) {
  return (e = +e) == 1 ? HA : function(t, r) {
    return r - t ? $M(t, r, e) : u0(isNaN(t) ? r : t);
  };
}
function HA(e, t) {
  var r = t - e;
  return r ? FM(e, r) : u0(isNaN(e) ? t : e);
}
...
function VM(e, t) {
  ...
  return r < t.length && (i = t.slice(r), u[o] ? u[o] += i : u[++o] = i), u.length < 2 ? s[0] ? KM(s[0].x) : GM(t) : (t = s.length, function(c) {
...
function xa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? u0(t) : (r === "number" ? Vo : r === "string" ? (n = vi(t)) ? (t = n, Nv) : VM : t instanceof vi ? Nv : t instanceof Date ? YM : qM(t) ? HM : Array.isArray(t) ? WM : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? zM : Vo)(e, t);
}
function s0(e, t) {
  return e = +e, t = +t, function(r) {
...
function es() {
  ...
  function l() {
    ...
    return o !== pt && (o = ZM(e[0], e[h - 1])), u = h > 2 ? eL : JM, s = c = null, f;
  }
  function f(h) {
...
var aL = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function Ei(e) {
  if (!(t = aL.exec(e))) throw new Error("invalid format: " + e);
  var t;
  return new l0({
    fill: t[1],
    align: t[2],
...
function uL(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? Lv : rL(kv.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? Lv : nL(kv.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", u = e.minus === void 0 ? "−" : e.minus + "", s = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f, h) {
    f = Ei(f);
    ...
    function D(R) {
      ...
      if (_ === "c")
        ...
        R = +R;
        var Q = R < 0 || 1 / R < 0;
        if (R = isNaN(R) ? s : N(Math.abs(R), A), b && (R = iL(R)), Q && +R == 0 && y !== "+" && (Q = !1), B = (Q ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + B, F = (_ === "s" && !isNaN(R) && Zo !== void 0 ? Bv[8 + Zo / 3] : "") + F + (Q && y === "(" ? ")" : ""), j) {
          for ($ = -1, q = R.length; ++$ < q; )
...
function sL(e) {
  return yo = uL(e), f0 = yo.format, qA = yo.formatPrefix, yo;
}
function cL(e) {
...
function WA(e, t, r, n) {
  ...
  switch (n = Ei(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = lL(a, o)) && (n.precision = i), qA(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(i = fL(a, Math.max(Math.abs(e), Math.abs(t)))) && (n.precision = i - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
      n.precision == null && !isNaN(i = cL(a)) && (n.precision = i - (n.type === "%") * 2);
      break;
    }
  }
  return f0(n);
...
function mL(e) {
  return e === 10 ? pL : e === Math.E ? Math.exp : (t) => Math.pow(e, t);
}
function yL(e) {
...
function d0(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = yL(n), i = mL(n), r()[0] < 0 ? (a = $v(a), i = $v(i), e(dL, hL)) : e(jv, Fv), t;
  }
...
function p0(e) {
  var t = e(pt, pt), r = 1;
  function n() {
    return r === 1 ? e(pt, pt) : r === 0.5 ? e(bL, gL) : e(qv(r), qv(1 / r));
  }
...
const rs = Sn(0), tu = Sn(1), TL = Sn(2), _L = Sn(3), ra = Sn(4), AL = Sn(5), OL = Sn(6);
rs.range;
tu.range;
TL.range;
_L.range;
...
const ns = xn(0), ru = xn(1), SL = xn(2), xL = xn(3), na = xn(4), wL = xn(5), PL = xn(6);
ns.range;
ru.range;
SL.range;
xL.range;
...
const [IL, CL] = eO(Or, _0, ns, JA, E0, g0), [NL, RL] = eO(Ar, T0, rs, eo, v0, b0);
function zf(e) {
  if (0 <= e.y && e.y < 100) {
...
function ka(e) {
  return new RegExp("^(?:" + e.map(kL).join("|") + ")", "i");
}
function Ba(e) {
...
function Dk(e) {
  return Rn = DL(e), iO = Rn.format, Rn.parse, oO = Rn.utcFormat, Rn.utcParse, Rn;
}
function Mk(e) {
  return new Date(e);
}
...
function A0(e, t, r, n, a, i, o, u, s, c) {
  ...
  return l.invert = function(_) {
    ...
    return arguments.length ? h(Array.from(_, Lk)) : h().map(Mk);
  }, l.ticks = function(_) {
    var O = h();
...
function kk() {
  return Ut.apply(A0(NL, RL, Ar, T0, rs, eo, v0, b0, sn, iO).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function Bk() {
  return Ut.apply(A0(IL, CL, Or, _0, ns, ts, E0, g0, sn, oO).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function as() {
...
function lO() {
  ...
  return r.domain = function(n) {
    ...
    return Array.from({ length: n + 1 }, (a, i) => OM(e, i / n));
  }, r.copy = function() {
...
function is() {
  ...
  function g(y) {
    return function(m) {
      var E, v, T;
      return arguments.length ? ([E, v, T] = m, c = XM(y, [E, v, T]), p) : [c(0), c(0.5), c(1)];
    };
  }
...
}, w0, Le = !0, Ft = "[DecimalError] ", hn = Ft + "Invalid argument: ", x0 = Ft + "Exponent out of range: ", Pa = Math.floor, nn = Math.pow, Qk = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ot, Xe = 1e7, Re = 7, yO = 9007199254740991, nu = Pa(yO / Re), ae = {};
...
function EO(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(hn + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, Qk.test(i)) f1(o, i);
    else throw Error(hn + i);
  }
  if (a.prototype = ae, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = EO, a.config = a.set = Zk, e === void 0 && (e = {}), e)
...
var a4 = function(t) {
  ...
  return t === 1 ? r : h1(function() {
    ...
    return o >= t ? r.apply(void 0, a) : e(t - o, h1(function() {
      ...
      return r.apply(void 0, Jk(l).concat(s));
    }));
  });
}, ls = function(t) {
  return i4(t.length, t);
}, wh = function(t, r) {
  for (var n = [], a = t; a < r; ++a)
    n[a - t] = a;
  return n;
...
var l4 = ls(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), f4 = ls(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), d4 = ls(function(e, t, r) {
  var n = t - +e;
...
const fs = {
  rangeStep: c4,
  getDigitCount: s4,
  interpolateNumber: l4,
  uninterpolateNumber: f4,
  uninterpolateTruncation: d4
};
function Ih(e) {
  return m4(e) || p4(e) || OO(e) || h4();
}
function h4() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function v4(e, t, r) {
  ...
  var o = Math.floor((t - 1) / 2), u = u4(o4(function(s) {
...
var _4 = AO(E4), A4 = AO(T4), O4 = process.env.NODE_ENV === "production", nd = "Invariant failed";
function vt(e, t) {
  if (O4)
    throw new Error(nd);
...
function k4(e, t, r) {
  return t = iu(t), B4(e, PO() ? Reflect.construct(t, r || [], iu(e).constructor) : t.apply(e, r));
}
function B4(e, t) {
...
var ds = /* @__PURE__ */ (function(e) {
  function t() {
    return D4(this, t), k4(this, t, arguments);
  }
  return F4(t, e), L4(t, [{
    key: "render",
    value: function() {
      var n = this.props, a = n.offset, i = n.layout, o = n.width, u = n.dataKey, s = n.data, c = n.dataPointFormatter, l = n.xAxis, f = n.yAxis, h = N4(n, S4), p = le(h, !1);
...
var X4 = function(t) {
  ...
  var o = r.props.children, u = jt(o, ds).filter(function(c) {
    return e8(a, i, c.props.direction);
  });
  if (u && u.length) {
  ...
  }), i = o8[n], o = z3().keys(a).value(function(u, s) {
    return +ut(u, s, 0);
  }).order(sh).offset(i);
  return o(t);
}, s8 = function(t, r, n, a, i, o) {
  if (!t)
    return null;
...
var uu = Math.PI / 180, v8 = function(t) {
  ...
  var n = t.x, a = t.y, i = r.cx, o = r.cy, u = T8({
    x: n,
    y: a
  }, {
    x: i,
  ...
  if (o === 0)
    return !0;
  var l = A8(r), f = l.startAngle, h = l.endAngle, p = u, g;
  if (f <= h) {
    for (; p > h; )
      p -= 360;
    for (; p < f; )
...
var k8 = function(t) {
  ...
  var a = t.position, i = t.viewBox, o = t.offset, u = t.className, s = i, c = s.cx, l = s.cy, f = s.innerRadius, h = s.outerRadius, p = s.startAngle, g = s.endAngle, y = s.clockWise, m = (f + h) / 2, E = B8(p, g), v = E >= 0 ? 1 : -1, T, A;
...
function Qe(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = N8(e, S8), a = We({
    offset: r
...
var WO = function(t) {
  ...
  if (!n)
    return o;
  var u = H8(t.label, r || i);
  return [u].concat(x8(o));
};
Qe.parseViewBox = WO;
Qe.renderCallByParent = q8;
var id, w1;
function W8() {
  if (w1) return id;
  w1 = 1;
...
var G8 = ["valueAccessor"], K8 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function V8(e) {
  return J8(e) || Z8(e) || Q8(e) || X8();
}
function X8() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var aB = function(t) {
  return Array.isArray(t.value) ? z8(t.value) : t.value;
};
function Gt(e) {
  var t = e.valueAccessor, r = t === void 0 ? aB : t, n = C1(e, G8), a = n.data, i = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = C1(n, K8);
...
function oB(e, t) {
  ...
  if (!r)
    return a;
  var i = iB(e.label, t);
  return [i].concat(V8(a));
}
Gt.renderCallByParent = oB;
function Ii(e) {
  "@babel/helpers - typeof";
...
var lB = function(t, r) {
  ...
  var r = t.cx, n = t.cy, a = t.innerRadius, i = t.outerRadius, o = t.startAngle, u = t.endAngle, s = lB(o, u), c = o + s, l = Ne(r, n, i, o), f = Ne(r, n, i, c), h = "M ".concat(l.x, ",").concat(l.y, `
  ...
  var r = R1(R1({}, dB), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < i || l === f)
    return null;
  var p = pe("recharts-sector", h), g = o - i, y = ht(u, g, 0, !0), m;
  return y > 0 && Math.abs(l - f) < 360 ? m = fB({
    cx: n,
    cy: a,
    innerRadius: i,
    outerRadius: o,
...
var L1 = {
  ...
  var r = t.type, n = r === void 0 ? "linear" : r, a = t.points, i = a === void 0 ? [] : a, o = t.baseLine, u = t.layout, s = t.connectNulls, c = s === void 0 ? !1 : s, l = yB(n, u), f = c ? i.filter(function(y) {
    return vo(y);
  }) : i, h;
  if (Array.isArray(o)) {
...
var j1;
function GO() {
  return j1 || (j1 = 1, process.env.NODE_ENV === "production" ? To.exports = gB() : To.exports = vB()), To.exports;
}
var od, F1;
function EB() {
  if (F1) return od;
...
function _B() {
  if (q1) return ld;
  q1 = 1;
  var e = GO(), t = EB(), r = /* @__PURE__ */ I0(), n = /* @__PURE__ */ KO(), a = /* @__PURE__ */ TB(), i = function() {
  };
...
function OB() {
  ...
  if (Y1 = 1, process.env.NODE_ENV !== "production") {
    var e = GO(), t = !0;
    Eo.exports = /* @__PURE__ */ _B()(e.isElement, t);
  } else
    Eo.exports = /* @__PURE__ */ AB()();
  return Eo.exports;
}
var SB = /* @__PURE__ */ OB();
const Ae = /* @__PURE__ */ xe(SB), { getOwnPropertyNames: xB, getOwnPropertySymbols: wB } = Object, { hasOwnProperty: PB } = Object.prototype;
function dd(e, t) {
...
function z1(e) {
  return xB(e).concat(wB(e));
}
const CB = (
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  Object.hasOwn || ((e, t) => PB.call(e, t))
);
function wn(e, t) {
  return e === t || !e && !t && e !== e && t !== t;
}
const NB = "__v", RB = "__o", DB = "_owner", { getOwnPropertyDescriptor: G1, keys: K1 } = Object;
function MB(e, t) {
...
function VO(e, t, r, n) {
  return (n === DB || n === RB || n === NB) && (e.$$typeof || t.$$typeof) ? !0 : CB(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
const YB = "[object ArrayBuffer]", zB = "[object Arguments]", GB = "[object Boolean]", KB = "[object DataView]", VB = "[object Date]", XB = "[object Error]", QB = "[object Map]", ZB = "[object Number]", JB = "[object Object]", e5 = "[object RegExp]", t5 = "[object Set]", r5 = "[object String]", n5 = {
  "[object Int8Array]": !0,
  "[object Uint8Array]": !0,
...
}, a5 = "[object URL]", i5 = Object.prototype.toString;
function o5({ areArrayBuffersEqual: e, areArraysEqual: t, areDataViewsEqual: r, areDatesEqual: n, areErrorsEqual: a, areFunctionsEqual: i, areMapsEqual: o, areNumbersEqual: u, areObjectsEqual: s, arePrimitiveWrappersEqual: c, areRegExpsEqual: l, areSetsEqual: f, areTypedArraysEqual: h, areUrlsEqual: p, unknownTagComparators: g }) {
...
function u5({ circular: e, createCustomConfig: t, strict: r }) {
  let n = {
    areArrayBuffersEqual: MB,
    areArraysEqual: r ? $a : LB,
    areDataViewsEqual: kB,
    areDatesEqual: BB,
    areErrorsEqual: jB,
    areFunctionsEqual: FB,
    areMapsEqual: r ? dd(V1, $a) : V1,
    areNumbersEqual: $B,
    areObjectsEqual: r ? $a : UB,
    arePrimitiveWrappersEqual: HB,
    areRegExpsEqual: qB,
...
function c5({ circular: e, comparator: t, createState: r, equals: n, strict: a }) {
  if (r)
    return function(u, s) {
...
function Xr(e = {}) {
  const { circular: t = !1, createInternalComparator: r, createState: n, strict: a = !1 } = e, i = u5(e), o = o5(i), u = r ? r(o) : s5(o);
  return c5({ circular: t, comparator: o, createState: n, equals: u, strict: a });
}
function f5(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(i)) {
        if (!i.length)
          return;
        var o = i, u = d5(o), s = u[0], c = u.slice(1);
        if (typeof s == "number") {
          Q1(a.bind(null, c), s);
          return;
        }
...
var E5 = function(t, r) {
  ...
  return t.map(function(a) {
    return "".concat(_5(a), " ").concat(r, "ms ").concat(n);
  }).join(",");
}, A5 = process.env.NODE_ENV !== "production", lu = function(t, r, n, a, i, o, u, s) {
  if (A5 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
      console.warn("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
    else {
...
var fu = 1e-4, ZO = function(t, r) {
  ...
  return function(n) {
    var a = ZO(t, r), i = [].concat(P5(a.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return JO(i, n);
  };
  ...
  var f = rE(a, o), h = rE(i, u), p = R5(a, o), g = function(E) {
...
var du = function(t, r, n) {
  ...
  var a = ti(function(i, o) {
    if (qh(o)) {
      var u = t(o.from, o.to, o.velocity), s = $5(u, 2), c = s[0], l = s[1];
      return tt(tt({}, o), {}, {
        from: c,
        velocity: l
      });
...
const Y5 = (function(e, t, r, n, a) {
  var i = E5(e, t), o = i.reduce(function(m, E) {
    ...
    c || (c = E);
    var v = E - c, T = v / r.dt;
    u = W5(r, u, T), a(tt(tt(tt({}, e), t), h())), c = E, p() || (s = requestAnimationFrame(f));
  }, y = function(E) {
    l || (l = E);
...
var z5 = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function G5(e, t) {
  if (e == null) return {};
  var r = K5(e, t), n, a;
  if (Object.getOwnPropertySymbols) {
...
function tj(e, t, r) {
  return t && ej(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function tS(e) {
  var t = rj(e, "string");
  ...
  return tj(r, [{
    ...
    value: function(a) {
      ...
      if (u) {
        ...
        if (!(l5(a.to, l) && a.canBegin && a.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(a) {
      var i = this, o = a.from, u = a.to, s = a.duration, c = a.easing, l = a.begin, f = a.onAnimationEnd, h = a.onAnimationStart, p = Y5(o, u, M5(c), s, this.changeStyle), g = function() {
        i.stopJSAnimation = p();
      };
    ...
    value: function(a) {
      var i = this, o = a.steps, u = a.begin, s = a.onAnimationStart, c = o[0], l = c.style, f = c.duration, h = f === void 0 ? 0 : f, p = function(y, m, E) {
        ...
        return [].concat(hd(y), [D, v, O]).filter(T5);
      };
    ...
    value: function() {
      ...
      var s = G5(a, z5), c = $r.count(i), l = this.state.style;
      if (typeof i == "function")
        return i(l);
      if (!u || c === 0 || o <= 0)
        return i;
...
var lE = function(t, r, n, a, i) {
  ...
  var r = cE(cE({}, mj), t), n = ii(), a = ft(-1), i = oj(a, 2), o = i[0], u = i[1];
  Et(function() {
...
}, yj = ["points", "className", "baseLinePoints", "connectNulls"];
function Fn() {
...
var dE = function(t) {
  ...
  var r = t.points, n = t.className, a = t.baseLinePoints, i = t.connectNulls, o = bj(t, yj);
  if (!r || !r.length)
    return null;
  var u = pe("recharts-polygon", n);
  if (a && a.length) {
    var s = o.stroke && o.stroke !== "none", c = Oj(r, a, i);
...
var xj = ["x", "y", "top", "left", "width", "height", "className"];
function Xh() {
...
var Dj = function(t, r, n, a, i, o) {
  return "M".concat(t, ",").concat(i, "v").concat(a, "M").concat(o, ",").concat(r, "h").concat(n);
}, Mj = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.top, u = o === void 0 ? 0 : o, s = t.left, c = s === void 0 ? 0 : s, l = t.width, f = l === void 0 ? 0 : l, h = t.height, p = h === void 0 ? 0 : h, g = t.className, y = Nj(t, xj), m = wj({
    x: n,
    y: i,
    top: u,
    left: c,
...
var Uj = ["cx", "cy", "angle", "ticks", "axisLine"], Hj = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function oa(e) {
  "@babel/helpers - typeof";
...
function zj(e, t, r) {
  return t = mu(t), Gj(e, rS() ? Reflect.construct(t, r || [], mu(e).constructor) : t.apply(e, r));
}
function Gj(e, t) {
...
var ps = /* @__PURE__ */ (function(e) {
  function t() {
    return Wj(this, t), zj(this, t, arguments);
  }
  return Vj(t, e), Yj(t, [{
    ...
    key: "getViewBox",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = Bj(u, function(l) {
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = n.axisLine, c = bE(n, Uj), l = u.reduce(function(g, y) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.angle, s = a.tickFormatter, c = a.stroke, l = bE(a, Hj), f = this.getTickTextAnchor(), h = le(l, !1), p = le(o, !1), g = i.map(function(y, m) {
...
function Jj(e, t, r) {
  return t = yu(t), eF(e, aS() ? Reflect.construct(t, r || [], yu(e).constructor) : t.apply(e, r));
}
function eF(e, t) {
...
var aF = Math.PI / 180, TE = 1e-5, ys = /* @__PURE__ */ (function(e) {
  function t() {
    return Qj(this, t), Jj(this, t, arguments);
  }
  return rF(t, e), Zj(t, [{
    ...
    key: "getTickTextAnchor",
    value: function(n) {
      var a = this.props.orientation, i = Math.cos(-n.coordinate * aF), o;
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Sj, an({
        className: "recharts-polar-angle-axis-line"
      }, c, {
        points: f
      }));
...
function oF() {
  if (AE) return bd;
  AE = 1;
  var e = xr(), t = iF(), r = wr(), n = "[object Object]", a = Function.prototype, i = Object.prototype, o = a.toString, u = i.hasOwnProperty, s = o.call(Object);
  function c(l) {
    if (!r(l) || e(l) != n)
      return !1;
    var f = t(l);
...
var PE = function(t, r, n, a, i) {
  ...
  var r = wE(wE({}, EF), t), n = ii(), a = ft(-1), i = dF(a, 2), o = i[0], u = i[1];
  Et(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
}, _F = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function ki(e) {
  "@babel/helpers - typeof";
...
function CE(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ C.createElement(TF, r);
    case "sector":
...
function oS(e) {
  var t = e.option, r = e.shapeType, n = e.propTransformer, a = n === void 0 ? PF : n, i = e.activeClassName, o = i === void 0 ? "recharts-active-shape" : i, u = e.isActive, s = AF(e, _F), c;
  if (/* @__PURE__ */ Lt(t))
    c = /* @__PURE__ */ Ue(t, gu(gu({}, s), CF(t)));
  else if (de(t))
    c = t(s);
  else if (sF(t) && !fF(t)) {
    var l = a(t, s);
...
function MF(e, t) {
  var r;
  return bs(e, t) ? r = NF : gs(e, t) ? r = RF : Bi(e, t) && (r = DF), r;
}
function LF(e, t) {
  var r;
...
function BF(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, a = LF(r, t), i = kF(r, t), o = n.filter(function(s, c) {
...
function $F(e, t, r) {
  return t = vu(t), UF(e, uS() ? Reflect.construct(t, r || [], vu(e).constructor) : t.apply(e, r));
}
function UF(e, t) {
...
var Ir = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return jF(this, t), n = $F(this, t, [r]), Rt(n, "pieRef", null), Rt(n, "sectorRefs", []), Rt(n, "id", Ki("recharts-pie-")), Rt(n, "handleAnimationEnd", function() {
...
var QF = ["Webkit", "Moz", "O", "ms"], ZF = function(t, r) {
  var n = t.replace(/(\w)/, function(i) {
    return i.toUpperCase();
  }), a = QF.reduce(function(i, o) {
...
function t9(e, t, r) {
  return t = _u(t), r9(e, fS() ? Reflect.construct(t, r || [], _u(e).constructor) : t.apply(e, r));
}
function r9(e, t) {
...
var o9 = function(t) {
  ...
  function t(r) {
    var n;
    return JF(this, t), n = t9(this, t, [r]), _t(n, "handleDrag", function(a) {
  ...
  return a9(t, e), e9(t, [{
    ...
    value: function() {
      ...
      if (!a || !a.length || !J(u) || !J(s) || !J(c) || !J(l) || c <= 0 || l <= 0)
        return null;
      var T = pe("recharts-brush", i), A = C.Children.count(o) === 1, b = ZF("userSelect", "none");
      return /* @__PURE__ */ C.createElement(Oe, {
        className: T,
...
function E9(e, t, r) {
  return t = T9(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function T9(e) {
  var t = _9(e, "string");
...
function S9(e, t) {
  var r = e.x, n = e.y, a = A9(e, v9), i = "".concat(r), o = parseInt(i, 10), u = "".concat(n), s = parseInt(u, 10), c = "".concat(t.height || a.height), l = parseInt(c, 10), f = "".concat(t.width || a.width), h = parseInt(f, 10);
...
function R9(e, t, r) {
  return t = Ou(t), D9(e, mS() ? Reflect.construct(t, r || [], Ou(e).constructor) : t.apply(e, r));
}
function D9(e, t) {
...
var sr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = R9(this, t, [].concat(a)), jr(r, "state", {
      isAnimationFinished: !1
...
jr(sr, "getComposedData", function(e) {
  var t = e.props, r = e.item, n = e.barPosition, a = e.bandSize, i = e.xAxis, o = e.yAxis, u = e.xAxisTicks, s = e.yAxisTicks, c = e.stackedData, l = e.dataStartIndex, f = e.displayedData, h = e.offset, p = r8(n, r);
  if (!p)
    return null;
  var g = t.layout, y = r.type.defaultProps, m = y !== void 0 ? $e($e({}, y), r.props) : r.props, E = m.dataKey, v = m.children, T = m.minPointSize, A = g === "horizontal" ? o : i, b = c ? A.scale.domain() : null, _ = c8({
    numericAxis: A
  }), O = jt(v, Ju), I = f.map(function(N, j) {
    var D, R, B, F, $, q;
    c ? D = n8(c[l + j], b) : (D = ut(N, E), Array.isArray(D) || (D = [_, D]));
    var Y = x9(T, pS.defaultProps.minPointSize)(D[1], j);
    if (g === "horizontal") {
...
var $9 = function(t, r, n, a, i) {
  ...
  return l.reduce(function(p, g) {
    ...
    if (y.type === "number" && (y.padding === "gap" || y.padding === "no-gap")) {
      var R = E[1] - E[0], B = 1 / 0, F = y.categoricalDomain.sort(WN);
...
var q9 = function(t) {
  var r = t.width, n = t.height, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i = H9(a), o = i * Math.PI / 180, u = Math.atan(n / r), s = o > u && o < Math.PI - u ? n / Math.sin(o) : r / Math.cos(o);
  return Math.abs(s);
}, Nd, tT;
function W9() {
  if (tT) return Nd;
...
var K9 = G9();
const V9 = /* @__PURE__ */ xe(K9);
var X9 = M_();
const Q9 = /* @__PURE__ */ xe(X9);
var Z9 = Q9(function(e) {
  return {
    x: e.left,
    y: e.top,
    width: e.width,
...
var D0 = /* @__PURE__ */ Vt(void 0), M0 = /* @__PURE__ */ Vt(void 0), ES = /* @__PURE__ */ Vt(void 0), TS = /* @__PURE__ */ Vt({}), _S = /* @__PURE__ */ Vt(void 0), AS = /* @__PURE__ */ Vt(0), OS = /* @__PURE__ */ Vt(0), iT = function(t) {
  var r = t.state, n = r.xAxisMap, a = r.yAxisMap, i = r.offset, o = t.clipPathId, u = t.children, s = t.width, c = t.height, l = Z9(i);
...
function u$(e, t, r) {
  return t = xu(t), s$(e, PS() ? Reflect.construct(t, r || [], xu(e).constructor) : t.apply(e, r));
}
function s$(e, t) {
...
var b$ = function(t, r) {
  ...
  if (a) {
    ...
    return nr(c, "discard") && l9(b, function(_) {
...
function v$(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = J9(), l = xS(a), f = wS(i), h = r$();
  if (!c || !h)
    return null;
  ...
  var p = R0({
    x: l.scale,
    y: f.scale
  }), g = ze(t), y = ze(r), m = n && n.length === 2, E = g$(p, g, y, m, h, e.position, l.orientation, f.orientation, e);
  if (!E)
    return null;
  var v = d$(E, 2), T = v[0], A = T.x, b = T.y, _ = v[1], O = _.x, I = _.y, N = nr(e, "hidden") ? "url(#".concat(c, ")") : void 0, j = uT(uT({
    clipPath: N
  }, le(e, !0)), {}, {
    x1: A,
    y1: b,
  ...
  }, b$(o, j), Qe.renderCallByParent(e, U9({
    x1: A,
    y1: b,
    x2: O,
    y2: I
...
var j0 = /* @__PURE__ */ (function(e) {
  function t() {
    return a$(this, t), u$(this, t, arguments);
  }
  return l$(t, e), o$(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(v$, this.props);
    }
  }]);
})(C.Component);
...
function A$(e, t, r) {
  return t = wu(t), O$(e, CS() ? Reflect.construct(t, r || [], wu(e).constructor) : t.apply(e, r));
}
function O$(e, t) {
...
var P$ = function(t) {
  ...
  function t() {
    return E$(this, t), A$(this, t, arguments);
  }
  return x$(t, e), _$(t, [{
    key: "render",
    value: function() {
...
function N$(e, t, r) {
  return t && C$(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function R$(e, t, r) {
  return t = Pu(t), D$(e, RS() ? Reflect.construct(t, r || [], Pu(e).constructor) : t.apply(e, r));
}
function D$(e, t) {
...
var B$ = function(t, r, n, a, i) {
  ...
  function t() {
    return I$(this, t), R$(this, t, arguments);
  }
  return L$(t, e), N$(t, [{
    key: "render",
    value: function() {
...
function F0(e, t, r) {
  ...
  if (!a || !a.length || !n)
    return [];
  if (J(s) || Sa.isSsr)
    return $$(a, typeof s == "number" && J(s) ? s : 0);
  ...
  }, m = a.length >= 2 ? dt(a[1].coordinate - a[0].coordinate) : 1, E = F$(i, m, p);
  return s === "equidistantPreserveStart" ? U$(m, E, y, a, o) : (s === "preserveStart" || s === "preserveStartEnd" ? h = z$(m, E, y, a, o, s === "preserveStartEnd") : h = Y$(m, E, y, a, o), h.filter(function(v) {
    return v.isShow;
  }));
}
var G$ = ["viewBox"], K$ = ["viewBox"], V$ = ["ticks"];
function ya(e) {
  "@babel/helpers - typeof";
...
function J$(e, t, r) {
  return t = Cu(t), eU(e, LS() ? Reflect.construct(t, r || [], Cu(e).constructor) : t.apply(e, r));
}
function eU(e, t) {
...
var Ia = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return Q$(this, t), n = J$(this, t, [r]), n.state = {
      fontSize: "",
      letterSpacing: ""
    }, n;
  }
  return rU(t, e), Z$(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = Ld(n, G$), u = this.props, s = u.viewBox, c = Ld(u, K$);
    ...
    value: function() {
      ...
      if (l)
        return null;
      var f = this.props, h = f.ticks, p = Ld(f, V$), g = h;
...
var aU = ["x1", "y1", "x2", "y2", "key"], iU = ["offset"];
function En(e) {
  "@babel/helpers - typeof";
...
function BS(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, u = t.key, s = bT(t, aU), c = le(s, !1);
    c.offset;
    var l = bT(c, iU);
...
function to(e) {
  var t, r, n, a, i, o, u = L0(), s = k0(), c = n$(), l = ot(ot({}, e), {}, {
  ...
  }), f = l.x, h = l.y, p = l.width, g = l.height, y = l.syncWithTicks, m = l.horizontalValues, E = l.verticalValues, v = e$(), T = t$();
  if (!J(p) || p <= 0 || !J(g) || g <= 0 || !J(f) || f !== +f || !J(h) || h !== +h)
    return null;
  var A = l.verticalCoordinatesGenerator || mU, b = l.horizontalCoordinatesGenerator || yU, _ = l.horizontalPoints, O = l.verticalPoints;
  if ((!_ || !_.length) && de(b)) {
...
function vU(e, t, r) {
  return t && gU(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function EU(e, t, r) {
  return t = Nu(t), TU(e, jS() ? Reflect.construct(t, r || [], Nu(e).constructor) : t.apply(e, r));
}
function TU(e, t) {
...
var Pn = /* @__PURE__ */ (function(e) {
  function t() {
    return bU(this, t), EU(this, t, arguments);
  }
  return AU(t, e), vU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(SU, this.props);
    }
  }]);
})(Wr.Component);
...
function IU(e, t, r) {
  return t = Ru(t), CU(e, US() ? Reflect.construct(t, r || [], Ru(e).constructor) : t.apply(e, r));
}
function CU(e, t) {
...
var MU = function(t) {
  ...
  function t() {
    return xU(this, t), IU(this, t, arguments);
  }
  return RU(t, e), PU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(MU, this.props);
    }
  }]);
})(Wr.Component);
...
var $U = FU();
const UU = /* @__PURE__ */ xe($U);
var Bd = new UU(), jd = "recharts.syncMouseEvents";
function Ui(e) {
  "@babel/helpers - typeof";
...
function WU(e, t, r) {
  return t && qU(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function Fd(e, t, r) {
...
var zU = /* @__PURE__ */ (function() {
  function e() {
    HU(this, e), Fd(this, "activeIndex", 0), Fd(this, "coordinateList", []), Fd(this, "layout", "horizontal");
  }
  return WU(e, [{
    key: "setDetails",
    value: function(r) {
...
var e7 = ["item"], t7 = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function va(e) {
  "@babel/helpers - typeof";
...
function s7(e, t, r) {
  return t && u7(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function c7(e, t, r) {
  return t = Du(t), l7(e, zS() ? Reflect.construct(t, r || [], Du(e).constructor) : t.apply(e, r));
}
function l7(e, t) {
...
var gp = function(t, r, n, a) {
  ...
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = v7(i, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, l = X4(o, u, c, s);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, h = gp(t, r, l, f), p = E7(n, u, l, i);
    return {
  ...
  return n.reduce(function(g, y) {
    ...
    GU(E.domain, A, v) && (R = Dh(E.domain, null, A), p && (v === "number" || _ !== "auto") && (F = ei(j, T, "category")));
    var $ = XS(v);
    if (!R || R.length === 0) {
      ...
      if (T) {
        if (R = ei(j, T, v), v === "category" && p) {
          ...
          var te = t8(j, a.filter(function(z) {
  ...
  return n.reduce(function(m, E) {
    ...
    if (!m[T]) {
      ...
      return g ? b = Eu(0, p) : u && u[T] && u[T].hasStack ? (b = FO(u[T].stackGroups, s, c), b = mp(f, b, T, i)) : (b = Dh(A, DO(h, n.filter(function(_) {
        ...
        hide: !0,
        orientation: xt(b7, "".concat(i, ".").concat(y % 2), null),
        domain: b,
        originalDomain: A,
        isCategorical: g,
        layout: l
  ...
  p && (E.bottom += p.props.height || la.defaultProps.height), g && r && (E = J4(E, a, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(E, v) {
    var T = v.graphicalItems, A = v.stackGroups, b = v.offset, _ = v.updateId, O = v.dataStartIndex, I = v.dataEndIndex, N = E.barSize, j = E.layout, D = E.barGap, R = E.barCategoryGap, B = E.maxBarSize, F = xT(j), $ = F.numericAxisName, q = F.cateAxisName, Y = S7(T), Q = [];
    return T.forEach(function(te, k) {
      ...
      }, fe), G = ce[q], re = ce["".concat(q, "Ticks")], ie = A && A[oe] && A[oe].hasStack && l8(te, A[oe].stackGroups), M = vr(te.type).indexOf("Bar") >= 0, ye = ou(G, re), X = [], Pe = Y && Q4({
        barSize: N,
        stackGroups: A,
        totalSize: w7(ce, q)
      });
    ...
    if (!By({
      ...
      return null;
    var O = T.children, I = T.layout, N = T.stackOffset, j = T.data, D = T.reverseStackOrder, R = xT(I), B = R.numericAxisName, F = R.cateAxisName, $ = jt(O, n), q = s8(j, $, "".concat(B, "Id"), "".concat(F, "Id"), N, D), Y = s.reduce(function(z, Z) {
      var ne = "".concat(Z.axisType, "Map");
      return H(H({}, z), {}, se({}, ne, A7(T, H(H({}, Z), {}, {
        graphicalItems: $,
    ...
    var te = Y["".concat(F, "Map")], k = O7(te), W = h(T, H(H({}, Y), {}, {
      dataStartIndex: A,
      dataEndIndex: b,
      updateId: _,
      graphicalItems: $,
    ...
    function E(v) {
      var T, A, b;
      return o7(this, E), b = c7(this, E, [v]), se(b, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(b, "accessibilityManager", new zU()), se(b, "handleLegendBBoxUpdate", function(_) {
        if (_) {
        ...
        var O = e3(_), I = xt(b.props, "".concat(O));
        if (O && de(I)) {
          var N, j;
        ...
        return /* @__PURE__ */ C.createElement(JU, {
          key: Q,
          activeCoordinate: j,
          activePayload: D,
    ...
    return d7(E, m), s7(E, [{
      ...
      value: function(T) {
        if (!this.container)
          return null;
        var A = this.container, b = A.getBoundingClientRect(), _ = H6(b), O = {
      ...
      value: function() {
        ...
        if (!By(this))
          return null;
        var A = this.props, b = A.children, _ = A.className, O = A.width, I = A.height, N = A.style, j = A.compact, D = A.title, R = A.desc, B = _T(A, t7), F = le(B, !1);
        if (j)
...
const I7 = "funding", C7 = ["Source", "Grants", "Total (GBP)"], N7 = [32, 10, 18], R7 = ["text", "number", "currency"], Gn = new Intl.NumberFormat("en-GB", {
  style: "currency",
  currency: "GBP",
  maximumFractionDigits: 0
});
function MH({ content: e, block: t }) {
  const r = An(I7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Funding received", o = M7(n), u = o.reduce((c, l) => c + l.total, 0);
  ct(
    t,
    "xlsx",
    r && o.length > 0 ? {
...
const L7 = "members", $d = ["Name", "Rank", "Department", "Tenured", "Start year"], k7 = [28, 14, 18, 10, 12], B7 = ["text", "text", "text", "text", "number"];
function LH({ content: e, block: t }) {
  const r = An(L7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Members", o = [...n].sort((s, c) => {
...
const F7 = "publications-by-journal", $7 = 10, U7 = ["Venue", "Count"], H7 = [48, 10], q7 = ["text", "number"];
function kH({ content: e, block: t }) {
  const r = An(F7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by journal", u = Y7(n, $7, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
...
const z7 = "publications-by-type", wT = [
  "#1e40af",
  // primary
  "#be123c",
  // accent
  ...
  "#64748b"
  // slate (fallback)
], G7 = ["Publication type", "Count"], K7 = [24, 10], V7 = ["text", "number"];
function BH({ content: e, block: t }) {
  const r = An(z7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by type", u = Q7(n, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications for the selected population." }) : /* @__PURE__ */ P(X7, { counts: u })
  ] }) : null;
}
function X7({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ P("div", { className: "chart-container", children: /* @__PURE__ */ P(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(P7, { children: [
    /* @__PURE__ */ P(
      Ir,
      {
        data: n,
...
const Z7 = "publications-by-year", J7 = ["Year", "Count", "Cumulative"], eH = [10, 10, 12], tH = ["number", "number", "number"];
function jH({ content: e, block: t }) {
  const r = An(Z7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by year", { series: u, total: s } = nH(n, i);
  return ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(rH, { series: u })
  ] }) : null;
}
function rH({ series: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
...
function oH(e) {
  return Array.isArray(e) ? e.map((t) => {
    const r = t._author ? aH(t._author) : void 0;
    return iH(t, { defaultAuthor: r });
  }).filter(Boolean) : [];
}
const uH = "publications-list", PT = {
...
function FH({ content: e, block: t }) {
  const r = An(uH), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications", u = [...j7(n, i)].sort((y, m) => {
    const E = Number(y.year) || 0;
    return (Number(m.year) || 0) - E;
  }), s = oH(u), c = s.map((y) => y.id).join("|"), [l, f] = ft({ loading: !0, entries: [] });
  Et(() => {
    let y = !1;
    if (!r || s.length === 0) {
      f({ loading: !1, entries: [] });
    ...
    return sH(i.citationStyle).then(({ formatAll: m, style: E }) => {
      if (!y)
        try {
...
const cH = "supervisions", IT = ["#1e40af", "#0f766e", "#ea580c", "#9333ea", "#be123c", "#0ea5e9"];
function $H({ content: e, block: t }) {
  const r = An(cH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Supervisions", { levels: o, rows: u, grandTotal: s } = fH(n), c = ["Member", ...o.map(Ep), "Total"], l = u.map((v) => [
    v.member,
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No supervisions recorded for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ P(lH, { rows: u, levels: o })
    ] })
  ] }) : null;
}
function lH({ rows: e, levels: t }) {
  const [r, n] = ft(!1);
  if (Et(() => {
    n(!0);
  }, []), !r)
...
const pH = "members";
function mH() {
  const e = HC(pH), [, t] = Mp(), [r, n] = Lp(), [a, i] = ft(() => NT(r, e));
  if (Et(() => {
    i(NT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
function yH({ field: e, def: t, value: r, onChange: n }) {
  const a = t?.label || e;
  switch (t?.type) {
    case "enum":
      ...
      /* @__PURE__ */ ee("label", { className: "report-options-field", children: [
        ...
        /* @__PURE__ */ P(
          "select",
          {
            ...
            onChange: s,
            className: "report-options-input",
            children: GC.map((c) => /* @__PURE__ */ P("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] })
    ] }),
...
function SH({ body: e, page: t }) {
  ...
  return Et(() => XC(t), [t]), /* @__PURE__ */ ee(JT, { basePath: r.basePath, children: [
    ...
    /* @__PURE__ */ P(OH, { title: n, filename: a })
  ] });
}
const xH = { ...No, vars: Tw || No?.vars, layouts: { MetricsLayout: SH } }, wH = {}, PH = {}, UH = { meta: wH, capabilities: xH, layoutMeta: PH };
export {
  DH as C,
  gr as D,
  MH as F,
...
//# sourceMappingURL=_entry.generated-CA809Vg1.js.map
