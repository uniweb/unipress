...
function Ln(e, t) {
  ...
  return t = Wx(r, a, t), e.title && Tr(t) && (t = FT(t, e.locale)), e.aux && (ke(t) && (t = t.join(e.sep || ", ")), t = Ap(e, t)), e.label && (ke(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = d2(e, t)), e.heading && (ke(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = f2(e, t)), e.wrap && (Du(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Wx(e, t, r) {
  switch (e) {
    case "null":
...
function BT(e, t) {
  const r = [];
  for (let n of t)
    ke(n) ? n = BT(e, n) : Dt(n) && (n = jT(e, n)), Du(n) || r.push(n);
...
function yw(e) {
  if (e == null) return null;
  if (typeof e == "number")
    return Number.isFinite(e) ? { tier: Yd, value: e * GT } : null;
  if (typeof e == "string") {
    const t = e.trim();
    if (t === "") return null;
    const r = bw(t);
...
const Dr = {
...
}, i_ = "html", Jw = "about:legacy-compat", eP = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", o_ = [
  ...
  "html"
]), u_ = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], nP = [
  ...u_,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function aP(e) {
  return e.name === i_ && e.publicId === null && (e.systemId === null || e.systemId === Jw);
}
function iP(e) {
  if (e.name !== i_)
    return Nt.QUIRKS;
...
function BI(e, t) {
  const r = t.tagID;
  v_.has(r) ? (e.openElements.hasInTableScope(d.TD) || e.openElements.hasInTableScope(d.TH)) && (e._closeTableCell(), ju(e, t)) : lt(e, t);
}
function jI(e, t) {
  const r = t.tagID;
  switch (r) {
...
function ZI(e, t) {
  if (dP(t))
    ...
    n === K.MATHML ? s_(t) : n === K.SVG && (hP(t), c_(t)), wp(t), t.selfClosing ? e._appendElement(t, n) : e._insertElement(t, n), t.ackSelfClosing = !0;
  }
}
function JI(e, t) {
...
const cC = {
  docx: { load: () => import("./docx-D_H0WvTM.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-5I-2bqRE.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-DSwVRouT.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-BnVaCdjr.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-Bii86Lk2.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = cC[e];
  return t ? {
...
function fC(e, t) {
  ...
  return r.ir ? dC(n, e) : r.consumes === "html" ? hC(n, e) : pC(n);
}
function dC(e, t) {
...
async function Em(e, t, r = {}) {
  const { basePath: n, theme: a, adapterOptions: i = {} } = r, o = yC(e, t, { basePath: n, theme: a });
  return lC(t, o, i);
}
async function gC(e, t = {}) {
  ...
  const g = p.via ?? a, y = p.getOptions ? await p.getOptions(n, { format: a, rootPath: o, loadAsset: f, ...l }) : {}, m = {
    ...
    ...y.adapterOptions,
    ...u
  }, v = TC(n, o), E = globalThis.uniweb?.childBlockRenderer;
...
function x_({
  ...
  const p = XT(), g = ui(a, p), y = Aw(o, p), m = l ?? f, v = { "data-type": "text" };
  return t && (v["data-bold"] = "true"), r && (v["data-italics"] = "true"), n && (v["data-underline"] = "true"), g && (v["data-color"] = g), i != null && (v["data-size"] = i), y && (v["data-font"] = y), u && (v["data-smallcaps"] = "true"), s && (v["data-allcaps"] = "true"), c && (v["data-strike"] = "true"), m && (v["data-style"] = m), /* @__PURE__ */ I("span", { ...v, ...h, children: OC(e) });
}
function SC({ latex: e, display: t = !1, id: r, ...n }) {
  const a = { "data-type": "math" };
  return a["data-latex"] = e || "", a["data-display"] = t ? "true" : "false", r && (a["data-id"] = r), /* @__PURE__ */ I("span", { ...a, ...n });
}
function xC({ tabStops: e, indent: t, role: r }) {
  const n = {};
...
function Bt({
  ...
  const u = xC({ tabStops: r, indent: n, role: a });
  if (t) {
    const s = AC(t);
...
function IC(e) {
  ...
  return PC.some((r) => t.includes(r));
}
const CC = /(<a\b[^>]*?\shref=)(["'])([^"']*)\2/gi, NC = /^(?:[a-z][a-z0-9+.-]*:|\/\/|#)/i;
function RC(e, t) {
...
function MC(e, t, { locale: r = !0 } = {}) {
  if (!e || typeof e != "string" || !t) return e;
  let n = e;
  return (e.startsWith("page:") || e.startsWith("topic:")) && (n = t.makeHref ? t.makeHref(e) : e), NC.test(n) || r && n.startsWith("/") && !IC(n) && (n = DC(n, t)), n;
}
function LC(e, t) {
  return !e || typeof e != "string" || !t ? e : RC(MC(e, t), t.basePath || "");
}
function kC(e, t) {
  ...
  return !r && !t.basePath && !n ? e : e.replace(CC, (a, i, o, u) => {
    const s = LC(u, t);
    return s === u ? a : `${i}${o}${s}${o}`;
  });
}
function BC({ value: e, className: t, as: r = "div", ...n }) {
...
function ln(e, t) {
  const { website: r } = Fu(), [, n] = ZS(FC, 0), i = r.activePage?.state;
  Et(() => {
    if (i)
...
const C_ = "academic-metrics/options", Rp = "all-members", N_ = Rp, $C = [
  "members",
...
function zC(e) {
  ...
  const r = () => YC(e), n = xm.map((a) => e.state.subscribe(a, r));
...
function IH({ content: e, block: t }) {
  ...
  return ct(t, "xlsx", {
    ...
    /* @__PURE__ */ ee("div", { className: "cover-meta", role: "list", children: [
      ...
      /* @__PURE__ */ I(oo, { label: "Funding", value: VC(s) }),
...
function xr() {
  if (Dm) return Fs;
  Dm = 1;
  var e = zi(), t = XC(), r = QC(), n = "[object Null]", a = "[object Undefined]", i = e ? e.toStringTag : void 0;
  function o(u) {
...
function eN() {
  if (Hm) return Ks;
  Hm = 1;
  var e = kp(), t = JC(), r = Gr(), n = D_(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, u = Object.prototype, s = o.toString, c = u.hasOwnProperty, l = RegExp(
...
function EN() {
  if (by) return Ac;
  by = 1;
  var e = vN(), t = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, n = e(function(a) {
    var i = [];
...
var xN = SN();
const mn = /* @__PURE__ */ xe(xN);
var wN = kp();
const de = /* @__PURE__ */ xe(wN);
var PN = Gr();
const _a = /* @__PURE__ */ xe(PN);
var so = { exports: {} }, ve = {};
var wy;
function IN() {
  if (wy) return ve;
...
var Iy;
function NN() {
  return Iy || (Iy = 1, process.env.NODE_ENV === "production" ? so.exports = IN() : so.exports = CN()), so.exports;
}
var RN = NN(), Dc, Cy;
function j_() {
  if (Cy) return Dc;
...
var MN = DN();
const Gi = /* @__PURE__ */ xe(MN);
var LN = j_();
const kN = /* @__PURE__ */ xe(LN);
var dt = function(t) {
...
var UN = ["viewBox", "children"], HN = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    Hp.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = qN(o, r, n));
  }), a;
}, WN = ["children"], YN = ["children"];
function Dy(e, t) {
  if (e == null) return {};
  var r = zN(e, t), n, a;
...
}, Ly = null, kc = null, qp = function e(t) {
  if (t === Ly && Array.isArray(kc))
    return kc;
  var r = [];
  return $r.forEach(t, function(n) {
    me(n) || (RN.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), kc = r, Ly = t, r;
};
function jt(e, t) {
  var r = [], n = [];
...
var ky = function(t) {
...
}, GN = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], KN = function(t) {
  return t && t.type && mn(t.type) && GN.indexOf(t.type) >= 0;
}, VN = function(t, r, n, a) {
  var i, o = (i = Lc?.[a]) !== null && i !== void 0 ? i : [];
  return r.startsWith("data-") || !de(t) && (a && o.includes(r) || HN.includes(r)) || n && Hp.includes(r);
}, le = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  return Object.keys(a).forEach(function(o) {
    var u;
    VN((u = a) === null || u === void 0 ? void 0 : u[o], o, r, n) && (i[o] = a[o]);
  }), i;
}, th = function e(t, r) {
  if (t === r)
    return !0;
  ...
  if (me(t) && me(r))
    return !0;
  if (!me(t) && !me(r)) {
    var n = t.props || {}, a = n.children, i = Dy(n, WN), o = r.props || {}, u = o.children, s = Dy(o, YN);
...
function nh(e) {
  var t = e.children, r = e.width, n = e.height, a = e.viewBox, i = e.className, o = e.style, u = e.title, s = e.desc, c = JN(e, ZN), l = a || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
var Oe = /* @__PURE__ */ C.forwardRef(function(e, t) {
  var r = e.children, n = e.className, a = r3(e, t3), i = pe("recharts-layer", n);
  return /* @__PURE__ */ C.createElement("g", ah({
    className: i
  }, le(a, !0), {
    ref: t
  }), r);
}), a3 = process.env.NODE_ENV !== "production", zt = function(t, r) {
...
function f3() {
  if (zy) return Wc;
  zy = 1;
  var e = l3(), t = e("toUpperCase");
  return Wc = t, Wc;
}
var d3 = f3();
const Yu = /* @__PURE__ */ xe(d3);
function Ce(e) {
  return function() {
    return e;
  };
}
const $_ = Math.cos, Lo = Math.sin, Qt = Math.sqrt, ko = Math.PI, zu = 2 * ko, ih = Math.PI, oh = 2 * ih, tn = 1e-6, h3 = oh - tn;
function U_(e) {
  this._ += e[0];
...
class m3 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? U_ : p3(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${l}` : (Math.abs(this._x1 - c) > tn || Math.abs(this._y1 - l) > tn) && this._append`L${c},${l}`, n && (h < 0 && (h = h % oh + oh), h > h3 ? this._append`A${n},${n},0,1,${f},${t - u},${r - s}A${n},${n},0,1,${f},${this._x1 = c},${this._y1 = l}` : h > tn && this._append`A${n},${n},0,${+(h >= ih)},${f},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
}, G_ = Qt(1 / 3), v3 = G_ * 2, E3 = {
  draw(e, t) {
    const r = Qt(t / v3), n = r * G_;
...
}, _3 = 0.8908130915292852, K_ = Lo(ko / 10) / Lo(7 * ko / 10), A3 = Lo(zu / 10) * K_, O3 = -$_(zu / 10) * K_, S3 = {
  draw(e, t) {
    const r = Qt(t * _3), n = A3 * r, a = O3 * r;
    e.moveTo(0, -r), e.lineTo(n, a);
    for (let i = 1; i < 5; ++i) {
      const o = zu * i / 5, u = $_(o), s = Lo(o);
...
}, Pt = -0.5, It = Qt(3) / 2, uh = 1 / Qt(12), w3 = (uh / 2 + 1) * 3, P3 = {
  draw(e, t) {
    const r = Qt(t / w3), n = r / 2, a = r * uh, i = n, o = r * uh + r, u = -i, s = o;
  ...
  lineEnd: function() {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        zc(this, this._t0, Vy(this, this._t0));
        break;
    }
    (this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
  },
    ...
    if (e = +e, t = +t, !(e === this._x1 && t === this._y1)) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          this._point = 3, zc(this, Vy(this, r = Ky(this, e, t)), r);
          break;
        default:
          zc(this, this._t0, r = Ky(this, e, t));
          break;
      }
...
(J_.prototype = Object.create(Fo.prototype)).point = function(e, t) {
...
function H3() {
  var e = Ce([]), t = sh, r = Vn, n = $3;
  function a(i) {
    var o = Array.from(e.apply(this, arguments), U3), u, s = o.length, c = -1, l;
    for (const f of i)
      for (u = 0, ++c; u < s; ++u)
...
var rA = {
  ...
  rA["symbol".concat(Yu(t))] = r;
}, Gp = function(t) {
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, u = o === void 0 ? "area" : o, s = X3(t, z3), c = Zy(Zy({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), l = function() {
    var m = J3(n), v = I3().type(m).size(eR(i, u, n));
    return v();
...
function oR(e, t, r) {
  return t = $o(t), uR(e, nA() ? Reflect.construct(t, r || [], $o(e).constructor) : t.apply(e, r));
}
function uR(e, t) {
...
var Ct = 32, Kp = /* @__PURE__ */ (function(e) {
  function t() {
    return nR(this, t), oR(this, t, arguments);
  }
  return cR(t, e), iR(t, [{
    key: "renderIcon",
    value: (
...
function iA() {
  if (ib) return Zc;
  ib = 1;
  var e = Hu(), t = fR(), r = dR(), n = hR(), a = pR(), i = mR();
  function o(u) {
...
function ER() {
  if (mb) return sl;
  mb = 1;
  var e = zi(), t = gR(), r = Bp(), n = cA(), a = vR(), i = Vp(), o = 1, u = 2, s = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", h = "[object Number]", p = "[object RegExp]", g = "[object Set]", y = "[object String]", m = "[object Symbol]", v = "[object ArrayBuffer]", E = "[object DataView]", _ = e ? e.prototype : void 0, A = _ ? _.valueOf : void 0;
...
function OR() {
  if (Eb) return hl;
  Eb = 1;
  var e = _R(), t = AR(), r = Object.prototype, n = r.propertyIsEnumerable, a = Object.getOwnPropertySymbols, i = a ? function(o) {
...
function Xp() {
  if (Ab) return yl;
  Ab = 1;
  var e = xR(), t = wr(), r = Object.prototype, n = r.hasOwnProperty, a = r.propertyIsEnumerable, i = e(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? e : function(o) {
...
function fA() {
  return Sb || (Sb = 1, (function(e, t) {
    var r = or(), n = wR(), a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, o = i && i.exports === a, u = o ? r.Buffer : void 0, s = u ? u.isBuffer : void 0, c = s || n;
    e.exports = c;
...
function hA() {
  if (Nb) return _l;
  Nb = 1;
  var e = PR(), t = dA(), r = IR(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return _l = a, _l;
}
var Al, Rb;
function CR() {
  if (Rb) return Al;
  Rb = 1;
  var e = SR(), t = Xp(), r = Tt(), n = fA(), a = Qp(), i = hA(), o = Object.prototype, u = o.hasOwnProperty;
  function s(c, l) {
...
function DR() {
  if (kb) return wl;
  kb = 1;
  var e = NR(), t = RR(), r = Object.prototype, n = r.hasOwnProperty;
  function a(i) {
    if (!e(i))
      return t(i);
    var o = [];
...
function LR() {
  if ($b) return Nl;
  $b = 1;
  var e = MR(), t = 1, r = Object.prototype, n = r.hasOwnProperty;
...
function FR() {
  if (Yb) return kl;
  Yb = 1;
  var e = kR(), t = jp(), r = BR(), n = mA(), a = jR(), i = xr(), o = D_(), u = "[object Map]", s = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", h = "[object DataView]", p = o(e), g = o(t), y = o(r), m = o(n), v = o(a), E = i;
...
function $R() {
  if (zb) return Bl;
  zb = 1;
  var e = iA(), t = cA(), r = ER(), n = LR(), a = FR(), i = Tt(), o = fA(), u = hA(), s = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", h = Object.prototype, p = h.hasOwnProperty;
...
function YR() {
  if (eg) return Yl;
  eg = 1;
  var e = k_(), t = Xp(), r = Tt(), n = Qp(), a = Zp(), i = Wu();
  function o(u, s, c) {
    s = e(s, u);
...
function GR() {
  if (rg) return Gl;
  rg = 1;
  var e = Jp(), t = B_(), r = zR(), n = Lp(), a = yA(), i = bA(), o = Wu(), u = 1, s = 2;
  function c(l, f) {
...
function nD() {
  if (mg) return uf;
  mg = 1;
  var e = mA(), t = rD(), r = Vp(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return uf = a, uf;
}
...
function aD() {
  if (yg) return sf;
  yg = 1;
  var e = oA(), t = eD(), r = tD(), n = sA(), a = nD(), i = Vp(), o = 200;
  function u(s, c, l) {
...
function lD(e, t, r) {
  return t = Uo(t), fD(e, EA() ? Reflect.construct(t, r || [], Uo(e).constructor) : t.apply(e, r));
}
function fD(e, t) {
...
var Tg = 1, Hr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = lD(this, t, [].concat(a)), Xu(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
...
function xD() {
  if (Dg) return Tf;
  Dg = 1;
  var e = $p(), t = Up(), r = ur(), n = OA(), a = AD(), i = dA(), o = SD(), u = Aa(), s = Tt();
  function c(l, f, h) {
...
function CD() {
  if (jg) return xf;
  jg = 1;
  var e = ID(), t = SA(), r = Aa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function MD() {
  if (qg) return Nf;
  qg = 1;
  var e = _A(), t = xD(), r = DD(), n = Qu(), a = r(function(i, o) {
    if (i == null)
      return [];
    var u = o.length;
    ...
    if (l && l.length) {
      var R = {
        ...
        var q = Rf({
          ...
          paddingBottom: 4,
          color: F.color || "#000"
        }, u), Y = F.formatter || f || WD, Q = F.value, te = F.name, k = Q, W = te;
        if (Y && k != null && W != null) {
          var z = Y(Q, te, F, $, l);
          if (Array.isArray(z)) {
            var Z = kD(z, 2);
...
var Da = "recharts-tooltip-wrapper", KD = {
  visibility: "hidden"
};
function VD(e) {
...
function t6(e, t, r) {
  return t = Ho(t), r6(e, xA() ? Reflect.construct(t, r || [], Ho(e).constructor) : t.apply(e, r));
}
function r6(e, t) {
...
var Vg = 1, o6 = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    ZD(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = t6(this, t, [].concat(a)), mh(r, "state", {
      dismissed: !1,
  ...
  return a6(t, e), e6(t, [{
    ...
    key: "render",
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, u = a.animationDuration, s = a.animationEasing, c = a.children, l = a.coordinate, f = a.hasPayload, h = a.isAnimationActive, p = a.offset, g = a.position, y = a.reverseDirection, m = a.useTranslate3d, v = a.viewBox, E = a.wrapperStyle, _ = QD({
...
function f6(e, t, r) {
  return t = qo(t), d6(e, PA() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function d6(e, t) {
...
function b6(e, t) {
  return /* @__PURE__ */ C.isValidElement(e) ? /* @__PURE__ */ C.cloneElement(e, t) : typeof e == "function" ? /* @__PURE__ */ C.createElement(e, t) : /* @__PURE__ */ C.createElement(YD, t);
}
var yt = /* @__PURE__ */ (function(e) {
  function t() {
    return s6(this, t), f6(this, t, arguments);
  }
  return p6(t, e), l6(t, [{
    key: "render",
    value: function() {
      ...
      var T = b.length > 0;
      return /* @__PURE__ */ C.createElement(o6, {
        allowEscapeViewBox: o,
        animationDuration: u,
        animationEasing: s,
        isAnimationActive: h,
...
function CA() {
  if (tv) return kf;
  tv = 1;
  var e = E6(), t = Gr(), r = Ta(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, u = parseInt;
  function s(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function T6() {
  if (rv) return Bf;
  rv = 1;
  var e = Gr(), t = g6(), r = CA(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(u, s, c) {
...
function _6() {
  if (nv) return jf;
  nv = 1;
  var e = T6(), t = Gr(), r = "Expected a function";
  function n(a, i, o) {
    var u = !0, s = !0;
...
var Xi = /* @__PURE__ */ NT(function(e, t) {
  ...
  }), P = w6(O, 2), N = P[0], j = P[1], D = ex(function(B, F) {
    j(function($) {
...
var Za = function(t) {
  ...
  try {
    ...
    return Cn.widthCache[a] = s, ++Cn.cacheCount > L6 && (Cn.cacheCount = 0, Cn.widthCache = {}), s;
  } catch {
    return {
      width: 0,
      height: 0
...
function cv(e, t) {
  for (var r = 0; r < t.length; r++) {
    var n = t[r];
    n.enumerable = n.enumerable || !1, n.configurable = !0, "value" in n && (n.writable = !0), Object.defineProperty(e, Y6(n.key), n);
  }
}
function W6(e, t, r) {
...
var lv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, fv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, G6 = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, K6 = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, RA = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, V6 = Object.keys(RA), Bn = "NaN";
function X6(e, t) {
  return e * RA[t];
}
var ho = /* @__PURE__ */ (function() {
  function e(t, r) {
    q6(this, e), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !G6.test(r) && (this.num = NaN, this.unit = ""), V6.includes(r) && (this.num = X6(t, r), this.unit = "px");
  }
  return W6(e, [{
    key: "add",
    value: function(r) {
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = K6.exec(r)) !== null && n !== void 0 ? n : [], i = Wo(a, 3), o = i[1], u = i[2];
...
function DA(e) {
  ...
  for (var t = e; t.includes("*") || t.includes("/"); ) {
    var r, n = (r = lv.exec(t)) !== null && r !== void 0 ? r : [], a = Wo(n, 4), i = a[1], o = a[2], u = a[3], s = ho.parse(i ?? ""), c = ho.parse(u ?? ""), l = o === "*" ? s.multiply(c) : s.divide(c);
    if (l.isNaN())
      return Bn;
    t = t.replace(lv, l.toString());
  }
  for (; t.includes("+") || /.-\d+(?:\.\d+)?/.test(t); ) {
    var f, h = (f = fv.exec(t)) !== null && f !== void 0 ? f : [], p = Wo(h, 4), g = p[1], y = p[2], m = p[3], v = ho.parse(g ?? ""), E = ho.parse(m ?? ""), _ = y === "+" ? v.add(E) : v.subtract(E);
    if (_.isNaN())
      return Bn;
...
function Q6(e) {
  for (var t = e; t.includes("("); ) {
    var r = dv.exec(t), n = Wo(r, 2), a = n[1];
    t = t.replace(dv, DA(a));
  }
  return t;
}
...
function Ff(e) {
  var t = J6(e.slice(5, -1));
  return t === Bn ? "" : t;
}
var eM = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], tM = ["dx", "dy", "angle", "className", "breakAll"];
function gh() {
...
var MA = /[ \f\n\r\t\v\u2028\u2029]+/, LA = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, l = t.scaleToFit, f = l === void 0 ? !1 : l, h = t.textAnchor, p = h === void 0 ? "start" : h, g = t.verticalAnchor, y = g === void 0 ? "end" : g, m = t.fill, v = m === void 0 ? bv : m, E = hv(t, eM), _ = Fr(function() {
    return sM({
      breakAll: E.breakAll,
      children: E.children,
      maxLines: E.maxLines,
  ...
  }, [E.breakAll, E.children, E.maxLines, f, E.style, E.width]), A = E.dx, b = E.dy, T = E.angle, O = E.className, P = E.breakAll, N = hv(E, tM);
  if (!ze(n) || !ze(i))
    return null;
...
function n0(e) {
  let t, r, n;
  e.length !== 2 ? (t = qr, r = (u, s) => qr(e(u), s), n = (u, s) => e(u) - s) : (t = e === qr || e === cM ? e : lM, r = e, n = e);
...
class gv extends Map {
  ...
  set(t, r) {
    return super.set(hM(this, t), r);
  }
  delete(t) {
    return super.delete(pM(this, t));
  }
}
...
function hM({ _intern: e, _key: t }, r) {
  const n = t(r);
...
const bM = Math.sqrt(50), gM = Math.sqrt(10), vM = Math.sqrt(2);
function Yo(e, t, r) {
  const n = (t - e) / Math.max(0, r), a = Math.floor(Math.log10(n)), i = n / Math.pow(10, a), o = i >= bM ? 10 : i >= gM ? 5 : i >= vM ? 2 : 1;
  let u, s, c;
...
function EM(e, t, r) {
  if (e = Float64Array.from(fM(e)), !(!(n = e.length) || isNaN(t = +t))) {
...
var bi = 0.7, zo = 1 / bi, Wn = "\\s*([+-]?\\d+)\\s*", gi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", AM = /^#([0-9a-f]{3,8})$/, OM = new RegExp(`^rgb\\(${Wn},${Wn},${Wn}\\)$`), SM = new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`), xM = new RegExp(`^rgba\\(${Wn},${Wn},${Wn},${gi}\\)$`), wM = new RegExp(`^rgba\\(${rr},${rr},${rr},${gi}\\)$`), PM = new RegExp(`^hsl\\(${gi},${rr},${rr}\\)$`), IM = new RegExp(`^hsla\\(${gi},${rr},${rr},${gi}\\)$`), _v = {
  aliceblue: 15792383,
...
function vi(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = AM.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? Sv(t) : r === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? po(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? po(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = OM.exec(e)) ? new gt(t[1], t[2], t[3], 1) : (t = SM.exec(e)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = xM.exec(e)) ? po(t[1], t[2], t[3], t[4]) : (t = wM.exec(e)) ? po(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = PM.exec(e)) ? Pv(t[1], t[2] / 100, t[3] / 100, 1) : (t = IM.exec(e)) ? Pv(t[1], t[2] / 100, t[3] / 100, t[4]) : _v.hasOwnProperty(e) ? Sv(_v[e]) : e === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function Sv(e) {
...
function Ah(e, t, r, n) {
  return arguments.length === 1 ? RM(e) : new gt(e, t, r, n ?? 1);
}
function gt(e, t, r, n) {
...
i0(Wt, MM, $A(Zi, {
  ...
  clamp() {
    return new Wt(Iv(this.h), mo(this.s), mo(this.l), Go(this.opacity));
  },
  displayable() {
...
function BM(e) {
  return (e = +e) == 1 ? HA : function(t, r) {
    return r - t ? kM(t, r, e) : o0(isNaN(t) ? r : t);
  };
}
function HA(e, t) {
  var r = t - e;
  return r ? LM(e, r) : o0(isNaN(e) ? t : e);
}
...
function YM(e, t) {
  ...
  return r < t.length && (i = t.slice(r), u[o] ? u[o] += i : u[++o] = i), u.length < 2 ? s[0] ? WM(s[0].x) : qM(t) : (t = s.length, function(c) {
...
function Sa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? o0(t) : (r === "number" ? Ko : r === "string" ? (n = vi(t)) ? (t = n, Cv) : YM : t instanceof vi ? Cv : t instanceof Date ? UM : FM(t) ? jM : Array.isArray(t) ? $M : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? HM : Ko)(e, t);
}
function u0(e, t) {
  return e = +e, t = +t, function(r) {
...
function Ju() {
  ...
  function l() {
    ...
    return o !== pt && (o = KM(e[0], e[h - 1])), u = h > 2 ? XM : VM, s = c = null, f;
  }
  function f(h) {
...
function nL(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? Mv : ZM(Lv.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? Mv : JM(Lv.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", u = e.minus === void 0 ? "−" : e.minus + "", s = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f, h) {
    f = Ei(f);
    ...
    function D(R) {
      ...
      if (T === "c")
        ...
        R = +R;
        var Q = R < 0 || 1 / R < 0;
        if (R = isNaN(R) ? s : N(Math.abs(R), A), b && (R = tL(R)), Q && +R == 0 && y !== "+" && (Q = !1), B = (Q ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + B, F = (T === "s" && !isNaN(R) && Qo !== void 0 ? kv[8 + Qo / 3] : "") + F + (Q && y === "(" ? ")" : ""), j) {
          for ($ = -1, q = R.length; ++$ < q; )
...
function aL(e) {
  return yo = nL(e), l0 = yo.format, qA = yo.formatPrefix, yo;
}
function iL(e) {
...
function WA(e, t, r, n) {
  ...
  switch (n = Ei(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = oL(a, o)) && (n.precision = i), qA(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(i = uL(a, Math.max(Math.abs(e), Math.abs(t)))) && (n.precision = i - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
      n.precision == null && !isNaN(i = iL(a)) && (n.precision = i - (n.type === "%") * 2);
      break;
    }
  }
  return l0(n);
...
function fL(e) {
  return e === 10 ? lL : e === Math.E ? Math.exp : (t) => Math.pow(e, t);
}
function dL(e) {
...
function f0(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = dL(n), i = fL(n), r()[0] < 0 ? (a = Fv(a), i = Fv(i), e(sL, cL)) : e(Bv, jv), t;
  }
...
function h0(e) {
  var t = e(pt, pt), r = 1;
  function n() {
    return r === 1 ? e(pt, pt) : r === 0.5 ? e(hL, pL) : e(Hv(r), Hv(1 / r));
  }
...
function VA() {
  ...
  return a.invert = function(i) {
    ...
    return arguments.length ? (e.range((t = Array.from(i, Vo)).map(qv)), a) : t.slice();
...
function XA() {
  ...
  function a() {
    ...
    for (r = new Array(u - 1); ++o < u; ) r[o - 1] = TM(e, o / u);
    return i;
  }
  function i(o) {
...
Jo.range;
const hr = 1e3, Mt = hr * 60, pr = Mt * 60, _r = pr * 24, m0 = _r * 7, Wv = _r * 30, Wf = _r * 365, un = Ke((e) => {
...
const ts = On(0), eu = On(1), bL = On(2), gL = On(3), ta = On(4), vL = On(5), EL = On(6);
ts.range;
eu.range;
bL.range;
gL.range;
...
const [SL, xL] = eO(Or, T0, rs, JA, v0, b0), [wL, PL] = eO(Ar, E0, ts, eo, g0, y0);
function Yf(e) {
  if (0 <= e.y && e.y < 100) {
...
function ka(e) {
  return new RegExp("^(?:" + e.map(RL).join("|") + ")", "i");
}
function Ba(e) {
...
function Ik(e) {
  return Nn = IL(e), iO = Nn.format, Nn.parse, oO = Nn.utcFormat, Nn.utcParse, Nn;
}
function Ck(e) {
  return new Date(e);
}
...
function _0(e, t, r, n, a, i, o, u, s, c) {
  ...
  return l.invert = function(T) {
    ...
    return arguments.length ? h(Array.from(T, Nk)) : h().map(Ck);
  }, l.ticks = function(T) {
    var O = h();
...
function Rk() {
  return Ut.apply(_0(wL, PL, Ar, E0, ts, eo, g0, y0, un, iO).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function Dk() {
  return Ut.apply(_0(SL, xL, Or, T0, rs, es, v0, b0, un, oO).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function ns() {
...
function lO() {
  ...
  return r.domain = function(n) {
    ...
    return Array.from({ length: n + 1 }, (a, i) => EM(e, i / n));
  }, r.copy = function() {
...
function as() {
  ...
  function g(y) {
    return function(m) {
      var v, E, _;
      return arguments.length ? ([v, E, _] = m, c = zM(y, [v, E, _]), p) : [c(0), c(0.5), c(1)];
    };
  }
...
}, x0, Le = !0, Ft = "[DecimalError] ", dn = Ft + "Invalid argument: ", S0 = Ft + "Exponent out of range: ", wa = Math.floor, rn = Math.pow, Gk = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ot, Xe = 1e7, Re = 7, yO = 9007199254740991, ru = wa(yO / Re), ae = {};
...
function EO(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(dn + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, Gk.test(i)) l1(o, i);
    else throw Error(dn + i);
  }
  if (a.prototype = ae, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = EO, a.config = a.set = Kk, e === void 0 && (e = {}), e)
...
var o4 = cs(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), u4 = cs(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), s4 = cs(function(e, t, r) {
  var n = t - +e;
...
const ls = {
  ...
  uninterpolateNumber: u4,
  uninterpolateTruncation: s4
};
function Ih(e) {
  return f4(e) || l4(e) || OO(e) || c4();
}
function c4() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function m4(e, t, r) {
  ...
  var o = Math.floor((t - 1) / 2), u = n4(r4(function(s) {
...
function y4(e) {
  ...
  if (c === l)
    return m4(c, a, i);
  var h = wO(c, l, o, i), p = h.step, g = h.tickMin, y = h.tickMax, m = ls.rangeStep(g, y.add(new Se(0.1).mul(p)), p);
  return r > n ? Ph(m) : m;
}
function b4(e, t) {
  ...
  if (s === c)
    return [s];
  var l = Math.max(t, 2), f = xO(new Se(c).sub(s).div(l - 1), i, 0), h = [].concat(Ih(ls.rangeStep(new Se(s), new Se(c).sub(new Se(0.99).mul(f)), f)), [c]);
  return n > a ? Ph(h) : h;
}
var g4 = AO(y4), v4 = AO(b4), E4 = process.env.NODE_ENV === "production", rd = "Invariant failed";
function vt(e, t) {
  if (E4)
    throw new Error(rd);
...
var T4 = ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"];
function na(e) {
  "@babel/helpers - typeof";
...
function R4(e, t, r) {
  return t = au(t), D4(e, PO() ? Reflect.construct(t, r || [], au(e).constructor) : t.apply(e, r));
}
function D4(e, t) {
...
var fs = /* @__PURE__ */ (function(e) {
  function t() {
    return I4(this, t), R4(this, t, arguments);
  }
  return L4(t, e), N4(t, [{
    key: "render",
    value: function() {
      var n = this.props, a = n.offset, i = n.layout, o = n.width, u = n.dataKey, s = n.data, c = n.dataPointFormatter, l = n.xAxis, f = n.yAxis, h = w4(n, T4), p = le(h, !1);
...
var z4 = function(t) {
  ...
  var o = r.props.children, u = jt(o, fs).filter(function(c) {
    return X4(a, i, c.props.direction);
  });
  if (u && u.length) {
  ...
  }), i = r8[n], o = H3().keys(a).value(function(u, s) {
    return +ut(u, s, 0);
  }).order(sh).offset(i);
  return o(t);
}, a8 = function(t, r, n, a, i, o) {
  if (!t)
    return null;
...
var ou = Math.PI / 180, m8 = function(t) {
  ...
  var n = t.x, a = t.y, i = r.cx, o = r.cy, u = b8({
    x: n,
    y: a
  }, {
    x: i,
  ...
  if (o === 0)
    return !0;
  var l = v8(r), f = l.startAngle, h = l.endAngle, p = u, g;
  if (f <= h) {
    for (; p > h; )
      p -= 360;
    for (; p < f; )
...
var R8 = function(t) {
  ...
  var a = t.position, i = t.viewBox, o = t.offset, u = t.className, s = i, c = s.cx, l = s.cy, f = s.innerRadius, h = s.outerRadius, p = s.startAngle, g = s.endAngle, y = s.clockWise, m = (f + h) / 2, v = D8(p, g), E = v >= 0 ? 1 : -1, _, A;
...
function Qe(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = w8(e, T8), a = We({
    offset: r
...
var WO = function(t) {
  ...
  if (!n)
    return o;
  var u = j8(t.label, r || i);
  return [u].concat(_8(o));
};
Qe.parseViewBox = WO;
...
var q8 = ["valueAccessor"], W8 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function Y8(e) {
  return V8(e) || K8(e) || G8(e) || z8();
}
function z8() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var eB = function(t) {
  return Array.isArray(t.value) ? H8(t.value) : t.value;
};
function Gt(e) {
  var t = e.valueAccessor, r = t === void 0 ? eB : t, n = I1(e, q8), a = n.data, i = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = I1(n, W8);
...
function rB(e, t) {
  ...
  if (!r)
    return a;
  var i = tB(e.label, t);
  return [i].concat(Y8(a));
}
Gt.renderCallByParent = rB;
function Ii(e) {
  "@babel/helpers - typeof";
...
var oB = function(t, r) {
  ...
  var r = t.cx, n = t.cy, a = t.innerRadius, i = t.outerRadius, o = t.startAngle, u = t.endAngle, s = oB(o, u), c = o + s, l = Ne(r, n, i, o), f = Ne(r, n, i, c), h = "M ".concat(l.x, ",").concat(l.y, `
  ...
  var r = N1(N1({}, sB), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < i || l === f)
    return null;
  var p = pe("recharts-sector", h), g = o - i, y = ht(u, g, 0, !0), m;
  return y > 0 && Math.abs(l - f) < 360 ? m = uB({
    cx: n,
    cy: a,
    innerRadius: i,
    outerRadius: o,
...
var M1 = {
  ...
  return (n === "curveMonotone" || n === "curveBump") && r ? M1["".concat(n).concat(r === "vertical" ? "Y" : "X")] : M1[n] || Gu;
}, hB = function(t) {
  var r = t.type, n = r === void 0 ? "linear" : r, a = t.points, i = a === void 0 ? [] : a, o = t.baseLine, u = t.layout, s = t.connectNulls, c = s === void 0 ? !1 : s, l = dB(n, u), f = c ? i.filter(function(y) {
    return vo(y);
  }) : i, h;
  if (Array.isArray(o)) {
...
var B1;
function GO() {
  return B1 || (B1 = 1, process.env.NODE_ENV === "production" ? To.exports = pB() : To.exports = mB()), To.exports;
}
var id, j1;
function yB() {
  if (j1) return id;
...
var ud, $1;
function KO() {
  return $1 || ($1 = 1, ud = Function.call.bind(Object.prototype.hasOwnProperty)), ud;
}
var sd, U1;
function bB() {
  if (U1) return sd;
...
function gB() {
  if (H1) return cd;
  H1 = 1;
  var e = GO(), t = yB(), r = /* @__PURE__ */ P0(), n = /* @__PURE__ */ KO(), a = /* @__PURE__ */ bB(), i = function() {
  };
...
function EB() {
  ...
  if (W1 = 1, process.env.NODE_ENV !== "production") {
    var e = GO(), t = !0;
    Eo.exports = /* @__PURE__ */ gB()(e.isElement, t);
  } else
    Eo.exports = /* @__PURE__ */ vB()();
  return Eo.exports;
}
var TB = /* @__PURE__ */ EB();
const Ae = /* @__PURE__ */ xe(TB), { getOwnPropertyNames: _B, getOwnPropertySymbols: AB } = Object, { hasOwnProperty: OB } = Object.prototype;
function fd(e, t) {
...
function Y1(e) {
  return _B(e).concat(AB(e));
}
const xB = (
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  Object.hasOwn || ((e, t) => OB.call(e, t))
);
function xn(e, t) {
  return e === t || !e && !t && e !== e && t !== t;
}
const wB = "__v", PB = "__o", IB = "_owner", { getOwnPropertyDescriptor: z1, keys: G1 } = Object;
function CB(e, t) {
...
function VO(e, t, r, n) {
  return (n === IB || n === PB || n === wB) && (e.$$typeof || t.$$typeof) ? !0 : xB(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
const UB = "[object ArrayBuffer]", HB = "[object Arguments]", qB = "[object Boolean]", WB = "[object DataView]", YB = "[object Date]", zB = "[object Error]", GB = "[object Map]", KB = "[object Number]", VB = "[object Object]", XB = "[object RegExp]", QB = "[object Set]", ZB = "[object String]", JB = {
  "[object Int8Array]": !0,
  "[object Uint8Array]": !0,
...
}, e5 = "[object URL]", t5 = Object.prototype.toString;
function r5({ areArrayBuffersEqual: e, areArraysEqual: t, areDataViewsEqual: r, areDatesEqual: n, areErrorsEqual: a, areFunctionsEqual: i, areMapsEqual: o, areNumbersEqual: u, areObjectsEqual: s, arePrimitiveWrappersEqual: c, areRegExpsEqual: l, areSetsEqual: f, areTypedArraysEqual: h, areUrlsEqual: p, unknownTagComparators: g }) {
...
function n5({ circular: e, createCustomConfig: t, strict: r }) {
  let n = {
    areArrayBuffersEqual: CB,
    areArraysEqual: r ? $a : NB,
    areDataViewsEqual: RB,
    areDatesEqual: DB,
    areErrorsEqual: MB,
    areFunctionsEqual: LB,
    areMapsEqual: r ? fd(K1, $a) : K1,
    areNumbersEqual: kB,
    areObjectsEqual: r ? $a : BB,
    arePrimitiveWrappersEqual: jB,
    areRegExpsEqual: FB,
    areSetsEqual: r ? fd(V1, $a) : V1,
...
function i5({ circular: e, comparator: t, createState: r, equals: n, strict: a }) {
  if (r)
    return function(u, s) {
...
function Xr(e = {}) {
  const { circular: t = !1, createInternalComparator: r, createState: n, strict: a = !1 } = e, i = n5(e), o = r5(i), u = r ? r(o) : a5(o);
  return i5({ circular: t, comparator: o, createState: n, equals: u, strict: a });
}
function u5(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(i)) {
        if (!i.length)
          return;
        var o = i, u = s5(o), s = u[0], c = u.slice(1);
        if (typeof s == "number") {
          X1(a.bind(null, c), s);
          return;
        }
...
var y5 = function(t, r) {
  ...
  return t.map(function(a) {
    return "".concat(g5(a), " ").concat(r, "ms ").concat(n);
  }).join(",");
}, v5 = process.env.NODE_ENV !== "production", cu = function(t, r, n, a, i, o, u, s) {
  if (v5 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
      console.warn("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
    else {
...
var lu = 1e-4, ZO = function(t, r) {
  ...
  return function(n) {
    var a = ZO(t, r), i = [].concat(O5(a.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return JO(i, n);
  };
  ...
  var f = tE(a, o), h = tE(i, u), p = P5(a, o), g = function(v) {
...
var fu = function(t, r, n) {
  ...
  var a = ti(function(i, o) {
    if (qh(o)) {
      var u = t(o.from, o.to, o.velocity), s = k5(u, 2), c = s[0], l = s[1];
      return tt(tt({}, o), {}, {
        from: c,
        velocity: l
      });
...
const U5 = (function(e, t, r, n, a) {
  var i = y5(e, t), o = i.reduce(function(m, v) {
    ...
    c || (c = v);
    var E = v - c, _ = E / r.dt;
    u = $5(r, u, _), a(tt(tt(tt({}, e), t), h())), c = v, p() || (s = requestAnimationFrame(f));
  }, y = function(v) {
    l || (l = v);
    var E = (v - l) / n, _ = ti(function(b, T) {
      return fu.apply(void 0, nE(T).concat([r(E)]));
    }, o);
    if (a(tt(tt(tt({}, e), t), _)), E < 1)
      s = requestAnimationFrame(f);
    else {
      var A = ti(function(b, T) {
        return fu.apply(void 0, nE(T).concat([r(1)]));
      }, o);
      a(tt(tt(tt({}, e), t), A));
    }
  };
...
var H5 = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function q5(e, t) {
  if (e == null) return {};
  var r = W5(e, t), n, a;
  if (Object.getOwnPropertySymbols) {
  ...
  return Q5(r, [{
    ...
    value: function(a) {
      ...
      if (u) {
        ...
        if (!(o5(a.to, l) && a.canBegin && a.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(a) {
      var i = this, o = a.from, u = a.to, s = a.duration, c = a.easing, l = a.begin, f = a.onAnimationEnd, h = a.onAnimationStart, p = U5(o, u, C5(c), s, this.changeStyle), g = function() {
        i.stopJSAnimation = p();
      };
    ...
    value: function(a) {
      var i = this, o = a.steps, u = a.begin, s = a.onAnimationStart, c = o[0], l = c.style, f = c.duration, h = f === void 0 ? 0 : f, p = function(y, m, v) {
        ...
        return [].concat(dd(y), [D, E, O]).filter(b5);
      };
    ...
    value: function() {
      ...
      var s = q5(a, H5), c = $r.count(i), l = this.state.style;
      if (typeof i == "function")
        return i(l);
      if (!u || c === 0 || o <= 0)
        return i;
...
var cE = function(t, r, n, a, i) {
  ...
  var r = sE(sE({}, fj), t), n = ii(), a = ft(-1), i = rj(a, 2), o = i[0], u = i[1];
  Et(function() {
...
}, dj = ["points", "className", "baseLinePoints", "connectNulls"];
function jn() {
...
var fE = function(t) {
  ...
  var r = t.points, n = t.className, a = t.baseLinePoints, i = t.connectNulls, o = hj(t, dj);
  if (!r || !r.length)
    return null;
  var u = pe("recharts-polygon", n);
  if (a && a.length) {
    var s = o.stroke && o.stroke !== "none", c = Ej(r, a, i);
...
var _j = ["x", "y", "top", "left", "width", "height", "className"];
function Xh() {
...
var Ij = function(t, r, n, a, i, o) {
  return "M".concat(t, ",").concat(i, "v").concat(a, "M").concat(o, ",").concat(r, "h").concat(n);
}, Cj = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.top, u = o === void 0 ? 0 : o, s = t.left, c = s === void 0 ? 0 : s, l = t.width, f = l === void 0 ? 0 : l, h = t.height, p = h === void 0 ? 0 : h, g = t.className, y = wj(t, _j), m = Aj({
    x: n,
    y: i,
    top: u,
    left: c,
...
var Bj = ["cx", "cy", "angle", "ticks", "axisLine"], jj = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function ia(e) {
  "@babel/helpers - typeof";
...
function Hj(e, t, r) {
  return t = pu(t), qj(e, rS() ? Reflect.construct(t, r || [], pu(e).constructor) : t.apply(e, r));
}
function qj(e, t) {
...
var hs = /* @__PURE__ */ (function(e) {
  ...
  return Yj(t, e), Uj(t, [{
    ...
    key: "getViewBox",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = Dj(u, function(l) {
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = n.axisLine, c = yE(n, Bj), l = u.reduce(function(g, y) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.angle, s = a.tickFormatter, c = a.stroke, l = yE(a, jj), f = this.getTickTextAnchor(), h = le(l, !1), p = le(o, !1), g = i.map(function(y, m) {
...
function Vj(e, t, r) {
  return t = mu(t), Xj(e, aS() ? Reflect.construct(t, r || [], mu(e).constructor) : t.apply(e, r));
}
function Xj(e, t) {
...
var eF = Math.PI / 180, EE = 1e-5, ms = /* @__PURE__ */ (function(e) {
  function t() {
  ...
  return Zj(t, e), Kj(t, [{
    ...
    key: "getTickTextAnchor",
    value: function(n) {
      var a = this.props.orientation, i = Math.cos(-n.coordinate * eF), o;
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Tj, nn({
        className: "recharts-polar-angle-axis-line"
      }, c, {
        points: f
      }));
...
function rF() {
  if (_E) return yd;
  _E = 1;
  var e = xr(), t = tF(), r = wr(), n = "[object Object]", a = Function.prototype, i = Object.prototype, o = a.toString, u = i.hasOwnProperty, s = o.call(Object);
  function c(l) {
    if (!r(l) || e(l) != n)
      return !1;
    var f = t(l);
...
var wE = function(t, r, n, a, i) {
  ...
  var r = xE(xE({}, yF), t), n = ii(), a = ft(-1), i = sF(a, 2), o = i[0], u = i[1];
  Et(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
}, gF = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function ki(e) {
  "@babel/helpers - typeof";
...
function IE(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ C.createElement(bF, r);
    case "sector":
...
function oS(e) {
  var t = e.option, r = e.shapeType, n = e.propTransformer, a = n === void 0 ? OF : n, i = e.activeClassName, o = i === void 0 ? "recharts-active-shape" : i, u = e.isActive, s = vF(e, gF), c;
  if (/* @__PURE__ */ Lt(t))
    c = /* @__PURE__ */ Ue(t, bu(bu({}, s), xF(t)));
  else if (de(t))
    c = t(s);
  else if (aF(t) && !uF(t)) {
    var l = a(t, s);
...
function CF(e, t) {
  var r;
  return ys(e, t) ? r = wF : bs(e, t) ? r = PF : Bi(e, t) && (r = IF), r;
}
function NF(e, t) {
  var r;
...
function DF(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, a = NF(r, t), i = RF(r, t), o = n.filter(function(s, c) {
...
function kF(e, t, r) {
  return t = gu(t), BF(e, uS() ? Reflect.construct(t, r || [], gu(e).constructor) : t.apply(e, r));
}
function BF(e, t) {
...
var Ir = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return MF(this, t), n = kF(this, t, [r]), Rt(n, "pieRef", null), Rt(n, "sectorRefs", []), Rt(n, "id", Ki("recharts-pie-")), Rt(n, "handleAnimationEnd", function() {
...
var GF = ["Webkit", "Moz", "O", "ms"], KF = function(t, r) {
  var n = t.replace(/(\w)/, function(i) {
    return i.toUpperCase();
  }), a = GF.reduce(function(i, o) {
...
function QF(e, t, r) {
  return t = Tu(t), ZF(e, fS() ? Reflect.construct(t, r || [], Tu(e).constructor) : t.apply(e, r));
}
function ZF(e, t) {
...
var r9 = function(t) {
  ...
  function t(r) {
    var n;
    return VF(this, t), n = QF(this, t, [r]), _t(n, "handleDrag", function(a) {
  ...
  return e9(t, e), XF(t, [{
    ...
    value: function() {
      ...
      if (!a || !a.length || !J(u) || !J(s) || !J(c) || !J(l) || c <= 0 || l <= 0)
        return null;
      var _ = pe("recharts-brush", i), A = C.Children.count(o) === 1, b = KF("userSelect", "none");
      return /* @__PURE__ */ C.createElement(Oe, {
        className: _,
...
function y9(e, t, r) {
  return t = b9(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function b9(e) {
  var t = g9(e, "string");
...
function T9(e, t) {
  var r = e.x, n = e.y, a = v9(e, m9), i = "".concat(r), o = parseInt(i, 10), u = "".concat(n), s = parseInt(u, 10), c = "".concat(t.height || a.height), l = parseInt(c, 10), f = "".concat(t.width || a.width), h = parseInt(f, 10);
...
function P9(e, t, r) {
  return t = Au(t), I9(e, mS() ? Reflect.construct(t, r || [], Au(e).constructor) : t.apply(e, r));
}
function I9(e, t) {
...
var sr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = P9(this, t, [].concat(a)), jr(r, "state", {
      isAnimationFinished: !1
  ...
  return N9(t, e), w9(t, [{
    ...
    value: function() {
      ...
      return i.map(function(c, l) {
        ...
        return /* @__PURE__ */ C.createElement(VE, _u({
...
jr(sr, "getComposedData", function(e) {
  var t = e.props, r = e.item, n = e.barPosition, a = e.bandSize, i = e.xAxis, o = e.yAxis, u = e.xAxisTicks, s = e.yAxisTicks, c = e.stackedData, l = e.dataStartIndex, f = e.displayedData, h = e.offset, p = Z4(n, r);
  if (!p)
    return null;
  var g = t.layout, y = r.type.defaultProps, m = y !== void 0 ? $e($e({}, y), r.props) : r.props, v = m.dataKey, E = m.children, _ = m.minPointSize, A = g === "horizontal" ? o : i, b = c ? A.scale.domain() : null, T = i8({
    numericAxis: A
  }), O = jt(E, Zu), P = f.map(function(N, j) {
    var D, R, B, F, $, q;
    c ? D = J4(c[l + j], b) : (D = ut(N, v), Array.isArray(D) || (D = [T, D]));
    var Y = _9(_, pS.defaultProps.minPointSize)(D[1], j);
    if (g === "horizontal") {
...
var k9 = function(t, r, n, a, i) {
  ...
  return l.reduce(function(p, g) {
    ...
    if (y.type === "number" && (y.padding === "gap" || y.padding === "no-gap")) {
      var R = v[1] - v[0], B = 1 / 0, F = y.categoricalDomain.sort($N);
...
var F9 = function(t) {
  var r = t.width, n = t.height, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i = j9(a), o = i * Math.PI / 180, u = Math.atan(n / r), s = o > u && o < Math.PI - u ? n / Math.sin(o) : r / Math.cos(o);
  return Math.abs(s);
}, Cd, eT;
function $9() {
  if (eT) return Cd;
...
var W9 = q9();
const Y9 = /* @__PURE__ */ xe(W9);
var z9 = M_();
const G9 = /* @__PURE__ */ xe(z9);
var K9 = G9(function(e) {
  return {
    x: e.left,
    y: e.top,
    width: e.width,
...
var R0 = /* @__PURE__ */ Vt(void 0), D0 = /* @__PURE__ */ Vt(void 0), ES = /* @__PURE__ */ Vt(void 0), TS = /* @__PURE__ */ Vt({}), _S = /* @__PURE__ */ Vt(void 0), AS = /* @__PURE__ */ Vt(0), OS = /* @__PURE__ */ Vt(0), aT = function(t) {
  var r = t.state, n = r.xAxisMap, a = r.yAxisMap, i = r.offset, o = t.clipPathId, u = t.children, s = t.width, c = t.height, l = K9(i);
...
var xS = function(t) {
  ...
  var n = r[t];
  return n == null && (process.env.NODE_ENV !== "production" ? vt(!1, 'Could not find xAxis by id "'.concat(t, '" [').concat(Ou(t), "]. ").concat(SS(r))) : vt()), n;
}, X9 = function() {
  var t = $t(R0);
  return kr(t);
}, Q9 = function() {
  var t = $t(D0), r = Y9(t, function(n) {
  ...
  r == null && (process.env.NODE_ENV !== "production" ? vt(!1, "Could not find Recharts context; are you sure this is rendered inside a Recharts wrapper component?") : vt());
  var n = r[t];
  return n == null && (process.env.NODE_ENV !== "production" ? vt(!1, 'Could not find yAxis by id "'.concat(t, '" [').concat(Ou(t), "]. ").concat(SS(r))) : vt()), n;
}, Z9 = function() {
  var t = $t(ES);
  return t;
}, J9 = function() {
...
function n$(e, t, r) {
  return t = Su(t), a$(e, PS() ? Reflect.construct(t, r || [], Su(e).constructor) : t.apply(e, r));
}
function a$(e, t) {
...
var h$ = function(t, r) {
  ...
  if (a) {
    ...
    return nr(c, "discard") && o9(b, function(T) {
...
function m$(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = V9(), l = xS(a), f = wS(i), h = Z9();
  if (!c || !h)
    return null;
  ...
  var p = N0({
    x: l.scale,
    y: f.scale
  }), g = ze(t), y = ze(r), m = n && n.length === 2, v = p$(p, g, y, m, h, e.position, l.orientation, f.orientation, e);
  if (!v)
    return null;
  var E = s$(v, 2), _ = E[0], A = _.x, b = _.y, T = E[1], O = T.x, P = T.y, N = nr(e, "hidden") ? "url(#".concat(c, ")") : void 0, j = oT(oT({
    clipPath: N
  }, le(e, !0)), {}, {
    x1: A,
    y1: b,
  ...
  }, h$(o, j), Qe.renderCallByParent(e, B9({
    x1: A,
    y1: b,
    x2: O,
    y2: P
...
var B0 = /* @__PURE__ */ (function(e) {
  function t() {
    return e$(this, t), n$(this, t, arguments);
  }
  return o$(t, e), r$(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(m$, this.props);
    }
  }]);
})(C.Component);
...
function v$(e, t, r) {
  return t = xu(t), E$(e, CS() ? Reflect.construct(t, r || [], xu(e).constructor) : t.apply(e, r));
}
function E$(e, t) {
...
var O$ = function(t) {
  ...
  function t() {
    return y$(this, t), v$(this, t, arguments);
  }
  return _$(t, e), g$(t, [{
    key: "render",
    value: function() {
...
function P$(e, t, r) {
  return t = wu(t), I$(e, RS() ? Reflect.construct(t, r || [], wu(e).constructor) : t.apply(e, r));
}
function I$(e, t) {
...
var D$ = function(t, r, n, a, i) {
  ...
  function t() {
    return S$(this, t), P$(this, t, arguments);
  }
  return N$(t, e), w$(t, [{
    key: "render",
    value: function() {
...
function j0(e, t, r) {
  ...
  if (!a || !a.length || !n)
    return [];
  if (J(s) || Oa.isSsr)
    return k$(a, typeof s == "number" && J(s) ? s : 0);
  ...
  }, m = a.length >= 2 ? dt(a[1].coordinate - a[0].coordinate) : 1, v = L$(i, m, p);
  return s === "equidistantPreserveStart" ? B$(m, v, y, a, o) : (s === "preserveStart" || s === "preserveStartEnd" ? h = H$(m, v, y, a, o, s === "preserveStartEnd") : h = U$(m, v, y, a, o), h.filter(function(E) {
    return E.isShow;
  }));
}
var q$ = ["viewBox"], W$ = ["viewBox"], Y$ = ["ticks"];
function ma(e) {
  "@babel/helpers - typeof";
...
function V$(e, t, r) {
  return t = Iu(t), X$(e, LS() ? Reflect.construct(t, r || [], Iu(e).constructor) : t.apply(e, r));
}
function X$(e, t) {
...
var Pa = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return G$(this, t), n = V$(this, t, [r]), n.state = {
      fontSize: "",
      letterSpacing: ""
    }, n;
  }
  return Z$(t, e), K$(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = Md(n, q$), u = this.props, s = u.viewBox, c = Md(u, W$);
    ...
    value: function() {
      ...
      if (l)
        return null;
      var f = this.props, h = f.ticks, p = Md(f, Y$), g = h;
...
var eU = ["x1", "y1", "x2", "y2", "key"], tU = ["offset"];
function vn(e) {
  "@babel/helpers - typeof";
...
function rU(e, t, r) {
  return t = nU(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function nU(e) {
  var t = aU(e, "string");
...
function BS(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, u = t.key, s = yT(t, eU), c = le(s, !1);
    c.offset;
    var l = yT(c, tU);
...
function to(e) {
  var t, r, n, a, i, o, u = M0(), s = L0(), c = J9(), l = ot(ot({}, e), {}, {
  ...
  }), f = l.x, h = l.y, p = l.width, g = l.height, y = l.syncWithTicks, m = l.horizontalValues, v = l.verticalValues, E = X9(), _ = Q9();
  if (!J(p) || p <= 0 || !J(g) || g <= 0 || !J(f) || f !== +f || !J(h) || h !== +h)
    return null;
  var A = l.verticalCoordinatesGenerator || fU, b = l.horizontalCoordinatesGenerator || dU, T = l.horizontalPoints, O = l.verticalPoints;
  if ((!T || !T.length) && de(b)) {
  ...
  return /* @__PURE__ */ C.createElement("g", {
    ...
    height: l.height,
    ry: l.ry
  }), /* @__PURE__ */ C.createElement(uU, sn({}, l, {
    offset: c,
    horizontalPoints: T,
    xAxis: E,
    yAxis: _
...
function mU(e, t, r) {
  return t && pU(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function yU(e, t, r) {
  return t = Cu(t), bU(e, jS() ? Reflect.construct(t, r || [], Cu(e).constructor) : t.apply(e, r));
}
function bU(e, t) {
...
var wn = /* @__PURE__ */ (function(e) {
  function t() {
    return hU(this, t), yU(this, t, arguments);
  }
  return vU(t, e), mU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(TU, this.props);
    }
  }]);
})(Wr.Component);
...
function OU(e, t, r) {
  return t && AU(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function SU(e, t, r) {
  return t = Nu(t), xU(e, US() ? Reflect.construct(t, r || [], Nu(e).constructor) : t.apply(e, r));
}
function xU(e, t) {
...
var CU = function(t) {
  ...
  function t() {
    return _U(this, t), SU(this, t, arguments);
  }
  return PU(t, e), OU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(CU, this.props);
    }
  }]);
})(Wr.Component);
...
var mp = function(t, r, n, a, i) {
  var o = jt(t, B0), u = jt(t, Es), s = [].concat(bT(o), bT(u)), c = jt(t, _s), l = "".concat(a, "Id"), f = a[0], h = r;
...
var kU = LU();
const BU = /* @__PURE__ */ xe(kU);
var kd = new BU(), Bd = "recharts.syncMouseEvents";
function Ui(e) {
  "@babel/helpers - typeof";
...
var HU = /* @__PURE__ */ (function() {
  function e() {
    jU(this, e), jd(this, "activeIndex", 0), jd(this, "coordinateList", []), jd(this, "layout", "horizontal");
  }
  return $U(e, [{
    key: "setDetails",
    value: function(r) {
...
function zU(e, t, r) {
  return t = GU(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function GU(e) {
  var t = KU(e, "string");
  return Hi(t) == "symbol" ? t : t + "";
...
var XU = ["item"], QU = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function ga(e) {
  "@babel/helpers - typeof";
...
function i7(e, t, r) {
  return t = Ru(t), o7(e, zS() ? Reflect.construct(t, r || [], Ru(e).constructor) : t.apply(e, r));
}
function o7(e, t) {
...
var gp = function(t, r, n, a) {
  ...
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = m7(i, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, l = z4(o, u, c, s);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, h = gp(t, r, l, f), p = y7(n, u, l, i);
    return {
  ...
  return n.reduce(function(g, y) {
    ...
    qU(v.domain, A, E) && (R = Dh(v.domain, null, A), p && (E === "number" || T !== "auto") && (F = ei(j, _, "category")));
    var $ = XS(E);
    if (!R || R.length === 0) {
      ...
      if (_) {
        if (R = ei(j, _, E), E === "category" && p) {
          var Q = FN(R);
          b && Q ? (B = R, R = vu(0, D)) : b || (R = T1(Y, R, y).reduce(function(z, Z) {
          ...
          var te = Q4(j, a.filter(function(z) {
      ...
      } else p ? R = vu(0, D) : u && u[N] && u[N].hasStack && E === "number" ? R = h === "expand" ? [0, 1] : FO(u[N].stackGroups, s, c) : R = DO(j, a.filter(function(z) {
  ...
  return n.reduce(function(m, v) {
    ...
    if (!m[_]) {
      y++;
      var b;
      return g ? b = vu(0, p) : u && u[_] && u[_].hasStack ? (b = FO(u[_].stackGroups, s, c), b = mp(f, b, _, i)) : (b = Dh(A, DO(h, n.filter(function(T) {
        ...
        hide: !0,
        orientation: xt(h7, "".concat(i, ".").concat(y % 2), null),
        domain: b,
        originalDomain: A,
        isCategorical: g,
        layout: l
  ...
  p && (v.bottom += p.props.height || ca.defaultProps.height), g && r && (v = V4(v, a, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(v, E) {
    var _ = E.graphicalItems, A = E.stackGroups, b = E.offset, T = E.updateId, O = E.dataStartIndex, P = E.dataEndIndex, N = v.barSize, j = v.layout, D = v.barGap, R = v.barCategoryGap, B = v.maxBarSize, F = ST(j), $ = F.numericAxisName, q = F.cateAxisName, Y = T7(_), Q = [];
    return _.forEach(function(te, k) {
      ...
      }, fe), G = ce[q], re = ce["".concat(q, "Ticks")], ie = A && A[oe] && A[oe].hasStack && o8(te, A[oe].stackGroups), M = vr(te.type).indexOf("Bar") >= 0, ye = iu(G, re), X = [], Pe = Y && G4({
        barSize: N,
        stackGroups: A,
        totalSize: A7(ce, q)
      });
    ...
    if (!ky({
      ...
      return null;
    var O = _.children, P = _.layout, N = _.stackOffset, j = _.data, D = _.reverseStackOrder, R = ST(P), B = R.numericAxisName, F = R.cateAxisName, $ = jt(O, n), q = a8(j, $, "".concat(B, "Id"), "".concat(F, "Id"), N, D), Y = s.reduce(function(z, Z) {
      var ne = "".concat(Z.axisType, "Map");
      return H(H({}, z), {}, se({}, ne, v7(_, H(H({}, Z), {}, {
        graphicalItems: $,
    ...
    var te = Y["".concat(F, "Map")], k = E7(te), W = h(_, H(H({}, Y), {}, {
      dataStartIndex: A,
      dataEndIndex: b,
      updateId: T,
      graphicalItems: $,
    ...
    function v(E) {
      var _, A, b;
      return r7(this, v), b = i7(this, v, [E]), se(b, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(b, "accessibilityManager", new HU()), se(b, "handleLegendBBoxUpdate", function(T) {
        if (T) {
        ...
        var O = XN(T), P = xt(b.props, "".concat(O));
        if (O && de(P)) {
          var N, j;
        ...
        return /* @__PURE__ */ C.createElement(VU, {
          key: Q,
          activeCoordinate: j,
          activePayload: D,
    ...
    return s7(v, m), a7(v, [{
      ...
      value: function(_) {
        if (!this.container)
          return null;
        var A = this.container, b = A.getBoundingClientRect(), T = j6(b), O = {
      ...
      value: function() {
        ...
        if (!ky(this))
          return null;
        var A = this.props, b = A.children, T = A.className, O = A.width, P = A.height, N = A.style, j = A.compact, D = A.title, R = A.desc, B = TT(A, QU), F = le(B, !1);
        if (j)
...
const S7 = "funding", x7 = ["Source", "Grants", "Total (GBP)"], w7 = [32, 10, 18], P7 = ["text", "number", "currency"], zn = new Intl.NumberFormat("en-GB", {
  style: "currency",
  currency: "GBP",
  maximumFractionDigits: 0
});
function CH({ content: e, block: t }) {
  const r = _n(S7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Funding received", o = C7(n), u = o.reduce((c, l) => c + l.total, 0);
  ct(
    t,
    "xlsx",
    r && o.length > 0 ? {
...
const N7 = "members", Fd = ["Name", "Rank", "Department", "Tenured", "Start year"], R7 = [28, 14, 18, 10, 12], D7 = ["text", "text", "text", "text", "number"];
function NH({ content: e, block: t }) {
  const r = _n(N7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Members", o = [...n].sort((s, c) => {
  ...
  return ct(
    ...
    r ? /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ ee(Ea, { widths: [32, 16, 22, 12, 18], borderColor: "cbd5e1", children: [
        /* @__PURE__ */ I(rt, { header: !0, children: Fd.map((s) => /* @__PURE__ */ I(he, { children: s }, s)) }),
    ...
    n.length === 0 ? /* @__PURE__ */ I("p", { className: "members-empty", children: "No members match the selected population." }) : /* @__PURE__ */ ee("table", { className: "members-table", children: [
      /* @__PURE__ */ I("thead", { children: /* @__PURE__ */ I("tr", { children: Fd.map((s) => /* @__PURE__ */ I("th", { children: s }, s)) }) }),
...
const L7 = "publications-by-journal", k7 = 10, B7 = ["Venue", "Count"], j7 = [48, 10], F7 = ["text", "number"];
function RH({ content: e, block: t }) {
  const r = _n(L7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by journal", u = U7(n, k7, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ I($7, { counts: u })
  ] }) : null;
}
function $7({ counts: e }) {
  const [t, r] = ft(!1);
...
const H7 = "publications-by-type", xT = [
  "#1e40af",
  // primary
  "#be123c",
  // accent
  ...
  "#64748b"
  // slate (fallback)
], q7 = ["Publication type", "Count"], W7 = [24, 10], Y7 = ["text", "number"];
function DH({ content: e, block: t }) {
  const r = _n(H7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by type", u = G7(n, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No publications for the selected population." }) : /* @__PURE__ */ I(z7, { counts: u })
  ] }) : null;
}
function z7({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(O7, { children: [
    /* @__PURE__ */ I(
      Ir,
      {
        data: n,
        ...
        children: n.map((a, i) => /* @__PURE__ */ I(Zu, { fill: xT[i % xT.length] }, i))
      }
    ),
    /* @__PURE__ */ I(
      yt,
...
const K7 = "publications-by-year", V7 = ["Year", "Count", "Cumulative"], X7 = [10, 10, 12], Q7 = ["number", "number", "number"];
function MH({ content: e, block: t }) {
  const r = _n(K7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by year", { series: u, total: s } = J7(n, i);
  return ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ I(Z7, { series: u })
  ] }) : null;
}
function Z7({ series: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(Os, { data: n, margin: { top: 16, right: 16, bottom: 16, left: 0 }, children: [
    /* @__PURE__ */ I(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
...
function rH(e) {
  return Array.isArray(e) ? e.map((t) => {
    const r = t._author ? eH(t._author) : void 0;
    return tH(t, { defaultAuthor: r });
  }).filter(Boolean) : [];
}
const nH = "publications-list", wT = {
...
function LH({ content: e, block: t }) {
  const r = _n(nH), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications", u = [...M7(n, i)].sort((y, m) => {
    const v = Number(y.year) || 0;
    return (Number(m.year) || 0) - v;
  }), s = rH(u), c = s.map((y) => y.id).join("|"), [l, f] = ft({ loading: !0, entries: [] });
  Et(() => {
    let y = !1;
    if (!r || s.length === 0) {
      f({ loading: !1, entries: [] });
    ...
    return aH(i.citationStyle).then(({ formatAll: m, style: v }) => {
      if (!y)
        try {
...
const iH = "supervisions", PT = ["#1e40af", "#0f766e", "#ea580c", "#9333ea", "#be123c", "#0ea5e9"];
function kH({ content: e, block: t }) {
  const r = _n(iH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Supervisions", { levels: o, rows: u, grandTotal: s } = uH(n), c = ["Member", ...o.map(Ep), "Total"], l = u.map((E) => [
    E.member,
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ I("p", { className: "chart-empty", children: "No supervisions recorded for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ I(oH, { rows: u, levels: o })
    ] })
  ] }) : null;
}
function oH({ rows: e, levels: t }) {
  const [r, n] = ft(!1);
  if (Et(() => {
    n(!0);
  }, []), !r)
    return /* @__PURE__ */ I("div", { className: "chart-container chart-container-placeholder" });
  const a = e.map((i) => {
    const o = { name: sH(i.member) };
    for (const u of t) o[Ep(u)] = i.counts[u] || 0;
    return o;
  });
  return /* @__PURE__ */ I("div", { className: "chart-container", children: /* @__PURE__ */ I(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(Os, { data: a, margin: { top: 16, right: 24, bottom: 16, left: 0 }, children: [
    /* @__PURE__ */ I(to, { strokeDasharray: "3 3", stroke: "var(--border)" }),
...
const lH = "members";
function fH() {
  const e = jC(lH), [, t] = Dp(), [r, n] = Mp(), [a, i] = ft(() => CT(r, e));
  if (Et(() => {
    i(CT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
function dH({ field: e, def: t, value: r, onChange: n }) {
  const a = t?.label || e;
  switch (t?.type) {
    case "enum":
      ...
      /* @__PURE__ */ ee("label", { className: "report-options-field", children: [
        ...
        /* @__PURE__ */ I(
          "select",
          {
            ...
            onChange: s,
            className: "report-options-input",
            children: qC.map((c) => /* @__PURE__ */ I("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] })
    ] }),
...
function mH() {
  ...
  return /* @__PURE__ */ ee("fieldset", { className: "section-toggles", children: [
    ...
    /* @__PURE__ */ I("div", { className: "section-toggles-list", children: $C.map((n) => /* @__PURE__ */ ee("label", { className: "section-toggles-item", children: [
      /* @__PURE__ */ I(
        "input",
        {
          type: "checkbox",
...
function TH({ body: e, page: t }) {
  ...
  return Et(() => zC(t), [t]), /* @__PURE__ */ ee(ZT, { basePath: r.basePath, children: [
    ...
    /* @__PURE__ */ I(EH, { title: n, filename: a })
  ] });
}
const _H = { ...zd, layouts: { MetricsLayout: TH } }, AH = {}, OH = {}, BH = { meta: AH, capabilities: _H, layoutMeta: OH };
export {
  IH as C,
  gr as D,
  CH as F,
...
//# sourceMappingURL=_entry.generated-B0r9xWYA.js.map
