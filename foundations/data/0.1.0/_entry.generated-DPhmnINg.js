...
import { getUniweb as Tp, applyBasePath as ax, deriveCacheKey as ix } from "@uniweb/core";
...
function qT(e) {
  return e >= 64976 && e <= 65007 || sx.has(e);
}
var U;
(function(e) {
...
class dx {
  constructor(t) {
    this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = fx, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (cx(r))
        return this.pos++, this._addGap(), lx(t, r);
...
const hx = /* @__PURE__ */ new Uint16Array(
  // prettier-ignore
...
function mx(e) {
  var t;
  return e >= 55296 && e <= 57343 || e > 1114111 ? 65533 : (t = px.get(e)) !== null && t !== void 0 ? t : e;
}
var Ze;
(function(e) {
...
class Ex {
  ...
  stateNumericStart(t, r) {
    return r >= t.length ? -1 : (t.charCodeAt(r) | yx) === Ze.LOWER_X ? (this.state = Ve.NumericHex, this.consumed += 1, this.stateNumericHex(t, r + 1)) : (this.state = Ve.NumericDecimal, this.stateNumericDecimal(t, r));
  }
  ...
  emitNumericEntity(t, r) {
    ...
    if (t === Ze.SEMI)
      ...
      return 0;
    return this.emitCodePoint(mx(this.result), this.consumed), this.errors && (t !== Ze.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(t, r) {
    ...
    for (; r < t.length; r++, this.excess++) {
      ...
      if (this.treeIndex = Tx(n, a, this.treeIndex + Math.max(1, i), o), this.treeIndex < 0)
        return this.result === 0 || // If we are parsing an attribute
        this.decodeMode === dr.Attribute && // We shouldn't have consumed any characters after the entity,
        (i === 0 || // And there should be no invalid characters.
        vx(o)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function Mu(e) {
  var t;
  return (t = _x.get(e)) !== null && t !== void 0 ? t : d.UNKNOWN;
}
const V = d, Ax = {
...
class wx {
  constructor(t, r) {
    this.options = t, this.handler = r, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = x.DATA, this.returnState = x.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new dx(r), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new Ex(hx, (n, a) => {
...
const zT = /* @__PURE__ */ new Set([d.DD, d.DT, d.LI, d.OPTGROUP, d.OPTION, d.P, d.RB, d.RP, d.RT, d.RTC]), z0 = /* @__PURE__ */ new Set([
  ...
  d.TEMPLATE,
  d.TH
]), Px = /* @__PURE__ */ new Set([...Io, d.OL, d.UL]), Ix = /* @__PURE__ */ new Set([...Io, d.BUTTON]), G0 = /* @__PURE__ */ new Set([d.ANNOTATION_XML, d.MI, d.MN, d.MO, d.MS, d.MTEXT]), K0 = /* @__PURE__ */ new Set([d.DESC, d.FOREIGN_OBJECT, d.TITLE]), Cx = /* @__PURE__ */ new Set([d.TR, d.TEMPLATE, d.HTML]), Nx = /* @__PURE__ */ new Set([d.TBODY, d.TFOOT, d.THEAD, d.TEMPLATE, d.HTML]), Rx = /* @__PURE__ */ new Set([d.TABLE, d.TEMPLATE, d.HTML]), Dx = /* @__PURE__ */ new Set([d.TD, d.TH]);
class Mx {
  ...
  hasInButtonScope(t) {
    return this.hasInDynamicScope(t, Ix);
  }
...
const Dr = {
...
}, GT = "html", kx = "about:legacy-compat", Bx = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", KT = [
  ...
  "html"
]), VT = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], $x = [
  ...VT,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function Ux(e) {
  return e.name === GT && e.publicId === null && (e.systemId === null || e.systemId === kx);
}
function Hx(e) {
  if (e.name !== GT)
    return Nt.QUIRKS;
  const { systemId: t } = e;
  if (t && t.toLowerCase() === Bx)
    return Nt.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (r = r.toLowerCase(), Fx.has(r))
      return Nt.QUIRKS;
    let n = t === null ? jx : KT;
    if (X0(r, n))
      return Nt.QUIRKS;
    if (n = t === null ? VT : $x, X0(r, n))
...
const Q0 = {
...
}, qx = "definitionurl", Wx = "definitionURL", Yx = new Map([
  "attributeName",
  "attributeType",
  "baseFrequency",
  "baseProfile",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((e) => [e.toLowerCase(), e])), zx = /* @__PURE__ */ new Map([
  ...
  "radialGradient",
  "textPath"
].map((e) => [e.toLowerCase(), e])), Kx = /* @__PURE__ */ new Set([
  d.B,
  d.BIG,
  d.BLOCKQUOTE,
  d.BODY,
...
function Vx(e) {
  const t = e.tagID;
  return t === d.FONT && e.attrs.some(({ name: n }) => n === ln.COLOR || n === ln.SIZE || n === ln.FACE) || Kx.has(t);
}
function XT(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === qx) {
      e.attrs[t].name = Wx;
      break;
    }
}
...
function Jx(e, t, r, n) {
  return (!n || n === K.HTML) && Zx(e, t, r) || (!n || n === K.MATHML) && Qx(e, t);
}
const e2 = "hidden", t2 = 8, r2 = 3;
var w;
(function(e) {
...
class a2 {
  constructor(t, r, n = null, a = null) {
    this.fragmentContext = n, this.scriptHandler = a, this.currentToken = null, this.stopped = !1, this.insertionMode = w.INITIAL, this.originalInsertionMode = w.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...Z0,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = r ?? this.treeAdapter.createDocument(), this.tokenizer = new wx(this.options, this), this.activeFormattingElements = new Lx(this.treeAdapter), this.fragmentContextID = n ? Mu(this.treeAdapter.getTagName(n)) : d.UNKNOWN, this._setContextModes(n ?? this.document, this.fragmentContextID), this.openElements = new Mx(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, r) {
    const n = new this(r);
  ...
  _err(t, r, n) {
    ...
    if (!this.onParseError)
      return;
    const i = (a = t.location) !== null && a !== void 0 ? a : n2, o = {
      code: r,
   ...
   */
  _processStartTag(t) {
    this.shouldProcessStartTagTokenInForeignContent(t) ? Lw(this, t) : this._startTagOutsideForeignContent(t);
  }
  /** @protected */
  ...
  /** @internal */
  onEndTag(t) {
    this.skipNextNewLine = !1, this.currentToken = t, this.currentNotInHTML ? kw(this, t) : this._endTagOutsideForeignContent(t);
  }
  /** @protected */
...
function u2(e, t, r) {
  ...
  for (let i = 0, o = a; o !== r; i++, o = a) {
    ...
    const u = e.activeFormattingElements.getElementEntry(o), s = u && i >= r2;
    !u || s ? (s && e.activeFormattingElements.removeEntry(u), e.openElements.remove(o)) : (o = s2(e, u), n === t && (e.activeFormattingElements.bookmark = u), e.treeAdapter.detachNode(n), e.treeAdapter.appendChild(o, n), n = o);
  }
  return n;
}
function s2(e, t) {
...
function Ap(e, t) {
  for (let r = 0; r < t2; r++) {
    ...
    const i = u2(e, a, n.element), o = e.openElements.getCommonAncestor(n.element);
    e.treeAdapter.detachNode(i), o && c2(e, o, i), l2(e, a, n);
  }
}
function Wd(e, t) {
...
function h2(e, t) {
  ...
  const r = t.forceQuirks ? Nt.QUIRKS : Hx(t);
  Ux(t) || e._err(t, U.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, r), e.insertionMode = w.BEFORE_HTML;
}
function Na(e, t) {
...
function r_(e) {
  ...
  return t != null && t.toLowerCase() === e2;
}
function j2(e, t) {
...
function Lw(e, t) {
  if (Vx(t))
    ...
    n === K.MATHML ? XT(t) : n === K.SVG && (Xx(t), QT(t)), _p(t), t.selfClosing ? e._appendElement(t, n) : e._insertElement(t, n), t.ackSelfClosing = !0;
  }
}
function kw(e, t) {
...
function Bw(e, t, r) {
  ...
  const n = a2.getFragmentParser(e, r);
  return n.tokenizer.write(t, !0), n.getFragment();
}
const jw = () => ({}), Zr = () => !0, Nr = (e) => {
  const t = parseInt(e, 10);
  return Number.isFinite(t) ? t : e;
}, Fw = (e) => typeof e != "string" ? e : e.split(",").map((t) => t.trim()).filter(Boolean).map((t) => parseInt(t, 10)).filter((t) => Number.isFinite(t)), $w = {
  "data-underline": { path: ["underline"], transform: jw },
...
const zw = {
  docx: { load: () => import("./docx-DvnFcJRh.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-CpvKGN2B.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-BfSOu2Sk.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-7N-AtZ9L.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-5la2ecdQ.js"), consumes: "html", ir: !1 }
};
function xp(e) {
  const t = zw[e];
  return t ? {
...
function Kw(e, t) {
  ...
  return r.ir ? Vw(n, e) : r.consumes === "html" ? Xw(n, e) : Qw(n);
}
function Vw(e, t) {
...
async function nm(e, t, r = {}) {
  const { basePath: n, theme: a, adapterOptions: i = {} } = r, o = Jw(e, t, { basePath: n, theme: a });
  return Gw(t, o, i);
}
async function tP(e, t = {}) {
  ...
  const g = p.via ?? a, y = p.getOptions ? await p.getOptions(n, { format: a, rootPath: o, loadAsset: f, ...l }) : {}, m = {
    ...
    ...y.adapterOptions,
    ...u
  }, E = aP(n, o), v = globalThis.uniweb?.childBlockRenderer;
...
function wp({
  ...
  const y = jT(), m = si(a, y), E = ox(o, y), v = h ?? p, T = { "data-type": "text" };
  return t && (T["data-bold"] = "true"), r && (T["data-italics"] = "true"), n && (T["data-underline"] = "true"), m && (T["data-color"] = m), i != null && (T["data-size"] = i), E && (T["data-font"] = E), u && (T["data-smallcaps"] = "true"), s && (T["data-allcaps"] = "true"), c && (T["data-strike"] = "true"), l && (T["data-subscript"] = "true"), f && (T["data-superscript"] = "true"), v && (T["data-style"] = v), /* @__PURE__ */ P("span", { ...T, ...g, children: uP(e) });
}
function sP(e) {
...
function lP({ part: e }) {
  const t = e.href || "", { anchor: r } = sP(t);
  return /* @__PURE__ */ P("a", { ...r !== null ? { "data-type": "internalHyperlink", "data-anchor": r } : { "data-type": "externalHyperlink", "data-link": t }, href: t, children: cP(e).map((a, i) => /* @__PURE__ */ P(
    wp,
    {
      style: "Hyperlink",
      bold: a.bold,
...
function kt({
  ...
  const u = dP({ tabStops: r, indent: n, role: a });
  if (t) {
    const s = oP(t);
    return /* @__PURE__ */ P(e, { "data-type": "paragraph", ...u, ...o, children: s.map((c, l) => c.type === "link" ? /* @__PURE__ */ P(lP, { part: c }, l) : c.type === "math" ? /* @__PURE__ */ P(
      fP,
      {
        latex: c.latex,
        display: c.display,
...
function vP(e, t, { locale: r = !0 } = {}) {
  ...
  let n = e;
  return (e.startsWith("page:") || e.startsWith("topic:")) && (n = t.makeHref ? t.makeHref(e) : e), bP.test(n) || r && n.startsWith("/") && !mP(n) && (n = gP(n, t)), n;
}
function EP(e, t) {
  return !e || typeof e != "string" || !t ? e : ax(vP(e, t), t.basePath || "");
}
function TP(e, t) {
...
function y_(e) {
  const t = Tp()?.activeWebsite ?? null, r = e && t ? ix(e) : null, n = r ? t.dataStore.get(r) : null, [a, i] = ft(
    () => n ? uo(n.data) : r ? om() : im()
  );
  return Et(() => {
    if (!r || !t) {
...
function h7(e, t = {}) {
  return {
    adapterOptions: {
      ...ex(e, t),
      paragraphStyles: t.paragraphStyles ?? f7,
...
const b7 = "members";
function g7() {
  const e = AP(b7), [, t] = Ip(), [r, n] = Cp(), [a, i] = ft(() => MT(r, e));
  if (Et(() => {
    i(MT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
const I7 = { layouts: { MetricsLayout: P7 } }, C7 = {}, N7 = {}, W7 = { meta: C7, capabilities: I7, layoutMeta: N7 };
export {
  k7 as C,
  yr as D,
  B7 as F,
...
//# sourceMappingURL=_entry.generated-DPhmnINg.js.map
