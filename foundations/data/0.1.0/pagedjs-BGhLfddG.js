import { n as m, M as f } from "./math-css-DA-qfWJB.js";
async function v(e, t = {}) {
  const { mode: r = "html", meta: o = {}, stylesheet: n, polyfillUrl: i, ...a } = t, d = (e && e.sections || []).join(`
`), g = { ...e?.metadata || {}, ...o }, c = u({
    body: d,
    meta: g,
    stylesheet: n,
...
function u({ body: e = "", meta: t = {}, stylesheet: r, polyfillUrl: o } = {}) {
  e = m(e).html;
  const n = t.language ?? "en", i = t.title ?? "Book", a = `${f}
${r || j}`, p = o || $;
  return `<!doctype html>
<html lang="${s(n)}">
  <head>
...
${t.map(
    ([o, n]) => `      <span data-field="${s(o)}">${l(String(n))}</span>`
  ).join(`
`)}
    </div>
` : "";
...
const $ = "https://unpkg.com/pagedjs@0.4.3/dist/paged.polyfill.js", j = `
...
`;
export {
  $ as DEFAULT_POLYFILL_URL,
  j as DEFAULT_STYLESHEET,
  v as compilePagedjs,
  u as emitDocument
};
//# sourceMappingURL=pagedjs-BGhLfddG.js.map
