...
const lC = {
  docx: { load: () => import("./docx-BVahYetv.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-CvT724Hv.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-Dw4HwgQL.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-cgYcDype.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-CM7zgy1W.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = lC[e];
  return t ? {
...
function ln(e, t) {
  const { website: r } = Fu(), [, n] = ZS($C, 0), i = r.activePage?.state;
  Et(() => {
    if (i)
...
const I_ = "academic-metrics/options", Rp = "all-members", C_ = Rp, UC = [
  "members",
...
function GC(e) {
  ...
  const r = () => zC(e), n = Sm.map((a) => e.state.subscribe(a, r));
...
function C7({ content: e, block: t }) {
  ...
  return ct(t, "xlsx", {
    ...
    /* @__PURE__ */ ee("div", { className: "cover-meta", role: "list", children: [
      ...
      /* @__PURE__ */ P(oo, { label: "Funding", value: XC(s) }),
...
function tN() {
  if (Um) return Ks;
  Um = 1;
  var e = kp(), t = eN(), r = Gr(), n = R_(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, u = Object.prototype, s = o.toString, c = u.hasOwnProperty, l = RegExp(
...
var Py;
function RN() {
  return Py || (Py = 1, process.env.NODE_ENV === "production" ? so.exports = CN() : so.exports = NN()), so.exports;
}
var DN = RN(), Dc, Iy;
function B_() {
  if (Iy) return Dc;
...
var Ly = function(t) {
  ...
  if (me(t) && me(r))
    return !0;
  if (!me(t) && !me(r)) {
    var n = t.props || {}, a = n.children, i = Ry(n, YN), o = r.props || {}, u = o.children, s = Ry(o, zN);
...
var h3 = d3();
const Yu = /* @__PURE__ */ xe(h3);
function Ce(e) {
  return function() {
    return e;
  };
}
const F_ = Math.cos, Lo = Math.sin, Qt = Math.sqrt, ko = Math.PI, zu = 2 * ko, ih = Math.PI, oh = 2 * ih, tn = 1e-6, p3 = oh - tn;
function $_(e) {
  this._ += e[0];
...
class y3 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? $_ : m3(t);
  }
  moveTo(t, r) {
...
}, z_ = Qt(1 / 3), E3 = z_ * 2, T3 = {
  draw(e, t) {
    const r = Qt(t / E3), n = r * z_;
...
}, A3 = 0.8908130915292852, G_ = Lo(ko / 10) / Lo(7 * ko / 10), O3 = Lo(zu / 10) * G_, S3 = -F_(zu / 10) * G_, x3 = {
  draw(e, t) {
...
var tA = {
  ...
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, u = o === void 0 ? "area" : o, s = Q3(t, G3), c = Qy(Qy({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), l = function() {
...
function uR(e, t, r) {
  return t = $o(t), sR(e, rA() ? Reflect.construct(t, r || [], $o(e).constructor) : t.apply(e, r));
}
function sR(e, t) {
...
function aA() {
  if (ab) return Zc;
  ab = 1;
  var e = Hu(), t = dR(), r = hR(), n = pR(), a = mR(), i = yR();
  function o(u) {
...
function TR() {
  if (pb) return sl;
  pb = 1;
  var e = zi(), t = vR(), r = Bp(), n = sA(), a = ER(), i = Vp(), o = 1, u = 2, s = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", h = "[object Number]", p = "[object RegExp]", g = "[object Set]", y = "[object String]", m = "[object Symbol]", v = "[object ArrayBuffer]", E = "[object DataView]", _ = e ? e.prototype : void 0, A = _ ? _.valueOf : void 0;
...
function dA() {
  if (Cb) return _l;
  Cb = 1;
  var e = IR(), t = fA(), r = CR(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return _l = a, _l;
}
var Al, Nb;
function NR() {
  if (Nb) return Al;
  Nb = 1;
  var e = xR(), t = Xp(), r = Tt(), n = lA(), a = Qp(), i = dA(), o = Object.prototype, u = o.hasOwnProperty;
  function s(c, l) {
...
function $R() {
  if (Wb) return kl;
  Wb = 1;
  var e = BR(), t = jp(), r = jR(), n = pA(), a = FR(), i = xr(), o = R_(), u = "[object Map]", s = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", h = "[object DataView]", p = o(e), g = o(t), y = o(r), m = o(n), v = o(a), E = i;
...
function UR() {
  if (Yb) return Bl;
  Yb = 1;
  var e = aA(), t = sA(), r = TR(), n = kR(), a = $R(), i = Tt(), o = lA(), u = dA(), s = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", h = Object.prototype, p = h.hasOwnProperty;
...
function KR() {
  if (tg) return Gl;
  tg = 1;
  var e = Jp(), t = k_(), r = GR(), n = Lp(), a = mA(), i = yA(), o = Wu(), u = 1, s = 2;
  function c(l, f) {
...
function aD() {
  if (pg) return uf;
  pg = 1;
  var e = pA(), t = nD(), r = Vp(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return uf = a, uf;
}
...
function iD() {
  if (mg) return sf;
  mg = 1;
  var e = iA(), t = tD(), r = rD(), n = uA(), a = aD(), i = Vp(), o = 200;
  function u(s, c, l) {
...
function fD(e, t, r) {
  return t = Uo(t), dD(e, vA() ? Reflect.construct(t, r || [], Uo(e).constructor) : t.apply(e, r));
}
function dD(e, t) {
...
var Eg = 1, Hr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = fD(this, t, [].concat(a)), Xu(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
...
function wD() {
  if (Rg) return Tf;
  Rg = 1;
  var e = $p(), t = Up(), r = ur(), n = AA(), a = OD(), i = fA(), o = xD(), u = Aa(), s = Tt();
  function c(l, f, h) {
...
function ND() {
  if (Bg) return xf;
  Bg = 1;
  var e = CD(), t = OA(), r = Aa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function LD() {
  if (Hg) return Nf;
  Hg = 1;
  var e = TA(), t = wD(), r = MD(), n = Qu(), a = r(function(i, o) {
    if (i == null)
      return [];
    var u = o.length;
...
function r6(e, t, r) {
  return t = Ho(t), n6(e, SA() ? Reflect.construct(t, r || [], Ho(e).constructor) : t.apply(e, r));
}
function n6(e, t) {
...
var Kg = 1, u6 = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    JD(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
...
function d6(e, t, r) {
  return t = qo(t), h6(e, wA() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function h6(e, t) {
...
function _6() {
  if (tv) return Bf;
  tv = 1;
  var e = Gr(), t = v6(), r = IA(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(u, s, c) {
...
var Xi = /* @__PURE__ */ CT(function(e, t) {
  ...
  }), I = P6(O, 2), N = I[0], j = I[1], D = ex(function(B, F) {
    j(function($) {
...
var cv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, lv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, K6 = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, V6 = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, NA = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
...
var ho = /* @__PURE__ */ (function() {
  ...
  return Y6(e, [{
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = V6.exec(r)) !== null && n !== void 0 ? n : [], i = Wo(a, 3), o = i[1], u = i[2];
...
var DA = /[ \f\n\r\t\v\u2028\u2029]+/, MA = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, l = t.scaleToFit, f = l === void 0 ? !1 : l, h = t.textAnchor, p = h === void 0 ? "start" : h, g = t.verticalAnchor, y = g === void 0 ? "end" : g, m = t.fill, v = m === void 0 ? yv : m, E = dv(t, tM), _ = Fr(function() {
    return cM({
      breakAll: E.breakAll,
      children: E.children,
      maxLines: E.maxLines,
  ...
  }, [E.breakAll, E.children, E.maxLines, f, E.style, E.width]), A = E.dx, b = E.dy, T = E.angle, O = E.className, I = E.breakAll, N = dv(E, rM);
  if (!ze(n) || !ze(i))
    return null;
...
var bi = 0.7, zo = 1 / bi, Wn = "\\s*([+-]?\\d+)\\s*", gi = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", OM = /^#([0-9a-f]{3,8})$/, SM = new RegExp(`^rgb\\(${Wn},${Wn},${Wn}\\)$`), xM = new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`), wM = new RegExp(`^rgba\\(${Wn},${Wn},${Wn},${gi}\\)$`), PM = new RegExp(`^rgba\\(${rr},${rr},${rr},${gi}\\)$`), IM = new RegExp(`^hsl\\(${gi},${rr},${rr}\\)$`), CM = new RegExp(`^hsla\\(${gi},${rr},${rr},${gi}\\)$`), Tv = {
  aliceblue: 15792383,
...
function vi(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = OM.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? Ov(t) : r === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? po(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? po(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = SM.exec(e)) ? new gt(t[1], t[2], t[3], 1) : (t = xM.exec(e)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = wM.exec(e)) ? po(t[1], t[2], t[3], t[4]) : (t = PM.exec(e)) ? po(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = IM.exec(e)) ? wv(t[1], t[2] / 100, t[3] / 100, 1) : (t = CM.exec(e)) ? wv(t[1], t[2] / 100, t[3] / 100, t[4]) : Tv.hasOwnProperty(e) ? Ov(Tv[e]) : e === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function Ov(e) {
...
function Sa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? o0(t) : (r === "number" ? Ko : r === "string" ? (n = vi(t)) ? (t = n, Iv) : zM : t instanceof vi ? Iv : t instanceof Date ? HM : $M(t) ? FM : Array.isArray(t) ? UM : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? qM : Ko)(e, t);
}
function u0(e, t) {
  return e = +e, t = +t, function(r) {
...
function aL(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? Dv : JM(Mv.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? Dv : eL(Mv.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", u = e.minus === void 0 ? "−" : e.minus + "", s = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f, h) {
    f = Ei(f);
    ...
    function D(R) {
      ...
      if (T === "c")
        ...
        R = +R;
        var Q = R < 0 || 1 / R < 0;
        if (R = isNaN(R) ? s : N(Math.abs(R), A), b && (R = rL(R)), Q && +R == 0 && y !== "+" && (Q = !1), B = (Q ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + B, F = (T === "s" && !isNaN(R) && Qo !== void 0 ? Lv[8 + Qo / 3] : "") + F + (Q && y === "(" ? ")" : ""), j) {
          for ($ = -1, q = R.length; ++$ < q; )
...
function iL(e) {
  return yo = aL(e), l0 = yo.format, HA = yo.formatPrefix, yo;
}
function oL(e) {
...
function qA(e, t, r, n) {
  ...
  switch (n = Ei(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = uL(a, o)) && (n.precision = i), HA(n, o);
    }
    case "":
    case "e":
    case "g":
...
function f0(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = hL(n), i = dL(n), r()[0] < 0 ? (a = jv(a), i = jv(i), e(cL, lL)) : e(kv, Bv), t;
  }
...
function h0(e) {
  var t = e(pt, pt), r = 1;
  function n() {
    return r === 1 ? e(pt, pt) : r === 0.5 ? e(pL, mL) : e(Uv(r), Uv(1 / r));
  }
...
const ts = On(0), eu = On(1), gL = On(2), vL = On(3), ta = On(4), EL = On(5), TL = On(6);
ts.range;
eu.range;
gL.range;
vL.range;
...
const rs = Sn(0), tu = Sn(1), _L = Sn(2), AL = Sn(3), ra = Sn(4), OL = Sn(5), SL = Sn(6);
rs.range;
tu.range;
_L.range;
AL.range;
...
const [xL, wL] = JA(Or, T0, rs, ZA, v0, b0), [PL, IL] = JA(Ar, E0, ts, eo, g0, y0);
function Yf(e) {
  if (0 <= e.y && e.y < 100) {
...
function Ck(e) {
  return Nn = CL(e), aO = Nn.format, Nn.parse, iO = Nn.utcFormat, Nn.utcParse, Nn;
}
function Nk(e) {
  return new Date(e);
}
...
function Dk() {
  return Ut.apply(_0(PL, IL, Ar, E0, ts, eo, g0, y0, un, aO).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function Mk() {
  return Ut.apply(_0(xL, wL, Or, T0, rs, es, v0, b0, un, iO).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function ns() {
...
}, x0, Le = !0, Ft = "[DecimalError] ", dn = Ft + "Invalid argument: ", S0 = Ft + "Exponent out of range: ", wa = Math.floor, rn = Math.pow, Kk = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ot, Xe = 1e7, Re = 7, mO = 9007199254740991, ru = wa(mO / Re), ae = {};
...
function vO(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(dn + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, Kk.test(i)) c1(o, i);
    else throw Error(dn + i);
  }
  if (a.prototype = ae, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = vO, a.config = a.set = Vk, e === void 0 && (e = {}), e)
...
var u4 = cs(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), s4 = cs(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), c4 = cs(function(e, t, r) {
  var n = t - +e;
...
var v4 = _O(b4), E4 = _O(g4), T4 = process.env.NODE_ENV === "production", rd = "Invariant failed";
function vt(e, t) {
  if (T4)
    throw new Error(rd);
...
function D4(e, t, r) {
  return t = au(t), M4(e, wO() ? Reflect.construct(t, r || [], au(e).constructor) : t.apply(e, r));
}
function M4(e, t) {
...
var ou = Math.PI / 180, y8 = function(t) {
...
function Gt(e) {
  var t = e.valueAccessor, r = t === void 0 ? tB : t, n = P1(e, W8), a = n.data, i = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = P1(n, Y8);
...
var uB = function(t, r) {
  ...
  var r = C1(C1({}, cB), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < i || l === f)
    return null;
...
var k1;
function zO() {
  return k1 || (k1 = 1, process.env.NODE_ENV === "production" ? To.exports = mB() : To.exports = yB()), To.exports;
}
var id, B1;
function bB() {
  if (B1) return id;
...
function vB() {
  if (U1) return cd;
  U1 = 1;
  var e = zO(), t = bB(), r = /* @__PURE__ */ P0(), n = /* @__PURE__ */ GO(), a = /* @__PURE__ */ gB(), i = function() {
  };
...
const PB = "__v", IB = "__o", CB = "_owner", { getOwnPropertyDescriptor: Y1, keys: z1 } = Object;
function NB(e, t) {
...
}, E5 = process.env.NODE_ENV !== "production", cu = function(t, r, n, a, i, o, u, s) {
...
var lu = 1e-4, QO = function(t, r) {
  ...
  return function(n) {
    var a = QO(t, r), i = [].concat(S5(a.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return ZO(i, n);
  };
  ...
  var f = eE(a, o), h = eE(i, u), p = I5(a, o), g = function(v) {
  ...
  return Z5(r, [{
    ...
    value: function(a) {
      var i = this, o = a.steps, u = a.begin, s = a.onAnimationStart, c = o[0], l = c.style, f = c.duration, h = f === void 0 ? 0 : f, p = function(y, m, v) {
        ...
        return [].concat(dd(y), [D, E, O]).filter(g5);
      };
...
var sE = function(t, r, n, a, i) {
  ...
  var r = uE(uE({}, dj), t), n = ii(), a = ft(-1), i = nj(a, 2), o = i[0], u = i[1];
  Et(function() {
...
function qj(e, t, r) {
  return t = pu(t), Wj(e, tS() ? Reflect.construct(t, r || [], pu(e).constructor) : t.apply(e, r));
}
function Wj(e, t) {
...
var hs = /* @__PURE__ */ (function(e) {
  ...
  return zj(t, e), Hj(t, [{
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = n.axisLine, c = mE(n, jj), l = u.reduce(function(g, y) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.angle, s = a.tickFormatter, c = a.stroke, l = mE(a, Fj), f = this.getTickTextAnchor(), h = le(l, !1), p = le(o, !1), g = i.map(function(y, m) {
...
var tF = Math.PI / 180, vE = 1e-5, ms = /* @__PURE__ */ (function(e) {
  function t() {
...
var xE = function(t, r, n, a, i) {
  ...
  var r = SE(SE({}, bF), t), n = ii(), a = ft(-1), i = cF(a, 2), o = i[0], u = i[1];
  Et(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
function NF(e, t) {
  var r;
  return ys(e, t) ? r = PF : bs(e, t) ? r = IF : Bi(e, t) && (r = CF), r;
}
function RF(e, t) {
  var r;
...
function BF(e, t, r) {
  return t = gu(t), jF(e, oS() ? Reflect.construct(t, r || [], gu(e).constructor) : t.apply(e, r));
}
function jF(e, t) {
...
function ZF(e, t, r) {
  return t = Tu(t), JF(e, lS() ? Reflect.construct(t, r || [], Tu(e).constructor) : t.apply(e, r));
}
function JF(e, t) {
...
function I9(e, t, r) {
  return t = Au(t), C9(e, pS() ? Reflect.construct(t, r || [], Au(e).constructor) : t.apply(e, r));
}
function C9(e, t) {
...
jr(sr, "getComposedData", function(e) {
  ...
  var g = t.layout, y = r.type.defaultProps, m = y !== void 0 ? $e($e({}, y), r.props) : r.props, v = m.dataKey, E = m.children, _ = m.minPointSize, A = g === "horizontal" ? o : i, b = c ? A.scale.domain() : null, T = o8({
    ...
    var Y = A9(_, hS.defaultProps.minPointSize)(D[1], j);
    if (g === "horizontal") {
...
function a$(e, t, r) {
  return t = Su(t), i$(e, wS() ? Reflect.construct(t, r || [], Su(e).constructor) : t.apply(e, r));
}
function i$(e, t) {
...
function y$(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = X9(), l = SS(a), f = xS(i), h = J9();
  if (!c || !h)
    return null;
  ...
  if (!v)
    return null;
  var E = c$(v, 2), _ = E[0], A = _.x, b = _.y, T = E[1], O = T.x, I = T.y, N = nr(e, "hidden") ? "url(#".concat(c, ")") : void 0, j = iT(iT({
    clipPath: N
  }, le(e, !0)), {}, {
    x1: A,
    y1: b,
...
function E$(e, t, r) {
  return t = xu(t), T$(e, IS() ? Reflect.construct(t, r || [], xu(e).constructor) : t.apply(e, r));
}
function T$(e, t) {
...
function I$(e, t, r) {
  return t = wu(t), C$(e, NS() ? Reflect.construct(t, r || [], wu(e).constructor) : t.apply(e, r));
}
function C$(e, t) {
...
var Pa = /* @__PURE__ */ (function(e) {
  ...
  return J$(t, e), V$(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = Md(n, W$), u = this.props, s = u.viewBox, c = Md(u, Y$);
    ...
    value: function() {
      ...
      if (l)
        return null;
      var f = this.props, h = f.ticks, p = Md(f, z$), g = h;
...
function kS(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, u = t.key, s = mT(t, tU), c = le(s, !1);
    c.offset;
    var l = mT(c, rU);
...
function bU(e, t, r) {
  return t = Cu(t), gU(e, BS() ? Reflect.construct(t, r || [], Cu(e).constructor) : t.apply(e, r));
}
function gU(e, t) {
...
function xU(e, t, r) {
  return t = Nu(t), wU(e, $S() ? Reflect.construct(t, r || [], Nu(e).constructor) : t.apply(e, r));
}
function wU(e, t) {
...
var kd = new jU(), Bd = "recharts.syncMouseEvents";
function Ui(e) {
  "@babel/helpers - typeof";
...
var qU = /* @__PURE__ */ (function() {
  function e() {
    FU(this, e), jd(this, "activeIndex", 0), jd(this, "coordinateList", []), jd(this, "layout", "horizontal");
  }
  return UU(e, [{
    key: "setDetails",
    value: function(r) {
...
function oH(e, t, r) {
  return t = Ru(t), uH(e, YS() ? Reflect.construct(t, r || [], Ru(e).constructor) : t.apply(e, r));
}
function uH(e, t) {
...
var gp = function(t, r, n, a) {
  ...
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = yH(i, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, l = G4(o, u, c, s);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, h = gp(t, r, l, f), p = bH(n, u, l, i);
    return {
  ...
  return n.reduce(function(m, v) {
    ...
    if (!m[_]) {
      ...
      return g ? b = vu(0, p) : u && u[_] && u[_].hasStack ? (b = jO(u[_].stackGroups, s, c), b = mp(f, b, _, i)) : (b = Dh(A, RO(h, n.filter(function(T) {
        ...
        hide: !0,
        orientation: xt(pH, "".concat(i, ".").concat(y % 2), null),
        domain: b,
        originalDomain: A,
        isCategorical: g,
        layout: l
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(v, E) {
    var _ = E.graphicalItems, A = E.stackGroups, b = E.offset, T = E.updateId, O = E.dataStartIndex, I = E.dataEndIndex, N = v.barSize, j = v.layout, D = v.barGap, R = v.barCategoryGap, B = v.maxBarSize, F = OT(j), $ = F.numericAxisName, q = F.cateAxisName, Y = _H(_), Q = [];
    return _.forEach(function(te, k) {
      ...
      }, fe), G = ce[q], re = ce["".concat(q, "Ticks")], ie = A && A[oe] && A[oe].hasStack && u8(te, A[oe].stackGroups), M = vr(te.type).indexOf("Bar") >= 0, ye = iu(G, re), X = [], Pe = Y && K4({
        barSize: N,
        stackGroups: A,
        totalSize: OH(ce, q)
      });
    ...
    if (!Ly({
      ...
      return null;
    var O = _.children, I = _.layout, N = _.stackOffset, j = _.data, D = _.reverseStackOrder, R = OT(I), B = R.numericAxisName, F = R.cateAxisName, $ = jt(O, n), q = i8(j, $, "".concat(B, "Id"), "".concat(F, "Id"), N, D), Y = s.reduce(function(z, Z) {
      var ne = "".concat(Z.axisType, "Map");
      return H(H({}, z), {}, se({}, ne, EH(_, H(H({}, Z), {}, {
        graphicalItems: $,
    ...
    var te = Y["".concat(F, "Map")], k = TH(te), W = h(_, H(H({}, Y), {}, {
      dataStartIndex: A,
      dataEndIndex: b,
      updateId: T,
      graphicalItems: $,
    ...
    function v(E) {
      var _, A, b;
      return nH(this, v), b = oH(this, v, [E]), se(b, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(b, "accessibilityManager", new qU()), se(b, "handleLegendBBoxUpdate", function(T) {
        if (T) {
    ...
    return cH(v, m), iH(v, [{
      ...
      value: function() {
        ...
        if (!Ly(this))
          return null;
        var A = this.props, b = A.children, T = A.className, O = A.width, I = A.height, N = A.style, j = A.compact, D = A.title, R = A.desc, B = ET(A, ZU), F = le(B, !1);
        if (j)
...
const xH = "funding", wH = ["Source", "Grants", "Total (GBP)"], PH = [32, 10, 18], IH = ["text", "number", "currency"], zn = new Intl.NumberFormat("en-GB", {
  style: "currency",
  currency: "GBP",
  maximumFractionDigits: 0
});
function N7({ content: e, block: t }) {
  const r = _n(xH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Funding received", o = NH(n), u = o.reduce((c, l) => c + l.total, 0);
  ct(
    t,
    "xlsx",
    r && o.length > 0 ? {
...
const RH = "members", Fd = ["Name", "Rank", "Department", "Tenured", "Start year"], DH = [28, 14, 18, 10, 12], MH = ["text", "text", "text", "text", "number"];
function R7({ content: e, block: t }) {
  const r = _n(RH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Members", o = [...n].sort((s, c) => {
...
const kH = "publications-by-journal", BH = 10, jH = ["Venue", "Count"], FH = [48, 10], $H = ["text", "number"];
function D7({ content: e, block: t }) {
  const r = _n(kH), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by journal", u = HH(n, BH, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(UH, { counts: u })
  ] }) : null;
}
function UH({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
...
const qH = "publications-by-type", ST = [
  "#1e40af",
  // primary
  "#be123c",
  // accent
  ...
  "#64748b"
  // slate (fallback)
], WH = ["Publication type", "Count"], YH = [24, 10], zH = ["text", "number"];
function M7({ content: e, block: t }) {
  const r = _n(qH), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by type", u = KH(n, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications for the selected population." }) : /* @__PURE__ */ P(GH, { counts: u })
  ] }) : null;
}
function GH({ counts: e }) {
  ...
  return /* @__PURE__ */ P("div", { className: "chart-container", children: /* @__PURE__ */ P(Xi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(SH, { children: [
    /* @__PURE__ */ P(
      Ir,
      {
        data: n,
...
const VH = "publications-by-year", XH = ["Year", "Count", "Cumulative"], QH = [10, 10, 12], ZH = ["number", "number", "number"];
function L7({ content: e, block: t }) {
  const r = _n(VH), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications by year", { series: u, total: s } = e7(n, i);
  return ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(JH, { series: u })
  ] }) : null;
}
function JH({ series: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
...
function n7(e) {
  return Array.isArray(e) ? e.map((t) => {
    const r = t._author ? t7(t._author) : void 0;
    return r7(t, { defaultAuthor: r });
  }).filter(Boolean) : [];
}
const a7 = "publications-list", xT = {
...
function k7({ content: e, block: t }) {
  const r = _n(a7), { members: n, activeLabel: a } = zr(e), [i] = Yi(), o = e?.title || "Publications", u = [...LH(n, i)].sort((y, m) => {
    const v = Number(y.year) || 0;
    return (Number(m.year) || 0) - v;
  }), s = n7(u), c = s.map((y) => y.id).join("|"), [l, f] = ft({ loading: !0, entries: [] });
  Et(() => {
    let y = !1;
    if (!r || s.length === 0) {
      f({ loading: !1, entries: [] });
    ...
    return i7(i.citationStyle).then(({ formatAll: m, style: v }) => {
      if (!y)
        try {
...
const o7 = "supervisions", wT = ["#1e40af", "#0f766e", "#ea580c", "#9333ea", "#be123c", "#0ea5e9"];
function B7({ content: e, block: t }) {
  const r = _n(o7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Supervisions", { levels: o, rows: u, grandTotal: s } = s7(n), c = ["Member", ...o.map(Ep), "Total"], l = u.map((E) => [
    E.member,
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No supervisions recorded for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ P(u7, { rows: u, levels: o })
    ] })
  ] }) : null;
}
function u7({ rows: e, levels: t }) {
  const [r, n] = ft(!1);
  if (Et(() => {
    n(!0);
  }, []), !r)
...
const f7 = "members";
function d7() {
  const e = FC(f7), [, t] = Dp(), [r, n] = Mp(), [a, i] = ft(() => IT(r, e));
  if (Et(() => {
    i(IT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
function h7({ field: e, def: t, value: r, onChange: n }) {
  const a = t?.label || e;
  switch (t?.type) {
    case "enum":
      ...
      /* @__PURE__ */ ee("label", { className: "report-options-field", children: [
        ...
        /* @__PURE__ */ P(
          "select",
          {
            ...
            onChange: s,
            className: "report-options-input",
            children: WC.map((c) => /* @__PURE__ */ P("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] })
    ] }),
...
function y7() {
  ...
  return /* @__PURE__ */ ee("fieldset", { className: "section-toggles", children: [
    ...
    /* @__PURE__ */ P("div", { className: "section-toggles-list", children: UC.map((n) => /* @__PURE__ */ ee("label", { className: "section-toggles-item", children: [
      /* @__PURE__ */ P(
        "input",
        {
          type: "checkbox",
...
function _7({ body: e, page: t }) {
  ...
  return Et(() => GC(t), [t]), /* @__PURE__ */ ee(QT, { basePath: r.basePath, children: [
    ...
    /* @__PURE__ */ P(T7, { title: n, filename: a })
  ] });
}
const A7 = { ...zd, layouts: { MetricsLayout: _7 } }, O7 = {}, S7 = {}, j7 = { meta: O7, capabilities: A7, layoutMeta: S7 };
export {
  C7 as C,
  gr as D,
  N7 as F,
...
//# sourceMappingURL=_entry.generated-hOCZAY0e.js.map
