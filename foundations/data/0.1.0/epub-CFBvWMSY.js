import { J as I } from "./jszip.min-C1ZyuNlD.js";
import { p as X } from "./_entry.generated-CmKl5l3v.js";
import { a as B } from "./fetch-C-PgllAm.js";
import { M as H } from "./math-css-BVI-Y5gH.js";
async function rt(t, e = {}) {
  const { sections: n = [], metadata: i = null } = t || {}, { meta: o = {}, stylesheet: m, identifier: f, cover: h, loadAsset: y } = e, s = { ...i || {}, ...o }, C = m || tt, x = f || s.identifier || W(), u = h || s.cover || s.coverImage, T = n.map((r, c) => Y(r, c)), d = /* @__PURE__ */ new Set();
  for (const r of T)
  ...
  const k = T.map((r, c) => {
    ...
    isCover: !0
  } : null, U = w ? [w, ...k] : k, N = new I();
  N.file("mimetype", "application/epub+zip", { compression: "STORE" }), N.file("META-INF/container.xml", R());
  const $ = N.folder("OEBPS");
  $.file("content.opf", Z({
    id: x,
    meta: s,
    chapters: U,
...
function G({ language: t, title: e, chapters: n, coverPage: i }) {
  const o = n.map(
...
function V({ id: t, title: e, chapters: n }) {
  const i = n.map(
...
function K({ language: t, title: e, imagePath: n, alt: i }) {
  return `<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" xml:lang="${a(t)}">
  <head>
...
function Q({ title: t, language: e, body: n, stylesheetHref: i }) {
...
const tt = `/* Minimal EPUB3 stylesheet — foundations can override via options.stylesheet. */
body {
...
`;
export {
  tt as DEFAULT_STYLESHEET,
  K as buildCoverXhtml,
  G as buildNav,
  V as buildNcx,
  Z as buildOpf,
  rt as compileEpub,
  M as serializeXhtml,
  Q as wrapChapterXhtml
};
//# sourceMappingURL=epub-CFBvWMSY.js.map
