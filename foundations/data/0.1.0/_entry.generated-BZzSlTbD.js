...
const zI = {
  ...
  xlsx: { load: () => import("./xlsx-Bw4ZidR1.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-_vOPemtY.js"), consumes: "typst", ir: !0 },
  ...
  epub: { load: () => import("./epub-v4Tv8w-t.js"), consumes: "html", ir: !1 }
};
function Op(e) {
  const t = zI[e];
  return t ? {
...
async function VI(e, t, r = {}) {
  ...
  const a = await n.load(), i = a.compileDocx || a.compileXlsx || a.compileTypst || a.compilePagedjs || a.compileEpub || a.compilePdf;
  if (!i)
    throw new Error(
...
//# sourceMappingURL=_entry.generated-BZzSlTbD.js.map
