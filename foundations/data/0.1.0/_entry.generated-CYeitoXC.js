...
import { getUniweb as _p, applyBasePath as ax, deriveCacheKey as ix } from "@uniweb/core";
const BT = /\s+/, ox = /([+\-*\/=<>!&|]+)/, q0 = {
  "|": 1,
  "&": 2,
  "=": 3,
...
function kn(e, t, r = {}) {
  ...
  function m(v, T) {
    if (i && v == "text") {
      ...
      for (let b of A)
        b = sx(b), b !== "" && o.push({ type: v, value: b });
    } else
...
function cx(e) {
  ...
  for (let i of e)
    if (i.type === "text")
      if (r = i.value.split(ox), r.length <= 1)
        t.push(i);
      else
...
function dx(e) {
  const t = cx(e), r = lx(t);
  for (const n of r)
    n.type === "chain" && (n.type = "enclosure", n.value = fx(n.tokens), delete n.tokens);
  return r;
}
function hx(e) {
  if (!e.length) return [];
...
}, yx = ["wrap", "aux", "label", "heading", "title"];
let Hd;
const z0 = {};
function G0(e, t, r) {
  z0[e] ??= bx(e);
...
function Gx(e, t) {
  if (!e) return [];
  if (e = Array.isArray(e) ? e : e.split("|"), Tr(t) && (t = t.split(",")), !c2(t))
    return e;
  const r = [];
  for (const n of t)
    r.push(e[n]);
...
function Bn(e, t) {
  if (e.type ??= Co(t, e), e.row ? (t = Gx(t, e.row), e.type = "list") : t = yr(t, e.type, e), t === null) return "";
  const r = e.json ? "json" : e.type, n = { ...e };
  yx.forEach((i) => {
    delete n[i];
  });
  const a = { ...n, [e.type]: e[e.type] };
  return t = Kx(r, a, t), e.title && Tr(t) && (t = qT(t, e.locale)), e.aux && (ke(t) && (t = t.join(e.sep || ", ")), t = Ap(e, t)), e.label && (ke(t) && (t = t.join(e.sep || ", ")), e.label === !0 && (e.label = e._params[0]), t = y2(e, t)), e.heading && (ke(t) && (t = t.join(e.sep || ", ")), e.heading === !0 && (e.heading = e._params[0]), t = m2(e, t)), e.wrap && (Lu(t) ? t = "" : (e.wrap === !0 && (e.wrap = "()"), t = e.wrap[0] + t + e.wrap[1])), t;
}
function Kx(e, t, r) {
  switch (e) {
    case "null":
...
function o2(e, t) {
  const r = e.date ? u2 : $T, n = e.desc ? -1 : 1;
...
function yr(e, t, r = {}) {
  switch (t) {
    case "boolean":
      return !Tn(e);
    case "date":
      return mn(e) ? e instanceof Date || r.date === "auto" && l2(e) ? e : new Date(e.replace(/-/g, "/")) : null;
    case "text":
    case "string":
...
class _2 extends st {
  ...
  format() {
    if (this.isEmpty()) return "";
    const { amount: t, currency: r, convertedAmount: n } = this.parsedArgs, a = px[r.toLowerCase()], o = [["u-amount", a ? new Intl.NumberFormat(`${si()}-CA`, {
      style: "currency",
      currency: a
    }).format(t) : t]];
...
const Z0 = /^[@]?[\$]?[\/]?[a-zA-Z_][a-zA-Z0-9_\/\.-]*$|^@$|^\?$/, O2 = /^-?\d+(\.\d+)?$/;
class S2 {
  /**
  ...
  evaluateExpression(t, r = null) {
    ...
    return r && r.has(n) ? { value: r.get(n), type: "aux" } : Z0.test(n) ? {
      ...
      type: "variable"
    } : O2.test(n) ? { value: parseFloat(n), type: "number" } : { value: this.getError(103, "Invalid expression", n), type: "error" };
  }
...
const x2 = new Set(YT.map((e) => e.join(" ").toUpperCase())), w2 = /* @__PURE__ */ new Set([
  "date",
  "currency",
  "number",
  "phone",
  ...
  "object",
  "tag"
]), P2 = /* @__PURE__ */ new Set([">=", "<=", "!=", "==", "&&", "||"]), I2 = /* @__PURE__ */ new Set(["+", "-", "*", "/", "%", "=", "<", ">", "!"]), C2 = /[a-zA-Z_@$?]/, N2 = /[a-zA-Z0-9_.\/@]/, Ns = /[0-9]/;
function R2(e) {
  return D2(e);
}
function D2(e) {
...
` || a === "\r") {
    ...
    if (Ns.test(a) || a === "-" && Ns.test(e[n + 1] || "") && M2(t)) {
      let o = n + (a === "-" ? 1 : 0);
...
function M2(e) {
  ...
  return !!(t.type === "operator" || t.type === "lparen" || t.type === "word" && x2.has(t.value.toUpperCase()));
}
function zT(e, t, r) {
...
const B2 = /* @__PURE__ */ new Set(["long", "full", "short", "medium"]), j2 = [
  ["for", "each"],
  ["total", "of"],
  ["sum", "of"],
  ["average", "of"],
  ...
  ["as"],
  ["if"]
], F2 = [["then"], ["show"]], $2 = [["otherwise"], ["else"]], U2 = [["else"], ["show"]], H2 = [["in"]], q2 = [["do"]], W2 = [["ascending"]], Y2 = [["descending"]];
function St(e, t) {
  return k2(e.tokens, e.i, t);
}
function nt(e, t) {
  e.i += t.length;
}
...
function J0(e) {
  ...
  const n = t[0];
  return r.length === 0 && Q2(n) ? { type: "show", value: n, modifiers: [] } : { type: "show", value: n, modifiers: r };
}
function X2(e) {
  const t = [];
  for (; e.i < e.tokens.length; ) {
...
function Sp(e) {
  ...
  for (; e.i < e.tokens.length; ) {
    ...
    switch (r.canonical) {
      case "AS": {
        nt(e, r), t.push({ type: "as", format: Z2(e) });
        break;
      }
      case "WITH LABEL": {
        nt(e, r);
...
function Z2(e) {
  ...
  const n = r[0], a = r[1];
  return a === "date" && B2.has(n) ? { type: "date", value: n } : a === "only" && (n === "year" || n === "month") ? { type: "date", value: n === "year" ? "y" : "m" } : w2.has(n) ? { type: n, value: a ?? null } : (a != null && e.i--, { type: n, value: null });
}
function J2(e) {
  const t = xp(e), r = St(e, F2);
  r && nt(e, r);
  const n = em(e);
  let a = null;
  const i = St(e, $2);
...
function nw(e) {
  const t = rm(e), r = Ge(e);
  if (r && r.type === "operator" && rw.has(r.value)) {
    Fe(e);
    const n = rm(e);
...
function gw(e) {
  const t = e?.website?.config?.placeholders;
...
function vw(e = {}) {
  ...
  return {
    content: (u, s) => {
      const c = gw(s), l = t(u);
      if (!l && !c) return null;
      const f = c ? { ...c, ...l || {} } : l, h = s.rawContent?.doc ?? s.rawContent, p = n ? s.properties?.[n] : null;
      if (!p) return Ln(h, r, f);
      let g = Ur(p, f);
      if (Array.isArray(g)) {
        const y = a ? s.properties?.[a] : null;
        y && (g = g.filter(
          (E) => r.evaluateText(y, { ...f, ...E })
        ));
        const m = i ? s.properties?.[i] : null;
        if (m) {
          const E = o ? s.properties?.[o] : null, v = String(E ?? "").trim().toLowerCase() === "desc";
          g = Ew(g, m, f, v ? -1 : 1);
        }
        if (y || m)
          return am(h, r, { ...f, [p]: g }, p);
      }
      return am(h, r, f, p);
    }
  };
...
const Ro = {
  ...
  outputs: {
    xlsx: {
      extension: "xlsx",
      getOptions: (e, t) => Ow(e, t)
    },
    docx: {
      extension: "docx",
      getOptions: (e, t) => Sw(e, t)
    }
  }
}, JT = Vt(null), om = Vt(""), gr = {
  colors: {
...
function i_(e) {
  return e >= 64976 && e <= 65007 || Nw.has(e);
}
var U;
(function(e) {
...
class Lw {
  constructor(t) {
    this.handler = t, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = Mw, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
  ...
  _processSurrogate(t) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (Rw(r))
        return this.pos++, this._addGap(), Dw(t, r);
...
const kw = /* @__PURE__ */ new Uint16Array(
  // prettier-ignore
...
function jw(e) {
  var t;
  return e >= 55296 && e <= 57343 || e > 1114111 ? 65533 : (t = Bw.get(e)) !== null && t !== void 0 ? t : e;
}
var Ze;
(function(e) {
...
class qw {
  ...
  stateNumericStart(t, r) {
    return r >= t.length ? -1 : (t.charCodeAt(r) | Fw) === Ze.LOWER_X ? (this.state = Ve.NumericHex, this.consumed += 1, this.stateNumericHex(t, r + 1)) : (this.state = Ve.NumericDecimal, this.stateNumericDecimal(t, r));
  }
  ...
  emitNumericEntity(t, r) {
    ...
    if (t === Ze.SEMI)
      ...
      return 0;
    return this.emitCodePoint(jw(this.result), this.consumed), this.errors && (t !== Ze.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)), this.consumed;
  }
  /**
  ...
  stateNamedEntity(t, r) {
    ...
    for (; r < t.length; r++, this.excess++) {
      ...
      if (this.treeIndex = Ww(n, a, this.treeIndex + Math.max(1, i), o), this.treeIndex < 0)
        return this.result === 0 || // If we are parsing an attribute
        this.decodeMode === dr.Attribute && // We shouldn't have consumed any characters after the entity,
        (i === 0 || // And there should be no invalid characters.
        Hw(o)) ? 0 : this.emitNotTerminatedNamedEntity();
...
function ku(e) {
  var t;
  return (t = Yw.get(e)) !== null && t !== void 0 ? t : d.UNKNOWN;
}
const V = d, zw = {
...
class Xw {
  constructor(t, r) {
    this.options = t, this.handler = r, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = x.DATA, this.returnState = x.DATA, this.entityStartPos = 0, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new Lw(r), this.currentLocation = this.getCurrentLocation(-1), this.entityDecoder = new qw(kw, (n, a) => {
...
const s_ = /* @__PURE__ */ new Set([d.DD, d.DT, d.LI, d.OPTGROUP, d.OPTION, d.P, d.RB, d.RP, d.RT, d.RTC]), lm = /* @__PURE__ */ new Set([
  ...
  d.TEMPLATE,
  d.TH
]), Qw = /* @__PURE__ */ new Set([...Do, d.OL, d.UL]), Zw = /* @__PURE__ */ new Set([...Do, d.BUTTON]), fm = /* @__PURE__ */ new Set([d.ANNOTATION_XML, d.MI, d.MN, d.MO, d.MS, d.MTEXT]), dm = /* @__PURE__ */ new Set([d.DESC, d.FOREIGN_OBJECT, d.TITLE]), Jw = /* @__PURE__ */ new Set([d.TR, d.TEMPLATE, d.HTML]), eP = /* @__PURE__ */ new Set([d.TBODY, d.TFOOT, d.THEAD, d.TEMPLATE, d.HTML]), tP = /* @__PURE__ */ new Set([d.TABLE, d.TEMPLATE, d.HTML]), rP = /* @__PURE__ */ new Set([d.TD, d.TH]);
class nP {
  ...
  clearBackToTableContext() {
    this.clearBackTo(tP, K.HTML);
  }
  clearBackToTableBodyContext() {
    this.clearBackTo(eP, K.HTML);
  }
  ...
  hasInListItemScope(t) {
    return this.hasInDynamicScope(t, Qw);
  }
  hasInButtonScope(t) {
...
const Dr = {
...
}, c_ = "html", iP = "about:legacy-compat", oP = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", l_ = [
  ...
  "html"
]), f_ = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], cP = [
  ...f_,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function lP(e) {
  return e.name === c_ && e.publicId === null && (e.systemId === null || e.systemId === iP);
}
function fP(e) {
  if (e.name !== c_)
    return Nt.QUIRKS;
  const { systemId: t } = e;
  if (t && t.toLowerCase() === oP)
    return Nt.QUIRKS;
  let { publicId: r } = e;
  if (r !== null) {
    if (r = r.toLowerCase(), sP.has(r))
      return Nt.QUIRKS;
    let n = t === null ? uP : l_;
    if (pm(r, n))
      return Nt.QUIRKS;
    if (n = t === null ? f_ : cP, pm(r, n))
...
const mm = {
...
}, dP = "definitionurl", hP = "definitionURL", pP = new Map([
  "attributeName",
  "attributeType",
  "baseFrequency",
  "baseProfile",
  ...
  "yChannelSelector",
  "zoomAndPan"
].map((e) => [e.toLowerCase(), e])), mP = /* @__PURE__ */ new Map([
  ...
  "radialGradient",
  "textPath"
].map((e) => [e.toLowerCase(), e])), bP = /* @__PURE__ */ new Set([
  d.B,
  d.BIG,
  d.BLOCKQUOTE,
  d.BODY,
...
function gP(e) {
  const t = e.tagID;
  return t === d.FONT && e.attrs.some(({ name: n }) => n === ln.COLOR || n === ln.SIZE || n === ln.FACE) || bP.has(t);
}
function d_(e) {
  for (let t = 0; t < e.attrs.length; t++)
    if (e.attrs[t].name === dP) {
      e.attrs[t].name = hP;
      break;
    }
}
...
function _P(e, t, r, n) {
  return (!n || n === K.HTML) && TP(e, t, r) || (!n || n === K.MATHML) && EP(e, t);
}
const AP = "hidden", OP = 8, SP = 3;
var w;
(function(e) {
...
class wP {
  constructor(t, r, n = null, a = null) {
    this.fragmentContext = n, this.scriptHandler = a, this.currentToken = null, this.stopped = !1, this.insertionMode = w.INITIAL, this.originalInsertionMode = w.INITIAL, this.headElement = null, this.formElement = null, this.currentNotInHTML = !1, this.tmplInsertionModeStack = [], this.pendingCharacterTokens = [], this.hasNonWhitespacePendingCharacterToken = !1, this.framesetOk = !0, this.skipNextNewLine = !1, this.fosterParentingEnabled = !1, this.options = {
      ...ym,
      ...t
    }, this.treeAdapter = this.options.treeAdapter, this.onParseError = this.options.onParseError, this.onParseError && (this.options.sourceCodeLocationInfo = !0), this.document = r ?? this.treeAdapter.createDocument(), this.tokenizer = new Xw(this.options, this), this.activeFormattingElements = new aP(this.treeAdapter), this.fragmentContextID = n ? ku(this.treeAdapter.getTagName(n)) : d.UNKNOWN, this._setContextModes(n ?? this.document, this.fragmentContextID), this.openElements = new nP(this.document, this.treeAdapter, this);
  }
  // API
  static parse(t, r) {
    const n = new this(r);
  ...
  _err(t, r, n) {
    ...
    if (!this.onParseError)
      return;
    const i = (a = t.location) !== null && a !== void 0 ? a : xP, o = {
      code: r,
   ...
   */
  _processStartTag(t) {
    this.shouldProcessStartTagTokenInForeignContent(t) ? aC(this, t) : this._startTagOutsideForeignContent(t);
  }
  /** @protected */
  ...
  /** @internal */
  onEndTag(t) {
    this.skipNextNewLine = !1, this.currentToken = t, this.currentNotInHTML ? iC(this, t) : this._endTagOutsideForeignContent(t);
  }
  /** @protected */
...
function CP(e, t, r) {
  ...
  for (let i = 0, o = a; o !== r; i++, o = a) {
    ...
    const u = e.activeFormattingElements.getElementEntry(o), s = u && i >= SP;
    !u || s ? (s && e.activeFormattingElements.removeEntry(u), e.openElements.remove(o)) : (o = NP(e, u), n === t && (e.activeFormattingElements.bookmark = u), e.treeAdapter.detachNode(n), e.treeAdapter.appendChild(o, n), n = o);
  }
  return n;
}
function NP(e, t) {
...
function Pp(e, t) {
  for (let r = 0; r < OP; r++) {
    ...
    const i = CP(e, a, n.element), o = e.openElements.getCommonAncestor(n.element);
    e.treeAdapter.detachNode(i), o && RP(e, o, i), DP(e, a, n);
  }
}
function Xd(e, t) {
...
function kP(e, t) {
  ...
  const r = t.forceQuirks ? Nt.QUIRKS : fP(t);
  lP(t) || e._err(t, U.nonConformingDoctype), e.treeAdapter.setDocumentMode(e.document, r), e.insertionMode = w.BEFORE_HTML;
}
function Na(e, t) {
...
function g_(e) {
  ...
  return t != null && t.toLowerCase() === AP;
}
function uI(e, t) {
...
function aC(e, t) {
  if (gP(t))
    ...
    n === K.MATHML ? d_(t) : n === K.SVG && (vP(t), h_(t)), wp(t), t.selfClosing ? e._appendElement(t, n) : e._insertElement(t, n), t.ackSelfClosing = !0;
  }
}
function iC(e, t) {
...
function oC(e, t, r) {
  ...
  const n = wP.getFragmentParser(e, r);
  return n.tokenizer.write(t, !0), n.getFragment();
}
const uC = () => ({}), Zr = () => !0, Nr = (e) => {
  const t = parseInt(e, 10);
  return Number.isFinite(t) ? t : e;
}, sC = (e) => typeof e != "string" ? e : e.split(",").map((t) => t.trim()).filter(Boolean).map((t) => parseInt(t, 10)).filter((t) => Number.isFinite(t)), cC = {
  "data-underline": { path: ["underline"], transform: uC },
...
const mC = {
  docx: { load: () => import("./docx-BD9wmfoj.js"), consumes: "docx", ir: !0 },
  xlsx: { load: () => import("./xlsx-e4dJoJvH.js"), consumes: "xlsx", ir: !1 },
  typst: { load: () => import("./typst-Bs2Pox5g.js"), consumes: "typst", ir: !0 },
  ...
  latex: { load: () => import("./latex-BkENDx3C.js"), consumes: "latex", ir: !0 },
  ...
  epub: { load: () => import("./epub-3dqmfd4g.js"), consumes: "html", ir: !1 }
};
function Np(e) {
  const t = mC[e];
  return t ? {
...
function bC(e, t) {
  ...
  return r.ir ? gC(n, e) : r.consumes === "html" ? vC(n, e) : EC(n);
}
function gC(e, t) {
...
async function Tm(e, t, r = {}) {
  const { basePath: n, theme: a, adapterOptions: i = {} } = r, o = _C(e, t, { basePath: n, theme: a });
  return yC(t, o, i);
}
async function OC(e, t = {}) {
  ...
  const g = p.via ?? a, y = p.getOptions ? await p.getOptions(n, { format: a, rootPath: o, loadAsset: f, ...l }) : {}, m = {
    ...
    ...y.adapterOptions,
    ...u
  }, E = wC(n, o), v = globalThis.uniweb?.childBlockRenderer;
...
function Rp({
  ...
  const y = e_(), m = ci(a, y), E = Iw(o, y), v = h ?? p, T = { "data-type": "text" };
  return t && (T["data-bold"] = "true"), r && (T["data-italics"] = "true"), n && (T["data-underline"] = "true"), m && (T["data-color"] = m), i != null && (T["data-size"] = i), E && (T["data-font"] = E), u && (T["data-smallcaps"] = "true"), s && (T["data-allcaps"] = "true"), c && (T["data-strike"] = "true"), l && (T["data-subscript"] = "true"), f && (T["data-superscript"] = "true"), v && (T["data-style"] = v), /* @__PURE__ */ P("span", { ...T, ...g, children: CC(e) });
}
function NC(e) {
...
function DC({ part: e }) {
  const t = e.href || "", { anchor: r } = NC(t);
  return /* @__PURE__ */ P("a", { ...r !== null ? { "data-type": "internalHyperlink", "data-anchor": r } : { "data-type": "externalHyperlink", "data-link": t }, href: t, children: RC(e).map((a, i) => /* @__PURE__ */ P(
    Rp,
    {
      style: "Hyperlink",
      bold: a.bold,
...
function Bt({
  ...
  const u = LC({ tabStops: r, indent: n, role: a });
  if (t) {
    const s = IC(t);
    return /* @__PURE__ */ P(e, { "data-type": "paragraph", ...u, ...o, children: s.map((c, l) => c.type === "link" ? /* @__PURE__ */ P(DC, { part: c }, l) : c.type === "math" ? /* @__PURE__ */ P(
      MC,
      {
        latex: c.latex,
        display: c.display,
...
function jC(e) {
  ...
  return BC.some((r) => t.includes(r));
}
const FC = /(<a\b[^>]*?\shref=)(["'])([^"']*)\2/gi, $C = /^(?:[a-z][a-z0-9+.-]*:|\/\/|#)/i;
function UC(e, t) {
...
function HC(e, t, { locale: r = !0 } = {}) {
  if (!e || typeof e != "string" || !t) return e;
  let n = e;
  return (e.startsWith("page:") || e.startsWith("topic:")) && (n = t.makeHref ? t.makeHref(e) : e), $C.test(n) || r && n.startsWith("/") && !jC(n) && (n = UC(n, t)), n;
}
function qC(e, t) {
  return !e || typeof e != "string" || !t ? e : ax(HC(e, t), t.basePath || "");
}
function WC(e, t) {
  ...
  return !r && !t.basePath && !n ? e : e.replace(FC, (a, i, o, u) => {
    const s = qC(u, t);
    return s === u ? a : `${i}${o}${s}${o}`;
  });
}
function YC({ value: e, className: t, as: r = "div", ...n }) {
...
function R_(e) {
  const t = _p()?.activeWebsite ?? null, r = e && t ? ix(e) : null, n = r ? t.dataStore.get(r) : null, [a, i] = ft(
    () => n ? uo(n.data) : r ? Om() : Am()
  );
  return Et(() => {
    if (!r || !t) {
...
function fn(e, t) {
  const { website: r } = Uu(), [, n] = tx(GC, 0), i = r.activePage?.state;
  Et(() => {
    if (i)
...
const D_ = "academic-metrics/options", Dp = "all-members", M_ = Dp, KC = [
  "members",
...
function eN(e) {
  ...
  const r = () => JC(e), n = wm.map((a) => e.state.subscribe(a, r));
...
function zr(e) {
  const [t] = Mp(), [r] = Lp(), n = Fr(
    ...
    i.where ? { path: "/data/members.json", as: "members", where: i.where } : null
  );
  return {
    members: i.where ? o || [] : a,
    activeView: i.view,
...
function B7({ content: e, block: t }) {
  ...
  return ct(t, "xlsx", {
    ...
    /* @__PURE__ */ ee("div", { className: "cover-meta", role: "list", children: [
      ...
      /* @__PURE__ */ P(so, { label: "Funding", value: nN(s) }),
...
function xr() {
  if (Mm) return Us;
  Mm = 1;
  var e = Ki(), t = aN(), r = iN(), n = "[object Null]", a = "[object Undefined]", i = e ? e.toStringTag : void 0;
  function o(u) {
...
function sN() {
  if (qm) return Xs;
  qm = 1;
  var e = Bp(), t = uN(), r = Gr(), n = k_(), a = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/, o = Function.prototype, u = Object.prototype, s = o.toString, c = u.hasOwnProperty, l = RegExp(
...
function PN() {
  if (gy) return Sc;
  gy = 1;
  var e = wN(), t = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, r = /\\(\\)?/g, n = e(function(a) {
    var i = [];
...
var MN = DN();
const yn = /* @__PURE__ */ xe(MN);
var LN = Bp();
const de = /* @__PURE__ */ xe(LN);
var kN = Gr();
const Oa = /* @__PURE__ */ xe(kN);
var lo = { exports: {} }, ve = {};
var Py;
function BN() {
  if (Py) return ve;
...
var Cy;
function FN() {
  return Cy || (Cy = 1, process.env.NODE_ENV === "production" ? lo.exports = BN() : lo.exports = jN()), lo.exports;
}
var $N = FN(), Lc, Ny;
function U_() {
  if (Ny) return Lc;
...
var HN = UN();
const Vi = /* @__PURE__ */ xe(HN);
var qN = U_();
const WN = /* @__PURE__ */ xe(qN);
var dt = function(t) {
...
var VN = ["viewBox", "children"], XN = [
  ...
  return Object.keys(t).forEach(function(i) {
    var o = t[i];
    qp.includes(i) && typeof o == "function" && (a || (a = {}), a[i] = QN(o, r, n));
  }), a;
}, ZN = ["children"], JN = ["children"];
function My(e, t) {
  if (e == null) return {};
  var r = e3(e, t), n, a;
...
var Ly = {
  ...
  return $r.forEach(t, function(n) {
    me(n) || ($N.isFragment(n) ? r = r.concat(e(n.props.children)) : r.push(n));
  }), jc = r, ky = t, r;
};
function jt(e, t) {
  var r = [], n = [];
...
var By = function(t) {
...
}, t3 = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], r3 = function(t) {
  return t && t.type && yn(t.type) && t3.indexOf(t.type) >= 0;
}, n3 = function(t, r, n, a) {
  var i, o = (i = Bc?.[a]) !== null && i !== void 0 ? i : [];
  return r.startsWith("data-") || !de(t) && (a && o.includes(r) || XN.includes(r)) || n && qp.includes(r);
}, le = function(t, r, n) {
  if (!t || typeof t == "function" || typeof t == "boolean")
    return null;
  var a = t;
  ...
  return Object.keys(a).forEach(function(o) {
    var u;
    n3((u = a) === null || u === void 0 ? void 0 : u[o], o, r, n) && (i[o] = a[o]);
  }), i;
}, th = function e(t, r) {
  if (t === r)
    return !0;
  ...
  if (me(t) && me(r))
    return !0;
  if (!me(t) && !me(r)) {
    var n = t.props || {}, a = n.children, i = My(n, ZN), o = r.props || {}, u = o.children, s = My(o, JN);
...
}, o3 = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function rh() {
...
function nh(e) {
  var t = e.children, r = e.width, n = e.height, a = e.viewBox, i = e.className, o = e.style, u = e.title, s = e.desc, c = u3(e, o3), l = a || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
var Oe = /* @__PURE__ */ C.forwardRef(function(e, t) {
  var r = e.children, n = e.className, a = l3(e, c3), i = pe("recharts-layer", n);
  return /* @__PURE__ */ C.createElement("g", ah({
    className: i
  }, le(a, !0), {
    ref: t
  }), r);
}), d3 = process.env.NODE_ENV !== "production", zt = function(t, r) {
  for (var n = arguments.length, a = new Array(n > 2 ? n - 2 : 0), i = 2; i < n; i++)
    a[i - 2] = arguments[i];
  if (d3 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
...
function v3() {
  if (Gy) return zc;
  Gy = 1;
  var e = g3(), t = e("toUpperCase");
  return zc = t, zc;
}
var E3 = v3();
const Gu = /* @__PURE__ */ xe(E3);
function Ce(e) {
  return function() {
    return e;
  };
}
const q_ = Math.cos, Bo = Math.sin, Qt = Math.sqrt, jo = Math.PI, Ku = 2 * jo, ih = Math.PI, oh = 2 * ih, rn = 1e-6, T3 = oh - rn;
function W_(e) {
  this._ += e[0];
...
class A3 {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? W_ : _3(t);
  }
  moveTo(t, r) {
  ...
  arc(t, r, n, a, i, o) {
    ...
    this._x1 === null ? this._append`M${c},${l}` : (Math.abs(this._x1 - c) > rn || Math.abs(this._y1 - l) > rn) && this._append`L${c},${l}`, n && (h < 0 && (h = h % oh + oh), h > T3 ? this._append`A${n},${n},0,1,${f},${t - u},${r - s}A${n},${n},0,1,${f},${this._x1 = c},${this._y1 = l}` : h > rn && this._append`A${n},${n},0,${+(h >= ih)},${f},${this._x1 = t + n * Math.cos(i)},${this._y1 = r + n * Math.sin(i)}`);
  }
  rect(t, r, n, a) {
...
}, X_ = Qt(1 / 3), w3 = X_ * 2, P3 = {
  draw(e, t) {
    const r = Qt(t / w3), n = r * X_;
...
}, C3 = 0.8908130915292852, Q_ = Bo(jo / 10) / Bo(7 * jo / 10), N3 = Bo(Ku / 10) * Q_, R3 = -q_(Ku / 10) * Q_, D3 = {
  draw(e, t) {
    const r = Qt(t * C3), n = N3 * r, a = R3 * r;
...
}, Pt = -0.5, It = Qt(3) / 2, uh = 1 / Qt(12), L3 = (uh / 2 + 1) * 3, k3 = {
  draw(e, t) {
    const r = Qt(t / L3), n = r / 2, a = r * uh, i = n, o = r * uh + r, u = -i, s = o;
...
function X3() {
  var e = Ce([]), t = sh, r = Qn, n = K3;
  function a(i) {
    var o = Array.from(e.apply(this, arguments), V3), u, s = o.length, c = -1, l;
    for (const f of i)
      for (u = 0, ++c; u < s; ++u)
...
var iA = {
  ...
  var r = t.type, n = r === void 0 ? "circle" : r, a = t.size, i = a === void 0 ? 64 : a, o = t.sizeType, u = o === void 0 ? "area" : o, s = aR(t, eR), c = Jy(Jy({}, s), {}, {
    type: n,
    size: i,
    sizeType: u
  }), l = function() {
    var m = uR(n), E = B3().type(m).size(sR(i, u, n));
    return E();
...
function pR(e, t, r) {
  return t = Ho(t), mR(e, oA() ? Reflect.construct(t, r || [], Ho(e).constructor) : t.apply(e, r));
}
function mR(e, t) {
...
var Ct = 32, Vp = /* @__PURE__ */ (function(e) {
  function t() {
    return fR(this, t), pR(this, t, arguments);
  }
  return bR(t, e), hR(t, [{
    key: "renderIcon",
    value: (
...
function sA() {
  if (ob) return el;
  ob = 1;
  var e = Wu(), t = vR(), r = ER(), n = TR(), a = _R(), i = AR();
  function o(u) {
...
function PR() {
  if (yb) return ll;
  yb = 1;
  var e = Ki(), t = xR(), r = jp(), n = dA(), a = wR(), i = Xp(), o = 1, u = 2, s = "[object Boolean]", c = "[object Date]", l = "[object Error]", f = "[object Map]", h = "[object Number]", p = "[object RegExp]", g = "[object Set]", y = "[object String]", m = "[object Symbol]", E = "[object ArrayBuffer]", v = "[object DataView]", T = e ? e.prototype : void 0, A = T ? T.valueOf : void 0;
...
function RR() {
  if (Tb) return ml;
  Tb = 1;
  var e = CR(), t = NR(), r = Object.prototype, n = r.propertyIsEnumerable, a = Object.getOwnPropertySymbols, i = a ? function(o) {
...
function Qp() {
  if (Ob) return gl;
  Ob = 1;
  var e = MR(), t = wr(), r = Object.prototype, n = r.hasOwnProperty, a = r.propertyIsEnumerable, i = e(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? e : function(o) {
...
function pA() {
  return xb || (xb = 1, (function(e, t) {
    var r = or(), n = LR(), a = t && !t.nodeType && t, i = a && !0 && e && !e.nodeType && e, o = i && i.exports === a, u = o ? r.Buffer : void 0, s = u ? u.isBuffer : void 0, c = s || n;
    e.exports = c;
...
function yA() {
  if (Rb) return Ol;
  Rb = 1;
  var e = kR(), t = mA(), r = BR(), n = r && r.isTypedArray, a = n ? t(n) : e;
  return Ol = a, Ol;
}
var Sl, Db;
function jR() {
  if (Db) return Sl;
  Db = 1;
  var e = DR(), t = Qp(), r = Tt(), n = pA(), a = Zp(), i = yA(), o = Object.prototype, u = o.hasOwnProperty;
  function s(c, l) {
...
function UR() {
  if (Bb) return Il;
  Bb = 1;
  var e = FR(), t = $R(), r = Object.prototype, n = r.hasOwnProperty;
  function a(i) {
    if (!e(i))
      return t(i);
    var o = [];
...
function qR() {
  if (Ub) return Dl;
  Ub = 1;
  var e = HR(), t = 1, r = Object.prototype, n = r.hasOwnProperty;
...
function GR() {
  if (zb) return jl;
  zb = 1;
  var e = WR(), t = Fp(), r = YR(), n = gA(), a = zR(), i = xr(), o = k_(), u = "[object Map]", s = "[object Object]", c = "[object Promise]", l = "[object Set]", f = "[object WeakMap]", h = "[object DataView]", p = o(e), g = o(t), y = o(r), m = o(n), E = o(a), v = i;
...
function KR() {
  if (Gb) return Fl;
  Gb = 1;
  var e = sA(), t = dA(), r = PR(), n = qR(), a = GR(), i = Tt(), o = pA(), u = yA(), s = 1, c = "[object Arguments]", l = "[object Array]", f = "[object Object]", h = Object.prototype, p = h.hasOwnProperty;
...
function tD() {
  if (ng) return Vl;
  ng = 1;
  var e = e0(), t = $_(), r = eD(), n = kp(), a = vA(), i = EA(), o = zu(), u = 1, s = 2;
  function c(l, f) {
...
function fD() {
  if (yg) return cf;
  yg = 1;
  var e = gA(), t = lD(), r = Xp(), n = 1 / 0, a = e && 1 / r(new e([, -0]))[1] == n ? function(i) {
    return new e(i);
  } : t;
  return cf = a, cf;
}
...
function dD() {
  if (bg) return lf;
  bg = 1;
  var e = cA(), t = sD(), r = cD(), n = fA(), a = fD(), i = Xp(), o = 200;
  function u(s, c, l) {
...
function gD(e, t, r) {
  return t = qo(t), vD(e, AA() ? Reflect.construct(t, r || [], qo(e).constructor) : t.apply(e, r));
}
function vD(e, t) {
...
var _g = 1, Hr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = gD(this, t, [].concat(a)), Zu(r, "lastBoundingBox", {
      width: -1,
      height: -1
    }), r;
  }
...
function MD() {
  if (Mg) return Af;
  Mg = 1;
  var e = Up(), t = Hp(), r = ur(), n = wA(), a = ND(), i = mA(), o = DD(), u = Sa(), s = Tt();
  function c(l, f, h) {
...
function jD() {
  if (Fg) return Pf;
  Fg = 1;
  var e = BD(), t = PA(), r = Sa(), n = t ? function(a, i) {
    return t(a, "toString", {
      configurable: !0,
      enumerable: !1,
      value: e(i),
...
function HD() {
  if (Wg) return Df;
  Wg = 1;
  var e = SA(), t = MD(), r = UD(), n = Ju(), a = r(function(i, o) {
    if (i == null)
      return [];
    var u = o.length;
    ...
    if (l && l.length) {
      var R = {
        ...
        var q = Mf({
          ...
          paddingBottom: 4,
          color: F.color || "#000"
        }, u), Y = F.formatter || f || ZD, Q = F.value, te = F.name, k = Q, W = te;
        if (Y && k != null && W != null) {
          var z = Y(Q, te, F, $, l);
          if (Array.isArray(z)) {
            var Z = WD(z, 2);
...
var Ma = "recharts-tooltip-wrapper", r6 = {
  visibility: "hidden"
};
function n6(e) {
...
function c6(e, t, r) {
  return t = Wo(t), l6(e, IA() ? Reflect.construct(t, r || [], Wo(e).constructor) : t.apply(e, r));
}
function l6(e, t) {
...
var Xg = 1, p6 = /* @__PURE__ */ (function(e) {
  function t() {
    var r;
    o6(this, t);
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = c6(this, t, [].concat(a)), mh(r, "state", {
      dismissed: !1,
  ...
  return d6(t, e), s6(t, [{
    ...
    key: "render",
    value: function() {
      var n = this, a = this.props, i = a.active, o = a.allowEscapeViewBox, u = a.animationDuration, s = a.animationEasing, c = a.children, l = a.coordinate, f = a.hasPayload, h = a.isAnimationActive, p = a.offset, g = a.position, y = a.reverseDirection, m = a.useTranslate3d, E = a.viewBox, v = a.wrapperStyle, T = i6({
...
function v6(e, t, r) {
  return t = Yo(t), E6(e, NA() ? Reflect.construct(t, r || [], Yo(e).constructor) : t.apply(e, r));
}
function E6(e, t) {
...
var yt = /* @__PURE__ */ (function(e) {
  function t() {
    return y6(this, t), v6(this, t, arguments);
  }
  return _6(t, e), g6(t, [{
    key: "render",
    value: function() {
...
function DA() {
  if (rv) return jf;
  rv = 1;
  var e = P6(), t = Gr(), r = Aa(), n = NaN, a = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, o = /^0o[0-7]+$/i, u = parseInt;
  function s(c) {
    if (typeof c == "number")
      return c;
    if (r(c))
...
function I6() {
  if (nv) return Ff;
  nv = 1;
  var e = Gr(), t = x6(), r = DA(), n = "Expected a function", a = Math.max, i = Math.min;
  function o(u, s, c) {
...
function C6() {
  if (av) return $f;
  av = 1;
  var e = I6(), t = Gr(), r = "Expected a function";
  function n(a, i, o) {
    var u = !0, s = !0;
...
var Zi = /* @__PURE__ */ LT(function(e, t) {
  ...
  }), I = L6(O, 2), N = I[0], j = I[1], D = nx(function(B, F) {
    j(function($) {
...
var ei = function(t) {
  ...
  try {
    ...
    return Nn.widthCache[a] = s, ++Nn.cacheCount > q6 && (Nn.cacheCount = 0, Nn.widthCache = {}), s;
  } catch {
    return {
      width: 0,
      height: 0
...
var fv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, dv = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, tM = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, rM = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, LA = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, nM = Object.keys(LA), Fn = "NaN";
function aM(e, t) {
  return e * LA[t];
}
var mo = /* @__PURE__ */ (function() {
  function e(t, r) {
    Q6(this, e), this.num = t, this.unit = r, this.num = t, this.unit = r, Number.isNaN(t) && (this.unit = ""), r !== "" && !tM.test(r) && (this.num = NaN, this.unit = ""), nM.includes(r) && (this.num = aM(t, r), this.unit = "px");
  }
  return Z6(e, [{
    key: "add",
    value: function(r) {
    ...
    key: "parse",
    value: function(r) {
      var n, a = (n = rM.exec(r)) !== null && n !== void 0 ? n : [], i = zo(a, 3), o = i[1], u = i[2];
...
function Uf(e) {
  var t = uM(e.slice(5, -1));
  return t === Fn ? "" : t;
}
var sM = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], cM = ["dx", "dy", "angle", "className", "breakAll"];
function gh() {
...
var BA = /[ \f\n\r\t\v\u2028\u2029]+/, jA = function(t) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, l = t.scaleToFit, f = l === void 0 ? !1 : l, h = t.textAnchor, p = h === void 0 ? "start" : h, g = t.verticalAnchor, y = g === void 0 ? "end" : g, m = t.fill, E = m === void 0 ? gv : m, v = pv(t, sM), T = Fr(function() {
    return yM({
      breakAll: v.breakAll,
      children: v.children,
      maxLines: v.maxLines,
  ...
  }, [v.breakAll, v.children, v.maxLines, f, v.style, v.width]), A = v.dx, b = v.dy, _ = v.angle, O = v.className, I = v.breakAll, N = pv(v, cM);
  if (!ze(n) || !ze(i))
    return null;
...
function a0(e) {
  let t, r, n;
  e.length !== 2 ? (t = qr, r = (u, s) => qr(e(u), s), n = (u, s) => e(u) - s) : (t = e === qr || e === bM ? e : gM, r = e, n = e);
...
class vv extends Map {
  ...
  set(t, r) {
    return super.set(TM(this, t), r);
  }
  delete(t) {
    return super.delete(_M(this, t));
  }
}
...
function _M({ _intern: e, _key: t }, r) {
  const n = t(r);
...
const SM = Math.sqrt(50), xM = Math.sqrt(10), wM = Math.sqrt(2);
function Go(e, t, r) {
  const n = (t - e) / Math.max(0, r), a = Math.floor(Math.log10(n)), i = n / Math.pow(10, a), o = i >= SM ? 10 : i >= xM ? 5 : i >= wM ? 2 : 1;
  let u, s, c;
...
function PM(e, t, r) {
  if (e = Float64Array.from(vM(e)), !(!(n = e.length) || isNaN(t = +t))) {
...
var vi = 0.7, Ko = 1 / vi, zn = "\\s*([+-]?\\d+)\\s*", Ei = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", rr = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", NM = /^#([0-9a-f]{3,8})$/, RM = new RegExp(`^rgb\\(${zn},${zn},${zn}\\)$`), DM = new RegExp(`^rgb\\(${rr},${rr},${rr}\\)$`), MM = new RegExp(`^rgba\\(${zn},${zn},${zn},${Ei}\\)$`), LM = new RegExp(`^rgba\\(${rr},${rr},${rr},${Ei}\\)$`), kM = new RegExp(`^hsl\\(${Ei},${rr},${rr}\\)$`), BM = new RegExp(`^hsla\\(${Ei},${rr},${rr},${Ei}\\)$`), Av = {
  aliceblue: 15792383,
...
function Ti(e) {
  var t, r;
  return e = (e + "").trim().toLowerCase(), (t = NM.exec(e)) ? (r = t[1].length, t = parseInt(t[1], 16), r === 6 ? xv(t) : r === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : r === 8 ? yo(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : r === 4 ? yo(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = RM.exec(e)) ? new gt(t[1], t[2], t[3], 1) : (t = DM.exec(e)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = MM.exec(e)) ? yo(t[1], t[2], t[3], t[4]) : (t = LM.exec(e)) ? yo(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = kM.exec(e)) ? Iv(t[1], t[2] / 100, t[3] / 100, 1) : (t = BM.exec(e)) ? Iv(t[1], t[2] / 100, t[3] / 100, t[4]) : Av.hasOwnProperty(e) ? xv(Av[e]) : e === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function xv(e) {
...
function Ah(e, t, r, n) {
  return arguments.length === 1 ? $M(e) : new gt(e, t, r, n ?? 1);
}
function gt(e, t, r, n) {
...
function YM(e) {
  return (e = +e) == 1 ? YA : function(t, r) {
    return r - t ? WM(t, r, e) : u0(isNaN(t) ? r : t);
  };
}
function YA(e, t) {
  var r = t - e;
  return r ? qM(e, r) : u0(isNaN(e) ? t : e);
}
...
function JM(e, t) {
  ...
  return r < t.length && (i = t.slice(r), u[o] ? u[o] += i : u[++o] = i), u.length < 2 ? s[0] ? ZM(s[0].x) : QM(t) : (t = s.length, function(c) {
...
function wa(e, t) {
  var r = typeof t, n;
  return t == null || r === "boolean" ? u0(t) : (r === "number" ? Xo : r === "string" ? (n = Ti(t)) ? (t = n, Nv) : JM : t instanceof Ti ? Nv : t instanceof Date ? VM : GM(t) ? zM : Array.isArray(t) ? KM : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? XM : Xo)(e, t);
}
function s0(e, t) {
  return e = +e, t = +t, function(r) {
...
function ts() {
  ...
  function l() {
    ...
    return o !== pt && (o = rL(e[0], e[h - 1])), u = h > 2 ? aL : nL, s = c = null, f;
  }
  function f(h) {
...
var sL = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function _i(e) {
  if (!(t = sL.exec(e))) throw new Error("invalid format: " + e);
  var t;
  return new l0({
    fill: t[1],
    align: t[2],
...
function fL(e) {
  var t = e.grouping === void 0 || e.thousands === void 0 ? Lv : oL(kv.call(e.grouping, Number), e.thousands + ""), r = e.currency === void 0 ? "" : e.currency[0] + "", n = e.currency === void 0 ? "" : e.currency[1] + "", a = e.decimal === void 0 ? "." : e.decimal + "", i = e.numerals === void 0 ? Lv : uL(kv.call(e.numerals, String)), o = e.percent === void 0 ? "%" : e.percent + "", u = e.minus === void 0 ? "−" : e.minus + "", s = e.nan === void 0 ? "NaN" : e.nan + "";
  function c(f, h) {
    f = _i(f);
    ...
    function D(R) {
      ...
      if (_ === "c")
        ...
        R = +R;
        var Q = R < 0 || 1 / R < 0;
        if (R = isNaN(R) ? s : N(Math.abs(R), A), b && (R = cL(R)), Q && +R == 0 && y !== "+" && (Q = !1), B = (Q ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + B, F = (_ === "s" && !isNaN(R) && Jo !== void 0 ? Bv[8 + Jo / 3] : "") + F + (Q && y === "(" ? ")" : ""), j) {
          for ($ = -1, q = R.length; ++$ < q; )
...
function dL(e) {
  return go = fL(e), f0 = go.format, zA = go.formatPrefix, go;
}
function hL(e) {
...
function GA(e, t, r, n) {
  ...
  switch (n = _i(n ?? ",f"), n.type) {
    case "s": {
      ...
      return n.precision == null && !isNaN(i = pL(a, o)) && (n.precision = i), zA(n, o);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      n.precision == null && !isNaN(i = mL(a, Math.max(Math.abs(e), Math.abs(t)))) && (n.precision = i - (n.type === "e"));
      break;
    }
    case "f":
    case "%": {
      n.precision == null && !isNaN(i = hL(a)) && (n.precision = i - (n.type === "%") * 2);
      break;
    }
  }
  return f0(n);
...
function vL(e) {
  return e === 10 ? gL : e === Math.E ? Math.exp : (t) => Math.pow(e, t);
}
function EL(e) {
...
function d0(e) {
  ...
  let n = 10, a, i;
  function o() {
    return a = EL(n), i = vL(n), r()[0] < 0 ? (a = $v(a), i = $v(i), e(yL, bL)) : e(jv, Fv), t;
  }
...
function p0(e) {
  var t = e(pt, pt), r = 1;
  function n() {
    return r === 1 ? e(pt, pt) : r === 0.5 ? e(TL, _L) : e(qv(r), qv(1 / r));
  }
...
function JA() {
  ...
  function a() {
    ...
    for (r = new Array(u - 1); ++o < u; ) r[o - 1] = IM(e, o / u);
    return i;
  }
  function i(o) {
...
const ns = Sn(0), ru = Sn(1), SL = Sn(2), xL = Sn(3), na = Sn(4), wL = Sn(5), PL = Sn(6);
ns.range;
ru.range;
SL.range;
xL.range;
...
const as = xn(0), nu = xn(1), IL = xn(2), CL = xn(3), aa = xn(4), NL = xn(5), RL = xn(6);
as.range;
nu.range;
IL.range;
CL.range;
...
const [DL, ML] = nO(Or, _0, as, rO, E0, g0), [LL, kL] = nO(Ar, T0, ns, ro, v0, b0);
function Gf(e) {
  if (0 <= e.y && e.y < 100) {
...
function Bk(e) {
  return Rn = BL(e), sO = Rn.format, Rn.parse, cO = Rn.utcFormat, Rn.utcParse, Rn;
}
function jk(e) {
  return new Date(e);
}
...
function A0(e, t, r, n, a, i, o, u, s, c) {
  ...
  return l.invert = function(_) {
    ...
    return arguments.length ? h(Array.from(_, Fk)) : h().map(jk);
  }, l.ticks = function(_) {
    var O = h();
...
function $k() {
  return Ut.apply(A0(LL, kL, Ar, T0, ns, ro, v0, b0, sn, sO).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function Uk() {
  return Ut.apply(A0(DL, ML, Or, _0, as, rs, E0, g0, sn, cO).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function is() {
...
function hO() {
  ...
  return r.domain = function(n) {
    ...
    return Array.from({ length: n + 1 }, (a, i) => PM(e, i / n));
  }, r.copy = function() {
...
function os() {
  ...
  function g(y) {
    return function(m) {
      var E, v, T;
      return arguments.length ? ([E, v, T] = m, c = eL(y, [E, v, T]), p) : [c(0), c(0.5), c(1)];
    };
  }
...
}, w0, Le = !0, Ft = "[DecimalError] ", hn = Ft + "Invalid argument: ", x0 = Ft + "Exponent out of range: ", Ia = Math.floor, nn = Math.pow, t4 = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ot, Xe = 1e7, Re = 7, vO = 9007199254740991, au = Ia(vO / Re), ae = {};
...
function AO(e) {
  ...
  function a(i) {
    ...
    if (typeof i == "number") {
      ...
      throw Error(hn + i);
    if (i.charCodeAt(0) === 45 ? (i = i.slice(1), o.s = -1) : o.s = 1, t4.test(i)) f1(o, i);
    else throw Error(hn + i);
  }
  if (a.prototype = ae, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.clone = AO, a.config = a.set = r4, e === void 0 && (e = {}), e)
...
var s4 = function(t) {
  ...
  return t === 1 ? r : h1(function() {
    ...
    return o >= t ? r.apply(void 0, a) : e(t - o, h1(function() {
      ...
      return r.apply(void 0, n4(l).concat(s));
    }));
  });
}, fs = function(t) {
  return c4(t.length, t);
}, wh = function(t, r) {
  for (var n = [], a = t; a < r; ++a)
    n[a - t] = a;
  return n;
...
var p4 = fs(function(e, t, r) {
  var n = +e, a = +t;
  return n + r * (a - n);
}), m4 = fs(function(e, t, r) {
  var n = t - +e;
  return n = n || 1 / 0, (r - e) / n;
}), y4 = fs(function(e, t, r) {
  var n = t - +e;
...
const ds = {
  rangeStep: h4,
  getDigitCount: d4,
  interpolateNumber: p4,
  uninterpolateNumber: m4,
  uninterpolateTruncation: y4
};
function Ih(e) {
  return v4(e) || g4(e) || wO(e) || b4();
}
function b4() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function A4(e, t, r) {
  ...
  var o = Math.floor((t - 1) / 2), u = f4(l4(function(s) {
...
var x4 = xO(O4), w4 = xO(S4), P4 = process.env.NODE_ENV === "production", ad = "Invariant failed";
function vt(e, t) {
  if (P4)
    throw new Error(ad);
...
function $4(e, t, r) {
  return t = ou(t), U4(e, NO() ? Reflect.construct(t, r || [], ou(e).constructor) : t.apply(e, r));
}
function U4(e, t) {
...
var hs = /* @__PURE__ */ (function(e) {
  function t() {
    return B4(this, t), $4(this, t, arguments);
  }
  return q4(t, e), F4(t, [{
    key: "render",
    value: function() {
      var n = this.props, a = n.offset, i = n.layout, o = n.width, u = n.dataKey, s = n.data, c = n.dataPointFormatter, l = n.xAxis, f = n.yAxis, h = L4(n, I4), p = le(h, !1);
...
var e8 = function(t) {
  ...
  var o = r.props.children, u = jt(o, hs).filter(function(c) {
    return a8(a, i, c.props.direction);
  });
  if (u && u.length) {
  ...
  }), i = l8[n], o = X3().keys(a).value(function(u, s) {
    return +ut(u, s, 0);
  }).order(sh).offset(i);
  return o(t);
}, d8 = function(t, r, n, a, i, o) {
  if (!t)
    return null;
...
var su = Math.PI / 180, A8 = function(t) {
  ...
  var n = t.x, a = t.y, i = r.cx, o = r.cy, u = S8({
    x: n,
    y: a
  }, {
    x: i,
  ...
  if (o === 0)
    return !0;
  var l = w8(r), f = l.startAngle, h = l.endAngle, p = u, g;
  if (f <= h) {
    for (; p > h; )
      p -= 360;
    for (; p < f; )
...
var $8 = function(t) {
  ...
  var a = t.position, i = t.viewBox, o = t.offset, u = t.className, s = i, c = s.cx, l = s.cy, f = s.innerRadius, h = s.outerRadius, p = s.startAngle, g = s.endAngle, y = s.clockWise, m = (f + h) / 2, E = U8(p, g), v = E >= 0 ? 1 : -1, T, A;
...
function Qe(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = L8(e, I8), a = We({
    offset: r
...
var GO = function(t) {
  ...
  if (!n)
    return o;
  var u = z8(t.label, r || i);
  return [u].concat(C8(o));
};
Qe.parseViewBox = GO;
Qe.renderCallByParent = G8;
var od, w1;
function K8() {
  if (w1) return od;
  w1 = 1;
...
var Q8 = ["valueAccessor"], Z8 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function J8(e) {
...
var sB = function(t) {
  return Array.isArray(t.value) ? X8(t.value) : t.value;
};
function Gt(e) {
  var t = e.valueAccessor, r = t === void 0 ? sB : t, n = C1(e, Q8), a = n.data, i = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = C1(n, Z8);
...
var pB = function(t, r) {
  ...
  var r = t.cx, n = t.cy, a = t.innerRadius, i = t.outerRadius, o = t.startAngle, u = t.endAngle, s = pB(o, u), c = o + s, l = Ne(r, n, i, o), f = Ne(r, n, i, c), h = "M ".concat(l.x, ",").concat(l.y, `
  ...
  var r = R1(R1({}, yB), t), n = r.cx, a = r.cy, i = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, l = r.startAngle, f = r.endAngle, h = r.className;
  if (o < i || l === f)
    return null;
  var p = pe("recharts-sector", h), g = o - i, y = ht(u, g, 0, !0), m;
  return y > 0 && Math.abs(l - f) < 360 ? m = mB({
    cx: n,
    cy: a,
    innerRadius: i,
    outerRadius: o,
...
var L1 = {
  ...
  var r = t.type, n = r === void 0 ? "linear" : r, a = t.points, i = a === void 0 ? [] : a, o = t.baseLine, u = t.layout, s = t.connectNulls, c = s === void 0 ? !1 : s, l = EB(n, u), f = c ? i.filter(function(y) {
    return To(y);
  }) : i, h;
  if (Array.isArray(o)) {
...
var j1;
function XO() {
  return j1 || (j1 = 1, process.env.NODE_ENV === "production" ? Ao.exports = _B() : Ao.exports = AB()), Ao.exports;
}
var ud, F1;
function OB() {
  if (F1) return ud;
...
function xB() {
  if (q1) return fd;
  q1 = 1;
  var e = XO(), t = OB(), r = /* @__PURE__ */ I0(), n = /* @__PURE__ */ QO(), a = /* @__PURE__ */ SB(), i = function() {
  };
...
function PB() {
  ...
  if (Y1 = 1, process.env.NODE_ENV !== "production") {
    var e = XO(), t = !0;
    _o.exports = /* @__PURE__ */ xB()(e.isElement, t);
  } else
    _o.exports = /* @__PURE__ */ wB()();
  return _o.exports;
}
var IB = /* @__PURE__ */ PB();
const Ae = /* @__PURE__ */ xe(IB), { getOwnPropertyNames: CB, getOwnPropertySymbols: NB } = Object, { hasOwnProperty: RB } = Object.prototype;
function Ua(e, t) {
...
function z1(e) {
  return CB(e).concat(NB(e));
}
const MB = (
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  Object.hasOwn || ((e, t) => RB.call(e, t))
);
function wn(e, t) {
  return e === t || !e && !t && e !== e && t !== t;
}
const LB = "__v", kB = "__o", BB = "_owner", jB = typeof Float16Array < "u", { getOwnPropertyDescriptor: G1, keys: K1 } = Object;
function FB(e, t) {
...
function lu(e, t) {
  ...
  if (t.length !== r || e.byteOffset !== t.byteOffset)
    return !1;
  if (e instanceof Float64Array || e instanceof Float32Array || jB && e instanceof Float16Array) {
    for (; r-- > 0; )
...
function GB(e, t) {
  return e.href === t.href ? !0 : e.protocol === t.protocol && e.username === t.username && e.password === t.password && e.host === t.host && e.pathname === t.pathname && e.hash === t.hash && KB(e.searchParams, t.searchParams);
}
function KB(e, t) {
...
function ZO(e, t, r, n) {
  return (n === BB || n === kB || n === LB) && (e.$$typeof || t.$$typeof) ? !0 : MB(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
const VB = "[object ArrayBuffer]", XB = "[object Arguments]", QB = "[object Boolean]", ZB = "[object DataView]", JB = "[object Date]", e5 = "[object Error]", t5 = "[object Map]", r5 = "[object Number]", n5 = "[object Object]", a5 = "[object RegExp]", i5 = "[object Set]", o5 = "[object String]", u5 = {
  "[object Int8Array]": !0,
  "[object Uint8Array]": !0,
...
}, s5 = "[object URL]", c5 = Object.prototype.toString;
function l5({ areArrayBuffersEqual: e, areArraysEqual: t, areDataViewsEqual: r, areDatesEqual: n, areErrorsEqual: a, areFunctionsEqual: i, areMapsEqual: o, areNumbersEqual: u, areObjectsEqual: s, arePrimitiveWrappersEqual: c, areRegExpsEqual: l, areSetsEqual: f, areTypedArraysEqual: h, areUrlsEqual: p, unknownTagComparators: g }) {
...
function f5({ circular: e, createCustomConfig: t, strict: r }) {
  let n = {
    areArrayBuffersEqual: FB,
    areArraysEqual: r ? Dn : $B,
    areDataViewsEqual: UB,
    areDatesEqual: HB,
...
function h5({ circular: e, comparator: t, createState: r, equals: n, strict: a }) {
  if (r)
    return function(u, s) {
...
function Xr(e = {}) {
  const { circular: t = !1, createInternalComparator: r, createState: n, strict: a = !1 } = e, i = f5(e), o = l5(i), u = r ? r(o) : d5(o);
  return h5({ circular: t, comparator: o, createState: n, equals: u, strict: a });
}
function m5(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(i)) {
        if (!i.length)
          return;
        var o = i, u = y5(o), s = u[0], c = u.slice(1);
        if (typeof s == "number") {
          eE(a.bind(null, c), s);
          return;
        }
...
function JO(e, t, r) {
  return t = _5(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function _5(e) {
  var t = A5(e, "string");
...
var O5 = function(t, r) {
  ...
  return t.map(function(a) {
    return "".concat(x5(a), " ").concat(r, "ms ").concat(n);
  }).join(",");
}, w5 = process.env.NODE_ENV !== "production", fu = function(t, r, n, a, i, o, u, s) {
  if (w5 && typeof console < "u" && console.warn && (r === void 0 && console.warn("LogUtils requires an error message argument"), !t))
    if (r === void 0)
      console.warn("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
    else {
...
var du = 1e-4, tS = function(t, r) {
  ...
  return function(n) {
    var a = tS(t, r), i = [].concat(R5(a.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return rS(i, n);
  };
  ...
  var f = iE(a, o), h = iE(i, u), p = k5(a, o), g = function(E) {
...
var hu = function(t, r, n) {
  ...
  var a = ni(function(i, o) {
    if (qh(o)) {
      var u = t(o.from, o.to, o.velocity), s = W5(u, 2), c = s[0], l = s[1];
      return tt(tt({}, o), {}, {
        from: c,
        velocity: l
      });
...
const V5 = (function(e, t, r, n, a) {
  var i = O5(e, t), o = i.reduce(function(m, E) {
    ...
    c || (c = E);
    var v = E - c, T = v / r.dt;
    u = K5(r, u, T), a(tt(tt(tt({}, e), t), h())), c = E, p() || (s = requestAnimationFrame(f));
  }, y = function(E) {
    l || (l = E);
...
var X5 = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function Q5(e, t) {
  if (e == null) return {};
  var r = Z5(e, t), n, a;
  if (Object.getOwnPropertySymbols) {
...
function ij(e, t, r) {
  return t && aj(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function aS(e) {
  var t = oj(e, "string");
  ...
  return ij(r, [{
    ...
    value: function(a) {
      ...
      if (u) {
        ...
        if (!(p5(a.to, l) && a.canBegin && a.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(a) {
      var i = this, o = a.from, u = a.to, s = a.duration, c = a.easing, l = a.begin, f = a.onAnimationEnd, h = a.onAnimationStart, p = V5(o, u, j5(c), s, this.changeStyle), g = function() {
        i.stopJSAnimation = p();
      };
    ...
    value: function(a) {
      var i = this, o = a.steps, u = a.begin, s = a.onAnimationStart, c = o[0], l = c.style, f = c.duration, h = f === void 0 ? 0 : f, p = function(y, m, E) {
        ...
        return [].concat(hd(y), [D, v, O]).filter(S5);
      };
    ...
    value: function() {
      ...
      var s = Q5(a, X5), c = $r.count(i), l = this.state.style;
      if (typeof i == "function")
        return i(l);
      if (!u || c === 0 || o <= 0)
        return i;
...
var hE = function(t, r, n, a, i) {
  ...
  var r = dE(dE({}, vj), t), n = ui(), a = ft(-1), i = lj(a, 2), o = i[0], u = i[1];
  Et(function() {
...
}, Ej = ["points", "className", "baseLinePoints", "connectNulls"];
function $n() {
...
var mE = function(t) {
  ...
  var r = t.points, n = t.className, a = t.baseLinePoints, i = t.connectNulls, o = Tj(t, Ej);
  if (!r || !r.length)
    return null;
  var u = pe("recharts-polygon", n);
  if (a && a.length) {
    var s = o.stroke && o.stroke !== "none", c = Pj(r, a, i);
...
var Bj = function(t, r, n, a, i, o) {
  return "M".concat(t, ",").concat(i, "v").concat(a, "M").concat(o, ",").concat(r, "h").concat(n);
}, jj = function(t) {
  var r = t.x, n = r === void 0 ? 0 : r, a = t.y, i = a === void 0 ? 0 : a, o = t.top, u = o === void 0 ? 0 : o, s = t.left, c = s === void 0 ? 0 : s, l = t.width, f = l === void 0 ? 0 : l, h = t.height, p = h === void 0 ? 0 : h, g = t.className, y = Lj(t, Cj), m = Nj({
    x: n,
    y: i,
    top: u,
    left: c,
...
var qj = Hj();
const Wj = /* @__PURE__ */ xe(qj);
var Yj = ["cx", "cy", "angle", "ticks", "axisLine"], zj = ["ticks", "tick", "angle", "tickFormatter", "stroke"];
function ua(e) {
  "@babel/helpers - typeof";
...
function Xj(e, t, r) {
  return t = yu(t), Qj(e, iS() ? Reflect.construct(t, r || [], yu(e).constructor) : t.apply(e, r));
}
function Qj(e, t) {
...
var ms = /* @__PURE__ */ (function(e) {
  ...
  return Jj(t, e), Vj(t, [{
    ...
    key: "getViewBox",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = Uj(u, function(l) {
    ...
    key: "renderAxisLine",
    value: function() {
      var n = this.props, a = n.cx, i = n.cy, o = n.angle, u = n.ticks, s = n.axisLine, c = EE(n, Yj), l = u.reduce(function(g, y) {
    ...
    key: "renderTicks",
    value: function() {
      var n = this, a = this.props, i = a.ticks, o = a.tick, u = a.angle, s = a.tickFormatter, c = a.stroke, l = EE(a, zj), f = this.getTickTextAnchor(), h = le(l, !1), p = le(o, !1), g = i.map(function(y, m) {
...
function nF(e, t, r) {
  return t = bu(t), aF(e, uS() ? Reflect.construct(t, r || [], bu(e).constructor) : t.apply(e, r));
}
function aF(e, t) {
...
var sF = Math.PI / 180, OE = 1e-5, bs = /* @__PURE__ */ (function(e) {
  function t() {
    return tF(this, t), nF(this, t, arguments);
  }
  return oF(t, e), rF(t, [{
    ...
    key: "getTickTextAnchor",
    value: function(n) {
      var a = this.props.orientation, i = Math.cos(-n.coordinate * sF), o;
    ...
    value: function() {
      ...
      return /* @__PURE__ */ C.createElement(Ij, an({
        className: "recharts-polar-angle-axis-line"
      }, c, {
        points: f
      }));
...
function lF() {
  if (xE) return bd;
  xE = 1;
  var e = xr(), t = cF(), r = wr(), n = "[object Object]", a = Function.prototype, i = Object.prototype, o = a.toString, u = i.hasOwnProperty, s = o.call(Object);
  function c(l) {
    if (!r(l) || e(l) != n)
      return !1;
    var f = t(l);
...
var NE = function(t, r, n, a, i) {
  ...
  var r = CE(CE({}, OF), t), n = ui(), a = ft(-1), i = yF(a, 2), o = i[0], u = i[1];
  Et(function() {
    if (n.current && n.current.getTotalLength)
      try {
...
function DE(e) {
  ...
  switch (t) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ C.createElement(SF, r);
    case "sector":
...
function cS(e) {
  var t = e.option, r = e.shapeType, n = e.propTransformer, a = n === void 0 ? RF : n, i = e.activeClassName, o = i === void 0 ? "recharts-active-shape" : i, u = e.isActive, s = wF(e, xF), c;
  if (/* @__PURE__ */ Lt(t))
    c = /* @__PURE__ */ Ue(t, vu(vu({}, s), MF(t)));
  else if (de(t))
    c = t(s);
  else if (dF(t) && !mF(t)) {
    var l = a(t, s);
...
function jF(e, t) {
  var r;
  return gs(e, t) ? r = LF : vs(e, t) ? r = kF : Fi(e, t) && (r = BF), r;
}
function FF(e, t) {
  var r;
...
function UF(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, a = FF(r, t), i = $F(r, t), o = n.filter(function(s, c) {
...
function WF(e, t, r) {
  return t = Eu(t), YF(e, lS() ? Reflect.construct(t, r || [], Eu(e).constructor) : t.apply(e, r));
}
function YF(e, t) {
...
var Ir = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return HF(this, t), n = WF(this, t, [r]), Rt(n, "pieRef", null), Rt(n, "sectorRefs", []), Rt(n, "id", Xi("recharts-pie-")), Rt(n, "handleAnimationEnd", function() {
...
var t9 = ["Webkit", "Moz", "O", "ms"], r9 = function(t, r) {
  var n = t.replace(/(\w)/, function(i) {
    return i.toUpperCase();
  }), a = t9.reduce(function(i, o) {
...
function i9(e, t, r) {
  return t = Au(t), o9(e, pS() ? Reflect.construct(t, r || [], Au(e).constructor) : t.apply(e, r));
}
function o9(e, t) {
...
var l9 = function(t) {
  ...
  function t(r) {
    var n;
    return n9(this, t), n = i9(this, t, [r]), _t(n, "handleDrag", function(a) {
  ...
  return s9(t, e), a9(t, [{
    ...
    value: function() {
      ...
      if (!a || !a.length || !J(u) || !J(s) || !J(c) || !J(l) || c <= 0 || l <= 0)
        return null;
      var T = pe("recharts-brush", i), A = C.Children.count(o) === 1, b = r9("userSelect", "none");
      return /* @__PURE__ */ C.createElement(Oe, {
        className: T,
...
function O9(e, t, r) {
  return t = S9(t), t in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = r, e;
}
function S9(e) {
  var t = x9(e, "string");
...
function I9(e, t) {
  var r = e.x, n = e.y, a = w9(e, A9), i = "".concat(r), o = parseInt(i, 10), u = "".concat(n), s = parseInt(u, 10), c = "".concat(t.height || a.height), l = parseInt(c, 10), f = "".concat(t.width || a.width), h = parseInt(f, 10);
...
function k9(e, t, r) {
  return t = Su(t), B9(e, gS() ? Reflect.construct(t, r || [], Su(e).constructor) : t.apply(e, r));
}
function B9(e, t) {
...
var sr = /* @__PURE__ */ (function(e) {
  function t() {
    ...
    for (var n = arguments.length, a = new Array(n), i = 0; i < n; i++)
      a[i] = arguments[i];
    return r = k9(this, t, [].concat(a)), jr(r, "state", {
      isAnimationFinished: !1
...
jr(sr, "getComposedData", function(e) {
  var t = e.props, r = e.item, n = e.barPosition, a = e.bandSize, i = e.xAxis, o = e.yAxis, u = e.xAxisTicks, s = e.yAxisTicks, c = e.stackedData, l = e.dataStartIndex, f = e.displayedData, h = e.offset, p = o8(n, r);
  if (!p)
    return null;
  var g = t.layout, y = r.type.defaultProps, m = y !== void 0 ? $e($e({}, y), r.props) : r.props, E = m.dataKey, v = m.children, T = m.minPointSize, A = g === "horizontal" ? o : i, b = c ? A.scale.domain() : null, _ = h8({
    numericAxis: A
  }), O = jt(v, es), I = f.map(function(N, j) {
    var D, R, B, F, $, q;
    c ? D = u8(c[l + j], b) : (D = ut(N, E), Array.isArray(D) || (D = [_, D]));
    var Y = C9(T, bS.defaultProps.minPointSize)(D[1], j);
    if (g === "horizontal") {
...
var W9 = function(t, r, n, a, i) {
  ...
  return l.reduce(function(p, g) {
    ...
    if (y.type === "number" && (y.padding === "gap" || y.padding === "no-gap")) {
      var R = E[1] - E[0], B = 1 / 0, F = y.categoricalDomain.sort(KN);
...
var G9 = function(t) {
  var r = t.width, n = t.height, a = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, i = z9(a), o = i * Math.PI / 180, u = Math.atan(n / r), s = o > u && o < Math.PI - u ? n / Math.sin(o) : r / Math.cos(o);
  return Math.abs(s);
}, Nd, aT;
function K9() {
  if (aT) return Nd;
...
var D0 = /* @__PURE__ */ Vt(void 0), M0 = /* @__PURE__ */ Vt(void 0), AS = /* @__PURE__ */ Vt(void 0), OS = /* @__PURE__ */ Vt({}), SS = /* @__PURE__ */ Vt(void 0), xS = /* @__PURE__ */ Vt(0), wS = /* @__PURE__ */ Vt(0), sT = function(t) {
  var r = t.state, n = r.xAxisMap, a = r.yAxisMap, i = r.offset, o = t.clipPathId, u = t.children, s = t.width, c = t.height, l = r$(i);
...
function f$(e, t, r) {
  return t = wu(t), d$(e, NS() ? Reflect.construct(t, r || [], wu(e).constructor) : t.apply(e, r));
}
function d$(e, t) {
...
var T$ = function(t, r) {
  ...
  if (a) {
    ...
    return nr(c, "discard") && p9(b, function(_) {
...
function A$(e) {
  var t = e.x, r = e.y, n = e.segment, a = e.xAxisId, i = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = n$(), l = IS(a), f = CS(i), h = o$();
  if (!c || !h)
    return null;
  ...
  var p = R0({
    x: l.scale,
    y: f.scale
  }), g = ze(t), y = ze(r), m = n && n.length === 2, E = _$(p, g, y, m, h, e.position, l.orientation, f.orientation, e);
  if (!E)
    return null;
  var v = y$(E, 2), T = v[0], A = T.x, b = T.y, _ = v[1], O = _.x, I = _.y, N = nr(e, "hidden") ? "url(#".concat(c, ")") : void 0, j = lT(lT({
    clipPath: N
  }, le(e, !0)), {}, {
    x1: A,
    y1: b,
  ...
  }, T$(o, j), Qe.renderCallByParent(e, Y9({
    x1: A,
    y1: b,
    x2: O,
    y2: I
...
var j0 = /* @__PURE__ */ (function(e) {
  function t() {
    return s$(this, t), f$(this, t, arguments);
  }
  return p$(t, e), l$(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ C.createElement(A$, this.props);
    }
  }]);
})(C.Component);
...
function w$(e, t, r) {
  return t = Pu(t), P$(e, DS() ? Reflect.construct(t, r || [], Pu(e).constructor) : t.apply(e, r));
}
function P$(e, t) {
...
function k$(e, t, r) {
  return t = Iu(t), B$(e, LS() ? Reflect.construct(t, r || [], Iu(e).constructor) : t.apply(e, r));
}
function B$(e, t) {
...
var U$ = function(t, r, n, a, i) {
  ...
  function t() {
    return D$(this, t), k$(this, t, arguments);
  }
  return F$(t, e), L$(t, [{
    key: "render",
    value: function() {
...
function F0(e, t, r) {
  ...
  if (!a || !a.length || !n)
    return [];
  if (J(s) || xa.isSsr)
    return W$(a, typeof s == "number" && J(s) ? s : 0);
  ...
  }, m = a.length >= 2 ? dt(a[1].coordinate - a[0].coordinate) : 1, E = q$(i, m, p);
  return s === "equidistantPreserveStart" ? Y$(m, E, y, a, o) : (s === "preserveStart" || s === "preserveStartEnd" ? h = X$(m, E, y, a, o, s === "preserveStartEnd") : h = V$(m, E, y, a, o), h.filter(function(v) {
    return v.isShow;
  }));
}
var Q$ = ["viewBox"], Z$ = ["viewBox"], J$ = ["ticks"];
function ba(e) {
  "@babel/helpers - typeof";
...
function nU(e, t, r) {
  return t = Nu(t), aU(e, jS() ? Reflect.construct(t, r || [], Nu(e).constructor) : t.apply(e, r));
}
function aU(e, t) {
...
var Ca = /* @__PURE__ */ (function(e) {
  function t(r) {
    var n;
    return tU(this, t), n = nU(this, t, [r]), n.state = {
      fontSize: "",
      letterSpacing: ""
    }, n;
  }
  return oU(t, e), rU(t, [{
    ...
    value: function(n, a) {
      var i = n.viewBox, o = Ld(n, Q$), u = this.props, s = u.viewBox, c = Ld(u, Z$);
    ...
    value: function() {
      ...
      if (l)
        return null;
      var f = this.props, h = f.ticks, p = Ld(f, J$), g = h;
...
var sU = ["x1", "y1", "x2", "y2", "key"], cU = ["offset"];
function En(e) {
  "@babel/helpers - typeof";
...
function $S(e, t) {
  ...
  if (/* @__PURE__ */ C.isValidElement(e))
    ...
    var n = t.x1, a = t.y1, i = t.x2, o = t.y2, u = t.key, s = ET(t, sU), c = le(s, !1);
    c.offset;
    var l = ET(c, cU);
...
function no(e) {
  var t, r, n, a, i, o, u = L0(), s = k0(), c = u$(), l = ot(ot({}, e), {}, {
  ...
  }), f = l.x, h = l.y, p = l.width, g = l.height, y = l.syncWithTicks, m = l.horizontalValues, E = l.verticalValues, v = a$(), T = i$();
  if (!J(p) || p <= 0 || !J(g) || g <= 0 || !J(f) || f !== +f || !J(h) || h !== +h)
    return null;
  var A = l.verticalCoordinatesGenerator || vU, b = l.horizontalCoordinatesGenerator || EU, _ = l.horizontalPoints, O = l.verticalPoints;
  if ((!_ || !_.length) && de(b)) {
  ...
  return /* @__PURE__ */ C.createElement("g", {
    ...
    horizontalPoints: _
  })), /* @__PURE__ */ C.createElement(gU, cn({}, l, {
    verticalPoints: O
  })));
}
...
function AU(e, t, r) {
  return t && _U(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function OU(e, t, r) {
  return t = Ru(t), SU(e, US() ? Reflect.construct(t, r || [], Ru(e).constructor) : t.apply(e, r));
}
function SU(e, t) {
...
var Pn = /* @__PURE__ */ (function(e) {
  function t() {
    return TU(this, t), OU(this, t, arguments);
  }
  return wU(t, e), AU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(IU, this.props);
    }
  }]);
})(Wr.Component);
...
function DU(e, t, r) {
  return t = Du(t), MU(e, WS() ? Reflect.construct(t, r || [], Du(e).constructor) : t.apply(e, r));
}
function MU(e, t) {
...
var jU = function(t) {
  ...
  return kU(t, e), RU(t, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ Wr.createElement(jU, this.props);
    }
  }]);
})(Wr.Component);
...
var WU = qU();
const YU = /* @__PURE__ */ xe(WU);
var Bd = new YU(), jd = "recharts.syncMouseEvents";
function qi(e) {
  "@babel/helpers - typeof";
...
var XU = /* @__PURE__ */ (function() {
  function e() {
    zU(this, e), Fd(this, "activeIndex", 0), Fd(this, "coordinateList", []), Fd(this, "layout", "horizontal");
  }
  return KU(e, [{
    key: "setDetails",
    value: function(r) {
...
var aH = ["item"], iH = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function Ea(e) {
  "@babel/helpers - typeof";
  return Ea = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t) {
    return typeof t;
...
function dH(e, t, r) {
  return t && fH(e.prototype, t), Object.defineProperty(e, "prototype", { writable: !1 }), e;
}
function hH(e, t, r) {
  return t = Mu(t), pH(e, VS() ? Reflect.construct(t, r || [], Mu(e).constructor) : t.apply(e, r));
}
function pH(e, t) {
  if (t && (Ea(t) === "object" || typeof t == "function"))
    return t;
...
var gp = function(t, r, n, a) {
  ...
  var i = a || {
    x: t.chartX,
    y: t.chartY
  }, o = AH(i, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, l = e8(o, u, c, s);
  if (l >= 0 && c) {
    var f = c[l] && c[l].value, h = gp(t, r, l, f), p = OH(n, u, l, i);
    return {
  ...
  return n.reduce(function(g, y) {
    ...
    QU(E.domain, A, v) && (R = Dh(E.domain, null, A), p && (v === "number" || _ !== "auto") && (F = ri(j, T, "category")));
    var $ = JS(v);
    if (!R || R.length === 0) {
      ...
      if (T) {
        if (R = ri(j, T, v), v === "category" && p) {
          ...
          var te = i8(j, a.filter(function(z) {
  ...
  return n.reduce(function(m, E) {
    ...
    if (!m[T]) {
      ...
      return g ? b = Tu(0, p) : u && u[T] && u[T].hasStack ? (b = HO(u[T].stackGroups, s, c), b = mp(f, b, T, i)) : (b = Dh(A, kO(h, n.filter(function(_) {
        ...
        hide: !0,
        orientation: xt(TH, "".concat(i, ".").concat(y % 2), null),
        domain: b,
        originalDomain: A,
        isCategorical: g,
        layout: l
  ...
  p && (E.bottom += p.props.height || fa.defaultProps.height), g && r && (E = n8(E, a, n, r));
  ...
  var r = t.chartName, n = t.GraphicalChild, a = t.defaultTooltipEventType, i = a === void 0 ? "axis" : a, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, l = t.formatAxisMap, f = t.defaultProps, h = function(E, v) {
    var T = v.graphicalItems, A = v.stackGroups, b = v.offset, _ = v.updateId, O = v.dataStartIndex, I = v.dataEndIndex, N = E.barSize, j = E.layout, D = E.barGap, R = E.barCategoryGap, B = E.maxBarSize, F = IT(j), $ = F.numericAxisName, q = F.cateAxisName, Y = IH(T), Q = [];
    return T.forEach(function(te, k) {
      ...
      }, fe), G = ce[q], re = ce["".concat(q, "Ticks")], ie = A && A[oe] && A[oe].hasStack && p8(te, A[oe].stackGroups), M = vr(te.type).indexOf("Bar") >= 0, ye = uu(G, re), X = [], Pe = Y && t8({
        barSize: N,
        stackGroups: A,
        totalSize: NH(ce, q)
      });
    ...
    if (!By({
      ...
      return null;
    var O = T.children, I = T.layout, N = T.stackOffset, j = T.data, D = T.reverseStackOrder, R = IT(I), B = R.numericAxisName, F = R.cateAxisName, $ = jt(O, n), q = d8(j, $, "".concat(B, "Id"), "".concat(F, "Id"), N, D), Y = s.reduce(function(z, Z) {
      var ne = "".concat(Z.axisType, "Map");
      return H(H({}, z), {}, se({}, ne, wH(T, H(H({}, Z), {}, {
        graphicalItems: $,
    ...
    var te = Y["".concat(F, "Map")], k = PH(te), W = h(T, H(H({}, Y), {}, {
      dataStartIndex: A,
      dataEndIndex: b,
      updateId: _,
      graphicalItems: $,
    ...
    function E(v) {
      var T, A, b;
      return lH(this, E), b = hH(this, E, [v]), se(b, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter")), se(b, "accessibilityManager", new XU()), se(b, "handleLegendBBoxUpdate", function(_) {
        if (_) {
        ...
        var O = a3(_), I = xt(b.props, "".concat(O));
        if (O && de(I)) {
          var N, j;
        ...
        return /* @__PURE__ */ C.createElement(nH, {
          key: Q,
          activeCoordinate: j,
          activePayload: D,
    ...
    return yH(E, m), dH(E, [{
      ...
      value: function(T) {
        if (!this.container)
          return null;
        var A = this.container, b = A.getBoundingClientRect(), _ = z6(b), O = {
      ...
      value: function() {
        ...
        if (!By(this))
          return null;
        var A = this.props, b = A.children, _ = A.className, O = A.width, I = A.height, N = A.style, j = A.compact, D = A.title, R = A.desc, B = ST(A, iH), F = le(B, !1);
        if (j)
...
const DH = "funding", MH = ["Source", "Grants", "Total (GBP)"], LH = [32, 10, 18], kH = ["text", "number", "currency"], Kn = new Intl.NumberFormat("en-GB", {
  style: "currency",
  currency: "GBP",
  maximumFractionDigits: 0
});
function j7({ content: e, block: t }) {
  const r = An(DH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Funding received", o = jH(n), u = o.reduce((c, l) => c + l.total, 0);
  ct(
    t,
    "xlsx",
    r && o.length > 0 ? {
...
const FH = "members", $d = ["Name", "Rank", "Department", "Tenured", "Start year"], $H = [28, 14, 18, 10, 12], UH = ["text", "text", "text", "text", "number"];
function F7({ content: e, block: t }) {
  const r = An(FH), { members: n, activeLabel: a } = zr(e), i = e?.title || "Members", o = [...n].sort((s, c) => {
...
const qH = "publications-by-journal", WH = 10, YH = ["Venue", "Count"], zH = [48, 10], GH = ["text", "number"];
function $7({ content: e, block: t }) {
  const r = An(qH), { members: n, activeLabel: a } = zr(e), [i] = Gi(), o = e?.title || "Publications by journal", u = VH(n, WH, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(KH, { counts: u })
  ] }) : null;
}
function KH({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
...
const XH = "publications-by-type", CT = [
  "#1e40af",
  // primary
  "#be123c",
  // accent
  ...
  "#64748b"
  // slate (fallback)
], QH = ["Publication type", "Count"], ZH = [24, 10], JH = ["text", "number"];
function U7({ content: e, block: t }) {
  const r = An(XH), { members: n, activeLabel: a } = zr(e), [i] = Gi(), o = e?.title || "Publications by type", u = t7(n, i);
  ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications for the selected population." }) : /* @__PURE__ */ P(e7, { counts: u })
  ] }) : null;
}
function e7({ counts: e }) {
  const [t, r] = ft(!1);
  if (Et(() => {
    r(!0);
  }, []), !t)
  ...
  return /* @__PURE__ */ P("div", { className: "chart-container", children: /* @__PURE__ */ P(Zi, { width: "100%", height: 320, children: /* @__PURE__ */ ee(RH, { children: [
    /* @__PURE__ */ P(
      Ir,
      {
        data: n,
...
const r7 = "publications-by-year", n7 = ["Year", "Count", "Cumulative"], a7 = [10, 10, 12], i7 = ["number", "number", "number"];
function H7({ content: e, block: t }) {
  const r = An(r7), { members: n, activeLabel: a } = zr(e), [i] = Gi(), o = e?.title || "Publications by year", { series: u, total: s } = u7(n, i);
  return ct(
    t,
    "xlsx",
    r && u.length > 0 ? {
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No publications in the selected population." }) : /* @__PURE__ */ P(o7, { series: u })
  ] }) : null;
}
...
function l7(e) {
  return Array.isArray(e) ? e.map((t) => {
    const r = t._author ? s7(t._author) : void 0;
    return c7(t, { defaultAuthor: r });
  }).filter(Boolean) : [];
}
const f7 = "publications-list", NT = {
...
function q7({ content: e, block: t }) {
  const r = An(f7), { members: n, activeLabel: a } = zr(e), [i] = Gi(), o = e?.title || "Publications", u = [...HH(n, i)].sort((y, m) => {
    const E = Number(y.year) || 0;
    return (Number(m.year) || 0) - E;
  }), s = l7(u), c = s.map((y) => y.id).join("|"), [l, f] = ft({ loading: !0, entries: [] });
  Et(() => {
    let y = !1;
    if (!r || s.length === 0) {
      f({ loading: !1, entries: [] });
    ...
    return d7(i.citationStyle).then(({ formatAll: m, style: E }) => {
      if (!y)
        try {
...
const h7 = "supervisions", RT = ["#1e40af", "#0f766e", "#ea580c", "#9333ea", "#be123c", "#0ea5e9"];
function W7({ content: e, block: t }) {
  const r = An(h7), { members: n, activeLabel: a } = zr(e), i = e?.title || "Supervisions", { levels: o, rows: u, grandTotal: s } = m7(n), c = ["Member", ...o.map(Ep), "Total"], l = u.map((v) => [
    v.member,
  ...
  return ct(
    ...
    u.length === 0 ? /* @__PURE__ */ P("p", { className: "chart-empty", children: "No supervisions recorded for the selected population." }) : /* @__PURE__ */ ee(wt, { children: [
      ...
      /* @__PURE__ */ P(p7, { rows: u, levels: o })
    ] })
  ] }) : null;
}
function p7({ rows: e, levels: t }) {
  const [r, n] = ft(!1);
  if (Et(() => {
    n(!0);
  }, []), !r)
...
const g7 = "members";
function v7() {
  const e = zC(g7), [, t] = Mp(), [r, n] = Lp(), [a, i] = ft(() => MT(r, e));
  if (Et(() => {
    i(MT(r, e));
  }, [e]), !e) return null;
  const o = (c, l) => {
...
function E7({ field: e, def: t, value: r, onChange: n }) {
  const a = t?.label || e;
  switch (t?.type) {
    case "enum":
      ...
      /* @__PURE__ */ ee("label", { className: "report-options-field", children: [
        ...
        /* @__PURE__ */ P(
          "select",
          {
            ...
            onChange: s,
            className: "report-options-input",
            children: QC.map((c) => /* @__PURE__ */ P("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] })
    ] }),
...
function A7() {
  ...
  return /* @__PURE__ */ ee("fieldset", { className: "section-toggles", children: [
    ...
    /* @__PURE__ */ P("div", { className: "section-toggles-list", children: KC.map((n) => /* @__PURE__ */ ee("label", { className: "section-toggles-item", children: [
      /* @__PURE__ */ P(
        "input",
        {
          type: "checkbox",
      ...
      /* @__PURE__ */ P("span", { children: XC(n) })
    ] }, n)) })
  ] });
}
function O7() {
  const { data: e } = R_({ path: "/data/queries.json", as: "queries" }), t = Array.isArray(e) ? e : [];
...
function I7({ body: e, page: t }) {
  ...
  return Et(() => eN(t), [t]), /* @__PURE__ */ ee(r_, { basePath: r.basePath, children: [
    ...
    /* @__PURE__ */ P(P7, { title: n, filename: a })
  ] });
}
const C7 = { ...Ro, vars: xw || Ro?.vars, layouts: { MetricsLayout: I7 } }, N7 = {
  Members: {
    data: {
      members: null,
      queries: null
...
}, R7 = {}, Y7 = { meta: N7, capabilities: C7, layoutMeta: R7 };
export {
  B7 as C,
  gr as D,
  j7 as F,
...
//# sourceMappingURL=_entry.generated-CYeitoXC.js.map
