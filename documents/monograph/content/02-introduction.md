...
The starter chapter that follows treats Victorian-naturalist sources as a worked example of the citation apparatus this template ships with. The author of this template assumes you will replace both the sample bibliography (`records/bibliography/`) and the chapter prose with your own material — the structural pattern is what's reusable.
