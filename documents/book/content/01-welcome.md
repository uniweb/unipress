...
What you can't do — or rather, what you don't *need* to do — is worry about how any of this will look. The book template handles that. Page breaks, chapter openings, the way a long quote indents differently than ordinary prose, the small caps in the running header — all of it is the template's job.

Your job is the writing.

When you're ready to see your own version of this book, edit `document.yml` first: change the title, change the author. Then start replacing the chapters. Compile any time you want to see what your book is becoming.

The next chapter shows what the template does with various kinds of formatting, in case you want to know what's available before you write.
