...
If you're reading this in a published version of the book, it means the author kept the colophon. If you're reading it in the placeholder version that ships with unipress, replace it with your own when you're ready, or remove the file from `pages/` if you don't want a colophon at all.
